...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
      ...
      <meta property="og:url" content="https://www.tutorialspoint.com/swift_4_online_training/index.asp" />
      <meta property="og:title" content="Swift 4 Online Training" />
      <meta property="og:description" content="Swift 4 Online Training - Swift 4 Online Training - Swift 4 Online Training - Swift 4 online video training for beginners to teach basic to advanced concepts covering Overview,  Introduction, Environment setup, Basic Syntax, Variables, Literals, Arithmetic Operator,  Logical Operator,  Loops, Repeat while loop, Arrays, Enumerations, Methods, Inheritance, Initialization, ARC Overview, Range Operator, Decision making &ndash; If statement, Decision making Swift Statement." />
      ...
      <meta name="twitter:title" content="Swift 4 Online Training">
      <meta name="twitter:description" content="Swift 4 Online Training - Swift 4 Online Training - Swift 4 Online Training - Swift 4 online video training for beginners to teach basic to advanced concepts covering Overview,  Introduction, Environment setup, Basic Syntax, Variables, Literals, Arithmetic Operator,  Logical Operator,  Loops, Repeat while loop, Arrays, Enumerations, Methods, Inheritance, Initialization, ARC Overview, Range Operator, Decision making &ndash; If statement, Decision making Swift Statement.">
            ...
            <div>
                  ...
                  <div class="courseimg">	
                     <div class="course_header">
                        <div class="course_img">
                           <div>
                              <img src="https://www.tutorialspoint.com/assets/videos/courses/67/images/course_67_image.png" alt="" />   
                           </div>                        
                        </div>
                        <div class="course_header_title" style="background:#fd2822">Swift 4 Online Training           
                        </div>
               ...
               <div class="content-body">
                  ...
                  <div class="options">                                            
                     ...
                     <a href='https://www.tutorialspoint.com/swift_4_online_training/index.asp' class="button round accent-color date prevpage">   
                        <i class="fa fa-arrow-circle-o-left big-font"></i> Previous Page
                     </a>                    
                                          <a href="https://www.tutorialspoint.com/swift_4_online_training/swift_4_andndash_course_overview.asp" class="button round accent-color date nextpage">
                     Next Page <i class="fa fa-arrow-circle-o-right big-font"></i>&nbsp;
                     </a>
                  </div>
                  <hr>               						
                  <h1>Swift 4 Online Training</h1>
                  <p></p>
                  <div>
                     <p>Swift is a programming language developed by apple, specially for application development of apple devices. Swift can be used to develop applications as well as for other advance programming like programming a server etc. In this tutorial we&#39;ll learn the basics of latest version of swift language, Swift4.</p><h1>Audience</h1><p>This tutorial is meant for beginners who want to learn Swift programming language. This course is suitable for anyone with or without prior experience in programming.</p>                     <h1>Instructor</h1>
                     <div class="user_desc">                        
                        <a href='https://www.tutorialspoint.com/videotutorials/profile/Ashish-Sharma' target='_blank' title='View Ashish Sharma  Profile'>
                           <img src="https://www.tutorialspoint.com/assets/profiles/6457/profile/200_142104-1511172405.jpg"  alt="Ashish-Sharma"/>
                           <div class="user_desc_title">Ashish Sharma </div>                            
                        </a>	
                        <p>Ashish Sharma has 7 years of programming experience. Ashish has experience in making enterprise iOS applications for MNC&amp;amp;#039;s. He&amp;amp;#039;s also experienced in Backend, Frontend Development Technologies.</p>
                     </div>
                  </div>
                  <hr>
                  <div class="options">                                            
...
<aside class="sidebar sidebar-right">
      ...
      <a href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.facebook.com/sharer.php?u=' + 'https://www.tutorialspoint.com/swift_4_online_training/index.asp','sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/facebookIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://twitter.com/share?url=' + 'https://www.tutorialspoint.com/swift_4_online_training/index.asp','sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/twitterIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.linkedin.com/cws/share?url=' + 'https://www.tutorialspoint.com/swift_4_online_training/index.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/linkedinIcon.jpg" alt="img" />
      </a>      
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.stumbleupon.com/submit?url=https://www.tutorialspoint.com/swift_4_online_training/index.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/StumbleUponIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://reddit.com/submit?url=https://www.tutorialspoint.com/swift_4_online_training/index.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=656,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/reddit.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.blogger.com/blog-this.g?u=https://www.tutorialspoint.com/swift_4_online_training/index.asp&amp;n='+ document.title,'sharer','toolbar=0,status=0,width=626,height=656,top='+sTop+',left='+sLeft);return false;">
