...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
      ...
      <meta property="og:url" content="https://www.tutorialspoint.com/swift_4_online_training/swift_4_andndash_for_in_loop.asp" />
      <meta property="og:title" content="Swift 4 &ndash; For in loop" />
      <meta property="og:description" content="Swift 4 &ndash; For in loop - Swift 4 &ndash; For in loop - Swift 4 Online Training - Swift 4 online video training for beginners to teach basic to advanced concepts covering Overview,  Introduction, Environment setup, Basic Syntax, Variables, Literals, Arithmetic Operator,  Logical Operator,  Loops, Repeat while loop, Arrays, Enumerations, Methods, Inheritance, Initialization, ARC Overview, Range Operator, Decision making &ndash; If statement, Decision making Swift Statement." />
      ...
      <meta name="twitter:title" content="Swift 4 &ndash; For in loop">
      <meta name="twitter:description" content="Swift 4 &ndash; For in loop - Swift 4 &ndash; For in loop - Swift 4 Online Training - Swift 4 online video training for beginners to teach basic to advanced concepts covering Overview,  Introduction, Environment setup, Basic Syntax, Variables, Literals, Arithmetic Operator,  Logical Operator,  Loops, Repeat while loop, Arrays, Enumerations, Methods, Inheritance, Initialization, ARC Overview, Range Operator, Decision making &ndash; If statement, Decision making Swift Statement.">
               ...
               <ul class="nav left-menu">	
                     ...
                     <li><a href="javascript:void(0);" class="clsSection" style="background-color:#fd2822!important;">Swift 4 Online Training</a>
                        <ul class="submenu">
                              ...
                              <li class="clsLecture activebar " id='135'>
      ...
      <div class="content">
         <div class="content-wrapper" style="height:auto!important;">
               ...
               <div class="content-body" style="margin:0px;">
                  <div>
                  <h1><span>Swift 4 &ndash; For in loop</span></h1>      
                  <hr>
               </div>
               </div>
               ...
               <div class="content-body">
                  ...
                  <br>
                     ...
                     <script>
                       var youtube_id = 'gO7gs7ORKNY';
                       var vc = 'VFBmK0NyZFFDVmR4TDhDNXNyTGZEUT09';
                       var vl = 'aXI3aERPbzVrdFFPYS9oRGVvV1pWQT09';
                       var vu = '';
                  ...
                  <div class="options">
                      ...
                      <a href="https://www.tutorialspoint.com/swift_4_online_training/swift_4_andndash_assignment_operator.asp" class="button round accent-color date prevpage">   
                     <i class="fa fa-arrow-circle-o-left big-font"></i> Previous Page
                     </a>                 
                                          <a href="https://www.tutorialspoint.com/swift_4_online_training/swift_4_andndash_while_loop.asp" class="button round accent-color date nextpage">
...
<aside class="sidebar sidebar-right">
      ...
      <a href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.facebook.com/sharer.php?u=' + 'https://www.tutorialspoint.com/swift_4_online_training/swift_4_andndash_for_in_loop.asp','sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/facebookIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://twitter.com/share?url=' + 'https://www.tutorialspoint.com/swift_4_online_training/swift_4_andndash_for_in_loop.asp','sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/twitterIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.linkedin.com/cws/share?url=' + 'https://www.tutorialspoint.com/swift_4_online_training/swift_4_andndash_for_in_loop.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/linkedinIcon.jpg" alt="img" />
      </a>      
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.stumbleupon.com/submit?url=https://www.tutorialspoint.com/swift_4_online_training/swift_4_andndash_for_in_loop.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/StumbleUponIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://reddit.com/submit?url=https://www.tutorialspoint.com/swift_4_online_training/swift_4_andndash_for_in_loop.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=656,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/reddit.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.blogger.com/blog-this.g?u=https://www.tutorialspoint.com/swift_4_online_training/swift_4_andndash_for_in_loop.asp&amp;n='+ document.title,'sharer','toolbar=0,status=0,width=626,height=656,top='+sTop+',left='+sLeft);return false;">
