...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
      <head>
      <meta charset="utf-8">
      <title>Blockchain Online Training</title>		
      <meta name="Description" content="Blockchain Online Training - Blockchain Online Training -  Blockchain Online Training - Introduction, A Short History, Getting Started, The block Structure, Forming a Chain, Proof of Work, Transactions, Exploring Demo Hash and Block, Exploring Demo Blockchain and P2P, Writing Simulation Code Getting Started, Writing Simulation Code Writing Block Structure, Writing Simulation Code Adding Blocks in Chain, Writing Simulation Code Run the Simulation, Blockchain Applications, Frameworks, etc."/>
      ...
      <meta property="og:url" content="https://www.tutorialspoint.com/blockchain_online_training/index.asp" />
      <meta property="og:title" content="Blockchain Online Training" />
      <meta property="og:description" content="Blockchain Online Training - Blockchain Online Training -  Blockchain Online Training - Introduction, A Short History, Getting Started, The block Structure, Forming a Chain, Proof of Work, Transactions, Exploring Demo Hash and Block, Exploring Demo Blockchain and P2P, Writing Simulation Code Getting Started, Writing Simulation Code Writing Block Structure, Writing Simulation Code Adding Blocks in Chain, Writing Simulation Code Run the Simulation, Blockchain Applications, Frameworks, etc." />
      ...
      <meta name="twitter:title" content="Blockchain Online Training">
      <meta name="twitter:description" content="Blockchain Online Training - Blockchain Online Training -  Blockchain Online Training - Introduction, A Short History, Getting Started, The block Structure, Forming a Chain, Proof of Work, Transactions, Exploring Demo Hash and Block, Exploring Demo Blockchain and P2P, Writing Simulation Code Getting Started, Writing Simulation Code Writing Block Structure, Writing Simulation Code Adding Blocks in Chain, Writing Simulation Code Run the Simulation, Blockchain Applications, Frameworks, etc.">
            ...
            <div>
                  ...
                  <div class="courseimg">	
                     <div class="course_header">
                        <div class="course_img">
                           <div>
                              <img src="https://www.tutorialspoint.com/assets/videos/courses/270/images/course_270_image.png" alt="" />   
                           </div>                        
                        </div>
                        <div class="course_header_title" style="background:#0da4ad">Blockchain Online Training           
                        </div>
               ...
               <div class="content-body">
                  ...
                  <div class="options">                                            
                     ...
                     <a href='https://www.tutorialspoint.com/blockchain_online_training/index.asp' class="button round accent-color date prevpage">   
                        <i class="fa fa-arrow-circle-o-left big-font"></i> Previous Page
                     </a>                    
                                          <a href="https://www.tutorialspoint.com/blockchain_online_training/blockchain_introduction.asp" class="button round accent-color date nextpage">
                     Next Page <i class="fa fa-arrow-circle-o-right big-font"></i>&nbsp;
                     </a>
                  </div>
                  <hr>               						
                  <h1>Blockchain Online Training</h1>
                  <p></p>
                  <div>
                     <p>Blockchain has been in a lot of Buzzword these days. And thats mainly because it’s backbone behind one of the very famous crypto-currency in the world - the Bitcoin. </p><p>Blockchain is the algorithm for Distributed Ledger Technology (DLT ). DLT and Blockchain as a concept can be used in varied applications beyond crypto-currency network like, Real estate, logistics, Banking and Financial Sector, Fin-Tech and elections & surveys. And the list is endless and expanding daily. </p><p>Many Governments and  leading Banks have decided to bring many of their conventional transactions on Blockchain concept. The applications and potential of this framework is huge and is considered to be changing the way in transact in various domains. </p><p>In this tutorial we will go through the Introduction to blockchain as a concept, Learn basic Building blocks and explore the working of Blockchain from conceptual and architectural point of view. </p><h1>Audience</h1><p>This Blockchain tutorial is for the professionals who want to get introduced to the concept of Blockchain and demystify the Buzz word. This is for a developer to understand the building block and get an idea how to develop a custom blockchain. The tutorial will go through the conceptual part fo the topic. However it is to be noted that this tutorial will not cover any of the cryptographic frameworks like Bitcoin, Ethereum, etc. </p>                     <h1>Instructor</h1>
                     <div class="user_desc">                        
                        <a href='https://www.tutorialspoint.com/videotutorials/profile/parth_joshi' target='_blank' title='View Parth Joshi Profile'>
                           <img src="https://www.tutorialspoint.com/assets/profiles/50931/profile/200_91954-1533017082.png"  alt="parth_joshi"/>
                           <div class="user_desc_title">Parth Joshi</div>                            
                        </a>	
                        <p>Parth Joshi has a industry experience of 10+ years. He is a Techno-Consultant, Trainer and an Entrepreneur. He is a child prodigy in programming and is passionate to learn and build new technology. His current endeavours are Open Source ERP implementations for ISPs, Telecoms Infrastructure Companies , Education Sectors and implement custom solutions in the IoT and Blockchain Arena. His key expertise include Project Management, Systems Architecture, Business Development, J2EE, Angular, Node JS, C/++ and many other programming languages.</p>
                     </div>
                  </div>
                  <hr>
                  <div class="options">                                            
...
<aside class="sidebar sidebar-right">
      ...
      <a href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.facebook.com/sharer.php?u=' + 'https://www.tutorialspoint.com/blockchain_online_training/index.asp','sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/facebookIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://twitter.com/share?url=' + 'https://www.tutorialspoint.com/blockchain_online_training/index.asp','sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/twitterIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.linkedin.com/cws/share?url=' + 'https://www.tutorialspoint.com/blockchain_online_training/index.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/linkedinIcon.jpg" alt="img" />
      </a>      
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.stumbleupon.com/submit?url=https://www.tutorialspoint.com/blockchain_online_training/index.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/StumbleUponIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://reddit.com/submit?url=https://www.tutorialspoint.com/blockchain_online_training/index.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=656,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/reddit.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.blogger.com/blog-this.g?u=https://www.tutorialspoint.com/blockchain_online_training/index.asp&amp;n='+ document.title,'sharer','toolbar=0,status=0,width=626,height=656,top='+sTop+',left='+sLeft);return false;">
