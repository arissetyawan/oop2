...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
      <head>
      <meta charset="utf-8">
      <title>Blockchain - A Short History</title>		
      <meta name="Description" content="Blockchain - A Short History - Blockchain A Short History -  Blockchain Online Training - Introduction, A Short History, Getting Started, The block Structure, Forming a Chain, Proof of Work, Transactions, Exploring Demo Hash and Block, Exploring Demo Blockchain and P2P, Writing Simulation Code Getting Started, Writing Simulation Code Writing Block Structure, Writing Simulation Code Adding Blocks in Chain, Writing Simulation Code Run the Simulation, Blockchain Applications, Frameworks, etc."/>
      ...
      <meta property="og:url" content="https://www.tutorialspoint.com/blockchain_online_training/blockchain_a_short_history.asp" />
      <meta property="og:title" content="Blockchain - A Short History" />
      <meta property="og:description" content="Blockchain - A Short History - Blockchain A Short History -  Blockchain Online Training - Introduction, A Short History, Getting Started, The block Structure, Forming a Chain, Proof of Work, Transactions, Exploring Demo Hash and Block, Exploring Demo Blockchain and P2P, Writing Simulation Code Getting Started, Writing Simulation Code Writing Block Structure, Writing Simulation Code Adding Blocks in Chain, Writing Simulation Code Run the Simulation, Blockchain Applications, Frameworks, etc." />
      ...
      <meta name="twitter:title" content="Blockchain - A Short History">
      <meta name="twitter:description" content="Blockchain - A Short History - Blockchain A Short History -  Blockchain Online Training - Introduction, A Short History, Getting Started, The block Structure, Forming a Chain, Proof of Work, Transactions, Exploring Demo Hash and Block, Exploring Demo Blockchain and P2P, Writing Simulation Code Getting Started, Writing Simulation Code Writing Block Structure, Writing Simulation Code Adding Blocks in Chain, Writing Simulation Code Run the Simulation, Blockchain Applications, Frameworks, etc.">
      ...
      <div class="content">
         <div class="content-wrapper" style="height:auto!important;">
               ...
               <div class="content-body" style="margin:0px;">
                  <div>
                  <h1><span>Blockchain - A Short History</span></h1>      
                  <hr>
               </div>
               </div>
               ...
               <div class="content-body">
                  ...
                  <br>
                     ...
                     <script>
                       var youtube_id = '3CXNCfcMBJ0';
                       var vc = 'dUVjWE1Fc1hLR1NNMTBHS2NxendYUT09';
                       var vl = 'UjlkR2wxRTlZS1hoVUk5cWxLRy9udz09';
                       var vu = '';
                  ...
                  <div class="options">
                      ...
                      <a href="https://www.tutorialspoint.com/blockchain_online_training/blockchain_introduction.asp" class="button round accent-color date prevpage">   
                     <i class="fa fa-arrow-circle-o-left big-font"></i> Previous Page
                     </a>                 
                                          <a href="https://www.tutorialspoint.com/blockchain_online_training/blockchain_getting_started.asp" class="button round accent-color date nextpage">
...
<aside class="sidebar sidebar-right">
      ...
      <a href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.facebook.com/sharer.php?u=' + 'https://www.tutorialspoint.com/blockchain_online_training/blockchain_a_short_history.asp','sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/facebookIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://twitter.com/share?url=' + 'https://www.tutorialspoint.com/blockchain_online_training/blockchain_a_short_history.asp','sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/twitterIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.linkedin.com/cws/share?url=' + 'https://www.tutorialspoint.com/blockchain_online_training/blockchain_a_short_history.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/linkedinIcon.jpg" alt="img" />
      </a>      
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.stumbleupon.com/submit?url=https://www.tutorialspoint.com/blockchain_online_training/blockchain_a_short_history.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/StumbleUponIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://reddit.com/submit?url=https://www.tutorialspoint.com/blockchain_online_training/blockchain_a_short_history.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=656,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/reddit.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.blogger.com/blog-this.g?u=https://www.tutorialspoint.com/blockchain_online_training/blockchain_a_short_history.asp&amp;n='+ document.title,'sharer','toolbar=0,status=0,width=626,height=656,top='+sTop+',left='+sLeft);return false;">
