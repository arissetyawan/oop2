...
<style>
      .retina, .sub-main-menu .sub-menuu div:hover, .sub-main-menu .viewall, header nav ul.nav-main li a:hover, button.btn-responsive-nav, header div.search button.btn-default{background:#cfb122; color:#fff;}
   .footer-wrapper, div.footer-copyright{background:#cfb122 url(../images/pattern.png)!important; color:#fff;}
   .magnifying-glass{right:5px;}
   .magnifying-glass:hover{background:transparent!important; color:#000!important;}
   h1.logo img{background: #cfb122!important; margin:5px!important;}
   .qa_pop_enroll {background: #cfb122!important;}
   #btnEnroll {background: #cfb122!important; border:none !important;}
   a.clsSection{background:#cfb122 url(../images/pattern.png) repeat center center!important;}
   </style>
<script>
         ...
         <aside class="sidebar sidebar-left" id="sidebar-left">  
            ...
            <div class="vd_enroll_course">
                  ...
                  <div class="qa_pop_enroll">
                     <a href="https://www.tutorialspoint.com/videotutorials/enrolment.php?cid=javascript_online_training&vid=index.asp" style="" ><i class="fa fa-check"></i> Enroll Course</a>               
                  </div>
