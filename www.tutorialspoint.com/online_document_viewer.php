...
<div id="mm5" style="width:200px;">
   ...
   <div class="menu-sep"></div>     
   <div data-options="plain:true, iconCls:'icon-whiteboard'"><a href="http://www.tutorialspoint.com/whiteboard.htm" style="color:#424242;text-decoration:none;" title="Web Collaboration Whiteboard">Whiteboard</a></div>
   <div class="menu-sep"></div>     
   ...
   <div class="menu-sep"></div>
   <div data-options="plain:true, iconCls:'icon-refresh'"><a href="http://www.tutorialspoint.com/online_file_conversion.htm" style="color:#424242;text-decoration:none;">File Conversion</a></div>
   <div class="menu-sep"></div>
...
<div id="center" data-options="region:'center'">
   ...
   <div id="file-drop-area">    
       <div id="file-drop-bg">
         <form action="http://tools.tutorialspoint.com/convert.php"  method="post" enctype="multipart/form-data" id="file-form">
            <img src="/images/download-icon-optim.png" class="download-icon"/>
            <div>Drop files here or click to upload<div class="clear"></div> 
               <span>Open PDF, PS,  MS Office, Visio, Publisher or Image Document</span>
               <div class="max-size">Upload upto <b>1 GB</b> files</div>
            </div>               
         ...
         </form><div class="fa-arrows-h botharrow"></div>
      </div>  
...
<div data-options="region:'west', split:false" style="padding:0px;width:0px" id="left"><!-- STAGE STARTS -->
</div>
...
<div class="simple-ad">
      ...
      <ul>
         <li><a href="/about/tutorials_writing.htm">Write for us</a></li>         <li><a href="/about/faq.htm">FAQ's</a></li>
         <li><a href="/about/about_helping.htm">Helping</a></li>
         <li style="border-right:none;"><a href="/about/contact_us.htm">Contact</a></li>      </ul>
      <div class="cprght">©Copyright 2017. All Rights Reserved.</div>
