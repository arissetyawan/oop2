...
<html lang="en-US" prefix="og: http://ogp.me/ns#">
      ...
      <meta name="Description" content="ReactJS - Components - ReactJS Components -  ReactJS, Introduction, Environment Setup Through NPM, JSX, Getting Started, Components, Multiple Components, Props, Props Validation, Events, States, Components Life Cycle, Forms, Refs, Working with Lists/Collections, Keys, Routing, Flux, Animation, etc."/>
      ...
      <meta property="og:url" content="https://www.tutorialspoint.com/reactjs_online_training/reactjs_components.asp" />
      <meta property="og:title" content="ReactJS - Components" />
      <meta property="og:description" content="ReactJS - Components - ReactJS Components -  ReactJS, Introduction, Environment Setup Through NPM, JSX, Getting Started, Components, Multiple Components, Props, Props Validation, Events, States, Components Life Cycle, Forms, Refs, Working with Lists/Collections, Keys, Routing, Flux, Animation, etc." />
      ...
      <meta name="twitter:description" content="ReactJS - Components - ReactJS Components -  ReactJS, Introduction, Environment Setup Through NPM, JSX, Getting Started, Components, Multiple Components, Props, Props Validation, Events, States, Components Life Cycle, Forms, Refs, Working with Lists/Collections, Keys, Routing, Flux, Animation, etc.">
      ...
      <div class="content">
         <div class="content-wrapper" style="height:auto!important;">
               ...
               <div class="content-body" style="margin:0px;">
                  <div>
                  <h1><span>ReactJS - Components</span></h1>      
                  <hr>
               </div>
               </div>
               ...
               <div class="content-body">
                  ...
                  <br>
                     ...
                     <script>
                       var youtube_id = 'GhUjuKVZ9y8';
                       var vc = 'eVh3K3VUWGRXL3dCWWNQOXRXWUU3QT09';
                       var vl = 'bWdFNEsrTVhtYkcxRkQ5VWJKSWtadz09';
                       var vu = '';
                  ...
                  <div class="options">
                      ...
                      <a href="https://www.tutorialspoint.com/reactjs_online_training/reactjs_getting_started.asp" class="button round accent-color date prevpage">   
                     <i class="fa fa-arrow-circle-o-left big-font"></i> Previous Page
                     </a>                 
                                          <a href="https://www.tutorialspoint.com/reactjs_online_training/reactjs_multiple_components.asp" class="button round accent-color date nextpage">
...
<aside class="sidebar sidebar-right">
      ...
      <a href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.facebook.com/sharer.php?u=' + 'https://www.tutorialspoint.com/reactjs_online_training/reactjs_components.asp','sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/facebookIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://twitter.com/share?url=' + 'https://www.tutorialspoint.com/reactjs_online_training/reactjs_components.asp','sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
      <img src="/images/twitterIcon.jpg" alt="img" />
      </a>
      <a  href="javascript:void(0)" onclick="var sTop = window.screen.height/2-(218); var sLeft = window.screen.width/2-(313);window.open('https://www.linkedin.com/cws/share?url=' + 'https://www.tutorialspoint.com/reactjs_online_training/reactjs_components.asp&amp;title='+ document.title,'sharer','toolbar=0,status=0,width=626,height=456,top='+sTop+',left='+sLeft);return false;">
