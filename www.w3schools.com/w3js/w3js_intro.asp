...
<a class="w3-right w3-button w3-green" href="w3js_selectors.asp">Next &#10095;</a>
</div>
<hr>

<h2>HTML Slideshows</h2>
...
<h2>Sort HTML Elements</h2>
<p>Click on the table headers to sort the table accordingly:</p>
...
<h2>Filter HTML Elements</h2>
<input type="text" id="myInput2" onkeyup="w3.filterHTML('#myUL', 'li', this.value)" placeholder="Search for names.." title="Type in a name">
...
<h2>Hide and Show HTML Elements</h2>
<button class="w3-btn w3-dark-grey" onclick="w3.hide('.city')">Hide Cities</button>
<button class="w3-btn w3-dark-grey" onclick="w3.show('.city')">Show Cities</button>
<button class="w3-btn w3-dark-grey" onclick="w3.toggleShow('.city')">Toggle 
Hide/Show</button>
...
<hr>
<h2>Add Style to HTML Elements</h2>
...
<button class="w3-btn w3-dark-grey" onclick="w3.addClass('.test2','x')">Add 
Class</button>
<button class="w3-btn w3-dark-grey" onclick="w3.removeClass('.test2','x')">
Remove Class</button>
<button class="w3-btn w3-dark-grey" onclick="w3.toggleClass('.test2','x')">
Toggle Class</button>

<div class="w3-row-padding" style="margin:0 -16px">
<div class="w3-half">
<div class="w3-panel w3-border test2">
  <h2>London</h2>
