...
<h1>W3.JS Data Servers</h1>

<div class="w3-clear nextprev">
  <a class="w3-left w3-button w3-green" href="w3js_controllers.asp">&#10094; Previous</a>
  <a class="w3-right w3-button w3-green" href="w3js_w3data.asp">Next &#10095;</a>
</div>
<hr>

<h2>Dynamic Data</h2>
<p>The data used in the previous chapter static data fetched from a server.</p>
<p>The server code for fetching dynamic data from a database can be written in many different languages.</p>
<p>Here are some examples:</p>
  
<hr>
<h2>Server Running PHP and MySQL</h2>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;?php<br>header("Access-Control-Allow-Origin: *");<br>header("Content-Type: 
application/json; charset=UTF-8");<br><br>$conn = 
new mysqli("myServer", "user", "pass", "myDB");<br><br>$result = $conn-&gt;query("SELECT 
CompanyName, City, Country FROM Customers");<br><br>$outp = "";<br>
while($rs = $result-&gt;fetch_array(MYSQLI_ASSOC)) {<br>&nbsp;&nbsp;&nbsp; 
if ($outp != "") {$outp .= ",";}<br>&nbsp;&nbsp;&nbsp; $outp .= '{"Name":"'&nbsp; . $rs["CompanyName"] . '",';<br>&nbsp;&nbsp;&nbsp; $outp .= '"City":"'&nbsp;&nbsp; . $rs["City"]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; . '",';<br>&nbsp;&nbsp;&nbsp; $outp .= '"Country":"'. $rs["Country"]&nbsp;&nbsp;&nbsp;&nbsp; . '"}';
<br>}<br>
$outp ='{"customers":['.$outp.']}';<br><br>$conn-&gt;close();<br><br>echo($outp);<br>?&gt;</div>
</div>
  
<hr>
<h2>Cross-Site HTTP Requests</h2>
<p>Requests for data from a different server (other than the requesting page), are 
called <strong>cross-site</strong> HTTP requests.</p>
<p>Cross-site requests are common on the web. Many pages load css, images, 
or scripts from different servers.</p>
<p>However, in modern browsers, HTTP requests <strong>from scripts</strong> 
are restricted to the <strong>same site</strong> for security reasons.</p>
<p>The following line (in the PHP example above) allows access 
to the page from a cross-site:</p>
...
<h2>Server Running Node.js and MySQL</h2>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
var express = require('express');<br>var app = express();<br><br>app.get('/', 
function (req, res) {<br>&nbsp; var sql = require(&quot;mssql&quot;);<br>&nbsp; var config = {user:'user', password:'pass',
server:'myServer', database:'myDB'};<br>&nbsp; sql.connect(config, function (err) {<br>&nbsp;&nbsp;&nbsp; if (err) 
console.log(err);<br>&nbsp;&nbsp;&nbsp; var request = new 
sql.Request();<br>&nbsp;&nbsp;&nbsp;
request.query('SELECT CompanyName, City, Country FROM Customers', function (err, recordset) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if 
(err) console.log(err)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; res.send(recordset);<br>
&nbsp;&nbsp;&nbsp; });<br>&nbsp; });<br>});<br><br>var server = app.listen(5000, function () {<br>
console.log('Server is running..');<br>});</div>
</div>

<hr>
<h2>Server Running ASP.NET, Razor and SQL Lite</h2>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
@{<br>Response.AppendHeader("Access-Control-Allow-Origin", "*")<br>Response.AppendHeader("Content-type", 
 "application/json")<br>var db = 
Database.Open("myDB");<br>var query = db.Query("SELECT CompanyName, 
City, Country FROM Customers");<br>var outp =""<br>var
c = chr(34)<br>}<br><br>@foreach(var row in 
...
<hr>
<h2>Server Running PHP and MS Access</h2>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;?php<br>header("Access-Control-Allow-Origin: *");<br>header("Content-Type: 
 application/json; charset=ISO-8859-1");<br><br>$conn = new COM("ADODB.Connection");<br>
$conn-&gt;open("PROVIDER=Microsoft.Jet.OLEDB.4.0;Data Source=myDB.mdb");<br>
<br>$rs = $conn-&gt;execute("SELECT CompanyName, City, Country FROM 
Customers");<br><br>$outp = "";<br>while (!$rs-&gt;EOF) {<br>&nbsp;&nbsp;&nbsp; 
if ($outp != "") {$outp .= ",";}<br>&nbsp;&nbsp;&nbsp; $outp .= '{"Name":"'&nbsp; . $rs["CompanyName"] . '",';<br>&nbsp;&nbsp;&nbsp; $outp .= '"City":"'&nbsp;&nbsp; . $rs["City"]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; . '",';<br>&nbsp;&nbsp;&nbsp; $outp .= '"Country":"'. $rs["Country"]&nbsp;&nbsp;&nbsp;&nbsp; . '"}';
<br>&nbsp;&nbsp;&nbsp; $rs-&gt;MoveNext();<br>}<br>$outp ='{"customers":['.$outp.']}';<br><br>
$conn-&gt;close();<br>echo ($outp);<br>?&gt;</div>
</div>
<hr>
<h2>Server Running ASP.NET, VB and MS Access</h2>

<div class="w3-example">
<div class="w3-code notranslate jsHigh">
&lt;%@ Import Namespace="System.IO"%&gt;<br>&lt;%@ Import Namespace="System.Data"%&gt;<br>
&lt;%@ Import Namespace="System.Data.OleDb"%&gt;<br><br>&lt;%<br>
Response.AppendHeader("Access-Control-Allow-Origin", "*")<br>Response.AppendHeader("Content-type", 
 "application/json")<br><br>Dim conn As 
...
Dim outp<br>Dim c<br><br>conn = New OledbConnection("Provider=Microsoft.Jet.OLEDB.4.0;data 
source=myDB.mdb")<br>objAdapter = New OledbDataAdapter("SELECT 
...
&amp; c &amp; ","<br>outp = outp &amp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; c &amp; "City"&nbsp;&nbsp;&nbsp; &amp; c &amp; ":" &amp; c 
&amp; x("City")&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &amp; c &amp; ","<br>outp = outp &amp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; c &amp; "Country" &amp; c 
&amp; ":" &amp; c &amp; x("Country")&nbsp;&nbsp;&nbsp;&nbsp; &amp; c &amp; "}"<br>next<br>outp 
 ="{" &amp; c &amp; "customers" &amp; c &amp; ":[" &amp; outp &amp; "]}"<br><br>conn.close<br>response.write(outp)<br>%&gt;</div>
</div>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-button w3-green" href="w3js_controllers.asp">&#10094; Previous</a>
