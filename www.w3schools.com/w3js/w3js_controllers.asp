...
<h1>W3.JS Controllers</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-button w3-green" href="w3js_http.asp">&#10094; Previous</a>
<a class="w3-right w3-button w3-green" href="w3js_servers.asp">Next &#10095;</a>
</div>

<hr>
<h2>What is a Controller?</h2>
<p>A controller is a function you write to control your data.</p>
<p>With a self-written controller, you can modify data anyway you want:</p>
<ul class="w3.ul">
<li>Convert to upper case</li>
<li>Convert currencies</li>
<li>Calculate and Summarize</li>
 <li>Round values</li>
 <li>Substitute values</li>
<li>Change colors according to values</li>
 <li>Anything else you are able to program</li>
</ul>

<hr>
<h2>Controller Example 1</h2>
<p>You want to convert your data to upper case before display.</p>
<div class="w3-example">
<h3>Convert to Upper Case</h3>
<div class="w3-code notranslate jsHigh">
&lt;script&gt;<br>w3.getHttpObject(&quot;customers.js&quot;, myFunction);<br><br>
function myFunction(myObject) {<br>&nbsp;&nbsp;&nbsp; var i;<br>&nbsp;&nbsp;&nbsp; 
var myArray = myObject.customers;<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; 
myArray.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myArray[i][&quot;CustomerName&quot;] 
=<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myArray[i][&quot;CustomerName&quot;].toUpperCase();<br>&nbsp;&nbsp;&nbsp; 
}<br>&nbsp;&nbsp;&nbsp; w3.displayObject(&quot;id01&quot;, myObject);<br>}<br>&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js_controllers_list" target="_blank">Try It Yourself &raquo;</a>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js_controllers_list_style" target="_blank">With CSS &raquo;</a>
</div>
<hr>
<h2>Controller Example 2</h2>
<div class="w3-example">
<h3>Summarize Price</h3>
<div class="w3-code notranslate jsHigh">
  &lt;script&gt;<br>w3.getHttpObject(&quot;cd_catalog.js&quot;, myFunction);<br><br>function 
  myFunction(myObject) {<br>&nbsp;&nbsp;&nbsp; var i, total = 0;<br>&nbsp;&nbsp;&nbsp; 
  var myArray = myObject.cd;<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; 
  myArray.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; total += 
  Number(myArray[i].price);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
  myObject.total = total.toFixed(2);<br>&nbsp;&nbsp;&nbsp; 
  w3.displayObject(&quot;id01&quot;, myObject);<br>}<br>&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js_controllers_table" target="_blank">Try It Yourself &raquo;</a>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js_controllers_table_style" target="_blank">With CSS &raquo;</a>
</div>
