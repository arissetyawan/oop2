...
<h1>W3.JS References</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-button w3-green" href="w3js_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-button w3-green" href="w3js_downloads.asp">Next &#10095;</a>
</div>

<hr>
<h2>Complete W3.JS API Reference</h2>

<table class="w3-table-all">
<tr>
<th>Function</th>
<th>Description</th>
<th class="w3-right">Example</th>
</tr>
<tr>
<td>w3.hide</td>
<td>Hides HTML elements</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_hide_show">Try it</a></td>
</tr>
<tr>
<td>w3.show</td>
<td>Shows HTML elements</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_hide_show">Try it</a></td>
</tr>
<tr>
<td>w3.toggleShow</td>
<td>Toggles between hiding and showing HTML elements</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_toggle_show">Try it</a></td>
</tr>
<tr>
<td>w3.toggleClass</td>
<td>Toggles the class of HTML elements</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_toggle_class">Try it</a></td>
</tr>
<tr>
<td>w3.addClass</td>
<td>Adds one or multiple classes to HTML elements</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_add_class">Try it</a></td>
</tr>
<tr>
<td>w3.addStyle</td>
<td>Adds style to HTML elements</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_add_style">Try it</a></td>
</tr>
<tr>
<td>w3.removeClass</td>
<td>Removes one or multiple classes from HTML elements</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_remove_class">Try it</a></td>
</tr>
<tr>
<td>w3.filterHTML</td>
<td>Filters the display of HTML elements</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_filter_html">Try it</a></td>
</tr>
<tr>
<td>w3.sortHTML</td>
<td>Sorts the display of HTML elements</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_sort_html">Try it</a></td>
</tr>
<tr>
<td>w3.slideshow</td>
<td>Make HTML elements display as a slideshow</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_slideshow">Try it</a></td>
</tr>
<tr>
<td>w3.displayObject</td>
<td>Displays JavaScript objects in HTML</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_display_object">Try it</a></td>
</tr>
<tr>
<td>w3.includeHTML</td>
<td>Displays HTML in HTML</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_include_html">Try it</a></td>
</tr>
<tr>
<td>w3.getHttpObject</td>
<td>Reads JSON data from a server</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_http">Try it</a></td>
</tr>
<tr>
<td>w3.getHttpData</td>
<td>Reads data from a server</td>
<td>&nbsp;</td>
</tr>
</table>

<hr>
<h2>Complete W3.JS Attribute Reference</h2>
...
<tr>
<td>{{ }}</td>
<td>Defines where to display data</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_display_object">Try it</a></td>
</tr>
<tr>
<td>w3-repeat</td>
<td>Defines where to repeat data</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_repeat">Try it</a></td>
</tr>
<tr>
<td>w3-include-HTML</td>
<td>Defines where to include HTML</td>
<td><a class="w3-btn" target="_blank" href="tryit.asp?filename=tryw3js_ref_include_html">Try it</a></td>
</tr>
</table>


<br><div class="w3-clear nextprev">
<a class="w3-left w3-button w3-green" href="w3js_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-button w3-green" href="w3js_downloads.asp">Next &#10095;</a>
</div>
</div>
