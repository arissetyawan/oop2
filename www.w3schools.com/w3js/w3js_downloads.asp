...
<h1>W3.JS Downloads</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-button w3-green" href="w3js_references.asp">&#10094; Previous</a>
<a class="w3-right w3-button w3-green" href="default.asp">Next &#10095;</a>
</div>
<div class="w3-theme w3-center w3-margin-top w3-padding-16">
<h2>How To Download and Use W3.JS</h2>
</div>

<hr>
<h2>Download W3.JS</h2>
<p>Download the latest version from this link:
<strong><a href="https://www.w3schools.com/lib/w3.js" target="_blank">
https://www.w3schools.com/lib/w3.js</a></strong></p>

<hr>
<h2>W3.JS is Free</h2>
<p>W3.JS is free to use. No license is necessary.</p>
<hr>
<h2>How To use W3.JS</h2>
<p>To use W3.JS, just add a link to &quot;w3.js&quot; in your web pages:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;title&gt;My Web&lt;/title&gt;<br><br>
<strong>&lt;script src="https://www.w3schools.com/lib/w3.js"&gt;&lt;/script&gt;</strong></div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js" target="_blank">Try It Yourself &raquo;</a>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js_style" target="_blank">With CSS &raquo;</a>
</div>

<p>Or download w3.js and run it from your own web site:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;title&gt;My Web&lt;/title&gt;<br>
<strong><br>&lt;script src="w3.js"&gt;&lt;/script&gt;</strong>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js_local" target="_blank">Try It Yourself &raquo;</a>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js_local_style" target="_blank">With CSS &raquo;</a>
</div>

<p>If you put w3.js in a subfolder, add the folder name between slashes:</p>
<div class="w3-example">
 <h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
  &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;title&gt;My Web&lt;/title&gt;<br><br>
  <strong>&lt;script src="/<em>foldername</em>/w3.js"&gt;&lt;/script&gt;</strong></div>
</div>

<p>If you place w3.js at the root of your web, add a slash:</p>
<div class="w3-example">
 <h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
  &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;title&gt;My Web&lt;/title&gt;<br><br>
  <strong>&lt;script src="/w3.js"&gt;&lt;/script&gt;</strong></div>
 <br>
</div>

<hr>
<h2>Changelog (Latest Versions)</h2>
<table class="w3-table w3-bordered w3-striped w3-border">
 <tr>
  ...
  <tr>
  <td style="width: 15%">1.03</td>
  <td>HTML Include now continues to the next include when the page is not found.</td>
  </tr>
  <tr>
  <td style="width: 15%">1.01</td>
  <td>Added slideshow.</td>
  </tr>
 <tr>
  <td style="width: 15%">1.0</td>
  <td>January 2018.</td>
 </tr>
</table>
