...
<h1>W3.JS Tutorial</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-button w3-green" href="/default.asp">&#10094; Previous</a>
<a class="w3-right w3-button w3-green" href="w3js_intro.asp">Next &#10095;</a>
</div>
<hr>

<p>W3.JS is a JavaScript library designed to simplify web development projects:</p>

<div class="w3-panel w3-info intro">
<p>Easy to learn and easy to use.</p>
<p>Designed for fast application development.</p>
<p>Designed for all devices: PC, Tablet, and Mobile.</p>
<p>Free to use. No licenses.</p>
</div>

<hr>

<h2>What Can W3.JS Do?</h2>
<p>Below is a list of the some of the things W3.JS can do:</p>
<ul class="w3-ul w3-border">
<li><a href="w3js_slideshow.asp">Run HTML Slideshows</a></li>
<li><a href="w3js_html_include.asp">Include (Import) HTML in HTML</a></li>
<li><a href="w3js_sort.asp">Sort the Content of any HTML Element</a></li>
<li><a href="w3js_filters.asp">Filter the Content of any HTML Element</a></li>
<li><a href="w3js_display.asp">Display JavaScript Objects in HTML</a></li>
<li><a href="w3js_http.asp">Read Data from Web Servers (Http Request)</a></li>
<li><a href="w3js_hide.asp">Hide or Show any HTML Element</a></li>
<li><a href="w3js_add_class.asp">Add or Remove Classes on any HTML Element</a></li>
<li><a href="w3js_add_style.asp">Add CSS to any HTML Element</a></li></ul>
<hr>

<h2>W3.JS Examples</h2>
<p>At the end of the W3.JS tutorial, you can find more than 100 examples.</p>
<p>With our online editor, you can edit and test each example yourself.</p>
<p><a href="w3js_examples.asp">Go to W3.JS Examples!</a></p>
<hr>

<h2>W3.JS References</h2>
<p>In this tutorial you will also find a complete W3.JS reference about  
all functions and attributes.</p>
<p><a href="w3js_referenses.asp">W3.JS References</a></p>
<hr>

<h2>How To</h2>
<p>W3.JS is very easy to use.</p>
<p>Just add a link to <strong>w3.js</strong> in your web page:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script src="https://www.w3schools.com/lib/w3.js"&gt;&lt;/script&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js" target="_blank">Try It Yourself »</a>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js_style" target="_blank">With CSS »</a>
</div>
<p>Or download <a href="https://www.w3schools.com/lib/w3.js" target="_blank">
w3.js</a> and add a link to the file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script src="w3.js"&gt;&lt;/script&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js_local" target="_blank">Try It Yourself »</a>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryw3js_local_style" target="_blank">With CSS »</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-button w3-green" href="/default.asp">&#10094; Previous</a>
