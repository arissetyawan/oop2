...
<h1>W3.JS Selectors</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-button w3-green" href="w3js_intro.asp">&#10094; Previous</a>
<a class="w3-right w3-button w3-green" href="w3js_hide.asp">Next &#10095;</a>
</div>
<hr>
<h2>W3.JS Selectors</h2>
<p>W3.JS <strong>selects</strong> HTML elements and perform <strong>actions</strong> on the selected element(s):</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
  w3.<em>action</em>(<em>selector</em>)
</div>
</div>

<ul>
<li>The <em>action</em>() is performed on the selected element(s)</li>
<li>The (<em>selector</em>) selects the HTML element(s)</li>
</ul>
<div class="w3-example">
<p>Example</p>
<div class="w3-code notranslate jsHigh">
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_hide_p" target="_blank">Try It Yourself &raquo;</a>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_hide_p_style" target="_blank">With CSS &raquo;</a>
</p>
</div>

<div class="w3-panel w3-note">
<p><b>Are you familiar with CSS selectors?</b><br><br>
W3.JS uses the CSS syntax to select and manipulate HTML elements.</p>
<p>Selectors are used to &quot;find&quot; (select) HTML elements based on their tag name, 
id, classes, types, attributes, values of attributes and much more. A list of 
all selectors can be found in our <a href="/cssref/css_selectors.asp">CSS Selector 
Reference</a>.</p></div>
<hr>
<h2>Selector Examples</h2>
<p>To select HTML elements, use a tag name:</p>
<div class="w3-example">
<p>Hide all &lt;h2&gt; elements:</p>
<div class="w3-code notranslate jsHigh">
  w3.hide('h2')</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_hide_tag" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<p>To select an element with a specific id, write a hash character, followed by the id of the HTML element:</p>
<div class="w3-example">
<p>Hide an element with id="London":</p>
<div class="w3-code notranslate jsHigh">
  w3.hide('#London')</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_hide_id" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<p>To select elements with a specific class, write a period character, followed by the name of the class:</p>
<div class="w3-example">
<p>Hide all elements with class="city":</p>
<div class="w3-code notranslate jsHigh">
  w3.hide('.city')</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_hide_class" target="_blank">Try It Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>More Selector Examples</h2>
...
<td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_all">Try it</a></td>
</tr>
<tr>
<td>(this)</td>
<td>Selects the current HTML element</td>
<td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_this">Try it</a></td>
</tr>
<tr>
<td>(&quot;p.intro&quot;)</td>
<td>Selects all &lt;p&gt; elements with class=&quot;intro&quot;</td>
<td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_p_intro">Try it</a></td>
</tr>
<tr>
<td>(&quot;div p&quot;)</td>
<td>Selects all &lt;p&gt; element inside all &lt;div&gt; elements</td>
<td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_div_p">Try it</a></td>
</tr>
<tr>
<td>(&quot;div p:first-child&quot;)</td>
<td>Selects the first &lt;p&gt; element inside all &lt;div&gt; elements</td>
<td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_p_first">Try it</a></td>
</tr>
<tr>
<td>(&quot;[href]&quot;)</td>
<td>Selects all elements with an href attribute</td>
<td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_href">Try it</a></td>
</tr>
<tr>
<td>(&quot;a[target=_blank]&quot;)</td>
<td>Selects all &lt;a&gt; elements with a target attribute value equal to "_blank"</td>
<td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_a_target">Try it</a></td>
</tr>
<tr>
<td>(&quot;p:nth-child(even)&quot;)</td>
<td>Selects all even &lt;p&gt; elements</td>
<td><a target="_blank" class="w3-btn" href="tryit.asp?filename=tryw3js_selectors_even">Try it</a></td>
</tr>
</table>
</div>
<p>For a complete reference of all CSS selectors, please go to our <a href="/cssref/css_selectors.asp">CSS Selectors Reference</a>.</p>
