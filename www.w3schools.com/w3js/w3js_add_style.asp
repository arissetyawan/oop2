...
<h1>W3.JS Add Style to HTML</h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-button w3-green" href="w3js_hide.asp">&#10094; Previous</a>
  <a class="w3-right w3-button w3-green" href="w3js_add_class.asp">Next &#10095;</a>
</div>
<hr>
<div class="w3-example">
<p>Add a CSS property value:</p>
<div class="w3-code notranslate jsHigh">
  w3.addStyle(<em>selector</em>,'<em>property</em>','<em>value</em>')
</div>
</div>
<hr>

<h2>Add Style by Id</h2>
<p>Add a red background color to an element with id="London":</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button onclick=&quot;w3.addStyle('#London','background-color','red')&quot;&gt;Add Style&lt;/button&gt;</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_add_style_id" target="_blank">Try It Yourself &raquo;</a>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_add_style_id_style" target="_blank">With CSS &raquo;</a>
</p>
</div>

<hr>
<h2>Add Style by Tag</h2>
<p>Add a red background color to all &lt;h2&gt; elements:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button onclick=&quot;w3.addStyle('h2','background-color','red')&quot;&gt;Add Style&lt;/button&gt;</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_add_style_tag" target="_blank">Try It Yourself &raquo;</a>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_add_style_tag_style" target="_blank">With CSS &raquo;</a>
</p>
</div>

<hr>
<h2>Add Style by Class</h2>
<p>Add a red background color to all elements with class="city":</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button onclick=&quot;w3.addStyle('.city','background-color','red')&quot;&gt;Add Style&lt;/button&gt;</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_add_style_class" target="_blank">Try It Yourself &raquo;</a>
<a class="w3-btn" href="tryit.asp?filename=tryw3js_add_style_class_style" target="_blank">With CSS &raquo;</a>
</p>
</div>
