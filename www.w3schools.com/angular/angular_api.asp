...
<a class="w3-left w3-btn" href="angular_validation.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="angular_w3css.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">API stands for <strong>A</strong>pplication 
<strong>P</strong>rogramming <strong>I</strong>nterface.</p>

<hr>
<h2>AngularJS Global API</h2>
<p>The AngularJS Global API is a set of global JavaScript functions for 
...
<p>The Global API functions are accessed using the angular object.</p>

<p>Below is a list of some common API functions:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_api_lowercase" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_api_uppercase" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_api_isstring" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_api_isnumber" target="_blank">Try it Yourself &raquo;</a>
</div>
