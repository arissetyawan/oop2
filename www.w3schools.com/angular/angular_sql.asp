...
<a class="w3-left w3-btn" href="angular_select.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="angular_htmldom.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">
...
app.controller('customersCtrl', function($scope, $http) {<br>
&nbsp;&nbsp;&nbsp; $http.get("customers_mysql.php")<br>
&nbsp;&nbsp;&nbsp; .then(function (response) {$scope.names = response.data.records;});<br>
});<br>
&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_customers_mysql" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
var app = angular.module('myApp', []);<br>
app.controller('customersCtrl', function($scope, $http) {<br>
&nbsp;&nbsp;&nbsp; $http.get("customers_sql.aspx")<br>
&nbsp;&nbsp;&nbsp; .then(function (response) {$scope.names = response.data.records;});<br>
});<br>
&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_customers_sql" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Requests for data from a different server (than the requesting page), are 
called <strong>cross-site</strong> HTTP requests.</p>
<p>Cross-site requests are common on the web. Many pages load CSS, images, 
and scripts from different servers.</p>
<p>In modern browsers, cross-site HTTP requests <strong>from scripts</strong> 
are restricted to <strong>same site</strong> for security reasons.</p>
...
<br>
$conn = new mysqli("myServer", "myUser", "myPassword", "Northwind");<br>
<br>
$result = $conn-&gt;query("SELECT CompanyName, City, Country FROM Customers");<br>
<br>
$outp = "";<br>
...
Dim outp<br>
Dim c<br>
conn = New OledbConnection("Provider=Microsoft.Jet.OLEDB.4.0;data source=Northwind.mdb")<br>
