...
<a class="w3-left w3-btn" href="angular_databinding.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="angular_scopes.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">AngularJS controllers <strong>control the data</strong> of AngularJS 
applications.</p>
...
<p>The <strong>ng-controller</strong> 
directive defines the application controller. </p>
<p>A controller is a <strong>JavaScript Object</strong>, created by a standard JavaScript <strong>object constructor</strong>.</p>
...
<div class="w3-code notranslate htmlHigh">
    ...
    <br>&lt;/div&gt;<br><br>&lt;script&gt;<br>var app = angular.module('myApp', 
    []);<br>app.controller('myCtrl', function($scope) {<br>&nbsp;&nbsp;&nbsp; $scope.firstName 
    = &quot;John&quot;;<br>&nbsp;&nbsp;&nbsp; $scope.lastName = &quot;Doe&quot;;<br>});<br>&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_controller" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Application explained:</p>
<p>The AngularJS application is defined by&nbsp; <strong>ng-app=&quot;myApp&quot;</strong>. The application 
runs inside the &lt;div&gt;.</p>
<p>The <strong>ng-controller=&quot;myCtrl&quot;</strong> attribute is an AngularJS directive. 
It defines a 
controller.</p>
<p>The <strong>myCtrl</strong> function is a JavaScript function.</p>
<p>AngularJS will invoke the controller with a <strong>$scope</strong> object.</p>
<p>In AngularJS, $scope is the application object (the owner of application 
variables and functions).</p>
<p>The controller creates two properties (variables) in the scope 
(<strong>firstName</strong> and
<strong>lastName</strong>).</p>
<p>The <strong>ng-model</strong> directives bind the input fields to  
the controller properties (firstName and lastName).</p>
<hr>
...
<p>The example above demonstrated a controller object with two properties: lastName and firstName.</p>
<p>A controller can also have methods (variables as functions):</p>
<div class="w3-example">
<h3>AngularJS Example</h3>
<div class="w3-code notranslate htmlHigh">
...
&lt;/div&gt;<br><br>
&lt;script&gt;<br>var app = angular.module('myApp', []);<br>app.controller('personCtrl', 
 function($scope) {<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_controller_property" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Controllers In External Files</h2>
<p>In larger applications, it is common to store controllers in 
external files.</p>
<p>Just copy the code between the &lt;script&gt; tags into an external file named 
<a href="personController.js" target="_blank">personController.js</a>:</p>
<div class="w3-example">
<h3>AngularJS Example</h3>
<div class="w3-code notranslate htmlHigh">
    &lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;personCtrl&quot;&gt;<br>
    <br>First Name: &lt;input type=&quot;text&quot; ng-model=&quot;firstName&quot;&gt;&lt;br&gt;<br>
    Last Name: &lt;input type=&quot;text&quot; ng-model=&quot;lastName&quot;&gt;&lt;br&gt;<br>&lt;br&gt;<br>
    Full Name: {{fullName()}}<br>
    <br>&lt;/div&gt;<br><br>&lt;script src=&quot;personController.js&quot;&gt;&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_controller_js" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Another Example</h2>
<p>For the next example we will create a new controller file:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
...
<p>Save the file as&nbsp; <a href="namesController.js" target="_blank">namesController.js</a>:</p>


<p>And then use the controller file in an application:</p>
<div class="w3-example">
<h3>AngularJS Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_controller_names" target="_blank">Try it Yourself &raquo;</a>
</div>
