...
<a class="w3-left w3-btn" href="angular_w3css.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="angular_animations.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">With AngularJS, you can include HTML from an external file.</p>

<hr>

<h2>AngularJS Includes</h2>
<p>With AngularJS, you can include HTML content using the <strong>ng-include</strong> 
directive:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
    &lt;body ng-app=&quot;&quot;&gt;<br><br>&lt;div ng-include=&quot;'myFile.htm'&quot;&gt;&lt;/div&gt;<br><br>
    &lt;/body&gt; </div>
    <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_include" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Include AngularJS Code</h2>
<p>The HTML files you include with the ng-include directive, can also contain 
AngularJS code:</p>
<div class="w3-example">
<h3>myTable.htm:</h3>
<div class="w3-code notranslate htmlHigh">
    &lt;table&gt;<br>&lt;tr ng-repeat=&quot;x in 
    names&quot;&gt;<br>&lt;td&gt;{{ x.Name }}&lt;/td&gt;<br>&lt;td&gt;{{ x.Country }}&lt;/td&gt;<br>&lt;/tr&gt;<br>
    &lt;/table&gt;<br></div>
</div>
<p>Include the file "myTable.htm" in your web page, and all AngularJS code will be 
executed, even the code inside the included file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate">
<div class="htmlHigh">
    &lt;body&gt;<br><br>&lt;div ng-app=&quot;myApp&quot; ng-controller=&quot;customersCtrl&quot;&gt; <br>&nbsp; 
    &lt;div ng-include=&quot;'myTable.htm'&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;script&gt;</div>
<div class="jsHigh">
var app = angular.module('myApp', []);<br>
    app.controller('customersCtrl', function($scope, $http) {<br>&nbsp;&nbsp;&nbsp; $http.get(&quot;customers.php&quot;).then(function (response) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $scope.names = response.data.records;<br>&nbsp;&nbsp;&nbsp; });<br>});<br></div>
<div class="htmlHigh">    
    &lt;/script&gt;</div></div>
    <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_include_table" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>To include files from another domain, you can add a whitelist of legal files 
and/or domains in the config function of your application:</p>
<div class="w3-example">
<h3>Example:</h3>
<div class="w3-code notranslate">
<div class="htmlHigh">
    &lt;body ng-app=&quot;myApp&quot;&gt;<br><br>&lt;div ng-include=&quot;'https://tryit.w3schools.com/angular_include.php'&quot;&gt;&lt;/div&gt;<br>
    <br>&lt;script&gt;</div>
<div class="jsHigh">var app = angular.module('myApp', [])<br>app.config(function($sceDelegateProvider) 
    {<br>&nbsp;&nbsp;&nbsp; $sceDelegateProvider.resourceUrlWhitelist([<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 'https://tryit.w3schools.com/**'<br>&nbsp;&nbsp;&nbsp; 
    ]);<br>});<br></div>
<div class="htmlHigh">&lt;/script&gt;<br><br>&lt;/body&gt;<br></div></div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_ng_include_crossdomain" target="_blank">Try it Yourself &raquo;</a>
</div>
