...
<div class="w3-code notranslate htmlHigh">
    &lt;button ondblclick=&quot;myFunction()&quot;&gt;Double-click me&lt;/button&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_ondblclick">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Double-click on a &lt;p&gt; element to change its text color to red:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;p id=&quot;demo&quot; ondblclick=&quot;myFunction()&quot;&gt;Double-click me to change my text color.&lt;/p&gt;<br>
 <br>&lt;script&gt;<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).style.color = &quot;red&quot;;<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_ondblclick2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Double-click on a button to copy some text from an input field to another input 
field:</p>
<div class="w3-code notranslate htmlHigh">
    &lt;button ondblclick=&quot;myFunction()&quot;&gt;Copy Text&lt;/button&gt;<br>
 <br>&lt;script&gt;<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;field2&quot;).value = document.getElementById(&quot;field1&quot;).value;<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_ondblclick3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/event_ondblclick.asp">ondblclick event</a></p>
<br>
