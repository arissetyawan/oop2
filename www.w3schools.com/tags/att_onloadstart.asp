...
<html lang="en-US">
<head>
<title>HTML onloadstart Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onloadstart</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_onloadedmetadata.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_onmousedown.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onloadstart event occurs when the browser starts looking for the specified audio/video. 
This is when the loading process starts.</p>
<p>During the loading process of an audio/video, the following events occur, in 
this order:</p>
<ol>
  <li>loadstart</li>
  <li><a href="att_ondurationchange.asp">durationchange</a></li>
  <li><a href="att_onloadedmetadata.asp">loadedmetadata</a></li>
  <li><a href="att_onloadeddata.asp">loadeddata</a></li>
  <li><a href="att_onprogress.asp">progress</a></li>
  <li><a href="att_oncanplay.asp">canplay</a></li>
  <li><a href="att_oncanplaythrough.asp">canplaythrough</a></li>
</ol>
<hr>
<h2>Applies to</h2>
<p>The onloadstart attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on the following elements:</p>
...
<h3>Audio Example</h3>
<p>Run &quot;myFunction&quot; when the data starts to load:</p>
<div class="w3-code notranslate htmlHigh">
    &lt;audio onloadstart=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_att_onloadstart_audio" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<p>Run &quot;myFunction&quot; when the data starts to load:</p>
<div class="w3-code notranslate htmlHigh">
    &lt;video onloadstart=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_att_onloadstart" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">onloadstart</code> attribute has the following browser support for each element:</p>
