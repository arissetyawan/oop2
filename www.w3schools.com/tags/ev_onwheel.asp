...
<h1>HTML <span class="color_h1">onwheel</span> Event Attribute</h1>
...
<div class="w3-code notranslate htmlHigh">
 &lt;div onwheel=&quot;myFunction()&quot;&gt;Roll the mouse wheel over me&lt;/div&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_onwheel">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onwheel attribute fires when the wheel of a pointing device is rolled 
up or down over an element.</p>
<p>The onwheel attribute also fires when the user scrolls or zooms on an 
...
<p>The onwheel attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
    &lt;<i>element</i> onwheel=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onwheel</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/event_onwheel.asp">onwheel event</a></p>
<br>
