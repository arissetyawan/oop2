...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_createlineargradient" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="browserref notranslate">
  <tr>
    <th style="width:20%;text-align:left;" class="auto-style1">Method</th>
    ...
    <td style="text-align:left;">addColorStop()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>stop</i></td>
    <td>A value between 0.0 and 1.0 that represents the position between  start and end in a gradient</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_addcolorstop">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>color</i></td>
...
<a class="w3-btn w3-margin-bottom" target="_blank" href="tryit.asp?filename=tryhtml5_canvas_addcolorstop_multiple">Try it Yourself &raquo;</a>
</div>
<hr>
