...
<h1>HTTP <span class="color_h1">Request Methods</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_httpmessages.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_pxtoemconversion.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The two most common HTTP methods are: GET and POST.</p>
<hr>
...
<p><strong>GET is used to request data from a specified 
resource.</strong></p>

<p><strong>GET is one of the most common HTTP methods. </strong></p>
...
<p class="intro"><strong>POST is used to send data to a server to create/update a resource.</strong></p>
...
<p><strong>POST is one of the most common HTTP methods. </strong></p>
...
<p><strong>PUT is used to send data to a server to create/update a resource.</strong></p>
...
<p><strong>HEAD is almost identical to GET, but without the response body.</strong></p>
...
<p><strong>The DELETE method deletes the specified resource.</strong></p>
<hr>

<h2>The OPTIONS Method</h2>
<p><strong>The OPTIONS method describes the communication options for the target 
resource.</strong></p>
<hr>
