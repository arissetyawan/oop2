...
<hr>
<p class="intro">The tool below allows you to work out the em sizes from pixels 
(or vice versa).</p>
<hr>

<h2>Pixel to Em Converter</h2>
<ul>
  <li>Set a default pixel size for body (usually 16px)</li>
...
<p class="clearfix"></p>
 <button class="btn btn-lg w3-green" onclick="myFunction()"><span class="glyphicon glyphicon-transfer"> </span> Convert</button>
<hr>
...
Look at <a href="/cssref/css_units.asp">CSS Units</a> for more 
measurement units.</p>
</div>
