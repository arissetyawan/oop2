...
<html lang="en-US">
<head>
<title>HTML onbeforeunload Event Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onbeforeunload</span> Event Attribute</h1>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_onbeforeunload">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onbeforeunload event fires when the document is about to be unloaded. </p>
<p>This event allows you to display a message in a confirmation dialog box to 
inform the user whether he/she wants to stay or leave the current page.</p>
...
sure you want to leave this page?&quot;. You cannot remove this message.</p>
...
<div class="w3-code w3-border notranslate"><div>
    &lt;<i>element</i> onbeforeunload=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onbeforeunload</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/event_onbeforeunload.asp">onbeforeunload event</a></p>
<br>
