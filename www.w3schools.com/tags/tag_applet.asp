...
<a class="w3-left w3-btn" href="tag_address.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_area.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p><span class="deprecated">The &lt;applet&gt; tag is not supported in HTML5. Use 
<a href="tag_embed.asp">&lt;embed&gt;</a> or <a href="tag_object.asp">&lt;object&gt;</a> instead.</span></p>
...
<p><strong>Note:</strong> The &lt;applet&gt; tag is supported in Internet 
Explorer 11 and earlier versions, using a plug-in.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>object</td>
    <td><i>name</i></td>
    <td>Specifies a reference to a serialized representation of an applet</td>
    </tr>
  </table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    middle<br>
    baseline</td>
    <td>Specifies the alignment of an applet according to surrounding elements</td>
  </tr>
  <tr>
    <td>alt</td>
    <td><i>text</i></td>
  ...
  <tr>
    <td>codebase</td>
    <td><i>URL</i></td>
    <td>Specifies a relative base URL for applets specified in the code attribute</td>
  </tr>
    <tr>
    <td>height</td>
    <td><i>pixels</i></td>
