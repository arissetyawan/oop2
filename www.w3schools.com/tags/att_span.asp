...
<html lang="en-US">
<head>
<title>HTML span Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">span</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_sizes.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_spellcheck.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The span attribute defines the number of columns a &lt;col&gt;/&lt;colgroup&gt; element should span.</p>
<hr>

<h2>Applies to</h2>
<p>The span attribute can be used on the following elements:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_col_test">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">

<h3>Colgroup Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_colgroup_span">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">span</code> attribute has the following browser support for each element:</p>
