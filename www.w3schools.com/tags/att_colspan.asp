...
<h1>HTML <span class="color_h1">colspan</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_cols.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_content.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The colspan attribute defines the number of columns a table cell should span.</p>
<hr>
<h2>Applies to</h2>
<p>The colspan attribute can be used on the following elements:</p>
...
<td><a href="att_td_cols.asp">colspan</a></td>
</tr>
<tr>
<td><a href="tag_th.asp">&lt;th&gt;</a></td>
<td><a href="att_th_cols.asp">colspan</a></td>
</tr>
</table>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_td_colspan" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_th_colspan" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">colspan</code> attribute has the following browser support for each element:</p>
