...
<a class="w3-left w3-btn" href="tag_em.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_fieldset.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_embed" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><i>URL</i></td>
    <td>Specifies the address of the external file to embed</td>
  </tr>
  <tr>
    <td><a href="att_embed_type.asp">type</a></td>
    <td><i>media_type</i></td>
    <td>Specifies the media type of the embedded content</td>
  </tr>
  <tr>
...
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/dom_obj_embed.asp">Embed Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;embed&gt; element with the following default values: </p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
    embed:focus { <br>&nbsp;&nbsp;&nbsp; outline: none;<br>} </div>
</div>
<br>
