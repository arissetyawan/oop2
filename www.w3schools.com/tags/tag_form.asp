...
<a class="w3-left w3-btn" href="tag_footer.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_frame.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_form_submit" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all notranslate" id="table1">
  ...
  <tr>
    ...
    <td><i>file_type</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies a comma-separated list of file types&nbsp; that the server accepts (that can be submitted through the file upload)</td>
  </tr>
  <tr>
...
<div class="w3-code notranslate cssHigh">
    form {<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; margin-top: 0em;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_form_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
