...
<a class="w3-left w3-btn" href="tag_iframe.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_input.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
are linked to HTML pages. The &lt;img&gt; tag creates a holding space for the referenced image.</p>
<p><b>Tip:</b> To link an image to another document, simply nest the &lt;img&gt; tag inside &lt;a&gt; tags.
<a target="_blank" href="tryit.asp?filename=tryhtml_image_link" class="w3-btn btnsmall" style="float:none;vertical-align:top">Try it &raquo;</a>
<!--<a target="_blank" class="tryiticon" href="tryit.asp?filename=tryhtml_image_link"><span>Try it Yourself</span> &raquo;</a></p>-->
<hr>
...
<p>The following attributes: align, border, hspace, and vspace are not supported in HTML5.</p>
<hr>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_image.asp">Image Object</a></p>
<p>CSS Tutorial: <a href="/css/css3_images.asp">Styling Images</a></p>

<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;img&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    img { <br>&nbsp;&nbsp;&nbsp; display: inline-block;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_img_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
