...
<h1>HTML <span class="color_h1">ondragover</span> Event Attribute</h1>
...
<a target="_blank" href="tryit.asp?filename=tryhtml5_ev_ondragover" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ondragover attribute fires when a draggable element or text selection is 
being dragged over a valid drop target.</p>
...
calling the event.preventDefault() method for the ondragover attribute.</p>
...
<ul>
  ...
  <li><strong>Events fired on the drop target:
    ...
    <ul>
    <li><a href="ev_ondragenter.asp">ondragenter</a> - fires when the dragged element enters the drop target</li>
...
<p>The ondragover attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
    &lt;<i>element</i> ondragover=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on ondragover</td>
  </tr>
</table>
...
<p>HTML DOM Reference: <a href="/jsref/event_ondragover.asp">ondragover Event</a></p>
<br>
