...
<html lang="en-US">
<head>
<title>HTML ISO Country Code Reference</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">ISO Country Codes</span> Reference</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_language_codes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_httpmessages.asp">Next &#10095;</a>
</div>
<hr>
<h2>ISO Country Codes</h2>
<p>ISO country codes define abbreviations for countries.</p>
<p>In HTML they can be used as an addition to the language value in the lang 
attribute.</p>
<p>The first two characters of a language code defines the <strong>language</strong>. 
(see previous reference)</p>
<p>The last two defines the <strong>country</strong>.</p>
<div class="w3-code w3-border notranslate htmlHigh">
 <div>
  &lt;html lang="en<strong>-US</strong>"&gt;<br>
  ...<br>
  &lt;/html&gt;
</div></div>
