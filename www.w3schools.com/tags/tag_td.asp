...
<a class="w3-left w3-btn" href="tag_tbody.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_template.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_td">Try it Yourself &raquo;</a>
</div>
 ...
 Specifies that the content inside a cell should not wrap</td>
  ...
  <tr>
    ...
    <td>col<br>
      ...
      row<br>
      rowgroup</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Defines a way to associate header cells and data cells in a table</td>
  </tr>
    <tr>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_tabledata.asp">TableData Object</a></p>
<p>CSS Tutorial: <a href="/css/css_table.asp">Styling Tables</a></p>

<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;td&gt; element with the following default values: </p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
    td {<br>&nbsp;&nbsp;&nbsp; display: table-cell;<br>&nbsp;&nbsp;&nbsp; vertical-align: inherit;<br>} </div>
</div>
<br>
