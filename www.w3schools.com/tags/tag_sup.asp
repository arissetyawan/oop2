...
<a class="w3-left w3-btn" href="tag_summary.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
  <a class="w3-right w3-btn" href="tag_svg.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The &lt;sup&gt; tag defines superscript text. Superscript text appears half a character above the 
normal line, and is sometimes rendered in a smaller font. Superscript text can be used for footnotes, like WWW<sup>[1]</sup>.</p>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_sup.asp">Superscript Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;sup&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    sup { <br>&nbsp;&nbsp;&nbsp; vertical-align: super;<br>&nbsp;&nbsp;&nbsp; font-size: smaller;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_sup_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
