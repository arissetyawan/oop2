...
<a class="w3-left w3-btn" href="tag_s.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_script.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_phrase_test" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;samp&gt; tag is a phrase tag. It defines sample output from a computer program.</p>
<p><strong>Tip:</strong> This tag is not deprecated, but it is possible to achieve richer effect with CSS.</p>
<p>All phrase tags:</p>
<table class="w3-table-all notranslate" id="table1"> 
  ...
  <tr>
    <td width="20%"><a href="tag_em.asp">&lt;em&gt;</a></td>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_samp.asp">Samp Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;samp&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    samp { <br>&nbsp;&nbsp;&nbsp; font-family: monospace;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_samp_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
