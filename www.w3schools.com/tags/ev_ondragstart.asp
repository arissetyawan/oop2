...
<html lang="en-US">
<head>
<title>HTML ondragstart Event Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">ondragstart</span> Event Attribute</h1>
...
<p>The ondragstart attribute fires when the user starts to drag an element or 
text selection.</p>
...
<p>The ondragstart attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
    &lt;<i>element</i> ondragstart=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on ondragstart</td>
  </tr>
</table>
...
<p>HTML DOM Reference: <a href="/jsref/event_ondragstart.asp">ondragstart Event</a></p>
<br>
