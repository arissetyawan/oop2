...
<h1>HTML <span class="color_h1">size</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_shape.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_sizes.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>For input elements, the size attribute specifies the visible width, in characters, of an &lt;input&gt; 
element.</p>
<p>For select elements, the size attribute specifies the number of visible options in a drop-down list.</p>
<hr>

<h2>Applies to</h2>
<p>The size attribute can be used on the following elements:</p>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_input_size" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" href="tryit.asp?filename=tryhtml_select_size" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">size</code> attribute has the following browser support for each element:</p>
