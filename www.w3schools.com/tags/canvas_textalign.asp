...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_textalign" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_textalign&preval=start">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>end</td>
    <td>The text ends at the specified position</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_textalign&preval=end">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>center</td>
    <td>The center of the text is placed at the specified position</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_textalign&preval=center">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>left</td>
    <td>The text starts at the specified position</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_textalign&preval=left">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>right</td>
    <td>The text ends at the specified position</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_textalign&preval=right">Play it &raquo;</a></td>
  </tr>
 </table>
<hr>
