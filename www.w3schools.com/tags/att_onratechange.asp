...
<html lang="en-US">
<head>
<title>HTML onratechange Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onratechange</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_onprogress.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_onreset.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onratechange attribute defines a script to be run when the playing speed of the audio/video is changed (like when a user switches to a slow motion or fast forward mode).</p>
<hr>
<h2>Applies to</h2>
<p>The onratechange attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on the following elements:</p>
...
<h3>Audio Example</h3>
<p>Run &quot;myFunction&quot; when the audio changes the rate:</p>
<div class="w3-code notranslate htmlHigh">
    &lt;audio onratechange=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_att_onratechange_audio" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">

<h3>Video Example</h3>
<p>Run &quot;myFunction&quot; when the video changes the rate:</p>
<div class="w3-code notranslate htmlHigh">
    &lt;video onratechange=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_att_onratechange" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">onratechange</code> attribute has the following browser support for each element:</p>
