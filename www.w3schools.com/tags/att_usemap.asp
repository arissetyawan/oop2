...
<html lang="en-US">
<head>
<title>HTML usemap Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">usemap</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_type.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_value.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage </h2>
<p>The usemap attribute specifies an image (or an object) as an image-map (an image-map is an image with clickable areas).</p>
...
<h2>Applies to</h2>
<p>The usemap attribute can be used on the following elements:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_object_usemap" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">usemap</code> attribute has the following browser support for each element:</p>
