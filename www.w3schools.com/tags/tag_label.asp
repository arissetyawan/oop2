...
<a class="w3-left w3-btn" href="tag_kbd.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_legend.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td class="html5badge"><a href="att_label_form.asp">form</a></td>
    <td><i>form_id</i></td>
...
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/dom_obj_label.asp">Label Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;label&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    label {<br>&nbsp;&nbsp;&nbsp; cursor: default;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_label_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
