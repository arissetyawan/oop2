...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_stroketext" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">strokeText()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<p><b>Note:</b> The maxWidth parameter is not supported in Safari 5.1 and earlier versions.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_stroketexttext">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>x</i></td>
    <td>The x coordinate where to start painting the text (relative to the  canvas)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_stroketextx">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>y</i></td>
    <td>The y coordinate where to start painting the text (relative to the  canvas)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_stroketexty">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>maxWidth</i></td>
    <td>Optional. The maximum allowed width of the text, in pixels</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_stroketextmaxwidth">Play it &raquo;</a></td>  
  </tr>
</table>
<hr>
