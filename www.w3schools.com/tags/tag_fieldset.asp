...
<a class="w3-left w3-btn" href="tag_embed.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_figcaption.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_fieldset" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate" id="table1">
  ...
  <tr>
    <td class="html5badge"><a href="att_fieldset_disabled.asp">disabled</a></td>
    <td>disabled</td>
    <td>Specifies that a group of related form elements should be disabled</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="att_fieldset_form.asp">form</a></td>
    <td><i>form_id</i></td>
    <td>Specifies one or more forms the fieldset belongs to</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="att_fieldset_name.asp">name</a></td>
    <td><i>text</i></td>
...
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/dom_obj_fieldset.asp">Fieldset Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;fieldset&gt; element with the following default values:</p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
    fieldset { <br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; margin-left: 2px;<br>&nbsp;&nbsp;&nbsp; margin-right: 2px;<br>&nbsp;&nbsp;&nbsp; padding-top: 0.35em;<br>&nbsp;&nbsp;&nbsp; padding-bottom: 0.625em;<br>&nbsp;&nbsp;&nbsp; padding-left: 0.75em;<br>&nbsp;&nbsp;&nbsp; padding-right: 0.75em;<br>&nbsp;&nbsp;&nbsp; border: 2px groove (<em>internal value</em>);<br>} </div>
</div>
<br>
