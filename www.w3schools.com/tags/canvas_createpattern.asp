...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">createPattern()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_createpattern&preval=repeat">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>repeat-x</td>
    <td>The pattern repeats only horizontally</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_createpattern&preval=repeat-x">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>repeat-y</td>
    <td>The pattern repeats only vertically</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_createpattern&preval=repeat-y">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>no-repeat</td>
    <td>The pattern will be displayed only once (no repeat)</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_createpattern&preval=no-repeat">Play it &raquo;</a></td>
  </tr>
</table>
<hr>
