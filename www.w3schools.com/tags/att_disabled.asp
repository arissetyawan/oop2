...
<h1>HTML <span class="color_h1">disabled</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_dirname.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_download.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The disabled attribute is a boolean attribute.</p>
<p>When present, it specifies that the element should be disabled.</p>
<p>A disabled element is unusable.</p>
<p>The disabled attribute can be set to keep a user from using the element
until some other condition has been met (like selecting a checkbox, etc.). Then, 
a JavaScript could remove the disabled value, and make the element usable.</p>
<hr>

<h2>Applies to</h2>
<p>The disabled attribute can be used on the following elements:</p>
...
<td><a href="att_fieldset_disabled.asp">disabled</a></td>
</tr>
<tr>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_button_disabled" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_fieldset_disabled" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Input Example</h3>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_input_disabled" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">

<h3>Optgroup Example</h3>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_optgroup_disabled" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" href="tryit.asp?filename=tryhtml_option_disabled" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_select_disabled" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_textarea_disabled">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">disabled</code> attribute has the following browser support for each element:</p>
