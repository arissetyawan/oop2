...
<html lang="en-US">
<head>
<title>HTML ondragover Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">ondragover</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_ondragleave.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_ondragstart.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
...
<p>To learn about Drag and Drop, read our HTML 
...
<ul>
  <li><strong>Events fired on the draggable target</strong> (the source element)<strong>:
    ...
    <ul>
      <li><a href="att_ondragstart.asp">ondragstart</a> - fires when the user starts to drag an element</li>
      <li><a href="att_ondrag.asp">ondrag</a> - fires when an element is being dragged</li>
      <li><a href="att_ondragend.asp">ondragend</a> - fires when the user has finished dragging the element</li>
    </ul>
  </li><br>
  <li><strong>Events fired on the drop target:
    </strong>
    <ul>
    <li><a href="att_ondragenter.asp">ondragenter</a> - fires when the dragged element enters the drop target</li>
    <li>ondragover - fires when the dragged element is over the drop target</li>
    <li><a href="att_ondragleave.asp">ondragleave</a> - fires when the dragged element leaves the drop target</li>
    <li><a href="att_ondrop.asp">ondrop</a> - fires when the dragged element is dropped on the drop target</li>
 </ul>
  </li>
</ul>
...
<hr>
<h2>Applies to</h2>
<p>The ondragover attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on any HTML elements.</p>
...
<td><a href="ev_ondragover.asp">ondragover</a></td>
</tr>
</table>
