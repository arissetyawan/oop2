...
<p>The &lt;data&gt; tag links the given content with a machine-readable 
translation.</p>
...
<p><strong>Tip:</strong> If the content is time- or date-related, the 
...
<p>The &lt;data&gt; tag is new in HTML5.</p>
<hr>
...
<p>The &lt;data&gt; tag also supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>
