...
<a class="w3-left w3-btn" href="tag_hr.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_i.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<hr>
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="/html/html_intro.asp">HTML Introduction</a></p>
<p>HTML DOM reference: <a href="/jsref/dom_obj_html.asp">HTML Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;html&gt; element with the following default values: </p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
    html { <br>&nbsp;&nbsp;&nbsp; display: block;<br>}<br><br>
 html:focus { <br>&nbsp;&nbsp;&nbsp; outline: none;<br>} </div>
</div>
<br>
