...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_getimagedata" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">getImageData()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<a target="_blank" href="tryit.asp?filename=tryhtml5_canvas_getimagedata_firstpx" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>x</i></td>
    <td>The x coordinate (in pixels) of the upper-left corner to start copy  from </td>
  </tr>
  <tr>
    <td><i>y</i></td>
    <td>The y coordinate (in pixels) of the upper-left corner to start copy  from</td>
  </tr>
  <tr>
    <td><i>width</i></td>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_getimagedata2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
