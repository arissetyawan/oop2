...
<h1>HTML <span class="color_h1">&lt;template&gt;</span> Tag</h1>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="tag_td.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
  <a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
  <a class="w3-right w3-btn" href="tag_textarea.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>The template element holds HTML code without displaying it:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;template&gt;<br>&nbsp; 
  &lt;h2&gt;Flower&lt;/h2&gt;<br>&nbsp; &lt;img src=&quot;img_white_flower.jpg&quot;&gt;<br>&lt;/template&gt; </div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_template" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;template&gt; tag holds its content hidden from the client.</p>
<p>Content inside a &lt;template&gt; tag will not be rendered.</p>
<p>The content can be visible and rendered later by using JavaScript.</p>
<p>Use the &lt;template&gt; tag when you have HTML code you want to use over and over 
again, but not until you ask for it. To do this <em>without</em> the &lt;template&gt; tag, you 
...
<p>The &lt;template&gt; tag is new in HTML5.</p>
<hr>

<h2>Global Attributes</h2>
<p>The &lt;template&gt; tag supports the <a href="ref_standardattributes.asp">Global Attributes in HTML</a>.</p>

<hr>
<h2>More Examples</h2>
<div class="w3-example">
<h3>Example</h3>
<p>Use JavaScript to get the content from a template, and add it to the page:</p>
<div class="w3-code notranslate jsHigh">
  function showContent() {<br>&nbsp; var temp = document.getElementsByTagName(&quot;template&quot;)[0];<br>&nbsp; 
  var clon = temp.content.cloneNode(true);<br>&nbsp; document.body.appendChild(clon);<br>
  } </div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_template2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use the content of a template for each item in an array:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;template&gt;<br>&nbsp; &lt;div class=&quot;myClass&quot;&gt;I like: &lt;/div&gt;<br>&lt;/template&gt;<br>
  <br>&lt;script&gt;<br>var myArr = [&quot;Audi&quot;, &quot;BMW&quot;, &quot;Ford&quot;, &quot;Honda&quot;, &quot;Jaguar&quot;, 
  &quot;Nissan&quot;];<br><br>function showContent() {<br>&nbsp; var temp, item, a, 
  i;<br>&nbsp; //get the template element:<br>&nbsp; temp = 
  document.getElementsByTagName(&quot;template&quot;)[0];<br>&nbsp; 
  //get the DIV element from the template:<br>&nbsp; item = 
  temp.content.querySelector(&quot;div&quot;);<br>&nbsp; //for each item in the array:<br>&nbsp; 
  for (i = 0; i &lt; myArr.length; i++) {<br>&nbsp;&nbsp;&nbsp; //Create a new 
  node, based on the template:<br>&nbsp;&nbsp;&nbsp; a = document.importNode(item, 
  true);<br>&nbsp;&nbsp;&nbsp; //Add data from the 
  array:<br>&nbsp;&nbsp;&nbsp; a.textContent += myArr[i];<br>&nbsp;&nbsp;&nbsp; 
  //append the new node wherever you like:<br>&nbsp;&nbsp;&nbsp; 
  document.body.appendChild(a);<br>&nbsp; }<br>}<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_template3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Test browser support for the template element::</p>
<div class="w3-code notranslate jsHigh">
  if (document.createElement(&quot;template&quot;).content) {<br>&nbsp; /*Code for 
  browsers that supports the TEMPLATE element*/<br>} else {<br>&nbsp; 
  /*Alternative code for browsers that do not support the TEMPLATE element*/<br>
  }</div>
  <a target="_blank" href="tryit.asp?filename=tryhtml5_template4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
