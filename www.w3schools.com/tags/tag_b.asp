...
<a class="w3-left w3-btn" href="tag_audio.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_base.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml5_b" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
be denoted with the 
<a href="tag_em.asp">&lt;em&gt;</a> tag, important text should be denoted 
with the <a href="tag_strong.asp">&lt;strong&gt;</a> tag, and marked/highlighted text should use the 
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_b.asp">Bold Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;b&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    b { <br>&nbsp;&nbsp;&nbsp; font-weight: bold;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_b_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
