...
<a class="w3-left w3-btn" href="tag_br.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_canvas.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_button_test" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Tip:</strong> Buttons are often styled with CSS: <a target="_blank" href="tryit.asp?filename=tryhtml_button_css" class="w3-btn btnsmall" style="float:none;vertical-align:top">Try it &raquo;</a></p>
<hr>
...
<p><strong>Tip:</strong> Visit our <a href="/css/css3_buttons.asp">CSS Buttons Tutorial</a> to find out how to style buttons with CSS.</p>
<hr>

<h2>Differences Between HTML 4.01 and HTML5</h2>
<p>HTML5 has the following new attributes: autofocus, form, formaction, formenctype, formmethod, formnovalidate, and formtarget.</p>
<hr>
...
<table class="w3-table-all notranslate" id="table1">
  ...
  <tr>
    <td class="html5badge"><a href="att_button_autofocus.asp">autofocus</a></td>
    <td>autofocus</td>
  ...
  <tr>
    <td class="html5badge"><a href="att_button_form.asp">form</a></td>
    <td><i>form_id</i></td>
    <td>Specifies one or more forms the button belongs to</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="att_button_formaction.asp">formaction</a></td>
    <td><i>URL</i></td>
    <td>Specifies where to send the form-data when a form is submitted. Only for type=&quot;submit&quot;</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="att_button_formenctype.asp">formenctype</a></td>
 ...
 text/plain</td>
  ...
  <tr>
    <td class="html5badge"><a href="att_button_formmethod.asp">formmethod</a></td>
    <td>get<br>post</td>
    <td>Specifies how to send the form-data (which HTTP method to use). Only for type=&quot;submit&quot;</td>
  </tr>
  <tr>
    <td class="html5badge"><a href="att_button_formnovalidate.asp">formnovalidate</a></td>
    <td>formnovalidate</td>
    <td>Specifies that the form-data should not be validated on submission. Only for type=&quot;submit&quot; </td>
  </tr>
  <tr>
    <td class="html5badge"><a href="att_button_formtarget.asp">formtarget</a></td>
    <td>_blank<br>
    _self<br>
    _parent<br>
    _top<br>
...
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/dom_obj_pushbutton.asp">Button Object</a></p>
<p>CSS Tutorial: <a href="/css/css3_buttons.asp">Styling Buttons</a></p>
<hr>
