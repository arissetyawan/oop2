...
<a class="w3-left w3-btn" href="tag_u.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_var.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_lists4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_ul.asp">Ul Object</a></p>
<p>CSS Tutorial: <a href="/css/css_list.asp">Styling Lists</a></p>

<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;ul&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    ul { <br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; list-style-type: disc;<br>&nbsp;&nbsp;&nbsp; margin-top: 1em;<br>&nbsp;&nbsp;&nbsp; margin-bottom: 1 em;<br>&nbsp;&nbsp;&nbsp; margin-left: 0;<br>&nbsp;&nbsp;&nbsp; margin-right: 0;<br>&nbsp;&nbsp;&nbsp; padding-left: 40px;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_ul_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
