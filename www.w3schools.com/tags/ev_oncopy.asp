...
<h1>HTML <span class="color_h1">oncopy</span> Event Attribute</h1>
...
<div class="w3-code w3-border notranslate"><div>
    &lt;<i>element</i> oncopy=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on oncopy</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML reference: <a href="ev_onpaste.asp">onpaste event</a></p>
<p>HTML reference: <a href="ev_oncut.asp">oncut event</a></p>
<p>HTML DOM reference: <a href="/jsref/event_oncopy.asp">oncopy event</a></p>
<br>
