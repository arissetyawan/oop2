...
<h1>HTML <span class="color_h1">alt</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_action.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_async.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
...
<p><b>Note:</b> The alt attribute is required for the &lt;img&gt; element.</p>
<p><b>Note:</b> For &lt;input&gt; elements, the alt attribute can only be used with &lt;input type="image"&gt;.</p>
<p><b>Tip:</b> To create a tooltip for an image, use the 
<a href="ref_standardattributes.asp">title</a> attribute!</p>
<hr>
<h2>Applies to</h2>
<p>The alt attribute can be used on the following elements:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_input_alt" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">alt</code> attribute has the following browser support for each element:</p>
