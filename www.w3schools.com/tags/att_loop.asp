...
<html lang="en-US">
<head>
<title>HTML loop Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">loop</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_list.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_low.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
...
<h2>Applies to</h2>
<p>The loop attribute can be used on the following elements:</p>
...
<td><a href="att_audio_loop.asp">loop</a></td>
</tr>
<tr>
...
<a target="_blank" href="tryit.asp?filename=tryhtml5_audio_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Video Example</h3>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_video_loop" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">loop</code> attribute has the following browser support for each element:</p>
