...
<a class="w3-left w3-btn" href="tag_dir.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_dl.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>A section in a document that will have a light blue background color:</p>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_div_test" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;div&gt; tag defines a division or a section in an HTML document.</p>
<p>The &lt;div&gt; element is often used as a container for other HTML elements to style them with CSS or to perform certain tasks with JavaScript.</p>
<hr>
...
<hr>
<h2>Related Pages</h2>
<p>HTML tutorial: <a href="/html/html_blocks.asp">HTML Blocks</a></p>
<p>HTML tutorial: <a href="/html/html_layout.asp">HTML Layout</a></p>
<p>HTML DOM reference: <a href="/jsref/dom_obj_div.asp">Div Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;div&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    div {<br>&nbsp;&nbsp;&nbsp; display: block;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_div_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
