...
<html lang="en-US">
<head>
<title>HTML onkeypress Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onkeypress</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_onkeydown.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_onkeyup.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
...
<ol>
  <li><a href="att_onkeydown.asp">onkeydown</a></li>
  <li>onkeypress</li>
  <li><a href="att_onkeyup.asp">onkeyup</a></li>
</ol>
...
use <a href="att_onkeydown.asp">onkeydown</a> instead, because it works for all keys.</p>
<hr>
<h2>Applies to</h2>
<p>The onkeypress attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on any HTML elements.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_onkeypress">Try it Yourself &raquo;</a>
</div>
