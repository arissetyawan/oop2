...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_shadowoffsety" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">shadowOffsetY</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>number</i></td>
    <td>A positive or negative number that defines the vertical distance of the shadow  from the shape</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_shadowoffsety">Play it &raquo;</a></td>
  </tr>
</table>
<hr>
