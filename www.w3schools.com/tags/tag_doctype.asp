...
<a class="w3-left w3-btn" href="tag_comment.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_a.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_doctype" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><b>Tip:</b> To check if the HTML of your Web documents is valid, go to <a href="http://validator.w3.org/" target="_blank">W3C's validation service</a>.</p>
<hr>
...
<h3>XHTML 1.1</h3>
<p>This DTD is equal to XHTML 1.0 Strict, but allows you to add modules (for example to provide 
Ruby support for East-Asian languages).</p>
<div class="w3-code w3-border notranslate htmlHigh"><div>
