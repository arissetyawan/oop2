...
<html lang="en-US">
<head>
<title>HTML onpageshow Event Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onpageshow</span> Event Attribute</h1>
...
<a target="_blank" href="tryit.asp?filename=tryhtml5_ev_onpageshow" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onpageshow event occurs when a user navigates to a webpage.</p>
<p>The onpageshow event is similar to the <a href="ev_onload.asp">onload</a> event, except that it occurs 
...
<div class="w3-code w3-border notranslate"><div>
    &lt;<i>element</i> onpageshow=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on onpageshow</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/event_onpageshow.asp">onpageshow event</a></p>
<br>
