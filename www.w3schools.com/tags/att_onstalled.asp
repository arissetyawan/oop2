...
<html lang="en-US">
<head>
<title>HTML onstalled Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onstalled</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_onshow.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_onsubmit.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The onstalled attribute defines a script to run when the browser is trying to get media data, but data 
is not available.</p>
...
<ul>
  ...
  <li><a href="att_onsuspend.asp">onsuspend</a></li>
</ul>
<hr>
<h2>Applies to</h2>
<p>The onstalled attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on the following elements:</p>
...
<p>The <code class="w3-codespan">onstalled</code> attribute has the following browser support for each element:</p>
