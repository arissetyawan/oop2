...
<ol>
  <li>onmousedown</li>
  <li><a href="ev_onmouseup.asp">onmouseup</a></li>
  <li><a href="ev_onclick.asp">onclick</a></li>
</ol>
<p>The order of events related to the onmousedown event (for the right mouse button):</p>
<ol>
  <li>onmousedown</li>
  <li><a href="ev_onmouseup.asp">onmouseup</a></li>
  <li><a href="ev_oncontextmenu.asp">oncontextmenu</a></li>
</ol>
<hr>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/event_onmousedown.asp">onmousedown event</a></p>
<br>
