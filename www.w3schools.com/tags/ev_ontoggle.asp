...
<h1>HTML <span class="color_h1">ontoggle</span> Event Attribute</h1>
...
<p>The ontoggle attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
    &lt;<i>element</i> ontoggle=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on ontoggle</td>
  </tr>
</table>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/event_ontoggle.asp">ontoggle event</a></p>
<br>
