...
<h1>HTML <span class="color_h1">target</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_tabindex.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_title.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>For a elements, and area elements, the target attribute specifies where to open the linked document.</p>
<p>For base elements the target attribute specifies the default target for all hyperlinks and forms in the page.</p>
<p>For form elements, the target attribute specifies a name or a keyword that indicates where to 
display the response that is received after submitting the form.</p>
<hr>

<h2>Applies to</h2>
<p>The target attribute can be used on the following elements:</p>
...
<td><a href="att_a_target.asp">src</a></td>
</tr>
<tr>
<td><a href="tag_area.asp">&lt;area&gt;</a></td>
<td><a href="att_area_target.asp">src</a></td>
</tr>
<tr>
<td><a href="tag_base.asp">&lt;base&gt;</a></td>
<td><a href="att_base_target.asp">src</a></td>
</tr>
<tr>
<td><a href="tag_form.asp">&lt;form&gt;</a></td>
<td><a href="att_form_target.asp">src</a></td>
</tr>
</table>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_a_target" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" href="tryit.asp?filename=tryhtml_areamap_target" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" href="tryit.asp?filename=tryhtml_base_target" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" href="tryit.asp?filename=tryhtml_form_target" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a> 
</div>
<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">target</code> attribute has the following browser support for each element:</p>
