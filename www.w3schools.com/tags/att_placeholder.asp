...
<h1>HTML <span class="color_h1">placeholder</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_pattern.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_poster.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The placeholder attribute specifies a short hint that describes the expected value 
of a input field / textarea.</p>
<p>The short hint is displayed in the field before the user enters a value.</p>
<hr>
<h2>Applies to</h2>
<p>The placeholder attribute can be used on the following elements:</p>
...
<td><a href="att_input_placeholder.asp">placeholder</a></td>
</tr>
<tr>
<td><a href="tag_textarea.asp">&lt;textarea&gt;</a></td>
<td><a href="att_textarea_placeholder.asp">placeholder</a></td>
</tr>
</table>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_input_placeholder" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" target="_blank" href="tryit.asp?filename=tryhtml5_textarea_placeholder">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The <code class="w3-codespan">placeholder</code> attribute has the following browser support for each element:</p>
