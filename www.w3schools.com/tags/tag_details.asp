...
<a class="w3-left w3-btn" href="tag_del.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_dfn.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml5_details" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;details&gt; tag specifies additional details that the user can view or hide on demand.</p>
<p>The &lt;details&gt; tag can be used to create an interactive widget that the user can 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td class="html5badge"><a href="att_details_open.asp">open</a></td>
    <td>open</td>
...
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/dom_obj_details.asp">Details Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;details&gt; element with the following default values: </p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
    details { <br>&nbsp;&nbsp;&nbsp; display: block;<br>} </div>
</div>
<br>
