...
<a class="w3-left w3-btn" href="tag_button.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_caption.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml5_canvas" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;canvas&gt; tag is used to draw graphics, on the fly, via scripting (usually JavaScript).</p>
<p>The &lt;canvas&gt; tag is only a container for graphics, you must use a script to actually draw the graphics.</p>
<hr>
...
<a href="/graphics/canvas_intro.asp">HTML Canvas Tutorial</a>.</p>
...
<p>Most browsers will display the &lt;canvas&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    canvas { <br>&nbsp;&nbsp;&nbsp; 
    height: 150px;<br>&nbsp;&nbsp;&nbsp; width: 300px;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_canvas_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
