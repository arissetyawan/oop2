...
<h1>HTML <span class="color_h1">min</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_method.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_multiple.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The min attribute specifies the minimum value of an element element.</p>
<p>When used together with the &lt;meter&gt; element, the min attribute specifies the lower bound of the gauge.</p>
<hr>

<h2>Applies to</h2>
<p>The min attribute can be used on the following elements:</p>
...
<td><a href="att_input_min.asp">min</a></td>
</tr>
<tr>
<td><a href="tag_meter.asp">&lt;meter&gt;</a></td>
<td><a href="att_meter_min.asp">min</a></td>
</tr>
</table>
...
<p>The <code class="w3-codespan">min</code> attribute has the following browser support for each element:</p>
