...
<a target="_blank" href="tryit.asp?filename=tryhtml_link_test" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p><b>Tip:</b> Use CSS to style links: <a href="/css/css_link.asp">CSS Links Tutorial</a> 
and <a href="/css/css3_buttons.asp">CSS Buttons Tutorial</a></p>
<hr>
...
<table class="w3-table-all notranslate" id="table1">
  ...
  <tr>
    <td title="New in HTML5" class="html5badge"><a href="att_a_download.asp">download</a></td>
    <td><i>filename</i></td>
  ...
  <tr>
    <td title="New in HTML5" class="html5badge"><a href="att_a_media.asp">media</a></td>
 ...
 <a href="ref_standardattributes.asp">id attribute</a> instead.<br></span>Specifies the name of an anchor</td>
  </tr>
  <tr>
    <td><a href="att_a_ping.asp">ping</a></td>
    <td><em>list_of_URLs</em></td>
    <td>Specifies a space-separated list of URLs to which, when the link is 
    followed, post requests with the body ping will be sent by the browser (in 
    the background). Typically used for tracking.</td>
      </tr>
  <tr>
 ...
 <em>framename</em></td>
    ...
    <tr>
    <td><a href="att_a_type.asp">type</a></td>
...
<p><a href="tryit.asp?filename=tryhtml_link_image" target="_blank">Create a 
clickable image</a><br>
...
<p><a href="tryit.asp?filename=tryhtml_link_mailto" target="_blank">Create an 
email link</a><br>
How to link to a mail message (will only work if you have mail installed).</p>
<p><a href="tryit.asp?filename=tryhtml_link_mailto2" target="_blank">Create 
another email link</a><br>
Another mailto link.</p>
<p><a href="tryit.asp?filename=tryhtml_link_phoneto" target="_blank">Create a 
phone link</a><br>
How to link to a phone number.</p>
<p><a href="tryit.asp?filename=tryhtml5_a_href_anchor" target="_blank">Link to 
another section on the same page</a><br>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_anchor.asp">Anchor Object</a></p>
<p>CSS Tutorial: <a href="/css/css_link.asp">Styling Links</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;a&gt; element with the following default values: </p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
    a:link, a:visited { <br>&nbsp;&nbsp;&nbsp; color: (<em>internal value</em>);<br>&nbsp;&nbsp;&nbsp; text-decoration: underline;<br>&nbsp;&nbsp;&nbsp; cursor: auto;<br>}<br><br>
