...
<a class="w3-left w3-btn" href="tag_samp.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_section.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_script" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Tip:</strong> If you want to learn JavaScript, visit our <a href="/js/default.asp">JavaScript 
Tutorial</a>.</p>
<hr>
...
<p><b>Note:</b> If the &quot;src&quot; attribute is present, the &lt;script&gt; element must be empty.</p>
...
<ul>
  ...
  <li>If neither async or defer is present: The script is fetched and executed immediately, before the browser 
...
<p>In XHTML, the content inside scripts is declared as #PCDATA (instead of CDATA), which means that entities will be parsed.</p>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td class="html5badge"><a href="att_script_async.asp">async</a></td>
    <td>async</td>
  ...
  <tr>
    ...
    <td><i>charset</i></td>
    <td>Specifies the character encoding used in an external script file</td>
  </tr>
  <tr>
    <td><a href="att_script_defer.asp">defer</a></td>
    <td>defer</td>
    <td>Specifies that the script is executed when the page has finished parsing (only for external scripts)</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Specifies the media type of the script</td>
  </tr>
  <tr>
    <td>xml:space</td>
    <td>preserve</td>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_script.asp">Script Object</a></p>
<p>JavaScript Tutorial: <a href="/js/default.asp">Learn JavaScript</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;script&gt; element with the following default values: </p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
    script {<br>&nbsp;&nbsp;&nbsp; display: none;<br>} </div>
</div>
<br>
