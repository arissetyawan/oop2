...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_linecap" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">lineCap</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_lineCap">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>round</td>
    <td>A rounded end cap is added to each end of the line</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_lineCap&preval=round">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>square</td>
    <td>A square end cap is added to each end of the line</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_lineCap&preval=square">Play it &raquo;</a></td>
  </tr>
</table>
<hr>
