...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_rotate" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
Example: to rotate 5 degrees, specify the following: 5*Math.PI/180</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_rotate">Play it &raquo;</a></td>  
  </tr>
</table>
<hr>
