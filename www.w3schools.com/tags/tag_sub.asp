...
<a class="w3-left w3-btn" href="tag_style.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_summary.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_sup" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;sub&gt; tag defines subscript text. Subscript text appears half a character below the 
normal line, and is sometimes rendered in a smaller font. Subscript text can be used for chemical formulas, like H<sub>2</sub>O.</p>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_sub.asp">Subscript Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;sub&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    sub { <br>&nbsp;&nbsp;&nbsp; vertical-align: sub;<br>&nbsp;&nbsp;&nbsp; font-size: smaller;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_sub_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
