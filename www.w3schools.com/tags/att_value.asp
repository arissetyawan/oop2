...
<h1>HTML <span class="color_h1">value</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_usemap.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_width.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>For button, input and option elements, the value attribute specifies the initial value of the element.</p>
<p>For li elements, the value attribute sets the value of an ordered list item. The following list items will increment from that number.</p>
<p>For progress elements, the value attribute specifies how much of the task has been completed.</p>
<p>For param elements, the value attribute specifies the value of a &lt;param&gt; element.</p>
...
<td><a href="att_progress_value.asp">value</a></td>
</tr>
<tr>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_button_value2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" href="tryit.asp?filename=tryhtml_input_value" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" href="tryit.asp?filename=tryhtml_li_value" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_option_value" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_progress" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<p>The <code class="w3-codespan">value</code> attribute has the following browser support for each element:</p>
