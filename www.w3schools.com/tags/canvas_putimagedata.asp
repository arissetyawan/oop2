...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">putImageData()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>x</i></td>
    <td>The x-coordinate, in pixels, of the upper-left corner of the  ImageData object</td>
  </tr>
  <tr>
    <td><i>y</i></td>
    <td>The y-coordinate, in pixels, of the upper-left corner of the  ImageData object</td>
  </tr>
  <tr>
    <td><i>dirtyX</i></td>
    <td>Optional. The horizontal (x) value, in pixels, where to place the  image on the canvas</td>
  </tr>
  <tr>
    <td><i>dirtyY</i></td>
    <td>Optional. The vertical (y) value, in pixels, where to place the  image on the canvas</td>
  </tr>
  <tr>
