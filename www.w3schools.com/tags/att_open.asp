...
<h1>HTML <span class="color_h1">open</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_onwheel.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_optimum.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The open attribute is a boolean attribute.</p>
<p>When present, it specifies that the details should be visible (open) by 
default.</p>
<hr>

<h2>Applies to</h2>
<p>The open attribute can be used on the following element:</p>
...
<td><a href="att_details_open.asp">open</a></td>
</tr>
</table>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_details_open" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
