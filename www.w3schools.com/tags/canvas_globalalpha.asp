...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_globalalpha" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="browserref notranslate">  <tr>
    <th style="width:20%;font-size:16px;text-align:left;">globalAlpha</th>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>number</em></td>
    <td>The transparency value. Must be a number between 0.0 (fully  transparent) and 1.0 (no transparancy)</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalAlpha&preval=0.5">Play it &raquo;</a></td>
  </tr>
</table>
<hr>
