...
<html lang="en-US">
<head>
<title>HTML onafterprint Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onafterprint</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_onabort.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_onbeforeprint.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The onafterprint attribute fires when a page has started printing, or if the 
print dialogue box has been closed.</p>
<p><b>Tip:</b> The onafterprint attribute is often used together with the <a href="att_onbeforeprint.asp">onbeforeprint</a> attribute.</p>
<hr>
<h2>Applies to</h2>
<p>The onafterprint attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on the following element:</p>
...
<h3>Example</h3>
<p>Execute a JavaScript when a page has started printing, or if the print 
dialogue box has been closed:</p>
<div class="w3-code notranslate htmlHigh">
&lt;body onafterprint=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_onafterprint">Try it Yourself &raquo;</a>
</div>
<hr>
