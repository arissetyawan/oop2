...
<div class="w3-code notranslate">
 ...
 ctx.beginPath(); <br>
 ctx.moveTo(20,20);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Create a starting point<br>
 ctx.lineTo(100,20);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Create a horizontal line<br>
 ctx.arcTo(150,20,150,70,50); // Create an arc<br>
 ctx.lineTo(150,120);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Continue with vertical line<br>
 ctx.stroke();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Draw it</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_arcto" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">arcTo()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<p><img src="img_canvas_arcto.png" alt="Canvas arcto() diagram" class="w3-image"></p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_arctox1">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>y1</i></td>
    <td>The y-coordinate of the first tangent</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_arctoy1">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>x2</i></td>
    <td>The x-coordinate of the second tangent</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_arctox2">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>y2</i></td>
    <td>The y-coordinate of the second tangent</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_arctoy2">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>r</i></td>
    <td>The radius of the arc</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_arctor&preval=100,20,100,70,50">Play it &raquo;</a></td>  
  </tr>
 </table>
<hr>
