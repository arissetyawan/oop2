...
<a class="w3-left w3-btn" href="tag_tfoot.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_thead.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td><span class="deprecated">Not supported in HTML5.</span><br> Categorizes header cells</td>
  </tr>
  <tr>
 ...
 Specifies the background color of a header cell</td>
  ...
  <tr>
    ...
    <td><i>character</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br> Aligns the content in a header cell to a character</td>
  </tr>
  <tr>
    <td><a href="att_th_charoff.asp">charoff</a></td>
    <td><i>number</i>&nbsp;</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br> Sets the number of characters the content will be aligned from the character specified by the char attribute</td>
  </tr>
  <tr>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_tablehead.asp">TableHeader Object</a></p>
<p>CSS Tutorial: <a href="/css/css_table.asp">Styling Tables</a></p>

<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;th&gt; element with the following default values: </p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
    th {<br>&nbsp;&nbsp;&nbsp; display: table-cell;<br>&nbsp;&nbsp;&nbsp; vertical-align: inherit;<br>&nbsp;&nbsp;&nbsp; font-weight: bold;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>} </div>
</div>
<br>
