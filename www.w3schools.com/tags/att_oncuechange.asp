...
<h1>HTML <span class="color_h1">oncuechange</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_oncopy.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_oncut.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The oncuechange attribute defines a script to run when th ecue changes in a &lt;track&gt; element.</p>
<hr>
<h2>Applies to</h2>
<p>The oncuechange attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on the following element:</p>
...
<p>The <code class="w3-codespan">oncuechange</code> attribute has the following browser support:</p>
