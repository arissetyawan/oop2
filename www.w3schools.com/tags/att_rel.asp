...
<h1>HTML <span class="color_h1">rel</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_readonly.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_required.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The rel attribute specifies the relationship between the current document and the linked document/resource.</p>
<hr>

<h2>Applies to</h2>
<p>The rel attribute can be used on the following elements:</p>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_a_rel" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Area Example</h3>
...
<a target="_blank" href="tryit.asp?filename=tryhtml5_area_rel" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<p>The <code class="w3-codespan">rel</code> attribute has the following browser support for each element:</p>
