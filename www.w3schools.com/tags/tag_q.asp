...
<a class="w3-left w3-btn" href="tag_progress.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_rp.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_q" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/dom_obj_quote.asp">Quote Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;q&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    q { <br>&nbsp;&nbsp;&nbsp; display: inline;<br>}<br><br>q:before { <br>&nbsp;&nbsp;&nbsp; content: open-quote;<br>}<br><br>q:after { <br>&nbsp;&nbsp;&nbsp; content: close-quote;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_q_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
