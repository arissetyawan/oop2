...
<html lang="en-US">
<head>
<title>HTML onbeforeprint Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onbeforeprint</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_onafterprint.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_onbeforeunload.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The onbeforeprint attribute fires when a page is about to be printed (before 
the print dialogue box appears).</p>
<p><b>Tip:</b> The onbeforeprint attribute is often used together with the <a href="att_onafterprint.asp">onafterprint</a> attribute.</p>
<hr>
<h2>Applies to</h2>
<p>The onbeforeprint attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on the following element:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_onbeforeprint">Try it Yourself &raquo;</a>
</div>
<hr>
