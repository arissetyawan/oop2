...
<html lang="en-US">
<head>
<title>HTML oncanplay Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">oncanplay</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_onblur.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_oncanplaythrough.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The oncanplay attribute defines a script to run when the browser can start playing the specified 
media (when it has 
buffered enough to begin).</p>
<hr>
<h2>Applies to</h2>
<p>The oncanplay attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on the following elements:</p>
...
<div class="w3-code notranslate htmlHigh">
    &lt;audio oncanplay=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_att_oncanplay_audio" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<div class="w3-code notranslate htmlHigh">
    &lt;video oncanplay=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhtml5_att_oncanplay" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">oncanplay</code> attribute has the following browser support for each element:</p>
