...
<html lang="en-US">
<head>
<title>HTML onpageshow Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onpageshow</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_ononline.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_onpaste.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The onpageshow event occurs when a user navigates to a webpage.</p>
<p>The onpageshow event is similar to the <a href="att_onload.asp">onload</a> event, except that it occurs 
...
<hr>
<h2>Applies to</h2>
<p>The onpageshow attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on the following element:</p>
