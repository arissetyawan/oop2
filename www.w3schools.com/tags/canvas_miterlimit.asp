...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_miterlimit" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">miterLimit</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>number</i></td>
    <td>A positive number that specifies the maximum miter length. If the  current miter length exceeds the miterLimit, the corner will display as lineJoin  &quot;bevel&quot;</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_miterLimit">Play it &raquo;</a></td>
  </tr>
</table>
<hr>
