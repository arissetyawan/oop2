...
<h1>HTML <span class="color_h1">charset</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_autoplay.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_checked.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>When used by the &lt;meta&gt; element, the charset attribute specifies the character encoding for the HTML document.</p>
<p>When used by the &lt;script&gt; element, the charset attribute specifies the character encoding used in an external script file.</p>

<hr>
<h2>Applies to</h2>
<p>The charset attribute can be used on the following elements:</p>
...
<td><a href="att_meta_charset.asp">charset</a></td>
</tr>
<tr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_meta_charset" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" href="tryit.asp?filename=tryhtml_script_charset" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">charset</code> attribute has the following browser support for each element:</p>
