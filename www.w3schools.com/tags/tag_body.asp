...
<a class="w3-left w3-btn" href="tag_blockquote.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_br.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>All layout attributes are removed in HTML5.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    Specifies the color of an active link in a document</td>
  </tr>
  <tr>
 ...
 Specifies a background image for a document</td>
  ...
  <tr>
    ...
    <td><i>color</i></td>
    <td><span class="deprecated">Not supported in HTML5. <br> </span>Specifies the color of unvisited links in a document</td>
  </tr>
  <tr>
    <td><a href="att_body_text.asp">text</a></td>
    <td><i>color</i></td>
    <td><span class="deprecated">Not supported in HTML5. <br> </span>Specifies the color of the text in a document</td>
  </tr>
  <tr>
    <td><a href="att_body_vlink.asp">vlink</a></td>
    <td><i>color</i></td>
    <td><span class="deprecated">Not supported in HTML5.<br> </span>Specifies the color of visited links in a document</td>
  </tr>
</table>
<hr>
...
<p>HTML DOM reference: <a href="/jsref/prop_doc_body.asp">document.body Property</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;body&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    body { <br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; margin: 8px;<br>}<br><br>body:focus { <br>&nbsp;&nbsp;&nbsp; outline: none;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhtml_body_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
