...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_strokerect" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">strokeRect()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_strokerectx">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>y</i></td>
    <td>The y-coordinate of the upper-left corner of the rectangle</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_strokerecty">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>width</i></td>
    <td>The width of the rectangle, in pixels</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_strokerectw">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>height</i></td>
    <td>The height of the rectangle, in pixels</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_strokerecth">Play it &raquo;</a></td>  
  </tr>
</table>
<hr>
