...
<a class="w3-left w3-btn" href="tag_picture.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_progress.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_pre" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><b>Tip:</b> Use the &lt;pre&gt; element when displaying text with unusual formatting, or some sort of computer code.</p>
<hr>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_pre.asp">Pre Object</a></p>
<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;pre&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    pre {<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; font-family: monospace;<br>&nbsp;&nbsp;&nbsp; white-space: pre;<br>&nbsp;&nbsp;&nbsp; margin: 1em 0;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_pre_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
