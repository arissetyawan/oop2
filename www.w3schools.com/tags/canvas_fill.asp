...
<h3>Example</h3>
<p>Draw two 150*100 pixels rectangles. Fill one with a red color and the other 
with a blue color:</p>
...
var ctx = c.getContext(&quot;2d&quot;);<br><br>ctx.beginPath();<br>
ctx.rect(20, 20, 150, 100);<br>
ctx.fillStyle = "red";<br>
ctx.fill();<br><br>ctx.beginPath();<br>ctx.rect(40, 40, 150, 100);<br>
 ctx.fillStyle = &quot;blue&quot;;<br>ctx.fill();</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_fill" target="_blank">Try it Yourself &raquo;</a>
</div>
