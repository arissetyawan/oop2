...
<a class="w3-left w3-btn" href="tag_object.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_optgroup.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate htmlHigh">
 ...
 &lt;li&gt;Milk&lt;/li&gt;<br>
 &lt;/ol&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhtml_lists" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
in HTML 4.01, but are supported in HTML5.</p>
...
<table class="w3-table-all notranslate"> 
 ...
 Specifies that the list should render smaller than normal</td>
  ...
  <tr>
    <td class="html5badge"><a href="att_ol_reversed.asp">reversed</a></td>
    <td>reversed</td>
...
<p>HTML DOM reference: <a href="/jsref/dom_obj_ol.asp">Ol Object</a></p>
<p>CSS Tutorial: <a href="/css/css_list.asp">Styling Lists</a></p>

<hr>
<h2>Default CSS Settings</h2>
<p>Most browsers will display the &lt;ol&gt; element with the following default values:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
    ol {<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; list-style-type: decimal;<br>&nbsp;&nbsp;&nbsp; margin-top: 1em;<br>&nbsp;&nbsp;&nbsp; margin-bottom: 1em;<br>&nbsp;&nbsp;&nbsp; margin-left: 0;<br>&nbsp;&nbsp;&nbsp; margin-right: 0;<br>&nbsp;&nbsp;&nbsp; padding-left: 40px;<br>} </div>
<a target="_blank" href="tryit.asp?filename=tryhtml_ol_default_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
