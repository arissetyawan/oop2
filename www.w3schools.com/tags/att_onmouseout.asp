...
<html lang="en-US">
<head>
<title>HTML onmouseout Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onmouseout</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_onmousemove.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_onmouseover.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The onmouseout attribute fires when the mouse pointer moves out of an element.</p>
<p><strong>Tip:</strong> The onmouseout attribute is often used together with 
the <a href="att_onmouseover.asp">onmouseover</a> attribute.</p>
<hr>
<h2>Applies to</h2>
<p>The onmouseout attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on any HTML elements.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_onmouseover">Try it Yourself &raquo;</a>
</div>
