...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_drawimage" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the 
method.</p>
<table class="browserref notranslate">  <tr>
...
<p><strong>Note:</strong> You cannot call the drawImage() method before the 
image has loaded. To ensure that the image has been loaded, you can call 
drawImage() from window.onload() or from document.getElementById(&quot;<em>imageID</em>&quot;).onload.</p>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_drawimagedx&preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>sy</i></td>
    <td>Optional. The y coordinate where to start clipping</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_drawimagedy&preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>swidth</i></td>
    <td>Optional. The width of the clipped image</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_drawimagedwidth&preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>sheight</i></td>
    <td>Optional. The height of the clipped image</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_drawimagedheight&preval=img,90,130,50,60,10,10,50,60">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>x</i></td>
    <td>The x coordinate where to place the image on the canvas</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_drawimagex&preval=img,10,10">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>y</i></td>
    <td>The y coordinate where to place the image on the canvas</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_drawimagey&preval=img,10,10">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>width</i></td>
    <td>Optional. The width of the image to use (stretch or reduce the image)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_drawimagewidth&preval=img,10,10,220,277">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>height</i></td>
    <td>Optional. The height of the image to use (stretch or reduce the image)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_drawimageheight&preval=img,10,10,220,277">Play it &raquo;</a></td>  
  </tr>
</table>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_drawimage2" target="_blank">Try it Yourself &raquo;</a>
</div>
<br>
...
<div class="w3-code notranslate">
 window.onload = function() {<br>&nbsp;&nbsp;&nbsp;
var c=document.getElementById(&quot;myCanvas&quot;);<br>&nbsp;&nbsp;&nbsp; var ctx=c.getContext(&quot;2d&quot;);<br>&nbsp;&nbsp;&nbsp; var img=document.getElementById(&quot;scream&quot;);<br>
 &nbsp;&nbsp;&nbsp;
 ctx.drawImage(img,90,130,50,60,10,10,50,60);<br>};</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_drawimage3" target="_blank">Try it Yourself &raquo;</a>
</div>
<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_drawimage_video" target="_blank">Try it Yourself &raquo;</a>
</div>
<script>
