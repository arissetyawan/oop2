...
<html lang="en-US">
<head>
<title>HTML ondrop Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">ondrop</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_ondragstart.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_ondurationchange.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
...
<ul>
  ...
  <li><strong>Events fired on the drop target:
    ...
    <li><a href="att_ondragover.asp">ondragover</a> - fires when the dragged element is over the drop target</li>
...
<hr>
<h2>Applies to</h2>
<p>The ondrop attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on any HTML elements.</p>
