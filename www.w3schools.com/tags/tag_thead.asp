...
<a class="w3-left w3-btn" href="tag_th.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_time.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_tbody" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The &lt;thead&gt; tag is used to group header content in an HTML table.</p>
<p>The &lt;thead&gt; element is used in conjunction with the <a href="tag_tbody.asp"> &lt;tbody&gt;</a> and <a href="tag_tfoot.asp">&lt;tfoot&gt;</a> elements to specify each part of a table (header, body, footer).</p>
<p>Browsers can use these elements to enable scrolling of the table body independently of the header and footer. Also, when printing a large table that spans multiple pages, these elements can enable the table header and footer to be printed at the top and bottom of each page.</p>
<p>The &lt;thead&gt; tag must be used in the following context: As a child of a &lt;table&gt; element, after any &lt;caption&gt;, and &lt;colgroup&gt; elements, and before any &lt;tbody&gt;, &lt;tfoot&gt;, and &lt;tr&gt; elements.</p>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td><i>number</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Sets the number of characters the content inside the &lt;thead&gt; element will be aligned from the character specified by the char attribute</td>
  </tr>
  <tr>
...
<p>Most browsers will display the &lt;thead&gt; element with the following default values: </p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
    thead {<br>&nbsp;&nbsp;&nbsp; display: table-header-group;<br>&nbsp;&nbsp;&nbsp; vertical-align: middle;<br>&nbsp;&nbsp;&nbsp; border-color: inherit;<br>} </div>
</div>
<br>
