...
<p><a href="ref_canvas.asp" class="w3-btn w3-white w3-border" title="HTML canvas Reference">&#10094; HTML Canvas Reference</a></p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_globalcompop" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  destination image</em></td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=source-over">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>source-atop</td>
    <td>Displays the <em>source image </em>on top of the <em>destination  image</em>. The part of the <i>source image</i> that is outside the <i>destination  image</i> is not shown</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=source-atop">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>source-in</td>
    <td>Displays the <em>source image </em>in to the <em>destination image</em>.  Only the part of the <i>source image</i> that is INSIDE the <i>destination  image</i> is shown, and the <i>destination image</i> is transparent</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=source-in">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>source-out</td>
    <td>Displays the <em>source image </em>out of the <em>destination image</em>.  Only the part of the <i>source image</i> that is OUTSIDE the <i>destination  image</i> is shown, and the <i>destination image</i> is transparent</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=source-out">Play it &raquo;</a></td>
  </tr>
  <tr>
  ...
  source image</em></td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=destination-over">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>destination-atop</td>
    <td>Displays the <em>
  destination image</em> on top of the <em>
  source image</em>. The part of the <i>destination image</i> that is outside the  <i>source  image</i> is not shown</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=destination-atop">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>destination-in</td>
    <td>Displays the <em>
  destination image</em> in to the <em>
  source image</em>. Only the part of the <i>destination image</i> that is  INSIDE the <i>source  image</i> is shown, and the <i>source image</i> is transparent</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=destination-in">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>destination-out</td>
    <td>Displays the <em>
  destination image</em> out of the <em>
  source image</em>. Only the part of the <i>destination image</i> that is  OUTSIDE the <i>source  image</i> is shown, and the <i>source image</i> is transparent</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=destination-out">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>lighter</td>
    <td>Displays the <em>source image </em>+ the <em>destination image</em></td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=lighter">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>copy</td>
    <td>Displays the <em>source image. </em>The <em>destination image</em> is ignored</td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=copy">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>xor</td>
    <td>The <em>source image</em> is combined by using an exclusive OR with the <em>destination image</em></td>
    <td>
  <a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_globalcompop&preval=xor">Play it &raquo;</a></td>
  </tr>
</table>
<br>
...
<div style="border:1px solid #d3d3d3;background-color:#ffffff;xheight:400px;xwidth:570px;padding:10px;">
<div style="overflow:auto">
<script>
var gco=new Array();
...
<div style="clear:both"></div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_globalcompop_all" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<a href="ref_canvas.asp" class="w3-btn w3-white w3-border" title="HTML canvas Reference">&#10094; HTML Canvas Reference</a>
</div>
