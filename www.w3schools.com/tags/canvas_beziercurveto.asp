...
<p><a href="ref_canvas.asp" class="w3-btn w3-white w3-border" title="HTML canvas Reference">&#10094; 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_beziercurvetocp1x">
  Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>cp1y</i></td>
    <td>The y-coordinate of the first Bézier control point</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_beziercurvetocp1y">
  Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>cp2x</i></td>
    <td>The x-coordinate of the second Bézier control point</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_beziercurvetocp2x">
  Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>cp2y</i></td>
    <td>The y-coordinate of the second Bézier control point</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_beziercurvetocp2y">
  Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>x</i></td>
    <td>The x-coordinate of the ending point</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_beziercurvetox">
  Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>y</i></td>
    <td>The y-coordinate of the ending point</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_beziercurvetoy">
  Play it &raquo;</a></td>  
  </tr>
</table>
<hr>
<a href="ref_canvas.asp" class="w3-btn w3-white w3-border" title="HTML canvas Reference">&#10094; 
