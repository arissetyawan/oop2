...
<div class="w3-code notranslate">
 ...
 var ctx=c.getContext(&quot;2d&quot;);<br>var imgData=ctx.createImageData(100,100);<br>for (var i=0;i&lt;imgData.data.length;i+=4)<br>&nbsp; {<br>&nbsp; imgData.data[i+0]=255;<br>&nbsp; imgData.data[i+1]=0;<br>&nbsp; imgData.data[i+2]=0;<br>&nbsp; imgData.data[i+3]=255;<br>&nbsp; }<br>
 ctx.putImageData(imgData,10,10);</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_createimagedata" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">createImageData()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
