...
<html lang="en-US">
<head>
<title>HTML onmousedown Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onmousedown</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_onloadstart.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_onmousemove.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
...
<ol>
  <li>onmousedown</li>
  <li><a href="att_onmouseup.asp">onmouseup</a></li>
  <li><a href="att_onclick.asp">onclick</a></li>
</ol>
<p>The order of events related to the onmousedown event (for the right mouse button):</p>
<ol>
  <li>onmousedown</li>
  <li><a href="att_onmouseup.asp">onmouseup</a></li>
  <li><a href="att_oncontextmenu.asp">oncontextmenu</a></li>
</ol>
<hr>
<h2>Applies to</h2>
<p>The onmousedown attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on any HTML elements.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_onmousedown">Try it Yourself &raquo;</a>
</div>
