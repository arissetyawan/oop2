...
<h1>HTML <span class="color_h1">readonly</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_preload.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_rel.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
<h2>Definition and Usage</h2>
<p>The readonly attribute is a boolean attribute.</p>
<p>When present, it specifies that an input field or textarea is read-only.</p>
...
<h2>Applies to</h2>
<p>The readonly attribute can be used on the following elements:</p>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_input_readonly" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_textarea_readonly">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Browser Support</h2>
<p>The <code class="w3-codespan">readonly</code> attribute has the following browser support for each element:</p>
