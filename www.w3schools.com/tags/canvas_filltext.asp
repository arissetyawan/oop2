...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_canvas_filltext" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">  <tr>
  ...
  <tr>
    <td style="text-align:left;">fillText()</td>
    <td>Yes</td>
    <td>9.0</td>
    <td>Yes</td>
    <td>Yes</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_filltexttext">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>x</i></td>
    <td>The x coordinate where to start painting the text (relative to the  canvas)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_filltextx">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>y</i></td>
    <td>The y coordinate where to start painting the text (relative to the  canvas)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_filltexty">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>maxWidth</i></td>
    <td>Optional. The maximum allowed width of the text, in pixels</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playcanvas.asp?filename=playcanvas_filltextmaxwidth">Play it &raquo;</a></td>  
  </tr>
</table>
<hr>
