...
<a class="w3-left w3-btn" href="tag_i.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete HTML </span>Reference</a>
<a class="w3-right w3-btn" href="tag_img.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=tryhtml_iframe" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>In XHTML, the name attribute is deprecated, and will be removed. Use the 
<a href="ref_standardattributes.asp">global id attribute</a> instead.</p>
<hr>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    ...
    <td>1<br>
      0</td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies whether or not to display a border around an &lt;iframe&gt;</td>
    </tr>
    <tr>
    ...
    <td><i>URL</i></td>
    <td><span class="deprecated">Not supported in HTML5.</span><br>Specifies a page that contains a long description of the content of an &lt;iframe&gt;</td>
      </tr>
      <tr>
    ...
    <td>Specifies the name of an &lt;iframe&gt;</td>
      ...
      <tr>
    <td class="html5badge"><a href="att_iframe_sandbox.asp">sandbox</a></td>
    <td>allow-forms<br>allow-pointer-lock<br>allow-popups<br>
  ...
  <tr>
    <td class="html5badge"><a href="att_iframe_srcdoc.asp">srcdoc</a></td>
    <td><i>HTML_code</i></td>
...
<p>Most browsers will display the &lt;iframe&gt; element with the following default values: </p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
    iframe:focus { <br>&nbsp;&nbsp;&nbsp; outline: none;<br>}<br><br>
 iframe[seamless] { <br>&nbsp;&nbsp;&nbsp; display: block;<br>} </div>
</div>
<br>
