...
<html lang="en-US">
<head>
<title>HTML onunload Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">onunload</span> Attribute</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="att_ontoggle.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="ref_attributes.asp"><span class="w3-hide-small">All HTML </span>Attributes</a>
<a class="w3-right w3-btn" href="att_onvolumechange.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<hr>
...
<p><b>Note:</b> If you reload a page, you will also trigger the onunload event (and the <a href="ev_onload.asp">onload</a> event).</p>
<hr>

<h2>Applies to</h2>
<p>The onunload attribute is part of the <a href="ref_eventattributes.asp">Event Attributes</a>, and can be used on the following element:</p>
...
<div class="w3-code notranslate htmlHigh">
    &lt;body onunload=&quot;myFunction()&quot;&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_onunload">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  <tr>
    <th style="width:20%;font-size:16px;text-align:left;">Event</th>    <th style="width:16%;" class="bsChrome" title="Chrome"></th>
