...
<html lang="en-US">
<head>
<title>HTML ondragenter Event Attribute</title>
<meta charset="utf-8">
...
<h1>HTML <span class="color_h1">ondragenter</span> Event Attribute</h1>
<p><a href="ref_eventattributes.asp" class="w3-btn w3-white w3-border" title="HTML Event Attributes">&#10094; HTML Event Attributes</a></p>
...
<a target="_blank" href="tryit.asp?filename=tryhtml5_ev_ondragenter" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ondragenter attribute fires when a draggable element or text selection 
...
Tutorial on <a href="/html/html5_draganddrop.asp">HTML5 Drag and Drop</a>.</p>
...
<p>There are many event attributes that are used, and can occur, in the different stages 
of a drag and drop operation:</p>
<ul>
  <li><strong>Events fired on the draggable target</strong> (the source element)<strong>:
  </strong>
    <ul>
      <li><a href="ev_ondragstart.asp">ondragstart</a> - fires when the user starts to drag an element</li>
      <li><a href="ev_ondrag.asp">ondrag</a> - fires when an element is being dragged</li>
      <li><a href="ev_ondragend.asp">ondragend</a> - fires when the user has finished dragging the element</li>
    </ul>
  </li><br>
  <li><strong>Events fired on the drop target:
    ...
    <li><a href="ev_ondragover.asp">ondragover</a> - fires when the dragged element is over the drop target</li>
    <li><a href="ev_ondragleave.asp">ondragleave</a> - fires when the dragged element leaves the drop target</li>
    <li><a href="ev_ondrop.asp">ondrop</a> - fires when the dragged element is dropped on the drop target</li>
 </ul>
  </li>
</ul>
<hr>
...
<table class="browserref notranslate">
  <tr>
    <th style="width:20%;font-size:16px;text-align:left;">Event Attribute</th>
...
<p>The ondragenter attribute is new in HTML5.</p>
<hr>

<h2>Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
    &lt;<i>element</i> ondragenter=&quot;<em>script</em>&quot;&gt;
</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>script</i></td>
    <td>The script to be run on ondragenter</td>
  </tr>
</table>
...
<div class="w3-example">
<h3>Example</h3>
<p>A demonstration of all possible drag events:</p>
<div class="w3-code notranslate jsHigh">
 // About to start dragging an element:<br>function dragStart(event) {<br>&nbsp;&nbsp;&nbsp; // The dataTransfer.setData() method sets the data type and the value of the dragged data<br>&nbsp;&nbsp;&nbsp; event.dataTransfer.setData(&quot;Text&quot;, event.target.id);<br><br>&nbsp;&nbsp;&nbsp; // Output some text when starting to drag the p element<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;Started to drag the p element.&quot;;<br><br>&nbsp;&nbsp;&nbsp; // Change the opacity of the draggable element<br>&nbsp;&nbsp;&nbsp; event.target.style.opacity = &quot;0.4&quot;;<br>}<br>
 <br>// While dragging the p element, change the color of the output text<br>
 function dragging(event) {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).style.color = &quot;red&quot;;<br>}<br><br>// Output some text when finished dragging the p element and reset the opacity<br>
 function dragEnd(event) {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = &quot;Finished dragging the p element.&quot;;<br>&nbsp;&nbsp;&nbsp; event.target.style.opacity = &quot;1&quot;;<br>}<br>
 <br>// When the draggable p element enters the droptarget, change the DIVS's border style<br>function dragEnter(event) {<br>&nbsp;&nbsp;&nbsp; if ( event.target.className == &quot;droptarget&quot; ) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.target.style.border = &quot;3px dotted red&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>
 <br>// By default, data/elements cannot be dropped in other elements. To allow a drop, we must prevent the default handling of the element<br>
 function allowDrop(event) {<br>&nbsp;&nbsp;&nbsp; event.preventDefault();<br>
 }<br><br>// When the draggable p element leaves the droptarget, reset the DIVS's border style<br>function dragLeave(event) {<br>&nbsp;&nbsp;&nbsp; if ( event.target.className == &quot;droptarget&quot; ) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.target.style.border = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br><br>/* On drop - Prevent the browser default handling of the data (default is open as link on drop)<br>Reset the color of the output text and DIV's border color<br>
 Get the dragged data with the dataTransfer.getData() method<br>The dragged data is the id of the dragged element (&quot;drag1&quot;)<br>Append the dragged element into the drop element<br>*/<br>function drop(event) {<br>&nbsp;&nbsp;&nbsp; event.preventDefault();<br>&nbsp;&nbsp;&nbsp; if ( event.target.className == &quot;droptarget&quot; ) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).style.color = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.target.style.border = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var data = event.dataTransfer.getData(&quot;Text&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.target.appendChild(document.getElementById(data));<br>&nbsp;&nbsp;&nbsp; }<br>}<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_ev_ondrag_all">Try it Yourself &raquo;</a>
</div>
<hr>
-->
<h2>Related Pages</h2>
<p>HTML Tutorial: <a href="/html/html5_draganddrop.asp">HTML5 Drag and Drop</a></p>
<p>HTML Reference: <a href="att_global_draggable.asp">HTML draggable Attribute</a></p>
<p>HTML DOM Reference: <a href="/jsref/event_ondragenter.asp">ondragenter Event</a></p>
<br>

<a href="ref_eventattributes.asp" class="w3-btn w3-white w3-border" title="HTML Event Attributes">&#10094; HTML Event Attributes</a>
</div>
