...
<title>W3Schools Online Code Editor</title>
<meta charset="utf-8">
...
.editor-container .editor-child {
  width:49.6%;
  float:left;
}
.editor-container .editor-edit {
  margin-right:5px;
}
.editor-container .editor-view {
  color:white;
...
<h2 class="left">Try It Yourself</h2>
<a target="_top" href="default.asp">Tryit Home</a>
...
<h1>W3Schools Online Code Editor</h1>

<p>With W3Schools online code editor, you can edit HTML, CSS and JavaScript code, and view the result in your browser.</p>
<br class="w3-hide-large w3-hide-medium">
<div class="w3-border mq">
<div style="background-color:#f1f1f1;xmargin-left:-16px;xmargin-right:-16px;">

 <div class="w3-bar w3-hide-small" style="overflow:hidden;">
  <a href="javascript:void(0);" class="w3-button w3-bar-item topnav-icons fa fa-home w3-hover-none" style="font-size:26px!important;color:#999999!important;margin-right:4px;margin-bottom:-4px;"></a>
  <a href="javascript:void(0);" class="w3-button w3-bar-item topnav-icons fa fa-bars w3-hover-none" style="font-size:26px!important;color:#999999 !important;margin-right:4px;margin-bottom:-4px;"></a>
  <a href="javascript:void(0);" class="w3-button w3-bar-item topnav-icons fa fa-save w3-hover-none" style="font-size:26px!important;color:#999999 !important;margin-right:4px;margin-bottom:-4px;"></a>
  <a href="javascript:void(0);" class="w3-button w3-bar-item topnav-icons fa fa-rotate w3-hover-none" style="font-size:26px!important;color:#999999!important;margin-right:4px;margin-bottom:-4px;"></a>
  <a href="tryit.asp?filename=tryhtml_default" class="w3-button w3-bar-item w3-green w3-hover-green" style="padding:14px 16px;margin-left:4px;margin-bottom:-4px;margin-top:-2px" target="_blank">Run &raquo;</a>
  <span class="w3-right w3-hide-small" style="padding:12px 16px 10px 0;display:block;float:right;"><span id="framesize">Result Size: <span></span></span></span>
</div>
...
<div class="w3-white w3-padding notranslate htmlHigh w3-code w3-border" style="border-left:none">
&lt;!DOCTYPE html&gt;<br>
&lt;html&gt;<br>&lt;head&gt;<br>&lt;title&gt;Page Title&lt;/title&gt;<br>&lt;style&gt;<br>body {<br>&nbsp;&nbsp;&nbsp; background-color: 
  black;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>}<br>&lt;/style&gt;<br>
&lt;/head&gt;<br>&lt;body&gt;<br><br>&lt;h1&gt;This is a Heading&lt;/h1&gt;<br>&lt;p&gt;This is a paragraph.&lt;/p&gt;<br>
...
<h1 style="font-family:Arial !important;">This is a Heading</h1>
<p style="font-family:Arial !important;font-size:17px">This is a paragraph.</p>
<img src="avatar.png" alt="Avatar" style="width:100%;max-width:200px;margin-top:30px;margin-bottom:30px;">
</div>
</div>
<a class="w3-btn" style="margin-left:16px;margin-top:8px;margin-bottom:16px" href="tryit.asp?filename=tryhtml_default" target="_blank">Try it Yourself &raquo;</a>
</div>
</div>
<p>Click on the &quot;Try it Yourself&quot; button to see how it works.</p>
<hr>

<h1>Web Editor Explained</h1>
<p>The window to the left is editable - edit the code and click on the "Run" button to view the result in the right window.</p>
<p class="w3-hide-small">The "Result Size" returns the width and the height of the result window in pixels (even when you resize the browser window).</p>
<p>You can control the size of a window with the bar in between the windows (draggable gutter).</p>
<p>The icons are explained in the table below:</p>
  <table class="w3-table-all">
    ...
    <tr>
      ...
      <td>Go to www.w3schools.com</td>
    </tr>
    <tr>
      <td><span class="fa fa-bars w3-xlarge" style="color:#888"></span></td>
      <td>Menu button for more options</td>
    </tr>
    <tr>
      <td><span class="fa fa-save w3-xlarge" style="color:#888"></span></td>
      <td>Save your code (and share it with others)</td>
    </tr>
    <tr>
      <td><span class="fa fa-rotate w3-xlarge" style="color:#888"></span></td>
      <td>Change orientation (horizontally or vertically)</td>
    </tr>
  </table>
<hr>

<h1>Learn to Code</h1>
<p>If you are new to coding, we suggest that you start with HTML, and move on to CSS and JavaScript:</p>
<a class="w3-btn w3-green" href="/html/default.asp">HTML Tutorial</a>
<a class="w3-btn w3-green" href="/css/default.asp">CSS Tutorial</a>
<a class="w3-btn w3-green" href="/js/default.asp">JavaScript Tutorial</a>
...
if (window.addEventListener) {              
  ...
  window.attachEvent("onresize", showFrameSize);
}

function showFrameSize() {
  var t;
  var width, height;
  width = Number(w3_getStyleValue(document.getElementById("editorEdit"), "width").replace("px", "")).toFixed();
  height = Number(w3_getStyleValue(document.getElementById("editorEdit"), "height").replace("px", "")).toFixed();
