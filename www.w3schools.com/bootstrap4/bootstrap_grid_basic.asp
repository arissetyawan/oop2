...
<html lang="en-US">
<head>
<title>Bootstrap 4 Grid Basic</title>
...
<h1>Bootstrap <span class="color_h1">4 Grids</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_get_started.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_typography.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The following example shows how to create three equal-width columns, on all 
...
<a target="_blank" href="tryit.asp?filename=trybs_grid_ex&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The following example shows how to create four equal-width columns starting at tablets and scaling to 
extra large desktops. <strong>On mobile phones or screens that are less than 576px wide, the columns will automatically stack 
on top of each other</strong>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
tablets and scaling to large extra desktops:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<p style="margin-bottom:8px"><strong>Tip:</strong> You will learn more about Bootstrap 4 grids later in this tutorial.</p>
</div>
