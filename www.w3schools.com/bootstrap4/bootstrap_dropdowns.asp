...
$(document).ready(function(){
     $('.test a[href]').click(function (e) { e.preventDefault(); });
});
</script>
</head>
<body>
...
<h1>Bootstrap 4 <span class="color_h1">Dropdowns</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_cards.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_collapse.asp">Next &#10095;</a>
</div>
<hr>

<h2>Basic Dropdown</h2>
<p>A dropdown menu is a toggleable menu that allows the user to choose one value 
...
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;dropdown&quot;&gt;<br>&nbsp; &lt;button type=&quot;button&quot; class=&quot;btn btn-primary 
  dropdown-toggle&quot; data-toggle=&quot;dropdown&quot;&gt;<br>&nbsp;&nbsp;&nbsp; Dropdown button<br>&nbsp; 
  &lt;/button&gt;<br>&nbsp; &lt;div class=&quot;dropdown-menu&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a 
  class=&quot;dropdown-item&quot; href=&quot;#&quot;&gt;Link 1&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a 
  class=&quot;dropdown-item&quot; href=&quot;#&quot;&gt;Link 2&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a 
  class=&quot;dropdown-item&quot; href=&quot;#&quot;&gt;Link 3&lt;/a&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_dropdown-menu&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Example Explained</h3>
<p>The <code class="w3-codespan">.dropdown</code> class indicates a dropdown menu.</p>
<p>To open the dropdown menu, use a button or a link with a class of <code class="w3-codespan">.dropdown-toggle</code> and 
the 
<code class="w3-codespan">data-toggle=&quot;dropdown&quot;</code> attribute.</p>
<p>Add the <code class="w3-codespan">.dropdown-menu</code> class to a <code class="w3-codespan">&lt;div&gt;</code> element to actually build the dropdown menu. Then add the 
<code class="w3-codespan">.dropdown-item</code> class to each element (links or 
buttons) inside the dropdown menu.</p>
<hr>
...
<p>The <code class="w3-codespan">.dropdown-divider</code> class is used to separate links inside the dropdown menu with a thin horizontal border:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;dropdown-divider&quot;&gt;&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_dropdown-divider&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="dropdown" style="margin:16px 0 24px 0">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
    <h5 class="dropdown-header" style="margin-top:0;font-weight:500">Dropdown header</h5>
    <a class="dropdown-item" href="javascript:void(0);">Link 1</a>
    <a class="dropdown-item" href="javascript:void(0);">Link 2</a>
    <a class="dropdown-item" href="javascript:void(0);">Link 3</a>
    <h5 class="dropdown-header" style="margin-top:0;font-weight:500">Dropdown header</h5>
...
<p>The <code class="w3-codespan">.dropdown-header</code> class is used to add headers inside the dropdown menu:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;dropdown-header&quot;&gt;Dropdown header 1&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_dropdown-header&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Disable and Active items</h2>
<div class="dropdown" style="margin:16px 0 24px 0">
...
<p>Highlight a specific dropdown item with the <code class="w3-codespan">.active</code> class (adds a blue background color).</p>
<p>To disable an item in the dropdown menu, use the <code class="w3-codespan">.disabled</code> class (gets a light-grey text color and a "no-parking-sign" icon on hover):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;a class=&quot;dropdown-item active&quot; href=&quot;#&quot;&gt;Active&lt;/a&gt;<br>
  &lt;a class=&quot;dropdown-item disabled&quot; href=&quot;#&quot;&gt;Disabled&lt;/a&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_dropdown-active&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Dropdown Position</h2>
<div class="dropdown dropright float-left" style="margin:16px 0 24px 0">
  <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButtonright" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Dropright
  </button>
...
<div class="dropdown dropleft float-right" style="margin:16px 0 24px 0">
  <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButtonleft" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Dropleft
  </button>
  <div class="dropdown-menu dropdown-menu-right">
    <a class="dropdown-item" href="javascript:void(0);">Link 1</a>
...
<p>You can also create a "dropright" or "dropleft" menu, by adding the <code class="w3-codespan">.dropright</code> or <code class="w3-codespan">.dropleft</code> class to the dropdown element. Note that the caret/arrow is added automatically:</p>
<div class="w3-row-padding" style="margin:-14px -16px">
<div class="w3-half">
<div class="w3-example">
 <h3>Dropright</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;dropdown dropright&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_dropdown-right&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
</div>
...
<a target="_blank" href="tryit.asp?filename=trybs_dropdown-left&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
</div>
...
<p>To right-align the dropdown menu, add the <code class="w3-codespan">.dropdown-menu-right</code> class to the element 
with .dropdown-menu:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;dropdown-menu dropdown-menu-right&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_dropdown-menu-right&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Dropup</h2>
<div class="dropup" style="margin:16px 0 24px 0">
  <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton5" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Dropdown button
  </button>
...
<p>If you want the dropdown menu to expand upwards instead of downwards, change 
the &lt;div&gt; element with class=&quot;dropdown&quot; to <code class="w3-codespan">&quot;dropup&quot;</code>:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class="dropup"&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_dropdown-menu-dropup&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="dropdown" style="margin:16px 0 24px 0">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="javascript:void(0);">Link 1</a>
      <a class="dropdown-item" href="javascript:void(0);">Link 2</a>
      <a class="dropdown-item-text bslinkblue" href="javascript:void(0);">Text Link</a>
      <span class="dropdown-item-text" href="javascript:void(0);">Just Text</span>
    </div>
</div>

<p>The <code class="w3-codespan">.dropdown-item-text</code> class is used to add plain text to 
a dropdown item, or used on links for default link styling.</p>                                         
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;dropdown-menu&quot;&gt;<br>&nbsp; &lt;a class=&quot;dropdown-item&quot; href=&quot;#&quot;&gt;Link 
  1&lt;/a&gt;<br>&nbsp; &lt;a class=&quot;dropdown-item&quot; href=&quot;#&quot;&gt;Link 2&lt;/a&gt;<br>&nbsp; &lt;a 
  class=&quot;dropdown-item-text&quot; href=&quot;#&quot;&gt;Text Link&lt;/a&gt;<br>&nbsp; &lt;span 
  class=&quot;dropdown-item-text&quot;&gt;Just Text&lt;/span&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_dropdown-text&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;btn-group&quot;&gt;<br>&nbsp; &lt;button type=&quot;button&quot; class=&quot;btn btn-primary&quot;&gt;Apple&lt;/button&gt;<br>&nbsp; &lt;button type=&quot;button&quot; class=&quot;btn btn-primary&quot;&gt;Samsung&lt;/button&gt;<br>
  &nbsp; &lt;div class=&quot;btn-group&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;button type=&quot;button&quot; class=&quot;btn 
  btn-primary dropdown-toggle&quot; data-toggle=&quot;dropdown&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  Sony<br>&nbsp;&nbsp;&nbsp; &lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div 
  class=&quot;dropdown-menu&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;a 
  class=&quot;dropdown-item&quot; href=&quot;#&quot;&gt;Tablet&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;a 
  class=&quot;dropdown-item&quot; href=&quot;#&quot;&gt;Smartphone&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_button_group_dropdown&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;btn-group&quot;&gt;<br>&nbsp; &lt;button type=&quot;button&quot; class=&quot;btn btn-primary&quot;&gt;Sony&lt;/button&gt;<br>&nbsp; 
  &lt;button type=&quot;button&quot; class=&quot;btn btn-primary dropdown-toggle 
  dropdown-toggle-split&quot; 
  data-toggle=&quot;dropdown&quot;&gt;<br>&nbsp; 
  &lt;/button&gt;<br>&nbsp; &lt;div class=&quot;dropdown-menu&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a 
  class=&quot;dropdown-item&quot; href=&quot;#&quot;&gt;Tablet&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a 
  class=&quot;dropdown-item&quot; href=&quot;#&quot;&gt;Smartphone&lt;/a&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_dropdown-split&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Vertical Button Group w/ Dropdown</h2>
<p>
  <div class="btn-group-vertical" style="margin-bottom:2px">
    <button type="button" class="btn btn-primary">Apple</button>
    <button type="button" class="btn btn-primary">Samsung</button>
    <div class="btn-group">
      <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
...
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;btn-group-vertical&quot;&gt;<br>&nbsp; &lt;button type=&quot;button&quot; class=&quot;btn 
  btn-primary&quot;&gt;Apple&lt;/button&gt;<br>&nbsp; &lt;button type=&quot;button&quot; class=&quot;btn btn-primary&quot;&gt;Samsung&lt;/button&gt;<br>&nbsp; 
  &lt;div class=&quot;btn-group&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;button type=&quot;button&quot; class=&quot;btn 
  btn-primary dropdown-toggle&quot; data-toggle=&quot;dropdown&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  Sony<br>&nbsp;&nbsp;&nbsp; &lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div 
  class=&quot;dropdown-menu&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;a 
  ...
  class=&quot;dropdown-item&quot; href=&quot;#&quot;&gt;Smartphone&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_button_group_v_dropdown&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Complete Bootstrap 4 Dropdown Reference</h2>
<p>For a complete reference of all dropdown options, methods and events, go to our
<a href="bootstrap_ref_js_dropdown.asp">Bootstrap 4 JS Dropdown Reference</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_cards.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_collapse.asp">Next &#10095;</a>
