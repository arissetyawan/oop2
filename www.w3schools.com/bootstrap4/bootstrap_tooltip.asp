...
<h1>Bootstrap 4 <span class="color_h1">Tooltip</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_modal.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_popover.asp">Next &#10095;</a>
</div>
<hr>
<h2>Bootstrap 4 Tooltip</h2>
<p>The Tooltip component is small pop-up box that appears when the user moves the 
mouse pointer over an element:</p>

<div>
  <button style="margin:0 15px 0 0;" type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Hooray!">Hover over me</button>
  <a style="position:relative;top:3px;text-decoration:none" href="javascript:void(0);" class="bslink" data-toggle="tooltip" data-placement="right" title="Hooray!">Hover over me</a>
</div>
