...
&lt;a&gt; elements are used to jump to a section in the scrollable area --&gt;<br>
  &lt;nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top"&gt; <br>&nbsp; 
  &lt;ul class="navbar-nav"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;li class="nav-item"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;a class="nav-link" href="#section1"&gt;Section 1&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/li&gt;<br>&nbsp; 
  ....<br>&nbsp; &lt;/ul&gt;<br>&lt;/nav&gt;<br><br>&lt;!-- Section 1 
...
<table class="w3-table-all notranslate">
 ...
 Specifies the number of pixels to offset from top when calculating the position of scroll</td>
  <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_scrollspy_js&stacked=h">Try it</a></td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.scrollspy(&quot;dispose&quot;)</td>
    <td>Destroys the scrollspy</td>
  </tr>
</table>
</div>
