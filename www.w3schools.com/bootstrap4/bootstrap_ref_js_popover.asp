...
<html lang="en-US">
<head>
<title>Bootstrap JS Popover Reference</title>
...
<h1>Bootstrap <span class="color_h1">JS Popover</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_js_modal.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_js_scrollspy.asp">Next &#10095;</a>
</div>
<hr>

<h2>JS Popover</h2>
<p>The Popover component is similar to tooltips; it is a pop-up box that appears 
when the user clicks on an element. The difference is that the popover can 
contain much more content.</p>
<p>For a tutorial about Popovers, read our <a href="bootstrap_popover.asp">Bootstrap Popover Tutorial</a>.</p>
<!--
<div class="w3-example">
<h3>Example</h3>
<div class="xexample_code notranslate htmlHigh">
  <button style="margin:7px 15px 17px 0;" type="button" data-placement="bottom" class="btn btn-md btn-success" data-toggle="popover" title="Popover Header" data-content="Some content inside the popover">Click To Toggle Popover</button>
  <a href="#" data-toggle="popover" data-placement="right" title="Popover Header" data-content="Some content inside the popover">Click To Toggle Popover</a>
<script>
$(document).ready(function(){
 ...
 &lt;a href=&quot;#&quot; data-toggle=&quot;popover&quot; title=&quot;Popover Header&quot; data-content=&quot;Some content inside the popover&quot;&gt;Toggle popover&lt;/a&gt;<br>
  <br>&lt;script&gt;<br>$(document).ready(function(){<br>&nbsp;&nbsp;&nbsp; $('[data-toggle=&quot;popover&quot;]').popover(); <br>});<br>&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_tooltip&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
-->
<hr>

<h2>Enable via data-* Attributes</h2>
<p>The <code class="w3-codespan">data-toggle="popover&quot;</code> activates the popover.</p>
<p>The <code class="w3-codespan">title</code> attribute specifies the header text of the popover.</p>
<p>The <code class="w3-codespan">data-content</code> attribute specifies the text that should be displayed inside 
the popover's body.</p>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_popover&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Via JavaScript</h2>
<p>Popovers are not CSS-only plugins, and must therefore be initialized with jQuery: select the specified element and call the <code class="w3-codespan">
popover()</code> method.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Select all 
elements with data-toggle="popover" in the document<br>
$('[data-toggle=&quot;popover&quot;]').popover(); <br><br>// Select a specified 
element<br>$('#myPopover').popover();
</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_popover&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
append the option name to data-, as in data-placement=&quot;&quot;.</p>
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>true</td>
    <td>
 <p>Specifies whether to add a CSS fade transition effect when opening and closing the popover</p>
 <ul>
    <li>true - Add a fading effect</li>
    <li>false - Do not add a fading effect</li>
 </ul>
   </td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_animation&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>container</td>
    <td>string, or the boolean false</td>
    <td>false</td>
    <td>Appends the popover to a specific element. <br>Example: container: 'body'</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_container&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>content</td>
    <td>string</td>
    <td>&quot;&quot;</td>
    <td>Specifies the text inside the popover's body</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_title_content&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>delay</td>
    <td>number, or object</td>
    <td>0</td>
    <td>Specifies the number of milliseconds it will take to open and close the popover.<br><br>To specify a delay for opening and another one for closing, use the object structure:<br><br>delay: {show: 500, hide: 100} - which will take 500 ms to open the popover, but only 100 ms to close it</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_delay&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>html</td>
    <td>boolean&nbsp;</td>
    <td>false</td>
    <td>Specifies whether to accept HTML tags in the popover:<br>&nbsp;<ul>
    <li>true - Accept HTML tags</li>
    <li>false - Do not accept HTML tags</li>
 </ul>
 <strong>Note:</strong>
 The HTML must be inserted in the title attribute (or using the title option). <br><br>When set to false (default), jQuery's <a href="/jquery/html_text.asp">text()</a> method will be used. Use this if you are worried about XSS attacks</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_html&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>placement</td>
    <td>string</td>
    <td>&quot;right&quot;</td>
    <td>Specifies the popover position. Possible values:<br><br><ul>
    <li>&quot;top&quot; - Popover on top</li>
    <li>&quot;bottom&quot; - Popover on bottom</li>
    <li>&quot;left&quot; - Popover on left</li>
    <li>&quot;right&quot; - Popover on right</li>
    <li>&quot;auto&quot; - Lets the browser decide the position of the  popover. For  example, if the value is &quot;auto left&quot;, the popover will display on the  left side when possible, otherwise on the right. If the value is &quot;auto  bottom&quot;, the popover will display at the bottom when possible, otherwise  on the top</li>
 </ul>
   </td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_placement&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>selector</td>
    <td>string, or the boolean false</td>
    <td>false</td>
    <td>Adds the popover to a specified selector</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_selector&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>template</td>
    <td>string</td>
    <td>&nbsp;</td>
    <td>Base HTML to use when creating the popover.<br><br>The popover's title will be injected into the .popover-header.<br><br>The popover's content will be injected into the .popover-body.<br><br>.arrow will become the popover's arrow.<br><br>The outermost wrapper element should have the .popover class.</td>
    <td></td>
  </tr>
  <tr>
    <td>title</td>
    <td>string</td>
    <td>&quot;&quot;</td>
    <td>Specifies the header text of the popover</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_title_content&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>trigger</td>
    <td>string</td>
    <td>&quot;click&quot;</td>
    <td>Specifies how the popover is triggered. Possible values:<br><br><ul>
    <li>&quot;click&quot; - Trigger the popover with a click</li>
    <li>&quot;hover&quot; - Trigger the popover on hover</li>
    <li>&quot;focus&quot; - Trigger the popover when it gets focus (by tabbing or  clicking .e.g)</li>
    <li>&quot;manual&quot; - Trigger the popover manually</li>
 </ul>
 <strong>Tip:</strong> To pass multiple values, separate them with a space</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_trigger&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>offset</td>
    <td>number or a string</td>
    <td>0</td>
    <td>Offset of the popover relative to its target</td>
    <td></td>
  </tr>
  <tr>
    <td>fallbackPlacement</td>
    <td>string or an aray</td>
    <td>"flip"</td>
    <td>Specifies which position Popper wil use on fallback</td>
    <td></td>
  </tr>
  <tr>
    <td>boundary</td>
    ...
    <td>"scrollParent"</td>
    <td>Overflow constraint boundary of the popover. Accepts the values "viewport", "window" or "scrollParent", or an HTML element</td>
    <td></td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.popover(<em>options</em>)</td>
    <td>Activates the popover with an option. See options above for valid values</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_placement&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.popover(&quot;show&quot;)</td>
    <td>Shows the popover</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_methods&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.popover(&quot;hide&quot;)</td>
    <td>Hides the popover</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_methods&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.popover(&quot;toggle&quot;)</td>
    <td>Toggles the popover</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_methods&stacked=h">Try it</a></td>
    </tr>
  <tr>
    <td>.popover(&quot;dispose&quot;)</td>
    <td>Hides and destroys the popover</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_methods&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.popover(&quot;enable&quot;)</td>
    <td>Enables the popover the ability to be shown. This is default</td>
    <td></td>
  </tr>
  <tr>
    <td>.popover(&quot;disable&quot;)</td>
    <td>Removes the ability to show a popover. The popover can only be shown if it is re-enabled again</td>
    <td></td>
  </tr>
  <tr>
    <td>.popover(&quot;toggleEnabled&quot;)</td>
    <td>Toggles the ability for the popover to be shown or hidden</td>
    <td></td>
  </tr>
  <tr>
    <td>.popover(&quot;update&quot;)</td>
    <td>Updates the position of the popover</td>
    <td></td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Occurs when the popover is about to be shown</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>shown.bs.popover </td>
    <td>Occurs when the popover is fully shown (after CSS transitions have completed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>hide.bs.popover </td>
    <td>Occurs when the popover is about to be hidden</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>hidden.bs.popover </td>
    <td>Occurs when the popover is fully hidden (after CSS transitions have completed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_popover_events&stacked=h">Try it</a></td>
    </tr>
  <tr>
    <td>inserted.bs.popover </td>
    <td>Occurs after the show.bs.popover event when the popover template has been added to the DOM</td>
    <td></td>
    </tr>
</table>
