...
<html lang="en-US">
<head>
<title>Bootstrap 4 JS Collapse Reference</title>
...
<h1>Bootstrap 4 <span class="color_h1">JS Collapse</span></h1>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Shows the collapsible content by default</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_collapse_show&stacked=h">Try it</a></td>
  </tr>
  <tr>
...
<p>Just add <code class="w3-codespan">data-toggle=&quot;collapse&quot;</code> and a <code class="w3-codespan">data-target</code> to element to automatically 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>selector</td>
    <td>false</td>
    <td>All collapsible elements under the specified parent will be closed when this collapsible item is shown. (similar to traditional <strong>accordion</strong> behavior)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_collapse&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>toggle</td>
    <td>boolean</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.collapse(&quot;dispose&quot;)</td>
    <td>Destroys the collapsible element</td>
    <td></td>
  </tr>
</table>
</div>
