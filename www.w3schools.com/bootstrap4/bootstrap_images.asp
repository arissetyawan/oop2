...
<h1>Bootstrap 4 <span class="color_h1">Images</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_tables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_jumbotron.asp">Next &#10095;</a>
</div>
<hr>

<h2>Bootstrap 4 Image Shapes</h2>
<div style="float:left;width:33%">
<p>Rounded Corners:</p>
<img src="paris.jpg" class="img-fluid rounded" alt="Paris" style="width:204px;height:auto;">
</div>
<div style="float:left;width:33%">
<p>Circle:</p>
<img src="newyork.jpg" class="img-fluid rounded-circle" alt="NYC" style="width:204px;height:auto;">
</div>
<div style="float:left;width:33%;">
<p>Thumbnail:</p>
<img src="sanfran.jpg" class="img-fluid img-thumbnail" alt="San Fran" style="width:204px;height:auto;">
</div>
<div style="clear:both;margin-bottom:20px;"></div>
<hr>

<h2>Rounded Corners</h2>
<p>The <code class="w3-codespan">.rounded</code> class adds rounded corners to an image:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;img src=&quot;cinqueterre.jpg&quot; class=&quot;rounded&quot; alt=&quot;Cinque Terre&quot;&gt;</div>
...
<h2>Circle</h2>
<p>The <code class="w3-codespan">.rounded-circle</code> class shapes the image to a circle:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;img src=&quot;cinqueterre.jpg&quot; class=&quot;rounded-circle&quot; alt=&quot;Cinque Terre&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_img_circle&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Thumbnail</h2>
<p>The <code class="w3-codespan">.img-thumbnail</code> class shapes the image to a thumbnail 
(bordered):</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<p>Float an image to the right with the <code class="w3-codespan">.float-right</code> class or to the left with <code class="w3-codespan">.float-left</code>:</p> 
<div class="w3-container" style="margin:0 -16px">
  <img src="paris.jpg" class="float-left" style="width:30%"> 
  <img src="paris.jpg" class="float-right" style="width:30%"> 
</div>

<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;img src=&quot;paris.jpg&quot; class=&quot;float-left&quot;&gt; <br>&lt;img src=&quot;paris.jpg&quot; 
  class=&quot;float-right&quot;&gt; </div>
<a target="_blank" href="tryit.asp?filename=trybs_img_align&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Centered Image</h2>
<p>Center an image by adding the utility classes <code class="w3-codespan">.mx-auto</code> (margin:auto) and <code class="w3-codespan">.d-block</code> (display:block) to the image:</p> 
<div class="w3-container" style="margin:0 -16px">
  <img src="paris.jpg" class="mx-auto d-block" style="width:30%"> 
</div>

<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;img src=&quot;paris.jpg&quot; class=&quot;mx-auto d-block&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_img_centered&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Create responsive images by adding an <code class="w3-codespan">.img-fluid</code> class 
to the <code class="w3-codespan">&lt;img&gt;</code> tag. The image will then scale nicely to the parent element.</p>
<p>The <code class="w3-codespan">.img-fluid</code> class applies <code class="w3-codespan">max-width: 100%;</code> and 
<code class="w3-codespan">height: auto;</code> to the image:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;img class=&quot;img-fluid&quot; src=&quot;img_chania.jpg&quot; alt=&quot;Chania&quot;&gt; </div>
...
<h2>Complete Bootstrap 4 Image Reference</h2>
<p>For a complete reference of all image classes, go to our complete
<a href="bootstrap_ref_css_images.asp" class="w3-border-bottom">Bootstrap 4 Image Reference</a>.</p>
-->
