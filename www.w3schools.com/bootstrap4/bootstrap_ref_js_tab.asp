...
<html lang="en-US">
<head>
<title>Bootstrap JS Tab Reference</title>
...
<h1>Bootstrap <span class="color_h1">JS Tab</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_js_scrollspy.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_js_tooltip.asp">Next &#10095;</a>
</div>
<hr>

<h2>Tab CSS Classes</h2>
<p>Tabs are used to separate content into different panes where each pane is 
viewable one at a time.</p>
<p>For a tutorial about Tabs, read our <a href="bootstrap_navs.asp">Bootstrap Tabs/Pills Tutorial</a>.</p>
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td><code>.nav nav-pills</code></td>
    <td>Creates navigation pills</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab-pills&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td><code>.nav-item</code></td>
    <td>Creates tab items</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td><code>.nav-link</code></td>
    <td>Styles links inside the navigation tab</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td><code>.nav-justified</code></td>
    <td>Makes navigation tabs/pills equal widths of their parent, at screens wider than 768px. On smaller screens, the nav tabs are stacked</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab-justified&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td><code>.tab-content</code></td>
    <td>Together with .tab-pane and data-toggle=&quot;tab&quot;, it makes the tab toggleable</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab-content&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td><code>.tab-pane</code></td>
    <td>Together with .tab-content and data-toggle=&quot;tab&quot;, it makes the tab toggleable</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab-content&stacked=h">Try it</a></td>
  </tr>
</table>
<hr>
...
<p>Add <code class="w3-codespan">data-toggle=&quot;tab&quot;</code> to each tab, and add a <code class="w3-codespan">.tab-pane</code> class with a unique ID 
for every tab and wrap them in a <code class="w3-codespan">.tab-content</code> class.</p>
...
<div class="w3-code notranslate htmlHigh">
  ...
  href=&quot;#menu2&quot;&gt;Menu 2&lt;/a&gt;<br>&nbsp; &lt;/li&gt;<br>&lt;/ul&gt;<br><br>&lt;!-- Tab panes --&gt;<br>
  &lt;div class=&quot;tab-content&quot;&gt;<br>&nbsp; &lt;div class=&quot;tab-pane active container&quot; 
  id=&quot;home&quot;&gt;...&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;tab-pane container&quot; 
  id=&quot;menu1&quot;&gt;...&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;tab-pane container&quot; 
  id=&quot;menu2&quot;&gt;...&lt;/div&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_tab-content&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
// Select all tabs<br>$('.nav-tabs a').click(function(){<br>&nbsp;&nbsp;&nbsp; $(this).tab('show');<br>})<br>
<br>// Select tab by name<br>$('.nav-tabs a[href=&quot;#home&quot;]').tab('show')<br>
<br>// Select first tab<br>$('.nav-tabs a:first').tab('show') <br><br>// Select 
last tab<br>$('.nav-tabs a:last').tab('show') <br><br>// Select fourth tab 
(zero-based)<br>$('.nav-tabs li:eq(3) a').tab('show')
</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_tab_js&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Tab Methods</h2>
<p>The following table lists all available tab methods.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.tab(&quot;show&quot;)</td>
    <td>Shows the tab</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab_show&stacked=h">Try it</a></td>
  </tr>
</table>
</div>

<h2>Tab Events</h2>
<p>The following table lists all available tab events.</p>
<div class="table-responsive">
<table class="w3-table-all notranslate">
  <tr>
    <th>Event</th>
  ...
  <tr>
    <td>show.bs.tab</td>
    <td>Occurs when the tab is about to be shown.</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>shown.bs.tab</td>
    <td>Occurs when the tab is fully shown (after CSS transitions have completed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>hide.bs.tab</td>
    <td>Occurs when the tab is about to be hidden</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>hidden.bs.tab</td>
    <td>Occurs when the tab is fully hidden (after CSS transitions have completed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tab_events&stacked=h">Try it</a></td>
    </tr>
</table>
<p><strong>Tip:</strong> Use jQuery's <a href="/jquery/event_target.asp">event.target</a> and <a href="/jquery/event_relatedtarget.asp">event.relatedTarget</a> 
to get the active tab and the previous active tab:</p>

<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 $('.nav-tabs a').on('shown.bs.tab', function(event){<br>&nbsp;&nbsp;&nbsp; var x = $(event.target).text();&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // active tab<br>&nbsp;&nbsp;&nbsp; var y = $(event.relatedTarget).text();&nbsp; // previous tab<br>});</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_tab_events2&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
</div>
