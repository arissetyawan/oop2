...
<h1>Bootstrap 4 <span class="color_h1">Grid System</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_filters.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_grid_stacked_to_horizontal.asp">Next &#10095;</a>
</div>
<hr>
<h2>Bootstrap 4 Grid System</h2>
<p>Bootstrap's grid system allows up to 12 columns across the page.</p>
<p>If you do not want to use all 12 column individually, you can group the columns together to create wider columns:</p>
...
</div><p>Bootstrap's grid system is responsive, and the columns will re-arrange 
...
the content items were stacked on top of each other.</p>
...
<p>Some Bootstrap 4 grid system rules:</p>
<ul>
  <li>Rows must be placed within a <code class="w3-codespan">.container</code> (fixed-width) or <code class="w3-codespan">.container-fluid</code> (full-width) for proper alignment and padding</li>
  <li>Use rows to create horizontal groups of columns</li>
  <li>Content should be placed within columns, and only columns may be immediate children of rows</li>
  <li>Predefined classes like <code class="w3-codespan">.row </code>and <code class="w3-codespan">.col-sm-4</code> are available for quickly making grid layouts</li>
  <li>Columns create gutters (gaps between column content) via padding. That padding is offset in rows for the first and last column via negative margin on <code class="w3-codespan">.rows</code></li>
  <li>Grid columns are created by specifying the number of 12 available columns you wish to span. For example, three equal columns would use three <code class="w3-codespan">.col-sm-4</code></li>
  <li>Column widths are in percentage, so they are always fluid and sized relative to their parent element</li>
  <li>The biggest <strong>difference between Bootstrap 3 and Bootstrap 4</strong> is that Bootstrap 4 now uses flexbox, instead of floats. One big advantage with flexbox is that grid columns without a specified width will automatically layout as "equal width columns" (and equal height). Example: Three elements with <code class="w3-codespan">.col-sm</code> will each automatically be 33.33% wide from the small breakpoint and up. <strong>Tip:</strong> If you want to learn more about Flexbox, you can read our <a href="/css/css3_flexbox.asp">CSS Flexbox Tutorial</a>.</li>
</ul>
<div class="w3-panel w3-note">
<p style="margin-bottom:0">Note that Flexbox is not supported in IE9 and earlier versions.</p>
<p style="margin-bottom:8px"><strong>If you require IE8-9 support, use <a href="/bootstrap/default.asp">Bootstrap 3.</a></strong> It is the most 
...
<div class="w3-example">
 <div class="w3-code notranslate htmlHigh">
   ...
   devices --&gt;<br>&lt;div class=&quot;row&quot;&gt;<br>&nbsp; &lt;div class=&quot;col-*-*&quot;&gt;&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;col-*-*&quot;&gt;&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;col-*-*&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;<br>
   <br>&lt;!-- Or let Bootstrap automatically handle the layout --&gt;<br>&lt;div class=&quot;row&quot;&gt;<br>&nbsp; &lt;div class=&quot;col&quot;&gt;&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;col&quot;&gt;&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;col&quot;&gt;&lt;/div&gt;<br>&nbsp; 
   &lt;div class=&quot;col&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_grid_ex_structure&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
represents a number, which should always add up to 12 for each row.</p>
...
<!--<p>Different grid examples:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-12&quot;&gt;.col-sm-12 yellow&lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-4&quot;&gt;.col-sm-4 beige&lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-4&quot;&gt;.col-sm-4 grey&lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-4&quot;&gt;.col-sm-4 blue&lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-lg-9 col-sm-8&quot;&gt;col-lg-9 col-sm-8 pink&lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-lg-3 col-sm-4&quot;&gt;col-lg-3 col-sm-4 orange&lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br>
 </div>
<p>Result:</p>
<div class="w3-padding w3-white notranslate test">
<div class="row">
  <div class="col-sm-12 columns" style="background-color:yellow;">.col-sm-12</div>
</div>
<div class="row">
  <div class="col-sm-4 columns" style="background-color:beige;">.col-sm-4</div>
  <div class="col-sm-4 columns" style="background-color:lightgrey;">.col-sm-4</div>
  <div class="col-sm-4 columns" style="background-color:lightblue;">.col-sm-4</div>
</div>
<div class="row">
  <div class="col-sm-8 col-lg-9 columns" style="background-color:pink;">.small-8 .large-9</div>
  <div class="col-sm-4 col-lg-3 columns" style="background-color:orange;">.small-4 .large-3</div>
</div>
</div>
<a target="_blank" href="tryit.asp?filename=trybs_grid_system&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a></div>
<p>So for the first row in 
our example above, the markup defines a &lt;div&gt; with class <code class="w3-codespan">.col-sm-12</code>, which is going to take up twelve 
columns of space (100% of the width). </p>
<p>The next row specifies three columns; Bootstrap lines these up next to each other, where <code class="w3-codespan">.col-sm-4</code> takes 
about 33.3% of the width (33.3% + 33.3% + 33.3%).</p>
<p>In our third row, we have added one extra class to each column (<code class="w3-codespan">.col-lg-9</code> and 
<code class="w3-codespan">.col-lg-3</code>). This means that when the page is viewed on a larger screen it should 
split the column width to 75% (<code class="w3-codespan">.col-lg-9</code>) and 25% (<code class="w3-codespan">.col-lg-3</code>). 
As we also have specified the small classes, the columns will split to 66% (<code class="w3-codespan">.col-sm-8</code>) 
and 33% (<code class="w3-codespan">.col-sm-4</code>) for small AND medium screens (scales up). This is useful for re-arranging 
the layout for 
...
<h2>Grid Options</h2>
<p>The following table summarizes how the Bootstrap 4 grid system works across 
different screen sizes:</p>
<div class="table-responsive">
...
<h2>Examples</h2>
<p>The next chapters shows examples of grid systems for different devices and screen widths:</p>
<ul>
  <li><a href="bootstrap_grid_stacked_to_horizontal.asp">Stacked-to-horizontal</a></li>
  <li><a href="bootstrap_grid_xsmall.asp">Auto Layout</a></li>
  <li><a href="bootstrap_grid_small.asp">Small devices</a></li>
  <li><a href="bootstrap_grid_medium.asp">Medium devices</a></li>
  <li><a href="bootstrap_grid_large.asp">Large devices</a></li>
  <li><a href="bootstrap_grid_xlarge.asp">Extra large devices</a></li>
  <li><a href="bootstrap_grid_examples.asp">More grid examples</a></li>
</ul>
