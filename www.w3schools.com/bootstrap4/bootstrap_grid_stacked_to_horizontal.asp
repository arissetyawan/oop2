...
<html lang="en-US">
<head>
<title>Bootstrap 4 Grid Stacked-to-horizontal</title>
...
<h1>Bootstrap 4 Grid <span class="color_h1">Stacked-to-horizontal</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_grid_system.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_grid_xsmall.asp">Next &#10095;</a>
</div>
<hr>
<h2>Bootstrap 4 Grid Example: Stacked-to-horizontal</h2>
<p>We will create a basic grid system that starts out stacked on extra small devices, before becoming horizontal on 
larger devices.</p>
...
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>
 ...
 &lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_grid_stacked_to_hor&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>

<div class="w3-panel w3-note">
  <p style="margin-bottom:8px;"><strong>Tip:</strong> The numbers in the <code class="w3-codespan">.col-sm-*</code> classes indicates how many columns the 
div should 
span (out of 12). So, <code class="w3-codespan">.col-sm-1</code> spans 1 column, <code class="w3-codespan">.col-sm-4</code> spans 4 columns, 
<code class="w3-codespan">.col-sm-6</code> spans 6 columns, etc.<br><br><strong>Note:</strong> 
  Make sure that the sum adds up to 12 or fewer (it is not required that you use 
  all 12 available columns):</p>
</div>

<p><strong>Tip:</strong> You can turn any fixed-width layout into a <strong>full-width</strong> layout by changing 
the <code class="w3-codespan">.container</code> class to <code class="w3-codespan">.container-fluid</code>:</p>
<div class="w3-example">
<h3>Example: Fluid container</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;container-fluid&quot;&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-6&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Lorem ipsum...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-6&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Sed ut perspiciatis...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_grid_container-fluid&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Auto Layout Columns</h2>
<p>In Bootstrap 4, there is an easy way to create equal width columns for all devices: just remove the number from <code class="w3-codespan">.col-<em>size</em>-*</code> and only use the <code class="w3-codespan">.col-<em>size</em></code> class on a specified number of 
<strong>col elements</strong>. Bootstrap will recognize how many columns there 
are, and each column will get the same width. The <em>size</em> classes 
determines when the columns should be responsive:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
...
<a target="_blank" href="tryit.asp?filename=trybs_grid_stacked_auto&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a></div>
