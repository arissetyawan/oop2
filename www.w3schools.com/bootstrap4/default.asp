...
<h1>Bootstrap 4 <span class="color_h1">Tutorial</span></h1>
...
<p style="margin-top:15px;">Bootstrap 4 is the newest version of <a href="/bootstrap/default.asp">Bootstrap</a>, which is the most popular HTML, CSS, and JavaScript framework for developing responsive, mobile-first websites.</p>
<p>Bootstrap 4 is completely free to download and use!</p>
<p><a href="bootstrap_get_started.asp" class="w3-btn w3-round w3-padding-large w3-hide-small">Start learning Bootstrap 4 now &raquo;</a></p>
<p><a href="bootstrap_get_started.asp" class="w3-btn w3-block w3-round w3-hide-large w3-hide-medium" style="padding:8px 16px">Learn Bootstrap 4</a></p>
</div>

<hr>

<h2>Try it Yourself Examples</h2>
<p>This Bootstrap 4 tutorial contains hundreds of Bootstrap 4 examples.</p>
...
stable version of Bootstrap, and it is still supported by the team for critical bugfixes and documentation changes. However, new features will NOT be added to 
it.</p>
</div>
<a href="/bootstrap/default.asp" class="w3-btn w3-dark-grey">Go To Bootstrap 3 &raquo;</a>
<hr>

<h2>Bootstrap 4 Basic Template</h2>
<p>We have created a responsive starter template with Bootstrap 4. You are free to modify, save, share, and use it in your projects:</p>
<div class="w3-content" style="max-width:1500px">
<iframe src="/howto/tryhow_website_bootstrap4_ifr.htm" class="w3-round" style="width:100%;border:5px solid #e9e9e9;height:600px"></iframe>
<div class="w3-row-padding" style="margin:16px -16px 0 -16px">
  <div class="w3-col m6">
    <a href="trybs_template1.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey w3-block">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="tryit.asp?filename=trybs_template1" target="_blank" class="w3-btn w3-padding-large w3-green w3-block">Try it Yourself</a>
  </div>
</div>
</div>
<hr>
...
<p>A complete list of all Bootstrap 4 CSS classes with description and examples:</p>
<ul style="margin:22px 0">
  <li><a href="bootstrap_ref_all_classes.asp">Bootstrap All CSS Classes</a> <span class="w3-tag w3-blue w3-round" style="margin-left:5px">Popular</span></li>
</ul>
<p>If you want to do more with Bootstrap components, see our complete Bootstrap 4 JavaScript/jQuery reference - all with &quot;Try it Yourself&quot; examples:</p>
