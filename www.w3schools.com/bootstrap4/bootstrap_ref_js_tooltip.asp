...
<h2>JS Tooltip</h2>
<p>The Tooltip is a small pop-up box that appears when the user moves the mouse pointer over an element.</p>
...
<table class="w3-table-all notranslate">
 ...
 <strong>Tip:</strong> To pass multiple values, separate them with a space</td>
  ...
  <tr>
    ...
    <td>"scrollParent"</td>
    <td>Overflow constraint boundary of the tooltip. Accepts the values "viewport", "window" or "scrollParent", or an HTML element</td>
    <td></td>
  </tr>
</table>
