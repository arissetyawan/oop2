...
<html lang="en-US">
<head>
<title>Bootstrap 4 Grid Small</title>
...
<h1>Bootstrap 4 Grid <span class="color_h1">Small</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_grid_xsmall.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_grid_medium.asp">Next &#10095;</a>
</div>
<hr>
<h2>Small Grid Example</h2>
<div class="table-responsive" style="margin:11px 0">
<table class="table table-striped table-bordered notranslate">
  <tr>
    <th style="width:20%;">&nbsp;</th>
    <th style="width:17%;">Extra small</th>
    <th class="w3-dark-grey" style="width:16%;">Small</th>
    <th style="width:16%;">Medium</th>
    <th style="width:16%;">Large</th>
    <th style="width:16%;">Extra Large</th>
  </tr>
  <tr>
    <td><strong>Class prefix</strong></td>
    <td><code class="w3-codespan">.col-</code></td>
    <td class="w3-dark-grey"><code class="w3-codespan">.col-sm-</code></td>
  ...
  <tr>
    ...
    <td>&lt;576px</td>
    <td class="w3-dark-grey">&gt;=576px</td>
    <td>&gt;=768px</td>
    <td>&gt;=992px</td>
    <td>&gt;=1200px</td>
  </tr>
...
<p>Assume we have a simple layout with two columns. We want the columns to be 
split 25%/75% for small devices.</p>
<div class="w3-note w3-panel">
<p style="margin-bottom:8px">
Small devices are defined as having a screen width from 
<strong>576 pixels to 767 pixels</strong>.</p>
</div>
<p>For small devices we will use the <code class="w3-codespan">.col-sm-*</code> classes.</p>
<p>We will add the following classes to our two columns:</p>
...
<p>Now Bootstrap is going to say &quot;at the small size, look for classes with 
-sm- in them and use those&quot;.</p>
<p>The following example will result in a 25%/75% split on small (and medium, large 
and xlarge) devices. On extra small devices, it will automatically stack (100%):</p>

<div class="row w3-padding">
  <div class="col-sm-3 w3-padding-16 bg-success">
    .col-sm-3
  </div>
  <div class="col-sm-9 w3-padding-16 bg-warning">
    .col-sm-9
  </div>
</div>
...
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;container-fluid&quot;&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-3 bg-success&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Lorem ipsum...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-9 bg-warning&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Sed ut perspiciatis...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>
 &lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_grid_small&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>

<div class="w3-panel w3-note">
  <p style="margin-bottom:8px;"><strong>Note:</strong> Make sure that the sum adds up to 12 or fewer (it is 
  not required that you use all 12 available columns):</p>
</div>

<p>For a 33.3%/66.6% split, you would use <code class="w3-codespan">.col-sm-4</code> and <code class="w3-codespan">.col-sm-8</code> (and for a 50%/50% split, you would use <code class="w3-codespan">.col-sm-6</code> and <code class="w3-codespan">.col-sm-6</code>):</p>

<div class="row w3-padding">
  <div class="col-sm-4 w3-padding-16 bg-success">
    .col-sm-4
  </div>
  <div class="col-sm-8 w3-padding-16 bg-warning">
    .col-sm-8
  </div>
</div>
<div class="row w3-padding">
  <div class="col-sm-6 w3-padding-16 bg-success">
    .col-sm-6
  </div>
  <div class="col-sm-6 w3-padding-16 bg-warning">
    .col-sm-6
  </div>
</div>
...
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- 33.3/66.6% split: --&gt;<br>&lt;div class=&quot;container-fluid&quot;&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-4 bg-success&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Lorem ipsum...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-8 bg-warning&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Sed ut perspiciatis...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>
 &lt;/div&gt;<br><br>&lt;!-- 50%/50% split: --&gt;<br>&lt;div class=&quot;container-fluid&quot;&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-6 bg-success&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Lorem ipsum...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class=&quot;col-sm-6 bg-warning&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Sed ut perspiciatis...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>
 &lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_grid_small2&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>

<h2>Auto Layout Columns</h2>
<p>In Bootstrap 4, there is an easy way to create equal width columns for all devices: just remove the number from <code class="w3-codespan">.col-sm-*</code> and only use the <code class="w3-codespan">.col-sm</code> class on a specified number of 
<strong>col elements</strong>. Bootstrap will recognize how many columns there 
are, and each column will get the same width.</p>
<p>If the screen size is <strong>less than 576px</strong>, the columns will 
stack horizontally:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Two columns: 50% width on all screens, except for extra small (100% 
  width) --&gt;<br>&lt;div class=&quot;row&quot;&gt;<br>&nbsp; &lt;div class=&quot;col-sm&quot;&gt;1 of 
  2&lt;/div&gt;<br>
&nbsp;
&lt;div class=&quot;col-sm&quot;&gt;2 of 2&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;!-- Four 
  columns: 25% width on all screens, except for extra small (100% width)--&gt;<br>&lt;div class=&quot;row&quot;&gt;<br>&nbsp; &lt;div class=&quot;col-sm&quot;&gt;1 of 4&lt;/div&gt;<br>
&nbsp;
&lt;div class=&quot;col-sm&quot;&gt;2 of 4&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;col-sm&quot;&gt;3 
  of 4&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;col-sm&quot;&gt;4 of 4&lt;/div&gt;<br>
  &lt;/div&gt;</div>
...
<a target="_blank" href="tryit.asp?filename=trybs_grid_small_auto&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a></div>

<p>The next chapter shows how to add a different split percent for medium devices.</p>
