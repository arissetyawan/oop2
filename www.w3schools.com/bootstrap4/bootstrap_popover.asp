...
<h1>Bootstrap 4 <span class="color_h1">Popover</span></h1>
...
<hr>
<h2>Bootstrap 4 Popover</h2>
<p>The Popover component is similar to tooltips; it is a pop-up box that appears when the user 
clicks on an element. The difference is that the popover can contain much more content.</p>

<button style="margin:2px 15px 0 0;" data-toggle="popover" title="Popover Header" data-placement="top" data-content="Some content inside the popover" class="btn btn-primary">Toggle popover</button>
  <a style="position:relative;top:4px;text-decoration:none;" href="javascript:void(0);" class="bslink" data-toggle="popover" data-placement="right" title="Hooray!" data-content="Some content inside the popover">Toggle popover</a>
