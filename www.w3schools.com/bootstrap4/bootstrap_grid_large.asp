...
<html lang="en-US">
<head>
<title>Bootstrap 4 Grid - Large</title>
...
<h1>Bootstrap 4 Grid - <span class="color_h1">Large</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_grid_medium.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_grid_xlarge.asp">Next &#10095;</a>
</div>
<hr>
<h2>Large Grid Example</h2>
...
<table class="table table-striped table-bordered notranslate">
  <tr>
    ...
    <th class="w3-dark-grey" style="width:16%;">Large</th>
  ...
  <tr>
    ...
    <td class="w3-dark-grey"><code class="w3-codespan">.col-lg-</code></td>
  ...
  <tr>
    ...
    <td>&gt;=576px</td>
    <td>&gt;=768px</td>
    <td class="w3-dark-grey">&gt;=992px</td>
    <td>&gt;=1200px</td>
  </tr>
</table>
</div>

<p>In the previous chapter, we presented a grid example with classes for small 
and medium devices. We used two divs (columns) and we gave them 
a 
25%/75% split on small devices, and a 50%/50% split on medium devices:</p>
<div class="w3-example">
 <div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;col-sm-3 col-md-6&quot;&gt;....&lt;/div&gt;<br>
&lt;div class=&quot;col-sm-9 col-md-6&quot;&gt;....&lt;/div&gt;</div>
</div>

<p>But on large devices the design may be better as a 33%/66% split.</p>
<div class="w3-note w3-panel">
<p style="margin-bottom:8px">Large devices are defined as having a screen width from 
<strong>992 pixels to 1199 pixels</strong>.</p>
</div>
<p>For large devices we will use the <code class="w3-codespan">.col-lg-*</code> classes:</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;col-sm-3 col-md-6 <strong>col-lg-4</strong>&quot;&gt;....&lt;/div&gt;<br>
&lt;div class=&quot;col-sm-9 col-md-6 <strong>col-lg-8</strong>&quot;&gt;....&lt;/div&gt;</div>
</div>

<p>Now Bootstrap is going to say &quot;at the small size, look at classes with 
...
in them and use those&quot;.</p>
<p>The following example will result in a 25%/75% split on small devices, a 
50%/50% split on medium devices, and a 33%/66% split on large and xlarge 
devices. On extra small devices, it will automatically stack (100%):</p>
<div class="w3-container">
<div class="row">
<div class="col-sm-3 col-md-6 col-lg-4 bg-success w3-padding-16">
.col-sm-3 .col-md-6 .col-lg-4
</div>
<div class="col-sm-9 col-md-6 col-lg-8 bg-warning w3-padding-16">
...
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;container-fluid&quot;&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class="col-sm-3 col-md-6 col-lg-4&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Lorem ipsum...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class="col-sm-9 col-md-6 col-lg-8&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Sed ut perspiciatis...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>
 &lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_grid_large&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h2>Using Only Large</h2>
<p>In the example below, we only specify the <code class="w3-codespan">.col-lg-6</code> class (without <code class="w3-codespan">.col-md-*</code> and/or <code class="w3-codespan">.col-sm-*</code>). This means that large 
and xlarge devices will split 50%/50%. However, 
for medium, small AND extra small devices, it will stack vertically (100% width):</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;container-fluid&quot;&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class="col-lg-6"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Lorem ipsum...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;div class="col-lg-6"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Sed ut perspiciatis...&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>
 &lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_grid_large2&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Auto Layout Columns</h2>
<p>In Bootstrap 4, there is an easy way to create equal width columns for all devices: just remove the number from <code class="w3-codespan">.col-lg-*</code> and only use the <code class="w3-codespan">.col-lg</code> class on a specified number of 
<strong>col elements</strong>. Bootstrap will recognize how many columns there 
are, and each column will get the same width.</p>
<p>If the screen size is <strong>less than 992px</strong>, the columns will 
stack horizontally:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Two columns: 50% width on large and up--&gt;<br>&lt;div class=&quot;row&quot;&gt;<br>&nbsp; &lt;div class=&quot;col-lg&quot;&gt;1 of 
  2&lt;/div&gt;<br>
&nbsp;
&lt;div class=&quot;col-lg&quot;&gt;2 of 2&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;!-- Four 
  columns: 25% width on large and up --&gt;<br>&lt;div class=&quot;row&quot;&gt;<br>&nbsp; &lt;div class=&quot;col-lg&quot;&gt;1 of 4&lt;/div&gt;<br>
&nbsp;
&lt;div class=&quot;col-lg&quot;&gt;2 of 4&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;col-lg&quot;&gt;3 
  of 4&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;col-lg&quot;&gt;4 of 4&lt;/div&gt;<br>
  &lt;/div&gt;</div>
...
<a target="_blank" href="tryit.asp?filename=trybs_grid_large_auto&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a></div>
