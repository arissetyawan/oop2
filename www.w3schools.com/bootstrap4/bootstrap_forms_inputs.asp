...
<html lang="en-US">
<head>
<title>Bootstrap 4 Input Groups</title>
...
<h1>Bootstrap 4 <span class="color_h1">Form Inputs</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_forms.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_forms_input_group.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Bootstrap supports all the HTML5 input types: 
text, password, datetime, datetime-local, date, month, time, week, number, 
email, url, search, tel, and color. </p>
<p><strong>Note:</strong> Inputs will NOT be fully styled if their type is not properly declared!</p>
...
<p>The following example contains two input elements; one of <code class="w3-codespan">type="text"</code> and one of 
<code class="w3-codespan">type="password"</code>. As we mentioned in the Forms chapter, we use the <code class="w3-codespan">.form-control</code> class to style inputs with full-width and proper padding, etc:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;form-group&quot;&gt;<br>&nbsp; &lt;label for=&quot;usr&quot;&gt;Name:&lt;/label&gt;<br>&nbsp; &lt;input type=&quot;text&quot; class=&quot;form-control&quot; id=&quot;usr&quot;&gt;<br>&lt;/div&gt;<br>&lt;div class=&quot;form-group&quot;&gt;<br>&nbsp; &lt;label for=&quot;pwd&quot;&gt;Password:&lt;/label&gt;<br>&nbsp; &lt;input type=&quot;password&quot; class=&quot;form-control&quot; id=&quot;pwd&quot;&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_input&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;form-group&quot;&gt;<br>&nbsp; &lt;label for=&quot;comment&quot;&gt;Comment:&lt;/label&gt;<br>&nbsp; &lt;textarea class=&quot;form-control&quot; rows=&quot;5&quot; id=&quot;comment&quot;&gt;&lt;/textarea&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_textarea&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Checkboxes are used if you want the user to select any number of options from 
a list of preset options.</p>
<p>The following example contains three checkboxes. The last option is disabled:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;form-check&quot;&gt;<br>&nbsp; &lt;label class=&quot;form-check-label&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;checkbox&quot; class=&quot;form-check-input&quot; value=&quot;&quot;&gt;Option 1<br>&nbsp; 
  &lt;/label&gt;<br>&lt;/div&gt;<br>&lt;div class=&quot;form-check&quot;&gt;<br>&nbsp; &lt;label 
  class=&quot;form-check-label&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input type=&quot;checkbox&quot; 
  class=&quot;form-check-input&quot; value=&quot;&quot;&gt;Option 2<br>&nbsp; &lt;/label&gt;<br>&lt;/div&gt;<br>
  &lt;div class=&quot;form-check disabled&quot;&gt;<br>&nbsp; &lt;label class=&quot;form-check-label&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;checkbox&quot; class=&quot;form-check-input&quot; value=&quot;&quot; disabled&gt;Option 3<br>&nbsp; 
  &lt;/label&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_checkbox&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example explained</h3>
<p>Use a wrapper element with <code class="w3-codespan">class="form-check"</code> to ensure proper margins for labels and checkboxes.</p>
<p>Add the <code class="w3-codespan">.form-check-label</code> class to label elements, and <code class="w3-codespan">.form-check-input</code> to style checkboxes properly inside the <code class="w3-codespan">.form-check</code> container.</p>
<hr>

<h2>Inline Checkboxes</h2>
<p>Use the <code class="w3-codespan">.form-check-inline</code> class if you want the checkboxes to appear on the 
same line:</p>
<div style="margin:20px 0 25px 0;">
  <div class="form-check form-check-inline">
    <label class="form-check-label"><input type="checkbox" class="form-check-input" value="">Option 1</label>
  </div>
  <div class="form-check form-check-inline">
    <label class="form-check-label"><input type="checkbox" class="form-check-input" value="">Option 2</label>
  </div>
  <div class="form-check form-check-inline disabled">
    <label class="form-check-label"><input type="checkbox" class="form-check-input" value="" disabled>Option 3</label>
  </div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;form-check-inline&quot;&gt;<br>&nbsp; &lt;label class=&quot;form-check-label&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;checkbox&quot; class=&quot;form-check-input&quot; value=&quot;&quot;&gt;Option 1<br>&nbsp; 
  &lt;/label&gt;<br>&lt;/div&gt;<br>&lt;div class=&quot;form-check-inline&quot;&gt;<br>&nbsp; &lt;label 
  class=&quot;form-check-label&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input type=&quot;checkbox&quot; 
  class=&quot;form-check-input&quot; value=&quot;&quot;&gt;Option 2<br>&nbsp; &lt;/label&gt;<br>&lt;/div&gt;<br>
  &lt;div class=&quot;form-check-inline disabled&quot;&gt;<br>&nbsp; &lt;label class=&quot;form-check-label&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;checkbox&quot; class=&quot;form-check-input&quot; value=&quot;&quot; disabled&gt;Option 3<br>&nbsp; 
  &lt;/label&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_checkbox_inline&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Radio buttons are used if you want to limit the user to just one selection 
from a list of preset options.</p>
...
<div class="w3-code notranslate htmlHigh">
  ...
  name=&quot;optradio&quot;&gt;Option 1<br>&nbsp; 
  &lt;/label&gt;<br>&lt;/div&gt;<br>&lt;div class=&quot;form-check&quot;&gt;<br>&nbsp; &lt;label 
  class=&quot;form-check-label&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input type=&quot;radio&quot; 
  class=&quot;form-check-input&quot; name=&quot;optradio&quot;&gt;Option 2<br>&nbsp; &lt;/label&gt;<br>&lt;/div&gt;<br>
  &lt;div class=&quot;form-check disabled&quot;&gt;<br>&nbsp; &lt;label class=&quot;form-check-label&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;radio&quot; class=&quot;form-check-input&quot; name=&quot;optradio&quot; disabled&gt;Option 3<br>&nbsp; 
  &lt;/label&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_radio&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>As with checkboxes, use the <code class="w3-codespan">.form-check-inline</code> class if you want the 
...
<div class="w3-code notranslate htmlHigh">
  ...
  &lt;input type=&quot;radio&quot; class=&quot;form-check-input&quot; name=&quot;optradio&quot; disabled&gt;Option 3<br>&nbsp; 
  &lt;/label&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_radio_inline&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div style="margin:20px 0 25px 0;">
   <div class="form-group">
      ...
      <br>
      <label for="sel2">Multiple select list (hold ctrl or shift (or drag with    the mouse) to select more than one):</label>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;form-group&quot;&gt;<br>&nbsp; &lt;label for=&quot;sel1&quot;&gt;Select list:&lt;/label&gt;<br>&nbsp; &lt;select class=&quot;form-control&quot; id=&quot;sel1&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option&gt;1&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option&gt;2&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option&gt;3&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option&gt;4&lt;/option&gt;<br>&nbsp; &lt;/select&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_select&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Form Control Sizing</h2>
<p>Change the size of the form control with <code class="w3-codespan">.form-control-sm</code> or <code class="w3-codespan">.form-control-lg</code>:</p>
<div style="margin:20px 0 25px 0;">
    <div class="form-group">
      <input type="text" class="form-control form-control-sm" placeholder="Small form control">
    </div>
    <div class="form-group">
      <input type="text" class="form-control" placeholder="Default form control">
    </div>
    <div class="form-group">
...
<a target="_blank" href="tryit.asp?filename=trybs_form-control-size&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Form Control with Plain Text</h2>
<p>Use the <code class="w3-codespan">.form-control-plaintext</code> if you want to style the input field as plain text:</p>
<div style="margin:20px 0 25px 0;">
    <div class="form-group">
      <input type="text" class="form-control" placeholder="Default form control">
    </div>
...
<h3>Example</h3>
  <div class="w3-code notranslate htmlHigh">
    &lt;input type=&quot;text&quot; class=&quot;form-control-plaintext&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form-control-plaintext&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Form Control File and Range</h2>
<p>Add the <code class="w3-codespan">.form-control-range</code> class to <code class="w3-codespan">input type"range"</code> or <code class="w3-codespan">.form-control-file</code> to <code class="w3-codespan">input type"file"</code> to style a range control or a file field with full-width:</p>
<div style="margin:20px 0 25px 0;">
    <div class="form-group">
...
<h3>Example</h3>
  <div class="w3-code notranslate htmlHigh">
    &lt;input type=&quot;range&quot; class=&quot;form-control-range&quot;&gt;<br>&lt;input type=&quot;file&quot; 
    class=&quot;form-control-file border&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form-control-range&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
