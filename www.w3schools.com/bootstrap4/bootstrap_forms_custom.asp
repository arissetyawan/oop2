...
<html lang="en-US">
<head>
<title>Bootstrap 4 Custom Forms</title>
...
<h1>Bootstrap 4 <span class="color_h1">Custom Forms</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_forms_input_group.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_carousel.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-half">
  ...
  <label for="customCheck2">Default checkbox</label>
</div>
</div>
...
<div class="w3-half" style="padding-top:12px">
  ...
  <label for="customRadio2">Default radio</label>
</div>
</div>

<div class="w3-row-padding" style="margin:0 -36px">
<div class="w3-half">
<div class="custom-control custom-radio mt-3">
<p>Custom Range:</p>
...
<div class="w3-half" style="padding-top:18px">
<p>Default Range:</p>
...
<div class="w3-half" xstyle="padding-top:12px">
<select class="mt-3">
...
<p>To create a custom checkbox, wrap a container element, like &lt;div&gt;, with a 
class of <code class="w3-codespan">.custom-control</code> and <code class="w3-codespan">.custom-checkbox</code> around the checkbox. Then add the <code class="w3-codespan">.custom-control-input</code> to the input with type="checkbox".</p>
<p><strong>Tip:</strong> If you use labels for accompanying text, add the <code class="w3-codespan">.custom-control-label</code> class to it. 
Note that the value of the for attribute should match the id of the checkbox:</p>
...
<div class="w3-half">
  ...
  <label for="customCheck3">Default checkbox</label>
</div>
</div>
...
<div class="w3-code notranslate htmlHigh">
  &lt;form&gt;<br>&nbsp; &lt;div class=&quot;custom-control custom-checkbox&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;checkbox&quot; class=&quot;custom-control-input&quot; id=&quot;customCheck&quot; 
  name=&quot;example1&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;label class=&quot;custom-control-label&quot; for=&quot;customCheck&quot;&gt;Check this custom 
  checkbox&lt;/label&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/form&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_custom_checkbox&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Custom Radio buttons</h2>
<p>To create a custom radio button, wrap a container element, like &lt;div&gt;, with a 
class of <code class="w3-codespan">.custom-control</code> and <code class="w3-codespan">.custom-radio</code> around the radio button. Then add the <code class="w3-codespan">.custom-control-input</code> to the input with type="radio".</p>
<p><strong>Tip:</strong> If you use labels for accompanying text, add the <code class="w3-codespan">.custom-control-label</code> class to it. 
Note that the value of the for attribute should match the id of the radio:</p>
...
<div class="w3-half">
  <input type="radio" id="customRadio3" name="example">
  <label for="customRadio3">Default radio</label>
</div>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;form&gt;<br>&nbsp; &lt;div class=&quot;custom-control custom-radio&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;radio&quot; class=&quot;custom-control-input&quot; id=&quot;customRadio&quot; 
  name=&quot;example1&quot; value=&quot;customEx&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;label 
  class=&quot;custom-control-label&quot; for=&quot;customRadio&quot;&gt;Custom radio&lt;/label&gt;<br>&nbsp; 
  &lt;/div&gt; <br>&lt;/form&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_custom_radio&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Inline Custom Form Controls</h2>
<p>If you want the custom form controls to sit side by side (inline), add the <code class="w3-codespan">.custom-control-inline</code> to the wrapper/container:</p>
<div class="custom-control custom-radio custom-control-inline">
  <input type="radio" class="custom-control-input" id="customRadio5" name="example">
  <label class="custom-control-label" for="customRadio5">Custom radio</label>
</div>
<div class="custom-control custom-radio custom-control-inline">
  <input type="radio" class="custom-control-input" id="customRadio6" name="example">
  <label class="custom-control-label" for="customRadio6">Custom radio</label>
</div>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;form&gt;<br>&nbsp; &lt;div class=&quot;custom-control custom-radio
  <span lang="no-bok">custom-control-inline</span>&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;radio&quot; class=&quot;custom-control-input&quot; id=&quot;customRadio&quot; 
  name=&quot;example&quot; value=&quot;customEx&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;label 
  class=&quot;custom-control-label&quot; for=&quot;customRadio&quot;&gt;Custom radio 
  1&lt;/label&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;custom-control custom-radio
  <span lang="no-bok">custom-control-inline</span>&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  ...
  2&lt;/label&gt;<br>&nbsp; 
  &lt;/div&gt; <br>&lt;/form&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_custom_inline&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>To create a custom select menu, add the <code class="w3-codespan">.custom-select</code> class to the 
&lt;select&gt; element:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;form&gt;<br>&nbsp; &lt;select name=&quot;cars&quot; class=&quot;custom-select-sm&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;option selected&gt;Custom Select Menu&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
  value=&quot;volvo&quot;&gt;Volvo&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option value=&quot;fiat&quot;&gt;Fiat&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;option value=&quot;audi&quot;&gt;Audi&lt;/option&gt;<br>&nbsp; &lt;/select&gt;<br>&lt;/form&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_custom_select&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Custom Select Menu Size</h2>
  <p>Use the <code class="w3-codespan">.custom-select-sm</code> class to create a small select menu and the <code class="w3-codespan">.custom-select-lg</code> class for a large one:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;form&gt;<br>&nbsp; &lt;!-- Small --&gt;<br>&nbsp; &lt;select name=&quot;cars&quot; class=&quot;custom-select-sm&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;option selected&gt;Small Custom Select Menu&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
  value=&quot;volvo&quot;&gt;Volvo&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option value=&quot;fiat&quot;&gt;Fiat&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;option value=&quot;audi&quot;&gt;Audi&lt;/option&gt;<br>&nbsp; &lt;/select&gt;<br>
  <br>&nbsp; &lt;!-- Large --&gt;<br>&nbsp; &lt;select name=&quot;cars&quot; class=&quot;custom-select-lg&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;option selected&gt;Large Custom Select Menu&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
  value=&quot;volvo&quot;&gt;Volvo&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option value=&quot;fiat&quot;&gt;Fiat&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;option value=&quot;audi&quot;&gt;Audi&lt;/option&gt;<br>&nbsp; &lt;/select&gt;<br>&lt;/form&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_custom_select_size&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Custom Range</h2>
<p>To create a custom select menu, add the <code class="w3-codespan">.custom-range</code> class to an 
input with type="&lt;range&gt;":</p>
    <label for="customRange">Custom range</label>
    <input type="range" class="custom-range" id="customRange" name="points1"><br><br>
    <label for="defaultRange">Default range</label>
    <input type="range" id="defaultRange" name="points2">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;form&gt;<br>&nbsp; &lt;label for=&quot;customRange&quot;&gt;Custom range&lt;/label&gt;<br>&nbsp; 
  &lt;input type=&quot;range&quot; class=&quot;custom-range&quot; id=&quot;customRange&quot; name=&quot;points1&quot;&gt;<br>&lt;/form&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_custom_range&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Custom File Upload</h2>
<p>To create a custom file upload, wrap a container element with a 
class of <code class="w3-codespan">.custom-file</code> around the input with type="file". Then add the <code class="w3-codespan">.custom-control-input</code> to it.</p>
<p><strong>Tip:</strong> If you use labels for accompanying text, add the <code class="w3-codespan">.custom-control-label</code> class to it. 
Note that the value of the for attribute should match the id of the checkbox:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;form&gt;<br>&nbsp; &lt;div class=&quot;custom-file&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input 
  type=&quot;file&quot; class=&quot;custom-file-input&quot; id=&quot;customFile&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;label class=&quot;custom-file-label&quot; for=&quot;customFile&quot;&gt;Choose file&lt;/label&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&lt;/form&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_form_custom_file&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
