...
<html lang="en-US">
<head>
<title>Bootstrap 4 Text/Typography</title>
...
<h1>Bootstrap 4 <span class="color_h1">Text/Typography</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_grid_basic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_colors.asp">Next &#10095;</a>
</div>
<hr>
<h2>Bootstrap 4 Default Settings</h2>
<p>Bootstrap 4 uses a default 
<code class="w3-codespan">font-size</code> of 16px, and its  
<code class="w3-codespan">line-height</code> is 1.5.</p>
<p>The default <code class="w3-codespan">font-family</code> is &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif.</p>
<p>In addition, all <code class="w3-codespan">&lt;p&gt;</code> elements have 
<code class="w3-codespan">margin-top: 0</code> and <code class="w3-codespan">margin-bottom: 1rem</code> (16px by default).</p>
<hr>

<h2>&lt;h1&gt; - &lt;h6&gt;</h2>
<p>Bootstrap 4 styles HTML headings (<code class="w3-codespan">&lt;h1&gt;</code> to
<code class="w3-codespan">&lt;h6&gt;</code>)&nbsp; with a bolder font-weight and 
an increased font-size:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate fix">
      <h1>h1 Bootstrap heading <span style="margin-left:10px;font-size:16px;font-weight:normal;color:#888">(2.5rem = 40px)</span></h1>
      <h2>h2 Bootstrap heading <span style="margin-left:10px;font-size:16px;font-weight:normal;color:#888">(2rem = 32px)</span></h2>
      <h3>h3 Bootstrap heading <span style="margin-left:10px;font-size:16px;font-weight:normal;color:#888">(1.75rem = 28px)</span></h3>
      <h4>h4 Bootstrap heading <span style="margin-left:10px;font-size:16px;font-weight:normal;color:#888">(1.5rem = 24px)</span></h4>
      <h5>h5 Bootstrap heading <span style="margin-left:10px;font-size:16px;font-weight:normal;color:#888">(1.25rem = 20px)</span></h5>
      <h6>h6 Bootstrap heading <span style="margin-left:10px;font-size:16px;font-weight:normal;color:#888">(1rem = 16px)</span></h6>
</div>
<a target="_blank" href="tryit.asp?filename=trybs_txt_hn&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>

<h2>Display Headings</h2>
<p>Display headings are used to stand out more than normal headings (larger 
font-size and lighter font-weight), and there 
are four classes to choose from: <code class="w3-codespan">.display-1</code>, <code class="w3-codespan">.display-2</code>, <code class="w3-codespan">.display-3</code>, <code class="w3-codespan">.display-4</code></p>
<div class="w3-example">
 <h3>Example</h3>
...
<a target="_blank" href="tryit.asp?filename=trybs_txt_display&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>

<h2>&lt;small&gt;</h2>
<p>In Bootstrap 4 the HTML <code class="w3-codespan">&lt;small&gt;</code> element is used to create a lighter, secondary text in any heading:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate fix">
...
<a target="_blank" href="tryit.asp?filename=trybs_txt_small&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>
...
<hr>
<h2>&lt;mark&gt;</h2>
<p>Bootstrap 4 will style the HTML <code class="w3-codespan">&lt;mark&gt;</code> element 
with a yellow background color and some padding:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate fix">
      <p>Use the mark element to <mark style="background-color:#fcf8e3;padding:.2em;">highlight</mark> text.</p>
</div>
<a target="_blank" href="tryit.asp?filename=trybs_txt_mark&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>

<h2>&lt;abbr&gt;</h2>
<p>Bootstrap 4 will style the HTML <code class="w3-codespan">&lt;abbr&gt;</code> element 
with a dotted border bottom:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate fix">
<p>The <abbr title="World Health Organization">WHO</abbr> was founded in 1948.</p>
</div>
<a target="_blank" href="tryit.asp?filename=trybs_txt_abbr&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>

<h2>&lt;blockquote&gt;</h2>
<p>Add the <code class="w3-codespan">.blockquote</code> class to a <code class="w3-codespan">&lt;blockquote&gt;</code> 
when quoting blocks of content from another source:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-white w3-padding w3-margin-bottom notranslate fix">
<blockquote class="blockquote">
  <p>For 50 years, WWF has been protecting the future of nature. The world's leading conservation organization, WWF works in 100 countries and is supported by 1.2 million members in the United States and close to 5 million globally.</p>
  <br><footer class="blockquote-footer">From WWF's website</footer>
</blockquote>
</div>
<a target="_blank" href="tryit.asp?filename=trybs_txt_blockquote&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>

<h2>&lt;dl&gt;</h2>
<p>Bootstrap 4 will style the HTML <code class="w3-codespan">&lt;dl&gt;</code> element in the following way:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate fix">
      <dl>
...
<a target="_blank" href="tryit.asp?filename=trybs_txt_dl&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>

<h2>&lt;code&gt;</h2>
<p>Bootstrap 4 will style the HTML <code class="w3-codespan">&lt;code&gt;</code> element in the following way:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate fix">
<p>The following HTML elements: <code>span</code>, <code>section</code>, and <code>div</code> defines a section in a document.</p>
</div>
<a target="_blank" href="tryit.asp?filename=trybs_txt_code&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>

<h2>&lt;kbd&gt;</h2>
<p>Bootstrap 4 will style the HTML <code class="w3-codespan">&lt;kbd&gt;</code> element in the following way:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate fix">
<p>Use <kbd>ctrl + p</kbd> to open the Print dialog box.</p>
</div>
<a target="_blank" href="tryit.asp?filename=trybs_txt_kbd&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>

<h2>&lt;pre&gt;</h2>
<p>Bootstrap 4 will style the HTML <code class="w3-codespan">&lt;pre&gt;</code> element in the following way:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate fix">
...
<a target="_blank" href="tryit.asp?filename=trybs_txt_pre&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>

<h2>More Typography Classes</h2>
<p>The Bootstrap 4 classes below can be added to style HTML elements further:</p>
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_text-left-responsive&stacked=h">Try it</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_text-center-responsive&stacked=h">Try it</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_text-right-responsive&stacked=h">Try it</a></td>
  </tr>
  <tr>
...
<h2>Complete Bootstrap 4 CSS Reference</h2>
<p>For a complete reference of all CSS classes available in Bootstrap 4, visit our
<a href="bootstrap_ref_all_classes.asp">Bootstrap 4 All Classes Reference</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_grid_basic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_colors.asp">Next &#10095;</a>
