...
<html lang="en-US">
<head>
<title>Bootstrap 4 JS Button Reference</title>
...
<h1>Bootstrap 4 <span class="color_h1">JS Button</span></h1>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Creates an outlined/bordered button. Use any of the contextual classes as * (btn-outline-primary, btn-outline-success, etc)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-outline&stacked=h">Try it</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Indicates a "less" important action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-danger&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td><code>.btn-toolbar</code></td>
    <td>Combine sets of button groups into button toolbars for more complex components</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-toolbar&stacked=h">Try it</a></td>
  </tr>
  <tr>
...
<p><strong>Note:</strong> Methods can also be passed via data 
attributes; append the method name to data-, as in data-toggle or data-dispose.</p>
...
<div class="w3-code notranslate cssHigh">
 .btn-primary {<br>&nbsp;&nbsp;&nbsp; border-radius: 0;<br>}</div>
...
<p>How to add a specific background color and text color:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .btn{<br>&nbsp;&nbsp;&nbsp; background: #000;<br>&nbsp;&nbsp;&nbsp; color: #fff;<br>}<br><br>.btn:hover {<br>&nbsp;&nbsp;&nbsp; background: #fff;<br>&nbsp;&nbsp;&nbsp; color: #000;<br>}</div>
...
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
 .btn-primary {<br>&nbsp;&nbsp;&nbsp; box-shadow: 1px 2px 5px #000000; <br>}</div>
