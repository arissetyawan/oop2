...
<h1>Bootstrap 4 <span class="color_h1">Alerts</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_jumbotron.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_buttons.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="alert alert-warning fade in alert-dismissible show">
 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true" style="font-size:20px">&times;</span>
  </button>    <strong>Warning!</strong> This alert box indicates a warning that might need attention.
</div>
...
<div class="alert alert-primary fade in alert-dismissible show">
 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true" style="font-size:20px">&times;</span>
  </button>    <strong>Primary!</strong> This alert box indicates an important action.
</div>
<div class="alert alert-secondary fade in alert-dismissible show">
 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true" style="font-size:20px">&times;</span>
  </button>    <strong>Secondary!</strong> This alert box indicates a less important action.
</div>
<div class="alert alert-dark fade in alert-dismissible show">
 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true" style="font-size:20px">&times;</span>
  </button>    <strong>Dark!</strong> Dark grey alert box.
</div>
<div class="alert alert-light fade in alert-dismissible show">
 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true" style="font-size:20px">&times;</span>
  </button>    <strong>Light!</strong> Light grey alert box.
</div>

</div>
<p>Alerts are created with the <code class="w3-codespan">.alert</code> class, followed by one of the 
contextual classes <code class="w3-codespan">.alert-success</code>, <code class="w3-codespan">.alert-info</code>, <code class="w3-codespan">.alert-warning</code>, 
<code class="w3-codespan">.alert-danger</code>, <code class="w3-codespan">.alert-primary</code>, <code class="w3-codespan">.alert-secondary</code>, <code class="w3-codespan">.alert-light</code> or <code class="w3-codespan">.alert-dark</code>:</p>
...
<a target="_blank" href="tryit.asp?filename=trybs_alerts&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Alert Links</h2>
<p>Add the <code class="w3-codespan">alert-link</code> class to any links inside the alert box to create "matching colored links":</p>
  <div class="alert alert-success">
    <strong>Success!</strong> You should <a href="javascript:void(0)" class="alert-link">read this message</a>.
  </div>
  <div class="alert alert-info">
    <strong>Info!</strong> You should <a href="javascript:void(0)" class="alert-link">read this message</a>.
  </div>
  <div class="alert alert-warning">
    <strong>Warning!</strong> You should <a href="javascript:void(0)" class="alert-link">read this message</a>.
  </div>
  <div class="alert alert-danger">
    <strong>Danger!</strong> You should <a href="javascript:void(0)" class="alert-link">read this message</a>.
  </div>
  <div class="alert alert-primary">
    <strong>Primary!</strong> You should <a href="javascript:void(0)" class="alert-link">read this message</a>.
  </div>
  <div class="alert alert-secondary">
    <strong>Secondary!</strong> You should <a href="javascript:void(0)" class="alert-link">read this message</a>.
  </div>
  <div class="alert alert-dark">
    <strong>Dark!</strong> You should <a href="javascript:void(0)" class="alert-link">read this message</a>.
  </div>
  <div class="alert alert-light">
    <strong>Light!</strong> You should <a href="javascript:void(0)" class="alert-link">read this message</a>.
  </div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;alert alert-success&quot;&gt;<br>&nbsp; &lt;strong&gt;Success!&lt;/strong&gt; You should &lt;a href=&quot;#&quot; class=&quot;alert-link&quot;&gt;read this message&lt;/a&gt;.<br>&lt;/div&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=trybs_alerts_link&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>To close the alert message, add a <code class="w3-codespan">.alert-dismissible</code> 
class to the alert container. Then add <code class="w3-codespan">class="close"</code> and <code class="w3-codespan">data-dismiss=&quot;alert&quot;</code> 
to a link or a button element (when you click on this the alert box will 
disappear).</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;alert alert-success alert-dismissible&quot;&gt;<br>
  &nbsp; &lt;button type=&quot;button&quot; class=&quot;close&quot; data-dismiss=&quot;alert&quot;&gt;&amp;times;&lt;/button&gt;<br>&nbsp; &lt;strong&gt;Success!&lt;/strong&gt; Indicates a successful or positive action.<br>
 &lt;/div&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=trybs_alerts_dismissible&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel w3-note">
<p style="margin-bottom:8px"><strong>Tip:</strong> &amp;times; (&times;) is an HTML entity that is the preferred icon for close 
buttons, rather than the letter &quot;x&quot;.<br><br>For a list of all HTML Entities, <a href="/charsets/ref_html_entities_4.asp">visit our HTML Entities Reference</a>.</p>
...
<p>The <code class="w3-codespan">.fade</code> and <code class="w3-codespan">.show</code> classes adds a fading effect when 
closing the alert message:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;alert alert-danger 
  alert-dismissible fade show&quot;&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=trybs_alerts_fade&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Complete Bootstrap 4 Alert Reference</h2>
<p>For a complete reference of all alert options, methods and events, go to our
<a href="bootstrap_ref_js_alert.asp">Bootstrap 4 JS Alert Reference</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_jumbotron.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_buttons.asp">Next &#10095;</a>
