...
<html lang="en-US">
<head>
<title>Bootstrap 4 JS Carousel Reference</title>
...
<h1>Bootstrap 4 <span class="color_h1">JS Carousel</span></h1>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_carousel2" class="w3-btn">Try it Yourself &raquo;</a>
<hr>
...
<div class="w3-code notranslate htmlHigh">
 &lt;!-- Carousel --&gt;<br>&lt;div id=&quot;myCarousel&quot; class=&quot;carousel slide&quot; data-ride=&quot;carousel&quot;&gt;<br><br>&lt;!-- Carousel Indicators --&gt;<br>&lt;li data-target=&quot;#myCarousel&quot; data-slide-to=&quot;1&quot;&gt;&lt;/li&gt;<br><br>&lt;!-- Carousel Controls --&gt;<br>
  &lt;a class=&quot;carousel-control-prev&quot; href=&quot;#myCarousel&quot; data-slide=&quot;prev&quot;&gt;<br>&nbsp; 
  &lt;span class=&quot;carousel-control-prev-icon&quot;&gt;&lt;/span&gt;<br>&lt;/a&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_carousel2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
 // Activate Carousel<br>$(&quot;#myCarousel&quot;).carousel();<br><br>// Enable Carousel Indicators<br>$(&quot;.item&quot;).click(function(){<br>&nbsp;&nbsp;&nbsp; $(&quot;#myCarousel&quot;).carousel(1);<br>});<br><br>// Enable Carousel Controls<br>$(&quot;.carousel-control-prev&quot;).click(function(){<br>&nbsp;&nbsp;&nbsp; $(&quot;#myCarousel&quot;).carousel(&quot;prev&quot;);<br>});
</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_carousel_js" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>5000</td>
    <td>Specifies the delay (in milliseconds) between each slide.<br><br><strong>Note:</strong> Set interval to <strong>false</strong> to stop the items from automatically sliding</td>
    <td><a style="margin-bottom:5px;" target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_interval">Using JS</a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_interval_data">Using data</a></td>
  </tr>
  <tr>
    <td>keyboard</td>
    <td>boolean</td>
    <td>true</td>
    <td>Specifies whether the carousel should react to keyboard events:<br><br>
    <ul>
    <li>true - the carousel can be navigated (next and previous) with the keyboard left and right arrows</li>
    <li>false - the carousel can NOT be navigated with the keyboard left and right arrows</li>
    </ul>
    </td>
    <td>
    <a target="_blank" style="margin-bottom:5px;" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_keyboard">Using JS</a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_keyboard_data">Using data</a></td>
  </tr>
  <tr>
    <td>pause</td>
    ...
    <td><a style="margin-bottom:5px;" target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_pause">Using JS</a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_pause_data">Using data</a></td>
  </tr>
  <tr>
    <td>wrap</td>
    <td>boolean</td>
  ...
  <li>false - stop at the last item</li>
    ...
    <td><a style="margin-bottom:5px;" target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_wrap">Using JS</a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_wrap_data">Using data</a></td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_interval">Try it</a></td>
  </tr>
  <tr>
    <td>.carousel(&quot;cycle&quot;)</td>
    <td>Goes through the carousel items from left to right</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_cycle_pause">Try it</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_number">Try it</a></td>
    </tr>
  <tr>
    <td>.carousel(&quot;prev&quot;)</td>
    <td>Goes to the previous item</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_prev_next">Try it</a></td>
  </tr>
  <tr>
    <td>.carousel(&quot;next&quot;)</td>
  ...
  <tr>
    <td>.carousel(&quot;dispose&quot;)</td>
    <td>Destroys a carousel</td>
    <td></td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_event_slide">Try it</a></td>
  </tr>
  <tr>
    <td>slid.bs.carousel</td>
    <td>Occurs when the carousel has finished sliding from one item to another</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_event_slid">Try it</a></td>
  </tr>
</table>

<p>The slid and slide events also has additional properties:</p>
<table class="w3-table-all notranslate">
  <tr>
    <th>Property</th>
    <th style="width:60%;">Description</th>
  ...
  <tr>
    <td>direction</td>
    <td>Returns the direction the carousel is sliding (left or right)</td>
    <td></td>
  </tr>
  <tr>
    <td>relatedTarget</td>
    <td>Returns the DOM element that is being slid into place as the active item</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_event_relatedtarget">Try it</a></td>
  </tr>
  <tr>
    <td>from</td>
    <td>Returns the index of where the previous item came from, when moving on to the next one</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_event_from">Try it</a></td>
  </tr>
  <tr>
    <td>to</td>
    <td>Returns the index of the next item</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_carousel_event_to">Try it</a></td>
  </tr>
</table>
