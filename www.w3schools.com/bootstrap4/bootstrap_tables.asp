...
<a target="_blank" href="tryit.asp?filename=trybs_table_basic&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_table_striped&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_table_bordered&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_table_hover&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_table_inverse&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_table_dark_striped&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_table_dark_hover&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Borderless Table</h2>
<p>The <code class="w3-codespan">.table-borderless</code> class removes borders from the table:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-padding w3-white notranslate">
<div class="table-responsive">
...
<a target="_blank" href="tryit.asp?filename=trybs_table_borderless&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Contextual Classes</h2>
<p>Contextual classes can be used to color the whole table (<code class="w3-codespan">&lt;table&gt;</code>),&nbsp; 
the table rows (<code class="w3-codespan">&lt;tr&gt;</code>) or table cells (<code class="w3-codespan">&lt;td&gt;</code>).</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-padding w3-white notranslate">
<div class="table-responsive">
...
<a target="_blank" href="tryit.asp?filename=trybs_table_contextual&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>The contextual classes that can be used are:</p>
<div class="table-responsive">
...
<p>The <code class="w3-codespan">.thead-dark</code> class adds a black background to table headers, and the <code class="w3-codespan">.thead-light</code> class adds a grey background to table headers:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-padding w3-white notranslate">
<div class="table-responsive">
...
<a target="_blank" href="tryit.asp?filename=trybs_table_head&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Small table</h2>
<p>The <code class="w3-codespan">.table-sm</code> class makes the table smaller by cutting cell padding in half:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-padding w3-white notranslate">
<div class="table-responsive">
...
<a target="_blank" href="tryit.asp?filename=trybs_table_sm&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Responsive Tables</h2>
<p>The <code class="w3-codespan">.table-responsive</code> class creates a responsive table: an horizontal scrollbar is added to the table on screens that are less than 992px wide (if needed). When viewing on anything 
larger than 992px wide, there is no difference:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;table-responsive&quot;&gt;<br>&nbsp; &lt;table class=&quot;table&quot;&gt;<br>&nbsp;&nbsp;&nbsp; ...<br>&nbsp; &lt;/table&gt;<br>&lt;/div&gt; </div>
<div class="w3-padding w3-white">
<iframe src="trybs_table_responsive_ifr.htm" style="border:none;height:160px;width:100%;"></iframe>
</div>
<a target="_blank" href="tryit.asp?filename=trybs_table_responsive" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>You can also decide when the table should get a scrollbar, depending on screen width:</p>
  <table class="table table-striped table-bordered">
    <thead>
      <tr>
        <th>Class</th>
    ...
    <tbody>
      <tr>
        <td><code class="w3-codespan">.table-responsive-sm</code></td>
        <td>&lt; 576px</td>
      </tr>      
      <tr>
        <td><code class="w3-codespan">.table-responsive-md</code></td>
        <td>&lt; 768px</td>
      </tr>      
      <tr>
        <td><code class="w3-codespan">.table-responsive-lg</code></td>
        <td>&lt; 992px</td>
      </tr>      
      <tr>
        <td><code class="w3-codespan">.table-responsive-xl</code></td>
        <td>&lt; 1200px</td>
      </tr>      
    </tbody>
  </table>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;table-responsive-sm&quot;&gt;<br>&nbsp; &lt;table class=&quot;table&quot;&gt;<br>&nbsp;&nbsp;&nbsp; ...<br>&nbsp; &lt;/table&gt;<br>&lt;/div&gt; </div>
<a target="_blank" href="tryit.asp?filename=trybs_table_responsive_sm" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<!--
<hr>
<h2>Complete Bootstrap 4 Table Reference</h2>
<p>For a complete reference of all table classes, go to our complete
<a href="bootstrap_ref_css_tables.asp" class="w3-border-bottom">Bootstrap 4 Tables Reference</a>.</p>
-->
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_colors.asp">&#10094; Previous</a>
