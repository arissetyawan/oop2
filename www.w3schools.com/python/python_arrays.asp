...
<h1>Python <span class="color_h1">Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_lambda.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_classes.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_array1">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  x = cars[0]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_array2">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  cars[0] = "Toyota"</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_array3">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  x = len(cars)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_array4">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_array5">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_array6">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
cars.pop(1)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_array7">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_array8">Run example &raquo;</a>
</div>
<div class="w3-panel w3-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">remove()</code> method 
