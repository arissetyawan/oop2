...
<h1>Python <span class="color_h1">Dictionaries</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_sets.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_conditions.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_access">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_get">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_change">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_loop">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_loop2">Run example &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>You can also use the <code class="w3-codespan">values()</code> function to 
return values of a dictionary:</p>
<div class="w3-code notranslate pythonHigh">
  for x in thisdict.values():<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_loop_values">Run example &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Loop through both <em>keys</em> and <em>values</em>, by using the
<code class="w3-codespan">items()</code> function:</p>
<div class="w3-code notranslate pythonHigh">
  for x, y in thisdict.items():<br>&nbsp; print(x, y)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_loop_items">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_in">Run example &raquo;</a>
</div>
...
<p>To determine how many items (key-value pairs) a dictionary have, use the <code class="w3-codespan">len()</code> method.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_length">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_add">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_del">Run example &raquo;</a>
</div>
...
&nbsp;&nbsp;"year": 1964<br>
  ...
  print(thisdict)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_pop">Run example &raquo;</a>
</div>
...
&nbsp;&nbsp;"year": 1964<br>
  ...
  print(thisdict)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_popitem">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_del2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_del3">Run example &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
  <p>The <code class="w3-codespan">clear()</code> keyword empties the 
  dictionary:</p>
<div class="w3-code notranslate pythonHigh">
thisdict =	{<br>
&nbsp;&nbsp;"brand": "Ford",<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_clear">Run example &raquo;</a>
</div>
...
<p>It is also possible to use the <span class="w3-codespan">dict()</span> constructor to make a dictionary:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_dictionary_dict">Run example &raquo;</a>
</div>
<hr>
...
<tr><td><a href="ref_dictionary_fromkeys.asp">fromkeys()</a></td><td>Returns a dictionary with the specified keys and values</td></tr>
<tr><td><a href="ref_dictionary_get.asp">get()</a></td><td>Returns the value of the specified key</td></tr>
<tr><td><a href="ref_dictionary_items.asp">items()</a></td><td>Returns a list containing the a tuple for each key value pair</td></tr>
<tr><td><a href="ref_dictionary_keys.asp">keys()</a></td><td>Returns a list contianing the dictionary's keys</td></tr>
...
<hr>
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_dictionaries1" method="post" target="_blank">
