...
<h1>Python <span class="color_h1">JSON</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_datetime.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_pip.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Python has a built-in package called <code class="w3-codespan">json</code>, which can be use to work with JSON data.</p>
...
<div class="w3-panel w3-note">
  <p>The result will be a <a href="python_dictionaries.asp">Python dictionary</a>.</p>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_json">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  print(y)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_json_from_python">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_json_from_python_all">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_json_from_python_all_in_one">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_json_from_python_indent">Run example &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use the <code class="w3-codespan">separators</code> parameter change the 
default separator:</p>
  <div class="w3-code notranslate pythonHigh">
    json.dumps(x, indent=4, separators=(&quot;. &quot;, &quot; = &quot;))<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_json_from_python_separators">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_json_from_python_sort_keys">Run example &raquo;</a>
</div>
