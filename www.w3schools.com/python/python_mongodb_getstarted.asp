...
<h1>Python <span class="color_h1">MongoDB</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mysql_join.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mongodb_create_db.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>MongoDB</h2>
<p>MongoDB stores data in JSON-like documents, which makes the database very 
flexible and scalable.</p>
<p>To be able experiment with the code examples in this tutorial, you will need access to a 
MongoDB database.</p>
...
<h2>PyMongo</h2>
<p>Python needs a MongoDB driver to access the MongoDB database.</p>
<p>In this tutorial we will use the MongoDB driver "PyMongo".</p>
<p>We recommend that you use PIP to install "PyMongo&quot;.</p>
...
<p>Download and install "PyMongo":</p>
<div class="w3-code notranslate w3-black">
C:\Users\<em>Your Name</em>\AppData\Local\Programs\Python\Python36-32\Scripts&gt;python -m pip install pymongo
</div>
</div>
<p>Now you have downloaded and installed a mongoDB driver.</p>
<hr>
<h2>Test PyMongo</h2>
<p>To test if the installation was successful, or if you already have "pymongo" 
installed, create a Python page with 
the following content:</p>
<div class="w3-example">
<p>demo_mongodb_test.py:</p>
<div class="w3-code notranslate jsHigh">
  import pymongo</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_test">Run example &raquo;</a>
</div>

<p>If the above code was executed with no errors, "pymongo" is installed and 
ready to be used.</p>
