...
<a class="w3-left w3-btn" href="python_syntax.asp">&#10094; Previous</a>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_variables1">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_variables2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_variables3">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_variables4">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_variables5">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_variables_test">Run example &raquo;</a>
</div>

<hr>

<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_variables1" method="post" target="_blank">
...
<pre>
<input name="ex1" maxlength="7" style="width: 75px;"> = "<input name="ex2" maxlength="5" style="width: 54px;">"
</pre>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_variables">Run example &raquo;</a>
</div>
