...
<html lang="en-US">
<head>
<title>Python MongoDB Create Collection</title>
<meta charset="utf-8">
...
<h1>Python MongoDB <span class="color_h1">Create Collection</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mongodb_create_db.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mongodb_insert.asp">Next &#10095;</a>
</div>
<hr>
<div class="w3-panel w3-note">
  <p>A <strong>collection</strong> in MongoDB is the same as a <strong>table</strong> in SQL databases.</p>
</div>

<h2>Creating a Collection</h2>
<p>To create a collection in MongoDB, use database object and specify the name 
of the colelction you want to create.</p>
<p>MongoDB will create the collection if it does not exist.</p>
...
<div class="w3-code notranslate pythonHigh">
  ...
  mydb = myclient[&quot;mydatabase&quot;]<br><br>mycol = mydb[&quot;customers&quot;]<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_create_collection">Run example &raquo;</a>
</div>
...
<h2>Check if Collection Exists</h2>
<div class="w3-panel w3-note">
  <p><strong>Remember:</strong> In MongoDB, a collection is not created until it 
  ...
  you check if the collection exists!</p>
</div>

<p>You can check if a collection exist in a database by listing all collections:</p>


<div class="w3-example">
<h3>Example</h3>
<p>Return a list of all collections in your database:</p>
<div class="w3-code notranslate pythonHigh">
  print(mydb.list_collection_names())<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_check_collection">Run example &raquo;</a>
</div>


<p>Or you can check a specific collection by name:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Check if the &quot;customers&quot; collection exists:</p>
<div class="w3-code notranslate pythonHigh">
  collist = mydb.list_collection_names()<br>if &quot;customers&quot; in collist:<br>&nbsp; 
  print(&quot;The collection exists.&quot;)<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_check_collection2">Run example &raquo;</a>
</div>
