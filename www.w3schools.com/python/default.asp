...
<a class="w3-btn w3-margin-bottom" href="python_intro.asp">Start learning Python now &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_default">Run example &raquo;</a>
</div>
