...
<h1>Python <span class="color_h1">For Loops</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_while_loops.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_functions.asp">Next &#10095;</a>
</div>
<hr>
...
<p>This is less like the <span class="w3-codespan">for</span> keyword in other programming language, and works more like an iterator method as found in other object-orientated programming languages.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_for">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_for_string">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_for_break">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_for_break2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_for_continue">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_for_range">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
  <p>Note that <span class="w3-codespan">range(6)</span> is not the values of 0 to 6, but the values 0 to 5.</p>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_for_range2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_for_range3">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_for_else">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_for_nested">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_recursion">Run example &raquo;</a>
</div>
<hr>

<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_loops3" method="post" target="_blank">
