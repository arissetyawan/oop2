...
<h1>Python MySQL <span class="color_h1">Drop Table</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mysql_delete.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mysql_update.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  mydb.cursor()<br><br>sql = &quot;DROP TABLE customers&quot;<br><br>mycursor.execute(sql)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_drop_table">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>mycursor = 
  mydb.cursor()<br><br>sql = &quot;DROP TABLE IF EXISTS customers&quot;<br><br>mycursor.execute(sql)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_drop_table2">Run example &raquo;</a>
</div>
