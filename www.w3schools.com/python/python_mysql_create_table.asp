...
<h1>Python MySQL <span class="color_h1">Create Table</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mysql_create_db.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mysql_insert.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
  <p>create a datebase named "mydatabase":</p>
<div class="w3-code notranslate jsHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>
  &nbsp;
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>
  <strong>&nbsp; database=&quot;mydatabase&quot;</strong><br>)<br><br>mycursor = mydb.cursor()<br>
  <br>mycursor.execute(&quot;CREATE TABLE customers (name VARCHAR(255), 
  address VARCHAR(255))&quot;)<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_create_table">Run example &raquo;</a>
</div>

<p>If the above code was executed with no errors, you have now successfully 
created a table.</p>

<hr>

<h2>Check if Table Exists</h2>

<p>You can check if a database exist by listing all tables in your database by 
using the &quot;SHOW TABLES&quot; statement:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return a list of your system's databases:</p>
<div class="w3-code notranslate pythonHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>&nbsp; 
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br><br>mycursor = mydb.cursor()<br><br>
  mycursor.execute(&quot;SHOW TABLES&quot;)<br><br>for x in mycursor:<br>&nbsp; 
  print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_show_tables">Run example &raquo;</a>
</div>
...
record.</p>
<p>This can be done by defining a PRIMARY KEY.</p>
<p>We use the statement &quot;INT AUTO_INCREMENT PRIMARY KEY&quot; which will insert a 
...
<div class="w3-code notranslate pythonHigh">
  ...
  &nbsp;
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>
  &nbsp; database=&quot;mydatabase&quot;<br>)<br><br>mycursor = mydb.cursor()<br>
  <br>mycursor.execute(&quot;CREATE TABLE customers (id INT AUTO_INCREMENT 
  PRIMARY KEY, name VARCHAR(255), 
  address VARCHAR(255))&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_primary_key">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>
  &nbsp; database=&quot;mydatabase&quot;<br>)<br><br>mycursor = mydb.cursor()<br>
  <br>mycursor.execute(&quot;ALTER TABLE customers ADD COLUMN id INT AUTO_INCREMENT 
  PRIMARY KEY&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_alter_primary_key">Run example &raquo;</a>
</div>
