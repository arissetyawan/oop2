...
<a class="w3-left w3-btn" href="python_lists.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_sets.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_tuple">Run example &raquo;</a>
</div>

<hr>
<h2>Access Tuple Items</h2>
<p>You can access tuple items by referring to the index number:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Return the item in position 1:</p>
<div class="w3-code notranslate pythonHigh">
thistuple = ("apple", "banana", "cherry")<br>
print(thistuple[1])
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_tuple1">Run example &raquo;</a>
</div>

<hr>
<h2>Change Tuple Values</h2>

<p>Once a tuple is created, you cannot change its values. Tuples are <strong>unchangeable</strong>.</p>
<div class="w3-example">
<h3>Example</h3>
<p>You cannot change values in a tuple:</p>
<div class="w3-code notranslate pythonHigh">
thistuple = ("apple", "banana", "cherry")<br>
thistuple[1] = "blackcurrant"<br># The values will remain the same:<br>print(thistuple)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_tuple2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_tuple_loop">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_tuple_in">Run example &raquo;</a>
</div>
...
<p>To determine how many items a list have, use the <code class="w3-codespan">len()</code> method:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_tuple_length">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_tuple_add">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_tuple_del">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_tuple3">Run example &raquo;</a>
</div>
...
<hr>
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_tuples1" method="post" target="_blank">
