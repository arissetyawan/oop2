...
<html lang="en-US">
<head>
<title>Python MySQL Delete From</title>
<meta charset="utf-8">
...
<h1>Python MySQL <span class="color_h1">Delete From By</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mysql_orderby.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mysql_drop_table.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
  <p>Delete any record where the address is &quot;Mountain 21&quot;:</p>
<div class="w3-code notranslate jsHigh">
  ...
  mydb.cursor()<br><br>sql = &quot;DELETE FROM customers WHERE address = 
  'Mountain 21'&quot;<br><br>mycursor.execute(sql)<br><br>mydb.commit()<br><br>print(mycursor.rowcount, &quot;record(s) deleted&quot;)<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_delete">Run example &raquo;</a>
</div>
...
<p>It is considered a good practice to escape the values of any query, also in delete statements.</p>
...
<div class="w3-example">
  <h3>Example</h3>
<p>Escape values by using the placeholder <code class="w3-codespan">%s</code> 
method:</p>
<div class="w3-code notranslate pythonHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>&nbsp;
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br>
  <br>mycursor = mydb.cursor()<br><br>sql = &quot;DELETE FROM customers WHERE address = 
  %s&quot;<br>adr = (&quot;Yellow Garden 2&quot;, )<br><br>
  mycursor.execute(sql, adr)<br><br>mydb.commit()<br><br>print(mycursor.rowcount, &quot;record(s) deleted&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_delete_escape">Run example &raquo;</a>
</div>
