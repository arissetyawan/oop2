...
<h1>Python MongoDB <span class="color_h1">Find</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mongodb_insert.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mongodb_query.asp">Next &#10095;</a>
</div>
<hr>
...
<code class="w3-codespan">find_one()</code> method.</p>
<p>The <code class="w3-codespan">find_one()</code> method returns the first 
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>x = mycol.find_one()<br><br>print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_find_one">Run example &raquo;</a>
</div>
...
<div class="w3-example">
  <h3>Example</h3>
<p>Return all documents in the &quot;customers&quot; collection, and print each document:</p>
<div class="w3-code notranslate pythonHigh">
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  mydb = myclient[&quot;mydatabase&quot;]<br>mycol = mydb[&quot;customers&quot;]<br>
  <br>for x in mycol.find():<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_find">Run example &raquo;</a>
</div>

<hr>

<h2>Return Only Some Fields</h2>
...
<div class="w3-example">
  <h3>Example</h3>
  <p>Return only the names and addresses, not the _ids:</p>
  <div class="w3-code notranslate pythonHigh">
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  mydb = myclient[&quot;mydatabase&quot;]<br>mycol = mydb[&quot;customers&quot;]<br>
  <br>for x in mycol.find({},{ &quot;_id&quot;: 0, &quot;name&quot;: 1, &quot;address&quot;: 1 }):<br>&nbsp; 
    print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_find_some">Run example &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  mydb = myclient[&quot;mydatabase&quot;]<br>mycol = mydb[&quot;customers&quot;]<br>
  <br>for x in mycol.find({},{ &quot;address&quot;: 0 }):<br>&nbsp; 
    print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_find_some2">Run example &raquo;</a>
</div>
...
(except if one of the fields is the _id field):</p>
  <div class="w3-code notranslate pythonHigh" style="border-left:4px solid transparent">
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  mydb = myclient[&quot;mydatabase&quot;]<br>mycol = mydb[&quot;customers&quot;]<br>
  <br>for x in mycol.find({},{ &quot;name&quot;: 1, &quot;address&quot;: 0 }):<br>&nbsp; 
    print(x)</div>
</div>
