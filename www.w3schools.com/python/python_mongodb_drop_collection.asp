...
<html lang="en-US">
<head>
<title>Python MongoDB Drop Collection</title>
<meta charset="utf-8">
...
<h1>Python MongoDB <span class="color_h1">Drop Collection</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mongodb_delete.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mongodb_update.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-example">
  <h3>Example</h3>
<p>Delete the &quot;customers&quot; collection:</p>
<div class="w3-code notranslate pythonHigh">
  ...
  <br>mycol.drop()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_drop_collection">Run example &raquo;</a>
</div>

<p>The <code class="w3-codespan">drop()</code> method returns true if the collection was dropped successfully, 
and false if the collection does not exist.</p>
