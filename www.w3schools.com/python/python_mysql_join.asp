...
<h1>Python MySQL <span class="color_h1">Join</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mysql_limit.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mongodb_getstarted.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>users</h3>
<div class="w3-code notranslate w3-black">{ id: 1, name: 'John', fav: 154},<br>{ id: 
  2, name: 'Peter', fav: 154},<br>{ id: 3, name: 'Amy', fav: 155},<br>{ id: 4, name: 'Hannah', fav:},<br>{ id: 5, name: 'Michael', fav:}<br></div>
</div>

<div class="w3-example">
<h3>products</h3>
<div class="w3-code notranslate w3-black">{ id: 154, name: 
  'Chocolate Heaven' },<br>{ id: 155, name: 'Tasty Lemons' },<br>{ 
  id: 156, name: 'Vanilla Dreams' }</div>
</div>

<p>These two tables can be combined by using users' <code class="w3-codespan">fav</code> field and products' 
...
<div class="w3-code notranslate jsHigh">
  ...
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br><br>
  mycursor = mydb.cursor()<br><br>sql = &quot;SELECT \<br>&nbsp; users.name AS user, 
  \<br>&nbsp; products.name AS favorite \<br>&nbsp; FROM users \<br>&nbsp; INNER JOIN 
  products ON users.fav = products.id&quot;<br><br>mycursor.execute(sql)<br><br>
  myresult = mycursor.fetchall()<br><br>for x in myresult:<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_inner_join">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
  <p><strong>Note:</strong> You can use JOIN instead of INNER JOIN. They will 
...
<h2>LEFT JOIN</h2>
<p>In the example above, Hannah, and Michael were excluded from the result, that 
is because INNER JOIN only shows the records where there is a match.</p>
<p>If you want to show all users, even if they do not have a favorite product, 
...
<div class="w3-code notranslate jsHigh">
  sql = &quot;SELECT \<br>&nbsp; users.name AS user, 
  \<br>&nbsp; products.name AS favorite \<br>&nbsp; FROM users \<br>&nbsp; LEFT JOIN 
  products ON users.fav = products.id&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_left_join">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
  ...
  products ON users.fav = products.id&quot;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_right_join">Run example &raquo;</a>
</div>
