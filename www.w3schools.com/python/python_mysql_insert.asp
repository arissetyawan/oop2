...
<html lang="en-US">
<head>
<title>Python MySQL Insert Into</title>
<meta charset="utf-8">
...
<h1>Python MySQL <span class="color_h1">Insert Into Table</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mysql_create_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mysql_select.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>
  &nbsp;
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br>
  <br>mycursor = mydb.cursor()<br><br>sql = &quot;INSERT INTO customers (name, 
  address) VALUES (%s, %s)&quot;<br>val = (&quot;John&quot;, &quot;Highway 21&quot;)<br>mycursor.execute(sql, 
  val)<br>
  <strong><br>mydb.commit()<br></strong><br>print(mycursor.rowcount, &quot;record inserted.&quot;)<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_insert">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
  <p><strong>Important!:</strong> Notice the statement: 
  <code class="w3-codespan">mydb.commit()</code>. It is required to make the 
  changes, otherwise no 
  changes are made to the table.</p>
</div>

<hr>

<h2>Insert Multiple Rows</h2>
<p>To insert multiple rows into a table, use the <code class="w3-codespan">
executemany()</code> method.</p>
<p>The second parameter of the <code class="w3-codespan">executemany()</code> method 
is a list of tuples, containing the data you want to insert:</p>
<div class="w3-example">
  <h3>Example</h3>
...
<div class="w3-code notranslate pythonHigh">
  ...
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br>
  <br>mycursor = mydb.cursor()<br><br>sql = &quot;INSERT INTO customers (name, 
  address) VALUES (%s, %s)&quot;<br>val = [<br>&nbsp; ('Peter', 'Lowstreet 4'),<br>&nbsp; 
  ...
  ('Chuck', 'Main Road 989'),<br>&nbsp; ('Viola', 'Sideway 1633')<br>]<br><br>
  mycursor.executemany(sql, val)<br><br>mydb.commit()<br><br>print(mycursor.rowcount, &quot;was inserted.&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_insert_many">Run example &raquo;</a>
</div>

<hr>
<h2>Get Inserted ID</h2>
<p>You can get the id of the row you 
just inserted by asking the cursor object.</p>
<div class="w3-panel w3-note">
<p><strong>Note:</strong> If you insert more that one row, the id of the last 
inserted row is returned.</p>
</div>
<div class="w3-example">
  <h3>Example</h3>
<p>Insert one row, and return the ID:</p>
<div class="w3-code notranslate pythonHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>
  &nbsp;
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br>
  <br>mycursor = mydb.cursor()<br><br>sql = &quot;INSERT INTO customers (name, 
  address) VALUES (%s, %s)&quot;<br>val = (&quot;Michelle&quot;, &quot;Blue Village&quot;)<br>
  mycursor.execute(sql, val)<br><br>mydb.commit()<br><br>print(&quot;1 record 
  inserted, ID:&quot;, mycursor.lastrowid)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_insert_id">Run example &raquo;</a>
</div>
