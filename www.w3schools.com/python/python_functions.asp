...
<a class="w3-left w3-btn" href="python_for_loops.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_lambda.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_function">Run example &raquo;</a>
</div>

<hr>
<h2>Parameters</h2>

<p>Information can be passed to functions as parameter.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_function_param">Run example &raquo;</a>
</div>
...
<p>If we call the function without parameter, it uses the default value:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_function_param2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_function_return">Run example &raquo;</a>
</div>
<hr>
