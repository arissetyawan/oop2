...
<html lang="en-US">
<head>
<title>Python Delete File</title>
<meta charset="utf-8">
...
<h1>Python <span class="color_h1">Delete File</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_file_write.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mysql_getstarted.asp">Next &#10095;</a>
</div>
<hr>
...
<p>To avoid getting an error, you might want to check if the file exist before you try to delete it:</p>
<div class="w3-example">
  <h3>Example</h3>
<p>Check if file exist, <em>then</em> delete it:</p>
<div class="w3-code notranslate pythonHigh">
