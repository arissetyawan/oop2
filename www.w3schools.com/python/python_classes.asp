...
<h1>Python <span class="color_h1">Classes and Objects</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_arrays.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_iterators.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_class2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_class3">Run example &raquo;</a>
</div>
<div class="w3-panel w3-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">__init__()</code> function is called automatically every time the class is being used to create a new object.</p>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  36)<br>p1.myfunc()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_class4">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
  <p><strong>Note:</strong> The <code class="w3-codespan">self</code> parameter 
  is a reference to the class instance itself, and is used to access variables that belongs to the class.</p>
</div>

<hr>

<h2>The self Parameter</h2>
<p>The <code class="w3-codespan">self</code> parameter is a reference to the class itself, and is used to access variables that belongs to the class.</p>
...
<div class="w3-code notranslate pythonHigh">
  ...
  36)<br>p1.myfunc()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_class5">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  p1.age = 40</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_class6">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  del p1.age</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_class7">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  del p1</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_class8">Run example &raquo;</a>
</div>
