...
<h1>Python <span class="color_h1">Sets</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_tuples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_dictionaries.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
  <p><strong>Note:</strong> Sets are unordered, so the items will appear in a random order.</p>
</div>
...
<p>You cannot access items in a set by referring to an index, since sets are 
unordered the items has no index.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set_loop">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  in thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set_in">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set_add">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set_update">Run example &raquo;</a>
</div>
...
<p>To determine how many items a set have, use the <code class="w3-codespan">len()</code> method.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set_length">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set_remove">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set_discard">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set_pop">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  thisset.clear()<br><br>
  print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set_clear">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  thisset<br><br>
  print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set_del">Run example &raquo;</a>
</div>
...
print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_set2">Run example &raquo;</a>
</div>
<hr>
...
<tr><td><a href="ref_set_pop.asp">pop()</a></td><td>Removes the specified element</td></tr>
...
<hr>
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_sets1" method="post" target="_blank">
