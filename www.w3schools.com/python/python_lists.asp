...
<a class="w3-left w3-btn" href="python_operators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_tuples.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_access">Run example &raquo;</a>
</div>
...
refer to the index number:<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_change">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_loop">Run example &raquo;</a>
</div>

<p>You will learn more about <code class="w3-codespan">for</code> loops in out <a href="python_for_loops.asp">Python For Loops</a> Chapter.</p>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_in">Run example &raquo;</a>
</div>
...
<p>To determine how many items a list have, use the <code class="w3-codespan">
len()</code> method:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_len">Run example &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Using the append() method to append an item:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>
thislist.append("orange")<br>
print(thislist)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_append">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_insert">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_remove">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_pop">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_del">Run example &raquo;</a>
</div>
...
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>
  del
thislist<br>print(thislist)
  #this will cause an error because &quot;thislist&quot; no longer exists.</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_del2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_clear">Run example &raquo;</a>
</div>
...
<p>It is also possible to use the <span class="w3-codespan">list()</span> constructor to make a list.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_list_constructor">Run example &raquo;</a>
</div>
...
<hr>
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_lists1" method="post" target="_blank">
