...
<h1>How to Reverse a String in Python</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_howto_remove_duplicates.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_exercises.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">Learn how to reverse a String in Python.</p>

<hr>
<p>There is no built-in function to reverse a String in Python.</p>
<p>The fastest (and easiest?) way is to use a slice that steps backwards, <code class="w3-codespan">-1</code>.</p>
<div class="w3-example">

  <h3>Example</h3>
  <p>Reverse the string "Hello World":</p>
<div class="w3-code notranslate pythonHigh">
  txt = &quot;Hello World&quot;[::-1]<br>print(txt)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_howto_reverse_string">Run example &raquo;</a>
</div>


<h2>Example Explained</h2>

<p>We have a string, &quot;Hello World&quot;, which we want to reverse:</p>

<div class="w3-example">
<h3>The String to Reverse</h3>
<div class="w3-code notranslate">
  <span class="pythonHigh opacityexampletext">txt = </span><strong class="pythonHigh">&quot;Hello World&quot;</strong><span class="pythonHigh opacityexampletext">[::-1]<br>
  print(txt)</span></div>
</div>

<p>Create a slice that starts at the end of the string, and moves backwards.</p>
<p>The slice statement <code class="w3-codespan">[::-1]</code> is the same as
<code class="w3-codespan">[11:0:-1]</code> which means start at position 11 
(because &quot;Hello &quot;World&quot; has 11 characters), end at position 0, move with the 
step <code class="w3-codespan">-1</code>, <em>negative</em> one, which means one step backwards. </p>

<div class="w3-example">
  <h3>Slice the String</h3>
<div class="w3-code notranslate">
  <span class="pythonHigh opacityexampletext">txt = &quot;Hello World&quot;</span><strong class="pythonHigh">[::-1]</strong><span class="pythonHigh opacityexampletext"><br>
  print(txt)</span></div>
</div>

<p>Now we have a string <code class="w3-codespan">txt</code> that reads &quot;Hello 
World&quot; backwards.</p>

<p>Print the String to demonstrate the result</p>

<div class="w3-example">
<h3>Print the List</h3>
<div class="w3-code notranslate">
  <span class="pythonHigh opacityexampletext">txt = &quot;Hello World&quot;[::-1]</span><br>
  <strong class="pythonHigh">print(txt)</strong></div>
</div>
...
<p>If you like to have a function where you can send your strings, and return 
them 
...
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  def my_function(x):<br>&nbsp; return x[::-1]<br><br>mytxt = 
  my_function(&quot;I wonder how this text looks like backwards&quot;)<br>
  <br>print(mytxt)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_howto_reverse_string2">Run example &raquo;</a>
</div>

<h2>Example Explained</h2>

<p>Create a function that takes a String as an argument.</p>

<div class="w3-example">
<h3>Create a Function</h3>
<div class="w3-code notranslate">
  <strong class="pythonHigh">def my_function(x):</strong><br>
  &nbsp; <span class="pythonHigh opacityexampletext">return x[::-1]<br><br>mytxt = 
  my_function(&quot;I wonder how this text looks like backwards&quot;)<br>
  <br>print(mytxt)</span>
</div>
</div>

<p>Slice the string starting at the end of the string and move backwards.</p>
<div class="w3-example">
<h3>Slice the String</h3>
<div class="w3-code notranslate">
  <span class="pythonHigh opacityexampletext">def my_function(x):<br>
  &nbsp; return x</span><strong class="pythonHigh">[::-1]</strong><span class="pythonHigh opacityexampletext"><br><br>mytxt = 
  my_function(&quot;I wonder how this text looks like backwards&quot;)<br>
  <br>print(mytxt)</span>
</div>
</div>

<p>Return the backward String</p>
<div class="w3-example">
<h3>Return the String</h3>
<div class="w3-code notranslate">
  <span class="pythonHigh opacityexampletext">def my_function(x):<br>
  &nbsp; </span><strong class="pythonHigh">return</strong><span class="pythonHigh opacityexampletext"> 
  x[::-1]</span><br><br><span class="pythonHigh opacityexampletext">mytxt = 
  my_function(&quot;I wonder how this text looks like backwards&quot;)<br>
  <br>print(mytxt )</span>
</div>
</div>

<p>Call the function, with a string as a parameter:</p>
...
<div class="w3-code notranslate">
  ...
  &nbsp; return 
  x[:-1]<br><br>
  </span><strong class="pythonHigh">mytxt = my_function(&quot;I 
  wonder how this text looks like backwards&quot;)<br>
  <br></strong><span class="pythonHigh opacityexampletext">print(mytxt)</span>
</div>
</div>
...
<div class="w3-code notranslate">
  ...
  &nbsp; return 
  x[::-1]<br><br>
  mytxt = my_function(&quot;I wonder how this text looks like backwards&quot;)<br>
  <br></span><strong class="pythonHigh">print(mytxt)</strong>
</div>
</div>
