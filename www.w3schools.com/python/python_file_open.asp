...
<h1>Python <span class="color_h1">File Open</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_file_handling.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_file_write.asp">Next &#10095;</a>
</div>
<hr>

<h2>Open a File on the Server</h2>

<p>Asume we have the following file, located in the same folder as Python:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_open">Run example &raquo;</a>
</div>
...
<p>By default the <code class="w3-codespan">read()</code> method returns the whole text, but you can also specify how many character you want to return:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_open2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_readline">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_readline2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_file_readline3">Run example &raquo;</a>
</div>
