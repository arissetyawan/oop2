...
<h1>Python <span class="color_h1">Lambda</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_functions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_arrays.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">A lambda function is a small anonymous function.</p>
<p class="intro">A lambda function can take any number of arguments, but can 
only have one expression.</p>
...
<h3>Example</h3>
  <p>A lambda function that adds 10 to the number passed in as an argument, and 
  print the result:</p>
<div class="w3-code notranslate pythonHigh">
  x = lambda a : a + 10<br>print(x(5))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_lambda">Run example &raquo;</a>
...
<div class="w3-example">
<h3>Example</h3>
  <p>A lambda function that multiplies argument a with argument b and print the 
  result:</p>
<div class="w3-code notranslate pythonHigh">
  x = lambda a, b : a * b<br>print(x(5, 6))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_lambda2">Run example &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
  <p>A lambda function that sums argument a, b, and c and print the 
  result:</p>
<div class="w3-code notranslate pythonHigh">
  x = lambda a, b, c : a + b + c<br>print(x(5, 6, 
  2))</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_lambda3">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_lambda_double">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_lambda_triple">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_lambda_both">Run example &raquo;</a>
</div>
...
<hr>
<form id="w3-exerciseform" action="exercise.asp?filename=exercise_functions5" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>Create a lambda function that takes one parameter (<code class="w3-codespan">a</code>) and returns it.</p>
<div class="exerciseprecontainer">
<pre>
x = <input name="ex1" maxlength="6" style="width: 65px;"> <input name="ex2" maxlength="1" style="width: 11px;"> <input name="ex3" maxlength="1" style="width: 12px;"> <input name="ex4" maxlength="1" style="width: 11px;">
</pre>
</div>
<br>
...
<!--
<hr>
<h2>Lambda Functions in map() Functions</h2>
-->
