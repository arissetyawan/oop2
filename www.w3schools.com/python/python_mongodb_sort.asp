...
<h1>Python MongoDB <span class="color_h1">Sort</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mongodb_query.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mongodb_delete.asp">Next &#10095;</a>
</div>
<hr>
<h2>Sort the Result</h2>
<p>Use the <code class="w3-codespan">sort()</code> method to sort the result in 
ascending or descending order.</p>
<p>The <code class="w3-codespan">sort()</code> method takes one parameter for 
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>mydoc = mycol.find().sort(&quot;name&quot;)<br><br>for x in mydoc:<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_sort">Run example &raquo;</a>
</div>

<hr>

<h2>Sort Descending</h2>
<p>Use the value -1 as the second parameter to sort descending.</p>

<div class="w3-panel w3-note">
  <p>
  sort("name", 1) #ascending<br>
...
<div class="w3-code notranslate pythonHigh">
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  mydb = myclient[&quot;mydatabase&quot;]<br>mycol = mydb[&quot;customers&quot;]<br>
  <br>mydoc = mycol.find().sort(&quot;name&quot;, -1)<br><br>for x in mydoc:<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_sort2">Run example &raquo;</a>
</div>
