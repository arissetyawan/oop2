...
<html lang="en-US">
<head>
<title>Python MySQL Where</title>
<meta charset="utf-8">
...
<h1>Python MySQL <span class="color_h1">Where</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mysql_select.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mysql_orderby.asp">Next &#10095;</a>
</div>
<hr>

<h2>Select With a Filter</h2>
<p>When selecting records from a table, you can filter the selection by using 
the "WHERE" statement:</p><div class="w3-example">
<h3>Example</h3>
  <p>Select record(s) where the address is "Park Lane 38":
  result:</p>
<div class="w3-code notranslate jsHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>&nbsp;
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br><br>mycursor = 
  mydb.cursor()<br><br>sql = &quot;SELECT * FROM customers WHERE address ='Park Lane 
  38'&quot;<br><br>mycursor.execute(sql)<br><br>
  myresult = mycursor.fetchall()<br><br>for x in myresult:<br>&nbsp; print(x)<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_where">Run example &raquo;</a>
</div>
...
or phrase.</p>
<p>Use the <code class="w3-codespan">%</code>&nbsp; to represent wildcard 
characters:</p>
<div class="w3-example">
  <h3>Example</h3>
<p>Select records where the address contains the word &quot;way&quot;:</p>
<div class="w3-code notranslate pythonHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>&nbsp;
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br>
  <br>mycursor = mydb.cursor()<br><br>sql = &quot;SELECT * FROM customers WHERE address 
  LIKE '%way%'&quot;<br><br>mycursor.execute(sql)<br><br>myresult = mycursor.fetchall()<br><br>for x in myresult:<br>&nbsp; 
  print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_where_wildcard">Run example &raquo;</a>
</div>

<hr>

<h2>Prevent SQL Injection</h2>
<p>When query values are provided by the user, you should escape the values.</p>
<p>This is to prevent SQL injections, which is a common web hacking technique to  
destroy or misuse your database.</p>
<p>The mysql.connector module has methods to escape query values:</p>
<div class="w3-example">
  <h3>Example</h3>
<p>Escape query values by using the placholder <code class="w3-codespan">%s</code> 
method:</p>
<div class="w3-code notranslate pythonHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>&nbsp;
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br>
  <br>mycursor = mydb.cursor()<br><br>sql = &quot;SELECT * FROM customers WHERE 
  address = %s&quot;<br>adr = (&quot;Yellow Garden 2&quot;, )<br><br>
  mycursor.execute(sql, adr)<br><br>myresult = mycursor.fetchall()<br><br>for x in myresult:<br>&nbsp; 
  print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_where_escape">Run example &raquo;</a>
</div>
