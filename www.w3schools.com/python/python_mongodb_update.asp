...
<html lang="en-US">
<head>
<title>Python MongoDB Update</title>
<meta charset="utf-8">
...
<h1>Python MongoDB <span class="color_h1">Update</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mongodb_drop_collection.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mongodb_limit.asp">Next &#10095;</a>
</div>
<hr>
<h2>Update Collection</h2>

<p>You can update a record, or document as it is called in MongoDB, by using 
the <code class="w3-codespan">update_one()</code> method.</p>
<p>The first parameter of the <code class="w3-codespan">update_one()</code> method 
...
<div class="w3-example">
  <h3>Example</h3>
<p>Change the address from &quot;Valley 345&quot; to &quot;Canyon 123&quot;:</p>
<div class="w3-code notranslate pythonHigh">
  ...
  <br>myquery = { &quot;address&quot;: &quot;Valley 345&quot; }<br>newvalues = { &quot;$set&quot;: { 
  &quot;address&quot;: &quot;Canyon 123&quot; } }<br>
  <br>mycol.update_one(myquery, newvalues)<br><br>#print &quot;customers&quot; after the update:<br>for x in mycol.find():<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_update_one">Run example &raquo;</a>
</div>
...
the <code class="w3-codespan">update_many()</code> method.</p>

<div class="w3-example">
  <h3>Example</h3>
<p>Update all documents were the address starts with the letter &quot;S&quot;:</p>
<div class="w3-code notranslate pythonHigh">
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  mydb = myclient[&quot;mydatabase&quot;]<br>mycol = mydb[&quot;customers&quot;]<br>
  <br>myquery = { &quot;address&quot;: { &quot;$regex&quot;: &quot;^S&quot; } }<br>newvalues = { &quot;$set&quot;: { 
  &quot;name&quot;: &quot;Minnie&quot; } }<br>
  <br>x = mycol.update_many(myquery, newvalues)<br><br>print(x.modified_count, &quot;documents updated.&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_update_many">Run example &raquo;</a>
</div>
