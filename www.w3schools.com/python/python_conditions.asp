...
<a class="w3-left w3-btn" href="python_dictionaries.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_while_loops.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_if2">Run example &raquo;</a>
</div>
...
<p>Python relies on indentation, using whitespace, to define scope in the code. Other programming languages often use curly-brackets for this purpose.
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_if_error">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_if_elif">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_if_else">Run example &raquo;</a>
</div>

<p>In this example <span class="w3-codespan">a</span> is greater to <span class="w3-codespan">b</span>,
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_if_else2">Run example &raquo;</a>
</div>
<hr>
<h2>Short Hand If</h2>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_if_short">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  print(&quot;A&quot;) if a &gt; b else print(&quot;B&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_if_else_short">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  print(&quot;A&quot;) if a &gt; b else print(&quot;=&quot;) if a == b else print(&quot;B&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_if_else_short2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_if_and">Run example &raquo;</a>
</div>
...
if a > b or a &gt; c:<br>
	&nbsp;
	print("At least one of the conditions are True")<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_if_or">Run example &raquo;</a>
</div>
<hr>
<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_ifelse1" method="post" target="_blank">
