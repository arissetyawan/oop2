...
<html lang="en-US">
<head>
<title>Python MySQL Update Table</title>
<meta charset="utf-8">
...
<h1>Python MySQL <span class="color_h1">Update Table</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mysql_drop_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mysql_limit.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
  <p>Overwrite the address column from &quot;Valley 345&quot; to &quot;Canyoun 123&quot;:</p>
<div class="w3-code notranslate jsHigh">
  ...
  mydb.cursor()<br><br>sql = &quot;UPDATE customers SET address = 'Canyon 123' 
  WHERE address = 'Valley 345'&quot;<br><br>mycursor.execute(sql)<br><br>mydb.commit()<br>
  <br>print(mycursor.rowcount, &quot;record(s) affected&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_update">Run example &raquo;</a>
</div>
...
<p>It is considered a good practice to escape the values of any query, also in 
update statements.</p>
<p>This is to prevent SQL injections, which is a common web hacking technique to  
destroy or misuse your database.</p>
<p>The mysql.connector module uses the placeholder <code class="w3-codespan">%s</code> to escape values in the delete statement:</p>
<div class="w3-example">
  <h3>Example</h3>
<p>Escape values by using the placholder <code class="w3-codespan">%s</code> 
method:</p>
<div class="w3-code notranslate pythonHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>&nbsp;
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br>
  <br>mycursor = mydb.cursor()<br><br>sql = &quot;UPDATE customers SET address = %s 
  WHERE address = %s&quot;<br>val = (&quot;Valley 345&quot;, &quot;Canyon 123&quot;)<br><br>mycursor.execute(sql, 
  val)<br><br>mydb.commit()<br><br>print(mycursor.rowcount, &quot;record(s) 
  affected&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_update_escape">Run example &raquo;</a>
</div>
