...
<html lang="en-US">
<head>
<title>Python MongoDB Delete Document</title>
<meta charset="utf-8">
...
<h1>Python MongoDB <span class="color_h1">Delete Document</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mongodb_sort.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mongodb_drop_collection.asp">Next &#10095;</a>
</div>
<hr>
<h2>Delete Document</h2>

<p>To delete one document, we use the
<code class="w3-codespan">delete_one()</code> method.</p>
<p>The first parameter of the <code class="w3-codespan">delete_one()</code> method 
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>myquery = { &quot;address&quot;: &quot;Mountain 21&quot; }<br>
  <br>mycol.delete_one(myquery)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_delete_one">Run example &raquo;</a>
</div>

<hr>

<h2>Delete Many Documents</h2>

<p>To delete more than one document, use the
<code class="w3-codespan">delete_many()</code> method.</p>
<p>The first parameter of the <code class="w3-codespan">delete_many()</code> method 
is a query object defining which documents to delete.</p>

<div class="w3-example">
  <h3>Example</h3>
<p>Delete all documents were the address starts with the letter S:</p>
<div class="w3-code notranslate pythonHigh">
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  mydb = myclient[&quot;mydatabase&quot;]<br>mycol = mydb[&quot;customers&quot;]<br>
  <br>myquery = { &quot;address&quot;: {&quot;$regex&quot;: &quot;^S&quot;} }<br>
  <br>x = mycol.delete_many(myquery)<br><br>print(x.deleted_count, &quot; documents 
  deleted.&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_delete_many">Run example &raquo;</a>
</div>

<hr>

<h2>Delete All Documents in a Collection</h2>

<p>To delete all documents in a collection, pass an empty query object to the <code class="w3-codespan">delete_many()</code> method:</p>

<div class="w3-example">
  <h3>Example</h3>
<p>Delete all documents in the &quot;customers&quot; collection:</p>
<div class="w3-code notranslate pythonHigh">
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  mydb = myclient[&quot;mydatabase&quot;]<br>mycol = mydb[&quot;customers&quot;]<br>
  <br>x = mycol.delete_many({})<br><br>print(x.deleted_count, &quot; documents 
  deleted.&quot;)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_delete_all">Run example &raquo;</a>
</div>
