...
<html lang="en-US">
<head>
<title>How to remove duplicates from a Python List</title>
<meta charset="utf-8">
...
<h1>How to Remove Duplicates From a Python List</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_ref_keywords.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_howto_reverse_string.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">Learn how to remove duplicates from a List in Python.</p>

<hr>
<div class="w3-example">
<h3>Example</h3>
  <p>Remove any duplicates from a List:</p>
<div class="w3-code notranslate pythonHigh">
  mylist = [&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;]<br>mylist = list(dict.fromkeys(mylist))<br>
  print(mylist)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_howto_remove_duplicates">Run example &raquo;</a>
</div>


<h2>Example Explained</h2>

<p>First we have a List that contains duplicates:</p>

<div class="w3-example">
<h3>A List with Duplicates</h3>
<div class="w3-code notranslate">
  <strong class="pythonHigh">mylist = [&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;]<br>
  </strong>
<span class="pythonHigh opacityexampletext">
mylist = list(dict.fromkeys(mylist))<br>
print(mylist)
</span>
</div>
</div>

<p>Create a dictionary, 
using the List items as keys. This will automatically remove any duplicates 
because dictionaries cannot have duplicate keys.</p>
...
<div class="w3-example">
  ...
  <div class="w3-code notranslate">
    ...
    <span class="pythonHigh opacityexampletext">mylist = list(</span><strong class="pythonHigh">dict.fromkeys(mylist)</strong><span class="pythonHigh opacityexampletext">)<br>
    print(mylist)</span>
  </div>
</div>

<p>Then, convert the dictionary back into a list:</p>

<div class="w3-example">
<h3>Convert Into a List</h3>
  <div class="w3-code notranslate">
    <span class="pythonHigh opacityexampletext">
      mylist = [&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;]<br>
    </span>
    <strong class="pythonHigh">mylist = list(</strong><span class="pythonHigh opacityexampletext">dict.fromkeys(mylist)</span><strong class="pythonHigh">)</strong><br>
    <span class="pythonHigh opacityexampletext">print(mylist)</span>
  </div>
</div>

<p>Now we have a List without any duplicates, and it has the same order as the 
original List.</p>

<p>Print the List to demonstrate the result</p>
...
<h3>Print the List</h3>
  <div class="w3-code notranslate">
    <span class="pythonHigh opacityexampletext">
    mylist = [&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;]<br>
    mylist = list(dict.fromkeys(mylist))<br></span>
    <strong class="pythonHigh">print(mylist)</strong>
  </div>
</div>
...
<p>If you like to have a function where you can send your lists, and get them 
back without duplicates, you can create a function and insert the code from the 
example above.</p>
<div class="w3-example">
  <h3>Example</h3>
<div class="w3-code notranslate pythonHigh">
  def my_function(x):<br>&nbsp; return list(dict.fromkeys(x))<br><br>mylist = 
  my_function([&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;])<br>
  <br>print(mylist)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_howto_remove_duplicates2">Run example &raquo;</a>
</div>

<h2>Example Explained</h2>

<p>Create a function that takes a List as an argument.</p>

<div class="w3-example">
<h3>Create a Function</h3>
<div class="w3-code notranslate">
  <strong class="pythonHigh">def my_function(x):</strong><br>
  &nbsp; <span class="pythonHigh opacityexampletext">return list(dict.fromkeys(x))<br><br>mylist = 
  my_function([&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;])<br>
  <br>print(mylist)</span>
</div>
</div>

<p>Create a dictionary, using this List items as keys.</p>
<div class="w3-example">
<h3>Create a Dictionary</h3>
<div class="w3-code notranslate">
  <span class="pythonHigh opacityexampletext">def my_function(x):<br>
  &nbsp; return list(</span><strong class="pythonHigh">dict.fromkeys(x)</strong><span class="pythonHigh opacityexampletext">)<br><br>mylist = 
  my_function([&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;])<br>
  <br>print(mylist)</span>
</div>
</div>

<p>Convert the dictionary into a list.</p>
<div class="w3-example">
<h3>Convert Into a List</h3>
<div class="w3-code notranslate">
  <span class="pythonHigh opacityexampletext">def my_function(x):<br>
  &nbsp; return </span><strong class="pythonHigh">list(</strong><span class="pythonHigh opacityexampletext">dict.fromkeys(x)</span><strong class="pythonHigh">)</strong><br><br><span class="pythonHigh opacityexampletext">mylist = 
  my_function([&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;])<br>
  <br>print(mylist)</span>
</div>
</div>
...
<div class="w3-code notranslate">
  <span class="pythonHigh opacityexampletext">def my_function(x):<br>
  &nbsp; </span><strong class="pythonHigh">return</strong><span class="pythonHigh opacityexampletext"> list(dict.fromkeys(x))<br><br>mylist = 
  my_function([&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;])<br>
  <br>print(mylist)</span>
</div>
</div>

<p>Call the function, with a list as a parameter:</p>

<div class="w3-example">
<h3>Call the Function</h3>
<div class="w3-code notranslate">
  <span class="pythonHigh opacityexampletext">def my_function(x):<br>
  &nbsp; return list(dict.fromkeys(x))<br><br>
  </span><strong class="pythonHigh">mylist = my_function([&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;])<br>
  <br></strong><span class="pythonHigh opacityexampletext">print(mylist)</span>
</div>
</div>
...
<div class="w3-code notranslate">
  <span class="pythonHigh opacityexampletext">def my_function(x):<br>
  &nbsp; return list(dict.fromkeys(x))<br><br>
  mylist = my_function([&quot;a&quot;, &quot;b&quot;, &quot;a&quot;, &quot;c&quot;, &quot;c&quot;])<br>
  <br></span><strong class="pythonHigh">print(mylist)</strong>
</div>
</div>
