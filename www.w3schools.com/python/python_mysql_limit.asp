...
<html lang="en-US">
<head>
<title>Python MySQL Limit</title>
<meta charset="utf-8">
...
<h1>Python MySQL <span class="color_h1">Limit</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mysql_update.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mysql_join.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  mydb.cursor()<br><br>mycursor.execute(&quot;SELECT * FROM customers LIMIT 5&quot;)<br><br>myresult = mycursor.fetchall()<br><br>for x in 
  myresult:<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_limit">Run example &raquo;</a>
</div>
...
<div class="w3-example">
<h3>Example</h3>
  <p>Start from position 3, and return 5 records:</p>
<div class="w3-code notranslate jsHigh">
  import mysql.connector<br><br>mydb = mysql.connector.connect(<br>&nbsp; host=&quot;localhost&quot;,<br>&nbsp;
  user=&quot;<em>yourusername</em>&quot;,<br>&nbsp; passwd=&quot;<em>yourpassword</em>&quot;,<br>&nbsp; database=&quot;mydatabase&quot;<br>)<br><br>mycursor = 
  mydb.cursor()<br><br>mycursor.execute(&quot;SELECT * FROM customers LIMIT 5 
  OFFSET 2&quot;)<br><br>myresult = mycursor.fetchall()<br><br>for x in 
  myresult:<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_limit_offset">Run example &raquo;</a>
</div>
