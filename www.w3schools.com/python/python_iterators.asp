...
<h1>Python <span class="color_h1">Iterators</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_classes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_modules.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<p>Return a iterator from a tuple, and print each value:</p>
  <div class="w3-code notranslate pythonHigh">
    mytuple = (&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;)<br>myit = iter(mytuple)<br><br>
    print(next(myit))<br>print(next(myit))<br>print(next(myit))<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_iterator">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_iterator2">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>for x in mytuple:<br>
    &nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_iterator_loop">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>for x in mystr:<br>
    &nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_iterator_loop2">Run example &raquo;</a>
</div>

<p>The <code class="w3-codespan">for</code> loop actually creates in iterator object and executes the next() 
...
<p>As you have learned in the <a href="python_classes.asp">Python 
Classes/Objects</a> chapter, all classes have a function called
<code class="w3-codespan">__init__()</code>, which allows you do some 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_iterator_create">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_iterator_create2">Run example &raquo;</a>
</div>
<hr>
