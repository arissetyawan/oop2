...
<html lang="en-US">
<head>
<title>Python MongoDB Create Database</title>
<meta charset="utf-8">
...
<h1>Python MongoDB <span class="color_h1">Create Database</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mongodb_getstarted.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mongodb_create_collection.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<p>Create a database called "mydatabase":</p>
<div class="w3-code notranslate pythonHigh">
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  <br>mydb = myclient[&quot;mydatabase&quot;]<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_create_db">Run example &raquo;</a>
</div>
...
<div class="w3-panel w3-note">
  <p><strong>Remember:</strong> In MongoDB, a database is not created until it 
  ...
  you check if the database exists!</p>
</div>

<p>You can check if a database exist by listing all databases in you system:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return a list of your system's databases:</p>
<div class="w3-code notranslate pythonHigh">
  print(myclient.list_database_names())<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_check_db">Run example &raquo;</a>
</div>


<p>Or you can check a specific database by name:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Check if &quot;mydatabase&quot; exists:</p>
<div class="w3-code notranslate pythonHigh">
  dblist = myclient.list_database_names()<br>if &quot;mydatabase&quot; in dblist:<br>&nbsp; 
  print(&quot;The database exists.&quot;)<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_check_db2">Run example &raquo;</a>
</div>
