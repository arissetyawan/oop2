...
<h1>Python <span class="color_h1">While Loops</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_conditions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_for_loops.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_while">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_while_continue">Run example &raquo;</a>
</div>
<hr>

<form autocomplete="off" id="w3-exerciseform" action="exercise.asp?filename=exercise_loops1" method="post" target="_blank">
