...
<html lang="en-US">
<head>
<title>Python MySQL Order By</title>
<meta charset="utf-8">
...
<h1>Python MySQL <span class="color_h1">Order By</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mysql_where.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mysql_delete.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
  <p>Sort the result alphabetically by name:
  result:</p>
<div class="w3-code notranslate jsHigh">
  ...
  mydb.cursor()<br><br>sql = &quot;SELECT * FROM customers ORDER BY name&quot;<br><br>mycursor.execute(sql)<br><br>
  myresult = mycursor.fetchall()<br><br>for x in myresult:<br>&nbsp; print(x)<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_orderby">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  <br>mycursor = mydb.cursor()<br><br>sql = &quot;SELECT * FROM customers ORDER BY 
  name DESC&quot;<br><br>mycursor.execute(sql)<br><br>myresult = mycursor.fetchall()<br><br>for x in myresult:<br>&nbsp; 
  print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mysql_orderby_desc">Run example &raquo;</a>
</div>
