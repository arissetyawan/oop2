...
<h1>Python MongoDB <span class="color_h1">Query</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="python_mongodb_find.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="python_mongodb_sort.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-example">
  <h3>Example</h3>
<p>Find document(s) with the address &quot;Park Lane 38&quot;:</p>
<div class="w3-code notranslate pythonHigh">
  ...
  <br>myquery = { &quot;address&quot;: &quot;Park Lane 38&quot; }<br>
  <br>mydoc = mycol.find(myquery)<br><br>for x in mydoc:<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_query">Run example &raquo;</a>
</div>
...
<p>To make advanced queries you can use modifiers as values in the query object.</p>
<p>E.g. to find the documents where the &quot;address&quot; field starts with the letter "S" 
or higher (alphabetically), use the greater than modifier:
<code class="w3-codespan">{&quot;$gt&quot;: &quot;S&quot;}</code>:</p>

<div class="w3-example">
  <h3>Example</h3>
<p>Find documents where the address starts with the letter &quot;S&quot; or 
higher:</p>
<div class="w3-code notranslate pythonHigh">
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  mydb = myclient[&quot;mydatabase&quot;]<br>mycol = mydb[&quot;customers&quot;]<br>
  <br>myquery = { &quot;address&quot;: { &quot;$gt&quot;: &quot;S&quot; } }<br><br>mydoc = mycol.find(myquery)<br>
  <br>for x in mydoc:<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_query_modifier">Run example &raquo;</a>
</div>

<hr>

<h2>Filter With Regular Expressions</h2>
<p>You can also use regular expressions as a modifier.</p>
...
expression <code class="w3-codespan">{&quot;$regex&quot;: &quot;^S&quot;}</code>:</p>
...
<div class="w3-code notranslate pythonHigh">
  import pymongo<br><br>myclient = pymongo.MongoClient(&quot;mongodb://localhost:27017/&quot;)<br>
  mydb = myclient[&quot;mydatabase&quot;]<br>mycol = mydb[&quot;customers&quot;]<br>
  <br>myquery = { &quot;address&quot;: { &quot;$regex&quot;: &quot;^S&quot; } }<br><br>mydoc = mycol.find(myquery)<br>
  <br>for x in mydoc:<br>&nbsp; print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython.asp?filename=demo_mongodb_query_regex">Run example &raquo;</a>
</div>
