...
<h1>HTML Windows-1252 (ANSI) Reference </h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="ref_html_ascii.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ref_html_8859.asp">Next &#10095;</a>
</div>
<hr>
<h2>Windows-1252</h2>
<p>Windows-1252 was the first default character set in Microsoft Windows.</p>
<p>It was the most popular character set in Windows from 1980 to 1990.</p>

<hr>
<h2>ANSI</h2>
<p>Historically, the term "ANSI Code Pages" was used in Windows to refer to non-DOS character sets.</p>
<p>The intention was that these character sets would be ANSI standards like ISO-8859-1.</p>
<p>Even though Windows-1252 is almost identical to ISO-8859-1, it has never been an ANSI 
or ISO standard.</p>
<hr>

<h2>Windows-1252 and ASCII</h2>
<p>The first part of Windows-1252 (entity numbers from 0-127) is the original ASCII 
...
<h2>The Windows-1252 Character Set</h2>
...
<tr><td>&nbsp;</td><td>0 - 31</td><td>&nbsp;</td><td>Control characters (see below)</td></tr>
...
<tr><td>&nbsp;</td><td>127</td><td>&nbsp;</td><td>Control character (see below)</td></tr>
...
<p>The control characters (range 00-31, plus 127) were designed to control 
hardware devices.</p>
