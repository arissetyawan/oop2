...
<a class="w3-right w3-btn" href="ref_html_ascii.asp">Next &#10095;</a>
</div>
<hr>
<p>To display an HTML page correctly, the browser must know what character-set (encoding) to use:</p>
...
<p>For HTML5, the default character encoding is UTF-8.</p>
...
<p>With XML and HTML5, UTF-8 finally arrived and solved a lot of character encoding problems.</p>

<hr>
<h2>In the Beginning: ASCII</h2>
<p>Computer data is stored as binary codes (01000101) in the electronics.</p>
<p>To standardize the storing of text, the American Standard Code for Information 
...
characters like ! $ + - ( ) @ &lt; &gt; , .</p>
<p>Since ASCII used 7 bits for the character, it could only represent 128 different characters.</p>
<p>The biggest weakness with ASCII, was that it excluded non English letters.</p>
<p>ASCII is still in use today, especially in large mainframe computer systems.</p>
<p>For a closer look, please study our <a href="ref_html_ascii.asp">Complete ASCII 
Reference</a>.</p>
<hr>
<h2>In Windows: Windows-1252</h2>
<p>Windows-1252 was the default character-set in Windows, up to Windows 95.</p>

<p>It is an extension to ASCII, with added international characters.</p>
<p>It 
uses a full byte (8-bits) to represent 256 different characters. </p>
<p>Since Windows-1252 has been the default in Windows, it is supported by all browsers.</p>
<p>For a closer look, please study: <a href="ref_html_ansi.asp">The Complete Windows-1252 Reference</a>.</p>
<hr>
...
<p>The default character-set in HTML 4 is ISO-8859-1.</p>
<p>ISO-8859-1 is an extension to ASCII, with added international characters.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
...
<p>In HTML 4, a character-set different from ISO-8859-1 can be specified in the &lt;meta&gt; tag:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
...
<p>When a browser detects ISO-8859-1 it normally defaults to Windows-1252,
because Windows-1252 has 32 more international characters.</p>
</div>

<p>For a closer look, please study: <a href="ref_html_8859.asp">The Complete ISO-8859-1 Reference</a></p>
<hr>

<h2>In HTML5: Unicode UTF-8</h2>

<p>The default character-set for HTML5 is UTF-8.</p>
...
<p>A character-set different from UTF-8 can be specified in the &lt;meta&gt; tag:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
...
<p>The Unicode Consortium developed the UTF-8 and UTF-16 standards, because the ISO-8859 character-sets are 
limited, and not compatible a multilingual environment.</p>

<p>The Unicode Standard covers (almost) all the characters, punctuations, and symbols in the world.</p>

<div class="w3-panel w3-note">
<p>All HTML5 and XML processors support UTF-8, UTF-16, Windows-1252, and ISO-8859.</p>
</div>

<p>For a closer look, please study: <a href="ref_html_utf8.asp">The Complete Unicode Reference</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="/default.asp">&#10094; Home</a>
<a class="w3-right w3-btn" href="ref_html_ascii.asp">Next &#10095;</a>
