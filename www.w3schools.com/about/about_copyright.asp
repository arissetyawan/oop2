...
<a class="w3-right w3-btn" href="about_privacy.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Pages, code or other content from W3Schools may not be redistributed or reproduced in any way, shape,
or form without the written
permission of Refsnes Data.</p>
<p>Failure to do so is a violation of copyright laws.</p>
<hr>
<h2>Fair Use</h2>
<p>Fair use defines W3Schools' exceptions to the rights protected by copyright 
laws.</p>
<p>Fair use of W3Schools includes using copyrighted material:</p>
<ul>
  <li>In research</li>
...
<p>Fair use of W3Schools also includes: </p>
<ul>
  <li>Linking to W3Schools </li>
  <li>Adding W3Schools to search engines</li>
  <li>Library archiving W3Schools</li>
</ul>
<hr>
<h2>Using W3Schools in Teaching</h2>
<p>Fair use includes using copyrighted material in teaching under this balancing:</p>
<h3>Favorable Use:</h3>
<ul>
  <li>Copying examples and code snippets for non-profit teaching and research.</li>
  <li>Copying small quantities, appropriate for classroom teaching.</li>
</ul>
<h3>Not Favorable Use:</h3>
<ul>
  <li>Copying for profitable or commercial use.</li>
  <li>Massive or verbatim copying.</li>
  <li>Copying large quantities.</li>
</ul>
<hr>
