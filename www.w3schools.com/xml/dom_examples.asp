...
<a class="w3-left w3-btn" href="dom_nodes_clone.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="xpath_intro.asp">Next &#10095;</a>
</div>
...
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_first">
A simple XMLHttpRequest example</a><br>
Create a simple XMLHttpRequest, and retrieve data from a TXT file.
</p>

<p>
<a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_header">
Retrieve header information with getAllResponseHeaders()</a><br>
Retrieve header information of a resource (file).
</p>

<p>
<a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_lastmodified">
Retrieve specific header information with getResponseHeader()</a><br>
Retrieve specific header information of a resource (file).
</p>

<p>
<a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_suggest">
Retrieve the content of an ASP file</a><br>
How a web page can communicate with a web server while a user type characters in an input field.
</p>

<p>
<a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_database">
Retrieve content from a database</a><br>
How a web page can fetch information from a database with the XMLHttpRequest 
object.
</p>

<p>
<a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_xml">Retrieve the content of an XML file</a><br>
Create an XMLHttpRequest to retrieve data from an XML file and display the data in an HTML table.
</p>

<p><a href="dom_httprequest.asp">Examples explained</a></p>


<hr>
<p><b> XML DOM Loading XML</b></p>
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_loadxmldoc">Load and parse an XML file</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_loadxmldoc2">Load and parse an XML file (II)</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_loadxmltext">Load and XML string</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_loadxmltext2">Load and parse an XML string (II)</a>
</p>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_index">Access a node using its index number in a node list</a><br>
...
<p>
<a href="dom_nodes_access.asp">Examples explained</a>
</p>
<hr>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_nodename3">Get the node name of an element node</a><br>
...
<a target="_blank" href="tryit.asp?filename=try_dom_root">Get the node name and type of an element node</a>
</p>
<p><a href="dom_nodes_info.asp">Examples explained</a></p>
<hr>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_nodelist">Get the text from the first &lt;title&gt; element</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_nodelist_length">Loop through nodes using the length property</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_attributes">Get the attribute of an element</a>
</p>
<p><a href="dom_nodes_nodelist.asp">Examples explained</a></p>
<hr>

<p><b> XML DOM Traversing Node Tree</b></p>
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_parsertest3">Traverse a node tree</a><br />
<a target="_blank" href="tryit.asp?filename=try_dom_nodetype_ievsmozilla">Display the length of a node list</a><br>
</p>
<p><a href="dom_nodes_traverse.asp">Examples explained</a></p>
<hr>

<p><b> XML DOM Navigating Nodes</b></p>
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.<p>
<a target="_blank" href="tryit.asp?filename=try_dom_nav_parentnode">Get the parent of a node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_nav_firstchild">Get the first child element of a node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_nav_lastchild">Get the last child element of a node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_nav_nextsibling">Get the next sibling element of a node</a>
<a target="_blank" href="tryit.asp?filename=try_dom_nav_prevsibling">Get the previous sibling element of a node</a>
</p>
<p><a href="dom_nodes_navigate.asp">Examples explained</a></p>
<hr>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_getelementsbytagname">Get an element's text value</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_getattribute">Get an attribute's text value</a>
</p>
<p><a href="dom_nodes_get.asp">Examples explained</a></p>
<hr>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_change_nodevalue">Change an elements text node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_setattribute1">Change an attributes value using setAttribute</a><br>
<a href="tryit.asp?filename=try_dom_att_nodevalue">Change an attributes value using nodeValue</a>
</p>
<p><a href="dom_nodes_set.asp">Examples explained</a></p>
<hr>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_removechild">Remove an element node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_removecurrent">Remove the current element node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_removetextnode">Remove a text node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_remove_nodevalue">Clear the text of a text node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_removeattribute">Remove an attribute by name</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_removeattributenode">Remove attributes by object</a>
</p>
<p><a href="dom_nodes_remove.asp">Examples explained</a></p>
<hr>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_replacechild">Replace an element node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_replacedata2">Replace data in a text node</a>
</p>
<p><a href="dom_nodes_replace.asp">Examples explained</a></p>
<hr>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_createelement1">Create an element node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_createattribute">Create an attribute node using createAttribute</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_createattribute3">Create an attribute node using setAttribute </a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_createelement1">Create a text node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_createcdatasection1">Create a CDATA section node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_createcomment1">Create a comment node</a>
</p>
<p><a href="dom_nodes_create.asp">Examples explained</a></p>
<hr>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_createelement2">Add a node after the last child node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_insertbefore">Add a node before a specified child node</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_createattribute3">Add a new attribute</a><br>
<a target="_blank" href="tryit.asp?filename=try_dom_insertdata">Add data to a text node</a>
</p>
<p><a href="dom_nodes_add.asp">Examples explained</a></p>
<hr>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.
<p>
<a target="_blank" href="tryit.asp?filename=try_dom_clonenode">Copy a node and append it to an existing node</a>
</p>
<p><a href="dom_nodes_clone.asp">Examples explained</a></p>
