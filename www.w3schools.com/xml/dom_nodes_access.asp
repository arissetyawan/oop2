...
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="dom_nodes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_nodes_info.asp">Next &#10095;</a>
</div>
<hr>
...
Use the getElementsByTagName() method to get the third &lt;title&gt; element in &quot;books.xml&quot;</p>
<p><a target="_blank" href="tryit.asp?filename=try_dom_list_loop">Loop through nodes using the length property</a><br>
Use the length property to loop through all &lt;title&gt; elements in &quot;books.xml&quot;</p>
<p><a target="_blank" href="tryit.asp?filename=try_dom_root">See the node type of an element</a><br>
Use the nodeType property to get node type of the root element in &quot;books.xml&quot;.</p>
<p><a target="_blank" href="tryit.asp?filename=try_dom_loop">Loop through element nodes</a><br>
Use the nodeType property to only process element nodes in &quot;books.xml&quot;.</p>
<p><a target="_blank" href="tryit.asp?filename=try_dom_navigate">Loop through 
element nodes using node relationships</a><br>
Use the nodeType property and the nextSibling property to process element nodes in &quot;books.xml&quot;.</p>
...
&nbsp;&nbsp;// 
    do something for each node<br>
&nbsp;&nbsp;}
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_list_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Node Types</h2>
...
<h3>Example</h3>
 <div class="w3-code notranslate jsHigh">
 txt = &quot;&quot;;<br>x = xmlDoc.documentElement.childNodes;<br>
<br>
for (i = 0; i &lt;x.length; i++)
{<br>
...
<a target="_blank" href="tryit.asp?filename=try_dom_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose you have loaded &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; into xmlDoc</li>
  <li>Get the child nodes of the root element (xmlDoc)</li>
  <li>For each child node, check the node type. If the node type is &quot;1&quot; it is an element node</li>
...
xlen = x.childNodes.length;<br>
y = x.firstChild;<br>
<br>txt = &quot;&quot;;<br>for (i = 0; i &lt;xlen; i++)
{<br>&nbsp; // Process only element nodes (type 1)<br>
&nbsp;
if (y.nodeType == 1) {<br>&nbsp;&nbsp;&nbsp; txt += y.nodeName + &quot;&lt;br&gt;&quot;;<br>
&nbsp; }<br>
&nbsp;
y = y.nextSibling;<br>
} </div>
<a target="_blank" href="tryit.asp?filename=try_dom_navigate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose you have loaded &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot;into xmlDoc</li>
