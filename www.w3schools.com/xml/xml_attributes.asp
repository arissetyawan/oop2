...
<a class="w3-left w3-btn" href="xml_elements.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xml_namespaces.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">XML elements can have attributes, just like HTML.</p>
<p class="intro">Attributes are designed to contain data related to a specific 
element.</p>
<hr>

<h2>XML Attributes Must be Quoted</h2>
<p>Attribute values must always be quoted. Either single or double quotes can be used.</p>
<p>For a person's 
gender, the &lt;person&gt; 
...
<p>In the first example gender is an attribute. In the last, gender is an element. Both examples provide the same information.</p>
<p>There are no rules about when to use attributes or when to use elements in 
XML.</p>
<hr>
...
<p>An expanded &lt;date&gt; element is used in the third example: (THIS IS MY FAVORITE):</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;note&gt;<br>
&nbsp;
