...
<html lang="en-US">
<head>
<title>XML, XLink and XPointer</title>
<meta charset="utf-8">
...
<h1>XML<span class="color_h1">, XLink and XPointer</span></h1>
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="xml_xquery.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xml_validator.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">XLink is used to create hyperlinks in XML documents.</p>
<hr>
...
<td>
<ul>
  <li>XLink is used to create hyperlinks within XML documents</li>
...
<p>There is no browser support for XLink in XML documents.</p>
<p>However, all major 
browsers support <a href="/graphics/svg_text.asp">XLinks in SVG</a>.</p>
<hr>
<h2>XLink Syntax</h2>
<p>In HTML, the &lt;a&gt; element 
...
what link elements will be called in XML documents.</p>
...
&lt;homepages xmlns:xlink=&quot;http://www.w3.org/1999/xlink&quot;&gt;<br>&nbsp;
  &lt;homepage xlink:type=&quot;simple&quot;
  xlink:href=&quot;https://www.w3schools.com&quot;&gt;Visit W3Schools&lt;/homepage&gt;<br>&nbsp;
  &lt;homepage xlink:type=&quot;simple&quot;
  xlink:href=&quot;http://www.w3.org&quot;&gt;Visit W3C&lt;/homepage&gt;<br>&lt;/homepages&gt;
</div></div>

<p>To get access to the XLink features we must declare the XLink namespace. The XLink namespace is: &quot;http://www.w3.org/1999/xlink&quot;.</p>
<p>The xlink:type and the xlink:href attributes in the &lt;homepage&gt; elements come from the 
XLink namespace.</p>
<p>The xlink:type=&quot;simple&quot; creates a simple &quot;HTML-like&quot; link (means &quot;click here 
to go there&quot;).</p>
<p>The xlink:href attribute specifies the URL to link to.</p>
<hr>

<h2>XLink Example</h2>
<p>The following XML document contains XLink features:</p>
...
&lt;book title=&quot;Harry Potter&quot;&gt;<br>
  ...
  &nbsp;
  xlink:href=&quot;/images/HPotter.gif&quot;<br>
  &nbsp;
  xlink:show=&quot;new&quot;&gt;<br>
  &nbsp;
...
&lt;book title=&quot;XQuery Kick Start&quot;&gt;<br>
  ...
  xlink:type=&quot;simple&quot;<br>
  &nbsp;
  xlink:href=&quot;/images/XQuery.gif&quot;<br>
  &nbsp;
  xlink:show=&quot;new&quot;&gt;<br>
  &nbsp;
...
<ul>
  <li>The XLink namespace is declared at the top of the  
document (xmlns:xlink=&quot;http://www.w3.org/1999/xlink&quot;)</li>
  <li>The xlink:type=&quot;simple&quot; creates a simple &quot;HTML-like&quot; link</li>
  <li>The xlink:href attribute specifies the URL to link to (in this case - an image)</li>
  <li>The xlink:show=&quot;new&quot; specifies that the link should open in a new window</li>
</ul>
<hr>
...
<p>In the example above we have demonstrated simple XLinks. XLink is getting 
more 
interesting when accessing remote locations as resources, instead of 
standalone pages.</p>
<p>If we set the value of the xlink:show 
attribute to &quot;embed&quot;, the linked resource should be processed inline 
within the page. When you consider that this could be 
another XML document you could, for example, build a hierarchy of XML documents.</p>
<p>You can also specify WHEN the resource should appear, with 
the xlink:actuate attribute.</p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    other<br>
    none</td>
    <td>Defines when the linked resource is read and shown:
 <ul>
   <li>onLoad - the resource should be loaded and shown when the document loads</li>
   <li>onRequest - the resource is not read or shown before the link is clicked</li>
    </ul>
  </td>
  </tr>
  <tr>
    <td>xlink:href</td>
    <td><i>URL</i></td>
    <td>Specifies the URL to link to</td>
  </tr>
  <tr>
    <td>xlink:show</td>
    <td>embed<br>
    ...
    other<br>
    none</td>
    <td>Specifies where to open the link. Default is &quot;replace&quot;</td>
  </tr>
  <tr>
    <td>xlink:type</td>
    <td>simple<br>
    ...
    title<br>
    none</td>
    <td>Specifies the type of link</td>
  </tr>
</table>
...
<td>
<ul>
  <li>XPointer allows links to point to specific parts of an XML document</li>
...
<p>In this example, we will use XPointer in conjunction with XLink to point to a specific part of another document.</p>
<p>We will start by looking at the target XML document (the document we are 
linking to):</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;<br><br>
...
&lt;dog breed=&quot;Rottweiler&quot; id=&quot;Rottweiler&quot;&gt;<br>
  &nbsp;
  &lt;picture url=&quot;https://dog.com/rottweiler.gif&quot; /&gt;<br>
  &nbsp;
...
&lt;dog breed=&quot;FCRetriever&quot; id=&quot;FCRetriever&quot;&gt;<br>
  &nbsp;
  &lt;picture url=&quot;https://dog.com/fcretriever.gif&quot; /&gt;<br>
  &nbsp;
...
<p>Note that the XML document above uses id attributes on each element!</p>
<p>So, instead of linking to the entire document (as with XLink), XPointer allows you to link to specific parts of the document. To link to a specific part of a 
page, add a number sign (#) and an XPointer expression after the URL in the xlink:href 
attribute, like this: xlink:href=&quot;https://dog.com/dogbreeds.xml#xpointer(id('Rottweiler'))&quot;. The expression refers to the element in the target document, with the id value of &quot;Rottweiler&quot;.</p>
<p>XPointer also allows a shorthand method for linking to an element with an id. You can use the 
value of the id directly, like this: xlink:href=&quot;https://dog.com/dogbreeds.xml#Rottweiler&quot;.</p>
<p>The following XML document contains links to more information of the dog breed for each of 
my dogs:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;<br><br>
...
&lt;mydog&gt;<br>
  ...
  &nbsp;
  &lt;/description&gt;<br>&nbsp;
&lt;fact xlink:type=&quot;simple&quot; xlink:href=&quot;https://dog.com/dogbreeds.xml#Rottweiler&quot;&gt;<br>&nbsp; Fact about Rottweiler <br>&nbsp; &lt;/fact&gt;<br>
&lt;/mydog&gt;<br><br>
&lt;mydog&gt;<br>
  &nbsp;
  &lt;description&gt;<br>
  ...
  &lt;/description&gt;<br>
&nbsp;
&lt;fact xlink:type=&quot;simple&quot; xlink:href=&quot;https://dog.com/dogbreeds.xml#FCRetriever&quot;&gt;<br>&nbsp; Fact about flat-coated Retriever <br>&nbsp; &lt;/fact&gt;<br>
&lt;/mydog&gt;<br><br>
&lt;/mydogs&gt;
</div></div>
