...
<a class="w3-left w3-btn" href="dom_nodes_navigate.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_nodes_set.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The text value of an element node is stored in a child node. This node is called a text node.</p>

<div class="w3-panel w3-note">
<p>To retrieve the text value of an element, you must retrieve the value of the elements' text node.</p>
</div>
<hr>

<h2>The getElementsByTagName Method</h2>
<p>The <strong>getElementsByTagName()</strong> method returns a <strong>node list 
of all elements</strong>, with the specified tag name, in the same order as they appear in the source document.</p>
<p>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; has 
been loaded into xmlDoc.</p>
<p>This code retrieves the first &lt;title&gt; element:</p>
...
<p>The <strong>childNodes</strong> property returns a <strong>list of an element's child nodes</strong>.</p>
<p>The following code retrieves the text node of the first &lt;title&gt; element:</p>
...
<p>The <strong>nodeValue</strong> property returns the <strong>text value of a text node</strong>.</p>
<p>The following code retrieves the text value of the text node of the first &lt;title&gt; element:</p>
...
<p>Result in z: &quot;Everyday Italian&quot;</p>
<hr>
...
&nbsp;&nbsp;&nbsp;
if (this.readyState == 4 && this.status == 200) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myFunction(this);<br>&nbsp;&nbsp;&nbsp; 
 }<br>};<br>xhttp.open(&quot;GET&quot;, 
 &quot;books.xml&quot;, true);<br>xhttp.send();<br><br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; 
 var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
 var x = xmlDoc.getElementsByTagName('title')[0];<br>&nbsp;&nbsp;&nbsp; var y = 
 x.childNodes[0];<br>&nbsp;&nbsp;&nbsp; 
 document.getElementById(&quot;demo&quot;).innerHTML = y.nodeValue; <br>}<br>&lt;/script&gt;<br>
 <br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_getelementsbytagname"
class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Loop through all &lt;title&gt; elements:
<a target="_blank" href="tryit.asp?filename=try_dom_getelementsbytagname1">Try it Yourself</a></p>
<hr>
...
<p>The <strong>getAttribute()</strong> method returns an <b>attribute's value</b>.</p>
<p>
...
<h3>Example</h3>
 <div class="w3-code notranslate jsHigh">
  x = xmlDoc.getElementsByTagName(&quot;title&quot;)[0];<br>txt = x.getAttribute(&quot;lang&quot;);
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_getattribute"
class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Result in txt: &quot;en&quot;</p>
...
<p>The <strong>getAttributeNode()</strong> method returns an <b>attribute node</b>.</p>
<p>
The following code retrieves the text value of the &quot;lang&quot; attribute of the first 
&lt;title&gt; element:</p>
<div class="w3-example">
<h3>Example</h3>
 <div class="w3-code notranslate jsHigh">
x = xmlDoc.getElementsByTagName(&quot;title&quot;)[0];<br>y = x.getAttributeNode(&quot;lang&quot;);<br>
txt = y.nodeValue;
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_getattributenode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Result in txt = &quot;en&quot;</p>
<p>Loop through all &lt;book&gt; elements and get their &quot;category&quot; attributes:
<a target="_blank" href="tryit.asp?filename=try_dom_getattributenode2">Try it Yourself</a></p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dom_nodes_navigate.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_nodes_set.asp">Next &#10095;</a>
