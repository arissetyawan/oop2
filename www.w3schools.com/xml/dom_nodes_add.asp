...
<a class="w3-left w3-btn" href="dom_nodes_create.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_nodes_clone.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=try_dom_createelement2">Add a node after the last child node</a><br>
This example uses appendChild() to add a child node to an existing node.</p>
<p><a target="_blank" href="tryit.asp?filename=try_dom_insertbefore">Add a node before a specified child node</a><br>
...
<p>The <strong>appendChild()</strong> method adds a child node to an existing node. </p>
...
<p>This code fragment creates an element (&lt;edition&gt;), and adds it after the last child of the first &lt;book&gt; element:</p>
...
<p>This code fragment does the same as above, but the new element is added with a value:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
newEle = xmlDoc.createElement(&quot;edition&quot;);<br>
 newText=xmlDoc.createTextNode(&quot;first&quot;);<br>newEle.appendChild(newText);<br>
<br>
 xmlDoc.getElementsByTagName(&quot;book&quot;)[0].appendChild(newEle);
</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_dom_createelement" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc </li>
  <li>Create a new node &lt;edition&gt;</li>
  <li>Create a new text node &quot;first&quot;</li>
    <li>Append the text node to the &lt;edition&gt; node</li>
    <li>Append the &lt;addition&gt; node to the &lt;book&gt; element</li>
</ol>
<hr>
...
<p>The <strong>insertBefore()</strong> method inserts a node before a specified child node.</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_insertbefore" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The <strong>setAttribute()</strong> method sets the value of an attribute.</p>
<div class="w3-example">
<h3>Example</h3>
 <div class="w3-code notranslate jsHigh">
...
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; has been loaded into xmlDoc</li>
  <li>Set the value of the attribute &quot;edition&quot; to &quot;first&quot; for the first &lt;book&gt; element</li>
</ol>

<div class="w3-panel w3-note">
<p>There is no method called add Attribute()<br>
...
<p>The <strong>insertData()</strong> method inserts data into an existing 
text node.</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_insertdata" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dom_nodes_create.asp">&#10094; Previous</a>
