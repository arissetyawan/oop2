...
<h1>XSL(T) Languages</h1>
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="xsl_intro.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="xsl_transformation.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro"><strong>XSLT</strong> is a language for transforming XML documents.</p>
<p class="intro"><strong>XPath</strong> is a language for navigating in XML documents.</p>
<p class="intro"><strong>XQuery</strong> is a language for querying XML documents.</p>
<hr>
...
<p>HTML uses predefined tags. The meaning of, and how to display each tag is well
understood.</p>

<p>CSS is used to add styles to HTML elements.&nbsp;</p>
<hr>

<h2>XSL = Style Sheets for XML</h2>
<p>XML does not use predefined tags, and 
therefore the meaning of each tag is not well understood.</p>
<p>A
&lt;table&gt; element could indicate an HTML table, a piece of furniture, or 
something else - and browsers do not know how to
display it!</p>
<p>So, XSL describes how the XML elements should be displayed.</p>
<hr>
<h2>XSL - More Than a Style Sheet Language</h2>
<p>XSL consists of four parts:</p>
<ul>
  <li>XSLT - a language for transforming XML documents</li>
  <li>XPath - a language for navigating in XML documents</li>
  <li>XSL-FO - a language for formatting XML documents (discontinued in 2013)</li>
  <li>XQuery - a language for querying XML documents </li>
</ul>

<div class="w3-panel w3-note">
<p>With the <strong>CSS3 Paged Media Module</strong>, W3C has delivered a new standard for document 
formatting. So, since 2013, CSS3 is proposed as an XSL-FO replacement.</p>
</div>
<hr>
<h2>What is XSLT?</h2>
<ul>
...
<p>If you want to study XPath first, please read our <a href="xpath_intro.asp">XPath Tutorial</a>.</p>
<hr>
...
<p>All major browsers support XSLT and XPath.</p>
<hr>
