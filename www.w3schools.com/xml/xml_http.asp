...
<h1>XML HttpRequest</h1>
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="xml_display.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xml_parser.asp">Next &#10095;</a>
</div>

<hr>
<p class="intro">All modern browsers have a built-in XMLHttpRequest object to 
request data from a server. </p>
<hr>

<h2>The XMLHttpRequest Object</h2>
<p>The XMLHttpRequest object can be used to request data from a web server.</p>
<p>The XMLHttpRequest object is <b>a developers dream</b>, because you can:</p>
<ul>
...
<h3>Example</h3>
<form action="javascript:void(0);" class="w3-code-result">
...
<p>The example above is explained in the AJAX chapters of this tutorial.</p>
</div>
<hr>

<h2>Sending an XMLHttpRequest</h2>
<p>A common JavaScript syntax for using the XMLHttpRequest object looks much like this:</p>
...
&nbsp;&nbsp;&nbsp; if (this.readyState == 4 &amp;&amp; this.status == 200) {<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Typical action to be performed when the document is ready:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
 document.getElementById(&quot;demo&quot;).innerHTML = xhttp.responseText;<br>
&nbsp;&nbsp;&nbsp; }<br>};<br>
xhttp.open(&quot;GET&quot;, &quot;<em>filename</em>&quot;, true);<br>
xhttp.send();
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryxml_httprequest" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The first line in the example above creates an <strong>XMLHttpRequest</strong> 
object:</p>
...
<p>The <b>onreadystatechange</b> property specifies a function to be executed 
every time the status of the XMLHttpRequest object changes:</p>
...
<p>When <strong>readyState</strong> property is 4 and the <strong>status</strong> 
property is 200, the response is ready:</p>
...
text string.</p>
<p>The text string can be used to update a web page:</p>
...
<div class="w3-panel w3-note">
<p>You will learn a lot more about the XMLHttpRequest object in the AJAX chapters of this tutorial.</p>
</div>
<hr>

<h2>Old Versions of Internet Explorer (IE5 and IE6)</h2>
<p>Old versions of Internet Explorer (IE5 and IE6) do not support the 
XMLHttpRequest object.</p>
<p>To handle IE5 and IE6,  
check if the browser supports the XMLHttpRequest object, or else create an ActiveXObject:</p>
...
&nbsp;&nbsp;&nbsp; xmlhttp = new ActiveXObject(&quot;Microsoft.XMLHTTP&quot;);<br>
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryxml_httprequest_ie" target="_blank">Try it Yourself &raquo;</a>
</div>
