...
<a class="w3-left w3-btn" href="dom_nodes_get.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_nodes_remove.asp">Next &#10095;</a>
</div>
<hr>
...
attribute's value using setAttribute</a><br>
This example uses the setAttribute() method to change the value of the &quot;category&quot; 
attribute of the first &lt;book&gt;.</p>
<p><a target="_blank" href="tryit.asp?filename=try_dom_att_nodevalue">Change an attribute's value 
...
<p>To change the text value of an element, you must change the value of the elements's text node.</p>
</div>
<hr>

<h2>Change the Value of a Text Node</h2>
<p>The <strong>nodeValue</strong> property can be used to change <strong>the value of a text node</strong>. </p>
<p>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; has 
been loaded into xmlDoc.</p>
<p>This code changes the text node value of the first &lt;title&gt; element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 xmlDoc.getElementsByTagName(&quot;title&quot;)[0].childNodes[0].nodeValue = &quot;<em>new 
 content</em>&quot;
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_change_nodevalue" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc  </li>
  <li>Get the first child node of the &lt;title&gt; element</li>
    <li>Change the node value to &quot;<em>new content</em>&quot;</li>
</ol>
...
<p>This can be done using the setAttribute() method or setting the nodeValue 
property of the attribute node.</p>
<hr>
<h2>Change an Attribute Using setAttribute()</h2>
<p>The <strong>setAttribute()</strong> method <strong>changes the value of an 
attribute</strong>.</p>
<p>If the attribute does not exist, a new attribute is created.</p>
<p>This code changes the category attribute of the &lt;book&gt; element:</p>
<div class="w3-example">
<h3>Example</h3>
 <div class="w3-code notranslate jsHigh">
  xmlDoc.getElementsByTagName(&quot;book&quot;)[0].setAttribute(&quot;category&quot;,&quot;food&quot;);
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_setattribute1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc  </li>
...
<p>The <strong>nodeValue</strong> property is <strong>the value of a attribute node</strong>.</p>
<p>Changing the value property changes the value of the attribute.</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_att_nodevalue" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc  </li>
