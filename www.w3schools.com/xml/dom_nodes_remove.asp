...
<a class="w3-left w3-btn" href="dom_nodes_set.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_nodes_replace.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The examples use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>. </p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_removechild">Remove an element node</a><br>
This example uses removeChild() to remove the first &lt;book&gt; element.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_removecurrent">Remove the current element node</a><br>
This example uses parentNode and removeChild() to remove the current &lt;book&gt; element.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_removetextnode">Remove a text node</a><br>
This example uses removeChild() to remove the text node from the first &lt;title&gt; element.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_remove_nodevalue">Clear the text of a text node</a><br>
This example uses the nodeValue() property to clear the text node of the first &lt;title&gt; element.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_removeattribute">Remove an attribute by name</a><br>
This example uses removeAttribute() to remove the &quot;category&quot; attribute from the first &lt;book&gt; element.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_removeattributenode">Remove attributes by object</a><br>
...
<p>The <strong>removeChild()</strong> method removes a specified node.</p>
<p>When a node is removed, all its child nodes are also removed.</p>
<p>This code will remove the first &lt;book&gt; element from the loaded xml:</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_removechild" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded 
  into xmlDoc  </li>
  <li>Set the variable y to be the element node to remove</li>
  <li>Remove the element node by using the removeChild() method from the parent node</li>
</ol>
<hr>
...
<a target="_blank" href="tryit.asp?filename=try_dom_removecurrent" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc  </li>
  <li>Set the variable y to be the element node to remove</li>
  <li>Remove the element node by using the parentNode property and the removeChild() method</li>
</ol>
<hr>

<h2>Remove a Text Node</h2>
<p>The <strong>removeChild()</strong> method can also be used to remove a text node:</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_removetextnode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc  </li>
...
<p>The <strong>nodeValue</strong> property can be used to change the value of a text 
node:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=try_dom_remove_nodevalue" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc  </li>
  <li>Get the first title element's first child node.</li>
  <li>Use the nodeValue property to clear the text from the text node</li>
</ol>
<hr>

<h2>Remove an Attribute Node by Name</h2>
<p>The <strong>removeAttribute(</strong>) method removes an attribute node 
by its name.</p>
<p>Example: removeAttribute('category')</p>
<p>This code removes the &quot;category&quot; attribute 
...
<a target="_blank" href="tryit.asp?filename=try_dom_removeattribute" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc  </li>
...
<p>The <strong>removeAttributeNode(</strong>) method removes an attribute node, 
using the node object as parameter.</p>
<p>Example: removeAttributeNode(x)</p>
<p>This code removes all the attributes of all &lt;book&gt; elements:</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_removeattributenode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc  </li>
