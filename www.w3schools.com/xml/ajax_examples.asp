...
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="ajax_applications.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="dom_intro.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a href="ajax_intro.asp" class="w3-btn w3-margin-top">Examples explained</a></p>

<hr>
<h3>Request Header Information</h3>
<p>
<a target="_blank" href="tryit.asp?filename=tryajax_header">Retrieve all header information 
of a resource (file)</a><br>
</p>

<p>
<a target="_blank" href="tryit.asp?filename=tryajax_lastmodified">Retrieve specific header information 
of a resource (file)</a><br>
</p>
<p><a href="ajax_xmlhttprequest_response.asp" class="w3-btn w3-margin-top">Examples explained</a></p>
<hr>
<h3>Request XML Files</h3>
<p>
...
<p><a href="ajax_xmlfile.asp" class="w3-btn w3-margin-top">Examples explained</a></p>


<hr>

<h3>Retrieve Server Data with PHP and ASP</h3>
<p>
<a target="_blank" href="tryit.asp?filename=tryajax_suggest_php">Retrieve the content of a PHP file</a><br>
How a web page can communicate with a web server while a user type characters in an input field.
</p>
<p>
<a target="_blank" href="tryit.asp?filename=tryajax_suggest_asp">Retrieve the content of an ASP file</a><br>
How a web page can communicate with a web server while a user type characters in an input field.
</p>
<p><a href="ajax_php.asp" class="w3-btn w3-margin-top">Examples explained</a></p>
<hr>
<h3>Retrieve Database Information</h3>
<p>
...
<p><a href="ajax_database.asp" class="w3-btn w3-margin-top">Examples explained</a></p>

<hr>
<h3>AJAX Applications</h3>
<p>
<a target="_blank" href="cd_catalog.xml">View an XML CD catalog</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_display_table">Display XML data in an HTML table</a><br>
...
<p><a href="ajax_applications.asp" class="w3-btn w3-margin-top">Examples explained</a></p>
