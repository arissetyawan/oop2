...
<a class="w3-right w3-btn" href="xml_whatis.asp">Next &#10095;</a>
</div>

<div class="w3-panel w3-info intro">
<p>XML stands for eXtensible Markup Language.</p>
<p>XML was designed to store and transport data.</p>
<p>XML was designed to be both human- and machine-readable.</p>
</div>
<hr>
...
<p>It is important (for all types of software developers!) to have a good understanding of XML.</p>

<hr>
<h2>What You Will Learn</h2>
<p>This tutorial will give you a solid understanding of XML:</p>
<ul class="w3-ul">
<li>What is XML?</li>
<li>How does XML work?</li>
<li>How can I use XML?</li>
<li>What can I use XML for?</li>
</ul>
<hr>
<h2>Important XML Standards</h2>
<p>This tutorial will also dig deep into the following important XML standards:</p>
<ul>
  <li><a href="ajax_intro.asp">XML AJAX</a></li>
  <li><a href="dom_intro.asp">XML DOM</a></li>
  <li><a href="xpath_intro.asp">XML XPath</a></li>
  <li><a href="xsl_intro.asp">XML XSLT</a></li>
  <li><a href="xquery_intro.asp">XML XQuery</a></li>
  <li><a href="xml_dtd_intro.asp">XML DTD</a></li>
  <li><a href="schema_intro.asp">XML Schema</a></li>
  <li><a href="xml_services.asp">XML Services</a></li>
</ul>
...
<ul>
  <li><a href="xml_examples.asp">XML Examples</a></li>
  <li><a href="ajax_examples.asp">AJAX Examples</a></li>
  <li><a href="dom_examples.asp">DOM Examples</a></li>
  <li><a href="xpath_examples.asp">XPath Examples</a></li>
  <li><a href="xsl_examples.asp">XSLT Examples</a></li>
</ul>
<div class="w3-panel w3-note">
<p>If you try all the examples, you will learn a lot about XML in a very short time!</p>
</div>
...
<a href="xml_quiz.asp">Start the XML Quiz!</a>
