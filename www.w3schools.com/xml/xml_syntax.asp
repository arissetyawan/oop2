...
<a class="w3-left w3-btn" href="xml_tree.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xml_elements.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The syntax rules of XML are very simple and logical. The rules 
are easy to learn, and easy to use.</p>
<hr>

<h2>XML Documents Must Have a Root Element</h2>
<p>XML documents must contain one <strong>root</strong> element that is the <b>
parent</b> 
...
<div class="w3-code notranslate htmlHigh">
 &lt;root&gt;<br>
  ...
  &nbsp; &lt;/child&gt;<br>
 &lt;/root&gt;</div></div>
<p>In this example <strong>&lt;note&gt;</strong> is the root element:</p>
...
<p>This line is called the XML <strong>prolog</strong>:</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
 &lt;?xml version="1.0" encoding="UTF-8<strong>"</strong>?&gt;</div></div>

<p>The XML prolog is optional. If it exists, it must come first in the document. </p>
<p>XML documents can contain international characters, like Norwegian øæå or 
French êèé.</p>
<p>To avoid errors, you should specify the encoding used, or save your XML files 
as UTF-8.</p>
<p>UTF-8 is the default character encoding for XML documents.</p>
<p>Character encoding can be studied in our <a href="/charsets/default.asp">
Character Set Tutorial</a>.</p>

<div class="w3-panel w3-note">
<p>UTF-8 is also the default encoding for HTML5, CSS, JavaScript, PHP, and SQL.</p>
</div>
<hr>
...
<p>In XML, it is illegal to omit the closing tag. All elements <b>must</b> have 
a closing tag:</p>
...
<div class="w3-panel w3-note">
<p><strong>Note:</strong> The XML prolog does not have a closing tag!
...
<p>XML tags are case sensitive. The tag &lt;Letter&gt; is different from the tag 
&lt;letter&gt;.</p>
...
<p>"Opening and closing tags" are often referred to as "Start and end tags". Use 
whatever you prefer. It is exactly the same thing.</p>
<hr>
...
<p>If you place a character like "&lt;" inside an XML element, it will generate an 
error because the parser interprets it as the start of a new element.</p>
<p>This will generate an XML error:</p>

<div class="w3-example">
<div class="w3-code notranslate">
 &lt;message&gt;salary &lt; 1000&lt;/message&gt;</div></div>

<p>To avoid this error, replace the "&lt;" character with an <b>entity reference</b>:</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
 &lt;message&gt;salary <span class="marked">&amp;lt;</span> 1000&lt;/message&gt;</div></div>  

<p>There are 5 pre-defined entity references in XML:</p>
...
<div class="w3-panel w3-note">
<p>Only &lt; and &amp; are strictly illegal in XML, but it is a good habit to replace &gt; 
with &amp;gt; as well.</p>
</div>
<hr>
...
<p>Two dashes in the middle of a comment are not allowed:</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
 &lt;!-- This is an invalid -- comment --&gt;</div>
</div>
<hr>

<h2>White-space is Preserved in XML</h2>

<p>XML does not truncate multiple white-spaces (HTML truncates multiple 
white-spaces to one single white-space):</p>
...
<p>Windows applications store a new line as: carriage return and line feed 
(CR+LF).</p>
<p>Unix and Mac OSX uses LF.</p>
