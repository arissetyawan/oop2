...
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="xquery_functions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xml_dtd_building.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is a DTD?</h2>
<p>A DTD is a Document Type Definition.</p>
<p>A DTD defines the structure and the legal elements and attributes of an XML document.</p>

<hr>

<h2>Why Use a DTD?</h2>
<p>With a DTD, independent groups of people can agree on a standard DTD for interchanging data.</p>
<p>An application can use a DTD to verify that XML data is valid.</p>
<hr>

<h2>An Internal DTD Declaration</h2>
<p>If the DTD is declared inside the XML file, it must be wrapped inside the &lt;!DOCTYPE&gt; definition:</p>
...
<a target="_blank" href="note_in_dtd.xml" class="w3-btn w3-margin-bottom">View XML file &raquo;</a>
<p>In the XML file, select &quot;view source&quot; to view the DTD.</p>
</div>

<p>The DTD above is interpreted like this:</p>
<ul>
  <li><b>!DOCTYPE note</b>  defines that the root element of this document is note</li>
  <li><b>!ELEMENT note</b>  defines that the note element must contain four elements: &quot;to,from,heading,body&quot;</li>
...
<hr>
<h2>An External DTD Declaration</h2>
<p>If the DTD is declared in an external file, the &lt;!DOCTYPE&gt; definition must 
contain a reference to the DTD file:</p>
<div class="w3-example">
...
<a target="_blank" href="note_ex_dtd.xml" class="w3-btn w3-margin-bottom">View XML file &raquo;</a>
</div>

<p>And here is the file &quot;note.dtd&quot;, which contains the DTD:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;!ELEMENT note (to,from,heading,body)&gt;<br>
&lt;!ELEMENT to (#PCDATA)&gt;<br>
