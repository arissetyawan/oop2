...
<a class="w3-left w3-btn" href="xml_dtd_building.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xml_dtd_attributes.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">In a DTD, elements are declared with an ELEMENT declaration.</p>
<hr>
<h2>Declaring Elements</h2>
<p>In a DTD, XML elements are declared with the following syntax:</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;!ELEMENT element-name category&gt;<br>or<br>&lt;!ELEMENT element-name (element-content)&gt;
</div></div>
<hr>
