...
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="dom_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xpath_nodes.asp">Next &#10095;</a>
</div>
<hr>

<div class="w3-panel w3-info">
<h2>What is XPath?</h2>
<p>XPath is a major element in the XSLT standard.</p>
<p>XPath can be used to navigate through elements and attributes in an XML document.</p>
</div>

<table style="width:100%;border:0">
<tr>
<td style="vertical-align:top;width:165px">
<img src="pic_xpath.gif" width="160" height="160" alt="XPath">
</td>
<td>
<ul>
  <li>XPath stands for XML Path Language</li>
  <li>XPath uses &quot;path like&quot; syntax to identify and navigate nodes in an XML document</li>
  <li>XPath contains over 200 built-in functions</li>
...
<p>XPath uses path expressions to select nodes or node-sets in an XML document.</p>
<p>These path expressions look very much like the path expressions you use with  
traditional computer file systems:</p>
<img src="img_xpath_folders.jpg" alt="Folders">
<hr>

<h2>XPath Standard Functions</h2>
<p>XPath includes over 200 built-in functions.</p>
<p>There are functions for string values, numeric values, booleans, date and time comparison, 
node manipulation, sequence manipulation, and much more.</p>
<p>Today XPath expressions can also be used in JavaScript, Java, XML Schema, PHP, Python, 
C and C++, and lots of other languages.</p>
<hr>

<h2>XPath is Used in XSLT</h2>
<p>XPath is a major element in the XSLT standard.</p>
<p>With XPath knowledge you will be able to take great advantage of your XSLT 
knowledge.</p>
<hr>

<h2>XPath is a W3C Recommendation</h2>
<p>XPath 1.0 became a W3C Recommendation on November 16, 1999.</p>
<p>XPath 2.0 became a W3C Recommendation on January 23, 2007.</p>
<p>XPath 3.0 became a W3C Recommendation on April 8, 2014.</p>
