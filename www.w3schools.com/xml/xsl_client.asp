...
<a class="w3-left w3-btn" href="xsl_apply_templates.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xsl_server.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a href="cdcatalog_client.xsl" target="_blank">View the XSL file</a>.</p>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>&lt;script&gt;<br>function loadXMLDoc(filename)<br>{<br>if (window.ActiveXObject)<br>&nbsp; 
...
<a target="_blank" href="tryit.asp?filename=try_cdcatalog" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><b>Tip:</b> If you don't know how to write JavaScript, please study our <a href="/js/default.asp">JavaScript tutorial</a>.</p>

<h2>Example Explained:</h2>
<p><b>The loadXMLDoc() function does the following:</b></p>
<ul>
  <li>Create an XMLHttpRequest object</li>
  <li>Use the open() and send() methods of the XMLHttpRequest object to send a request to a server</li>
...
<ul>
  ...
  <li>If Internet Explorer:<ul>
   <li>Use the transformNode() method to apply the XSL style sheet to the  xml document</li>
   <li>Set the body of the current document (id=&quot;example&quot;) to contain the  styled xml document</li>
 </ul>
 </li>
  <li>If other browsers:<ul>
   <li>Create a new XSLTProcessor object and import the XSL file to it</li>
   <li>Use the transformToFragment() method to apply the XSL style sheet to  the xml document</li>
   <li>Set the body of the current document (id=&quot;example&quot;) to contain the  styled xml document</li>
 </ul>
 </li>
</ul>
