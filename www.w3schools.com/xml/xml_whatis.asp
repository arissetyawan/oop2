...
<a class="w3-right w3-btn" href="xml_usedfor.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">XML is a software- and hardware-independent tool for storing and 
transporting data.</p>
<hr>
...
<p>Maybe it is a little hard to understand, but XML does not DO anything.</p>
<p>This note is a note to Tove from Jani, stored as XML:</p>
...
<p>The XML above is quite self-descriptive:</p>
<ul class="auto-style1">
 <li>It has sender information.</li>
 <li>It has receiver information</li>
 <li>It has a heading</li>
 <li>It has a message body.</li>
</ul>
<p>But still, the XML above does not DO anything. XML is just information wrapped in tags.</p>
<p>Someone must write a piece of software to send, receive, 
store, or display it:</p>
...
<p>Most XML applications will work as expected even if new data is added (or 
removed).</p>
<p>Imagine an application designed to display the original version of note.xml 
(&lt;to&gt; &lt;from&gt; &lt;heading&gt; &lt;body&gt;).</p>
<p>Then imagine a newer version of note.xml with added &lt;date&gt; and &lt;hour&gt; 
elements, and a removed &lt;heading&gt;.</p>
<p>The way XML is constructed, older version of the application can still work:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;note&gt;<br>
&nbsp;
 &lt;date&gt;2015-09-01&lt;/date&gt;<br>&nbsp; &lt;hour&gt;08:30&lt;/hour&gt;<br>&nbsp; &lt;to&gt;Tove&lt;/to&gt;<br>
&nbsp;
&lt;from&gt;Jani&lt;/from&gt;<br>
&nbsp;
&lt;body&gt;Don't forget me this weekend!&lt;/body&gt;<br>
...
<p>Many computer systems contain data in incompatible formats. Exchanging data 
...
<p>XML stores data in plain text format. This provides a software- and
hardware-independent way of storing, transporting, and sharing data.</p>

<p>XML also makes it easier to expand or upgrade to new operating systems, new 
applications, or new browsers, without losing data.</p>
<p>With XML, data can be available to all kinds of &quot;reading
machines&quot; like people, computers, voice machines, news feeds, etc.</p>

<hr>

<h2>XML is a W3C Recommendation</h2>
<p>XML became a W3C Recommendation as early as in February 1998.</p>
