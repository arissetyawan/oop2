...
<h1>XML <span class="color_h1">WSDL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="xml_services.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xml_soap.asp">Next &#10095;</a>
</div>
<hr>
...
<ul>
  ...
  <li>WSDL is written in XML</li>
    <li>WSDL is a W3C recommendation from 26. June 2007</li>
</ul>

<hr>

<h2>WSDL Documents</h2>

<p>An WSDL document describes a web service. It specifies the location 
of the service, and  
the methods of the service, using these major elements:</p>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>&lt;types&gt;</td>
    <td>Defines the (XML Schema) data types used by the web service</td>
  </tr>
  <tr>
    <td>&lt;message&gt;</td>
    <td>Defines the data elements for each operation</td>
  </tr>
  <tr>
    <td>&lt;portType&gt;</td>
    <td>
  ...
  <tr>
    <td>&lt;binding&gt;</td>
    <td>Defines the protocol and data format for each port type</td>
  </tr>
</table>
...
<h2>WSDL Request-Response Operation</h2>
...
<h2>WSDL Binding to SOAP</h2>
<p>WSDL bindings defines the message format and protocol details for a web service.</p>
<p>A request-response operation example:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;message name=&quot;getTermRequest&quot;&gt;<br>
