...
<a class="w3-left w3-btn" href="dom_intro.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="dom_nodes_access.asp">Next &#10095;</a>
</div>
<hr>
<p>According to the XML DOM, everything in an XML document is a <b>node</b>:</p>
<ul>
...
<h2>DOM Example</h2>
<p>Look at the following XML file (<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>):</p>
...
<p>The root node in the XML above is named &lt;bookstore&gt;.</p>
<p>All other nodes in the document are contained within &lt;bookstore&gt;.</p>
<p>The root node &lt;bookstore&gt; holds 4 &lt;book&gt; nodes.</p>
<p>The first &lt;book&gt; node holds the child nodes: &lt;title&gt;, &lt;author&gt;, &lt;year&gt;, and &lt;price&gt;.</p>
<p>The child nodes contain one text node each, &quot;Everyday Italian&quot;, &quot;Giada 
...
<p>The XML DOM views an XML document as a tree-structure. The tree structure is called a <b>node-tree.</b></p>
<p>All nodes can be accessed through the tree. Their contents can be 
modified or deleted, and new elements can be created.</p>

<p>The node tree shows the set of nodes, and the connections between them. The tree starts at 
the root node and branches out to the text nodes at the lowest level of the tree:</p>
<div class="w3-example">
<div class="w3-section w3-white w3-center">
<p><img src="nodetree.gif" alt="DOM node tree" class="w3-image"></p>
</div>
</div>

<p>The image above represents the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>.</p>
<hr>

<h2>Node Parents, Children, and Siblings</h2>
<p>The nodes in the node tree have a hierarchical relationship to each other.</p>
<p>The terms parent, child, and sibling are used to describe the relationships. Parent nodes have 
children. Children on the same level are called siblings (brothers or sisters).</p>
<ul>
...
<p>The following image illustrates a part of the node tree and the relationship between the nodes:</p>
...
knowing the exact structure of the tree and without knowing the type of data contained within. </p>
<p>You will learn more about traversing the node tree in a later chapter of this tutorial.</p>
<hr>
