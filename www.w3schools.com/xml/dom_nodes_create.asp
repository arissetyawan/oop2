...
<a class="w3-left w3-btn" href="dom_nodes_replace.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_nodes_add.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The examples below use the XML file <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>. <br>
</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_createelement1">Create an element node</a><br>
This example uses createElement() to create a new element node, and appendChild() to add it to a node.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_createattribute">Create an attribute node using createAttribute </a><br>
This example uses createAttribute() to create a new attribute node, and setAttributeNode() to insert it to an element.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_createattribute3">Create an attribute node using setAttribute </a><br>
This example uses setAttribute() to create a new attribute for an element.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_createelement1">Create a text node</a><br>
...
<p><a target="_blank" href="tryit.asp?filename=try_dom_createcomment1">Create a comment node</a><br>
...
<p>The <strong>createElement()</strong> method creates a new element node:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
newElement = xmlDoc.createElement(&quot;edition&quot;);<br>
<br>
 xmlDoc.getElementsByTagName(&quot;book&quot;)[0].appendChild(newElement);
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_createelement2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The <strong>createAttribute()</strong> is used to create a new attribute node:</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_createattribute" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc</li>
...
<p>If the attribute already exists, it is replaced by the new one.</p>
</div>

<hr>
<h2>Create an Attribute Using setAttribute()</h2>
<p>Since the <strong>setAttribute()</strong> method creates a new attribute if the attribute does 
...
<a target="_blank" href="tryit.asp?filename=try_dom_createattribute3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc </li>
  <li>Set the attribute &quot;edition&quot; value to &quot;first&quot; for the first &lt;book&gt; element</li>
</ol>
...
<p>The <strong>createTextNode()</strong> method creates a new text node:</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_createelement1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc </li>
...
<p>The <strong>createCDATASection()</strong> method creates a new CDATA section node.</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_createcdatasection1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc </li>
...
<p>The <strong>createComment()</strong> method creates a new comment node.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
newComment = xmlDoc.createComment(&quot;Revised March 2015&quot;);<br>
<br>
 xmlDoc.getElementsByTagName(&quot;book&quot;)[0].appendChild(newComment);
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_createcomment1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc using </li>
