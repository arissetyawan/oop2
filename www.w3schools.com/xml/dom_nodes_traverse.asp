...
<a class="w3-left w3-btn" href="dom_nodes_nodelist.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_nodes_navigate.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate htmlHigh">
 ...
 var x, i ,xmlDoc;<br>var txt = &quot;&quot;;<br>var text = &quot;&lt;book&gt;&quot; + <br>
 &quot;&lt;title&gt;Everyday Italian&lt;/title&gt;&quot; +<br>&quot;&lt;author&gt;Giada De Laurentiis&lt;/author&gt;&quot; +<br>
 &quot;&lt;year&gt;2005&lt;/year&gt;&quot; +<br>&quot;&lt;/book&gt;&quot;;<br><br>parser = new DOMParser();<br>xmlDoc 
 = parser.parseFromString(text,&quot;text/xml&quot;);<br><br>// documentElement always 
 represents the root node<br>x = xmlDoc.documentElement.childNodes;<br>for (i = 
 0; i &lt; x.length ;i++) {<br>&nbsp;&nbsp;&nbsp; txt += x[i].nodeName + &quot;: &quot; + 
 x[i].childNodes[0].nodeValue + &quot;&lt;br&gt;&quot;;<br>}<br>
 document.getElementById(&quot;demo&quot;).innerHTML = txt;<br>&lt;/script&gt;<br><br>&lt;/body&gt;<br>
 &lt;/html&gt;
</div>
<p>Output:</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_parsertest3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Load the XML string into xmlDoc</li>
  <li>Get the child nodes of the root element</li>
  <li>For each child node, output the node name and the node value of the text node</li>
</ol>
<hr>
...
later versions, and other browsers will output 9 child nodes:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function myFunction(xml) {<br>    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; x = 
    xmlDoc.documentElement.childNodes;<br>&nbsp;&nbsp;&nbsp; 
    document.getElementById(&quot;demo&quot;).innerHTML = <br>&nbsp;&nbsp;&nbsp; &quot;Number 
    of child nodes: &quot; + x.length;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_nodetype_ievsmozilla" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;message&gt;This text is also parsed&lt;/message&gt;</div></div>

<p>The parser does this because XML elements can contain other elements, as in this example,
where the &lt;name&gt; element contains two other elements (first and last):</p>
...
<p>Some text, like JavaScript code, contains a lot of &quot;&lt;&quot; or &quot;&amp;&quot; characters.
To avoid errors script code can be defined as CDATA.</p>
