...
<a class="w3-left w3-btn" href="xpath_operators.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="xsl_intro.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Using an XMLHttpRequest object to load XML documents is supported in all modern 
browsers.</p>
...
<p>Code for older browsers (IE5 and IE6) can be found in the AJAX tutorial.</p>
</div>
<hr>

<h2>Selecting Nodes</h2>
<p>Unfortunately, there are different ways of dealing with XPath in different 
browsers.</p>

<p>Chrome, Firefox, Edge, Opera, and Safari use the evaluate() method to select nodes:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
xmlDoc.evaluate(<i>xpath</i>, xmlDoc, null, XPathResult.ANY_TYPE,null);
</div></div>
<p>Internet Explorer uses the selectNodes() method to select node:</p>
...
<a target="_blank" href="tryit.asp?filename=try_xpath_select_cdnodes" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=try_xpath_select_cdnodes_first" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=try_xpath_select_pricenodes_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=try_xpath_select_pricenodes_35" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=try_xpath_select_pricenodes_high" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="xpath_operators.asp">&#10094; Previous</a>
