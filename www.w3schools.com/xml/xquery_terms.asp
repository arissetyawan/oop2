...
<a class="w3-left w3-btn" href="xquery_flwor_html.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xquery_syntax.asp">Next &#10095;</a>
</div>
<hr>
<h2>XQuery Terminology</h2>
<h3>Nodes</h3>
<p>In XQuery, there are seven kinds of nodes: element, 
attribute, text, namespace, processing-instruction, comment, and document (root) nodes.</p>
<p>XML documents are treated as trees of nodes. The root of the tree is called 
