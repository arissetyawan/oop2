...
<a class="w3-left w3-btn" href="dom_nodes_add.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_examples.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=try_dom_clonenode">Copy a node and append it to an existing node</a><br>
...
<hr>
<h2>Copy a Node</h2>
<p>The <strong>cloneNode()</strong> method creates a copy of a specified node.</p>
...
<a target="_blank" href="tryit.asp?filename=try_dom_clonenode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc </li>
  <li>Get the node to copy (oldNode)</li>
  <li>Clone the node into &quot;newNode&quot;</li>
  <li>Append the new node to the root node of the XML document</li>
</ol>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dom_nodes_add.asp">&#10094; Previous</a>
