...
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="xml_http.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="xml_dom.asp">Next &#10095;</a>
</div>

<hr>
<p class="intro">All major browsers have a built-in XML parser to access and manipulate XML.</p>

<hr>
<h2>XML Parser</h2>
<p>The <a href="dom_intro.asp">XML DOM (Document Object Model)</a> defines the properties and methods for accessing 
and editing XML.</p>
<p>However, before an XML document can be accessed, it must be 
loaded into an XML DOM object.</p>
<p>All modern browsers have a built-in XML parser that can convert text into an XML DOM object.</p>
<hr>

<h2>Parsing a Text String</h2>

<p>This example parses a text string into an XML DOM object, and  
...
&lt;p id=&quot;demo&quot;&gt;&lt;/p&gt;<br><br>
&lt;script&gt;<br>
var text, parser, xmlDoc;<br><br>
text = &quot;&lt;bookstore&gt;&lt;book&gt;&quot; +<br>
&quot;&lt;title&gt;Everyday Italian&lt;/title&gt;&quot; +<br>
&quot;&lt;author&gt;Giada De Laurentiis&lt;/author&gt;&quot; +<br>
&quot;&lt;year&gt;2005&lt;/year&gt;&quot; +<br>
&quot;&lt;/book&gt;&lt;/bookstore&gt;&quot;;<br><br>
...
<p>An XML DOM parser is created:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
parser = new DOMParser();
</div>
</div>
<p>The parser creates a new XML DOM object using the text string:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<h2>Old Versions of Internet Explorer</h2>
<p>Old versions of Internet Explorer (IE5, IE6, IE7, IE8) do not support the DOMParser object.</p>
<p>To handle older versions of Internet Explorer,  
check if the browser supports the DOMParser object, or else create an ActiveXObject:</p>
...
&nbsp; xmlDoc.loadXML(text); <br>
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_dom_loadxmltext_ie" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The XMLHttpRequest Object</h2>
<p>The <a href="xml_http.asp">XMLHttpRequest Object</a> has a built in XML 
Parser.</p>
<p>The <strong>responseText </strong>property returns the response as a string.</p>
<p>The <strong>responseXML</strong> property returns the response as an XML DOM object.</p>
<p>If you want to use the response as an XML DOM object, you can use the responseXML 
property.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Request the file <a target="_blank" href="cd_catalog.xml">cd_catalog.xml</a> and 
use the response as an XML DOM object:</p>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_dom_xmlhttprequest_responsexml">Try it Yourself &raquo;</a>
</div>
