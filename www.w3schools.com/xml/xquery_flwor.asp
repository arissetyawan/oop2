...
<a class="w3-left w3-btn" href="xquery_example.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xquery_flwor_html.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is FLWOR?</h2>

<p>FLWOR (pronounced &quot;flower&quot;) is an acronym for &quot;For, Let, Where, Order by, Return&quot;.</p>
<ul>
  <li><strong>For</strong> - selects a sequence of nodes</li>
  <li><strong>Let</strong> - binds a sequence to a variable</li>
  <li><strong>Where</strong> - filters the nodes</li>
  <li><strong>Order by</strong> - sorts the nodes</li>
  <li><strong>Return</strong> - what to return (gets evaluated once for every node)</li>
</ul>
<hr>
