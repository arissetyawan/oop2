...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="xml_server.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xml_quiz.asp">Next &#10095;</a>
</div>
<hr>
...
<p><b><a href="xml_display.asp" class="w3-btn w3-margin-top">Examples explained</a></b></p>
<hr>
<h3>XML and CSS</h3>
<p>
<a target="_blank" href="cd_catalog.xml">View an XML CD catalog</a><br>
...
<a target="_blank" href="simplexsl.xml">Display the food menu styled with an XSLT style sheet</a></p>
<p><a href="xml_xslt.asp" class="w3-btn w3-margin-top">Examples explained</a></p>
<hr>
<h3>Parsing XML and the XML DOM</h3>
<p>
<a target="_blank" href="note.xml">View a simple XML file (note.xml)</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_parsertest2">Parse an XML string</a><br>
<a target="_blank" href="tryit.asp?filename=tryxml_parsertest">Parse the XML file</a><br>
</p>
<p><a href="xml_parser.asp" class="w3-btn w3-margin-top">Examples explained</a></p>

<hr>
<h3>XML Output From a Server</h3>
...
<p><a href="xml_server.asp" class="w3-btn w3-margin-top">Examples explained</a></p>
