...
<a class="w3-left w3-btn" href="dom_http.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="xsl_elementref.asp">Next &#10095;</a>
</div>
<hr>
<h2>XML Parser Error</h2>

<p>When trying to open an XML document, a parser-error may occur.</p>
<p>If the parser encounters an error, it may load an XML 
document containing the error description.</p>

<p>The code example below tries to load an XML document that is not well-formed.
</p>

<p>You can read more about well-formed XML in <a href="xml_syntax.asp">XML 
Syntax</a>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 &lt;html&gt;<br>&lt;body&gt;<br><br>&lt;p id=&quot;demo&quot;&gt;&lt;/p&gt;<br><br>&lt;script&gt;<br>var xhttp = new 
    XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>&nbsp; if (xhttp.this 
    == 4 &amp;&amp; this.status == 200) {<br>&nbsp;&nbsp;&nbsp; myFunction(this);<br>&nbsp; 
    }<br>};<br>xhttp.open(&quot;GET&quot;, &quot;note_error.xml&quot;, true);<br>xhttp.send();<br>
    <br>function myFunction(xml) {<br>&nbsp; var parser, xmlDoc;<br>&nbsp; 
    parser = new DOMParser();<br>&nbsp; xmlDoc = parser.parseFromString(xml.responseText,&quot;text/xml&quot;);<br>&nbsp; 
    document.getElementById(&quot;demo&quot;).innerHTML =<br>&nbsp; myLoop(xmlDoc.documentElement);<br>
    }<br><br>function myLoop(x) {<br>&nbsp; var i, y, xLen, txt;<br>&nbsp; txt = 
    &quot;&quot;;<br>&nbsp; x = x.childNodes;<br>&nbsp; xLen = x.length;<br>&nbsp; for (i 
    = 0; i &lt; xLen ;i++) {<br>&nbsp;&nbsp;&nbsp; y = x[i];<br>&nbsp;&nbsp;&nbsp; 
    if (y.nodeType != 3) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (y.childNodes[0] 
    != undefined) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; txt += myLoop(y);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    }<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; txt += y.nodeValue + 
    &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>&nbsp; return txt;<br>}<br>&lt;/script&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=try_dom_parser_error" target="_blank">Try it Yourself &raquo;</a>
</div>
