...
<a class="w3-left w3-btn" href="dom_nodes_traverse.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_nodes_get.asp">Next &#10095;</a>
</div>
<hr>
...
relationship between nodes in <a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>:</p>
<p><img src="navigate.gif" alt="Node tree" class="w3-image"></p>
<hr>

<h2>DOM - Parent Node</h2>
<p>All nodes have exactly one parent node. The following code navigates to the 
parent node of &lt;book&gt;: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function myFunction(xml) {<br>    var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; var x = xmlDoc.getElementsByTagName(&quot;book&quot;)[0];<br>&nbsp;&nbsp;&nbsp; 
    document.getElementById(&quot;demo&quot;).innerHTML = x.parentNode.nodeName;<br>}
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_nav_parentnode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Load &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; into xmlDoc  </li>
...
<div class="w3-code notranslate htmlHigh">
 &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;p id=&quot;demo&quot;&gt;&lt;/p&gt;<br><br>&lt;script&gt;<br>
 var xhttp = new XMLHttpRequest();<br>xhttp.onreadystatechange = function() {<br>&nbsp;&nbsp;&nbsp; if (this.readyState == 4 && this.status == 200) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myFunction(this);<br>&nbsp;&nbsp;&nbsp; }<br>};<br>xhttp.open(&quot;GET&quot;, 
 &quot;books.xml&quot;, true);<br>xhttp.send();<br><br>function myFunction(xml) {<br>&nbsp;&nbsp;&nbsp; 
 var xmlDoc = xml.responseXML;<br>&nbsp;&nbsp;&nbsp; 
 var x = get_firstChild(xmlDoc.getElementsByTagName(&quot;book&quot;)[0]);<br>&nbsp;&nbsp;&nbsp; 
 document.getElementById(&quot;demo&quot;).innerHTML = x.nodeName;<br>}<br><br>//check if 
 the first node is an element node<br>function get_firstChild(n) {<br>&nbsp;&nbsp;&nbsp; 
 var y = n.firstChild;<br>&nbsp;&nbsp;&nbsp; while (y.nodeType != 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
 y = y.nextSibling;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; return y;<br>}<br>
...
<a target="_blank" href="tryit.asp?filename=try_dom_nav_firstchild" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Load &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; into xmlDoc  </li>
  <li>Use the get_firstChild function on the first &lt;book&gt; element node to get the first child node that is an element node</li>
  <li>Output the node name of first child node that is an element node</li>
</ol>
<hr>

<h2>More Examples</h2>
<p><a target="_blank" href="tryit.asp?filename=try_dom_nav_lastchild">lastChild()</a><br>
This example uses the lastChild() method and a custom function to get the last child node of a node</p>
<p><a target="_blank" href="tryit.asp?filename=try_dom_nav_nextsibling">nextSibling()</a><br>
This example uses the nextSibling() method and a custom function to get the next sibling node of a node</p>
<p><a target="_blank" href="tryit.asp?filename=try_dom_nav_prevsibling">previousSibling()</a><br>
