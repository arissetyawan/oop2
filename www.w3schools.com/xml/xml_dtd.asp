...
<a class="w3-left w3-btn" href="xml_validator.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xml_schema.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">An XML document with correct syntax is called &quot;Well Formed&quot;.</p>
<p class="intro">An XML document validated against a DTD is both &quot;Well Formed&quot; 
and &quot;Valid&quot;.</p>
<hr>
...
<a target="_blank" href="note_entities.xml" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel w3-note">
<p>An entity has three parts: an ampersand (&amp;), an entity name, and a semicolon (;).</p>
</div>
<hr>

<h2>When to Use a DTD/Schema?</h2>
<p>With a DTD, independent groups of people can agree to use a standard DTD for 
interchanging data.</p>
...
<p>If you want to study DTD, please read our <a href="xml_dtd_intro.asp">DTD Tutorial</a>.</p>
<hr>

<h2>When NOT to Use a DTD/Schema?</h2>
<p>XML does not require a DTD/Schema.</p>
<p>When you are experimenting with XML, or when you are working with small XML 
files, creating DTDs may be a waste of time.</p>
