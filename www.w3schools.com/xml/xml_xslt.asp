...
<h1>XML <span class="color_h1">and XSLT</span></h1>
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="xml_xpath.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="xml_xquery.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">With XSLT you can transform an XML document into HTML.</p>
<hr>
<h2>Displaying XML with XSLT</h2>
<p>XSLT (eXtensible Stylesheet Language Transformations) is the recommended style sheet language 
for XML.</p>
<p>XSLT is far more sophisticated than CSS. With XSLT you can add/remove 
...
display, and a lot more.</p>
<p>XSLT uses XPath to find information in an XML document.</p>
<hr>
...
<p>Use XSLT to transform XML into HTML, before it is displayed in a browser:</p>
<div class="w3-example">
<h3>Example XSLT Stylesheet:</h3>
<div class="w3-code notranslate htmlHigh">
...
&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" href="simplexsl.xml" class="w3-btn w3-margin-bottom">Transform the XML Document with XSLT &raquo;</a>
</div>
<hr>

<h2>XSLT Tutorial</h2>
<p>If you want to learn more about XSLT, go to our <a href="xsl_intro.asp">XSLT Tutorial</a>.</p>
