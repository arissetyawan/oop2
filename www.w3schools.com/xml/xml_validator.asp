...
<a class="w3-left w3-btn" href="xml_xlink.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xml_dtd.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Use our XML validator to syntax-check your XML.</p>
<hr>
<h2>Well Formed XML Documents</h2>
<p>An XML document with correct syntax is called &quot;Well Formed&quot;.</p>
...
<p>The W3C XML specification states that a program should stop processing an XML document if it finds an error.
The reason is that XML software should be small, fast, and compatible.</p>
<p>HTML browsers are allowed to display HTML documents with errors (like missing end tags). </p>
...
<p>Try to syntax-check correct XML : <input type="button" value="Check XML" onclick="validateXML('xml1')"></p>
...
<p>Try to syntax-check incorrect XML : <input type="button" value="Check XML" onclick="validateXML('xml2')"></p>
<textarea id="xml2" rows="10" style="width:100%" cols="20" name="xml2">
&lt;?xml version="1.0" encoding="UTF-8"?&gt;
&lt;note&gt;
&lt;to&gt;Tove&lt;/to&gt;
&lt;from&gt;Jani&lt;/from&gt; 
...
<p>Try to syntax-check your own XML : <input type="button" value="Check XML" onclick="validateXML('xml3')"></p>
<textarea id="xml3" rows="10" style="width:100%" cols="20" name="xml3">
&lt;?xml version="1.0" encoding="UTF-8"?&gt;
</textarea>
<br>
<hr>
...
<p>A &quot;well formed&quot; XML document is not the same as a &quot;valid&quot; XML document.</p>
<p>A &quot;valid&quot; XML document must be well formed. In addition, it must conform to a  
document type definition.</p>
<p>There are two different document type definitions that can be used with XML:</p>
<ul>
  <li>DTD - The original Document Type Definition</li>
  <li>XML Schema - An XML-based alternative to DTD</li>
</ul>
<p>A document type definition defines the rules and the legal elements and attributes 
for an XML document.</p>
