...
<a class="w3-left w3-btn" href="dom_comment.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_parser.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_first">A 
simple XMLHttpRequest example</a><br>
Create a simple XMLHttpRequest, and retrieve data from a TXT file.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_header">
Retrieve header information with getAllResponseHeaders()</a><br>
Retrieve header information of a resource (file).</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_lastmodified">
...
<p><a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_suggest">Retrieve the content of an ASP file</a><br>
How a web page can communicate with a web server while a user type characters in an input field.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_database">Retrieve content from a database</a><br>
How a web page can fetch information from a database with the XMLHttpRequest object.</p>

<p><a target="_blank" href="tryit.asp?filename=try_dom_xmlhttprequest_xml">Retrieve the content of an XML file</a><br>
