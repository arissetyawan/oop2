...
<a class="w3-left w3-btn" href="xpath_syntax.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="xpath_operators.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>XPath Axes</h2>
<p>An axis represents a relationship to the context (current) node, and is used 
to locate nodes relative to that node on the tree.</p>
