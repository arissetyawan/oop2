...
<a class="w3-left w3-btn" href="xml_dtd_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="schema_howto.asp">Next &#10095;</a>
</div>

<hr>
<h2>What is an XML Schema?</h2>
<p>An XML Schema describes the structure of an XML document.</p>
<p class="intro">The XML Schema language is also referred to as XML Schema Definition (XSD).</p>
...
<h2>Why Learn XML Schema?</h2>
<p>In the XML world, hundreds of standardized XML formats are in daily use. </p>
<p>Many of these XML standards are defined by XML Schemas.</p>
<p class="intro">XML Schema is an XML-based (and more powerful) alternative to DTD.</p>
<hr>
