...
<a class="w3-left w3-btn" href="dom_nodes_info.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="dom_nodes_traverse.asp">Next &#10095;</a>
</div>
<hr>
...
<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>. </p>
...
<h2>DOM Node List</h2>
<p>When using properties or methods like childNodes or getElementsByTagName(), a node list object is returned.</p>
...
<p>The following image represents a node list of the &lt;title&gt; elements in &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot;:</p>
<p><img src="nodelist.gif" alt="DOM node list" class="w3-image"></p>
<p>Suppose &quot;books.xml&quot; is loaded into the variable xmlDoc.</p>
<p>This code fragment returns a node list of title elements in &quot;books.xml&quot;:</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
x = xmlDoc.getElementsByTagName(&quot;title&quot;);
</div></div>
<p>After the execution of the statement above, x is a node list object.</p>
<p>The following code fragment returns the text from the first &lt;title&gt; element in the node list (x):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
var txt = x[0].childNodes[0].nodeValue;
</div>
<a target="_blank" href="tryit.asp?filename=try_dom_nodelist" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
deleted or added, the list is automatically updated.</p>
<p>The length property of a node list is the number of nodes in the list.</p>
<p>This code fragment returns the number of &lt;title&gt; elements in &quot;books.xml&quot;:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
x = xmlDoc.getElementsByTagName('title').length;
</div>
</div>
<p>After the execution of the statement above, the value of x will be 4.</p>
<p>The length of the node list can be used to loop through all the elements in the list.</p>
<p>This code fragment uses the length property to loop through the list of &lt;title&gt; elements:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=try_dom_nodelist_length" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<ol>
  ...
  <li>Collect the text node values from &lt;title&gt; elements</li>
</ol>
<hr>
...
<p>An attribute list keeps itself up-to-date. If an attribute is 
deleted or added, the list is automatically updated.</p>
<p>This code fragment returns a list of attribute nodes from the first &lt;book&gt; element in &quot;books.xml&quot;:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<p>This code fragment gets the value of the &quot;category&quot; 
...
<a target="_blank" href="tryit.asp?filename=try_dom_attributes" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>Example explained:</p>
<ol>
  <li>Suppose &quot;<a href="javascript:void(0)" onclick="displayXML('books.xml')">books.xml</a>&quot; is loaded into xmlDoc  </li>
  <li>Set the x variable to hold a list of all attributes of the first &lt;book&gt; element</li>
  <li>Get the value of the &quot;category&quot; attribute and the length of the attribute list</li>
</ol>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="dom_nodes_info.asp">&#10094; Previous</a>
