...
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="ajax_xmlfile.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="ajax_asp.asp">Next &#10095;</a>
</div>
<hr>
...
}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; };<br>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; xmlhttp.open(&quot;GET&quot;, &quot;gethint.php?q=&quot; + str, true);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xmlhttp.send();<br>&nbsp;&nbsp;&nbsp; 
...
&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryajax_suggest_php" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
$a[] = &quot;Wenche&quot;;<br>
$a[] = &quot;Vicky&quot;;<br><br>
// get the q parameter from URL<br>$q = $_REQUEST[&quot;q&quot;];<br><br>$hint = &quot;&quot;;<br><br>// 
lookup all hints from array if $q is different from &quot;&quot; <br>if ($q !== &quot;&quot;) 
{<br>&nbsp;&nbsp;&nbsp; $q = strtolower($q);<br>&nbsp;&nbsp;&nbsp; $len=strlen($q);<br>&nbsp;&nbsp;&nbsp; foreach($a as 
$name) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (stristr($q, substr($name, 0, $len))) 
{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if ($hint === &quot;&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $hint = $name;<br>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else 
{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $hint .= &quot;, $name&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; }<br>}<br><br>// Output &quot;no suggestion&quot; if no hint was found 
or output correct values <br>
