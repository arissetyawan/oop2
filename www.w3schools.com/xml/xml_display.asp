...
<h1>Displaying <span class="color_h1">XML</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="xml_namespaces.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="xml_http.asp">Next &#10095;</a>
</div>
...
<div style="padding:7px;border:1px rgb(95,95,95) solid;margin-bottom:15px;">
<span style="color:blue">&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8"?&gt;</span><br>
<span style="color:red">&nbsp;- </span><span style="color:blue">&lt;</span><span style="color:maroon">note</span><span style="color:blue">&gt;</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">to</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Tove</span><span style="color:blue">&lt;/</span><span style="color:maroon">to</span><span style="color:blue">&gt;</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">from</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Jani</span><span style="color:blue">&lt;/</span><span style="color:maroon">from</span><span style="color:blue">&gt;</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">heading</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Reminder</span><span style="color:blue">&lt;/</span><span style="color:maroon">heading</span><span style="color:blue">&gt;</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">body</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Don't forget me this weekend!</span><span style="color:blue">&lt;/</span><span style="color:maroon">body</span><span style="color:blue">&gt;</span><br>
&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;/</span><span style="color:maroon">note</span><span style="color:blue">&gt;</span>
</div>

<p>Look at the XML file above in your browser: <a target="_blank" href="note.xml">note.xml</a></p>
<p>Most browsers will display an XML document with color-coded elements.</p>
<p>Often a plus (+) or minus sign (-) to the left
of the elements can be clicked to expand or collapse the element structure.</p>
<p>To view raw XML source, try to select &quot;View Page Source&quot; or &quot;View Source&quot; from the browser menu.</p>
<p><b>Note:</b> In Safari 5 (and earlier), only the element text will be displayed. To view the raw XML, you must right click the page and select &quot;View Source&quot;.</p>
<hr>

<h2>Viewing an Invalid XML File</h2>

<p>If an erroneous XML file is opened, some browsers will report the error, and some 
will display it, or display it incorrectly.</p>
<div style="padding:7px;border:1px rgb(95,95,95) solid;margin-bottom:15px;">
<span style="color:blue">&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8"?&gt;</span><br>
<span style="color:red">&nbsp;- </span><span style="color:blue">&lt;</span><span style="color:maroon">note</span><span style="color:blue">&gt;</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">to</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Tove</span><span style="color:blue">&lt;/</span><span style="color:maroon">to</span><span style="color:blue">&gt;</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">from</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Jani</span><span style="color:red">&lt;/Ffrom</span><span style="color:blue">&gt;</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">heading</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Reminder</span><span style="color:blue">&lt;/</span><span style="color:maroon">heading</span><span style="color:blue">&gt;</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;</span><span style="color:maroon">body</span><span style="color:blue">&gt;</span><span style="font-weight:bold">Don't forget me this weekend!</span><span style="color:blue">&lt;/</span><span style="color:maroon">body</span><span style="color:blue">&gt;</span><br>
&nbsp;&nbsp;&nbsp;<span style="color:blue">&lt;/</span><span style="color:maroon">note</span><span style="color:blue">&gt;</span>
</div>

<p>Try to open the following XML file:
<a href="javascript:void(0)"
onclick="displayXML('note_error.xml')">
note_error.xml</a> </p>
...
onclick="displayXML('simple.xml')">
An XML breakfast menu</a><br>
This is a breakfast food menu from a restaurant, stored as XML.
</p>
<p><a href="javascript:void(0)"
onclick="displayXML('cd_catalog.xml')">
An XML CD catalog</a><br>
This is a CD collection, stored as XML.
</p>
<p><a href="javascript:void(0)"
onclick="displayXML('plant_catalog.xml')">
An XML plant catalog</a><br>
...
<p>Without any information about how to display the data, the browsers can just display the XML document as it is.</p>
<div class="w3-panel w3-note">
<p><strong>Tip:</strong> If you want to style an XML document, use
<a href="xsl_intro.asp">XSLT</a>.</p>
</div>
