...
#grad2 {
    ...
    background-image: -webkit-linear-gradient(red,yellow); /* For Safari 5.1 to 6.0 */
    background-image: -o-linear-gradient(red,yellow); /* For Opera 11.1 to 12.0 */
    background-image: -moz-linear-gradient(red,yellow); /* For Firefox 3.6 to 15 */
...
#grad3 {
    ...
    width:100%;
    background-color: red; /* For browsers that do not support gradients */    
    background-image: -webkit-linear-gradient(left,red,yellow); /* For Safari 5.1 to 6.0 */
    background-image: -o-linear-gradient(right,red,yellow); /* For Opera 11.1 to 12.0 */
    background-image: -moz-linear-gradient(right,red,yellow); /* For Firefox 3.6 to 15 */
...
#grad4 {
    ...
    width:100%;
    background-color: red; /* For browsers that do not support gradients */    
    background-image: -webkit-linear-gradient(left top,red,yellow); /* For Safari 5.1 to 6.0 */
    background-image: -o-linear-gradient(bottom right,red,yellow); /* For Opera 11.1 to 12.0 */
    background-image: -moz-linear-gradient(bottom right,red,yellow); /* For Firefox 3.6 to 15 */
...
#grad5 {
    ...
    width:100%;
    background-color: red; /* For browsers that do not support gradients */    
    background-image: -webkit-linear-gradient(-90deg, red, yellow); /* For Safari 5.1 to 6.0 */
    background-image: -o-linear-gradient(-90deg, red, yellow); /* For Opera 11.1 to 12.0 */
    background-image: -moz-linear-gradient(-90deg, red, yellow); /* For Firefox 3.6 to 15 */
...
#grad7 {
    ...
    width:100%;
    background-color: red; /* For browsers that do not support gradients */    
    background-image: -webkit-linear-gradient(left, red, orange, yellow, green, blue, indigo, violet); /* For Safari 5.1 to 6.0 */
    background-image: -o-linear-gradient(left, red, orange, yellow, green, blue, indigo, violet); /* For Opera 11.1 to 12.0 */
    background-image: -moz-linear-gradient(left, red, orange, yellow, green, blue, indigo, violet); /* For Fx 3.6 to 15 */
...
#grad8 {
    height: 150px;
    width:100%;
    background-image: -webkit-linear-gradient(left, rgba(255,0,0,0), rgba(255,0,0,1)); /* For Safari 5.1 to 6.0 */
    background-image: -o-linear-gradient(right, rgba(255,0,0,0), rgba(255,0,0,1)); /* For Opera 11.1 to 12.0 */
    background-image: -moz-linear-gradient(right, rgba(255,0,0,0), rgba(255,0,0,1)); /* For Firefox 3.6 to 15 */
...
#grad9 {
    ...
    width:100%;
    background-color: red; /* For browsers that do not support gradients */    
    background-image: -webkit-repeating-linear-gradient(red, yellow 10%, green 20%); /* For Safari 5.1 to 6.0 */
    background-image: -o-repeating-linear-gradient(red, yellow 10%, green 20%); /* For Opera 11.1 to 12.0 */
    background-image: -moz-repeating-linear-gradient(red, yellow 10%, green 20%); /* For Firefox 3.6 to 15 */
...
#grad10 {
    ...
    width:100%;
    background-color: red; /* For browsers that do not support gradients */    
    background-image: -webkit-radial-gradient(red,yellow,green); /* Safari 5.1 to 6.0 */
    background-image: -o-radial-gradient(red,yellow,green); /* For Opera 11.6 to 12.0 */
    background-image: -moz-radial-gradient(red,yellow,green); /* For Firefox 3.6 to 15 */
...
#grad11 {
    ...
    width:100%;
    background-color: red; /* For browsers that do not support gradients */    
    background-image: -webkit-radial-gradient(red 5%,yellow 15%,green 60%); /* Safari 5.1 to 6.0 */
    background-image: -o-radial-gradient(red 5%,yellow 15%,green 60%); /* For Opera 11.6 to 12.0 */
    background-image: -moz-radial-gradient(red 5%,yellow 15%,green 60%); /* For Firefox 3.6 to 15 */
...
#grad12 {
    ...
    width:50%;
    background-color: red; /* For browsers that do not support gradients */    
    background-image: -webkit-radial-gradient(circle, red, yellow, green); /* For Safari 5.1 to 6.0 */
    background-image: -o-radial-gradient(circle, red, yellow, green); /* For Opera 11.6 to 12.0 */
    background-image: -moz-radial-gradient(circle, red, yellow, green); /* For Fx 3.6 to 15 */
...
#grad13 {
    ...
    width:100%;
    background-color: red; /* For browsers that do not support gradients */    
    background-image: -webkit-repeating-radial-gradient(red, yellow 10%, green 15%); /* For Safari 5.1 to 6.0 */
    background-image: -o-repeating-radial-gradient(red, yellow 10%, green 15%); /* For Opera 11.6 to 12.0 */
    background-image: -moz-repeating-radial-gradient(red, yellow 10%, green 15%); /* For Firefox 3.6 to 15 */
...
<a class="w3-left w3-btn" href="css3_colors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_shadows.asp">Next &#10095;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear_ltr" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear_diagonal" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear_angles" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear_cs" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear_rainbow" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear_trans" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-linear_repeating" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-radial" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-radial2" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-radial_shape" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-radial_size" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gradient-radial_repeating" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_gradients1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_gradients2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_gradients3" target="_blank">Exercise 3 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_gradients4" target="_blank">Exercise 4 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_gradients5" target="_blank">Exercise 5 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_gradients6" target="_blank">Exercise 6 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_gradients7" target="_blank">Exercise 7 &raquo;</a>
  </div>
</div>
<hr>
