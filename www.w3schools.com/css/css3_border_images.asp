...
<a class="w3-left w3-btn" href="css3_borders.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css3_backgrounds.asp">Next &#10095;</a>
</div>
<hr>
...
padding: 15px;<br>&nbsp;&nbsp;&nbsp; border-image: url(border.png) 
30% round;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-image3">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_border_images1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_border_images2" target="_blank">Exercise 2 &raquo;</a>
  </div>
</div>
<hr>
