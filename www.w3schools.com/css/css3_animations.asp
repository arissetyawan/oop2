...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_animations1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_animations2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_animations3" target="_blank">Exercise 3 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_animations4" target="_blank">Exercise 4 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_animations5" target="_blank">Exercise 5 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_css3_animations6" target="_blank">Exercise 6 &raquo;</a>
  </div>
</div>
<hr>
