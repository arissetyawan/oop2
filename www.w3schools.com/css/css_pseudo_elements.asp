...
<a class="w3-left w3-btn" href="css_pseudo_classes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_image_transparency.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-panel w3-note">
  <p><strong>Notice the double colon notation - </strong> <code class="w3-codespan">::first-line</code> versus
<code class="w3-codespan">:first-line</code><br><br>The double colon replaced the single-colon 
...
<p>The <code class="w3-codespan">::first-line</code> pseudo-element is used to add a special style 
...
<a target="_blank" href="tryit.asp?filename=trycss_firstline" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> The <code class="w3-codespan">::first-line</code> pseudo-element can only be applied to block-level 
elements.</p>
<p>The following properties apply to the <code class="w3-codespan">::first-line</code> 
pseudo-element:</p>
<ul>
...
<p>The <code class="w3-codespan">::first-letter</code> pseudo-element is used to add a special style to the first 
letter of a text.</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_firstletter" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> The <code class="w3-codespan">::first-letter</code> pseudo-element can only be applied to block-level 
elements.</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_pseudo-element" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_firstline_letter" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS - The ::before Pseudo-element</h2>
<p>The <code class="w3-codespan">::before</code> pseudo-element can be used to insert some content before the content of an element.</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_before" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS - The ::after Pseudo-element</h2>
<p>The <code class="w3-codespan">::after</code> pseudo-element can be used to insert some content after the content of an element.</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_after" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>CSS - The ::selection Pseudo-element</h2>
<p>The <code class="w3-codespan">::selection</code> pseudo-element matches the portion of an element that is 
selected by a user.</p>
<p>The following CSS properties can be applied to <code class="w3-codespan">::selection</code>: 
<code class="w3-codespan">color</code>, 
<code class="w3-codespan">background</code>, <code class="w3-codespan">cursor</code>, and <code class="w3-codespan">outline</code>.</p>
...
<a target="_blank" href="tryit.asp?filename=trycss3_selection" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_pseudo_elements1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_pseudo_elements2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_pseudo_elements3" target="_blank">Exercise 3 &raquo;</a>
  </div>
</div>
<hr>
