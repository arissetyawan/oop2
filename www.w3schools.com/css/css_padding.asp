...
<a class="w3-left w3-btn" href="css_margin.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_dimension.asp">Next &#10095;</a>
</div>
<hr>
...
<br>
<a target="_blank" href="tryit.asp?filename=trycss_padding_intro" class="w3-btn">Try it Yourself &raquo;</a>
<hr>

<h2>CSS Padding</h2>
<p>The CSS <code class="w3-codespan">padding</code> properties are used to generate space around 
...
<p>The following example sets different padding for all four sides of a &lt;div&gt; element:&nbsp;</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_padding_sides" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
one property.</p>
<p>The <code class="w3-codespan">padding</code> property is a shorthand property for the following individual 
...
<p>If the <code class="w3-codespan">padding</code> property has four values:</p>
<ul>
...
<a target="_blank" href="tryit.asp?filename=trycss_padding_shorthand_4val" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>If the <code class="w3-codespan">padding</code> property has three values:</p>
<ul>
...
<a target="_blank" href="tryit.asp?filename=trycss_padding_shorthand_3val" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>If the <code class="w3-codespan">padding</code> property has two values:</p>
<ul>
...
<a target="_blank" href="tryit.asp?filename=trycss_padding_shorthand_2val" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>If the <code class="w3-codespan">padding</code> property has one value:</p>
<ul>
...
<div class="w3-code notranslate cssHigh">
  div {<br>&nbsp;&nbsp;&nbsp;
  padding: 25px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_padding_shorthand_1val" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Padding and Element Width</h2>
<p>The CSS <code class="w3-codespan">width</code> property specifies the width of the element's content area. The 
...
<p>In the following example, the &lt;div&gt; element is given a width of 300px. 
...
<a target="_blank" href="tryit.asp?filename=trycss_padding_width" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>To keep the width at 300px, no matter the amount of padding, you can use the <code class="w3-codespan">
...
<div class="w3-code notranslate cssHigh">
  ...
  box-sizing: border-box;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_padding_width2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_padding1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_padding2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_padding3" target="_blank">Exercise 3 &raquo;</a>
  </div>
</div>
<hr>
