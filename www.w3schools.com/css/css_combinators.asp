...
$(document).ready(function(){
  $("p.w3-green").click(function(){
    $(".parentdiv p").css({"color":"#F44336","border":"2px solid #F44336"});
  });
});
</script>
<style>
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_element_element" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
div &gt; p {<br>&nbsp;&nbsp;&nbsp; background-color: yellow;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_sel_element_gt" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
div + p {<br>&nbsp;&nbsp;&nbsp; background-color: yellow;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_sel_element_pluss" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
div ~ p {<br>&nbsp;&nbsp;&nbsp; background-color: yellow;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_sel_element_tilde" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_combinators1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_combinators2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_combinators3" target="_blank">Exercise 3 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_combinators4" target="_blank">Exercise 4 &raquo;</a>
  </div>
</div>
