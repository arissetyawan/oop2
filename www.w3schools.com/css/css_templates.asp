...
<h1>CSS <span class="color_h1">Templates</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_grid_item.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_examples.asp">Next &#10095;</a>
</div>
<hr>

<h2>CSS Layout Templates</h2>
<p>We have created some responsive starter templates with CSS.</p>
<p>You are free to modify, save, share, and use them in all your projects.</p>

<div class="w3-row-padding" style="margin:24px -22px">
  <div class="w3-col l6">
    <div class="w3-card-2 w3-padding w3-padding-16"><p style="margin-top:0px">Header, equal columns and footer:</p>
      <iframe src="trycss_template_ifr.htm" style="border:0;width:100%;overflow:hidden;height:280px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trycss_template1_float" class="w3-btn w3-block" style="margin-top:8px">Try it (using float) &raquo;</a>
      <a target="_blank" href="tryit.asp?filename=trycss_template1_flexbox" class="w3-btn w3-block" style="margin-top:8px">Try it (using flexbox) &raquo;</a>
      <a target="_blank" href="tryit.asp?filename=trycss_template1_grid" class="w3-btn w3-block" style="margin-top:8px">Try it (using grid) &raquo;</a>
    </div>
  </div>

  <div class="w3-col l6">
    <div class="w3-card-2 w3-padding w3-padding-16"><p style="margin-top:0px">Header, unequal columns and footer:</p>
      <iframe src="trycss_template_ifr3.htm" style="border:0;width:100%;overflow:hidden;height:280px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trycss_template2_float" class="w3-btn w3-block" style="margin-top:8px">Try it (using float) &raquo;</a>
      <a target="_blank" href="tryit.asp?filename=trycss_template2_flexbox" class="w3-btn w3-block" style="margin-top:8px">Try it (using flexbox) &raquo;</a>
      <a target="_blank" href="tryit.asp?filename=trycss_template2_grid" class="w3-btn w3-block" style="margin-top:8px">Try it (using grid) &raquo;</a>
    </div>
  </div>
</div>
<div class="w3-row-padding" style="margin:28px -22px">
  <div class="w3-col l6">
    <div class="w3-card-2 w3-padding w3-padding-16"><p style="margin-top:0px">Topnav, content and footer:</p>
      <iframe src="trycss_template_ifr2.htm" style="border:0;width:100%;overflow:hidden;height:280px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trycss_template3" class="w3-btn w3-block" style="margin-top:8px">Try it Yourself &raquo;</a>
    </div>
  </div>
  <div class="w3-col l6">
    <div class="w3-card-2 w3-padding w3-padding-16"><p style="margin-top:0px">Sidenav and content:</p>
      <iframe src="trycss_template_ifr4.htm" style="border:0;width:100%;overflow:hidden;height:280px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trycss_template4" class="w3-btn w3-block" style="margin-top:8px">Try it Yourself &raquo;</a>
    </div>
  </div>
</div>
