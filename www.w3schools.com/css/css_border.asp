...
<a class="w3-left w3-btn" href="css_background.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_margin.asp">Next &#10095;</a>
</div>
<hr>
<h2>CSS Border Properties</h2>
<p>The CSS <code class="w3-codespan" class="w3-codespan">border</code> properties allow you to specify the style, width, and color of an element's border.</p>
...
<h2>Border Style</h2>
<p>The <code class="w3-codespan" class="w3-codespan">border-style</code> property specifies what kind of border to display.</p>
...
<p>The <code class="w3-codespan" class="w3-codespan">border-style</code> property can have from one to four values (for 
...
<a target="_blank" href="tryit.asp?filename=trycss_border-style" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel w3-note">
  <p><b>Note:</b> None of the OTHER CSS border properties described below will have ANY effect unless the 
<code class="w3-codespan" class="w3-codespan">border-style</code> property is set!</p>
</div>
...
<h2>Border Width</h2>
<p>The <code class="w3-codespan" class="w3-codespan">border-width</code> property specifies the width of the four borders.</p>
...
<p>The <code class="w3-codespan" class="w3-codespan">border-width</code> property can have from one to four values (for 
the top border, right border, bottom border, and the left border).</p>
...
<h2>Border Color</h2>
<p>The <code class="w3-codespan" class="w3-codespan">border-color</code> property is used to set the color of the four borders.</p>
...
<p>The <code class="w3-codespan" class="w3-codespan">border-color</code> property can have from one to four values (for 
the top border, right border, bottom border, and the left border).&nbsp;</p>
<p>If <code class="w3-codespan" class="w3-codespan">border-color</code> is not set, it inherits the color of the element.</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-color1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-side" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-side2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>So, here is how it works:</p>
<p>If the <code class="w3-codespan" class="w3-codespan">border-style</code> property has four values:</p>
<ul>
...
<p>If the <code class="w3-codespan" class="w3-codespan">border-style</code> property has three values:</p>
<ul>
...
<p>If the <code class="w3-codespan" class="w3-codespan">border-style</code> property has two values:</p>
<ul>
...
<p>If the <code class="w3-codespan" class="w3-codespan">border-style</code> property has one value:</p>
<ul>
<li><b>border-style: dotted;</b><ul><li>all four borders are dotted</li></ul>
</li>
</ul>
<p>The <code class="w3-codespan" class="w3-codespan">border-style</code> property is used in the example above. However, it also works with 
<code class="w3-codespan" class="w3-codespan">border-width</code> 
and <code class="w3-codespan" class="w3-codespan">border-color</code>.</p>
<hr>
...
one property.</p>
<p>The <code class="w3-codespan" class="w3-codespan">border</code> property is a shorthand property for the following individual border properties:</p>
<ul>
<li><code class="w3-codespan" class="w3-codespan">border-width</code></li>
<li><code class="w3-codespan" class="w3-codespan">border-style</code> (required)</li>
<li><code class="w3-codespan" class="w3-codespan">border-color</code></li>
</ul>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<a target="_blank" href="tryit.asp?filename=trycss_border" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_border_left" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_border_bottom" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Rounded Borders</h2>
<p>The <code class="w3-codespan" class="w3-codespan">border-radius</code> property is used to add rounded borders to an element:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_border_round" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> The <code class="w3-codespan" class="w3-codespan">border-radius</code> property is not supported in IE8 and earlier versions.</p>
<hr>

<h2>More Examples</h2>
<p><a target="_blank" href="tryit.asp?filename=trycss_border-top">All the top border properties in one declaration</a><br>
This example demonstrates a shorthand property for setting all of the properties for the top border in one declaration.</p>

<p><a target="_blank" href="tryit.asp?filename=trycss_border-bottom-style">Set the style of the bottom border</a><br>
This example demonstrates how to set the style of the bottom border.</p>

<p><a target="_blank" href="tryit.asp?filename=trycss_border-left-width">Set the width of the left border</a><br>
This example demonstrates how to set the width of the left border.</p>

<p><a target="_blank" href="tryit.asp?filename=trycss_border-color">Set the color of the four borders</a><br>
This example demonstrates how to set the color of the four borders. It can have from one to four colors.</p>

<p><a target="_blank" href="tryit.asp?filename=trycss_border-right-color">Set the color of the right border</a><br>
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_border1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_border2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_border3" target="_blank">Exercise 3 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_border4" target="_blank">Exercise 4 &raquo;</a>
  </div>
</div>
