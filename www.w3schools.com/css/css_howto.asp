...
<a class="w3-left w3-btn" href="css_syntax.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_colors.asp">Next &#10095;</a>
</div>
<hr>
...
href=&quot;mystyle.css&quot;&gt;<br>
&lt;/head&gt;</div>
<a target="_blank" href="tryit.asp?filename=trycss_howto_external" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
&lt;/style&gt;<br>&lt;/head&gt;</div>
<a target="_blank" href="tryit.asp?filename=trycss_howto_internal" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trycss_howto_inline" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss_howto_multiple" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
&lt;/head&gt;</div>
<a target="_blank" href="tryit.asp?filename=trycss_howto_multiple2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><a class="w3-btn" href="tryit.asp?filename=trycss_howto_cascade" target="_blank">Try it Yourself &raquo;</a></p>
<hr>

<div class="w3-container w3-dark-grey w3-padding">
  <h2>Test Yourself with Exercises!</h2>
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_howto1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_howto2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_howto3" target="_blank">Exercise 3 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_howto4" target="_blank">Exercise 4 &raquo;</a>
  </div>
</div>
