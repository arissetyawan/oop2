...
<a class="w3-left w3-btn" href="css_dimension.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_outline.asp">Next &#10095;</a>
</div>
...
padding: 25px;<br>&nbsp;&nbsp;&nbsp; 
margin: 25px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_boxmodel" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
margin: 0;
<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_boxmodel_width" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_boxmodel1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_boxmodel2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_boxmodel3" target="_blank">Exercise 3 &raquo;</a>
    <a class="w3-bar-item w3-btn w3-hover-light-grey" href="exercise.asp?filename=exercise_boxmodel4" target="_blank">Exercise 4 &raquo;</a>
  </div>
</div>
<hr>
