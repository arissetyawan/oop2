...
<div class="w3-dark-grey w3-center w3-padding-large w3-padding-48" style="padding-bottom:68px!important">
  ...
  <div class="w3-third">
  <p><a class="w3-btn w3-green w3-block w3-padding-16" href="/html/html_exercises.asp">HTML Exercises &raquo;</a></p>
  </div>
  <div class="w3-third">
  <p><a class="w3-btn w3-green w3-block w3-padding-16" href="/css/css_exercises.asp">CSS Exercises &raquo;</a></p>
  </div>
  <div class="w3-third">
  <p><a class="w3-btn w3-green w3-block w3-padding-16" href="/js/js_exercises.asp">JavaScript Exercises &raquo;</a></p>
  </div>
  </div>
</div>
