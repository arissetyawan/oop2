...
<p>To insert an icon, add the name of the icon class to any inline HTML element.</p>
<p>The <code class="w3-codespan">&lt;i&gt;</code> and <code class="w3-codespan">&lt;span&gt;</code> elements are widely used to add 
icons.</p>
<p>All the icons in the icon libraries below, are scalable vector icons that can 
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryicons_awesome" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<p>To use the Bootstrap glyphicons, add the following line inside the <code class="w3-codespan">&lt;head&gt;</code> section of your HTML page:</p>
<p><code class="w3-codespan">&lt;link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"&gt;</code></p>
<p><strong>Note:</strong> No downloading or installation is required!</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryicons_bootstrap" target="_blank">Try It Yourself &raquo;</a></div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryicons_google" target="_blank">Try It Yourself &raquo;</a>
</div>


<div class="w3-panel w3-note">
<p>For a complete list of ALL icons (font awesome, bootstrap and google), visit the
<a href="icons_reference.asp">Icon Reference</a>.</p>
<p>For a complete list of all Font Awesome icons, visit the
<a href="fontawesome_icons_intro.asp">Font Awesome icon reference</a>.</p>
<p>For a complete list of all Bootstrap Glyphicons, visit the
<a href="bootstrap_icons_glyphicons.asp">Bootstrap Glyphicon reference</a>.</p>
<p>For a complete list of all Google icons, visit the
<a href="google_icons_intro.asp">Google icon reference</a>.</p>
</div>
<br>
