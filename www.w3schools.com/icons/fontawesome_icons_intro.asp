...
<html lang="en-US">
<head>
<title>Font Awesome Intro</title>
<meta charset="utf-8">
...
<h1>Font Awesome <span class="color_h1">Introduction</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="icons_reference.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="fontawesome_icons_brand.asp">Next &#10095;</a>
</div>
<hr>

<h2>Basic Icons</h2>
<p>To use the Font Awesome icons, add the following line inside the <code class="w3-codespan">&lt;head&gt;</code> section of your HTML page:</p>
<p><code class="w3-codespan">&lt;link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"&gt;</code></p>
<p><strong>Note:</strong> No downloading or installation is required!</p>
<p>You place Font Awesome icons by using the prefix <code class="w3-codespan">fa</code> and the icon's name.</p>
...
<p>The following code:</p>
 <div class="w3-code notranslate htmlHigh">
  ...
  &lt;/head&gt;<br>&lt;body&gt;<br><br>&lt;i class="fa fa-car"&gt;&lt;/i&gt;<br>
    &lt;i class="fa fa-car" style="font-size:48px;"&gt;&lt;/i&gt;<br>
    &lt;i class="fa fa-car" style="font-size:60px;color:red;"&gt;&lt;/i&gt;<br>
  <br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<p>Results in:</p>
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryicons_awesome_intro_basic" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<h1>Larger Icons</h1>
<p>The <code class="w3-codespan">fa-lg</code> (33% increase), <code class="w3-codespan">fa-2x</code>, <code class="w3-codespan">fa-3x</code>, 
<code class="w3-codespan">fa-4x</code>, or <code class="w3-codespan">fa-5x</code> classes are used to increase the icon sizes relative to their container.</p>

<div class="w3-example">
<h3>Example</h3>
<p>The following code:</p>
 <div class="w3-code notranslate htmlHigh">
     &lt;i class="fa fa-car fa-lg"&gt;&lt;/i&gt;<br>
    &lt;i class="fa fa-car fa-2x"&gt;&lt;/i&gt;<br>
    &lt;i class="fa fa-car fa-3x"&gt;&lt;/i&gt;<br>
    &lt;i class="fa fa-car fa-4x"&gt;&lt;/i&gt;<br>
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryicons_awesome_intro_larger" target="_blank">Try It Yourself &raquo;</a>
</div>
<p><b>Tip:</b> If your icons are getting chopped off on top and bottom, increase the line-height.</p>
<hr>
...
<p>The following code:</p>
 <div class="w3-code notranslate htmlHigh">
&lt;ul class="fa-ul"&gt;<br>&nbsp; &lt;li&gt;&lt;i class="fa-li fa fa-check-square"&gt;&lt;/i&gt;List 
icons&lt;/li&gt;<br>&nbsp;
&lt;li&gt;&lt;i class="fa-li fa fa-spinner fa-spin"&gt;&lt;/i&gt;List icons&lt;/li&gt;<br>&nbsp; &lt;li&gt;&lt;i class="fa-li 
fa fa-square"&gt;&lt;/i&gt;List icons&lt;/li&gt;<br>&lt;/ul&gt;</div>
<p>Results in:</p>
<div class="w3-white w3-padding notranslate">
<ul class="fa-ul">
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryicons_awesome_intro_list" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<p>The following code:</p>
<div class="w3-code notranslate htmlHigh">
&lt;i class="fa fa-quote-left fa-3x fa-pull-left fa-border"&gt;&lt;/i&gt;<br>
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryicons_awesome_intro_pull" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<p>The following code:</p>
<div class="w3-code notranslate htmlHigh">
&lt;i class="fa fa-spinner fa-spin"&gt;&lt;/i&gt;<br>&lt;i class="fa fa-circle-o-notch fa-spin"&gt;&lt;/i&gt;<br>
&lt;i class="fa fa-refresh fa-spin"&gt;&lt;/i&gt;<br>&lt;i class="fa fa-cog fa-spin"&gt;&lt;/i&gt;<br>&lt;i 
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryicons_awesome_intro_animate" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<p>The following code:</p>
<div class="w3-code notranslate htmlHigh">
&lt;i class="fa fa-shield"&gt;&lt;/i&gt;<br>&lt;i class="fa fa-shield fa-rotate-90"&gt;&lt;/i&gt;<br>&lt;i class="fa fa-shield fa-rotate-180"&gt;&lt;/i&gt;<br>&lt;i class="fa fa-shield fa-rotate-270"&gt;&lt;/i&gt;<br>&lt;i class="fa fa-shield fa-flip-horizontal"&gt;&lt;/i&gt;<br>&lt;i class="fa fa-shield fa-flip-vertical"&gt;&lt;/i&gt;</div>
<p>Results in:</p>
<div class="w3-white w3-padding notranslate">
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryicons_awesome_intro_rotate" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>
...
<p>The following code:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;span class="fa-stack fa-lg"&gt;<br>&nbsp; &lt;i class="fa fa-circle-thin fa-stack-2x"&gt;&lt;/i&gt;<br>&nbsp; &lt;i class="fa fa-twitter fa-stack-1x"&gt;&lt;/i&gt;<br>
 &lt;/span&gt;<br>
 fa-twitter on fa-circle-thin&lt;br&gt;<br><br>&lt;span class="fa-stack fa-lg"&gt;<br>&nbsp; &lt;i class="fa fa-circle fa-stack-2x"&gt;&lt;/i&gt;<br>&nbsp; &lt;i class="fa fa-twitter fa-stack-1x fa-inverse"&gt;&lt;/i&gt;<br>&lt;/span&gt;<br>fa-twitter (inverse) on fa-circle&lt;br&gt;<br><br>
 &lt;span class="fa-stack fa-lg"&gt;<br>&nbsp; &lt;i class="fa fa-camera fa-stack-1x"&gt;&lt;/i&gt;<br>&nbsp; &lt;i class="fa fa-ban fa-stack-2x text-danger" style="color:red;"&gt;&lt;/i&gt;<br>&lt;/span&gt;<br>fa-ban on fa-camera</div>
<p>Results in:</p>
<div class="w3-white w3-padding notranslate">
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryicons_awesome_intro_stack" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h1>Fixed Width Icons</h1>
<p>The <code class="w3-codespan">fa-fw</code> class is used to set icons at a fixed width. This class is useful when different icon 
widths throw off alignment. Especially useful in Bootstrap's navlists and list groups.</p>
<div class="w3-example">
<h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
  &lt;div class="list-group"&gt;<br>&nbsp; &lt;a href="#" class="list-group-item"&gt;&lt;i  class="fa fa-home fa-fw"&gt;&lt;/i&gt; Home&lt;/a&gt;<br>&nbsp; &lt;a href="#"  class="list-group-item"&gt;&lt;i class="fa fa-book fa-fw"&gt;&lt;/i&gt; Library&lt;/a&gt;<br>&nbsp;  &lt;a href="#" class="list-group-item"&gt;&lt;i class="fa fa-pencil fa-fw"&gt;&lt;/i&gt;  Applications&lt;/a&gt;<br>&nbsp; &lt;a href="#" class="list-group-item"&gt;&lt;i class="fa  fa-cog fa-fw"&gt;&lt;/i&gt; Settings&lt;/a&gt;<br>&lt;/div&gt; </div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryicons_awesome_intro_fixed" target="_blank">Try It Yourself &raquo;</a>
</div>
<hr>

<h1>Bootstrap</h1>
<p>Font Awesome also works great with all the Bootstrap components.</p>
