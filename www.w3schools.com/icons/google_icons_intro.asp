...
<html lang="en-US">
<head>
<title>Google Icons Intro</title>
<meta charset="utf-8">
...
.w3-code .md-18 {font-size:18px !important;}
.w3-code .md-36 {font-size:36px;}
.w3-code .md-48 {font-size:48px;}
</style>
</head>
<body>
...
<h1>Google Icons <span class="color_h1">Introduction</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_icons_glyphicons.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="google_icons_action.asp">Next &#10095;</a>
</div>
<hr>

<h2>Basic Icons</h2>
<p>To use the Google icons, add the following line inside the <code class="w3-codespan">&lt;head&gt;</code> section of your HTML page:</p>
...
<p>Add the <code class="w3-codespan">material-icons</code> class to an inline element and insert the 
icon's name:</p>
...
<p>The following code:</p>
 <div class="w3-code notranslate htmlHigh">
  ...
  <br>&lt;i class="material-icons"&gt;cloud&lt;/i&gt;<br>&lt;i class="material-icons"  style="font-size:48px;"&gt;cloud&lt;/i&gt;<br>&lt;i class="material-icons"  style="font-size:60px;color:red;"&gt;cloud&lt;/i&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<p>Results in:</p>
<div class="w3-code notranslate">
<i class="material-icons">cloud</i>
<i class="material-icons" style="font-size:48px;">cloud</i>
<i class="material-icons" style="font-size:60px;color:red;">cloud</i></div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryicons_google-intro_basic" target="_blank">Try It Yourself &raquo;</a>
</div>

<p>Google icons are designed to be used with inline elements. The <code class="w3-codespan">&lt;i&gt;</code> and <code class="w3-codespan">&lt;span&gt;</code> 
elements are widely used for icons.</p>
<p><strong>Note:</strong> Material icons are 24px by default.</p>
<p>Also note that if you change the color of the icon's container, the color of 
the icon 
...
unless something else is specified.</p>
<hr>
...
<h1>Sizable Icons</h1>
<p>Although the material icons can be scaled to any size, the recommended 
font-size is either 18, 24, 36 or 48px:</p>

<div class="w3-example">
<h3>Example</h3>
<p>The following code:</p>
 <div class="w3-code notranslate htmlHigh">
     &lt;style&gt;<br><span style="color:green">/* Rules for icon sizes: */</span><br><span style="color:brown">.material-icons.md-18</span> { <span style="color:red;">font-size:</span> <span style="color:mediumblue">
  18px;</span> }<br><span style="color:brown">.material-icons.md-24</span> { <span style="color:red;">font-size:</span> <span style="color:mediumblue">
  24px;</span>  } <span style="color:green"> /* Default */</span><br><span style="color:brown">.material-icons.md-36</span> { <span style="color:red;">font-size:</span> <span style="color:mediumblue">
  36px;</span> }<br><span style="color:brown">.material-icons.md-48</span> { <span style="color:red;">font-size:</span> <span style="color:mediumblue">
  48px;</span> }<br>&lt;/style&gt;<br><br>&lt;i class="material-icons md-18"&gt;cloud&lt;/i&gt;<br>&lt;i class="material-icons  md-24"&gt;cloud&lt;/i&gt;<br>&lt;i class="material-icons md-36"&gt;cloud&lt;/i&gt;<br>&lt;i class="material-icons  md-48"&gt;cloud&lt;/i&gt;</div>
<p>Results in:</p>
 <div class="w3-code notranslate">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryicons_google-intro-size" target="_blank">Try It Yourself &raquo;</a>
</div>
