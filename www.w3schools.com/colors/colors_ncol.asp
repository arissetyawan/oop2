...
<h1>Colors <span class="color_h1">NCol</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="colors_cmyk.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="colors_gradient.asp">Next &#10095;</a>
</div>
<br>
<div class="w3-container w3-padding-large" style="background-color:#f1f1f1;border:1px solid #d3d3d3;">
<h2>NCol Calculator</h2>
<br>
<div class="w3-row">
...
<h2>Natural Colors (NCol)</h2>
<p>Natural colors (NCol) is an initiative from W3Schools.</p>
<p>The system is designed to make it easier to select HTML colors.</p>
<p>NCol specifies colors using a color letter with a number to specify the distance (in percent) from the color.</p>
<p>R30 means 30% away from <strong>Red</strong> , moving towards <strong>Yellow</strong>. (In other words: Red with 30% Yellow)</p>

<table class="w3-table-all">
<tr><th>Letter</th><th>Color</th><th>Hues</th></tr>
...
<p>Color and distance can also be given in hues (0-360):</p>
...
<hr>
<h2>HTML Support</h2>
<p>NCol is not supported in HTML (yet), but it is very close to the new HWB 
color system suggested in CSS4. </p>
<p>While waiting for CSS4, you can include W3Schools' Color library, and use NCol as an HTML attribute like this:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycolors_ncol" target="_blank">Try It Yourself &raquo;</a>
</div>
...
<p>Trying to explain colors using RGB or HEX notation is very difficult.</p>
<p>Can you tell what color rgb(199,21,133) is?</p>
<p>RGB is based on how to physically produce colors by mixing light sources.</p>
<p><strong>NCol is based on what colors look like to the human eye. </strong> </p>
<p>Because of this, NCol makes it much easier to describe colors. </p>
<p>Natural colors were first described by Karl Ewald Konstantin Hering (Germany 
1834 - 1918).</p>
