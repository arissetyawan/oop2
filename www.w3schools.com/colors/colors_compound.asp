...
<html lang="en-US">
<head>
<title>Color Scheme - Compound</title>
...
<h1>Compound Color Schemes (or Split Complementary)</h1>

<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="colors_triadic.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="colors_fs595.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Compound schemes are almost the same as complementary schemes.</p>
<p class="intro">Instead of using colors that are opposites, it uses colors on both sides of the opposite hue</p>
