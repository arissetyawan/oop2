...
<html lang="en-US">
<head>
<title>Color Scheme - Monochromatic</title>
<script src="/lib/w3color.js"></script>
<script src="trycolorwheel.js"></script>
<link href='trycolorwheel.css' rel='stylesheet'>
...
<h1>Monochromatic Color Schemes</h1>

<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="colors_trends.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="colors_analogous.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">Monochromatic color schemes are easy to create because they use only one color.</p>
<p class="intro">Monochromatic schemes use different tones from the same angle on the color wheel (<strong>the same hue</strong>).</p>

<div w3-include-html="trycolorwheel.htm"></div> 
...
<p>Monochromatic color schemes are guaranteed to suit each other because they 
all come from the same family. </p>
<hr>
