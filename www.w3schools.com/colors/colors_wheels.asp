...
<h1>Color <span class="color_h1">Wheels</span></h1>

<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="colors_theory.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="colors_hues.asp">Next &#10095;</a>
</div>
<hr>

<h2>Color Wheels</h2>
<p>A color wheel is an illustrative organization of colors around a circle,
showing the relationships between primary colors, secondary colors, and tertiary colors.</p>

<p><img src="pic_ryb_itten.jpg" alt="Color Wheel" style="max-width:100%"></p>
<hr>

<h2>Three Important Color Wheels</h2>
<p>How many ways can you rearrange the rainbow?</p>

<div class="w3-row-padding" style="margin:0 -16px">
<div class="w3-third">
<div class="w3-container w3-center w3-card">
<p class="w3-xlarge">RGB</p>
<img alt="Color Scheme" src="pic_rgb_wheel.gif" style="max-height:150px">
<p>Red, Green, Blue</p>
</div>
</div>
<div class="w3-third ">
...
<img alt="Color Scheme" src="pic_cmyk_wheel.gif" style="max-height:150px">
...
<img alt="Color Scheme" src="pic_ryb_wheel.gif" style="max-height:150px">
<p>Red, Yellow, Blue</p>
</div>
</div>
</div>
...
<hr>
<h2>The RGB Color Wheel</h2>
<div class="w3-row w3-section">
<div class="w3-col" style="width:250px">
<img alt="Color Scheme" src="pic_rgb_wheel.gif" style="height:230px">
</div>
<div class="w3-rest">
<p>The RGB (Red, Green, Blue) color wheel represents the 3 light sources used to produce colors on a TV 
or computer screen.</p>
<p><strong>Primary colors are Red, Green, and Blue.</strong></p>
<p>Secondary colors are created by mixing primary colors:</p>
<p>Red and Green= Yellow<br>Green and Blue = Cyan<br>Blue and Red = Magenta</p>
</div>
</div>
<h3>The 12 Main Colors of RGB:</h3>
...
<td style="background-color:#00ff80"><br>#00FF80<br>(0,255,80)</td>
</tr>
<tr>
...
<td style="color:white;background-color:#8000ff"><br>#8000FF<br>(128,00,255)</td>
...
<p>RGB Green is different from the HTML color named Green.</p>
</div>
<div class="w3-container" style="color:white;background-color:green">
<p>RGB Green is different from the HTML color named Green.</p>
</div>

<p><a href="colors_rgb.asp">Read more about RGB</a>.</p>
<hr>
...
<h2>The CMY(K) Color Wheel</h2>
<div class="w3-row w3-section">
<div class="w3-col" style="width:250px">
<img alt="Color Scheme" src="pic_cmyk_wheel.gif" style="height:230px">
</div>
<div class="w3-rest">
<p>The CMY(K) (Cyan, Magenta, Yellow) represent the colors used to print on paper.</p>
<p><strong>The primary colors are Cyan, Magenta, and Yellow.</strong></p>
<p>Secondary colors are created by mixing primary colors:</p>
<p>Cyan and Magenta = Blue<br>Magenta and Yellow = Red<br>Yellow and Cyan = 
Green.</p>
</div>
</div>
<h3>The 12 Main Colors of CYM:</h3>
<table class="w3-table-all w3-section w3-small">
<tr>
...
<p><a href="colors_cmyk.asp">Read more about CMYK</a>.</p>
<hr>

<h2>The RYB Color Wheel</h2>
<div class="w3-row">
<div class="w3-col" style="width:250px">
<img alt="Color Scheme" src="pic_ryb_itten.jpg" style="margin-top:16px;height:230px">
</div>
<div class="w3-rest">
<p>The RYB (Red, Yellow, Blue) color wheel is used by painters, artists and 
designers for blending pigment colors.</p>
<p>The 3 primary colors are <strong>Red, Yellow, and Blue.</strong></p>
<p>Secondary colors are created by mixing primary colors.</p>
	<p>The 3 secondary colors are Orange, Green, and Purple.</p>
<p>Red and Yellow = Orange<br>Yellow and Blue = Green<br>Blue and Red = Purple.</p>
</div>
</div>

<p>The tertiary colors are made by mixing two secondary colors.</p>
<p>The 6 tertiary colors are Red-Orange, Yellow-Orange, Yellow-Green, Blue-Green, Blue-Purple, Red-Purple </p>


<h3>The 12 Main Colors of RYB:</h3>
<table class="w3-table-all w3-section w3-small">
<tr>
...
<div class="w3-panel w3-pale-yellow w3-border w3-lefttile">
	<p>RYB is the best color wheel to identify the colors that go well together.</p>
<p>The RYB wheel can be used to create pleasing color schemes for the web.</p>
<p>You will learn more about color schemes in the chapter of
<a href="colors_schemes.asp">Color Schemes</a>.</p>
</div>
