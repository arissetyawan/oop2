...
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="colors_ncol.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="colors_theory.asp">Next &#10095;</a>
</div>
<br>
...
var thisleft = "135";
      ...
      <div id='selectedhexagon2' style='visibility:hidden;position:relative;width:21px;height:21px;background-image:url("img_selectedcolor.gif")'></div>
    </div>
  </div>
</div>
...
<a class="w3-btn w3-margin-bottom" onclick="submitTryit()" href="tryit.asp?filename=trycolors_gradient" target="_blank">Try It Yourself &raquo;</a>
<form id="gradientform" action="tryit.asp?filename=trycolors_gradient" target="_blank" method="post">
