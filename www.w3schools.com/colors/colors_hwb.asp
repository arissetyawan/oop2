...
<h1>Colors <span class="color_h1">HWB</span></h1>

<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="colors_hsl.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="colors_cmyk.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">HWB (Hue, Whiteness, Blackness) is a suggested standard for CSS4.</p>

<hr>
<div class="w3-container w3-padding-large" style="background-color:#f1f1f1;border:1px solid #d3d3d3;">
<h2>HWB Calculator</h2>
<br>
<div class="w3-row">
...
<hr>
<h2>HTML Support</h2>
<p>HWB is not supported in HTML (yet), but it is suggested as a new standard in CSS4. </p>
<p>While waiting for CSS4, you can include W3Schools' Color library, and use HWB as an HTML attribute like this:</p>
...
&lt;/div&gt;<br><br>&lt;script src=&quot;/lib/w3color.js&quot;&gt;&lt;/script&gt;
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycolors_hwb" target="_blank">Try It Yourself &raquo;</a>
</div>
