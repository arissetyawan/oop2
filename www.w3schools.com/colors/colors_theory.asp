...
<h1>Color <span class="color_h1">Theory</span></h1>

<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="colors_gradient.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="colors_wheels.asp">Next &#10095;</a>
</div>
<hr>

<h2>What is Color Theory?</h2>
<p>Color theory is a multitude of categories, definitions and concepts.</p>
<p>This tutorial covers the parts that are most useful for web design:</p>
<ul class="w3-ul w3-border">
	<li>Primary, Secondary, and Tertiary Colors</li>
	<li>Color Wheels (RGB, CMY, RYB)</li>
	<li>Color Hue, Lightness and Saturation</li>
</ul>

<hr>
<h2>The Color of Light</h2>
<p>Sir Isaac Newton developed the theory 
that all colors are mixtures of <strong>Red</strong>, <strong>Green</strong>, and <strong>Blue</strong> light.</p>
<p>This resulted in the first known color circle in 1666.</p>

<div class="w3-row">
<div class="w3-half">
<img src="img_newton.jpg" alt="Sir Isaac Newton" style="width:90%">
</div>
<div class="w3-half">
<img src="img_newton_wheel.jpg" alt="Color Wheel" style="width:100%">
</div>
</div>

<hr>
<h2>The Color of Paint</h2>
<p>In 1766 the scientist Moses Harris created the first color wheel to classify 
<strong>Red</strong>, <strong>Yellow</strong>, and <strong>Blue</strong> as the primary colors.</p>
<p>Moses Harris worked with paint (Newton worked with light) following a theory (by a French painter) that all 
colors are mixtures of Red, Yellow, and Blue pigments.</p>

<div class="w3-row">
<div class="w3-half">
<img src="img_moses_harris.jpg" alt="Moses Harris" style="width:90%">
</div>
<div class="w3-half">
<img src="img_harris_wheel.jpg" alt="Color Wheel" style="width:100%">
</div>
</div>
<hr>
...
<h2>Color Systems</h2>
<p>In this tutorial we will cover 3 different color systems:</p>
<ul>
	<li>The color system used when producing colors by light (RGB)</li>
	<li>The color system used when printing (CMY)</li>
	<li>The color system used by artist and painters (RYB)</li>
</ul>
<div class="w3-panel w3-note">
<p>Printing actually uses a four ink color system.</p>
	<p>CMYK: Cyan, Magenta, Yellow, and Key (black).</p>
</div>
<hr>

<h2>Primary Colors</h2>
<p>Primary colors are the <strong>main colors</strong> in a given color system.</p>
<p>Primary colors can not be produced by mixing other colors a color system.</p>

<p>The primary colors for <strong>light</strong> are Red, Green, and Blue:</p>
...
<p>The primary colors for <strong>print</strong> are Cyan, Magenta, and Yellow:</p>
<table class="w3-table w3-card">
<tr>
<tr>
...
<p>The primary colors for <strong>paint</strong> are Red, Yellow, and Blue:</p>
<table class="w3-table w3-card">
<tr>
<tr>
...
<p>Secondary colors are made by <strong>mixing two primary colors</strong> in a color system</p>
<p>There are 3 secondary colors in the color systems described here.</p>
<hr>

<h3>Mixing Light (RGB)</h3>
<p>Secondary colors are Yellow, Cyan Magenta.</p>
...
<hr>
<h3>Mixing Ink (CMY)</h3>
<p>Secondary colors are Blue, Red, Green.</p>
<table class="w3-table w3-bordered w3-border">
<tr>
<td style="width:30%;background-color:cyan">Cyan</td>
<td style="width:5%;text-align:center"><b>+</b></td>
...
<div class="w3-panel w3-note">
<p>Note that mixing the primary colors of CMY produces the primary colors of light (RGB)</p>
</div>
<hr>
<h3>Mixing Paint (RYB)</h3>
<p>Secondary colors are Orange, Green, Violet.</p>
<table class="w3-table w3-bordered w3-border">
<tr>
<td style="width:30%;color:white;background-color:#fe2712">Red</td>
<td style="width:5%;text-align:center"><b>+</b></td>
...
<p>Tertiary colors are made by mixing one<strong> primary </strong>and one<strong> 
secondary</strong> color in a color system.</p>
<p>There are six named tertiary colors in RYB:</p>
<ul>
	<li>Red-Orange</li>
	<li>Yellow-Orange</li>
	<li>Yellow-Green</li>
...
<div class="w3-half">
<img class="w3-right" src="img_tertiary.jpg" alt="Tertiary" style="width:90%">
</div>
</div>
