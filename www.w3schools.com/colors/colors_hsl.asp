...
<h1>Colors <span class="color_h1">HSL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="colors_hexadecimal.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="colors_hwb.asp">Next &#10095;</a>
</div>
<br>
<div class="w3-container w3-padding-large" style="background-color:#f1f1f1;border:1px solid #d3d3d3;">
<h2>HSL Calculator</h2>
<br>
<div class="w3-row">
...
<p>HSL color values are specified with: <code class="w3-codespan">hsl(<em>hue</em>, <em>saturation</em>, 
<em>lightness</em>)</code>.</p>
<hr>
<h2>Hue</h2>
<p>Hue is a degree on the color wheel from 0 to 360. 0 is red, 120 
is green, 240 is blue.</p>
<hr>
<h2>Saturation</h2>
<p>Saturation is a percentage value; 0% means a shade of 
gray and 100% is the full color.</p>


<hr>
<h2>Lightness</h2>
<p>Lightness is also a percentage; 0% is black, 
100% is white.</p>
...
<p>HSL color values are supported in all major browsers.</p>
...
<br>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycolors_hsl" target="_blank">Try It Yourself &raquo;</a>
</div>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="colors_hexadecimal.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="colors_hwb.asp">Next &#10095;</a>
