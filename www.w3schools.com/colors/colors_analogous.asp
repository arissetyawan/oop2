...
<html lang="en-US">
<head>
<title>Color Scheme - Analogous</title>
...
<h1>Analogous Color Schemes</h1>

<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="colors_monochromatic.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="colors_complementary.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">Analogous color schemes are created by using colors that are next to each other on the color wheel.</p>
...
<p>If an analogous color scheme does not have enough contrast between the colors (for an nice website design), it can be adjusted to give it more variety.</p>
<hr>
