...
<h1>Color <span class="color_h1">Hues, Tints, Shades, and Tones</span></h1>

<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="colors_wheels.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="colors_schemes.asp">Next &#10095;</a>
</div>
<hr>

<h2>Color Hue</h2>
<p>Hue is just another word for color.</p>
<p>Simply put: Each position around the color wheel represents a different hue:</p>
<div class="w3-row">
...
<p>You can experiment with hue values using our <a href="colors_picker.asp">Color Picker</a>.</p>

<hr>

<h2>Color Value (Lightness / Darkness)</h2>
<p>Color value is a term for how light or dark dark a color is (from white to black)</p>
<p>These 3 examples changes the lightness and darkness for red, orange, and yellow hues:</p>
...
<p>You can experiment with lightness and darkness for the same hue using our <a href="colors_picker.asp">Color Picker</a>.</p>
<hr>
...
<p>Saturation is about intensity.</p>
<p>Highly saturated colors are bright. Desaturated colors have less pigment.</p>
<p>These 3 examples changes the saturation for red, orange, and yellow hues:</p>
<div class="w3-row">
<div class="w3-third">
<div class="w3-container" style="background-color:#ff0000;height:200px"><h3>#ff0000</h3></div>
</div>
...
<p>You can experiment with saturation values for the 
same hue using our <a href="colors_picker.asp">Color Picker</a>.</p>
