...
<h1>Color <span class="color_h1">Schemes</span></h1>

<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="colors_hues.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="colors_palettes.asp">Next &#10095;</a>
</div>
<hr>
...
<h1>Color Schemes</h1>
<p>Color schemes are logical combinations of colors on the color wheel.</p>
<p>The purpose of a color scheme is to create an aesthetic feeling of style and 
appeal.</p>
</div>
<div class="w3-half w3-container w3-center">
<img alt="Color Weel" src="pic_ryb_itten.jpg" style="max-width:200px;height:auto;">
</div>
</div>
<hr>
...
<div class="w3-row">
  ...
  <div class="w3-col m9 w3-container">
    ...
    <p>The white on black achromatic color scheme is often preferred for smaller devices.</p>
    <p>White on black requires less energy (improves battery life) on most display technologies.</p>
  </div>
</div>
...
<div class="w3-row">
  <div class="w3-col m3 w3-center">
    <img alt="Monochromatic Color Scheme" src="img_monochromatic.png" style="width:100%;max-width:200px;height:auto;">
  </div>
  <div class="w3-col m9 w3-container">
    <p>Monochromatic color schemes are easy to create because they use only one color.</p>
    <p>Monochromatic schemes use different tones from the same angle on the color wheel (<strong>the same hue</strong>).</p>
    <p>Experiment and learn more using our <a href="colors_monochromatic.asp">Monochromatic Color Scheme Generator</a>.</p>
  </div>
</div>
...
<div class="w3-row">
  <div class="w3-col m3 w3-center">
    <img alt="Analogous Color Scheme" src="img_analogous.png" style="width:100%;max-width:200px;height:auto;">
  </div>
  <div class="w3-col m9 w3-container">
    <p>Analogous color schemes are also easy to create.</p>
    <p>Analogous color schemes are created by using colors that are next to each other on the color wheel.</p>
    <p>Experiment and learn more using our <a href="colors_analogous.asp">Analogous Color Scheme Generator</a>.</p>
  </div>
</div>
...
<div class="w3-row">
  <div class="w3-col m3 w3-center">
    <img alt="Complementary Color Scheme" src="img_complementary.png" style="width:100%;max-width:200px;height:auto;">
  </div>
  <div class="w3-col m9 w3-container">
    <p>Complementary schemes are created by combining colors from opposite sides of the color wheel.</p>
    <p>Experiment and learn more using our <a href="colors_complementary.asp">Complementary Color Scheme Generator</a>.</p>
  </div>
</div>
...
<div class="w3-row">
  <div class="w3-col m3 w3-center">
    <img alt="Triadic Color Scheme" src="img_triadic.png" style="width:100%;max-width:200px;height:auto;">
  </div>
  <div class="w3-col m9 w3-container">
    <p>Triadic schemes are made up of hues equally spaced around color wheel.</p>
    <p>Experiment and learn more using our <a href="colors_triadic.asp">Triadic Color Scheme Generator</a>.</p>
  </div>
</div>

<hr>

<h2>Compound (aka Split Complementary) Color Scheme</h2>
<div class="w3-row">
  <div class="w3-col m3 w3-center">
    <img alt="Compound Color Scheme" src="img_compound.png" style="width:100%;max-width:200px;height:auto;">
  </div>
  <div class="w3-col m9 w3-container">
    <p>Compound schemes are almost the same as complementary schemes.</p>
    <p>Instead of using colors that are opposites, it uses colors on both sides of the opposite hue.</p>
    <p>Experiment and learn more using <a href="colors_compound.asp">Compound Color Scheme Generator</a>.</p>
  </div>
</div>
