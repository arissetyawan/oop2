...
<a class="w3-left w3-btn" href="colors_metro.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="colors_trends.asp">Next &#10095;</a>
</div>

<hr>
<ul>
<li>Colors can influence human behavior.</li>
<li>Colors can influence human perceptions.</li>
<li>Colors can influence the taste of food.</li>
<li>Colors can influence attractiveness.</li>
</ul>
<hr>
<h2>The Perception of Colors</h2>

<div class="w3-container w3-section w3-red">
<h2 class="w3-center">RED</h2>
<p class="w3-center w3-xlarge">Red attracts the human eye</p>
</div>
<div class="w3-container w3-section w3-red">
<div class="w3-row">
<div class="w3-third w3-center w3-xlarge">
<h2>Energy</h2>
<p>
Power<br>
Strength<br>
...
<h2 class="w3-center">GREEN</h2>
<p class="w3-center w3-xlarge">Green is the most restful color</p>
</div>
<div class="w3-container w3-section w3-green">
<div class="w3-row">
<div class="w3-third w3-center w3-xlarge">
...
<h2 class="w3-center">BLUE</h2>
<p class="w3-center w3-xlarge">Blue is the most used office color</p>
</div>
<div class="w3-container w3-section w3-blue">
<div class="w3-row">
<div class="w3-third w3-center w3-xlarge">
...
<h2 class="w3-center">Yellow</h2>
<p class="w3-center w3-xlarge">Yellow is a Happy Color</p>
</div>
<div class="w3-container w3-section w3-yellow">
<div class="w3-row">
<div class="w3-half w3-center w3-xlarge">
<h2>Sunshine</h2>
<p>
Light<br>
Clarity<br>
...
<h2 class="w3-center">Black</h2>
<p class="w3-center w3-xlarge">Black is Authority and Mystery</p>
</div>
<div class="w3-container w3-section w3-black">
<div class="w3-row">
<div class="w3-half w3-center w3-xlarge">
...
<div class="w3-container w3-section w3-gray">
<h2 class="w3-center">Gray</h2>
<p class="w3-center w3-xlarge">Grey is Conservative</p>
</div>

<div class="w3-container w3-section w3-grey w3-center w3-xlarge">
<p>Security</p>
<p>Reliability</p>
<p>Classic Knowledge</p>
<p>Professional Wisdom</p>
</div>

<div class="w3-container w3-section w3-border w3-center w3-xlarge">
<h2 class="w3-center">White</h2>
<p class="w3-center w3-xlarge">White is Purity</p>
<p>Cleanliness</p>
<p>Neutrality</p>
<p>Goodness</p>
<p>Innocence</p>
