...
<html lang="en-US">
<head>
<title>How To - Fading Buttons</title>
<meta charset="utf-8">
...
.btn3:hover {background-color: #3e8e41;color:white}
...
<h1>How TO - Fading Buttons</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_animate_buttons.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_button_on_image.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create fading buttons with CSS.</p>
<hr>

<h2>Fading Buttons</h2>
<div class="w3-row-padding" style="margin:0 -16px">

<div class="w3-col l4 x">
<div class="w3-example">
<h3>Example</h3>
<p>Fade in on hover:</p>
<div class="w3-padding w3-white">
<button class="btn btn1" style="width:150px;">Fade In</button>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_buttons_fade1" class="w3-btn w3-margin-top w3-margin-bottom">
...
<div class="w3-example">
<h3>Example</h3>
<p>Fade out on hover:</p>
<div class="w3-padding w3-white">
<button class="btn btn2" style="width:150px;">Fade Out</button>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_buttons_fade2" class="w3-btn w3-margin-top w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Fade background on hover:</p>
<div class="w3-padding w3-white">
<button class="btn btn3" style="width:150px;">Fade Bg</button>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_buttons_fade3" class="w3-btn w3-margin-top w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
</div>
