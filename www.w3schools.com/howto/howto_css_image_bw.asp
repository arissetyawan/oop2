...
<html lang="en-US">
<head>
<title>How To Create a Black and White Image</title>
<meta charset="utf-8">
...
<h1>How TO - Black and White Images</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_image_effects.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_text.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a "black and white" image with CSS.</p>
<hr>
...
<div class="w3-row-padding" style="margin:-16px -16px 24px -16px">
  <div class="w3-half">
  <p>Original image</p>
<img src="pineapple.jpg" alt="Pineapple" class="w3-image" style="width:100%;">
</div>
   <div class="w3-half">
 <p>grayscale(100%)</p>

 <img class="w3-image filtergray" src="pineapple.jpg" alt="Pineapple" style="width:100%;">
</div>
</div>
</div>
<p>Use the CSS <code class="w3-codespan">filter</code> property to convert an image to black and white.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_filter_grayscale">Try it Yourself &raquo;</a>
</div>

<p>Go to our <a href="/css/css3_images.asp">CSS Images Tutorial</a> to learn 
more about how to style images.</p>
<p>Go to our <a href="/cssref/css3_pr_filter.asp">CSS filter Property</a> to learn more about 
CSS filters.</p>
