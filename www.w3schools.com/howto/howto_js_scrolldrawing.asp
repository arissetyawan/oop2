...
<html lang="en-US">
<head>
<title>How To Draw on Scroll</title>
<meta charset="utf-8">
...
<h1>How TO - Scroll Drawing</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_fullscreen.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_smooth_scroll.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to draw on scroll using JavaScript and SVG.</p>
<hr>
<iframe src="tryhow_js_svg_scrolldrawing.htm" style="height:300px;width:100%;border:3px solid #e9e9e9"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_svg_scrolldrawing" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>Scroll Drawing</h2>
<p>Using SVG and JavaScript to draw a triangle on scroll - note that it has to be a 
&lt;path&gt; element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
&lt;svg id=&quot;mySVG&quot;&gt;<br>&nbsp; &lt;path fill=&quot;none&quot; stroke=&quot;red&quot; stroke-width=&quot;3&quot; 
id=&quot;triangle&quot; d=&quot;M150 0 L75 200 L225 200 Z&quot;/&gt;<br>&lt;/svg&gt;<br><br>&lt;script&gt;<br>// Get the id of the 
&lt;path&gt; element and the length of &lt;path&gt;<br>var triangle = 
document.getElementById(&quot;triangle&quot;);<br>var length = triangle.getTotalLength();<br>
<br>// The start position of the drawing<br>triangle.style.strokeDasharray = 
length;<br><br>// Hide the triangle by offsetting dash. Remove this line to 
show the triangle before scroll draw<br>triangle.style.strokeDashoffset = 
length;<br><br>// Find scroll percentage on scroll (using cross-browser 
properties), and offset dash same amount as percentage scrolled<br>
window.addEventListener(&quot;scroll&quot;, myFunction);<br><br>function myFunction() 
{<br>&nbsp; var scrollpercent = (document.body.scrollTop + 
document.documentElement.scrollTop) / (document.documentElement.scrollHeight 
- document.documentElement.clientHeight);<br><br>&nbsp; var draw = length * 
scrollpercent;<br><br>&nbsp; // Reverse the drawing (when scrolling upwards)<br>&nbsp; 
triangle.style.strokeDashoffset = length - draw;<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_svg_scrolldrawing" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> <a href="/graphics/svg_intro.asp">Learn more about SVG in our SVG Tutorial</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_fullscreen.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_smooth_scroll.asp">Next &#10095;</a>
