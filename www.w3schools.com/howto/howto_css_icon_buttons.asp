...
<html lang="en-US">
<head>
<title>How To Create Icon Buttons</title>
<meta charset="utf-8">
...
<h1>How TO - Icon Buttons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_notification_button.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_next_prev.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create icon buttons with CSS.</p>
<hr>

<div>
<p>Icon buttons:</p>
<button class="btnic"><i class="fa fa-home"></i></button>
<button class="btnic"><i class="fa fa-bars"></i></button>
<button class="btnic"><i class="fa fa-trash"></i></button>
<button class="btnic"><i class="fa fa-close"></i></button>
<button class="btnic"><i class="fa fa-folder"></i></button>
</div>
<div>
<p>Icon buttons with text:</p>
<button class="btnic"><i class="fa fa-home"></i> Home</button>
<button class="btnic"><i class="fa fa-bars"></i> Menu</button>
<button class="btnic"><i class="fa fa-trash"></i> Trash</button>
<button class="btnic"><i class="fa fa-close"></i> Close</button>
<button class="btnic"><i class="fa fa-folder"></i> Folder</button>
</div>

<a target="_blank" href="tryit.asp?filename=tryhow_css_icon_buttons" class="w3-btn" style="margin-top:24px;">Try it Yourself &raquo;</a>

<hr>

<h2>How To Create Icon Buttons</h2>
<h5>Step 1) Add HTML:</h5>
<p>Add an icon library, such as font awesome, and append icons to HTML buttons:</p>
...
&lt;!-- Add icon library --&gt;<br>&lt;link rel=&quot;stylesheet&quot; href=&quot;https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css&quot;&gt;<br>
  <br>&lt;!-- Add font awesome icons to buttons&nbsp; --&gt;<br>&lt;p&gt;Icon 
  buttons:&lt;/p&gt;<br>&lt;button class=&quot;btn&quot;&gt;&lt;i class=&quot;fa fa-home&quot;&gt;&lt;/i&gt;&lt;/button&gt;<br>
  &lt;button class=&quot;btn&quot;&gt;&lt;i class=&quot;fa fa-bars&quot;&gt;&lt;/i&gt;&lt;/button&gt;<br>&lt;button 
  class=&quot;btn&quot;&gt;&lt;i class=&quot;fa fa-trash&quot;&gt;&lt;/i&gt;&lt;/button&gt;<br>&lt;button class=&quot;btn&quot;&gt;&lt;i 
  class=&quot;fa fa-close&quot;&gt;&lt;/i&gt;&lt;/button&gt;<br>&lt;button class=&quot;btn&quot;&gt;&lt;i class=&quot;fa fa-folder&quot;&gt;&lt;/i&gt;&lt;/button&gt;<br>
  <br>&lt;p&gt;Icon buttons with text:&lt;/p&gt;<br>&lt;button class=&quot;btn&quot;&gt;&lt;i 
  class=&quot;fa fa-home&quot;&gt;&lt;/i&gt; Home&lt;/button&gt;<br>&lt;button class=&quot;btn&quot;&gt;&lt;i class=&quot;fa fa-bars&quot;&gt;&lt;/i&gt; 
  Menu&lt;/button&gt;<br>&lt;button class=&quot;btn&quot;&gt;&lt;i class=&quot;fa fa-trash&quot;&gt;&lt;/i&gt; 
  Trash&lt;/button&gt;<br>&lt;button class=&quot;btn&quot;&gt;&lt;i class=&quot;fa fa-close&quot;&gt;&lt;/i&gt; 
  Close&lt;/button&gt;<br>&lt;button class=&quot;btn&quot;&gt;&lt;i class=&quot;fa fa-folder&quot;&gt;&lt;/i&gt; 
  Folder&lt;/button&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style buttons */<br>.btn {<br>&nbsp;&nbsp;&nbsp; background-color: DodgerBlue; 
  /* Blue background */<br>&nbsp;&nbsp;&nbsp; 
  border: none; /* Remove borders */<br>&nbsp;&nbsp;&nbsp; color: white; /* 
  White text */<br>&nbsp;&nbsp;&nbsp; padding: 12px 16px; /* Some padding */<br>&nbsp;&nbsp;&nbsp; 
  font-size: 16px; /* Set a font size */<br>&nbsp;&nbsp;&nbsp; cursor: pointer; 
  /* Mouse pointer on hover */<br>
  }<br><br>/* Darker background on mouse-over */<br>.btn:hover {<br>&nbsp;&nbsp;&nbsp; background-color: 
  RoyalBlue;<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_icon_buttons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Go to our <a href="/icons/default.asp">Icons Tutorial</a> to learn more about icons.</p>
<p>Go to our <a href="/css/css3_buttons.asp">CSS Buttons Tutorial</a> to learn more about how to style buttons.</p>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_notification_button.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_next_prev.asp">Next &#10095;</a>
