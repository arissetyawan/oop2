...
<html lang="en-US">
<head>
<title>How To Create a Sticky Image</title>
<meta charset="utf-8">
...
<h1>How TO - Sticky Image</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_team.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_flip_image.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a sticky image with CSS.</p>
<hr>

<h2>Sticky Image</h2>

<iframe src="tryhow_css_image_sticky_ifr.htm" style="border:none;width:100%;height:300px;border:4px solid #f1f1f1"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_image_sticky" class="w3-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate cssHigh">
  img.sticky {<br>&nbsp;&nbsp;&nbsp; position: -webkit-sticky; /* Safari */<br>&nbsp;&nbsp;&nbsp; 
  position: sticky;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_sticky" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
