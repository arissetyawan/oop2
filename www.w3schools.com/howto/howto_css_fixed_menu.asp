...
<html lang="en-US">
<head>
<title>How To Create a Fixed Menu</title>
<meta charset="utf-8">
...
<h1>How TO - Fixed Menu</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_topnav_equal_width.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_navbar_slide.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a &quot;fixed&quot; menu with CSS.</p>
<hr>
<iframe src="tryhow_css_fixed_menu.htm" style="width:100%;height:300px;border:1px solid #ddd"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_fixed_menu" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Fixed Top Menu</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;navbar&quot;&gt;<br>&nbsp; &lt;a href=&quot;#home&quot;&gt;Home&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#news&quot;&gt;News&lt;/a&gt;<br>&nbsp; 
&lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>&lt;/div&gt;<br><br>&lt;div class=&quot;main&quot;&gt;<br>&nbsp; 
&lt;p&gt;Some text some text some text some text..&lt;/p&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>To create a fixed top menu, use <code class="w3-codespan">position:fixed</code> and <code class="w3-codespan">top:0</code>. Note that the fixed menu will overlay your other content. To fix this, add a <code class="w3-codespan">margin-top</code> (to the content) that is equal or larger than the height of your menu.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
/* The navigation bar */<br>.navbar {<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>&nbsp;&nbsp;&nbsp; 
  background-color: #333;<br>&nbsp;&nbsp;&nbsp; <strong>position: fixed;</strong> /* Set 
  the navbar to fixed position */<br>&nbsp;&nbsp;&nbsp; <strong>top: 0;</strong> 
/* Position the navbar at the top of the page */<br>&nbsp;&nbsp;&nbsp; <strong>width: 
100%;</strong> /* Full width */<br>}<br><br>/* Links inside the navbar */<br>
  .navbar a {<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; display: 
  block;<br>&nbsp;&nbsp;&nbsp; color: #f2f2f2;<br>&nbsp;&nbsp;&nbsp; text-align: 
  center;<br>&nbsp;&nbsp;&nbsp; padding: 14px 16px;<br>&nbsp;&nbsp;&nbsp; 
  text-decoration: none;<br>}<br><br>/* Change background on mouse-over */<br>.navbar 
  a:hover {<br>&nbsp;&nbsp;&nbsp; background: #ddd;<br>&nbsp;&nbsp;&nbsp; color: 
  black;<br>}<br><br>/* Main 
content */<br>.main {<br>&nbsp;&nbsp;&nbsp; margin-top: 30px; /* Add a top 
  margin to avoid content overlay */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_fixed_menu" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>How To Create a Fixed Bottom Menu</h2>

<p>To create a fixed bottom menu, use <code class="w3-codespan">position:fixed</code> and <code class="w3-codespan">
bottom:0</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
/* The navigation bar */<br>.navbar {<br>&nbsp;&nbsp;&nbsp; 
position: fixed; /* Set the navbar to fixed position */<br>&nbsp;&nbsp;&nbsp; 
bottom: 0; 
/* Position the navbar at the bottom of the page */<br>&nbsp;&nbsp;&nbsp; width: 
100%; /* Full width */<br>}<br><br>/* Main 
content */<br>.main 
{<br>&nbsp;&nbsp;&nbsp; margin-bottom: 30px; /* Add a bottom margin to avoid content overlay */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_fixed_menu_bottom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
