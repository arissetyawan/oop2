...
<html lang="en-US">
<head>
<title>How To Create a Collapsible</title>
<meta charset="utf-8">
...
<h1>How TO - Collapse</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_popup.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_calendar.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a collapsible section.</p>
<hr>
<h2>Collapsible</h2>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryhow_js_collapsible" class="w3-btn">Try it Yourself &raquo;</a>
</p>
<hr>

<h2>Create A Collapsible</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button class=&quot;collapsible&quot;&gt;Open Collapsible&lt;/button&gt;<br>&lt;div class=&quot;content&quot;&gt;<br>&nbsp; 
  &lt;p&gt;Lorem ipsum...&lt;/p&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
/* Style the button that is used to open and close the 
  collapsible content */<br>.collapsible {<br>&nbsp; background-color: #eee;<br>&nbsp; 
  color: #444;<br>&nbsp; cursor: pointer;<br>&nbsp; padding: 18px;<br>&nbsp; 
  width: 100%;<br>&nbsp; border: none;<br>&nbsp; text-align: left;<br>&nbsp; 
  outline: none;<br>&nbsp; font-size: 15px;<br>}<br><br>/* Add a background color to the button if it is clicked on (add the 
.active class with JS), and when you move the mouse over it (hover) */<br>
  .active, .collapsible:hover {<br>&nbsp; background-color: #ccc;<br>}<br><br>/* Style the 
  collapsible content. Note: 
hidden by default */<br>.content {<br>&nbsp; padding: 0 18px;<br>&nbsp; display: 
  none;<br>&nbsp; overflow: hidden;<br>&nbsp; background-color: #f1f1f1;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var coll = document.getElementsByClassName(&quot;collapsible&quot;);<br>var i;<br><br>
  for (i = 0; i &lt; coll.length; i++) {<br>&nbsp; coll[i].addEventListener(&quot;click&quot;, 
  function() {<br>&nbsp;&nbsp;&nbsp; this.classList.toggle(&quot;active&quot;);<br>&nbsp;&nbsp;&nbsp; 
  var content = this.nextElementSibling;<br>&nbsp;&nbsp;&nbsp; if (content.style.display 
  === &quot;block&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; content.style.display = 
  &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  content.style.display = &quot;block&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; });<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_collapsible" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Animated Collapsible (Slide Down)</h2>
<p>To make an animated collapsible, add <code class="w3-codespan">max-height: 0</code>, <code class="w3-codespan">overflow: hidden</code> and 
a <code class="w3-codespan">transition</code> for the max-height property, to 
the <code class="w3-codespan">panel</code> class.</p>
<p>Then, use JavaScript to slide down the content by setting a calculated 
<code class="w3-codespan">max-height</code>, depending on the panel's height on different screen sizes: </p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>.content {<br>&nbsp;&nbsp;&nbsp; padding: 0 18px;<br>&nbsp;&nbsp;&nbsp; background-color: white;<br>&nbsp;&nbsp;&nbsp; 
  max-height: 0;<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>&nbsp;&nbsp;&nbsp; 
  transition: max-height 0.2s ease-out;<br>}<br>&lt;/style&gt;<br><br>&lt;script&gt;<br>var 
  coll = 
  document.getElementsByClassName(&quot;collapsible&quot;);<br>var i;<br><br>for (i = 0; i &lt; 
  coll.length; i++) {<br>&nbsp; coll[i].addEventListener(&quot;click&quot;, function() {<br>&nbsp;&nbsp;&nbsp; this.classList.toggle(&quot;active&quot;);<br>
  &nbsp;&nbsp;&nbsp;
  var content = this.nextElementSibling;<br>&nbsp;&nbsp;&nbsp; if (content.style.maxHeight){<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  content.style.maxHeight = null;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  content.style.maxHeight = 
  content.scrollHeight + &quot;px&quot;;<br>&nbsp;&nbsp;&nbsp; } <br>&nbsp; });<br>}<br>
  &lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_collapsible_animate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Add Icons</h2>
<p>Add a symbol to each button to indicate whether the collapsible content is 
open or closed:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .collapsible:after {<br>&nbsp;&nbsp;&nbsp; content: '\02795'; /* Unicode 
character for &quot;plus&quot; sign (+) */<br>&nbsp;&nbsp;&nbsp; font-size: 13px;<br>
  &nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; float: right;<br>&nbsp;&nbsp;&nbsp; 
margin-left: 5px;<br>}<br><br>
  .active:after {<br>&nbsp;&nbsp;&nbsp; content: &quot;\2796&quot;; /* 
Unicode character for &quot;minus&quot; sign (-) */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_collapsible_symbol" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
