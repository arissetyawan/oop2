...
<html lang="en-US">
<head>
<title>How To Style the HR Element with CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Style HR (Horizontal Ruler/Line)</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_circles.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_coupon.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style an hr element with CSS.</p>
<hr>
<h2>How To Style HR</h2>
<hr class="new">
<hr class="new2">
<hr class="new3">
<hr class="new4">
...
<p>You can use the <code class="w3-codespan">border</code> property to style a <code class="w3-codespan">hr</code> element:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Red border */<br>hr.new1 {<br>&nbsp; border-top: 1px solid red;<br>}<br><br>/* Dashed red 
  border */<br>hr.new2 {<br>&nbsp; 
  border-top: 1px dashed red;<br>}<br><br>/* Dotted red border */<br>hr.new3 {<br>&nbsp; border-top: 1px dotted red;<br>
  }<br><br>/* Thick red border */<br>hr.new4 {<br>&nbsp; border: 1px solid red;<br>}<br><br>/* Large rounded 
  green border */<br>hr.new5 {<br>&nbsp; 
  border: 10px solid green;<br>&nbsp; border-radius: 5px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_style_hr" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>The <a href="/tags/tag_hr.asp">HTML hr tag</a>.</p>
<br>
