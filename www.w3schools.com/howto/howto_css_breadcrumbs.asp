...
<html lang="en-US">
<head>
<title>How To Make a Breadcrumb Navigation</title>
<meta charset="utf-8">
...
<h1>How TO - CSS Breadcrumbs</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_pagination.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_button_group.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a breadcrumb navigation with CSS.</p>
<hr>
<h2>How To Create a Breadcrumb Navigation</h2>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_breadcrumbs" class="w3-btn">Try it Yourself &raquo;</a></p>
...
&lt;li&gt;&lt;a href="#"&gt;Home&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Pictures&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
&lt;li&gt;&lt;a href="#"&gt;Summer 15&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
  &lt;li&gt;Italy&lt;/li&gt;<br>
&lt;/ul&gt;</div>
</div>
...
<div class="w3-code notranslate cssHigh">
  /* Style the list */<br>ul.breadcrumb {<br>&nbsp;&nbsp;&nbsp; padding: 10px 
  16px;<br>&nbsp;&nbsp;&nbsp; list-style: none;<br>&nbsp;&nbsp;&nbsp; 
  background-color: #eee;<br>}<br><br>/* Display list items side by side */<br>
  ul.breadcrumb li {<br>&nbsp;&nbsp;&nbsp; display: inline;<br>&nbsp;&nbsp;&nbsp; font-size: 18px;<br>}<br><br>/* Add a 
  slash symbol (/) before/behind each list item */<br>ul.breadcrumb li+li:before 
  {<br>&nbsp;&nbsp;&nbsp; padding: 8px;<br>&nbsp;&nbsp;&nbsp; color: black;<br>&nbsp;&nbsp;&nbsp; 
  content: &quot;/\00a0&quot;;<br>}<br><br>/* Add a color to all links inside the list */<br>
  ul.breadcrumb li a {<br>&nbsp;&nbsp;&nbsp; color: #0275d8;<br>&nbsp;&nbsp;&nbsp; 
  text-decoration: none;<br>}<br><br>
  /* Add a color on mouse-over */<br>ul.breadcrumb li a:hover {<br>&nbsp;&nbsp;&nbsp; 
  color: #01447e;<br>&nbsp;&nbsp;&nbsp; text-decoration: underline;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_breadcrumbs" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Go to our <a href="/css/css3_pagination.asp">CSS Pagination Tutorial</a> to learn more about pagination.</p>
<br>
