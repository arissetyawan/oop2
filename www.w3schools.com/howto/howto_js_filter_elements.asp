...
<html lang="en-US">
<head>
<title>How To Filter Elements</title>
<meta charset="utf-8">
...
<h1>How TO - Filter Elements</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_filter_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_filter_dropdown.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to filter a DIV element based on its class name.</p>
<hr>
<h2>Filter DIV Elements</h2>
<div id="mycontainerclass">
<button class="w3-button w3-light-grey w3-padding" id="myBtn2" onclick="activeFunction();filterSelection('all')">Show all</button>
<button class="w3-button w3-light-grey w3-padding" onclick="activeFunction();filterSelection('cars')">Cars</button>
<button class="w3-button w3-light-grey w3-padding" onclick="activeFunction();filterSelection('animals')">Animals</button>
<button class="w3-button w3-light-grey w3-padding" onclick="activeFunction();filterSelection('fruits')">Fruits</button>
<button class="w3-button w3-light-grey w3-padding" onclick="activeFunction();filterSelection('colors')">Colors</button>
</div>
<div style="overflow:auto">
  <div class="fdiv cars">BMW</div>
  <div class="fdiv colors fruits">Orange</div>
  <div class="fdiv cars">Volvo</div>
  <div class="fdiv colors">Red</div>
  <div class="fdiv cars animals">Mustang</div>
  <div class="fdiv colors">Blue</div>
  <div class="fdiv animals">Cat</div>
  <div class="fdiv animals">Dog</div>
  <div class="fdiv fruits">Melon</div>
  <div class="fdiv fruits animals">Kiwi</div>
  <div class="fdiv fruits">Banana</div>
  <div class="fdiv fruits">Lemon</div>
  <div class="fdiv animals">Cow</div>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_filter_elements" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>
<script>
function activeFunction() {
    var x = document.getElementById("mycontainerclass");
    var y = x.getElementsByClassName("w3-button");
    var i;
...
<h2>Create Filterable DIV Elements</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Control buttons --&gt;<br>&lt;div id="myBtnContainer"&gt;<br>&nbsp; &lt;button 
  class="btn active" onclick="filterSelection('all')"&gt; Show all&lt;/button&gt;<br>&nbsp; 
  &lt;button class="btn" onclick="filterSelection('cars')"&gt; Cars&lt;/button&gt;<br>&nbsp; 
  &lt;button class="btn" onclick="filterSelection('animals')"&gt; Animals&lt;/button&gt;<br>&nbsp; 
  &lt;button class="btn" onclick="filterSelection('fruits')"&gt; Fruits&lt;/button&gt;<br>&nbsp; 
  &lt;button class="btn" onclick="filterSelection('colors')"&gt; Colors&lt;/button&gt;<br>
  &lt;/div&gt;<br><br>&lt;!-- The filterable elements. Note that 
  some have multiple class names (this can be used if they belong to multiple 
  categories) --&gt;<br>&lt;div 
  class="container"&gt;<br>&nbsp; &lt;div 
  class="filterDiv cars"&gt;BMW&lt;/div&gt;<br>&nbsp; &lt;div class="filterDiv colors 
  fruits"&gt;Orange&lt;/div&gt;<br>&nbsp; &lt;div class="filterDiv cars"&gt;Volvo&lt;/div&gt;<br>&nbsp; 
  &lt;div class="filterDiv colors"&gt;Red&lt;/div&gt;<br>&nbsp; &lt;div class="filterDiv cars 
  animals"&gt;Mustang&lt;/div&gt;<br>&nbsp; &lt;div class="filterDiv colors"&gt;Blue&lt;/div&gt;<br>&nbsp; 
  &lt;div class="filterDiv animals"&gt;Cat&lt;/div&gt;<br>&nbsp; &lt;div class="filterDiv 
  animals"&gt;Dog&lt;/div&gt;<br>&nbsp; &lt;div class="filterDiv fruits"&gt;Melon&lt;/div&gt;<br>&nbsp; 
  &lt;div class="filterDiv fruits animals"&gt;Kiwi&lt;/div&gt;<br>&nbsp; &lt;div class="filterDiv 
  fruits"&gt;Banana&lt;/div&gt;<br>&nbsp; &lt;div class="filterDiv fruits"&gt;Lemon&lt;/div&gt;<br>&nbsp; 
  &lt;div class="filterDiv animals"&gt;Cow&lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<h3>Example</h3>
  <div class="w3-code notranslate cssHigh">
    .container {<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>}<br><br>.filterDiv {<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; 
  background-color: #2196F3;<br>&nbsp;&nbsp;&nbsp; color: #ffffff;<br>&nbsp;&nbsp;&nbsp; 
  width: 100px;<br>&nbsp;&nbsp;&nbsp; line-height: 100px;<br>&nbsp;&nbsp;&nbsp; 
  text-align: center;<br>&nbsp;&nbsp;&nbsp; margin: 2px;<br>&nbsp;&nbsp;&nbsp; 
  display: none; /* Hidden by default */<br>}<br><br>/* The &quot;show&quot; class is 
  added to the filtered elements */<br>.show {<br>&nbsp;&nbsp;&nbsp; display: block;<br>}<br>
    <br>/* Style the buttons */<br>.btn {<br>&nbsp; border: none;<br>&nbsp; 
    outline: none;<br>&nbsp; padding: 12px 16px;<br>&nbsp; background-color: 
    #f1f1f1;<br>&nbsp; cursor: pointer;<br>}<br><br>/* Add a light grey 
    background on mouse-over */<br>.btn:hover {<br>&nbsp; 
    background-color: #ddd;<br>}<br><br>/* Add a dark background to 
    the active button */<br>.btn.active {<br>&nbsp; 
...
<div class="w3-code notranslate jsHigh">
  filterSelection(&quot;all&quot;)<br>function filterSelection(c) {<br>&nbsp; var x, i;<br>&nbsp; 
  x = document.getElementsByClassName(&quot;filterDiv&quot;);<br>&nbsp; if (c == &quot;all&quot;) c = &quot;&quot;;<br>&nbsp; 
  ...
  to the current control button (highlight it)<br>var btnContainer = document.getElementById("myBtnContainer");<br>var btns = 
  btnContainer.getElementsByClassName("btn");<br>for (var i = 0; i &lt; btns.length; i++) 
  {<br>&nbsp; btns[i].addEventListener("click", function() {<br>&nbsp;&nbsp;&nbsp; 
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_filter_elements" target="_blank">Try it Yourself &raquo;</a>
</div>
<br>
