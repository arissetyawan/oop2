...
<title>How To Get an Element in an iframe</title>
<meta charset="utf-8">
...
<h1>How TO - Get Iframe Elements</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_animate.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_make_a_website.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Get an element from within an iframe with JavaScript.</p>
<hr>

<iframe id="myFrame" class="w3-border" src="/default.asp" style="height:380px;width:100%;"></iframe>

<p>Click the button to hide the first H1 element in the iframe (another document).</p>

<button onclick="myFunction()" class="w3-button w3-red">Hide H1 Element</button>
...
<h2>Get Element in Iframe</h2>
<p>Get the first &lt;h1&gt; element inside the iframe and hide it:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  var iframe = document.getElementById(&quot;myFrame&quot;);<br>var elmnt = 
  iframe.contentWindow.document.getElementsByTagName(&quot;H1&quot;)[0];<br>
  elmnt.style.display = &quot;none&quot;;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_element_iframe" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
