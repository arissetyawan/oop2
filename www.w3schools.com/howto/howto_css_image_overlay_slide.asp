...
<html lang="en-US">
<head>
<title>How To Create Image Hover Overlay Slide Effects</title>
<meta charset="utf-8">
...
<h1>How TO - Image Overlay Slide</h1>
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="howto_css_image_overlay.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_overlay_zoom.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create image overlay hover slide effects.</p>
<hr>

<h2>Image Overlay Slide</h2>

<p>Learn how to create a sliding overlay effect to an image, on hover:</p>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_slidetop" class="w3-btn w3-margin-top w3-margin-bottom">
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_slidebottom" class="w3-btn w3-margin-top w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_slideright" class="w3-btn w3-margin-top w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_slideleft" class="w3-btn w3-margin-top w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
</div>
