...
<title>How To Display Text when a Checkbox is Checked</title>
<meta charset="utf-8">
...
<h1>How TO - Display Text when Checkbox is Checked</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_switch.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_detect_capslock.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Check whether a checkbox is checked with JavaScript.</p>
<hr>
<p>Display some text when the checkbox is checked:</p>

Checkbox: <input type="checkbox" id="myCheck"  onclick="myFunction()" class="w3-check" style="top:3px;width:18px;height:18px">
...
<h2>Check Whether a Checkbox is Checked</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  Checkbox: &lt;input type=&quot;checkbox&quot; id=&quot;myCheck&quot; onclick=&quot;myFunction()&quot;&gt;<br><br>
  &lt;p id=&quot;text&quot; style=&quot;display:none&quot;&gt;Checkbox is CHECKED!&lt;/p&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  function myFunction() {<br>&nbsp; // Get the checkbox<br>&nbsp; var checkBox = 
  document.getElementById(&quot;myCheck&quot;);<br>&nbsp; // Get the output text<br>&nbsp; 
  var text = document.getElementById(&quot;text&quot;);<br><br>&nbsp; // If the checkbox 
  is checked, display the output text<br>&nbsp; if (checkBox.checked == true){<br>&nbsp;&nbsp;&nbsp; 
  text.style.display = &quot;block&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  text.style.display = &quot;none&quot;;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_display_checkbox_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
