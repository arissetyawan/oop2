...
<h1>How TO - Autocomplete</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_form_steps.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_filter_lists.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an Autocomplete.</p>
<hr>
<h2>Autocomplete</h2>
<p>Start typing:</p>

<!--Make sure the form has the autocomplete function switched off:-->
<form autocomplete="off" action="/action_page.php" class="autocomplete-form">
  <div class="autocomplete" style="width:300px;">
    <input id="myInput" type="text" name="myCountry" placeholder="Country">
  </div>
  <button type="button" class="autocompletebtn">Submit</button>
</form>
...
<br>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_autocomplete" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>Create an Autocomplete Form</h2>
<h5>Step 1) Add HTML:</h5>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!--Make sure the form has the autocomplete function switched off:--&gt;<br>&lt;form 
  autocomplete=&quot;off&quot; action=&quot;/action_page.php&quot;&gt;<br>&nbsp; &lt;div class=&quot;autocomplete&quot; 
  style=&quot;width:300px;&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input id=&quot;myInput&quot; type=&quot;text&quot; name=&quot;myCountry&quot; 
  placeholder=&quot;Country&quot;&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;input type=&quot;submit&quot;&gt;<br>&lt;/form&gt;<br></div>
</div>

<hr>
<h5>Step 2) Create a JavaScript Array:</h5>

<div class="w3-example">
<h3>Example</h3>
<p>An Array of all the countries in the world:</p>
<div class="w3-code notranslate jsHigh" style="white-space: nowrap;overflow:auto;">
  ...
  City&quot;,&quot;Venezuela&quot;,&quot;Vietnam&quot;,&quot;Virgin Islands (US)&quot;,&quot;Yemen&quot;,&quot;Zambia&quot;,&quot;Zimbabwe&quot;];<br></div>
</div>

<hr>
<h5>Step 3) Add CSS:</h5>
<p>The container must have a &quot;relative&quot; positioning.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  * { box-sizing: border-box; }<br>body {<br>&nbsp; font: 16px Arial; <br>}<br>
  .autocomplete {<br>&nbsp; /*the container must be positioned relative:*/<br>&nbsp; 
  position: relative;<br>&nbsp; display: inline-block;<br>}<br>input {<br>&nbsp; border: 1px 
  solid transparent;<br>&nbsp; background-color: #f1f1f1;<br>&nbsp; padding: 
  10px;<br>&nbsp; font-size: 16px;<br>}<br>input[type=text] {<br>&nbsp; 
  background-color: #f1f1f1;<br>&nbsp; width: 100%;<br>}<br>input[type=submit] {<br>&nbsp; background-color: DodgerBlue;<br>&nbsp; 
  color: #fff;<br>}<br>.autocomplete-items {<br>&nbsp; position: absolute;<br>&nbsp; border: 1px 
  solid #d4d4d4;<br>&nbsp; border-bottom: none;<br>&nbsp; border-top: none;<br>&nbsp; 
  z-index: 99;<br>&nbsp; /*position the autocomplete items to be the same width 
  as the container:*/<br>&nbsp; top: 100%;<br>&nbsp; left: 0;<br>&nbsp; right: 
  0;<br>}<br>.autocomplete-items div {<br>&nbsp; 
  padding: 10px;<br>&nbsp; cursor: pointer;<br>&nbsp; background-color: #fff;
  <br>&nbsp; border-bottom: 1px solid #d4d4d4; <br>}<br>.autocomplete-items div:hover {<br>&nbsp; 
  /*when hovering an item:*/<br>&nbsp; background-color: #e9e9e9; <br>}<br>
  .autocomplete-active {<br>&nbsp; /*when navigating through the items using the 
  arrow keys:*/<br>&nbsp; background-color: DodgerBlue !important; <br>&nbsp; 
  color: #ffffff; <br>}</div>
</div>
<hr>
...
<h5>Step 4) Add JavaScript:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  function autocomplete(inp, arr) {<br>&nbsp; /*the autocomplete function takes 
  two arguments,<br>&nbsp; the text field element and an array of possible 
  autocompleted values:*/<br>&nbsp; var currentFocus;<br>&nbsp; /*execute a 
  function when someone writes in the text field:*/<br>&nbsp; 
  inp.addEventListener(&quot;input&quot;, function(e) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  var a, b, i, val = this.value;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /*close any 
  already open lists of autocompleted values*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  closeAllLists();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (!val) { return false;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  currentFocus = -1;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /*create a DIV element 
  that will contain the items (values):*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; a = 
  document.createElement(&quot;DIV&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  a.setAttribute(&quot;id&quot;, this.id + &quot;autocomplete-list&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  a.setAttribute(&quot;class&quot;, &quot;autocomplete-items&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /*append the DIV element as a child of the autocomplete container:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  this.parentNode.appendChild(a);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /*for each 
  item in the array...*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; 
  arr.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /*check if 
  the item starts with the same letters as the text field value:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /*create a DIV element for each matching element:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  b = document.createElement(&quot;DIV&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /*make the matching letters bold:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  b.innerHTML = &quot;&lt;strong&gt;&quot; + arr[i].substr(0, val.length) + &quot;&lt;/strong&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  b.innerHTML += arr[i].substr(val.length);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /*insert a input field that will hold the current array item's value:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  b.innerHTML += &quot;&lt;input type='hidden' value='&quot; + arr[i] + &quot;'&gt;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /*execute a function when someone clicks on the item value (DIV element):*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  b.addEventListener(&quot;click&quot;, function(e) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /*insert the value for the autocomplete text field:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  inp.value = this.getElementsByTagName(&quot;input&quot;)[0].value;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /*close the list of autocompleted values,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  (or any other open lists of autocompleted values:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  closeAllLists();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; });<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  a.appendChild(b);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp; });<br>&nbsp; /*execute a function presses a key on the 
  keyboard:*/<br>&nbsp; inp.addEventListener(&quot;keydown&quot;, function(e) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  var x = document.getElementById(this.id + &quot;autocomplete-list&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  if (x) x = x.getElementsByTagName(&quot;div&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if 
  (e.keyCode == 40) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /*If the 
  arrow DOWN key is pressed,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  increase the currentFocus variable:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  currentFocus++;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /*and and make 
  the current item more visible:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  addActive(x);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else if (e.keyCode == 38) { 
  //up<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /*If the arrow UP key is 
  pressed,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; decrease the 
  currentFocus variable:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  currentFocus--;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /*and and make 
  the current item more visible:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  addActive(x);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else if (e.keyCode == 13) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /*If the ENTER key is pressed, prevent the form from being submitted,*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  e.preventDefault();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (currentFocus 
  &gt; -1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /*and 
  simulate a click on the &quot;active&quot; item:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  if (x) x[currentFocus].click();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp; });<br>&nbsp; function 
  addActive(x) {<br>&nbsp;&nbsp;&nbsp; /*a function to classify an item as 
  &quot;active&quot;:*/<br>&nbsp;&nbsp;&nbsp; if (!x) return false;<br>&nbsp;&nbsp;&nbsp; 
  /*start by removing the &quot;active&quot; class on all items:*/<br>&nbsp;&nbsp;&nbsp; 
  removeActive(x);<br>&nbsp;&nbsp;&nbsp; if (currentFocus &gt;= x.length) 
  currentFocus = 0;<br>&nbsp;&nbsp;&nbsp; if (currentFocus &lt; 0) currentFocus = (x.length 
  - 1);<br>&nbsp;&nbsp;&nbsp; /*add class &quot;autocomplete-active&quot;:*/<br>&nbsp;&nbsp;&nbsp; 
  x[currentFocus].classList.add(&quot;autocomplete-active&quot;);<br>&nbsp; }<br>&nbsp; 
  function removeActive(x) {<br>&nbsp;&nbsp;&nbsp; /*a function to remove the 
  &quot;active&quot; class from all autocomplete items:*/<br>&nbsp;&nbsp;&nbsp; for (var i 
  = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x[i].classList.remove(&quot;autocomplete-active&quot;);<br>&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp; }<br>&nbsp; function closeAllLists(elmnt) {<br>&nbsp;&nbsp;&nbsp; 
  /*close all autocomplete lists in the document,<br>&nbsp;&nbsp;&nbsp; except 
  the one passed as an argument:*/<br>&nbsp;&nbsp;&nbsp; var x = 
  document.getElementsByClassName(&quot;autocomplete-items&quot;);<br>&nbsp;&nbsp;&nbsp; 
  for (var i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (elmnt 
  != x[i] &amp;&amp; elmnt != inp) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x[i].parentNode.removeChild(x[i]);<br>&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp; }<br>}<br>/*execute a function when someone clicks in the document:*/<br>
  document.addEventListener(&quot;click&quot;, function (e) {<br>&nbsp;&nbsp;&nbsp; 
  closeAllLists(e.target);<br>});<br>}</div>
</div>
<hr>

<h5>Step 5) Initiate the Autocomplete Effect on &quot;myInput&quot;:</h5>
<div class="w3-example">
<h3>Example</h3>
  <p>Pass the countries array as the second parameter of the autocomplete 
  function:</p>
<div class="w3-code notranslate htmlHigh">
  &lt;script&gt;<br>autocomplete(document.getElementById(&quot;myInput&quot;), 
  countries);<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_autocomplete" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
