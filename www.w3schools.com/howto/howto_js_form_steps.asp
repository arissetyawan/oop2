...
<html lang="en-US">
<head>
<title>How To Create a Form With Multiple Steps</title>
...
<h1>How TO - Form with Multiple Steps</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_toggle_password.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_autocomplete.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a form with multiple steps.</p>
<hr>
<h2>Form Wizard - Multi Step Form:</h2>
<div class="example">
<form id="regForm" action="">
  <h1 style="text-align:center;font-family:Raleway;">Register:</h1>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_form_steps" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;form id="regForm" action=""&gt;<br><br>&lt;h1&gt;Register:&lt;/h1&gt;<br><br>&lt;!-- One "tab" 
  for each step in the form: --&gt;<br>&lt;div class="tab"&gt;Name:<br>&nbsp; &lt;p&gt;&lt;input 
  placeholder="First name..." oninput="this.className = ''"&gt;&lt;/p&gt;<br>&nbsp; 
  &lt;p&gt;&lt;input placeholder="Last name..." oninput="this.className = ''"&gt;&lt;/p&gt;<br>
  &lt;/div&gt;<br><br>&lt;div class="tab"&gt;Contact Info:<br>&nbsp; &lt;p&gt;&lt;input 
  placeholder="E-mail..." oninput="this.className = ''"&gt;&lt;/p&gt;<br>&nbsp; &lt;p&gt;&lt;input 
  placeholder="Phone..." oninput="this.className = ''"&gt;&lt;/p&gt;<br>&lt;/div&gt;<br><br>
  &lt;div class="tab"&gt;Birthday:<br>&nbsp; &lt;p&gt;&lt;input placeholder="dd" oninput="this.className 
  = ''"&gt;&lt;/p&gt;<br>&nbsp; &lt;p&gt;&lt;input placeholder="mm" oninput="this.className = 
  ''"&gt;&lt;/p&gt;<br>&nbsp; &lt;p&gt;&lt;input placeholder="yyyy" oninput="this.className = 
  ''"&gt;&lt;/p&gt;<br>&lt;/div&gt;<br><br>&lt;div class="tab"&gt;Login Info:<br>&nbsp; &lt;p&gt;&lt;input 
  placeholder="Username..." oninput="this.className = ''"&gt;&lt;/p&gt;<br>&nbsp; 
  &lt;p&gt;&lt;input placeholder="Password..." oninput="this.className = ''"&gt;&lt;/p&gt;<br>
  &lt;/div&gt;<br><br>&lt;div style="overflow:auto;"&gt;<br>&nbsp; &lt;div style="float:right;"&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;button type="button" id="prevBtn" onclick="nextPrev(-1)"&gt;Previous&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;button type="button" id="nextBtn" onclick="nextPrev(1)"&gt;Next&lt;/button&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;!-- Circles which indicates the steps of the form: 
  --&gt;<br>&lt;div style="text-align:center;margin-top:40px;"&gt;<br>&nbsp; &lt;span 
  class="step"&gt;&lt;/span&gt;<br>&nbsp; &lt;span class="step"&gt;&lt;/span&gt;<br>&nbsp; &lt;span 
  class="step"&gt;&lt;/span&gt;<br>&nbsp; &lt;span class="step"&gt;&lt;/span&gt;<br>&lt;/div&gt;<br><br>
  &lt;/form&gt;</div>
</div>
<hr>
...
<p>Style the form elements:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Style the form */<br>#regForm {<br>&nbsp; background-color: #ffffff;<br>&nbsp; margin: 100px auto;<br>&nbsp; padding: 40px;<br>&nbsp; width: 
  70%;<br>&nbsp; 
  min-width: 300px;<br>}<br><br>/* Style the input fields */<br>input {<br>&nbsp; padding: 10px;<br>&nbsp; width: 100%;<br>&nbsp; 
  font-size: 17px;<br>&nbsp; font-family: Raleway;<br>&nbsp; border: 1px solid #aaaaaa;<br>
  }<br><br>/* Mark input boxes that gets an error on validation: */<br>input.invalid 
  {<br>&nbsp; background-color: #ffdddd;<br>}<br><br>/* Hide all steps by 
  default: */<br>.tab {<br>&nbsp; display: none;<br>}<br><br>/* Make circles that indicate the 
  steps of the form: */<br>.step {<br>&nbsp; height: 15px;<br>&nbsp; width: 15px;<br>&nbsp; 
  margin: 0 2px;<br>&nbsp; background-color: #bbbbbb;<br>&nbsp; border: none; <br>&nbsp; 
  border-radius: 50%;<br>&nbsp; display: inline-block;<br>&nbsp; opacity: 0.5;<br>
  }<br><br>/* Mark the active step: */<br>.step.active {<br>&nbsp; opacity: 1;<br>}<br><br>
  /* Mark the steps that are finished and valid: */<br>.step.finish {<br>&nbsp; 
  background-color: #4CAF50;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var currentTab = 0; // Current tab is set to be the first tab (0)<br>showTab(currentTab); 
  // Display the current tab<br><br>function showTab(n) {<br>&nbsp; // This function will display the 
  specified tab of the form ...<br>&nbsp; var x = 
  document.getElementsByClassName("tab");<br>&nbsp; x[n].style.display = 
  "block";<br>&nbsp; // ... and fix the Previous/Next buttons:<br>&nbsp; if (n 
  == 0) {<br>&nbsp;&nbsp;&nbsp; document.getElementById("prevBtn").style.display 
  = "none";<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; document.getElementById("prevBtn").style.display 
  = "inline";<br>&nbsp; }<br>&nbsp; if (n == (x.length - 1)) {<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById("nextBtn").innerHTML = "Submit";<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById("nextBtn").innerHTML = "Next";<br>&nbsp; }<br>&nbsp; 
  // ... and run a function that displays the correct step indicator:<br>&nbsp; 
  fixStepIndicator(n)<br>}<br><br>function nextPrev(n) {<br>&nbsp; // This function will 
  figure out which tab to display<br>&nbsp; var x = 
  document.getElementsByClassName("tab");<br>&nbsp; // Exit the function if any 
  field in the <em>current</em> tab is invalid:<br>&nbsp; if (n == 1 &amp;&amp; !validateForm()) return false;<br>&nbsp; 
  // Hide the current tab:<br>&nbsp; x[currentTab].style.display = "none";<br>&nbsp; 
  // Increase or decrease the current tab by 1:<br>&nbsp; currentTab = 
  currentTab + n;<br>&nbsp; // if you have reached the end of the form... :<br>&nbsp; 
  if (currentTab &gt;= x.length) {<br>&nbsp;&nbsp;&nbsp; //...the form gets 
  submitted:<br>&nbsp;&nbsp;&nbsp; document.getElementById("regForm").submit();<br>&nbsp;&nbsp;&nbsp; 
  return false;<br>&nbsp; }<br>&nbsp; // Otherwise, display the correct tab:<br>&nbsp; 
  showTab(currentTab);<br>}<br>
  <br>function validateForm() {<br>&nbsp; // This function deals with validation 
  of the form fields<br>&nbsp; var x, y, i, valid = true;<br>&nbsp; x = 
  document.getElementsByClassName("tab");<br>&nbsp; y = x[currentTab].getElementsByTagName("input");<br>&nbsp; 
  // A loop that checks every input field in the current tab:<br>&nbsp; for (i 
  = 0; i &lt; y.length; i++) {<br>&nbsp;&nbsp;&nbsp; // If a field is empty...<br>&nbsp;&nbsp;&nbsp; if (y[i].value == "") {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // add an 
  "invalid" class to the field:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  y[i].className += " invalid";<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // and set the 
  current valid status to false:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; valid = false;<br>&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp; }<br>&nbsp; // If the valid status is true, mark the step as 
  finished and valid:<br>&nbsp; if (valid) {<br>&nbsp;&nbsp;&nbsp; document.getElementsByClassName("step")[currentTab].className 
  += " finish";<br>&nbsp; }<br>&nbsp; return valid; // return the valid status<br>}<br><br>function fixStepIndicator(n) {<br>&nbsp; 
  // This function removes the "active" class of all steps...<br>&nbsp; var 
  i, x = document.getElementsByClassName("step");<br>&nbsp; for (i = 0; i &lt; 
  x.length; i++) {<br>&nbsp;&nbsp;&nbsp; x[i].className = x[i].className.replace(" 
  active", "");<br>&nbsp; }<br>&nbsp; //... and adds the "active" class to the 
  current step:<br>&nbsp; x[n].className += " active";<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_form_steps" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<script>
var currentTab = 0; // Current tab is set be the first tab (0)
showTab(currentTab); // Run a function that will display the specified step
...
function nextPrev(n) {
  // This function will figure out which step you should see next...
  var x = document.getElementsByClassName("tab");
  // ... but only if the current step validates:
...
function validateForm() {
  ...
  for (i = 0; i < y.length; i++) {
    // If a field is empty, add a "invalid" class to the field:
    if (y[i].value == "") {
  ...
  if (valid) document.getElementsByClassName("dot")[currentTab].className += " finish"
  return valid; // return the valid status
}

function fixDots(n) {
  // This function removes the "active" class of all "dots" ... :
...
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_js_toggle_password.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_autocomplete.asp">Next &#10095;</a>
</div>
</div>
