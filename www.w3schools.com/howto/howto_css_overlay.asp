...
<html lang="en-US">
<head>
<title>How To Create an Overlay</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="howto_css_user_rating.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_contact_chips.asp">Next &#10095;</a>
</div>
<hr>
...
<div id="overlay" onclick="off()" title="Click to turn off the overlay effect">
...
<button onclick="on()" class="w3-button w3-green">Turn on the overlay effect</button>
...
<div class="w3-code notranslate jsHigh">
  ...
  = &quot;block&quot;;<br>}<br><br>function off() {<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById(&quot;overlay&quot;).style.display = &quot;none&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_overlay" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>#text{<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
  top: 50%;<br>&nbsp;&nbsp;&nbsp; left: 50%;<br>&nbsp;&nbsp;&nbsp; font-size: 
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_overlay_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
