...
<h1>How TO - JavaScript HTML Animations</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_syntax_highlight.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_element_iframe.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create animations using JavaScript.</p>
<hr>

<iframe src="tryhow_js_animate_3.htm" style="width:100%;height:470px;border:1px solid #f1f1f1;"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_animate_3" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>
<h2>A Basic Web Page</h2>
<p>To demonstrate how to create HTML animations with JavaScript, we can use a simple 
web page.</p>
...
&lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;h1&gt;My First 
 ...
 &lt;div id =&quot;myContainer&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div id =&quot;myAnimation&quot;&gt;My 
 animation will go here&lt;/div&gt;<br>&lt;/div&gt;<br><br>
&lt;/body&gt;<br>&lt;html&gt;<br></div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_animate_1" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>To make an animation possible, the animated element must be animated relative 
to a &quot;parent container&quot;.</p>
...
<div class="w3-code notranslate cssHigh">
 #myContainer {<br>&nbsp;&nbsp;&nbsp; width: 400px;<br>&nbsp;&nbsp;&nbsp; height: 
 400px;<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; 
 background: yellow;<br>
 }<br>#myAnimation {<br>&nbsp;&nbsp;&nbsp; width: 50px;<br>&nbsp;&nbsp;&nbsp; height: 
 50px;<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
 background: red;<br>}
</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_animate_2" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>The Animation Code</h2>
...
<div class="w3-code notranslate jsHigh">
 ...
 document.getElementById(&quot;myAnimation&quot;); <br>&nbsp;&nbsp;&nbsp; var pos = 0;<br>&nbsp;&nbsp;&nbsp; var id = setInterval(frame, 
 10);<br>&nbsp;&nbsp;&nbsp; 
 function frame() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (pos == 
 350) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
 clearInterval(id);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
 pos++; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
 elem.style.top = pos + 'px'; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; elem.style.left = pos + 'px'; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
 }<br>}</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_animate_3" target="_blank">Try it Yourself &raquo;</a>
</div>

<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_syntax_hightlight.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_element_iframe.asp">Next &#10095;</a>
</div>
</div>
