...
<html lang="en-US">
<head>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"><title>How To Create an Image Overlay Icon</title>
<meta charset="utf-8">
...
<h1>How TO - Image Overlay Icon</h1>
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="howto_css_image_overlay_title.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_effects.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an image overlay icon effect on hover.</p>
<hr>
...
<div class="container">
  ...
  <div class="overlay">
    <a href="javascript:void(0)" class="icon w3-text-white" title="User Profile">
      <i class="fa fa-user"></i>
    </a>
  </div>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_icon" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Create an Overlay Image Icon</h2>
...
&lt;!-- Add icon library --&gt;<br>&lt;link rel=&quot;stylesheet&quot; href=&quot;https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css&quot;&gt;<br>
  <br>&lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;img src=&quot;img_avatar.png&quot; alt=&quot;Avatar&quot; 
  class=&quot;image&quot;&gt;<br>&nbsp; &lt;div class=&quot;overlay&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#&quot; 
  class=&quot;icon&quot; title=&quot;User Profile&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;i 
  class=&quot;fa fa-user&quot;&gt;&lt;/i&gt; <br>&nbsp;&nbsp;&nbsp; &lt;/a&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Container 
  needed to position the overlay. Adjust the width as needed */<br>.container {<br>&nbsp; position: relative;<br>&nbsp; width: 
  100%;<br>&nbsp; max-width: 400px;<br>}<br>
  <br>/* Make the image to responsive */<br>.image {<br>&nbsp; width: 100%;<br>&nbsp; height: auto;<br>}<br><br>/* 
  The overlay effect (full height and width) - lays on top of the container and 
  over the image */<br>.overlay {<br>&nbsp; position: absolute;<br>&nbsp; top: 
  0;<br>&nbsp; bottom: 0;<br>&nbsp; left: 0;<br>&nbsp; right: 0;<br>&nbsp; 
  height: 100%;<br>&nbsp; width: 100%;<br>&nbsp; opacity: 0;<br>&nbsp; 
  transition: .3s ease;<br>&nbsp; background-color: red;<br>}<br><br>/* When you mouse over the container, fade 
  in the overlay icon*/<br>.container:hover .overlay {<br>&nbsp; opacity: 1;<br>}<br><br>/* 
  The icon inside the overlay is positioned in 
  the middle vertically and horizontally */<br>.icon {<br>&nbsp; color: white;<br>&nbsp; 
  font-size: 100px;<br>&nbsp; position: absolute;<br>&nbsp; top: 50%;<br>&nbsp; 
  left: 50%;<br>&nbsp; transform: translate(-50%, -50%);<br>&nbsp; -ms-transform: 
  translate(-50%, -50%);<br>&nbsp; text-align: center;<br>}<br><br>/* When you 
  move the mouse over the icon, change color */<br>.fa-user:hover {<br>&nbsp; 
  color: #eee;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_icon" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Also see other image overlay effects (fade, slide, etc) in our <a href="howto_css_image_overlay.asp">How To - Image Hover Overlay</a>.</p>
