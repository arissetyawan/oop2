...
<html lang="en-US">
<head>
<title>How To Toggle Text</title>
<meta charset="utf-8">
...
<h1>How TO - Toggle/Swap Text</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_toggle_hide_show.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_toggle_class.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to toggle text with JavaScript.</p>
<hr>

<p><button onclick="myFunction()" class="w3-button w3-dark-grey">Toggle Text</button></p>
...
<h2>Toggle Text of an Element</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button onclick=&quot;myFunction()&quot;&gt;Click Me&lt;/button&gt;<br><br>&lt;div id=&quot;myDIV&quot;&gt;Hello&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  if (x.innerHTML === &quot;Hello&quot;) {<br>&nbsp;&nbsp;&nbsp; x.innerHTML = &quot;Swapped 
  text!&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; x.innerHTML = &quot;Hello&quot;;<br>&nbsp; 
  }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_toggle_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
