...
<html lang="en-US">
<head>
<title>How To Create an Alert Message Box</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_product_card.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_callout.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create alert messages with CSS.</p>
<hr>
<h2>Alerts</h2>
<p>Alert messages can be used to notify the user about something special: danger, success, information or warning.</p>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_alert" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>Create An Alert Message</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;alert&quot;&gt;<br>&nbsp; &lt;span class=&quot;closebtn&quot;
onclick=&quot;this.parentElement.style.display='none';&quot;&gt;&amp;times;&lt;/span&gt; <br>&nbsp; This is an alert box.<br>&lt;/div&gt;</div>
</div>
<p>If you want the ability to close the alert message, add a &lt;span&gt; element with 
an <code class="w3-codespan">onclick</code> attribute that says &quot;when you click on me, hide my parent element&quot; - 
which is the container &lt;div&gt; (class=&quot;alert&quot;).</p>
<p><strong>Tip:</strong> Use the HTML entity &quot;<code class="w3-codespan">&amp;times;</code>&quot; to create the letter &quot;x&quot;.</p>
<hr>
...
<p>Style the alert box and the close button:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
/* The alert message box */<br>.alert {<br>&nbsp;&nbsp;&nbsp; padding: 20px;<br>&nbsp;&nbsp;&nbsp; 
background-color: #f44336; /* Red */<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
margin-bottom: 15px;<br>}<br>
<br>/* The close button */<br>.closebtn {<br>&nbsp;&nbsp;&nbsp; margin-left: 15px;<br>&nbsp;&nbsp;&nbsp; 
color: white;<br>&nbsp;&nbsp;&nbsp; font-weight: bold;<br>&nbsp;&nbsp;&nbsp; 
float: right;<br>&nbsp;&nbsp;&nbsp; font-size: 22px;<br>&nbsp;&nbsp;&nbsp; 
line-height: 20px;<br>&nbsp;&nbsp;&nbsp; 
cursor: pointer;<br>&nbsp;&nbsp;&nbsp; transition: 0.3s;<br>}<br><br>/* When 
moving the mouse over the close button */<br>.closebtn:hover {<br>&nbsp;&nbsp;&nbsp; color: black;<br>
}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_alert" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Many Alerts</h2>
<p>If you have many alert messages on a page, you can add the following script 
to close different alerts without using the onclick attribute on each &lt;span&gt; 
element.</p>
<p>And, if you want the alerts to slowly fade out when you click on them, add <code class="w3-codespan">opacity</code> 
and <code class="w3-codespan">transition</code> to the <code class="w3-codespan">alert</code> class:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;style&gt;<br>.alert {<br>&nbsp;&nbsp;&nbsp; opacity: 1;<br>&nbsp;&nbsp;&nbsp; 
transition: opacity 0.6s; /* 600ms to fade out */<br>}<br>&lt;/style&gt;<br><br>&lt;script&gt;<br>
// Get all elements with class=&quot;closebtn&quot;<br>var close = document.getElementsByClassName(&quot;closebtn&quot;);<br>var 
i;<br><br>// Loop through all close buttons<br>for (i = 0; i &lt; close.length; i++) {<br>&nbsp;&nbsp;&nbsp; 
// When someone clicks on a close button<br>&nbsp;&nbsp;&nbsp; close[i].onclick = 
function(){<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Get the 
parent of &lt;span class=&quot;closebtn&quot;&gt; (&lt;div class=&quot;alert&quot;&gt;)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var div = this.parentElement;<br>
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Set the opacity of div to 
0 (transparent)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; div.style.opacity = &quot;0&quot;;<br>
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Hide the div after 600ms 
(the same amount of milliseconds it takes to fade out)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
setTimeout(function(){ div.style.display = &quot;none&quot;; }, 600);<br>&nbsp;&nbsp;&nbsp; }<br>}<br>
&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_alerts" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Also check out <a href="howto_css_notes.asp">Notes</a>.</p>
