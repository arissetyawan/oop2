...
<html lang="en-US">
<head>
<title>How To Create a Search Bar</title>
<meta charset="utf-8">
...
<h1>How TO - Search Bar</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_search_menu.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_fixed_sidebar.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add a search box inside a responsive navigation 
menu.</p>
<hr>
<h2>Search Bar</h2>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_searchbar3" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create A Search Bar</h2>
...
<div class="w3-code notranslate htmlHigh">
  ...
  &lt;input type=&quot;text&quot; placeholder=&quot;Search..&quot;&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Add a black background color to the top navigation bar */<br>.topnav {<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>&nbsp;&nbsp;&nbsp; 
  background-color: #e9e9e9;<br>}<br><br>/* Style the links inside the navigation 
  bar */<br>.topnav 
  a {<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; color: black;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>&nbsp;&nbsp;&nbsp; 
  padding: 14px 16px;<br>&nbsp;&nbsp;&nbsp; text-decoration: none;<br>&nbsp;&nbsp;&nbsp; 
  font-size: 17px;<br>}<br><br>/* Change the color of links on hover */<br>.topnav a:hover {<br>&nbsp;&nbsp;&nbsp; background-color: #ddd;<br>&nbsp;&nbsp;&nbsp; 
  color: black;<br>}<br>
  <br>/* Style the &quot;active&quot; element to highlight the current page */<br>.topnav a.active {<br>
  &nbsp;&nbsp;&nbsp; background-color: #2196F3;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>}<br>
  <br>/* Style the search box inside the navigation bar */<br>.topnav input[type=text] {<br>&nbsp;&nbsp;&nbsp; float: right;<br>&nbsp;&nbsp;&nbsp; 
  padding: 6px;<br>&nbsp;&nbsp;&nbsp; border: none;<br>&nbsp;&nbsp;&nbsp; margin-top: 8px;<br>&nbsp;&nbsp;&nbsp; 
  margin-right: 16px;<br>&nbsp;&nbsp;&nbsp; font-size: 17px;<br>}<br><br>/* 
  When the screen is less than 600px wide, stack the links and the search field 
  vertically instead of horizontally */<br>@media screen and (max-width: 600px) {<br>&nbsp;&nbsp;&nbsp; 
  .topnav a, .topnav input[type=text] {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  float: none;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  text-align: left;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  margin: 0;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; padding: 14px;<br>&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp;&nbsp;&nbsp; .topnav input[type=text] {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; border: 1px 
  solid #ccc;<br>&nbsp;&nbsp;&nbsp; }<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_searchbar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Example with Submit Button</h2>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_searchbar2" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h2>Example with Submit Icon</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-white w3-padding w3-padding-16">
<div class="topnav2">
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_searchbar3" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
