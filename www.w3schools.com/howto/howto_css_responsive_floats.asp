...
<html lang="en-US">
<head>
<title>How To Create Responsive Floats</title>
<meta charset="utf-8">
...
<h1>How TO - Responsive Floats</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_clearfix.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_snackbar.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create responsive floating elements with CSS.</p>
<hr>

<h2>Responsive floats</h2>
<p>Use media queries and set the specified screen width (in pixels) for when the element should float:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Float to the right on screens that are equal to or less than 768px wide */<br>
  @media (max-width: 768px) {<br>&nbsp; .float-right-sm {<br>&nbsp;&nbsp;&nbsp; 
  float: right;<br>&nbsp; }<br>}<br><br>/* Float to the right on screens that 
  are equal to or greater than 769px wide */<br>@media (min-width: 769px) {<br>&nbsp; .float-right-lg {<br>&nbsp;&nbsp;&nbsp; 
  float: right;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_floats" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
