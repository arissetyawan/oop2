...
<html lang="en-US">
<head>
<title>How To Create Social Media Buttons</title>
<meta charset="utf-8">
...
<h1>How TO - Social Media Buttons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_button_on_image.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_read_more.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style social media buttons with CSS.</p>
<hr>
...
<a href="javascript:void(0)" class="fa fa-android"></a>
<a href="javascript:void(0)" class="fa fa-dribbble"></a>
<a href="javascript:void(0)" class="fa fa-vimeo"></a>
<a href="javascript:void(0)" class="fa fa-tumblr"></a>
<a href="javascript:void(0)" class="fa fa-vine"></a>
<a href="javascript:void(0)" class="fa fa-foursquare"></a>
<a href="javascript:void(0)" class="fa fa-stumbleupon"></a>
<a href="javascript:void(0)" class="fa fa-flickr"></a>
<a href="javascript:void(0)" class="fa fa-yahoo"></a>
<a href="javascript:void(0)" class="fa fa-reddit"></a>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_social_media_buttons" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>

<h2>How To Style Social Media Buttons</h2>
...
&lt;!-- Add icon library --&gt;<br>&lt;link rel=&quot;stylesheet&quot; href=&quot;https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css&quot;&gt;<br>
  <br>&lt;!-- Add font awesome icons --&gt;<br>&lt;a href=&quot;#&quot; class=&quot;fa fa-facebook&quot;&gt;&lt;/a&gt;<br>&lt;a href=&quot;#&quot; class=&quot;fa fa-twitter&quot;&gt;&lt;/a&gt;<br>
  ...</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<div class="w3-example">
<h3>Square Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Style all font awesome icons */<br>.fa {<br>&nbsp;&nbsp;&nbsp; padding: 20px;<br>&nbsp;&nbsp;&nbsp; 
  font-size: 30px;<br>&nbsp;&nbsp;&nbsp; width: 50px;<br>&nbsp;&nbsp;&nbsp; 
  text-align: center;<br>&nbsp;&nbsp;&nbsp; text-decoration: none;<br>}<br><br>
  /* Add a hover effect if you want */<br>.fa:hover {<br>&nbsp;&nbsp;&nbsp; opacity: 0.7;<br>}<br><br>/* Set a specific color for each brand */<br><br>/* Facebook */<br>.fa-facebook 
  {<br>&nbsp;&nbsp;&nbsp; background: #3B5998;<br>&nbsp;&nbsp;&nbsp; color: 
  white;<br>}<br><br>/* Twitter */<br>.fa-twitter {<br>&nbsp;&nbsp;&nbsp; background: 
  #55ACEE;<br>&nbsp;&nbsp;&nbsp; color: white;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_social_media_buttons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Round Buttons</h2>
<p><strong>Tip:</strong> Add <code class="w3-codespan">border-radius:50%</code> 
to create round buttons, and reduce the <code class="w3-codespan">width</code>:</p>
<div class="w3-example">
<h3>Rounded Example</h3>
<div class="w3-code notranslate cssHigh">
  .fa {<br>&nbsp;&nbsp;&nbsp; padding: 20px;<br>&nbsp;&nbsp;&nbsp; 
  font-size: 30px;<br>&nbsp;&nbsp;&nbsp; width: 30px;<br>&nbsp;&nbsp;&nbsp; 
  text-align: center;<br>&nbsp;&nbsp;&nbsp; text-decoration: none;<br>&nbsp;&nbsp;&nbsp;
  <strong>border-radius: 50%;</strong><br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_social_media_buttons2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
