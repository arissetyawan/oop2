...
<html lang="en-US">
<head>
<title>How To Create a Collapsed Sidebar</title>
<meta charset="utf-8">
...
<h1>How TO - Collapse Sidebar</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_curtain_menu.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_collapse_sidepanel.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a collapsible sidebar menu.</p>
<hr>
...
<a href="javascript:void(0)">About</a>
 ...
 <p>Click on the button to open the collapsible sidebar:</p>
  <button class="w3-btn w3-dark-grey w3-padding w3-margin-bottom" onclick="openOffcanvas()">&#9776; Toggle Sidebar</button><br>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_collapse_sidebar" class="w3-btn">Try it Yourself &raquo;</a>

<hr>

<h2>Create a Collapsed Sidebar</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div id=&quot;mySidebar&quot; class=&quot;sidebar&quot;&gt;<br>&nbsp; &lt;a href=&quot;javascript:void(0)&quot; 
class=&quot;closebtn&quot; onclick=&quot;closeNav()&quot;&gt;&amp;times;&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;About&lt;/a&gt;<br>&nbsp; 
&lt;a href=&quot;#&quot;&gt;Services&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Clients&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Contact&lt;/a&gt;<br>
&lt;/div&gt;<br><br>&lt;div id=&quot;main&quot;&gt;<br>&nbsp; &lt;button class=&quot;openbtn&quot; onclick=&quot;openNav()&quot;&gt;&amp;#9776; 
  Toggle Sidebar&lt;/button&gt; <br>&nbsp; &lt;h2&gt;Collapsed Sidebar&lt;/h2&gt;<br>&nbsp; 
  &lt;p&gt;Content...&lt;/p&gt;<br>&lt;/div&gt;<br></div>
</div>
<hr>
...
/* The sidebar menu */<br>.sidebar {<br>&nbsp;&nbsp;&nbsp; height: 100%; /* 
...
transition: 0.5s; /* 0.5 second transition effect to slide in the sidebar */<br>
}<br><br>/* The sidebar links */<br>.sidebar a {<br>&nbsp;&nbsp;&nbsp; padding: 8px 8px 8px 32px;<br>&nbsp;&nbsp;&nbsp; 
...
change their color */<br>.sidebar a:hover {<br>&nbsp;&nbsp;&nbsp; 
color: #f1f1f1;<br>}<br><br>/* Position and style the close button (top 
right corner) */<br>.sidebar .closebtn {<br>&nbsp;&nbsp;&nbsp; position: 
absolute;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; right: 25px;<br>&nbsp;&nbsp;&nbsp; 
font-size: 36px;<br>&nbsp;&nbsp;&nbsp; margin-left: 50px;<br>}<br><br>/* The 
  button used to open the sidebar */<br>.openbtn 
  {<br>&nbsp;&nbsp;&nbsp; font-size: 20px;<br>&nbsp;&nbsp;&nbsp; cursor: 
  pointer;<br>&nbsp;&nbsp;&nbsp; background-color: #111;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>&nbsp;&nbsp;&nbsp; padding: 10px 15px;<br>&nbsp;&nbsp;&nbsp; 
  border: none;<br>}<br><br>.openbtn:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #444;<br>}<br>
<br>/* Style page content - use this if you want to push the page content to 
the right when you open the side navigation */<br>#main {<br>&nbsp;&nbsp;&nbsp; transition: margin-left .5s; 
  /* If you want a transition effect */<br>&nbsp;&nbsp;&nbsp; 
...
size) */<br>@media screen and (max-height: 450px) {<br>&nbsp;&nbsp;&nbsp; .sidebar 
{padding-top: 15px;}<br>&nbsp;&nbsp;&nbsp; .sidebar a {font-size: 18px;}<br>
}</div>
</div>
<hr>
...
openNav() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;mySidebar&quot;).style.width 
= &quot;250px&quot;;<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;main&quot;).style.marginLeft 
= &quot;250px&quot;;<br>}<br><br>/* Set the width of the sidebar to 0 and the 
left margin of the page content to 0 */<br>function closeNav() {<br>&nbsp;&nbsp;&nbsp; 
document.getElementById(&quot;mySidebar&quot;).style.width = &quot;0&quot;;<br>&nbsp;&nbsp;&nbsp; 
document.getElementById(&quot;main&quot;).style.marginLeft = &quot;0&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_collapse_sidebar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
