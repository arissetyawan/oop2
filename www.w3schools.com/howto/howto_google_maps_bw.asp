...
<html lang="en-US">
<head>
<title>How To Create Black and White Google Maps</title>
<meta charset="utf-8">
...
<h1>How TO - Grayscale Google Maps</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_google_maps.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_google_translate.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add a grayscale (black and white) filter to Google Maps.</p>
<hr>
<div id="googleMap" style="width:100%;height:380px;" class="w3-grayscale-max"></div>
<script>
function myMap()
{
  var mapProp= {
...
<a class="w3-btn w3-margin-top" href="tryit.asp?filename=tryhow_google_map_bw" target="_blank">Try it Yourself &raquo;</a>
<hr>

<h2>Grayscale Google Maps</h2>
<p>Use the CSS <code class="w3-codespan">filter</code> property to convert the google map to black and white. 100% is completely black and white:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Style the map --&gt;<br>&lt;style&gt;<br>#map {<br>&nbsp; width: 100%;<br>&nbsp; 
  height: 400px;<br>&nbsp; -webkit-filter: grayscale(100%); /* Safari 6.0 - 9.0 
  */<br>&nbsp; filter: grayscale(100%);<br>}<br>&lt;/style&gt;<br><br>&lt;!-- Display the 
  map --&gt;<br>&lt;div id=&quot;map&quot;&gt;&lt;/div&gt;<br><br>&lt;!-- Google Maps Script --&gt;<br>&lt;script&gt;<br>function myMap() {<br>&nbsp;&nbsp;&nbsp; var mapCanvas = 
...
mapOptions);<br>}<br>&lt;/script&gt;<br><br>&lt;script src=&quot;https://maps.googleapis.com/maps/api/js?key=YOUR_KEY&amp;callback=myMap&quot;&gt;&lt;/script&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_google_map_bw" target="_blank">Try it Yourself &raquo;</a>
</div>
