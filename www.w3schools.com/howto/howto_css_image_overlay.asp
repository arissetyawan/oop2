...
<html lang="en-US">
<head>
<title>How To Create Image Hover Overlay Effects</title>
<meta charset="utf-8">
...
<h1>How TO - Image Hover Overlay</h1>
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="howto_js_tab_img_gallery.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_overlay_slide.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create image overlay hover effects.</p>
<hr>

<h2>Image Overlay Fade</h2>

<p>Learn how to create a fading overlay effect to an image, on hover:</p>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_fade" class="w3-btn w3-margin-top w3-margin-bottom">
...
<div class="container">
  <img src="/w3css/img_avatar3.png" alt="Avatar" class="image" style="width:100%">
  <div class="middle">
    <div class="text">John</div>
  </div>
</div>

<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_opacity" class="w3-btn w3-margin-top w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
</div>
...
<p><strong>Tip:</strong> Go to our <a href="/css/css3_images.asp">CSS Images Tutorial</a> to learn 
more about how to style images.</p>
<p>Also check out: <a href="howto_css_image_overlay_slide.asp">Image Overlay Slide</a>, <a href="howto_css_image_overlay_zoom.asp">Image Overlay Zoom</a>, <a href="howto_css_image_overlay_title.asp">Image Overlay Title</a> and <a href="howto_css_image_overlay_icon.asp">Image Overlay Icon</a>.</p>
<br>
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="howto_js_tab_img_gallery.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_overlay_slide.asp">Next &#10095;</a>
