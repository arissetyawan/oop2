...
<a class="w3-left w3-btn" href="howto_css_fixed_sidebar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_sidebar_responsive.asp">Next &#10095;</a>
</div>
<hr>
...
<a href="javascript:void(0)">About</a>
  ...
  <button class="w3-btn w3-dark-grey w3-padding w3-margin-bottom" onclick="openOffcanvas1()">Sidenav overlay</button><br>
  <button class="w3-btn w3-dark-grey w3-padding w3-margin-bottom" onclick="openOffcanvas2()">Sidenav overlay without animation</button><br>
  <button class="w3-btn w3-dark-grey w3-padding w3-margin-bottom" onclick="openOffcanvas()">Sidenav push (off-canvas)</button><br>
  <button class="w3-btn w3-dark-grey w3-padding w3-margin-bottom" onclick="openNav3();openOffcanvas()">Sidenav push w/opacity</button><br>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav_push" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav_push_opacity" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
document.getElementById(&quot;mySidenav&quot;).style.width = &quot;0&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav_full" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav_none" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav_right" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_sidenav" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
