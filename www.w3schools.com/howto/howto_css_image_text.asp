...
<html lang="en-US">
<head>
<title>How To Position Text Over an Image</title>
<meta charset="utf-8">
...
<h1>How TO - Position Text Over an Image</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_image_bw.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_text_blocks.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to place text over an image.</p>
<hr>

<h2>Image Text</h2>

<div style="position:relative;text-align:center;">
<img src="img_snow_wide.jpg" alt="Snow" style="width:100%;height:auto;opacity:0.3">
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_image_text" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Place Text in Image</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class="container"&gt;<br>&nbsp; &lt;img src="img_snow_wide.jpg" alt="Snow" 
  style="width:100%;"&gt;<br>&nbsp; &lt;div class="bottom-left"&gt;Bottom Left&lt;/div&gt;<br>&nbsp; 
  &lt;div class="top-left"&gt;Top Left&lt;/div&gt;<br>&nbsp; &lt;div class="top-right"&gt;Top 
  Right&lt;/div&gt;<br>&nbsp; &lt;div class="bottom-right"&gt;Bottom Right&lt;/div&gt;<br>&nbsp; 
  &lt;div class="centered"&gt;Centered&lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
...
<div class="w3-code notranslate cssHigh">
  /* Container holding the image and the text */<br>.container {<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; 
  text-align: center;<br>&nbsp;&nbsp;&nbsp; color: white;<br>}<br><br>/* Bottom 
  left text */<br>
  .bottom-left {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
  bottom: 8px;<br>&nbsp;&nbsp;&nbsp; left: 16px;<br>}<br><br>/* Top left text */<br>.top-left {<br>&nbsp;&nbsp;&nbsp; position: 
  absolute;<br>&nbsp;&nbsp;&nbsp; top: 8px;<br>&nbsp;&nbsp;&nbsp; left: 16px;<br>}<br>
  <br>/* Top right text */<br>.top-right {<br>&nbsp;&nbsp;&nbsp; 
  position: absolute;<br>&nbsp;&nbsp;&nbsp; top: 8px;<br>&nbsp;&nbsp;&nbsp; 
  right: 16px;<br>}<br><br>/* Bottom right text */<br>
  .bottom-right {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
  bottom: 8px;<br>&nbsp;&nbsp;&nbsp; right: 16px;<br>}<br><br>/* Centered text 
  */<br>.centered {<br>&nbsp;&nbsp;&nbsp; position: 
  absolute;<br>&nbsp;&nbsp;&nbsp; top: 50%;<br>&nbsp;&nbsp;&nbsp; left: 50%;<br>&nbsp;&nbsp;&nbsp; 
  transform: translate(-50%, -50%);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
