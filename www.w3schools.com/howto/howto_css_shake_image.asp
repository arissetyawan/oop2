...
<html lang="en-US">
<head>
<title>How To Shake an Image</title>
<meta charset="utf-8">
...
<h1>How TO - Shake an Image</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_flip_image.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_portfolio_gallery.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to shake/wiggle an image with CSS.</p>
<hr>

<p>Move your mouse over the image:</p>
<img src="pineapple.jpg" class="testimg" alt="Pinapple" style="width:40%;min-width:300px;">
<hr>

<h2>How To Shake an Image</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  img:hover {<br>&nbsp;&nbsp;&nbsp; /* Start the shake animation and make the 
  animation last for 0.5 seconds */<br>&nbsp;&nbsp;&nbsp; animation: shake 
  0.5s; <br>&nbsp;&nbsp;&nbsp; /* When the animation is finished, start again */<br>&nbsp;&nbsp;&nbsp; 
  animation-iteration-count: infinite; <br>}<br><br>@keyframes shake {<br>&nbsp;&nbsp;&nbsp; 0% { transform: 
  translate(1px, 1px) rotate(0deg); }<br>&nbsp;&nbsp;&nbsp; 10% { transform: 
  translate(-1px, -2px) rotate(-1deg); }<br>&nbsp;&nbsp;&nbsp; 20% { transform: 
  translate(-3px, 0px) rotate(1deg); }<br>&nbsp;&nbsp;&nbsp; 30% { transform: 
  translate(3px, 2px) rotate(0deg); }<br>&nbsp;&nbsp;&nbsp; 40% { transform: 
  translate(1px, -1px) rotate(1deg); }<br>&nbsp;&nbsp;&nbsp; 50% { transform: 
  translate(-1px, 2px) rotate(-1deg); }<br>&nbsp;&nbsp;&nbsp; 60% { transform: 
  translate(-3px, 1px) rotate(0deg); }<br>&nbsp;&nbsp;&nbsp; 70% { transform: 
  translate(3px, 1px) rotate(-1deg); }<br>&nbsp;&nbsp;&nbsp; 80% { transform: 
  translate(-1px, -1px) rotate(1deg); }<br>&nbsp;&nbsp;&nbsp; 90% { transform: 
  translate(1px, 2px) rotate(0deg); }<br>&nbsp;&nbsp;&nbsp; 100% { transform: 
  translate(1px, -2px) rotate(-1deg); }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_shake" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_team.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_portfolio_gallery.asp">Next &#10095;</a>
</div>
</div>
