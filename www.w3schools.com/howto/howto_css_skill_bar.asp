...
<html lang="en-US">
<head>
<title>How To Create a Skill Bar CSS</title>
<meta charset="utf-8">
...
<h1>How TO - CSS Skill Bar</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_progressbar.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_rangeslider.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a skill bar with CSS.</p>
<hr>

<h1>My Skills</h1>
<p>A "skill bar" is often used in online CV's/resumes to display your skills in different subjects:</p>

<p style="margin-bottom:6px;">HTML</p>
<div class="container">
  <div class="skills html" style="">90%</div>
</div>
...
<p style="margin-bottom:6px;">PHP</p>
<div class="container">
  <div class="skills php">60%</div>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_skill_bar" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Skill Bar</h2>
<h5>Step 1) Add HTML</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;p&gt;HTML&lt;/p&gt;<br>&lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;div class=&quot;skills html&quot;&gt;90%&lt;/div&gt;<br>
  &lt;/div&gt;<br><br>&lt;p&gt;CSS&lt;/p&gt;<br>&lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;div class=&quot;skills css&quot;&gt;80%&lt;/div&gt;<br>
  &lt;/div&gt;<br><br>&lt;p&gt;JavaScript&lt;/p&gt;<br>&lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;div 
  class=&quot;skills js&quot;&gt;65%&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;p&gt;PHP&lt;/p&gt;<br>&lt;div 
  class=&quot;container&quot;&gt;<br>&nbsp; &lt;div class=&quot;skills php&quot;&gt;60%&lt;/div&gt;<br>&lt;/div&gt;<br></div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Make sure that padding behaves as expected */<br>* {box-sizing:border-box}<br>
  <br>/* Container for skill bars */<br>.container {<br>&nbsp;&nbsp;&nbsp; width: 100%; 
  /* Full width */<br>
  &nbsp;&nbsp;&nbsp;
  background-color: #ddd; /* Grey background */<br>}<br><br>.skills {<br>&nbsp;&nbsp;&nbsp; text-align: right; 
  /* Right-align text */<br>
  &nbsp;&nbsp;&nbsp; padding: 10px; /* Add some padding */<br>&nbsp;&nbsp;&nbsp; color: white; /* White text 
  color */<br>}<br><br>.html 
  {width: 90%; background-color: #4CAF50;} /* Green */<br>.css 
  {width: 80%; background-color: #2196F3;} /* Blue */<br>.js 
  {width: 65%; background-color: #f44336;} /* Red */<br>.php 
  {width: 60%; background-color: #808080;} /* Dark Grey */<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_skill_bar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
