...
<a class="w3-left w3-btn" href="howto_css_menu_icon.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_tabs.asp">Next &#10095;</a>
</div>
<hr>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryhow_js_accordion" class="w3-btn">Try it Yourself &raquo;</a>
</p>
<hr>
...
/* Style the buttons that are used to open and close the accordion panel */<br>
  .accordion {<br>&nbsp;&nbsp;&nbsp; background-color: #eee;<br>&nbsp;&nbsp;&nbsp; 
...
background-color: #ccc;<br>}<br><br>/* Style the accordion panel. Note: 
hidden by default */<br>.panel {<br>&nbsp;&nbsp;&nbsp; padding: 0 18px;<br>&nbsp;&nbsp;&nbsp; 
background-color: white;<br>&nbsp;&nbsp;&nbsp; 
display: none;<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>}</div>
</div>
<hr>
...
&quot;active&quot; class,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; to 
  highlight the button that controls the panel */<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_accordion" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Animated Accordion (Slide Down)</h2>
<p>To make an animated accordion, add <code class="w3-codespan">max-height: 0</code>, <code class="w3-codespan">overflow: hidden</code> and 
...
<div class="w3-code notranslate htmlHigh">
  ...
  transition: max-height 0.2s ease-out;<br>}<br>&lt;/style&gt;<br><br>&lt;script&gt;<br>var acc = 
  ...
  &lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_accordion_animate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .accordion:after {<br>&nbsp;&nbsp;&nbsp; content: '\02795'; /* Unicode 
character for &quot;plus&quot; sign (+) */<br>&nbsp;&nbsp;&nbsp; font-size: 13px;<br>&nbsp;&nbsp;&nbsp; 
color: #777;<br>&nbsp;&nbsp;&nbsp; float: right;<br>&nbsp;&nbsp;&nbsp; 
margin-left: 5px;<br>}<br><br>
  .active:after {<br>&nbsp;&nbsp;&nbsp; content: &quot;\2796&quot;; /* 
Unicode character for &quot;minus&quot; sign (-) */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_accordion_symbol" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
