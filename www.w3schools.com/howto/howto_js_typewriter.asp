...
<html lang="en-US">
<head>
<title>How To Create a Typing Effect</title>
<meta charset="utf-8">
...
<h1>How TO - Typing Effect</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_countdown.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_coming_soon.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a typing effect with JavaScript.</p>
<hr>

<script>
var irrr = 0;
var testtxt = 'Lorem ipsum typing effect! Great stuff! Cant wait to check out the Try it Yourself!';

function typeWriter() {
  if (irrr < testtxt.length) {
    document.getElementById("heyhey").innerHTML += testtxt.charAt(irrr);
    irrr++;
...
<button onclick="typeWriter()" class="w3-button w3-light-grey">Start the typing effect</button>

<p id="heyhey">&nbsp;</p>
<hr>

<h2>Creating a Typing Effect</h2>
...
<div class="w3-code notranslate jsHigh">
  var i = 0;<br>var txt = 'Lorem ipsum typing effect!'; /* The text */<br>var 
  speed = 50; /* The speed/duration of the effect in milliseconds */<br><br>function 
  typeWriter() {<br>&nbsp; if (i &lt; txt.length) {<br>
  &nbsp;&nbsp;&nbsp;
  document.getElementById(&quot;demo&quot;).innerHTML += txt.charAt(i);<br>&nbsp;&nbsp;&nbsp; i++;<br>
  &nbsp;&nbsp;&nbsp;
  setTimeout(typeWriter, speed);<br>&nbsp; }<br>}<br></div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_typewriter" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Learn more about the <a href="/jsref/met_win_setinterval.asp">window.setTimeout()</a> method in our JavaScript Reference.</p>
