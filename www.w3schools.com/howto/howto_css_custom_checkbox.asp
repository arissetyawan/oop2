...
<html lang="en-US">
<head>
<title>How To Create a Custom Checkbox and Radio Buttons</title>
<meta charset="utf-8">
...
<h1>How TO - Custom Checkbox</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_login_form_navbar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_custom_select.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create custom checkboxes and radio buttons with CSS.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_custom_checkbox" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Custom Checkbox</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;label class=&quot;container&quot;&gt;One<br>&nbsp; &lt;input type=&quot;checkbox&quot; 
  checked=&quot;checked&quot;&gt;<br>&nbsp; &lt;span class=&quot;checkmark&quot;&gt;&lt;/span&gt;<br>&lt;/label&gt;<br>
  <br>&lt;label class=&quot;container&quot;&gt;Two<br>&nbsp; &lt;input type=&quot;checkbox&quot;&gt;<br>&nbsp; 
  &lt;span class=&quot;checkmark&quot;&gt;&lt;/span&gt;<br>&lt;/label&gt;<br><br>
  &lt;label class=&quot;container&quot;&gt;Three<br>&nbsp; &lt;input type=&quot;checkbox&quot;&gt;<br>&nbsp; 
  &lt;span class=&quot;checkmark&quot;&gt;&lt;/span&gt;<br>&lt;/label&gt;<br><br>&lt;label class=&quot;container&quot;&gt;Four<br>&nbsp; 
  &lt;input type=&quot;checkbox&quot;&gt;<br>&nbsp; &lt;span class=&quot;checkmark&quot;&gt;&lt;/span&gt;<br>&lt;/label&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Customize the label (the container) */<br>.container {<br>&nbsp; display: block;<br>&nbsp; 
  position: relative;<br>&nbsp; padding-left: 35px;<br>&nbsp; margin-bottom: 
  12px;<br>&nbsp; cursor: pointer;<br>&nbsp; font-size: 22px;<br>&nbsp; -webkit-user-select: 
  none;<br>&nbsp; -moz-user-select: none;<br>&nbsp; -ms-user-select: none;<br>&nbsp; 
  user-select: none;<br>}<br><br>/* Hide the 
  browser's default checkbox */<br>.container input {<br>&nbsp; position: absolute;<br>&nbsp; 
  opacity: 0;<br>&nbsp; cursor: pointer;<br>&nbsp; height: 0;<br>&nbsp; width: 
  0;<br>
  }<br>
  <br>/* Create a custom checkbox */<br>.checkmark {<br>&nbsp; position: 
  absolute;<br>&nbsp; top: 0;<br>&nbsp; left: 0;<br>&nbsp; height: 25px;<br>&nbsp; 
  width: 25px;<br>&nbsp; background-color: #eee;<br>}<br><br>/* On mouse-over, add a grey background color */<br>.container:hover 
  input ~ .checkmark {<br>&nbsp; background-color: #ccc;<br>}<br><br>/* When the 
  checkbox is checked, add a blue background */<br>.container input:checked ~ 
  .checkmark {<br>&nbsp; background-color: #2196F3;<br>}<br><br>/* Create the 
  checkmark/indicator (hidden when not checked) */<br>.checkmark:after {<br>&nbsp; 
  content: &quot;&quot;;<br>&nbsp; position: absolute;<br>&nbsp; display: none;<br>}<br><br>/* Show the 
  checkmark when checked */<br>.container input:checked ~ .checkmark:after {<br>&nbsp; 
  display: block;<br>}<br><br>/* Style the checkmark/indicator */<br>.container 
  .checkmark:after {<br>&nbsp; left: 9px;<br>&nbsp; top: 5px;<br>&nbsp; width: 
  5px;<br>&nbsp; height: 10px;<br>&nbsp; border: solid white;<br>&nbsp; 
  border-width: 0 3px 3px 0;<br>&nbsp; -webkit-transform: rotate(45deg);<br>&nbsp; 
  -ms-transform: rotate(45deg);<br>&nbsp; transform: rotate(45deg);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_custom_checkbox" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>How To Create a Custom Radio Button</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Customize the label (the container) */<br>.container {<br>&nbsp; display: block;<br>&nbsp; 
  ...
  none;<br>&nbsp; -moz-user-select: none;<br>&nbsp; -ms-user-select: none;<br>&nbsp; 
  user-select: none;<br>}<br><br>/* Hide the 
  browser's default radio button */<br>.container input {<br>&nbsp; position: absolute;<br>&nbsp; 
  opacity: 0;<br>&nbsp; cursor: pointer;<br>&nbsp; height: 0;<br>&nbsp; width: 
  0;<br>
  }<br>
  <br>/* Create a custom radio button */<br>.checkmark {<br>&nbsp; position: 
  absolute;<br>&nbsp; top: 0;<br>&nbsp; left: 0;<br>&nbsp; height: 25px;<br>&nbsp; 
  width: 25px;<br>&nbsp; background-color: #eee;<br>&nbsp; border-radius: 50%;<br>
  }<br><br>/* On mouse-over, add a grey background color 
  */<br>.container:hover input ~ .checkmark {<br>&nbsp; background-color: #ccc;<br>
  }<br>
  <br>/* When the radio button is checked, add a blue background */<br>
  .container input:checked ~ .checkmark {<br>&nbsp; background-color: #2196F3;<br>
  }<br>
  <br>/* Create the indicator (the dot/circle - hidden when not checked) */<br>.checkmark:after 
  {<br>&nbsp; content: &quot;&quot;;<br>&nbsp; position: absolute;<br>&nbsp; display: 
  none;<br>}<br><br>/* Show 
  the indicator (dot/circle) when checked */<br>.container input:checked ~ .checkmark:after 
  {<br>&nbsp; display: block;<br>}<br><br>/* Style the indicator (dot/circle) */<br>
  .container .checkmark:after {<br>&nbsp; top: 9px;<br>&nbsp; left: 9px;<br>&nbsp; 
  width: 8px;<br>&nbsp; height: 8px;<br>&nbsp; border-radius: 50%;<br>&nbsp; 
  background: white;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_custom_radio" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
