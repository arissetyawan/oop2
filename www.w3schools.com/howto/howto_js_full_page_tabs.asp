...
<html lang="en-US">
<head>
<title>How To Create Full Page Tabs</title>
<meta charset="utf-8">
...
<h1>How TO - Full Page Tabs</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_tab_header.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_hover_tabs.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create full page tabs, that covers the entire 
browser window, with  CSS and JavaScript.</p>
<hr>
<h2>Full Page Tabs</h2>
<p>Click on the links to display the "current" page:</p>

<button class="tablink" onclick="openCity('London', this, '#f44336')">Home</button>
<button class="tablink" onclick="openCity('Paris', this, '#4CAF50')" id="defaultOpen">News</button>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_full_page_tabs" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>Create One Page Tabs</h2>
...
<p>Style the links and the tab content (full page):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Set height of body and the document to 100% to enable &quot;full page tabs&quot; */<br>
  body, html {<br>&nbsp; 
...
<div class="w3-code notranslate jsHigh">
  ...
  <br>&nbsp;&nbsp;&nbsp; // Show the specific tab content<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById(pageName).style.display = &quot;block&quot;;<br><br>&nbsp;&nbsp;&nbsp; 
  // Add the specific color to the button used to open the tab content<br>&nbsp;&nbsp;&nbsp; 
  elmnt.style.backgroundColor = color;<br>}<br><br>// Get the element with id=&quot;defaultOpen&quot; 
  and click on it<br>document.getElementById(&quot;defaultOpen&quot;).click();</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_full_page_tabs" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
