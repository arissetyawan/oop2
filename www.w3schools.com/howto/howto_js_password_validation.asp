...
<html lang="en-US">
<head>
<title>How To Create a Password Validation Form</title>
<meta charset="utf-8">
...
<h1>How TO - Password Validation</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_trigger_button_enter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_toggle_password.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a password validation form with CSS and JavaScript.</p>
<hr>
<h2>Password Validation</h2>
<img src="passw_val.jpg" style="width:100%" class="w3-image w3-border">
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_password_val" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>Create A Password Validation Form</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;form action=&quot;/action_page.php&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;label for=&quot;usrname&quot;&gt;Username&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input type=&quot;text&quot; id=&quot;usrname&quot; 
  name=&quot;usrname&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp; &lt;label for=&quot;psw&quot;&gt;Password&lt;/label&gt;<br>&nbsp; 
  &lt;&nbsp; input type=&quot;password&quot; id=&quot;psw&quot; name=&quot;psw&quot; pattern=&quot;(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}&quot; 
  title=&quot;Must contain at least one number and one uppercase and lowercase 
  letter, and at least 8 or more characters&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp; &lt;input 
  type=&quot;submit&quot; value=&quot;Submit&quot;&gt;<br>&nbsp; &lt;/form&gt;<br>&lt;/div&gt;<br>
  <br>&lt;div id=&quot;message&quot;&gt;<br>&nbsp; &lt;h3&gt;Password must contain the following:&lt;/h3&gt;<br>&nbsp; 
  &lt;p id=&quot;letter&quot; class=&quot;invalid&quot;&gt;A &lt;b&gt;lowercase&lt;/b&gt; letter&lt;/p&gt;<br>&nbsp; &lt;p 
  id=&quot;capital&quot; class=&quot;invalid&quot;&gt;A &lt;b&gt;capital (uppercase)&lt;/b&gt; letter&lt;/p&gt;<br>&nbsp; 
  &lt;p id=&quot;number&quot; class=&quot;invalid&quot;&gt;A &lt;b&gt;number&lt;/b&gt;&lt;/p&gt;<br>&nbsp; &lt;p id=&quot;length&quot; 
  class=&quot;invalid&quot;&gt;Minimum &lt;b&gt;8 characters&lt;/b&gt;&lt;/p&gt;<br>&lt;/div&gt;</div>
</div>
<p><strong>Note:</strong> We use the pattern attribute (with a regular 
...
<p>Style the input fields and the message box:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Style all input fields */<br>input {<br>&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp;&nbsp;&nbsp; padding: 12px;<br>&nbsp;&nbsp;&nbsp; 
  border: 1px solid #ccc;<br>&nbsp;&nbsp;&nbsp; border-radius: 4px;<br>&nbsp;&nbsp;&nbsp; 
  box-sizing: border-box;<br>&nbsp;&nbsp;&nbsp; margin-top: 6px;<br>&nbsp;&nbsp;&nbsp; 
  margin-bottom: 16px;<br>}<br><br>/* Style the submit 
  button */<br>input[type=submit] {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; color: white;<br>}<br><br>/* Style the container 
  for inputs */<br>.container 
  {<br>&nbsp;&nbsp;&nbsp; background-color: #f1f1f1;<br>&nbsp;&nbsp;&nbsp; 
  padding: 20px;<br>}<br><br>/* The message 
  box is shown when the user clicks on the password field */<br>#message {<br>&nbsp;&nbsp;&nbsp; 
  display:none;<br>&nbsp;&nbsp;&nbsp; background: #f1f1f1;<br>&nbsp;&nbsp;&nbsp; 
  color: #000;<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; 
  padding: 20px;<br>&nbsp;&nbsp;&nbsp; margin-top: 10px;<br>}<br><br>#message p {<br>&nbsp;&nbsp;&nbsp; 
  padding: 10px 35px;<br>&nbsp;&nbsp;&nbsp; font-size: 18px;<br>}<br><br>/* Add a green text color and a 
  checkmark when the requirements are right */<br>.valid {<br>&nbsp;&nbsp;&nbsp; 
  color: green;<br>}<br>
  <br>.valid:before {<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; 
  left: -35px;<br>&nbsp;&nbsp;&nbsp; content: &quot;&amp;#10004;&quot;;<br>}<br><br>/* Add a red text color and an &quot;x&quot; icon when the 
  requirements are wrong */<br>.invalid {<br>&nbsp;&nbsp;&nbsp; color: red;<br>}<br><br>.invalid:before 
  {<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; left: -35px;<br>&nbsp;&nbsp;&nbsp; 
  content: &quot;&amp;#10006;&quot;;<br>}</div>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script&gt;<br>var myInput = document.getElementById(&quot;psw&quot;);<br>var 
  letter = document.getElementById(&quot;letter&quot;);<br>var capital = 
  document.getElementById(&quot;capital&quot;);<br>var number = document.getElementById(&quot;number&quot;);<br>
  var length = document.getElementById(&quot;length&quot;);<br><br>// When the user clicks 
  on the password field, show the message box<br>myInput.onfocus = function() {<br>&nbsp; 
  document.getElementById(&quot;message&quot;).style.display = &quot;block&quot;;<br>}<br><br>// 
  When the user clicks outside of the password field, hide the message box<br>
  myInput.onblur = function() {<br>&nbsp; document.getElementById(&quot;message&quot;).style.display 
  = &quot;none&quot;;<br>}<br><br>// When the user starts to type something inside the 
  password field<br>myInput.onkeyup = function() {<br>&nbsp; // Validate 
  lowercase letters<br>&nbsp; var lowerCaseLetters = /[a-z]/g;<br>&nbsp; if(myInput.value.match(lowerCaseLetters)) 
  { <br>&nbsp;&nbsp;&nbsp; letter.classList.remove(&quot;invalid&quot;);<br>&nbsp;&nbsp;&nbsp; 
  letter.classList.add(&quot;valid&quot;);<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  letter.classList.remove(&quot;valid&quot;);<br>&nbsp;&nbsp;&nbsp; letter.classList.add(&quot;invalid&quot;);<br>
  }<br><br>&nbsp; // Validate capital letters<br>&nbsp; var upperCaseLetters = 
  /[A-Z]/g;<br>&nbsp; if(myInput.value.match(upperCaseLetters)) { <br>&nbsp;&nbsp;&nbsp; 
  capital.classList.remove(&quot;invalid&quot;);<br>&nbsp;&nbsp;&nbsp; 
  capital.classList.add(&quot;valid&quot;);<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  capital.classList.remove(&quot;valid&quot;);<br>&nbsp;&nbsp;&nbsp; capital.classList.add(&quot;invalid&quot;);<br>&nbsp; 
  }<br><br>&nbsp; // Validate numbers<br>&nbsp; var numbers = /[0-9]/g;<br>&nbsp; 
  if(myInput.value.match(numbers)) { <br>&nbsp;&nbsp;&nbsp; 
  number.classList.remove(&quot;invalid&quot;);<br>&nbsp;&nbsp;&nbsp; number.classList.add(&quot;valid&quot;);<br>&nbsp; 
  } else {<br>&nbsp;&nbsp;&nbsp; number.classList.remove(&quot;valid&quot;);<br>&nbsp;&nbsp;&nbsp; 
  number.classList.add(&quot;invalid&quot;);<br>&nbsp; }<br><br>&nbsp; // Validate length<br>&nbsp; 
  if(myInput.value.length &gt;= 8) {<br>&nbsp;&nbsp;&nbsp; length.classList.remove(&quot;invalid&quot;);<br>&nbsp;&nbsp;&nbsp; 
  length.classList.add(&quot;valid&quot;);<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  length.classList.remove(&quot;valid&quot;);<br>&nbsp;&nbsp;&nbsp; length.classList.add(&quot;invalid&quot;);<br>&nbsp; 
  }<br>}<br>
&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_password_val" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
