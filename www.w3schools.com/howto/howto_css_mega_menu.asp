...
<html lang="en-US">
<head>
<title>How To Create a Mega Menu</title>
<meta charset="utf-8">
...
<h1>How TO - Mega Menu</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_dropup.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_mobile_navbar.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a mega menu (full-width dropdown menu in a navigation bar).</p>
<hr>
<h2>Mega Menu</h2>

<div style="padding:10px;border:3px solid #f1f1f1">
<iframe src="tryhow_css_mega_menu_responsive.htm" style="width:100%;border:none;height:400px;"></iframe>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_mega_menu_responsive" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create A Mega Menu</h2>
<p>Create a dropdown menu that appears when the user moves the mouse over an 
element inside a navigation bar.</p>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;navbar&quot;&gt;<br>&nbsp; &lt;a href=&quot;#home&quot;&gt;Home&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#news&quot;&gt;News&lt;/a&gt;<br>&nbsp; 
  &lt;div class=&quot;dropdown&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;button class=&quot;dropbtn&quot;&gt;Dropdown
  <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;i class=&quot;fa fa-caret-down&quot;&gt;&lt;/i&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;dropdown-content&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;div class=&quot;header&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;h2&gt;Mega 
  Menu&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
or &lt;p&gt; element.</p>
<p>Use a container element (like &lt;div class=&quot;dropdown-content&quot;&gt;) to create 
the dropdown menu and add a grid (columns) and add dropdown links inside the 
grid.</p>
<p>Wrap a &lt;div class=&quot;dropdown&quot;&gt; element around the button and the 
...
<div class="w3-code notranslate cssHigh">
  /* Navbar container */<br>.navbar {<br>&nbsp; overflow: hidden;<br>&nbsp; 
  background-color: #333;<br>&nbsp; font-family: Arial;<br>}<br><br>/* Links inside the navbar */<br>.navbar a {<br>&nbsp; 
  float: left;<br>&nbsp; font-size: 16px;<br>&nbsp; color: white;<br>&nbsp; 
  text-align: center;<br>&nbsp; padding: 14px 16px;<br>&nbsp; text-decoration: 
  none;<br>}<br><br>/* The dropdown 
  container */<br>.dropdown {<br>&nbsp; float: left;<br>&nbsp; 
  overflow: hidden;<br>}<br><br>/* Dropdown button */<br>.dropdown .dropbtn {<br>&nbsp; font-size: 16px; <br>&nbsp; 
  border: none;<br>&nbsp; outline: none;<br>&nbsp; color: white;<br>&nbsp; 
  padding: 14px 16px;<br>&nbsp; background-color: inherit;<br>&nbsp; font: inherit; 
  /* Important for vertical align on mobile phones */<br>&nbsp; margin: 0; /* 
  Important for vertical align on mobile phones */<br>}<br><br>/* Add a 
  red background color to navbar links on hover */<br>.navbar a:hover, .dropdown:hover .dropbtn {<br>&nbsp; 
  background-color: red;<br>}<br><br>/* Dropdown content (hidden by default) */<br>
  .dropdown-content {<br>&nbsp; display: 
  none;<br>&nbsp; position: absolute;<br>&nbsp; background-color: #f9f9f9;<br>&nbsp; 
  width: 100%;<br>&nbsp; left: 0;<br>&nbsp; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);<br>&nbsp; 
  z-index: 1;<br>}<br><br>/* Mega Menu header, if needed */<br>.dropdown-content 
  .header {<br>&nbsp; background: red;<br>&nbsp; 
  padding: 16px;<br>&nbsp; color: white;<br>}<br><br>/* 
  Show the dropdown menu on hover */<br>.dropdown:hover .dropdown-content {<br>&nbsp; display: block;<br>}<br>
  <br>/* Create three equal columns that floats next to each other */<br>.column 
  {<br>&nbsp; float: left;<br>&nbsp; width: 33.33%;<br>&nbsp; padding: 10px;<br>&nbsp; 
  background-color: #ccc;<br>&nbsp; height: 250px;<br>}<br><br>/* Style links 
  inside the columns */<br>.column a {<br>&nbsp; float: none;<br>&nbsp; 
  color: black;<br>&nbsp; padding: 16px;<br>&nbsp; text-decoration: none;<br>&nbsp; 
  display: block;<br>&nbsp; text-align: left;<br>}<br><br>/* Add a background 
  color on hover */<br>.column a:hover {<br>&nbsp; background-color: #ddd;<br>}<br><br>/* Clear floats after the columns */<br>.row:after {<br>&nbsp; 
  content: &quot;&quot;;<br>&nbsp; display: table;<br>&nbsp; clear: both;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_mega_menu" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
<p>We have styled the navigation bar and the navbar links with a 
background-color, padding, etc.</p>
<p>We have styled the dropdown button with a background-color, padding, etc.</p>
<p>The <code class="w3-codespan">.dropdown</code> class uses <code class="w3-codespan">position:relative</code>, which is needed when we want the 
dropdown content to be placed right below the dropdown button (using <code class="w3-codespan">position:absolute</code>).</p>
<p>The <code class="w3-codespan">.dropdown-content</code> class holds the actual 
...
width is set to 100% to cover the whole screen.</p>
<p>Instead of using a border, we have used the <code class="w3-codespan">box-shadow</code> property to make the 
dropdown menu look like a "card". We also use z-index to place the dropdown in 
front of other elements.</p>
...
<p>The <code class="w3-codespan">.column</code> classes are used to create three columns that floats next to each 
other inside the dropdown menu (to show different categories). </p>
<hr>
...
<iframe src="tryhow_css_mega_menu_responsive_ifr.htm" style="width:100%;border:none;height:500px;"></iframe>
</div>
<div class="w3-code notranslate cssHigh">
  /* Responsive layout - makes the three columns stack on top of each other 
  instead of next to each other */<br>@media screen and (max-width: 600px) {<br>&nbsp; 
  .column {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; height: 
  auto;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_mega_menu_responsive" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>


<p><strong>Tip:</strong> Go to our <a href="/css/css_dropdowns.asp">CSS Dropdowns Tutorial</a> to learn more about 
dropdowns.</p>
<p><strong>Tip:</strong> Go to our <a href="howto_js_dropdown.asp">Clickable Dropdowns</a> to learn more about clickable dropdowns</p>
<p><strong>Tip:</strong> Go to our <a href="/css/css_navbar.asp">CSS Navbar Tutorial</a> to learn more about 
navbars.</p>
<p><strong>Tip:</strong> Go to our <a href="howto_js_topnav_responsive.asp">Responsive Top Navigation</a> to learn about how to create a responsive navbar.</p>
<br>
