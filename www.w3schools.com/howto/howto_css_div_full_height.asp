...
<html lang="en-US">
<head>
<title>How To Make a DIV Full Height of the Browser Window</title>
<meta charset="utf-8">
...
<h1>How TO - Full Height Element</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_html_download_link.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_browser_window.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to stretch elements to fit the whole height of the browser window with CSS.</p>
<hr>
<h2>Full Height Div</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh htmlHigh">
  html, body {<br>&nbsp; height: 100%;<br>}<br><br>
  .full-height {<br>&nbsp; height: 100%;<br>}<br>
  <br>&lt;div class=&quot;full-height&quot;&gt;..&lt;/div&gt;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_css_div_full_height" target="_blank">Try it Yourself &raquo;</a>
</div>
