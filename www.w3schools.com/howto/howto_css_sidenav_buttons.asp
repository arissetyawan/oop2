...
<html lang="en-US">
<head>
<title>How To Create a Hoverable Side Navigation</title>
<meta charset="utf-8">
...
<h1>How TO - Side Navigation Buttons</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_off-canvas.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_sidebar_icons.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create hoverable side navigation buttons with CSS.</p>
<hr>

<iframe src="tryhow_css_sidenav_buttons_ifr.htm" style="width:100%;height:280px" class="w3-border"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_sidenav_buttons" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Create a Hoverable Sidenav</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div id=&quot;mySidenav&quot; class=&quot;sidenav&quot;&gt;<br>&nbsp; &lt;a href=&quot;#&quot; 
  id=&quot;about&quot;&gt;About&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot; id=&quot;blog&quot;&gt;Blog&lt;/a&gt;<br>&nbsp; &lt;a 
  href=&quot;#&quot; id=&quot;projects&quot;&gt;Projects&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot; 
  id=&quot;contact&quot;&gt;Contact&lt;/a&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style the links inside the sidenav */<br>#mySidenav a {<br>&nbsp;&nbsp;&nbsp; position: absolute; 
  /* Position them relative to the browser window */<br>&nbsp;&nbsp;&nbsp; left: -80px; 
  /* Position them outside of the screen */<br>&nbsp;&nbsp;&nbsp; transition: 0.3s; 
  /* Add transition on hover */<br>&nbsp;&nbsp;&nbsp; padding: 15px; /* 15px 
  padding */<br>&nbsp;&nbsp;&nbsp; width: 100px; /* Set a specific width */<br>&nbsp;&nbsp;&nbsp; text-decoration: none; 
  /* Remove underline */<br>
  &nbsp;&nbsp;&nbsp;
  font-size: 20px; /* Increase font size */<br>&nbsp;&nbsp;&nbsp; color: white; 
  /* White text color */<br>&nbsp;&nbsp;&nbsp; border-radius: 0 5px 5px 0; /* 
  Rounded corners on the top right and bottom right side */<br>}<br><br>#mySidenav 
  a:hover {<br>&nbsp;&nbsp;&nbsp; left: 0; /* On mouse-over, make the elements 
  appear as they should */<br>}<br><br>/* The about link: 20px from the top with 
  a green background */<br>#about {<br>&nbsp;&nbsp;&nbsp; top: 20px;<br>
  &nbsp;&nbsp;&nbsp;
  background-color: #4CAF50;<br>}<br><br>#blog {<br>&nbsp;&nbsp;&nbsp; top: 80px;<br>
  &nbsp;&nbsp;&nbsp;
  background-color: #2196F3; /* Blue */<br>}<br><br>#projects {<br>&nbsp;&nbsp;&nbsp; top: 140px;<br>
  &nbsp;&nbsp;&nbsp;
  background-color: #f44336; /* Red */<br>}<br><br>#contact {<br>&nbsp;&nbsp;&nbsp; top: 200px;<br>
  &nbsp;&nbsp;&nbsp;
  background-color: #555 /* Light Black */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_sidenav_buttons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
