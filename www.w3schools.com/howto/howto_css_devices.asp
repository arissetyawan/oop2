...
<html lang="en-US">
<head>
<title>How To Create a Device Look with CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Device Look</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_custom_scrollbar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_placeholder.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create different device looks (smartphone, tablet and laptop) with CSS.</p>
<hr>

<h2>Devices</h2>
<iframe src="tryhow_css_phone_tablet_laptop.htm" style="width:100%;border:5px solid #ddd;height:384px;"></iframe>

<div class="w3-row-padding" style="margin:16px -16px">
  <div class="w3-third">
    <a target="_blank" href="tryit.asp?filename=tryhow_css_device_smartphone" class="w3-btn w3-block w3-margin-bottom">Try Smartphone &raquo;</a>
  </div>
  
  <div class="w3-third">
    <a target="_blank" href="tryit.asp?filename=tryhow_css_device_tablet&stacked=h" class="w3-btn w3-block w3-margin-bottom">Try Tablet &raquo;</a>
  </div>
  <div class="w3-third">
    <a target="_blank" href="tryit.asp?filename=tryhow_css_device_laptop&stacked=h" class="w3-btn w3-block w3-margin-bottom">Try Laptop &raquo;</a>
  </div>
</div>
