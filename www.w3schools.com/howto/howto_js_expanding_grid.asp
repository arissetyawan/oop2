...
<title>How To Create an Expanding Grid</title>
<meta charset="utf-8">
...
<h1>How TO - Expanding Grid</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_four_columns.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_list_grid_view.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an expanding grid with CSS and JavaScript.</p>
<hr>
<h2>Expanding Grid</h2>
<p>Click on a box to "expand" it (100% width):</p>
<div class="w3-row-padding" style="margin:0 -16px">
  <div class="w3-col s4 w3-container">
  <a href="javascript:void(0)" onclick="openTab('b1');" style="text-decoration:none">
    <div class="w3-green w3-xlarge w3-center" style="padding:50px">Box 1</div>
  </a>
  </div>
  <div class="w3-col s4 w3-container">
    <a href="javascript:void(0)" onclick="openTab('b2');" style="text-decoration:none">
    <div class="w3-blue w3-xlarge w3-center" style="padding:50px">Box 2</div>
    </a>
  </div>
  <div class="w3-col s4 w3-container">
    <a href="javascript:void(0)" onclick="openTab('b3');" style="text-decoration:none">
    <div class="w3-red w3-xlarge w3-center" style="padding:50px">Box 3</div>
    </a>
  </div>
</div><br>

<div id="b1" class="picture w3-margin-bottom w3-display-container">
  <span onclick="this.parentElement.style.display='none'" class="w3-display-topright w3-text-white w3-xlarge w3-hover-text-light-grey" style="cursor:pointer;font-weight:bold;padding:20px 30px">&times;</span>      
    <div class="w3-green w3-container" style="padding:50px">
  <h2>Box 1</h2>
      <p>Lorem ipsum dolor sit amet, te quo doctus abhorreant, et pri deleniti intellegat, te sanctus inermis ullamcorper nam. Ius error diceret deseruisse ad</p>
    </div>
</div>

<div id="b2" class="picture w3-margin-bottom w3-display-container">
  <span onclick="this.parentElement.style.display='none'" class="w3-display-topright w3-text-white w3-xlarge w3-hover-text-light-grey" style="cursor:pointer;font-weight:bold;padding:20px 30px">&times;</span>      
    <div class="w3-blue w3-container" style="padding:50px">
      <h2>Box 2</h2>
      <p>Lorem ipsum dolor sit amet, te quo doctus abhorreant, et pri deleniti intellegat, te sanctus inermis ullamcorper nam. Ius error diceret deseruisse ad</p>
    </div>
</div>

<div id="b3" class="picture w3-margin-bottom w3-display-container">
   <span onclick="this.parentElement.style.display='none'" class="w3-display-topright w3-text-white w3-xlarge w3-hover-text-light-grey" style="cursor:pointer;font-weight:bold;padding:20px 30px">&times;</span>     
    <div class="w3-red w3-container" style="padding:50px">
        <h2>Box 3</h2>
      <p>Lorem ipsum dolor sit amet, te quo doctus abhorreant, et pri deleniti intellegat, te sanctus inermis ullamcorper nam. Ius error diceret deseruisse ad</p>
    </div>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_expanding_grid" class="w3-btn">Try it Yourself &raquo;</a>

<hr>

<h2>Create an Expanding Grid</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- The grid: three columns --&gt;<br>
  &lt;div class=&quot;row&quot;&gt;<br>&nbsp; 
  &lt;div class=&quot;column&quot; onclick=&quot;openTab('b1');&quot; style=&quot;background:green;&quot;&gt;Box 
  1&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;column&quot; onclick=&quot;openTab('b2');&quot; style=&quot;background:blue;&quot;&gt;Box 
  2&lt;/div&gt;<br>&nbsp; &lt;div class=&quot;column&quot; onclick=&quot;openTab('b3');&quot; style=&quot;background:red;&quot;&gt;Box 
  3&lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;!-- The expanding grid (hidden by default) --&gt;<br>
  &lt;div id=&quot;b1&quot; class=&quot;containerTab&quot; style=&quot;display:none;background:green&quot;&gt;<br>&nbsp; 
  &lt;!-- If you want the ability to close the container, add a close button --&gt;<br>&nbsp; 
  &lt;span onclick=&quot;this.parentElement.style.display='none'&quot; class=&quot;closebtn&quot;&gt;x&lt;/span&gt;<br>&nbsp; 
  &lt;h2&gt;Box 1&lt;/h2&gt;<br>&nbsp; &lt;p&gt;Lorem ipsum..&lt;/p&gt;<br>&lt;/div&gt;<br><br>&lt;div id=&quot;b2&quot; class=&quot;containerTab&quot; style=&quot;display:none;background:blue&quot;&gt;<br>&nbsp; 
  &lt;span onclick=&quot;this.parentElement.style.display='none'&quot; class=&quot;closebtn&quot;&gt;x&lt;/span&gt;<br>&nbsp; 
  &lt;h2&gt;Box 2&lt;/h2&gt;<br>&nbsp; &lt;p&gt;Lorem ipsum..&lt;/p&gt;<br>&lt;/div&gt;<br><br>&lt;div id=&quot;b3&quot; class=&quot;containerTab&quot; style=&quot;display:none;background:red&quot;&gt;<br>&nbsp; 
  &lt;span onclick=&quot;this.parentElement.style.display='none'&quot; class=&quot;closebtn&quot;&gt;x&lt;/span&gt;<br>&nbsp; 
  &lt;h2&gt;Box 3&lt;/h2&gt;<br>&nbsp; &lt;p&gt;Lorem ipsum..&lt;/p&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* The grid: Three equal columns that floats next to each other */<br>.column 
  {<br>&nbsp;&nbsp;&nbsp; 
  float: left;<br>&nbsp;&nbsp;&nbsp; width: 33.33%;<br>&nbsp;&nbsp;&nbsp; 
  padding: 50px;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>&nbsp;&nbsp;&nbsp; 
  font-size: 25px;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>}<br><br>.containerTab 
  {<br>&nbsp;&nbsp;&nbsp; padding: 20px;<br>&nbsp;&nbsp;&nbsp; color: white;<br>
  }<br><br>/* Clear floats after the 
  columns */<br>.row:after {<br>&nbsp;&nbsp;&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
  display: table;<br>&nbsp;&nbsp;&nbsp; clear: both;<br>}<br><br>/* Closable button inside the image */<br>.closebtn {<br>&nbsp;&nbsp;&nbsp; 
  float: right;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
...
<div class="w3-code notranslate jsHigh">
  ...
  except for the one that matches the clickable grid column<br>function openTab(tabName) {<br>&nbsp;&nbsp;&nbsp; 
  var i, x;<br>&nbsp;&nbsp;&nbsp; x = document.getElementsByClassName(&quot;containerTab&quot;);<br>&nbsp;&nbsp;&nbsp; 
  for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  x[i].style.display = &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById(tabName).style.display = &quot;block&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_expanding_grid" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
