...
<html lang="en-US">
<head>
<title>How To Add a Class Name</title>
<meta charset="utf-8">
...
<h1>How TO - Add a Class</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_toggle_class.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_remove_class.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add a class name to an element with JavaScript.</p>
<hr>
<button onclick="myFunction()" class="w3-btn w3-dark-grey w3-hover-black" style="box-shadow:none">Add Class</button>
...
<p>Add a class name to the div element with id="myDIV" (in this example we use a button to add the class).</p>
...
<p>Style the specified class name:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>Get the &lt;div&gt; element with id="myDIV" and add the "mystyle" class to it:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function myFunction() {<br>&nbsp;&nbsp;&nbsp; var element = document.getElementById(&quot;myDIV&quot;);<br>
  &nbsp;&nbsp;&nbsp; element.classList.add(&quot;mystyle&quot;);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_add_class" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Cross-browser solution</h2>
<p><strong>Note:</strong> The classList property is not supported in Internet 
Explorer 9. The following code will work in all browsers:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  function myFunction() {<br>&nbsp;&nbsp;&nbsp; var element, name, arr;<br>&nbsp;&nbsp;&nbsp; 
  element = document.getElementById(&quot;myDIV&quot;);<br>&nbsp;&nbsp;&nbsp; name = &quot;mystyle&quot;;<br>&nbsp;&nbsp;&nbsp; 
  arr = element.className.split(&quot; &quot;);<br>&nbsp;&nbsp;&nbsp; if (arr.indexOf(name) 
  == -1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; element.className += &quot; 
  &quot; + name;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_add_class_crossbrowser" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Also see <a href="howto_js_toggle_class.asp">How To Toggle A Class</a>.</p>
...
<p><strong>Tip:</strong> Learn more about the <a href="/jsref/prop_html_classname.asp">className</a> property in our JavaScript Reference.</p>
