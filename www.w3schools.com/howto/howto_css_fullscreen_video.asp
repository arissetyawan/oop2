...
<html lang="en-US">
<head>
<title>How To Create a Fullscreen Video Background</title>
<meta charset="utf-8">
...
<h1>How TO - Fullscreen Video</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_comparison_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_modals.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a full screen video background with CSS.</p>
<hr>

<h2>Fullscreen Video Background</h2>
<p>Learn how to create a full screen video background that covers the entire browser window:</p>
<iframe src="tryhow_css_fullscreen_video.htm" style="border:11px solid #f1f1f1;border-radius:5px;width:100%;height:700px"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_css_fullscreen_video" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Create a Fullscreen Video</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- The video --&gt;<br>&lt;video autoplay muted loop id=&quot;myVideo&quot;&gt;<br>&nbsp; &lt;source src=&quot;rain.mp4&quot; 
  type=&quot;video/mp4&quot;&gt;<br>
  &lt;/video&gt;<br><br>&lt;!-- Optional: some overlay text to describe the video --&gt;<br>
  &lt;div class=&quot;content&quot;&gt;<br>&nbsp; &lt;h1&gt;Heading&lt;/h1&gt;<br>&nbsp; &lt;p&gt;Lorem ipsum...&lt;/p&gt;<br>&nbsp; 
  &lt;!-- Use a button to pause/play the video with JavaScript --&gt;<br>&nbsp; 
  &lt;button id=&quot;myBtn&quot; onclick=&quot;myFunction()&quot;&gt;Pause&lt;/button&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style the video: 100% width and height to cover the entire window */<br>#myVideo {<br>&nbsp;&nbsp;&nbsp; 
  position: fixed;<br>&nbsp;&nbsp;&nbsp; right: 0;<br>&nbsp;&nbsp;&nbsp; bottom: 
  0;<br>&nbsp;&nbsp;&nbsp; min-width: 100%; <br>&nbsp;&nbsp;&nbsp; min-height: 
  100%;<br>}<br><br>/* Add some content at the bottom of the video/page */<br>
  .content {<br>&nbsp;&nbsp;&nbsp; position: fixed;<br>&nbsp;&nbsp;&nbsp; 
  bottom: 0;<br>&nbsp;&nbsp;&nbsp; background: rgba(0, 0, 0, 0.5);<br>&nbsp;&nbsp;&nbsp; 
  color: #f1f1f1;<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; 
  padding: 20px;<br>}<br><br>/* Style the button used to pause/play the video */<br>#myBtn {<br>&nbsp;&nbsp;&nbsp; width: 200px;<br>&nbsp;&nbsp;&nbsp; 
  font-size: 18px;<br>&nbsp;&nbsp;&nbsp; padding: 10px;<br>&nbsp;&nbsp;&nbsp; 
  border: none;<br>&nbsp;&nbsp;&nbsp; background: #000;<br>&nbsp;&nbsp;&nbsp; 
  color: #fff;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>}<br><br>#myBtn:hover 
  {<br>&nbsp;&nbsp;&nbsp; background: #ddd;<br>&nbsp;&nbsp;&nbsp; color: black;<br>
  }</div>
</div>
<hr>
...
<p>Optionally, you can add JavaScript to pause/play the video with a click of a button:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script&gt;<br>// Get the video<br>var video = document.getElementById(&quot;myVideo&quot;);<br>
  <br>// Get the button<br>var 
  btn = document.getElementById(&quot;myBtn&quot;);<br><br>// Pause and play the 
  video, and change the button text<br>function myFunction() {<br>&nbsp;&nbsp;&nbsp; if (video.paused) 
  {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; video.play();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; btn.innerHTML = &quot;Pause&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; video.pause();<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  btn.innerHTML = &quot;Play&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_fullscreen_video" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
