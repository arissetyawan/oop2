...
<h1>How TO - Create a Draggable HTML Element</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_media_query_breakpoints.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_media_queries.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a draggable HTML element with JavaScript and CSS.</p>
<hr>
...
<h2>Create a Draggable DIV Element</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Draggable DIV --&gt;<br>&lt;div id=&quot;mydiv&quot;&gt;<br>&nbsp; &lt;!-- Include a header 
  DIV with the same name as the draggable DIV, followed by "header" --&gt;<br>&nbsp; &lt;div id=&quot;mydivheader&quot;&gt;Click 
  here to move&lt;/div&gt;<br>&nbsp; &lt;p&gt;Move&lt;/p&gt;<br>&nbsp; &lt;p&gt;this&lt;/p&gt;<br>&nbsp; 
  &lt;p&gt;DIV&lt;/p&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>The only important style is <code class="w3-codespan">position: absolute</code>, 
the rest is up to you:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  #mydiv {<br>&nbsp; &nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; z-index: 9;<br>&nbsp;&nbsp;&nbsp; background-color: #f1f1f1;<br>&nbsp;&nbsp;&nbsp; border: 1px solid #d3d3d3;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>}<br><br>#mydivheader {<br>&nbsp;&nbsp;&nbsp; padding: 10px;<br>&nbsp;&nbsp;&nbsp; cursor: move;<br>&nbsp;&nbsp;&nbsp; z-index: 10;<br>&nbsp;&nbsp;&nbsp; background-color: #2196F3;<br>&nbsp;&nbsp;&nbsp; color: #fff;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  // Make the DIV element draggable:<br>dragElement(document.getElementById(&quot;mydiv&quot;));<br>
  <br>function dragElement(elmnt) {<br>&nbsp; var pos1 = 0, pos2 = 0, pos3 = 0, 
  pos4 = 0;<br>&nbsp; if (document.getElementById(elmnt.id + &quot;header&quot;)) {<br>&nbsp;&nbsp;&nbsp; 
  ...
  } else {<br>&nbsp;&nbsp;&nbsp; // otherwise, move the DIV from anywhere inside 
  the DIV: <br>&nbsp;&nbsp;&nbsp; elmnt.onmousedown = dragMouseDown;<br>&nbsp; 
  }<br><br>&nbsp; function dragMouseDown(e) {<br>&nbsp;&nbsp;&nbsp; e = e || 
  window.event;<br>&nbsp;&nbsp;&nbsp; e.preventDefault();<br>&nbsp;&nbsp;&nbsp; // get the mouse cursor position at 
  startup:<br>&nbsp;&nbsp;&nbsp; pos3 = e.clientX;<br>&nbsp;&nbsp;&nbsp; pos4 = 
  e.clientY;<br>&nbsp;&nbsp;&nbsp; document.onmouseup = closeDragElement;<br>&nbsp;&nbsp;&nbsp; 
  // call a function whenever the cursor moves:<br>&nbsp;&nbsp;&nbsp; 
  document.onmousemove = elementDrag;<br>&nbsp; }<br><br>&nbsp; function 
  elementDrag(e) {<br>&nbsp;&nbsp;&nbsp; e = e || window.event;<br>&nbsp;&nbsp;&nbsp; 
  e.preventDefault();<br>&nbsp;&nbsp;&nbsp; 
  // calculate the new cursor position:<br>&nbsp;&nbsp;&nbsp; pos1 = pos3 - 
  e.clientX;<br>&nbsp;&nbsp;&nbsp; pos2 = pos4 - e.clientY;<br>&nbsp;&nbsp;&nbsp; 
  pos3 = e.clientX;<br>&nbsp;&nbsp;&nbsp; pos4 = e.clientY;<br>&nbsp;&nbsp;&nbsp; 
  // set the element's new position:<br>&nbsp;&nbsp;&nbsp; elmnt.style.top = (elmnt.offsetTop 
  - pos2) + &quot;px&quot;;<br>&nbsp;&nbsp;&nbsp; elmnt.style.left = (elmnt.offsetLeft - 
  pos1) + &quot;px&quot;;<br>&nbsp; }<br><br>&nbsp; function closeDragElement() {<br>&nbsp;&nbsp;&nbsp; 
  // stop moving when mouse button is released:<br>&nbsp;&nbsp;&nbsp; 
  document.onmouseup = null;<br>&nbsp;&nbsp;&nbsp; document.onmousemove = null;<br>&nbsp; 
  }<br>}<br></div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_draggable" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
