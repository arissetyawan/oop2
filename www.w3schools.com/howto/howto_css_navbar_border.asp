...
<html lang="en-US">
<head>
<title>How To - Bottom Border Nav Links</title>
<meta charset="utf-8">
...
<h1>How TO - Bottom Border Nav Links</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_bottom_nav_responsive.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_topnav_right.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create bottom bordered (underline) navigation links with CSS.</p>
<hr>
<h2>Bottom Border Nav Links</h2>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_navbar_border" class="w3-btn">Try it Yourself &raquo;</a></p>
...
Style the links inside the navigation bar */<br>.topnav a {<br>&nbsp;&nbsp;&nbsp; 
  ...
  .topnav a:hover {<br>&nbsp;&nbsp;&nbsp; border-bottom: 3px solid red;<br>}<br><br>.topnav 
  a.active {<br>&nbsp;&nbsp;&nbsp; border-bottom: 3px solid red;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_navbar_border" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
