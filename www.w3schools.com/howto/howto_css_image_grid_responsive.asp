...
<html lang="en-US">
<head>
<title>How To Create a Responsive Image Grid</title>
<meta charset="utf-8">
...
<h1>How TO - Responsive Image Grid</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_lightbox.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_image_grid.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a Responsive Image Grid.</p>
<hr>

<h2>Responsive Image Grid</h2>
<p>Learn how to create an image gallery that varies between four, two or full-width images, depending on screen size:</p>
<iframe src="tryhow_css_image_grid_responsive.htm" style="border:3px solid #f1f1f1;width:100%;height:600px;padding-bottom:10px"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_image_grid_responsive" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .row {<br>&nbsp; display: flex;<br>&nbsp; flex-wrap: wrap;<br>&nbsp; padding: 0 4px;<br>}<br><br>/* 
  Create four equal columns that sits next to each other */<br>.column {<br>&nbsp; flex: 25%;<br>&nbsp; max-width: 25%;<br>&nbsp; 
  padding: 0 4px;<br>}<br><br>.column img {<br>&nbsp; margin-top: 8px;<br>&nbsp; 
  vertical-align: middle;<br>}<br><br>/* Responsive layout - makes a two 
  column-layout instead of four columns */<br>@media screen and (max-width: 800px) {<br>&nbsp; 
  .column {<br>&nbsp;&nbsp;&nbsp; flex: 
  50%;<br>&nbsp;&nbsp;&nbsp; max-width: 50%;<br>&nbsp; }<br>}<br><br>/* 
  Responsive layout - makes the two columns stack on top of each other instead 
  of next to each other */<br>@media screen and (max-width: 600px) {<br>&nbsp; .column {<br>
  &nbsp;&nbsp;&nbsp; flex: 100%;<br>&nbsp;&nbsp;&nbsp; 
  max-width: 100%;<br>&nbsp; }<br>}</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_css_image_grid_responsive" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-note w3-panel">
<p><strong>Tip:</strong> Go to our <a href="howto_js_image_grid.asp">Image Grid Tutorial</a> to learn how to create a clickable grid that varies between columns.</p>
