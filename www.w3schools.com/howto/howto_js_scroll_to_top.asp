...
<html lang="en-US">
<head>
<title>How To Create a Scroll Back To Top Button</title>
<meta charset="utf-8">
...
<h1>How TO - Scroll Back To Top Button</h1>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="howto_css_round_buttons.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_login_form.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a "scroll back to top" button with CSS.</p>
<hr>
<iframe src="tryhow_js_scroll_to_top.htm" class="w3-border w3-border-light-grey" style="width:100%;border:none;height:200px;padding:3px 0 12px 0"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_scroll_to_top" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Scroll To Top Button</h2>
...
<div class="w3-code notranslate cssHigh">
  #myBtn {<br>&nbsp;&nbsp;&nbsp; display: none; /* Hidden by default */<br>&nbsp;&nbsp;&nbsp; 
  position: fixed; /* Fixed/sticky position */<br>&nbsp;&nbsp;&nbsp; bottom: 20px; 
  /* Place the button at the bottom of the page */<br>&nbsp;&nbsp;&nbsp; 
  right: 30px; /* Place the button 30px from the right */<br>&nbsp;&nbsp;&nbsp; z-index: 99; 
  /* Make sure it does not overlap */<br>&nbsp;&nbsp;&nbsp; border: 
  none; /* Remove borders */<br>&nbsp;&nbsp;&nbsp; outline: none; /* Remove 
  outline */<br>&nbsp;&nbsp;&nbsp; 
  background-color: red; /* Set a background color */<br>&nbsp;&nbsp;&nbsp; color: white; 
  /* Text color */<br>&nbsp;&nbsp;&nbsp; 
  cursor: pointer; /* Add a mouse pointer on hover */<br>&nbsp;&nbsp;&nbsp; padding: 
  15px; 
  /* Some padding */<br>&nbsp;&nbsp;&nbsp; 
  border-radius: 10px; /* Rounded corners */<br>&nbsp;&nbsp;&nbsp; font-size: 
  18px; /* Increase font size */<br>}<br><br>#myBtn:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #555; /* Add a dark-grey background on hover */<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  button<br>window.onscroll = function() {scrollFunction()};<br><br>function 
  scrollFunction() {<br>&nbsp;&nbsp;&nbsp; if (document.body.scrollTop &gt; 20 || 
  document.documentElement.scrollTop &gt; 20) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  document.getElementById(&quot;myBtn&quot;).style.display = &quot;block&quot;;<br>&nbsp;&nbsp;&nbsp; 
  } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myBtn&quot;).style.display 
  = &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br><br>// When the user clicks on the 
  button, scroll to the top of the document<br>function topFunction() {<br>&nbsp;&nbsp;&nbsp; 
  document.body.scrollTop = 0; // For Safari<br>&nbsp;&nbsp;&nbsp; 
  document.documentElement.scrollTop = 0; // For Chrome, Firefox, IE and Opera<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_scroll_to_top" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
