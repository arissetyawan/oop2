...
<html lang="en-US">
<head>
<title>How To Create an Off-Canvas Menu</title>
<meta charset="utf-8">
...
<h1>How TO - Off-Canvas Menu</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_fullscreen_overlay.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_sidenav_buttons.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an off-canvas menu.</p>
<hr>
...
<a href="javascript:void(0)">About</a>
  ...
  <button class="w3-btn w3-dark-grey w3-padding w3-margin-bottom" onclick="openOffcanvas()">Open Off-Canvas Menu</button><br>
  <button class="w3-btn w3-dark-grey w3-padding w3-margin-bottom" onclick="openNav3();openOffcanvas()">Off-Canvas Menu w/opacity</button><br>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav_push" class="w3-btn">Try it Yourself &raquo;</a>

<hr>

<h2>Create an Off-Canvas Menu</h2>
...
<div class="w3-example">
<h3>Off-Canvas Menu w/ opacity</h3>
<div class="w3-code notranslate jsHigh">
/* Set the width of the side navigation to 250px and the left margin of the 
