...
<html lang="en-US">
<head>
<title>How To Align Images Side By Side</title>
<meta charset="utf-8">
...
<h1>How TO - Align Images Side By Side</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_bg_change_scroll.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_rounded_images.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to align images side by side with CSS.</p>
<hr>

<h2>Side-by-Side Image Gallery</h2>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_images_side_by_side" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Place Images Side by Side</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class="row"&gt;<br>&nbsp; &lt;div class="column"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;img 
  src="img_snow.jpg" alt="Snow" style="width:100%"&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; 
  &lt;div class="column"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;img src="img_forest.jpg" 
  alt="Forest" style="width:100%"&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div 
  class="column"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;img src="img_mountains.jpg" 
  alt="Mountains" style="width:100%"&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>

<hr>
<h5>Step 2) Add CSS:</h5>
<p>How to create side-by-side images with the CSS <code class="w3-codespan">float</code> property:</p>
<div class="w3-example">
<h3>Float Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Three image containers (use 25% for four, and 50% for two, etc) */<br>
  .column {<br>&nbsp; float: left;<br>&nbsp; width: 33.33%;<br>&nbsp; padding: 
  5px;<br>}<br><br>/* Clear floats after image containers */<br>.row::after {<br>&nbsp; 
  content: "";<br>&nbsp; clear: both;<br>&nbsp; display: table;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_images_side_by_side" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>How to create side-by-side images with the CSS <code class="w3-codespan">flex</code> property:</p>
<div class="w3-example">
<h3>Flexbox Example</h3>
<div class="w3-code notranslate cssHigh">
  .row {<br>&nbsp; display: flex;<br>}<br><br>.column {<br>&nbsp; flex: 33.33%;<br>&nbsp; padding: 
  5px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_images_side_by_side2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-note w3-panel">
<p><strong>Note:</strong> Flexbox is not supported in Internet Explorer 10 and earlier versions. It is up to you if you want to use floats or flex to create a three-column layout. However, if you need support for IE10 and down, you should use float.</p>
...
<h2>Add Responsiveness</h2>
<p>Optionally, you could add media queries to make the images stack on top of each other instead of floating next to each other, on a specific screen width.</p>
<p>The following example will stack the images vertically on screens that are 500px wide or less:</p>
<div class="w3-example">
<h3>Responsive Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Responsive layout - makes the three columns stack on top of each other 
  instead of next to each other */<br>@media screen and (max-width: 500px) {<br>&nbsp; 
  .column {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_images_side_by_side_resp" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-note w3-panel">
<p>To learn more about media queries, read our <a href="/css/css3_mediaqueries.asp">CSS Media Queries Tutorial</a>.</p>
</div>
<hr>

<h2>Related Pages</h2>
<p>To learn more about how to style images, read our <a href="/css/css3_images.asp">CSS Images Tutorial</a>.</p>
<p>To learn more about CSS Float, read our <a href="/css/css_float.asp">CSS Float Tutorial</a>.</p>
<p>To learn how to create an image gallery with CSS, read our <a href="/css/css_image_gallery.asp">CSS Image Gallery Tutorial</a>.</p>
