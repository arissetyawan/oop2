...
<html lang="en-US">
<head>
<title>How To Add Active Class To Current Element</title>
<meta charset="utf-8">
...
<h1>How TO - Add Active Class to Current Element</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_remove_class.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_treeview.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add an active class to the current element with JavaScript.</p>
<hr>

<p>Highlight the active/current (pressed) button:</p>
<div id="myDIV">
  <button class="btn">1</button>
  <button class="btn activehr">2</button>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_active_element" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>
...
<div class="w3-code notranslate htmlHigh">
  &lt;div id=&quot;myDIV&quot;&gt;<br>&nbsp; &lt;button class=&quot;btn&quot;&gt;1&lt;/button&gt;<br>&nbsp; &lt;button 
  class=&quot;btn active&quot;&gt;2&lt;/button&gt;<br>&nbsp; &lt;button class=&quot;btn&quot;&gt;3&lt;/button&gt;<br>&nbsp; 
  &lt;button class=&quot;btn&quot;&gt;4&lt;/button&gt;<br>&nbsp; &lt;button class=&quot;btn&quot;&gt;5&lt;/button&gt;<br>
  &lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style the buttons */<br>.btn {<br>&nbsp; border: none;<br>&nbsp; outline: 
  none;<br>&nbsp; padding: 10px 16px;<br>&nbsp; background-color: #f1f1f1;<br>&nbsp; 
  cursor: pointer;<br>}<br><br>/* Style the active class (and buttons on 
  mouse-over) */<br>.active, .btn:hover {<br>&nbsp; background-color: #666;<br>&nbsp; 
  color: white;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  // Get the container element<br>var btnContainer = document.getElementById(&quot;myDIV&quot;);<br>
  <br>// Get all buttons with class=&quot;btn&quot; inside the container<br>var btns = 
  btnContainer.getElementsByClassName(&quot;btn&quot;);<br><br>// Loop through 
  the buttons and add the active class to the current/clicked button<br>for (var i = 0; i &lt; btns.length; 
  ...
  this.className += &quot; active&quot;;<br>&nbsp; });<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_active_element" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>If you do not have an active class set on the button element to start with, use the following code:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  // Get the container element<br>var btnContainer = document.getElementById(&quot;myDIV&quot;);<br>
  ...
  the buttons and add the active class to the current/clicked button<br>for (var i = 0; i &lt; btns.length; 
  i++) {<br>&nbsp; btns[i].addEventListener(&quot;click&quot;, function() {<br>&nbsp;&nbsp;&nbsp; 
  var current = document.getElementsByClassName(&quot;active&quot;);<br><br>&nbsp;&nbsp;&nbsp; 
  // If there's no active class<br>&nbsp;&nbsp;&nbsp; if (current.length &gt; 0) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  current[0].className = current[0].className.replace(&quot; active&quot;, &quot;&quot;);<br>&nbsp;&nbsp;&nbsp; 
  }<br><br>&nbsp;&nbsp;&nbsp; // Add the active class to the current/clicked 
  button<br>&nbsp;&nbsp;&nbsp; 
  this.className += &quot; active&quot;;<br>&nbsp; });<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_active_element2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
