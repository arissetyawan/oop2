...
<html lang="en-US">
<head>
<title>How To Create a Countdown Timer</title>
<meta charset="utf-8">
...
<h1>How TO - JavaScript Countdown Timer</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_animate_icons.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_typewriter.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a countdown timer with JavaScript.</p>
<hr>
...
<p id="countdown1" style="font-size:64px;font-family:arial" class="w3-center"></p>
 <a class="w3-btn" href="tryit.asp?filename=tryhow_js_countdown" target="_blank">Try it Yourself &raquo;</a>
<hr>

<h2>Creating a Countdown Timer</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Display the countdown timer in an element --&gt;<br>&lt;p id=&quot;demo&quot;&gt;&lt;/p&gt;<br><br>&lt;script&gt;<br>// Set the date we're counting down to<br>
  ...
  <br>&nbsp; // Find the distance between now and the count down date<br>&nbsp; 
  ...
  % (1000 * 60)) / 1000);<br><br>&nbsp; // Display the result in the element with 
  ...
  = &quot;EXPIRED&quot;;<br>&nbsp; }<br>}, 1000);<br>
  &lt;/script&gt;<br></div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_countdown" target="_blank">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Learn more about the <a href="/jsref/met_win_setinterval.asp">window.setInterval()</a> method in our JavaScript Reference.</p>
