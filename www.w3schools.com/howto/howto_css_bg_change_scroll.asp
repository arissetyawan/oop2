...
<html lang="en-US">
<head>
<title>How To Change Background Image on Scroll</title>
<meta charset="utf-8">
...
<h1>How TO - Change Background on Scroll</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_blurred_background.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_images_side_by_side.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to change background images on scroll with CSS.</p>
<hr>
<h2>Change Background Image on Scroll</h2>
<p>Scroll down inside the frame to see the effect:</p>
<iframe src="tryhow_css_bg_change_scroll.htm" style="width:100%;border:2px solid #f1f1f1;height:500px;"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_bg_change_scroll" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Change Background Image on Scroll</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;bg-image img1&quot;&gt;&lt;/div&gt;<br>&lt;div class=&quot;bg-image img2&quot;&gt;&lt;/div&gt;<br>&lt;div 
  class=&quot;bg-image img3&quot;&gt;&lt;/div&gt;<br>&lt;div class=&quot;bg-image img4&quot;&gt;&lt;/div&gt;<br>&lt;div 
  class=&quot;bg-image img5&quot;&gt;&lt;/div&gt;<br>&lt;div class=&quot;bg-image img6&quot;&gt;&lt;/div&gt;<br><br>&lt;div 
  class=&quot;bg-text&quot;&gt;TEXT&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  body, html {<br>&nbsp; height: 100%;<br>&nbsp; margin: 0;<br>&nbsp; 
  font-family: Arial, Helvetica, sans-serif;<br>}<br><br>* {<br>&nbsp; box-sizing: border-box;<br>}<br><br>.bg-image {<br>&nbsp; 
  /* Full height */<br>&nbsp; height: 50%; <br><br>&nbsp; /* Center and scale 
  the image nicely */<br>&nbsp; background-position: center;<br>&nbsp; 
  background-repeat: no-repeat;<br>&nbsp; background-size: cover;<br>}<br><br>/* Images used */<br>.img1 { 
  background-image: url(&quot;img_snow.jpg&quot;); }<br>.img2 { background-image: url(&quot;img_girl.jpg&quot;); 
  }<br>.img3 { background-image: url(&quot;img_lights.jpg&quot;); }<br>.img4 { 
  background-image: url(&quot;img_nature.jpg&quot;); }<br>.img5 { background-image: url(&quot;img_forest.jpg&quot;); 
  }<br>.img6 { background-image: url(&quot;img_woods.jpg&quot;); }<br><br>/* Position text 
  in the middle of the page/image */<br>.bg-text {<br>&nbsp; background-color: rgb(0,0,0); 
  /* Fallback color */<br>&nbsp; background-color: rgba(0,0,0, 0.4); /* Black 
  w/opacity/see-through */<br>&nbsp; color: white;<br>&nbsp; font-weight: bold;<br>&nbsp; 
  font-size: 80px;<br>&nbsp; border: 10px solid #f1f1f1;<br>&nbsp; position: 
  fixed; /* Stay fixed */<br>&nbsp; top: 50%;<br>&nbsp; left: 50%;<br>&nbsp; transform: 
  translate(-50%, -50%);<br>&nbsp; z-index: 2;<br>&nbsp; width: 300px;<br>&nbsp; 
  padding: 20px;<br>&nbsp; text-align: center;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_bg_change_scroll" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
