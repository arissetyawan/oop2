...
<h1>How TO - Center Website</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_website_bootstrap4.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_contact_section.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to center your website horizontally with CSS.</p>
<hr>

<h2>Center Website</h2>
<p>Learn how to center your website horizontally:</p>
<div class="w3-black">
<div class="w3-content w3-dark-grey w3-padding" style="max-width:500px">
  <h4>This example is horizontally centered on screens that are wider than 500 pixels.</h4>
</div>
</div>
<hr>

<h2>How To Center Your Website</h2>
<p>Use a container element and set a specific <code class="w3-codespan">max-width</code>. A common width many websites use is 960px. To actually center the page, 
add <code class="w3-codespan">margin: auto</code>.</p>
<p>The following example will center the website on screens that are wider than 
500px. On screens that are less than 500px 
wide, it will span the whole of the page:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>.content {<br>&nbsp;&nbsp;&nbsp; max-width: 500px;<br>&nbsp;&nbsp;&nbsp; 
  margin: auto;<br>}<br>&lt;/style&gt;<br>
  &lt;body&gt;<br><br>&lt;div class=&quot;content&quot;&gt;<br>&nbsp; &lt;!-- Page content --&gt;<br>&lt;/div&gt;<br><br>&lt;/body&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_center_website" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
