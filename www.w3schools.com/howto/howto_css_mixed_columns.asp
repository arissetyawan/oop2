...
<html lang="en-US">
<head>
<title>How To Create a Mixed Column Layout</title>
<meta charset="utf-8">
...
<h1>How TO - Mixed Column Layout</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_list_grid_view.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_column_cards.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a mixed column layout grid with CSS.</p>
<hr>
<p>Learn how to create a responsive column layout that varies between 4 columns, 2 columns and full-width columns depending on screen width.</p>
<p><strong>Resize</strong> the browser window to see the responsive effect:</p>
<iframe src="tryhow_css_mixed_columns_ifr.htm" style="width:100%;border:3px solid #ddd;height:206px"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_mixed_columns" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Create a Mixed Column Layout</h2>
...
<p>In this example, we will create a four column layout that will transform to 
...
floating next to each other.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Create four equal columns that floats next to each other */<br>.column {<br>&nbsp;&nbsp;&nbsp; 
  float: left;<br>&nbsp;&nbsp;&nbsp; width: 25%;<br>}<br><br>/* Clear floats */<br>
  .row:after {<br>&nbsp;&nbsp;&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
  display: table;<br>&nbsp;&nbsp;&nbsp;&nbsp; clear: both;<br>}<br><br>/* Responsive layout - makes a two column-layout 
  instead of four columns */<br>@media screen and (max-width: 900px) {<br>&nbsp;&nbsp;&nbsp; 
  .column {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width: 50%;<br>&nbsp;&nbsp;&nbsp; 
  }<br>}<br><br>/* Responsive layout - makes the two columns 
  stack on top of each other instead of next to each other */<br>@media 
  screen and (max-width: 600px) {<br>&nbsp;&nbsp;&nbsp; .column {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_mixed_columns" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
