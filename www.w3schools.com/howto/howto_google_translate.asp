...
<html lang="en-US">
<head>
<title>How To Google Translate</title>
<meta charset="utf-8">
...
<h1>How TO - Google Translate</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_google_maps_bw.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_google_charts.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add a Google Translate button on your web page.</p>
<hr>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-white notranslate">
<iframe style="width:100%;height:250px;border:none;" scrolling="no" src="tryhow_google_translate.htm"></iframe>
</div>
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryhow_google_translate" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Google Translate Button</h2>
<p>Start with a simple basic web page.</p>
<p>Add a &lt;div&gt; element with the id "google_translate_element":</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_google_translate_basic" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>Add a reference to the translate API at google.com:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<p>Add a javascript function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;script type=&quot;text/javascript&quot;&gt;<br>function googleTranslateElementInit() {<br>
 new google.translate.TranslateElement({pageLanguage: 'en'}, 'google_translate_element');<br>
 }<br>&lt;/script&gt;</div>
</div>

<p>And you are ready to translate the content of your page:</p>
<div class="w3-example">
<h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
     &lt;!DOCTYPE html&gt;<br>&lt;html lang=&quot;en-US&quot;&gt;<br>&lt;body&gt;<br><br>&lt;h1&gt;My Web  Page&lt;/h1&gt;<br><br>&lt;p&gt;Hello everybody!&lt;/p&gt;<br><br>&lt;p&gt;Translate this page:&lt;/p&gt;<br>
  <br>&lt;div id=&quot;google_translate_element&quot;&gt;&lt;/div&gt;<br><br>&lt;script type=&quot;text/javascript&quot;&gt;<br>
  function googleTranslateElementInit() {<br>new  google.translate.TranslateElement({pageLanguage: 'en'}, 'google_translate_element');<br>
  }<br>&lt;/script&gt;<br><br>&lt;script type=&quot;text/javascript&quot; src=&quot;//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit&quot;&gt;&lt;/script&gt;<br>
  <br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_google_translate" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>There are currently three different design modes for the Google Translate 
button.</p>
...
<p>Vertically:</p>
<div class="w3-code notranslate htmlHigh">
  <iframe style="width:100%;height:60px;border:none;" scrolling="no" src="tryhow_google_translate_vertically.htm"></iframe>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_google_translate_vertically" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>Horizontally:</p>
<div class="w3-code notranslate htmlHigh">
  <iframe style="width:100%;height:50px;border:none;" scrolling="no" src="tryhow_google_translate_horizontally.htm"></iframe>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_google_translate_horizontally" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
<p>A dropdown menu, with no other text:</p>
<div class="w3-code notranslate htmlHigh">
  <iframe style="width:100%;height:50px;border:none;" scrolling="no" src="tryhow_google_translate_dropdown.htm"></iframe>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_google_translate_dropdown" target="_blank">Try it Yourself &raquo;</a>
</div>
