...
<html lang="en-US">
<head>
<title>How To Create a Blurred Background Image</title>
<meta charset="utf-8">
...
<h1>How TO - Blurred Background Image</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_hero_image.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_bg_change_scroll.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a blurry background image with CSS.</p>
<hr>
<h2>Blur Background Image</h2>
<p><strong>Note:</strong> This example does not work in Edge 12, IE 11 or earlier versions.</p>
<iframe src="tryhow_css_blurred_bg_ifr.htm" style="width:100%;border:2px solid #f1f1f1;height:400px;"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_blurred_bg" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Blurry Background Image</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;bg-image&quot;&gt;&lt;/div&gt;<br><br>&lt;div class=&quot;bg-text&quot;&gt;<br>&nbsp; &lt;h1&gt;I am 
  John Doe&lt;/h1&gt;<br>&nbsp; &lt;p&gt;And I'm a Photographer&lt;/p&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  body, html {<br>&nbsp; height: 100%;<br>}<br><br>* {<br>&nbsp; box-sizing: border-box;<br>}<br><br>
  .bg-image {<br>&nbsp; /* The image used */<br>&nbsp; background-image: url(&quot;photographer.jpg&quot;);<br>
  <br>&nbsp; /* Add the blur effect */<br>&nbsp; filter: blur(8px);<br>&nbsp; -webkit-filter: 
  blur(8px);<br><br>&nbsp; /* Full height */<br>&nbsp; height: 100%; <br><br>&nbsp; 
  /* Center and scale the image nicely */<br>&nbsp; background-position: center;<br>&nbsp; 
  background-repeat: no-repeat;<br>&nbsp; background-size: cover;<br>}<br><br>/* 
  Position text in the middle of the page/image */<br>
  .bg-text {<br>&nbsp; background-color: rgb(0,0,0); /* Fallback color */<br>&nbsp; 
  background-color: rgba(0,0,0, 0.4); /* Black w/opacity/see-through */<br>&nbsp; color: white;<br>&nbsp; 
  font-weight: bold;<br>&nbsp; border: 3px solid #f1f1f1;<br>&nbsp; position: 
  absolute;<br>&nbsp; top: 50%;<br>&nbsp; left: 50%;<br>&nbsp; transform: 
  translate(-50%, -50%);<br>&nbsp; z-index: 2;<br>&nbsp; width: 80%;<br>&nbsp; 
  padding: 20px;<br>&nbsp; text-align: center;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_blurred_bg" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
