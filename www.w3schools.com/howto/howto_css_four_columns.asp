...
<html lang="en-US">
<head>
<title>How To Create a Four Column Layout</title>
<meta charset="utf-8">
...
<h1>How TO - Four Column Layout</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_three_columns.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_expanding_grid.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a 4-column layout grid with CSS.</p>
<hr>

<div class="w3-row">
<div class="w3-col s3" style="height:320px;padding:20px;background-color:#bbb">
<div class="w3-hide-small">
<h2>Column 1</h2>
<p>Some text..</p>
</div>
</div>
<div class="w3-col s3" style="height:320px;padding:20px;background-color:#ccc">
<div class="w3-hide-small">
<h2>Column 2</h2>
<p>Some text..</p>
</div>
</div>
<div class="w3-col s3" style="height:320px;padding:20px;background-color:#ddd">
<div class="w3-hide-small">
<h2>Column 3</h2>
<p>Some text..</p>
</div>
</div>
<div class="w3-col s3" style="height:320px;padding:20px;background-color:#eee">
<div class="w3-hide-small">
<h2>Column 4</h2>
<p>Some text..</p>
</div>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_four_columns" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Create a Four Column Layout</h2>
...
<p>In this example, we will create four column layout:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .column {<br>&nbsp;&nbsp;&nbsp; 
  float: left;<br>&nbsp;&nbsp;&nbsp; width: 25%;<br>}<br><br>/* Clear floats after the 
  columns */<br>.row:after {<br>&nbsp;&nbsp;&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
  display: table;<br>&nbsp;&nbsp;&nbsp; clear: both;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_four_columns" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>In this example, we will create a <strong>responsive</strong> four column layout:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  ...
  width: 100%;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_four_columns_responsive" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
