...
<title>How To Detect Caps Lock</title>
<meta charset="utf-8">
...
<h1>How TO - Detect Caps Lock</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_display_checkbox_text.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_trigger_button_enter.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to find out if capslock is on inside an input field with JavaScript.</p>
<hr>

<h2>Detect if Caps Lock is On</h2>
<p>Try to press the "Caps Lock" key inside the input field:</p>
<input id="myInputx" value="Some text..">
<p id="capsWarning">WARNING! Caps lock is ON.</p>

<script>
var xinput = document.getElementById("myInputx");
...
<div class="w3-code notranslate jsHigh">
  // Get the input field<br>var input = document.getElementById(&quot;myInput&quot;);<br>
  <br>// Get the warning text<br>var text = document.getElementById(&quot;text&quot;);<br>
  <br>// When the user presses any key on the keyboard, run the function<br>
  input.addEventListener(&quot;keyup&quot;, function(event) {<br><br>&nbsp; // If &quot;caps 
  lock&quot; is pressed, display the warning text<br>&nbsp; if (event.getModifierState(&quot;CapsLock&quot;)) 
  {<br>&nbsp;&nbsp;&nbsp; text.style.display = &quot;block&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  text.style.display = &quot;none&quot;<br>&nbsp; }<br>});</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_detect_capslock" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Read more about the getModifierState() method in our <a href="/jsref/event_mouse_getmodifierstate.asp">JavaScript Event Reference - getModifierState()</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_display_checkbox_text.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_trigger_button_enter.asp">Next &#10095;</a>
</div>
</div>
