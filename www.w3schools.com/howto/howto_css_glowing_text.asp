...
<html lang="en-US">
<head>
<title>How To Create a Glowing Text</title>
<meta charset="utf-8">
...
<h1>How TO - Glowing Text</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_cutout_text.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_fixed_footer.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a glowing text with CSS.</p>
<hr>

<iframe src="tryhow_css_glowing_text.htm" style="width:100%;border:3px solid #f1f1f1;height:400px"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_css_glowing_text" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Create a Glowing Text</h2>
<p>Use the <code class="w3-codespan">text-shadow</code> property to create the neon light effect, and then use <code class="w3-codespan">animation</code> together with <code class="w3-codespan">keyframes</code> to add the repeatedly glowing effect:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .glow {<br>&nbsp; font-size: 80px;<br>&nbsp; color: #fff;<br>&nbsp; 
  text-align: center;<br>&nbsp; -webkit-animation: glow 1s ease-in-out infinite 
  alternate;<br>&nbsp; -moz-animation: glow 1s ease-in-out infinite alternate;<br>&nbsp; 
  animation: glow 1s ease-in-out infinite alternate;<br>}<br>
  <br>@-webkit-keyframes glow {<br>&nbsp; from {<br>&nbsp;&nbsp;&nbsp; 
  text-shadow: 0 0 10px #fff, 0 0 20px #fff, 0 0 30px #e60073, 0 0 40px #e60073, 
  0 0 50px #e60073, 0 0 60px #e60073, 0 0 70px #e60073;<br>&nbsp; }<br>&nbsp; to 
  {<br>&nbsp;&nbsp;&nbsp; text-shadow: 0 0 20px #fff, 0 0 30px #ff4da6, 0 0 40px 
  #ff4da6, 0 0 50px #ff4da6, 0 0 60px #ff4da6, 0 0 70px #ff4da6, 0 0 80px 
  #ff4da6;<br>&nbsp; }<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_glowing_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
