...
<html lang="en-US">
<head>
<title>How To Create Popups</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="howto_css_tooltip.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_collapsible.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create popups with CSS and JavaScript.</p>
<hr>

<div class="popup w3-text-blue" onclick="myFunction()">Click me to toggle the popup!
  <span class="popuptext" id="myPopup">A Simple Popup!</span>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_popup" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create Popups</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;popup&quot; onclick=&quot;myFunction()&quot;&gt;Click me!<br>&nbsp; &lt;span class=&quot;popuptext&quot; 
id=&quot;myPopup&quot;&gt;Popup text...&lt;/span&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
/* Popup container */<br>.popup {<br>&nbsp;&nbsp;&nbsp; 
position: relative;<br>&nbsp;&nbsp;&nbsp; display: inline-block;<br>&nbsp;&nbsp;&nbsp; 
cursor: pointer;<br>}<br><br>/* The actual popup (appears on top) 
*/<br>.popup .popuptext 
{<br>&nbsp;&nbsp;&nbsp; visibility: hidden;<br>&nbsp;&nbsp;&nbsp; width: 
160px;<br>&nbsp;&nbsp;&nbsp; background-color: #555;<br>&nbsp;&nbsp;&nbsp; 
color: #fff;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>&nbsp;&nbsp;&nbsp; 
border-radius: 6px;<br>&nbsp;&nbsp;&nbsp; padding: 8px 0;<br>&nbsp;&nbsp;&nbsp; 
position: absolute;<br>&nbsp;&nbsp;&nbsp; z-index: 1;<br>&nbsp;&nbsp;&nbsp; 
bottom: 125%;<br>&nbsp;&nbsp;&nbsp; left: 50%;<br>&nbsp;&nbsp;&nbsp; 
margin-left: -80px;<br>}<br><br>/* Popup arrow */<br>.popup .popuptext::after {<br>&nbsp;&nbsp;&nbsp; 
content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
top: 100%;<br>&nbsp;&nbsp;&nbsp; left: 50%;<br>&nbsp;&nbsp;&nbsp; 
margin-left: -5px;<br>&nbsp;&nbsp;&nbsp; border-width: 5px;<br>&nbsp;&nbsp;&nbsp; 
border-style: solid;<br>&nbsp;&nbsp;&nbsp; border-color: #555 transparent 
transparent transparent;<br>}<br><br>/* 
Toggle this class when clicking on the popup container (hide and show the 
popup) */<br>.popup .show {<br>&nbsp;&nbsp;&nbsp; 
visibility: visible;<br>&nbsp;&nbsp;&nbsp; -webkit-animation: 
fadeIn 1s;<br>&nbsp;&nbsp;&nbsp; animation: fadeIn 1s<br>}<br><br>/* Add animation (fade in the popup) */<br>
@-webkit-keyframes fadeIn {<br>&nbsp;&nbsp;&nbsp; from {opacity: 0;} <br>&nbsp;&nbsp;&nbsp; to {opacity: 1;}<br>}<br>
<br>@keyframes fadeIn {<br>&nbsp;&nbsp;&nbsp; from {opacity: 0;}<br>&nbsp;&nbsp;&nbsp; 
to {opacity:1 ;}<br>}</div>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script&gt;<br>// When the user clicks on &lt;div&gt;, open the popup<br>function 
myFunction() {<br>&nbsp;&nbsp;&nbsp; var popup = document.getElementById(&quot;myPopup&quot;);<br>&nbsp;&nbsp;&nbsp; 
popup.classList.toggle(&quot;show&quot;);<br>}<br>&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_popup" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>

<p><strong>Tip:</strong> Tooltips are similar to popups. Go to our <a href="howto_css_tooltip.asp">How To Create Tooltips Tutorial</a> to learn about 
tooltips.</p>
<p><strong>Tip:</strong> Modals are also similar to popups. Go to our <a href="howto_css_modals.asp">How To Create Modals Tutorial</a> to learn about 
modals.</p>
