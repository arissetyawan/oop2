...
<html lang="en-US">
<head>
<title>How To Create Equal Width Menu Links</title>
<meta charset="utf-8">
...
<h1>How TO - Equal Width Navbar Links</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_topnav_centered.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_fixed_menu.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a navigation bar with equal-width navigation links.</p>
<hr>
<h2>Equal Width Menu</h2>

<div class="navbarx">
  <a class="activexx" href="javascript:void(0)">Home</a> 
  <a href="javascript:void(0)">Search</a> 
  <a href="javascript:void(0)">Contact</a> 
  <a href="javascript:void(0)">Login</a>
</div>

<p><a target="_blank" href="tryit.asp?filename=tryhow_css_topnav_equal_width" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create a Responsive Navigation Bar</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- The navigation menu --&gt;<br>&lt;div class=&quot;navbar&quot;&gt;<br>&nbsp; &lt;a class=&quot;active&quot; href=&quot;#&quot;&gt;Home&lt;/a&gt; <br>&nbsp; &lt;a href=&quot;#&quot;&gt;Search&lt;/a&gt; <br>&nbsp; &lt;a href=&quot;#&quot;&gt;Contact&lt;/a&gt; <br>&nbsp; &lt;a href=&quot;#&quot;&gt;Login&lt;/a&gt;<br>
  &lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style the navigation menu */<br>.navbar {<br>&nbsp; width: 100%;<br>&nbsp; background-color: #555;<br>&nbsp; 
  overflow: auto;<br>}<br><br>/* Navigation links */<br>.navbar a {<br>&nbsp; float: left;<br>&nbsp; padding: 12px;<br>&nbsp; 
  color: white;<br>&nbsp; text-decoration: none;<br>&nbsp; font-size: 17px;<br>&nbsp; 
  width: 25%; /* Four equal-width links. If you have two links, use 50%, and 
  33.33% for three links, etc.. */<br>&nbsp; text-align: center; /* If you want 
  the text to be centered */<br>}<br><br>/* Add a background color on mouse-over 
  */<br>.navbar a:hover {<br>&nbsp; background-color: #000;<br>}<br>
  <br>/* Style the current/active link */<br>
  .navbar a.active {<br>&nbsp; background-color: #4CAF50;<br>}<br><br>/* Add 
  responsiveness - on screens less than 500px, make the navigation links appear 
  on top of each other, instead of next to each other */<br>@media screen and 
  (max-width: 500px) {<br>&nbsp; .navbar a {<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp;&nbsp;&nbsp; 
  display: block;<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; 
  text-align: left; /* If you want the text to be left-aligned on small screens 
  */<br>&nbsp; }<br>}<br><br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_topnav_equal_width" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Equal Width Navigation Links with Icons</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-white w3-padding w3-padding-16">
<div class="navbarx">
  <a class="activexx" href="javascript:void(0)"><i class="fa fa-fw fa-home"></i> Home</a> 
  <a href="javascript:void(0)"><i class="fa fa-fw fa-search"></i> Search</a> 
  <a href="javascript:void(0)"><i class="fa fa-fw fa-envelope"></i> Contact</a> 
  <a href="javascript:void(0)"><i class="fa fa-fw fa-user"></i> Login</a>
</div>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_topnav_equal_width_icons" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
