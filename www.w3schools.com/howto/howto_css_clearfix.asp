...
<html lang="en-US">
<head>
<title>How To Clear Floats (Clearfix)</title>
<meta charset="utf-8">
...
<h1>How TO - Clear Floats (Clearfix)</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_equal_height.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_responsive_floats.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to clear floats with the "clearfix" hack.</p>
<hr>
<h2>How To Clear Floats (Clearfix)</h2>
<p>Elements after a floating element will flow around it. Use the "clearfix&quot; 
hack to fix the problem:</p>
<div class="w3-row-padding" style="margin:0 -16px 32px">
<div class="w3-half">
<h3>Without Clearfix</h3>
<img src="clearfix_prob.jpg" style="width:100%;" class="w3-image">
</div>
<div class="w3-half">
<h3>With Clearfix</h3>
<img src="clearfix_solution.jpg" style="width:100%;" class="w3-image">
</div>
</div>
<hr>
...
<a target="_blank" href="/css/tryit.asp?filename=trycss_layout_clearfix" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>The overflow:auto clearfix works well as long as you are able to keep control of your margins and padding (else you 
...
<a target="_blank" href="/css/tryit.asp?filename=trycss_layout_clearfix2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-note w3-panel">
<p><strong>Tip:</strong> Learn more about floats in our <a href="/css/css_float.asp">CSS Float</a> Tutorial.</p>
</div>
