...
<html lang="en-US">
<head>
<title>How To Create Range Sliders</title>
<meta charset="utf-8">
...
<h1>How TO - Range Sliders</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_skill_bar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_tooltip.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create custom range sliders with CSS and JavaScript.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_rangeslider" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>
<h2>Creating a Range Slider</h2>
<h5>Step 1) Add HTML:</h5>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;slidecontainer&quot;&gt;<br>&nbsp; &lt;input type=&quot;range&quot; min=&quot;1&quot; max=&quot;100&quot; 
  value=&quot;50&quot; class=&quot;slider&quot; id=&quot;myRange&quot;&gt;<br>&lt;/div&gt;<br></div>
</div>
...
<div class="w3-code notranslate cssHigh">
  .slidecontainer {<br>&nbsp;&nbsp;&nbsp; width: 100%; /* Width of the outside 
  container */<br>}<br><br>/* The slider itself */<br>.slider 
  {<br>&nbsp;&nbsp;&nbsp; -webkit-appearance: none;&nbsp; /* Override default 
  CSS styles */<br>&nbsp;&nbsp;&nbsp; appearance: none;<br>&nbsp;&nbsp;&nbsp; width: 
  100%; /* Full-width */<br>&nbsp;&nbsp;&nbsp; height: 25px; /* Specified height 
  */<br>&nbsp;&nbsp;&nbsp; background: #d3d3d3; /* Grey background */<br>&nbsp;&nbsp;&nbsp; outline: 
  none; /* Remove outline */<br>&nbsp;&nbsp;&nbsp; opacity: 0.7; /* Set 
  transparency (for mouse-over effects on hover) */<br>&nbsp;&nbsp;&nbsp; -webkit-transition: 
  .2s; /* 0.2 seconds transition on hover */<br>&nbsp;&nbsp;&nbsp; transition: opacity .2s;<br>}<br><br>/* Mouse-over 
  effects */<br>.slider:hover 
  {<br>&nbsp;&nbsp;&nbsp; opacity: 1; /* Fully shown on mouse-over */<br>}<br>
  <br>/* The <strong>slider handle</strong> (use -webkit- (Chrome, Opera, Safari, 
  Edge) and -moz- (Firefox) to override default look) */ <br>.slider::-webkit-slider-thumb {<br>&nbsp;&nbsp;&nbsp; 
  -webkit-appearance: none; /* Override default look */<br>&nbsp;&nbsp;&nbsp; appearance: none;<br>&nbsp;&nbsp;&nbsp; 
  width: 25px; /* Set a specific slider handle width */<br>&nbsp;&nbsp;&nbsp; height: 25px; 
  /* Slider handle height */<br>&nbsp;&nbsp;&nbsp; background: #4CAF50; /* Green 
  background */<br>&nbsp;&nbsp;&nbsp; 
  cursor: pointer; /* Cursor on hover */<br>}<br><br>.slider::-moz-range-thumb 
  {<br>&nbsp;&nbsp;&nbsp; 
  width: 25px; /* Set a specific slider handle width */<br>&nbsp;&nbsp;&nbsp; height: 25px; 
  /* Slider handle height */<br>&nbsp;&nbsp;&nbsp; 
  background: #4CAF50; /* Green background */<br>&nbsp;&nbsp;&nbsp; cursor: pointer; 
  /* Cursor on hover */<br>}</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_css_rangeslider" target="_blank">Try it Yourself &raquo;</a>
</div>

<h5>Step 3) Add JavaScript:</h5>
<p>Create a dynamic range slider to display the current value, with JavaScript:</p>

<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate jsHigh">
    var slider = document.getElementById(&quot;myRange&quot;);<br>var output = 
   document.getElementById(&quot;demo&quot;);<br>output.innerHTML = slider.value; 
    // Display the default slider value<br><br>// Update the current slider 
    value (each time you drag the slider handle)<br>
   slider.oninput = function() {<br>&nbsp;&nbsp;&nbsp; output.innerHTML = 
   this.value;<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_css_js_rangeslider" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<hr>
<h2>Round Slider</h2>
<p>To create a round slider handle, use the <code class="w3-codespan">border-radius</code> property. <strong>Tip:</strong> 
Set the height of the slider to a different value than the slider thumbs if you want 
unequal 
heights (15px vs. 25px in this example):</p>
<iframe src="tryhow_ifr_rangeslider.htm" style="height:48px;width:100%;border:none"></iframe>

<div class="w3-example">
   <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
   .slider 
  {<br>&nbsp;&nbsp;&nbsp; -webkit-appearance: none;<br>&nbsp;&nbsp;&nbsp; width: 
  100%;<br>&nbsp;&nbsp;&nbsp; <strong>height: 15px;</strong><br>&nbsp;&nbsp;&nbsp;
   <strong>border-radius: 5px;&nbsp;&nbsp;</strong> <br>&nbsp;&nbsp;&nbsp; background: #d3d3d3;<br>&nbsp;&nbsp;&nbsp; outline: 
  none;<br>&nbsp;&nbsp;&nbsp; opacity: 0.7;<br>&nbsp;&nbsp;&nbsp; -webkit-transition: 
  .2s;<br>&nbsp;&nbsp;&nbsp; transition: opacity .2s;<br>}<br><br>.slider::-webkit-slider-thumb {<br>&nbsp;&nbsp;&nbsp; 
  -webkit-appearance: none;<br>&nbsp;&nbsp;&nbsp; appearance: none;<br>&nbsp;&nbsp;&nbsp; 
  width: 25px;<br>&nbsp;&nbsp;&nbsp; <strong>height: 25px;</strong><br>&nbsp;&nbsp;&nbsp; 
   <strong>border-radius: 50%;&nbsp;</strong><br>&nbsp;&nbsp;&nbsp; background: #4CAF50;<br>&nbsp;&nbsp;&nbsp; 
  cursor: pointer;<br>}<br><br>.slider::-moz-range-thumb 
  {<br>&nbsp;&nbsp;&nbsp; width: 25px;<br>&nbsp;&nbsp;&nbsp; <strong>height: 25px;</strong><br>&nbsp;&nbsp;&nbsp; 
   <strong>border-radius: 50%;</strong><br>&nbsp;&nbsp;&nbsp; 
  background: #4CAF50;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>}</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_css_js_rangeslider_round" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Slider Icon/Image</h2>
<p>To create a slider handle icon/image, use the <code class="w3-codespan">background</code> property 
and insert an image url:</p>
<iframe src="tryhow_ifr_rangeslider2.htm" style="height:48px;width:100%;border:none"></iframe>

<div class="w3-example">
   <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
   .slider::-webkit-slider-thumb {<br>&nbsp;&nbsp;&nbsp; 
  -webkit-appearance: none;<br>&nbsp;&nbsp;&nbsp; appearance: none;<br>&nbsp;&nbsp;&nbsp; 
  width: 23px;<br>&nbsp;&nbsp;&nbsp; height: 24px;<br>&nbsp;&nbsp;&nbsp; border: 
   0;<br>&nbsp;&nbsp;&nbsp; <strong>background: url('contrasticon.png');</strong><br>&nbsp;&nbsp;&nbsp; 
  cursor: pointer;<br>}<br><br>.slider::-moz-range-thumb 
  {<br>&nbsp;&nbsp;&nbsp; width: 23px;<br>&nbsp;&nbsp;&nbsp; height: 25px;<br>&nbsp;&nbsp;&nbsp; border: 0;<br>
   &nbsp;&nbsp;&nbsp; <strong>background: url('contrasticon.png');</strong><br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>}</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_css_js_rangeslider_pic" target="_blank">Try it Yourself &raquo;</a>
</div>
