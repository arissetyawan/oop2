...
<html lang="en-US">
<head>
<title>How To Create a Filter/Search List</title>
<meta charset="utf-8">
...
<h1>How TO - Filter/Search List</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_autocomplete.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_filter_table.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a filter list with JavaScript.</p>
<hr>
<h2>Filter List</h2>
<p>How to use JavaScript to search for items in a list.</p>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_filter_list" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>Create A Search List</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;input type=&quot;text&quot; id=&quot;myInput&quot; onkeyup=&quot;myFunction()&quot; placeholder=&quot;Search 
for names..&quot;&gt;<br><br>&lt;ul id=&quot;myUL&quot;&gt;<br>&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Adele&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
&lt;li&gt;&lt;a href=&quot;#&quot;&gt;Agnes&lt;/a&gt;&lt;/li&gt;<br><br>&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Billy&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
&lt;li&gt;&lt;a href=&quot;#&quot;&gt;Bob&lt;/a&gt;&lt;/li&gt;<br><br>&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Calvin&lt;/a&gt;&lt;/li&gt;<br>&nbsp; 
&lt;li&gt;&lt;a href=&quot;#&quot;&gt;Christina&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Cindy&lt;/a&gt;&lt;/li&gt;<br>
&lt;/ul&gt;</div>
</div>
<p><strong>Note:</strong> We use href=&quot;#&quot; in this demo since we do not have a 
page to link it to. In real life this should be a real URL to a specific page.</p>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>Style the input element and the list:</p>
<div class="w3-example">
<h3>Example</h3>
...
below the input */<br>}<br><br>#myUL {<br>&nbsp;&nbsp;&nbsp; 
/* Remove default list styling */<br>&nbsp;&nbsp;&nbsp; list-style-type: 
none;<br>&nbsp;&nbsp;&nbsp; padding: 0;<br>&nbsp;&nbsp;&nbsp; margin: 0;<br>
}<br><br>#myUL li a {<br>&nbsp;&nbsp;&nbsp; 
border: 1px solid #ddd; /* Add a border to all links */<br>&nbsp;&nbsp;&nbsp; 
margin-top: -1px; /* Prevent double borders */<br>&nbsp;&nbsp;&nbsp; 
background-color: #f6f6f6; /* Grey background color */<br>&nbsp;&nbsp;&nbsp; 
padding: 12px; /* Add some padding */<br>&nbsp;&nbsp;&nbsp; text-decoration: 
none; /* Remove default text underline */<br>&nbsp;&nbsp;&nbsp; font-size: 
18px; /* Increase the font-size */<br>&nbsp;&nbsp;&nbsp; color: black; /* 
Add a black text color */<br>&nbsp;&nbsp;&nbsp; display: block; /* Make it 
into a block element to fill the whole list */<br>}<br><br>#myUL 
li a:hover:not(.header) {<br>&nbsp;&nbsp;&nbsp; background-color: #eee; /* 
Add a hover effect to all links, except for headers */<br>}</div>
</div>
<hr>
...
ul, li, a, i;<br>&nbsp;&nbsp;&nbsp; input = document.getElementById('myInput');<br>&nbsp;&nbsp;&nbsp; 
filter = input.value.toUpperCase();<br>&nbsp;&nbsp;&nbsp; ul = 
document.getElementById(&quot;myUL&quot;);<br>&nbsp;&nbsp;&nbsp; li = 
ul.getElementsByTagName('li');<br><br>&nbsp;&nbsp;&nbsp; // Loop through all 
list items, and hide those who don't match the search query<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; 
li.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; a = li[i].getElementsByTagName(&quot;a&quot;)[0];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_filter_list" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel w3-note">
<p><strong>Tip:</strong> Remove <span class="w3-codespan">toUpperCase()</span> if you want to perform a case-sensitive search.</p>
</div>

<p><strong>Tip:</strong> Also check out <a href="howto_js_filter_table.asp">Filter Table</a>.</p>
