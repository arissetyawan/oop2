...
<h1>How TO - Tab Gallery</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_image_grid.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_image_overlay.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a tabbed image gallery with CSS and JavaScript.</p>
<hr>
<h2>Tab Gallery</h2>
...
<div id="Nature" class="picture w3-display-container" xstyle="display:none">
  <img src="img_nature.jpg" alt="Nature" style="width:100%">
  <span onclick="this.parentElement.style.display='none'" 
  class="w3-display-topright w3-button w3-transparent w3-text-white w3-xxlarge">&times;</span>
...
<div id="Snow" class="picture w3-display-container" style="display:none">
  <img src="img_snow.jpg" alt="Snow" style="width:100%">
  <span onclick="this.parentElement.style.display='none'" 
  class="w3-display-topright w3-button w3-transparent xw3-text-white w3-xxlarge">&times;</span>
...
<div id="Mountains" class="picture w3-display-container" style="display:none">
  <img src="img_mountains.jpg" alt="Mountains" style="width:100%">
  <span onclick="this.parentElement.style.display='none'" 
  class="w3-display-topright w3-button w3-transparent w3-xxlarge">&times;</span>
  <div class="w3-display-bottomleft w3-container w3-padding w3-text-white w3-large">Mountains</div>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_tab_img_gallery" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>

<h2>Create a Tab Gallery</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- The grid: four columns --&gt;<br>&lt;div class=&quot;row&quot;&gt;<br>&nbsp; &lt;div 
  class=&quot;column&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;img src=&quot;img_nature.jpg&quot; alt=&quot;Nature&quot; 
  onclick=&quot;openImg(this);&quot;&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;column&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;img src=&quot;img_snow.jpg&quot; alt=&quot;Snow&quot; onclick=&quot;openImg(this);&quot;&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;column&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;img src=&quot;img_mountains.jpg&quot; 
  alt=&quot;Mountains&quot; onclick=&quot;openImg(this);&quot;&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; 
  &lt;div class=&quot;column&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;img src=&quot;img_lights.jpg&quot; 
  alt=&quot;Lights&quot; onclick=&quot;openImg(this);&quot;&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;!-- The expanding 
  image container --&gt;<br>&lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;!-- Close the 
  image --&gt;<br>&nbsp; &lt;span onclick=&quot;this.parentElement.style.display='none'&quot; 
  class=&quot;closebtn&quot;&gt;&amp;times;&lt;/span&gt;<br><br>&nbsp; &lt;!-- Expanded image --&gt;<br>&nbsp; 
  &lt;img id=&quot;expandedImg&quot; style=&quot;width:100%&quot;&gt;<br><br>&nbsp; &lt;!-- Image text --&gt;<br>&nbsp; 
  &lt;div id=&quot;imgtext&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
<p>Use images to expand the specific image. The image that is clicked on inside 
the column, is shown in a container below the columns. </p>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>Create four columns and style the images:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* The grid: Four equal columns that floats next to each other */<br>.column {<br>&nbsp;&nbsp;&nbsp; 
  float: left;<br>&nbsp;&nbsp;&nbsp; width: 25%;<br>&nbsp;&nbsp;&nbsp; padding: 
  10px;<br>}<br><br>/* Style the 
  images inside the grid */<br>.column img {<br>&nbsp;&nbsp;&nbsp; opacity: 0.8;
  <br>&nbsp;&nbsp;&nbsp; cursor: pointer; <br>}<br><br>.column img:hover {<br>&nbsp;&nbsp;&nbsp; opacity: 1;<br>
  }<br><br>/* Clear 
  floats after the columns */<br>.row:after {<br>&nbsp;&nbsp;&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
  display: table;<br>&nbsp;&nbsp;&nbsp; clear: both;<br>}<br><br>/* The expanding image 
  container (positioning is needed to position the close button and the text) */<br>.container {<br>&nbsp;&nbsp;&nbsp; 
  position: relative;<br>&nbsp;&nbsp;&nbsp; display: none;<br>}<br><br>/* Expanding image text */<br>
  #imgtext {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
  bottom: 15px;<br>&nbsp;&nbsp;&nbsp; left: 15px;<br>&nbsp;&nbsp;&nbsp; color: 
  white;<br>&nbsp;&nbsp;&nbsp; font-size: 20px;<br>}<br><br>/* Closable button inside the image */<br>.closebtn 
  {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; top: 10px;<br>&nbsp;&nbsp;&nbsp; 
  right: 15px;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
  font-size: 35px;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  function myFunction(imgs) {<br>&nbsp; // Get the expanded image<br>&nbsp; var 
  expandImg = document.getElementById(&quot;expandedImg&quot;);<br>&nbsp; // Get the image 
  text<br>&nbsp; var imgText = document.getElementById(&quot;imgtext&quot;);<br>&nbsp; // 
  Use the same src in the expanded image as the image being clicked on from the 
  grid<br>&nbsp; expandImg.src = imgs.src;<br>&nbsp; // Use the value of the alt 
  attribute of the clickable image as text inside the expanded image<br>&nbsp; 
  imgText.innerHTML = imgs.alt;<br>&nbsp; // Show the container element (hidden with 
  CSS)<br>&nbsp; 
  expandImg.parentElement.style.display = &quot;block&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_tab_img_gallery" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
