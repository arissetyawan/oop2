...
<html lang="en-US">
<head>
<title>How To Shrink a Header on Scroll</title>
<meta charset="utf-8">
...
<h1>How TO - Resize Header on Scroll</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_sticky_header.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_pricing_table.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to shrink a header on scroll with CSS and JavaScript.</p>
<hr>
<iframe src="tryhow_js_shrink_header_scroll.htm" style="border:2px solid #eee;width:100%;height:430px;padding:0"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_shrink_header_scroll" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Shrink a Header on Scroll</h2>
...
<p>Style the header:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  #header {<br>&nbsp; background-color: #f1f1f1; /* Grey background */<br>&nbsp; 
  padding: 50px 10px; /* Some padding */<br>&nbsp; color: black;<br>&nbsp; 
  text-align: center; /* Centered text */<br>&nbsp; font-size: 90px; /* Big font 
  size */ <br>&nbsp; font-weight: bold; <br>&nbsp; position: fixed; /* Fixed 
  position - sit on top of the page */<br>&nbsp; top: 0; <br>&nbsp; width: 100%; 
  /* Full width */<br>&nbsp; transition: 0.2s; /* Add a transition effect (when 
  scrolling - and font size is decreased) */<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  // When the user scrolls down 50px from the top of the document, resize the 
  header's font size<br>window.onscroll = function() {scrollFunction()};<br><br>
  function scrollFunction() {<br>&nbsp; if (document.body.scrollTop &gt; 50 || 
  document.documentElement.scrollTop &gt; 50) {<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById(&quot;header&quot;).style.fontSize = &quot;30px&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById(&quot;header&quot;).style.fontSize = &quot;90px&quot;;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_shrink_header_scroll" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
