...
<html lang="en-US">
<head>
<title>How To Create a Dropdown Menu With CSS and JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - Clickable Dropdown</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_dropdown.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_dropdown_navbar.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a clickable dropdown menu with CSS and JavaScript.</p>
<hr>
<h2>Dropdown</h2>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_js_dropdown" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
...
&lt;div id="myDropdown" class="dropdown-content"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href="#"&gt;Link 
1&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; 
...
background-color: #3498DB;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
...
background-color: #2980B9;<br>}<br><br>/* The 
...
absolute;<br>&nbsp;&nbsp;&nbsp; background-color: #f1f1f1;<br>&nbsp;&nbsp;&nbsp; 
...
.dropdown-content a:hover {background-color: #ddd}<br><br>/* Show the dropdown menu (use JS to add this class to the .dropdown-content 
...
is hidden by default, and will be displayed on hover (see below). Note the <code class="w3-codespan">min-width</code> is set to 160px. Feel free to change 
...
// Close the dropdown menu if the user clicks outside of it<br>
window.onclick = function(event) {<br>&nbsp; if (!event.target.matches('.dropbtn')) 
{<br><br>&nbsp;&nbsp;&nbsp; var dropdowns = document.getElementsByClassName("dropdown-content");<br>&nbsp;&nbsp;&nbsp; 
var i;<br>&nbsp;&nbsp;&nbsp; 
for (i = 0; i &lt; dropdowns.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
var openDropdown = dropdowns[i];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (openDropdown.classList.contains('show')) 
{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
openDropdown.classList.remove('show');<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
}<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_js_dropdown" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<iframe src="tryhow_css_js_dropdown_right.htm" style="width:100%;border:none;height:320px;"></iframe>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_js_dropdown_right" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-white w3-padding notranslate">
<iframe src="tryhow_css_js_dropdown_filter_ifr.htm" style="width:100%;border:none;height:475px;"></iframe>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_js_dropdown_filter" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
