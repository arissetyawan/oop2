...
<html lang="en-US">
<head>
<title>How To Create a Header</title>
<meta charset="utf-8">
...
<h1>How TO - Style a Header</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_contact_section.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_example_website.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style a header.</p>
<hr>
<h2>Big Header</h2>
<iframe src="tryhow_css_style_header.htm" style="border:3px solid #f1f1f1;width:100%;height:600px"></iframe>

<a target="_blank" href="tryit.asp?filename=tryhow_css_style_header" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
...
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;header&quot;&gt;<br>&nbsp; &lt;h1&gt;Header&lt;/h1&gt;<br>&nbsp; &lt;p&gt;My supercool 
  header&lt;/p&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>Style the header with a large padding, centered text, a specific background-color and a big sized text:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .header {<br>&nbsp; padding: 60px;<br>&nbsp; text-align: center;<br>&nbsp; 
  background: #1abc9c;<br>&nbsp; color: white;<br>&nbsp; font-size: 30px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_style_header" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
