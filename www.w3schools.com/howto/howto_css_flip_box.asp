...
<html lang="en-US">
<head>
<title>How To Create a 3D Flip Box with CSS</title>
<meta charset="utf-8">
...
<h1>How TO - 3D Flip Box</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_zoom_hover.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_center-vertical.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a flip box with CSS.</p>
<hr>


<h2>Flip Box</h2>
<p>Move your mouse over the boxes below to see the effect:</p>
<div class="w3-row-padding" style="margin:0 -16px">

<div class="w3-col hh">
<p><strong>Horizontal</strong> Flip:</p>
<div class="flip-box">
  <div class="flip-box-inner">
    <div class="flip-box-front"><h2>Front Side</h2></div>
    <div class="flip-box-back"><h2>Back Side</h2></div>
  </div>
</div>

<p><a target="_blank" href="tryit.asp?filename=tryhow_css_flip_box" class="w3-btn">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-col hh">
<p><strong>Vertical</strong> Flip:</p>
<div class="flip-box2">
  <div class="flip-box-inner2">
    <div class="flip-box-front2"><h2>Front Side</h2></div>
    <div class="flip-box-back2"><h2>Back Side</h2></div>
  </div>
</div>

</div>
<p class="w3-clearfix" style="margin-bottom:-16px">&nbsp;</p>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_flip_box2" class="w3-btn" style="margin-left:8px">Try it Yourself &raquo;</a></p>

</div>

<hr>
<h2>How To Create a Flip Box</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;flip-box&quot;&gt;<br>&nbsp; &lt;div class=&quot;flip-box-inner&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;div class=&quot;flip-box-front&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;h2&gt;Front 
  Side&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div 
  class=&quot;flip-box-back&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;h2&gt;Back Side&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; 
...
<div class="w3-code notranslate cssHigh">
  ...
  the box on hover (remove perspective if you don't want the 3D effect */<br>.flip-box {<br>&nbsp; background-color: transparent;<br>&nbsp; width: 300px;<br>&nbsp; 
  height: 200px;<br>&nbsp; border: 1px solid #f1f1f1;<br>&nbsp; perspective: 
  1000px; /* Remove this if you don't want the 3D effect */<br>}<br><br>/* This 
  container is needed to position the front and back side */<br>
  .flip-box-inner {<br>&nbsp; position: relative;<br>&nbsp; width: 100%;<br>&nbsp; 
  height: 100%;<br>&nbsp; text-align: center;<br>&nbsp; transition: transform 
  0.8s;<br>&nbsp; transform-style: preserve-3d;<br>}<br><br>/* Do an horizontal 
  flip when you move the mouse over the flip box container */<br>.flip-box:hover .flip-box-inner {<br>&nbsp; 
  transform: rotateY(180deg);<br>}<br><br>/* Position the front and back side */<br>.flip-box-front, .flip-box-back {<br>&nbsp; 
  position: absolute;<br>&nbsp; width: 100%;<br>&nbsp; height: 100%;<br>&nbsp; 
  backface-visibility: hidden;<br>}<br><br>/* Style the front side */<br>.flip-box-front {<br>&nbsp; background-color: #bbb;<br>&nbsp; 
  color: black;<br>}<br><br>/* Style the back side */<br>.flip-box-back {<br>&nbsp; background-color: dodgerblue;<br>&nbsp; 
  color: white;<br>&nbsp; transform: rotateY(180deg);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_flip_box" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Vertical Flip</h2>
<p>To do a vertical flip instead of a horizontal, use the <code class="w3-codespan">rotateX</code> method instead of <code class="w3-codespan">rotateY</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .flip-box:hover .flip-box-inner {<br>&nbsp; 
  transform: rotateX(180deg);<br>}<br><br>.flip-box-back {<br>&nbsp; transform: rotateX(180deg);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_flip_box2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Note:</strong> These examples do not work properly on tablets and/or mobile phones.</p>
<p><strong>Tip:</strong> Go to our <a href="/css/css3_2dtransforms.asp">CSS 2D Transforms</a> Tutorial, to learn more about 
2D transformations, such as the rotate() method.</p>
<p><strong>Tip:</strong> Go to our <a href="/css/css3_3dtransforms.asp">CSS 3D Transforms</a> Tutorial, to learn more about 
