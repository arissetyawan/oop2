...
<html lang="en-US">
<head>
<title>How To Copy to Clipboard</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="howto_html_clear_input.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_animated_search.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to copy text to the clipboard with JavaScript.</p>
<hr>
...
<div class="w3-code notranslate htmlHigh">
  &lt;!-- The text field --&gt;<br>&lt;input type=&quot;text&quot; value=&quot;Hello World&quot; id=&quot;myInput&quot;&gt;<br>
  <br>&lt;!-- The button used to copy the text --&gt;<br>&lt;button onclick=&quot;myFunction()&quot;&gt;Copy 
  text&lt;/button&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  function myFunction() {<br>&nbsp; /* Get the text field */<br>&nbsp; var copyText = document.getElementById(&quot;myInput&quot;);<br>
  <br>&nbsp; /* Select the text field */<br>&nbsp; 
  copyText.select();<br><br>&nbsp; /* Copy the text inside the text field */<br>&nbsp; document.execCommand(&quot;copy&quot;);<br>
  <br>&nbsp; /* Alert the copied text */<br>&nbsp; 
  alert(&quot;Copied the text: &quot; + copyText.value);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_copy_clipboard" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> The <a href="/jsref/met_document_execcommand.asp">document.execCommand()</a> method is not supported in IE8 and earlier.</p>
<hr>
...
<h2>Display Copied Text in a Tooltip</h2>
<p>Add CSS:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .tooltip {<br>&nbsp; position: relative;<br>&nbsp; display: inline-block;<br>}<br><br>
  .tooltip .tooltiptext {<br>&nbsp; visibility: hidden;<br>&nbsp; width: 140px;<br>&nbsp; 
  background-color: #555;<br>&nbsp; color: #fff;<br>&nbsp; text-align: center;<br>&nbsp; 
  border-radius: 6px;<br>&nbsp; padding: 5px;<br>&nbsp; position: absolute;<br>&nbsp; 
  z-index: 1;<br>&nbsp; bottom: 150%;<br>&nbsp; left: 50%;<br>&nbsp; 
  margin-left: -75px;<br>&nbsp; opacity: 0;<br>&nbsp; transition: opacity 0.3s;<br>
  }<br><br>.tooltip .tooltiptext::after {<br>&nbsp; 
  content: &quot;&quot;;<br>&nbsp; position: absolute;<br>&nbsp; top: 100%;<br>&nbsp; 
  left: 50%;<br>&nbsp; margin-left: -5px;<br>&nbsp; border-width: 5px;<br>&nbsp; 
  border-style: solid;<br>&nbsp; border-color: #555 transparent transparent 
  transparent;<br>}<br><br>.tooltip:hover 
  .tooltiptext {<br>&nbsp; visibility: visible;<br>&nbsp; opacity: 1;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_copy_clipboard2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
