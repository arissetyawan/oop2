...
<html lang="en-US">
<head>
<title>How To Create a Full Page Image</title>
<meta charset="utf-8">
...
<h1>How TO - Full Page Image</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_image_transparent.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_form_on_image.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a full page background image with CSS.</p>
<hr>

<h2>Full Page Image</h2>
<p>Learn how to create a background image that covers the entire browser window. The following example shows a full-screen (and a half-screen) responsive background image:</p>
<p>
<a href="tryhow_css_fullpage_demo.htm" class="w3-btn w3-blue" target="_blank">Demo - Full page background image</a></p>
<p>
<a href="tryhow_css_halfpage_demo.htm" class="w3-btn w3-purple" target="_blank">Demo - Half page background image</a></p>
<hr>

<h2>How To Create a Full Height Image</h2>
<p>Use a container element and add a background image to the container with <code class="w3-codespan">height: 100%</code>. 
<strong>Tip:</strong> Use 50% to create a half page background image. Then use the following background properties to center and scale the image perfectly:</p>

<p><strong>Note:</strong> To make sure that the image covers the whole screen, you must also 
apply <code class="w3-codespan">height: 100%</code> to both &lt;html&gt; and &lt;body&gt;:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
body, html {<br>&nbsp;&nbsp;&nbsp; height: 100%;<br>}<br><br>.bg { <br>&nbsp;&nbsp;&nbsp; 
/* The image used */<br>&nbsp;&nbsp;&nbsp; background-image: url(&quot;img_girl.jpg&quot;);<br>
<br>&nbsp;&nbsp;&nbsp; /* Full height */<br>&nbsp;&nbsp;&nbsp; 
height: 100%; <br><br>&nbsp;&nbsp;&nbsp; /* Center and scale the image nicely */<br>&nbsp;&nbsp;&nbsp; 
background-position: center;<br>&nbsp;&nbsp;&nbsp; background-repeat: 
no-repeat;<br>&nbsp;&nbsp;&nbsp; background-size: cover;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_full_page" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Half page background image:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .bg { <br>&nbsp;&nbsp;&nbsp; 
height: 50%; <br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_half_page" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
