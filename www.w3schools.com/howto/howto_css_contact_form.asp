...
<html lang="en-US">
<head>
<title>How To Create a Contact Form with CSS</title>
<meta charset="utf-8">
...
<style>
input[type=text].test, select.test.test,textarea.test {
    width: 100%;
    padding: 12px;
    display: inline-block;
...
<h1>How TO - Contact Form</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_checkout_form.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_social_login.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a contact form with CSS.</p>
<hr>
<div class="test" style="border-radius:5px;background-color:#f2f2f2;padding:30px;">
 <label for="fname" class="test">First Name</label>
  <input type="text" class="test" id="fname" name="firstname" placeholder="Your name..">

  <label for="lname" class="test">Last Name</label>
  <input type="text" class="test" id="lname" name="lastname" placeholder="Your last name..">

  <label for="country" class="test">Country</label>
  <select id="country" class="test" name="country">
  ...
  <textarea class="test" placeholder="Write something.." style="height:200px"></textarea>
 
<a target="_blank" href="javascript:void(0)" class="w3-btn w3-padding w3-round">Submit</a>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_contact_form" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Contact Form</h2>
...
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;form action=&quot;action_page.php&quot;&gt;<br><br>&nbsp;&nbsp;&nbsp; 
  &lt;label for=&quot;fname&quot;&gt;First Name&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input type=&quot;text&quot; 
  id=&quot;fname&quot; name=&quot;firstname&quot; placeholder=&quot;Your name..&quot;&gt;<br><br>&nbsp;&nbsp;&nbsp; 
  &lt;label for=&quot;lname&quot;&gt;Last Name&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input type=&quot;text&quot; 
  id=&quot;lname&quot; name=&quot;lastname&quot; placeholder=&quot;Your last name..&quot;&gt;<br><br>&nbsp;&nbsp;&nbsp; 
  &lt;label for=&quot;country&quot;&gt;Country&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; &lt;select 
  id=&quot;country&quot; name=&quot;country&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;option value=&quot;australia&quot;&gt;Australia&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;option value=&quot;canada&quot;&gt;Canada&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;option value=&quot;usa&quot;&gt;USA&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/select&gt;<br><br>&nbsp;&nbsp;&nbsp; 
  &lt;label for=&quot;subject&quot;&gt;Subject&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; &lt;textarea 
  id=&quot;subject&quot; name=&quot;subject&quot; placeholder=&quot;Write something..&quot; 
  style=&quot;height:200px&quot;&gt;&lt;/textarea&gt;<br><br>&nbsp;&nbsp;&nbsp; &lt;input 
  type=&quot;submit&quot; value=&quot;Submit&quot;&gt;<br><br>&nbsp; &lt;/form&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style inputs with type=&quot;text&quot;, select elements and textareas */<br>input[type=text], select, textarea {<br>&nbsp;&nbsp;&nbsp; width: 100%; /* 
  Full width */<br>&nbsp;&nbsp;&nbsp; 
  padding: 12px; /* Some padding */&nbsp; <br>&nbsp;&nbsp;&nbsp; border: 1px solid #ccc; 
  /* Gray border */<br>&nbsp;&nbsp;&nbsp; 
  border-radius: 4px; /* Rounded borders */<br>&nbsp;&nbsp;&nbsp; box-sizing: border-box; 
  /* Make sure that padding and width stays in place */<br>&nbsp;&nbsp;&nbsp; 
  margin-top: 6px; /* Add a top margin */<br>&nbsp;&nbsp;&nbsp; margin-bottom: 16px; 
  /* Bottom margin */<br>&nbsp;&nbsp;&nbsp; resize: vertical /* Allow the user 
  to vertically resize the textarea (not horizontally) */<br>}<br>
  <br>/* Style the submit button with a specific background color etc */<br>input[type=submit] {<br>&nbsp;&nbsp;&nbsp; background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>&nbsp;&nbsp;&nbsp; padding: 12px 20px;<br>&nbsp;&nbsp;&nbsp; 
  border: none;<br>&nbsp;&nbsp;&nbsp; border-radius: 4px;<br>&nbsp;&nbsp;&nbsp; 
  cursor: pointer;<br>}<br><br>/* When moving the mouse over the submit button, 
  add a darker green color */<br>input[type=submit]:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #45a049;<br>}<br><br>/* Add a background color and some 
  padding around the form */<br>.container {<br>&nbsp;&nbsp;&nbsp; border-radius: 5px;<br>&nbsp;&nbsp;&nbsp; 
  background-color: #f2f2f2;<br>&nbsp;&nbsp;&nbsp; padding: 20px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_contact_form" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
