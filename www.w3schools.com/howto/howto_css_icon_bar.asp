...
<html lang="en-US">
<head>
<title>How To Create an Icon Bar</title>
<meta charset="utf-8">
...
<h1>How TO - Icon Bar</h1>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="default.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_menu_icon.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create icon bars with CSS.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_icon_bar_v" class="w3-btn">Try it Yourself &raquo;</a></p>
</div>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_icon_bar_h" class="w3-btn">Try it Yourself &raquo;</a></p>

</div>
<p style="clear:both"></p>
<hr>

<h2>How To Create an Icon Bar</h2>
...
.icon-bar {<br>&nbsp;&nbsp;&nbsp; width: 
90px; /* Set a specific width */<br>&nbsp;&nbsp;&nbsp; 
background-color: #555; /* Dark-grey background */<br>}<br><br>.icon-bar a {<br>&nbsp;&nbsp;&nbsp; 
display: block; /* Make the links appear below each other instead of 
  side-by-side */<br>&nbsp;&nbsp;&nbsp; text-align: center; /* Center-align text 
  */<br>&nbsp;&nbsp;&nbsp; padding: 16px; /* Add some padding */<br>&nbsp;&nbsp;&nbsp; transition: all 0.3s ease; 
  /* Add transition for hover effects */<br>&nbsp;&nbsp;&nbsp; 
color: white; /* White text color */<br>&nbsp;&nbsp;&nbsp; font-size: 36px; /* 
  Increased font-size */<br>}<br><br>
.icon-bar a:hover {<br>&nbsp;&nbsp;&nbsp; background-color: #000; /* Add a hover 
  color */<br>}<br><br>.active {<br>&nbsp;&nbsp;&nbsp; 
background-color: #4CAF50; /* Add an active/current color */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_icon_bar_v" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Horizontal Example</h3>
<div class="w3-code notranslate cssHigh">
.icon-bar {<br>&nbsp;&nbsp;&nbsp; width: 100%; /* Full-width */<br>&nbsp;&nbsp;&nbsp; background-color: #555; 
  /* Dark-grey background */<br>&nbsp;&nbsp;&nbsp; 
overflow: auto; /* Overflow due to float */<br>}<br><br>.icon-bar a {<br>&nbsp;&nbsp;&nbsp; 
float: left; /* Float links side by side */<br>&nbsp;&nbsp;&nbsp; text-align: 
  center; /* Center-align text */<br>&nbsp;&nbsp;&nbsp; 
width: 20%; /* Equal width (5 icons with 20% width each = 100%) */<br>&nbsp;&nbsp;&nbsp; padding: 12px 0; 
  /* Some top and bottom padding */<br>&nbsp;&nbsp;&nbsp; transition: all 0.3s ease; 
  /* Add transition for hover effects */<br>&nbsp;&nbsp;&nbsp; 
color: white; /* White text color */<br>&nbsp;&nbsp;&nbsp; font-size: 36px; /* 
  Increased font size */<br>}<br><br>.icon-bar a:hover {<br>&nbsp;&nbsp;&nbsp; 
background-color: #000; /* Add a hover color */<br>}<br><br>.active {<br>&nbsp;&nbsp;&nbsp; 
background-color: #4CAF50; /* Add an active/current color */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_icon_bar_h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Related Pages</h2>
