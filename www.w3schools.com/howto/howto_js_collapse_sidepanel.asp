...
<html lang="en-US">
<head>
<title>How To Create a Collapsed Sidepanel</title>
<meta charset="utf-8">
...
<h1>How TO - Collapse Sidepanel</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_collapse_sidebar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_pagination.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a collapsible sidepanel menu.</p>
<hr>
<iframe src="tryhow_js_collapse_sidepanel.htm" style="border:3px solid #f1f1f1;width:100%;height:400px"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_js_collapse_sidepanel" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>

<h2>Create a Collapsed Sidepanel</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div id=&quot;mySidepanel&quot; class=&quot;sidepanel&quot;&gt;<br>&nbsp; &lt;a href=&quot;javascript:void(0)&quot; 
class=&quot;closebtn&quot; onclick=&quot;closeNav()&quot;&gt;&amp;times;&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;About&lt;/a&gt;<br>&nbsp; 
&lt;a href=&quot;#&quot;&gt;Services&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Clients&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Contact&lt;/a&gt;<br>
&lt;/div&gt;<br><br>&lt;button class=&quot;openbtn&quot; onclick=&quot;openNav()&quot;&gt;&amp;#9776; 
  Toggle Sidepanel&lt;/button&gt; <br>&lt;h2&gt;Collapsed Sidepanel&lt;/h2&gt;<br>&lt;p&gt;Content...&lt;/p&gt;<br></div>
</div>
<hr>
...
/* The sidepanel menu */<br>.sidepanel {<br>&nbsp;&nbsp;&nbsp; height: 
  250px; /* 
  Specify a height */<br>&nbsp;&nbsp;&nbsp; width: 0; /* 0 width - change this 
...
transition: 0.5s; /* 0.5 second transition effect to slide in the sidepanel */<br>
}<br><br>/* The sidepanel links */<br>.sidepanel a {<br>&nbsp;&nbsp;&nbsp; padding: 8px 8px 8px 32px;<br>&nbsp;&nbsp;&nbsp; 
...
change their color */<br>.sidepanel a:hover {<br>&nbsp;&nbsp;&nbsp; 
color: #f1f1f1;<br>}<br><br>/* Position and style the close button (top 
right corner) */<br>.sidepanel .closebtn {<br>&nbsp;&nbsp;&nbsp; position: 
absolute;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; right: 25px;<br>&nbsp;&nbsp;&nbsp; 
font-size: 36px;<br>&nbsp;&nbsp;&nbsp; margin-left: 50px;<br>}<br><br>/* Style 
  the button that is used to open the sidepanel */<br>.openbtn {<br>&nbsp; 
  font-size: 20px;<br>&nbsp; cursor: pointer;<br>&nbsp; background-color: #111;<br>&nbsp; 
  color: white;<br>&nbsp; padding: 10px 15px;<br>&nbsp; border: none;<br>}<br><br>.openbtn:hover {<br>&nbsp; 
  background-color: #444;<br>}</div>
</div>
<hr>
...
/* Set the width of the sidebar to 250px 
  (show it) */<br>function 
openNav() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;mySidepanel&quot;).style.width 
= &quot;250px&quot;;<br>}<br><br>/* Set the width of the sidebar to 0 (hide it) */<br>function closeNav() {<br>&nbsp;&nbsp;&nbsp; 
document.getElementById(&quot;mySidepanel&quot;).style.width = &quot;0&quot;;<br>}</div>
