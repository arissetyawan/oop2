...
<html lang="en-US">
<head>
<title>How To Detect Online Connectivity</title>
<meta charset="utf-8">
...
<h1>How TO - Online Offline Detection</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_remove_property_object.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_check_hidden.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to detect whether the browser is online or offline with JavaScript.</p>
<hr>

<h2>Offline Detection</h2>
<p>The <code class="w3-codespan">onLine</code> property of the <code class="w3-codespan">Navigator</code> object returns a Boolean value that specifies whether the browser is in online or offline mode:</p>
<div class="w3-example">
<h3>Example</h3>
<p>Find out whether the browser is online:</p>
<div class="w3-code notranslate jsHigh">
 var x = &quot;Is the browser online? &quot; + navigator.onLine;<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_offline_detection" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-note w3-panel">
<p>Read more about the Navigator Object in our <a href="/js/js_window_navigator.asp">JavaScript Navigator Tutorial</a>.</p>
</div>
