...
<h1>How TO - Custom Scrollbar</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_browser_window.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_devices.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a custom scrollbar with CSS.</p>
<hr>
<h2>Custom Scrollbars</h2>
<div class="w3-row-padding" style="margin:0 -16px">
<div class="w3-half">
<iframe src="tryhow_css_custom_scrollbar.htm" style="width:100%;border:5px solid #ddd"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_css_custom_scrollbar" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
</div>
<div class="w3-half">
<iframe src="tryhow_css_custom_scrollbar2.htm" style="width:100%;border:5px solid #ddd"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_css_custom_scrollbar2" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
</div>
</div>
<div class="w3-note w3-panel">
<p>Custom scrollbars are <strong>not</strong> supported in Firefox or IE/Edge.</p>
</div>
<hr>

<h2>How To Create Custom Scrollbars</h2>
<p>Webkit browsers, such as Chrome, Safari and Opera, supports the non-standard <code class="w3-codespan">::-webkit-scrollbar</code> pseudo element, which allows us to modify the look of the browser's scrollbar.</p>
<p>The following example creates a thin (10px wide) scrollbar, which has a grey track/bar 
color and a dark-grey (#888) handle:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* width */<br>::-webkit-scrollbar {<br>&nbsp;&nbsp;&nbsp; width: 10px;<br>}<br><br>/* Track */<br>
  ::-webkit-scrollbar-track {<br>&nbsp;&nbsp;&nbsp; background: #f1f1f1; <br>}<br><br>/* Handle */<br>
  ::-webkit-scrollbar-thumb {<br>&nbsp;&nbsp;&nbsp; background: #888; <br>}<br>
  <br>/* Handle on hover */<br>::-webkit-scrollbar-thumb:hover {<br>&nbsp;&nbsp;&nbsp; 
  background: #555; <br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_custom_scrollbar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>This example creates a scrollbar with box shadow:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* width */<br>::-webkit-scrollbar {<br>&nbsp;&nbsp;&nbsp; width: 20px;<br>}<br><br>/* Track */<br>
  ::-webkit-scrollbar-track {<br>&nbsp;&nbsp;&nbsp; box-shadow: inset 0 0 5px 
  grey; <br>&nbsp;&nbsp;&nbsp; border-radius: 10px;<br>}<br><br>/* Handle */<br>::-webkit-scrollbar-thumb {<br>&nbsp;&nbsp;&nbsp; 
  background: red; <br>&nbsp;&nbsp;&nbsp; border-radius: 10px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_custom_scrollbar2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Scrollbar Selectors</h2>
<p>For webkit browsers, you can use the following pseudo elements to customize the browser's scrollbar:</p>

<ul><li><code class="w3-codespan">::-webkit-scrollbar</code> the scrollbar.</li>
<li><code class="w3-codespan">::-webkit-scrollbar-button</code> the buttons on the scrollbar (arrows pointing upwards and downwards).</li>
<li><code class="w3-codespan">::-webkit-scrollbar-thumb</code> the draggable scrolling handle.</li>
<li><code class="w3-codespan">::-webkit-scrollbar-track</code> the track (progress bar) of the scrollbar.</li>
<li><code class="w3-codespan">::-webkit-scrollbar-track-piece</code> the track (progress bar) NOT covered by the handle.</li>
<li><code class="w3-codespan">::-webkit-scrollbar-corner</code> the bottom corner of the scrollbar, where both horizontal and 
vertical scrollbars meet.</li>
<li><code class="w3-codespan">::-webkit-resizer</code> the draggable resizing handle that appears at the bottom corner of some elements.</li>
</ul><br>
