...
<html lang="en-US">
<head>
<title>How To Sort a List</title>
<meta charset="utf-8">
...
<h1>How TO - Sort a List</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_filter_dropdown.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_sort_table.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to sort an HTML list, using JavaScript.</p>
<hr>

<p>Click the button to sort the list alphabetically:</p>
<button class="w3-btn w3-dark-grey" onclick="sortList()">Sort</button>

<ul id="id01" class="w3-ul xw3-border w3-margin-top">
  <li>Oslo</li>
  <li>Stockholm</li>
  <li>Helsinki</li>
  <li>Berlin</li>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_sort_list" class="w3-btn">Try it Yourself &raquo;</a></p>
...
<h2>Creating a Sort Function</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;ul id=&quot;id01&quot;&gt;<br>&nbsp; &lt;li&gt;Oslo&lt;/li&gt;<br>&nbsp; &lt;li&gt;Stockholm&lt;/li&gt;<br>&nbsp; 
  &lt;li&gt;Helsinki&lt;/li&gt;<br>&nbsp; &lt;li&gt;Berlin&lt;/li&gt;<br>&nbsp; &lt;li&gt;Rome&lt;/li&gt;<br>&nbsp; 
  &lt;li&gt;Madrid&lt;/li&gt;<br>&lt;/ul&gt;<br><br>&lt;script&gt;<br>function sortList() {<br>&nbsp; 
  var list, i, switching, b, shouldSwitch;<br>&nbsp; list = 
  document.getElementById(&quot;id01&quot;);<br>&nbsp; switching = true;<br>&nbsp; /* Make 
  a loop that will continue until<br>&nbsp; no switching has been done: */<br>&nbsp; 
  while (switching) {<br>&nbsp;&nbsp;&nbsp; // Start by saying: no switching is 
  done:<br>&nbsp;&nbsp;&nbsp; switching = false;<br>&nbsp;&nbsp;&nbsp; b = 
  list.getElementsByTagName(&quot;LI&quot;);<br>&nbsp;&nbsp;&nbsp; // Loop through all 
  list items:<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; (b.length - 1); i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // Start by saying there should be no switching:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  shouldSwitch = false;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /* Check if the next 
  item should<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; switch place with the current 
  item: */<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (b[i].innerHTML.toLowerCase() &gt; 
  b[i + 1].innerHTML.toLowerCase()) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /* If next item is alphabetically lower than current item,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  mark as a switch and break the loop: */<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  shouldSwitch = true;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; break;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; if (shouldSwitch) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /* If a switch has been marked, make the switch<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  and mark the switch as done: */<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  b[i].parentNode.insertBefore(b[i + 1], b[i]);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  switching = true;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}<br>&lt;/script&gt;<br></div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_sort_list" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>The first time you click the button, the sorting direction is ascending (A to Z).</p>
<p>Click again, and the sorting direction will be descending (Z to A):</p>
<button class="w3-btn" onclick="sortListDir()">Sort</button>
...
<div class="w3-code notranslate htmlHigh">
  &lt;ul id=&quot;id01&quot;&gt;<br>&nbsp; &lt;li&gt;Oslo&lt;/li&gt;<br>&nbsp; &lt;li&gt;Stockholm&lt;/li&gt;<br>&nbsp; 
  &lt;li&gt;Helsinki&lt;/li&gt;<br>&nbsp; &lt;li&gt;Berlin&lt;/li&gt;<br>&nbsp; &lt;li&gt;Rome&lt;/li&gt;<br>&nbsp; 
  &lt;li&gt;Madrid&lt;/li&gt;<br>&lt;/ul&gt;<br><br>&lt;script&gt;<br>function sortListDir() {<br>&nbsp; 
  var list, i, switching, b, shouldSwitch, dir, switchcount = 0;<br>&nbsp; list 
  = document.getElementById(&quot;id01&quot;);<br>&nbsp; switching = true;<br>&nbsp; // Set 
  the sorting direction to ascending:<br>&nbsp; dir = &quot;asc&quot;; <br>&nbsp; // Make a 
  loop that will continue until no switching has been done:<br>&nbsp; while 
  (switching) {<br>&nbsp;&nbsp;&nbsp; // Start by saying: no switching is done:<br>&nbsp;&nbsp;&nbsp; 
  switching = false;<br>&nbsp;&nbsp;&nbsp; b = list.getElementsByTagName(&quot;LI&quot;);<br>&nbsp;&nbsp;&nbsp; 
  // Loop through all list-items:<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; (b.length 
  - 1); i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Start by saying there should 
  be no switching:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; shouldSwitch = false;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /* Check if the next item should switch place with the current item,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  based on the sorting direction (asc or desc): */<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  if (dir == &quot;asc&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (b[i].innerHTML.toLowerCase() 
  &gt; b[i + 1].innerHTML.toLowerCase()) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /* If next item is alphabetically lower than current item,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  mark as a switch and break the loop: */<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  shouldSwitch = true;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  break;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  } else if (dir == &quot;desc&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if 
  (b[i].innerHTML.toLowerCase() &lt; b[i + 1].innerHTML.toLowerCase()) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /* If next item is alphabetically higher than current item,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  mark as a switch and break the loop: */<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  shouldSwitch= true;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  break;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; if (shouldSwitch) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  b[i].parentNode.insertBefore(b[i + 1], b[i]);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  switching = true;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Each time a switch is 
  done, increase switchcount by 1:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; switchcount 
  ++;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /* If no 
  ...
  dir = &quot;desc&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; switching = true;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}<br>&lt;/script&gt;<br></div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_sort_list_desc" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Sort List Numerically</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  if (Number(b[i].innerHTML) &gt; Number(b[i + 1].innerHTML)) {<br>&nbsp; 
  shouldSwitch =&nbsp; true;<br>&nbsp; break;<br>}<br></div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_sort_list_number" target="_blank">Try it Yourself &raquo;</a>
</div>
