...
<html lang="en-US">
<head>
<title>How To Create a Vertical Menu</title>
<meta charset="utf-8">
...
<h1>How TO - Vertical Menu</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_menu_horizontal_scroll.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_bottom_nav.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a vertical menu with CSS.</p>
<hr>

<h2>Vertical Menu</h2>
<div class="w3-bar-block w3-light-grey test" style="width:40%">
<a href="javascript:void(0)" class="w3-bar-item w3-button w3-green w3-hover-green">Home</a>
...
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 4</a>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_vertical_menu" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Create a Vertical Button Group</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;vertical-menu&quot;&gt;<br>&nbsp; &lt;a href=&quot;#&quot; 
  class=&quot;active&quot;&gt;Home&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Link 
  1&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Link 2&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Link 3&lt;/a&gt;<br>&nbsp; 
  &lt;a href=&quot;#&quot;&gt;Link 4&lt;/a&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .vertical-menu {<br>&nbsp;&nbsp; &nbsp;width: 200px; /* Set a width if you like */<br>
  }<br><br>.vertical-menu a {<br>&nbsp;&nbsp;&nbsp; background-color: #eee; 
  /* Grey background color */<br>&nbsp;&nbsp;&nbsp; color: black; /* Black text 
  color */<br>&nbsp;&nbsp;&nbsp; display: block; /* Make the links appear below 
  each other */<br>&nbsp;&nbsp;&nbsp; padding: 12px; /* Add some padding */<br>&nbsp;&nbsp;&nbsp; 
  text-decoration: none; /* Remove underline from links */<br>}<br><br>.vertical-menu a:hover 
  {<br>&nbsp;&nbsp;&nbsp; background-color: #ccc; /* 
  Dark grey background on mouse-over */<br>}<br><br>.vertical-menu a.active {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #4CAF50; /* Add a green color to the &quot;active/current&quot; link 
  */<br>&nbsp;&nbsp;&nbsp; color: white;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_vertical_menu" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-bar-block w3-light-grey test" style="width:40%;height:120px;overflow-y:auto">
<a href="javascript:void(0)" class="w3-bar-item w3-button w3-green w3-hover-green">Home</a>
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 1</a>
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 2</a>
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 3</a>
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 4</a>
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 5</a>
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 6</a>
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 7</a>
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 8</a>
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 9</a>
<a href="javascript:void(0)" class="w3-bar-item w3-button">Link 10</a>
</div>

<p>Set a specific <code class="w3-codespan">height</code> and add the <code class="w3-codespan">overflow</code> property if you want a vertical scroll menu:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_vertical_menu_scroll" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Check out our <a href="howto_js_sidenav.asp">How To - Side Navigation</a> tutorial to learn how to create a fixed, full-height side navigation.</p>
<br>
