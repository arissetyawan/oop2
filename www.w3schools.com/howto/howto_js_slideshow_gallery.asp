...
<h1>How TO - Slideshow Gallery</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_slideshow.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_modal_images.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive slideshow gallery with CSS and JavaScript.</p>
<hr>
...
<div class="slgcontainer">
  ...
  <div class="slgrow">
    <div class="slgcolumn">
      <img class="slgdemo cursor" src="img_woods.jpg" style="width:100%" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="slgcolumn">
      <img class="slgdemo cursor" src="img_5terre.jpg" style="width:100%" onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="slgcolumn">
      <img class="slgdemo cursor" src="img_mountains.jpg" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
    <div class="slgcolumn">
      <img class="slgdemo cursor" src="img_lights.jpg" style="width:100%" onclick="currentSlide(4)" alt="Northern Lights">
    </div>
    <div class="slgcolumn">
      <img class="slgdemo cursor" src="img_nature.jpg" style="width:100%" onclick="currentSlide(5)" alt="Nature and sunrise">
    </div>    
    <div class="slgcolumn" style="width:16.67%">
      <img class="slgdemo cursor" src="img_snow.jpg" style="width:100%" onclick="currentSlide(6)" alt="Snowy Mountains">
    </div>
  </div>
</div>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_slideshow_gallery" class="w3-btn">Try it Yourself &raquo;</a></p>
</div>

<hr>

<h2>Create A Slideshow Gallery</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Container for the image gallery --&gt;<br>&lt;div class=&quot;container&quot;&gt;<br>
  <br>&nbsp; &lt;!-- Full-width images with number text --&gt;<br>&nbsp; &lt;div class=&quot;mySlides&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  ...
  style=&quot;width:100%&quot;&gt;<br>&nbsp; &lt;/div&gt;<br><br>&nbsp; &lt;!-- 
  Next and previous buttons --&gt;<br>&nbsp; &lt;a class=&quot;prev&quot; onclick=&quot;plusSlides(-1)&quot;&gt;&amp;#10094;&lt;/a&gt;<br>&nbsp; 
  &lt;a class=&quot;next&quot; onclick=&quot;plusSlides(1)&quot;&gt;&amp;#10095;&lt;/a&gt;<br>
  <br>&nbsp; &lt;!-- Image text --&gt;<br>&nbsp; &lt;div 
  class=&quot;caption-container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p id=&quot;caption&quot;&gt;&lt;/p&gt;<br>&nbsp; 
  &lt;/div&gt;<br><br>&nbsp; &lt;!-- Thumbnail images --&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div 
...
<p>Style the image gallery, next and previous buttons, the caption text and the dots:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp; box-sizing: border-box;<br>}<br><br>/* Position the image container 
  (needed to position the left and right arrows) */<br>.container {<br>&nbsp; 
  position: relative;<br>}<br><br>/* Hide the images by default */<br>.mySlides {<br>&nbsp; 
  display: none;<br>}<br><br>/* Add a pointer when hovering over the thumbnail 
  images */<br>.cursor {<br>&nbsp; cursor: pointer;<br>}<br><br>/* Next &amp; previous 
  buttons */<br>.prev,<br>.next {<br>&nbsp; cursor: pointer;<br>&nbsp; position: 
  absolute;<br>&nbsp; top: 40%;<br>&nbsp; width: auto;<br>&nbsp; padding: 16px;<br>&nbsp; 
  margin-top: -50px;<br>&nbsp; color: white;<br>&nbsp; font-weight: bold;<br>&nbsp; 
  font-size: 20px;<br>&nbsp; border-radius: 0 3px 3px 0;<br>&nbsp; user-select: 
  none;<br>&nbsp; -webkit-user-select: none;<br>}<br><br>/* Position 
  the &quot;next button&quot; to the right */<br>.next {<br>&nbsp; right: 0;<br>&nbsp; 
  border-radius: 3px 0 0 3px;<br>}<br><br>/* On hover, add a black background color with a 
  little bit see-through */<br>.prev:hover,<br>.next:hover {<br>&nbsp; 
  background-color: rgba(0, 0, 0, 0.8);<br>}<br><br>/* Number text (1/3 etc) */<br>
  .numbertext {<br>&nbsp; color: #f2f2f2;<br>&nbsp; font-size: 12px;<br>&nbsp; 
  padding: 8px 12px;<br>&nbsp; position: absolute;<br>&nbsp; top: 0;<br>}<br><br>/* Container for 
  image text */<br>.caption-container {<br>&nbsp; text-align: center;<br>&nbsp; 
  background-color: #222;<br>&nbsp; padding: 2px 16px;<br>&nbsp; color: white;<br>
  }<br><br>.row:after 
  {<br>&nbsp; content: &quot;&quot;;<br>&nbsp; display: table;<br>&nbsp; clear: both;<br>}<br><br>/* Six 
  columns side by side */<br>.column {<br>&nbsp; float: left;<br>&nbsp; width: 
  16.66%;<br>}<br>
  <br>/* Add a transparency effect for thumnbail images */<br>.demo {<br>&nbsp; 
...
<div class="w3-code notranslate jsHigh">
  var slideIndex = 1;<br>showSlides(slideIndex);<br><br>// Next/previous 
  controls<br>function plusSlides(n) {<br>&nbsp; 
  showSlides(slideIndex += n);<br>}<br><br>// Thumbnail image controls<br>function currentSlide(n) {<br>&nbsp; 
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_slideshow_gallery" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
