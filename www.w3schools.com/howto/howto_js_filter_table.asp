...
<a class="w3-left w3-btn" href="howto_js_filter_lists.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_filter_elements.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_filter_table" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>
...
below the input */<br>}<br><br>#myTable {<br>&nbsp;&nbsp;&nbsp; 
border-collapse: collapse; /* Collapse borders */<br>&nbsp;&nbsp;&nbsp; 
...
table, tr, td, i;<br>&nbsp; input = document.getElementById(&quot;myInput&quot;);<br>&nbsp; 
...
if (td) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (td.innerHTML.toUpperCase().indexOf(filter) 
&gt; -1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; tr[i].style.display = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
tr[i].style.display = &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
} <br>&nbsp; }<br>}<br>
&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_filter_table" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
