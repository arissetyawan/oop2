...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_navbar_image.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_dropdown.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_js_dropdown_hover" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
...
.dropdown-content a:hover {background-color: #ddd;}<br><br>/* Show the 
dropdown menu on hover */<br>.dropdown:hover .dropdown-content {display: block;}<br><br>/* Change the background color of the dropdown 
button when the dropdown content is shown */<br>.dropdown:hover .dropbtn {background-color: #3e8e41;}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_js_dropdown_hover" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
...
<iframe src="tryhow_css_dropdown_right.htm" style="width:100%;border:none;height:300px;"></iframe>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_dropdown_right" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-white w3-padding notranslate">
<iframe src="tryhow_css_dropdown_navbar.htm" style="width:100%;border:none;height:230px;"></iframe>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_dropdown_navbar" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
