...
<html lang="en-US">
<head>
<title>How To Change Bullet Color of a List</title>
<meta charset="utf-8">
...
<h1>How TO - Change Bullet Color of Lists</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_text_selection.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_vertical_line.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to change bullet colors for lists with CSS.</p>
<hr>

<h2>Change Bullet Color</h2>
<ul class="hey">
  <li>Adele</li>
  <li>Agnes</li>
  <li>Billy</li>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_bullet_color" class="w3-btn">Try it Yourself &raquo;</a>
<hr>
<h5>Step 1) Add HTML:</h5>
<p>Create a basic list:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;ul&gt;<br>&nbsp; &lt;li&gt;Adele&lt;/li&gt;<br>&nbsp; &lt;li&gt;Agnes&lt;/li&gt;<br>&nbsp; 
  &lt;li&gt;Billy&lt;/li&gt;<br>&nbsp; &lt;li&gt;Bob&lt;/li&gt;<br>&lt;/ul&gt;</div>
</div>

<h5>Step 2) Add CSS:</h5>
<p>By default, it is not possible to change the bullet color of a list item. 
However, you can do some CSS tricks to make it possible. Note that you might 
have to tweak it a bit differently if you're using a CSS framework or a special 
stylesheet:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  ul {<br>&nbsp; list-style: none; /* Remove default bullets */<br>}<br><br>ul li::before {<br>&nbsp; 
  content: &quot;\2022&quot;;&nbsp; /* Add content: \2022 is the CSS Code/unicode for a 
  bullet */<br>&nbsp; color: red; /* Change the color */<br>&nbsp; font-weight: 
  bold; /* If you want it to be bold */<br>&nbsp; display: inline-block; /* 
  Needed to add space between the bullet and the text */ <br>&nbsp; width: 1em; 
  /* Also needed for space (tweak if needed) */<br>&nbsp; margin-left: -1em; /* 
  Also needed for space (tweak if needed) */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_bullet_color" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
