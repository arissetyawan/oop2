...
<html lang="en-US">
<head>
<title>How To Place a Navigation Menu on an Image</title>
<meta charset="utf-8">
...
<h1>How TO - Navbar on Image</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_navbar_sticky.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_dropdown.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add a navigation menu on an image with CSS.</p>
<hr>
<iframe src="tryhow_css_navbar_on_image.htm"  style="width:100%;border:3px solid #e9e9e9;height:480px;padding:0 10px;"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_navbar_on_image" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Navbar on Image</h2>
<h5>Step 1) Add HTML:</h5>
<p>Create a navigation bar:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;bg-img&quot;&gt;<br>&nbsp; &lt;div class=&quot;container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;div class=&quot;topnav&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#home&quot;&gt;Home&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;a href=&quot;#news&quot;&gt;News&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;a href=&quot;#about&quot;&gt;About&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>
  &lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .bg-img {<br>&nbsp; /* The image used */<br>&nbsp; background-image: url(&quot;img_nature.jpg&quot;);<br>
  <br>&nbsp; min-height: 380px;<br><br>&nbsp; /* Center and scale the image 
  nicely */<br>&nbsp; background-position: center;<br>&nbsp; background-repeat: 
  no-repeat;<br>&nbsp; background-size: cover;<br><br>&nbsp; /* Needed to 
  position the navbar */<br>&nbsp; position: relative;<br>}<br><br>/* Position the navbar container inside the 
  image */<br>.container {<br>&nbsp; position: absolute;<br>&nbsp; margin: 20px;<br>&nbsp; 
  width: auto;<br>}<br><br>/* The navbar */<br>.topnav {<br>&nbsp; overflow: hidden;<br>&nbsp; 
  background-color: #333;<br>}<br><br>/* Navbar links */<br>.topnav a {<br>&nbsp; 
  float: left;<br>&nbsp; color: #f2f2f2;<br>&nbsp; text-align: center;<br>&nbsp; 
  padding: 14px 16px;<br>&nbsp; text-decoration: none;<br>&nbsp; font-size: 
  17px;<br>}<br><br>.topnav a:hover {<br>&nbsp; 
  background-color: #ddd;<br>&nbsp; color: black;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_navbar_on_image" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
