...
<a class="w3-left w3-btn" href="howto_css_image_overlay_icon.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_bw.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>Image Filters</h2>
<iframe src="/css/trycss_ex_images_filters.htm" style="width:100%;border:none;height:600px;padding:2%;border:1px solid #f1f1f1;"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_filter_grayscale" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>
<h2>CSS Filters</h2>
...
<div class="img">
 <img src="pineapple.jpg" alt="Pineapple" class="w3-image">
 <div class="desc">Original image</div>
</div>

<div class="img">
 <img class="w3-image filter_gray" src="pineapple.jpg" alt="Pineapple">
 <div class="desc">grayscale(100%)</div>
</div>
<p style="clear:both;"></p>
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=tryhow_filter_grayscale">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh"> 
 img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: blur(5px); /* Safari 6.0 - 9.0 */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_blur" src="pineapple.jpg" alt="Pineapple">
 <div class="desc">blur(5px)</div>
</div>
<p style="clear:both;"></p>
</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=tryhow_filter_blur">Try it Yourself &raquo;</a>
</div>

<p style="margin-top:30px">Go to our <a href="/cssref/css3_pr_filter.asp">CSS filter Property</a> to learn more about 
CSS filters.</p>
