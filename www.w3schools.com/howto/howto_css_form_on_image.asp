...
<html lang="en-US">
<head>
<title>How To Add a Form to an Image</title>
<meta charset="utf-8">
...
<h1>How TO - Form on Image</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_full_page.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_hero_image.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add a form to a full-width image with CSS.</p>
<hr>

<h2>Form on Image</h2>
<iframe src="tryhow_css_form_on_image_ifr.htm" scrolling="no" style="border:none;overflow:hidden;height:380px;width:100%;"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_css_form_on_image" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Add a Form to an Image</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;bg-img&quot;&gt;<br>&nbsp; &lt;form action=&quot;/action_page.php&quot; 
  class=&quot;container&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&gt;Login&lt;/h1&gt;<br>
  <br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;label for=&quot;email&quot;&gt;&lt;b&gt;Email&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;input type=&quot;text&quot; placeholder=&quot;Enter Email&quot; name=&quot;email&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;label for=&quot;psw&quot;&gt;&lt;b&gt;Password&lt;/b&gt;&lt;/label&gt;<br>
  &nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;password&quot; placeholder=&quot;Enter Password&quot; name=&quot;psw&quot; required&gt;<br>
  <br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;button type=&quot;submit&quot; class=&quot;btn&quot;&gt;Login&lt;/button&gt;<br>&nbsp; &lt;/form&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  body, html {<br>&nbsp; height: 100%;<br>}<br><br>* {<br>&nbsp; box-sizing: border-box;<br>}<br><br>.bg-img {<br>&nbsp; 
  /* The image used */<br>&nbsp; background-image: url(&quot;img_nature.jpg&quot;);<br>
  <br>&nbsp; /* Control the height of the image */<br>&nbsp; min-height: 380px;<br>
  <br>&nbsp; /* Center and scale the image nicely */<br>&nbsp; 
  background-position: center;<br>&nbsp; background-repeat: no-repeat;<br>&nbsp; 
  background-size: cover;<br>&nbsp; position: relative;<br>}<br><br>/* Add styles to the form container */<br>
  .container {<br>&nbsp; position: absolute;<br>&nbsp; right: 0;<br>&nbsp; 
  margin: 20px;<br>&nbsp; max-width: 300px;<br>&nbsp; padding: 16px;<br>&nbsp; 
  background-color: white;<br>}<br><br>/* 
  Full-width input fields */<br>&nbsp; input[type=text], input[type=password] {<br>&nbsp; 
  width: 100%;<br>&nbsp; padding: 15px;<br>&nbsp; margin: 5px 0 22px 0;<br>&nbsp; 
  border: none;<br>&nbsp; background: #f1f1f1;<br>}<br><br>input[type=text]:focus, 
  input[type=password]:focus {<br>&nbsp; background-color: #ddd;<br>&nbsp; 
  outline: none;<br>}<br>
  <br>/* Set a style for the submit button */<br>.btn {<br>&nbsp; 
  background-color: #4CAF50;<br>&nbsp; color: white;<br>&nbsp; padding: 16px 
  20px;<br>&nbsp; border: none;<br>&nbsp; cursor: pointer;<br>&nbsp; width: 
  100%;<br>&nbsp; opacity: 0.9;<br>}<br><br>.btn:hover {<br>&nbsp; 
  opacity: 1;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_form_on_image" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
