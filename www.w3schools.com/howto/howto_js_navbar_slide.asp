...
<html lang="en-US">
<head>
<title>How To Slide Down a Bar on Scroll</title>
<meta charset="utf-8">
...
<h1>How TO - Slide Down a Bar on Scroll</h1>
<div class="w3-clear nextprev">
    <a class="w3-left w3-btn" href="howto_css_fixed_menu.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_navbar_hide_scroll.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to slide down a navigation bar on scroll with CSS and JavaScript.</p>
<hr>
<iframe src="tryhow_js_navbar_slide.htm" class="w3-border w3-border-light-grey" style="width:100%;border:none;height:200px;padding:0"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_navbar_slide" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Slide Down a Bar</h2>
...
<div class="w3-code notranslate cssHigh">
  #navbar {<br>&nbsp;&nbsp;&nbsp; background-color: #333; /* Black background 
  color */<br>&nbsp;&nbsp;&nbsp; position: fixed; /* Make it stick/fixed  
  */<br>&nbsp;&nbsp;&nbsp; top: -50px; /* Hide the navbar 50 px outside of the 
  top view */<br>&nbsp;&nbsp;&nbsp; width: 100%; /* Full width */<br>&nbsp;&nbsp;&nbsp; 
  transition: top 0.3s; /* Transition effect when sliding down (and up) */<br>}<br>
  <br>/* Style the navbar links */<br>#navbar a {<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; 
...
<div class="w3-code notranslate jsHigh">
  ...
  the navbar<br>// When the user scrolls to the top of the page, slide up the 
  navbar (50px out of the top view)<br>window.onscroll = function() {scrollFunction()};<br>
  <br>function 
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_navbar_slide" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
