...
<h1>How TO - Download Button</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_loading_buttons.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_pill_button.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style download buttons with CSS.</p>
<hr>

<p>Auto width:</p>
<p><button class="btnic"><i class="fa fa-download"></i> Download</button></p>
<p>Full width:</p><p><button class="btnic w3-block"><i class="fa fa-download"></i> Download</button></p>
<a target="_blank" href="tryit.asp?filename=tryhow_css_download_button" class="w3-btn">Try it Yourself &raquo;</a>

<hr>

<h2>How To Create Download Buttons</h2>
...
&lt;!-- Add icon library --&gt;<br>&lt;link rel=&quot;stylesheet&quot; href=&quot;https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css&quot;&gt;<br>
  <br>&lt;!-- Auto width --&gt;<br>&lt;button class=&quot;btn&quot;&gt;&lt;i class=&quot;fa fa-download&quot;&gt;&lt;/i&gt; Download&lt;/button&gt;<br>
  <br>&lt;!-- Full width --&gt;<br>&lt;button class=&quot;btn&quot; 
  style=&quot;width:100%&quot;&gt;&lt;i class=&quot;fa fa-download&quot;&gt;&lt;/i&gt; Download&lt;/button&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style buttons */<br>.btn {<br>&nbsp; background-color: DodgerBlue;<br>&nbsp; 
  border: none;<br>&nbsp; color: white;<br>&nbsp; padding: 12px 30px;<br>&nbsp; cursor: pointer;<br>&nbsp; font-size: 20px;<br>}<br><br>/* Darker background on mouse-over */<br>
  .btn:hover {<br>&nbsp; background-color: RoyalBlue;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_download_button" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_loading_buttons.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_pill_buttonn.asp">Next &#10095;</a>
</div>
</div>
