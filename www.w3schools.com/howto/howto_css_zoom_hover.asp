...
<html lang="en-US">
<head>
<title>How To Zoom on Hover with CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Zoom on Hover</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_redirect_webpage.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_flip_box.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to zoom/scale an element on hover with CSS.</p>
<hr>

<div class="w3-center">
<h1>Zoom on Hover</h1>
<p>Hover over the green box:</p>
  
<div class="zoom"></div>
</div>
<hr>

<h2>How To Zoom on Hover</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>.zoom {<br>&nbsp;&nbsp;&nbsp; padding: 50px;<br>&nbsp;&nbsp;&nbsp; 
  background-color: green;<br>&nbsp;&nbsp;&nbsp; transition: transform .2s; /* 
  Animation */<br>&nbsp;&nbsp;&nbsp; width: 200px;<br>&nbsp;&nbsp;&nbsp; height: 
  200px;<br>&nbsp;&nbsp;&nbsp; margin: 0 auto;<br>}<br><br>.zoom:hover {<br>&nbsp;&nbsp;&nbsp; transform: 
  scale(1.5); /* (150% zoom - Note: if the zoom is too large, it will go outside 
  of the viewport) */<br>}<br>&lt;/style&gt;<br><br>&lt;div class=&quot;zoom&quot;&gt;&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_zoom_hover" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
