...
<html lang="en-US">
<head>
<title>How To Create a Tab Header</title>
<meta charset="utf-8">
...
<p style="margin-top:2px"><a target="_blank" href="tryit.asp?filename=tryhow_js_tab_header" class="w3-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate cssHigh">
  /* Style the tab buttons */<br>.tablink {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #555;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
  float: left;<br>&nbsp;&nbsp;&nbsp; border: none;<br>&nbsp;&nbsp;&nbsp; 
  outline: none;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>&nbsp;&nbsp;&nbsp; 
  padding: 14px 16px;<br>&nbsp;&nbsp;&nbsp; font-size: 17px;<br>&nbsp;&nbsp;&nbsp; 
  width: 25%;<br>}<br>
  <br>/* Change background color of buttons on hover */<br>.tablink:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #777;<br>}<br><br>/* Set default styles for tab content */<br>.tabcontent 
  {<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; display: none;<br>&nbsp;&nbsp;&nbsp; 
  padding: 50px;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>}<br><br>/* Style 
  each tab content individually */ <br>#London {background-color:red;}<br>#Paris {background-color:green;}<br>
...
<div class="w3-code notranslate jsHigh">
  function openCity(cityName, elmnt, color) {<br>&nbsp;&nbsp;&nbsp; // Hide all 
  ...
  document.getElementById(cityName).style.display = &quot;block&quot;;<br><br>&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_tab_header" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
