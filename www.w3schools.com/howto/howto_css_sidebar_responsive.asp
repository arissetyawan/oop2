...
<html lang="en-US">
<head>
<title>How To Create a Responsive Sidebar</title>
<meta charset="utf-8">
...
<h1>How TO - Responsive Sidebar</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_sidenav.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_fullscreen_overlay.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive side navigation menu with CSS.</p>
<hr>
<iframe src="tryhow_css_sidebar_responsive.htm" style="width:100%;border:4px solid #e9e9e9;height:300px;padding:0;"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_css_sidebar_responsive" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>

<h2>Create a Responsive Sidebar</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- The sidebar --&gt;<br>&lt;div class=&quot;sidebar&quot;&gt;<br>&nbsp; &lt;a class=&quot;active&quot; href=&quot;#home&quot;&gt;Home&lt;/a&gt;<br>&nbsp; 
  &lt;a href=&quot;#news&quot;&gt;News&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>&nbsp; &lt;a 
  href=&quot;#about&quot;&gt;About&lt;/a&gt;<br>&lt;/div&gt;<br><br>&lt;!-- Page content --&gt;<br>&lt;div 
  class=&quot;content&quot;&gt;<br>&nbsp; ..<br>
  &lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* The side navigation menu */<br>.sidebar {<br>&nbsp; margin: 0;<br>&nbsp; 
  padding: 0;<br>&nbsp; width: 200px;<br>&nbsp; background-color: #f1f1f1;<br>&nbsp; 
  position: fixed;<br>&nbsp; height: 100%;<br>&nbsp; overflow: auto;<br>}<br><br>/* Sidebar links */<br>.sidebar a {<br>&nbsp; display: 
  block;<br>&nbsp; color: black;<br>&nbsp; padding: 16px;<br>&nbsp; 
  text-decoration: none;<br>}<br><br>/* Active/current link */<br>.sidebar a.active {<br>&nbsp; 
  background-color: #4CAF50;<br>&nbsp; color: white;<br>}<br><br>/* Links on 
  mouse-over */<br>.sidebar a:hover:not(.active) {<br>&nbsp; background-color: #555;<br>&nbsp; 
  color: white;<br>}<br><br>/* Page content. The value of the margin-left 
  property should match the value of the sidebar's width property */<br>
  div.content {<br>&nbsp; margin-left: 200px;<br>&nbsp; padding: 1px 16px;<br>&nbsp; 
  height: 1000px;<br>}<br><br>/* On screens that are less than 700px wide, make 
  the sidebar into a topbar */<br>@media screen and (max-width: 700px) {<br>&nbsp; .sidebar 
  {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; height: auto;<br>&nbsp;&nbsp;&nbsp; 
  position: relative;<br>&nbsp; }<br>&nbsp; .sidebar a {float: left;}<br>&nbsp; 
  div.content {margin-left: 0;}<br>}<br><br>/* On screens that are less than 
  400px, display the bar vertically, instead of horizontally */<br>@media screen 
  and (max-width: 400px) {<br>&nbsp; .sidebar a {<br>&nbsp;&nbsp;&nbsp; text-align: 
  center;<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_sidebar_responsive" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
