...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_table_zebra.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_comparison_table.asp">Next &#10095;</a>
</div>
<hr>
...
<br>
<p>To create a responsive table, add a container element with <code class="w3-codespan">overflow-x:auto</code> 
around the &lt;table&gt;:</p>
...
&lt;/table&gt;<br>&lt;/div&gt;<br></div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_css_table_responsive" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-note w3-panel">
<p><strong>Note:</strong> In OS X Lion (on Mac), scrollbars are hidden by default and only shown when being used (even though "overflow:scroll" or auto is set).</p>
</div>

<p>Go to our <a href="/css/css_table.asp">CSS Tables Tutorial</a> to learn more about 
how to style 
tables.</p>
<br>
<div class="w3-clear nextprev">
