...
<a class="w3-left w3-btn" href="howto_js_slideshow_gallery.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_lightbox.asp">Next &#10095;</a>
</div>
<hr>
...
<p>This example use most of the code from the previous example, <a href="howto_css_modals.asp">Modal Boxes</a>, only in this example, we use images.</p>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_modal_img" class="w3-btn">Try it Yourself &raquo;</a></p>
...
&lt;!-- Trigger the Modal --&gt;<br>&lt;img id="myImg" src="img_snow.jpg" 
alt="Snow" style=&quot;width:100%;max-width:300px&quot;&gt;<br><br>&lt;!-- The Modal 
--&gt;<br>&lt;div id="myModal" 
class="modal"&gt;<br><br>&nbsp; &lt;!-- The Close Button --&gt;<br>&nbsp; &lt;span class="close"&gt;&amp;times;&lt;/span&gt;<br>
...
.modal-content, #caption { <br>&nbsp;&nbsp;&nbsp; animation-name: zoom;<br>&nbsp;&nbsp;&nbsp; 
animation-duration: 0.6s;<br>}<br><br>
...
modal.style.display = "block";<br>&nbsp;&nbsp;&nbsp; modalImg.src = this.src;<br>&nbsp;&nbsp;&nbsp; captionText.innerHTML = 
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_modal_img" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Also check out <a href="howto_css_modals.asp">Modals</a> and <a href="howto_js_lightbox.asp">Lightbox</a>.</p>
