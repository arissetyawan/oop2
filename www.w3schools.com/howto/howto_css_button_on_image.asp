...
<html lang="en-US">
<head>
<title>How To Add a Button to an Image</title>
<meta charset="utf-8">
...
<h1>How TO - Button on Image</h1>
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="howto_css_fading_buttons.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_social_media_buttons.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add a button to an image with CSS.</p>
<hr>

<h2>Button on Image</h2>

<div class="container">
  <img src="img_snow.jpg" alt="Snow" class="image" style="width:100%">
  <div class="middle">
    <button class="btn">Button</button>
  </div>
</div>

<a target="_blank" href="tryit.asp?filename=tryhow_css_button_on_image" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>

<h2>How To Add Button over Image</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;img src=&quot;img_snow.jpg&quot; alt=&quot;Snow&quot;&gt;<br>&nbsp; 
  &lt;button class=&quot;btn&quot;&gt;Button&lt;/button&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Container needed to position the button. Adjust the width as needed */<br>
  .container {<br>&nbsp; position: relative;<br>&nbsp; width: 
  50%;<br>}<br><br>/* Make the 
  image responsive */<br>.container img {<br>&nbsp; width: 100%;<br>&nbsp; 
  height: auto;<br>}<br><br>/* Style the button and place it in the middle of 
  the container/image */<br>.container .btn {<br>&nbsp; position: absolute;<br>&nbsp; 
  top: 50%;<br>&nbsp; left: 50%;<br>&nbsp; transform: translate(-50%, -50%);<br>&nbsp; 
  -ms-transform: translate(-50%, -50%);<br>&nbsp; background-color: #555;<br>&nbsp; 
  color: white;<br>&nbsp; font-size: 16px;<br>&nbsp; padding: 12px 24px;<br>&nbsp; 
  border: none;<br>&nbsp; cursor: pointer;<br>&nbsp; border-radius: 5px;<br>}<br><br>
  .container .btn:hover {<br>&nbsp; background-color: black;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_button_on_image" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<br>
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="howto_css_fading_button.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_social_media_buttons.asp">Next &#10095;</a>
</div>
</div>
