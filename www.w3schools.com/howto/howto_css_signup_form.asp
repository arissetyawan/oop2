...
<html lang="en-US">
<head>
<title>How To Create a Sign Up Form</title>
<meta charset="utf-8">
...
.w3-modal input[type=text], .w3-modal input[type=password] {
    width: 100%;
    padding: 15px;
    margin: 5px 0 16px 0;
    display: inline-block;
...
.w3-modal input[type=text]:focus, .w3-modal input[type=password]:focus {
...
<h1>How TO - Sign Up Form</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_login_form.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_checkout_form.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive sign up form with CSS.</p>
<hr>

<p>Click on the button to open the sign up form:</p>
<button onclick="document.getElementById('id01').style.display='block'" class="w3-btn w3-blue w3-padding-large">Sign Up</button>

<div id="id01" class="w3-modal" style="cursor:pointer;background-color: rgba(0,0,0,0.75);">
    <span onclick="document.getElementById('id01').style.display='none'" title="Close Modal"
  class="w3-hover-text-red w3-container w3-text-white w3-display-topright w3-xxxlarge" style="right:50px;">&times;</span>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryhow_css_signup_form_modal" class="w3-btn">Try it Yourself &raquo;</a>
</p>
<hr>

<h2>How To Create a Sign Up Form</h2>
<h5>Step 1) Add HTML:</h5>
<p>Use a &lt;form&gt; element to process the input. You can learn more about this in our <a href="/php/default.asp">PHP</a> tutorial. Then add 
inputs (with a matching label) for each field:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate htmlHigh">
    &lt;form action=&quot;action_page.php&quot; style=&quot;border:1px solid #ccc&quot;&gt;<br>&nbsp; &lt;div 
    class=&quot;container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;h1&gt;Sign Up&lt;/h1&gt;<br>&nbsp;&nbsp;&nbsp; 
    &lt;p&gt;Please fill in this form to create an account.&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; 
    &lt;hr&gt;<br><br>&nbsp;&nbsp;&nbsp; &lt;label for=&quot;email&quot;&gt;&lt;b&gt;Email&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; 
    &lt;input type=&quot;text&quot; placeholder=&quot;Enter Email&quot; name=&quot;email&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp; 
    &lt;label for=&quot;psw&quot;&gt;&lt;b&gt;Password&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input type=&quot;password&quot; 
    placeholder=&quot;Enter Password&quot; name=&quot;psw&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp; 
    ...
    <br>&nbsp;&nbsp;&nbsp; &lt;label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input 
    type=&quot;checkbox&quot; checked=&quot;checked&quot; name=&quot;remember&quot; style=&quot;margin-bottom:15px&quot;&gt; Remember me<br>&nbsp;&nbsp;&nbsp; 
    &lt;/label&gt;<br><br>&nbsp;&nbsp;&nbsp; &lt;p&gt;By creating an account you agree to 
    our &lt;a href=&quot;#&quot; style=&quot;color:dodgerblue&quot;&gt;Terms &amp; Privacy&lt;/a&gt;.&lt;/p&gt;<br><br>&nbsp;&nbsp;&nbsp; 
    &lt;div class=&quot;clearfix&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;button 
    type=&quot;button&quot; class=&quot;cancelbtn&quot;&gt;Cancel&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    &lt;button type=&quot;submit&quot; class=&quot;signupbtn&quot;&gt;Sign Up&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; 
    &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/form&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box}<br><br>/* Full-width input fields */<br>&nbsp; 
  input[type=text], input[type=password] {<br>&nbsp; width: 100%;<br>&nbsp; 
  padding: 15px;<br>&nbsp; margin: 5px 0 22px 0;<br>&nbsp; display: 
  inline-block;<br>&nbsp; border: none;<br>&nbsp; background: #f1f1f1;<br>}<br><br>input[type=text]:focus, 
  input[type=password]:focus {<br>&nbsp; background-color: #ddd;<br>&nbsp; 
  outline: none;<br>}<br><br>hr {<br>&nbsp; border: 1px solid #f1f1f1;<br>&nbsp; 
  margin-bottom: 25px;<br>}<br><br>/* 
  Set a style for all buttons */<br>button {<br>&nbsp; background-color: 
  #4CAF50;<br>&nbsp; color: white;<br>&nbsp; padding: 14px 20px;<br>&nbsp; 
  margin: 8px 0;<br>&nbsp; border: none;<br>&nbsp; cursor: pointer;<br>&nbsp; 
  width: 100%;<br>&nbsp; opacity: 0.9;<br>}<br><br>button:hover {<br>&nbsp; opacity:1;<br>}<br><br>/* Extra styles for the 
  cancel button */<br>.cancelbtn {<br>&nbsp; padding: 14px 20px;<br>&nbsp; 
  background-color: #f44336;<br>}<br><br>/* Float cancel and signup buttons and 
  add an equal width */<br>.cancelbtn, .signupbtn {<br>&nbsp; float: left;<br>&nbsp; 
  width: 50%;<br>}<br><br>/* Add padding to container elements */<br>.container {<br>&nbsp; 
  padding: 16px;<br>}<br><br>/* Clear floats */<br>.clearfix::after {<br>&nbsp; 
  content: &quot;&quot;;<br>&nbsp; clear: both;<br>&nbsp; display: table;<br>}<br><br>/* Change styles 
  for cancel button and signup button on extra small screens */<br>@media screen 
  and (max-width: 300px) {<br>&nbsp; .cancelbtn, .signupbtn {<br>&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_signup_form" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>How To Create a Modal Sign Up Form</h2>
<h5>Step 1) Add HTML:</h5>
<p>Use a &lt;form&gt; element to process the input. You can learn more about this in our <a href="/php/default.asp">PHP</a> tutorial. Then add 
inputs (with a matching label) for each field:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Button to open the modal --&gt;<br>&lt;button onclick=&quot;document.getElementById('id01').style.display='block'&quot;&gt;Sign 
  Up&lt;/button&gt;<br><br>&lt;!-- The Modal (contains the Sign Up form) --&gt;<br>
  &lt;div id=&quot;id01&quot; class=&quot;modal&quot;&gt;<br>&nbsp; &lt;span onclick=&quot;document.getElementById('id01').style.display='none'&quot; 
  class=&quot;close&quot; title=&quot;Close Modal&quot;&gt;times;&lt;/span&gt;<br>&nbsp; &lt;form 
  class=&quot;modal-content&quot; action=&quot;/action_page.php&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div 
  class=&quot;container&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;h1&gt;Sign Up&lt;/h1&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;p&gt;Please fill in this form to create an account.&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;hr&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;label for=&quot;email&quot;&gt;&lt;b&gt;Email&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;text&quot; placeholder=&quot;Enter Email&quot; name=&quot;email&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;label for=&quot;psw&quot;&gt;&lt;b&gt;Password&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input 
  type=&quot;password&quot; placeholder=&quot;Enter Password&quot; name=&quot;psw&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;label for=&quot;psw-repeat&quot;&gt;&lt;b&gt;Repeat Password&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input 
  type=&quot;password&quot; placeholder=&quot;Repeat Password&quot; name=&quot;psw-repeat&quot; required&gt;<br>
  <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  &amp; Privacy&lt;/a&gt;.&lt;/p&gt;<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class=&quot;clearfix&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;button type=&quot;button&quot; onclick=&quot;document.getElementById('id01').style.display='none'&quot; 
  class=&quot;cancelbtn&quot;&gt;Cancel&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;button type=&quot;submit&quot; class=&quot;signup&quot;&gt;Sign Up&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box}<br>/* Full-width input fields */<br>&nbsp; 
  input[type=text], input[type=password] {<br>&nbsp; width: 100%;<br>&nbsp; 
  padding: 15px;<br>&nbsp; margin: 5px 0 22px 0;<br>&nbsp; display: 
  inline-block;<br>&nbsp; border: none;<br>&nbsp; background: #f1f1f1;<br>}<br><br>/* Add a background color when the inputs get 
  focus */<br>input[type=text]:focus, input[type=password]:focus {<br>&nbsp; 
  background-color: #ddd;<br>&nbsp; outline: none;<br>}<br><br>/* Set a style for all 
  buttons */<br>button {<br>&nbsp; background-color: #4CAF50;<br>&nbsp; color: 
  white;<br>&nbsp; padding: 14px 20px;<br>&nbsp; margin: 8px 0;<br>&nbsp; 
  border: none;<br>&nbsp; cursor: pointer;<br>&nbsp; width: 100%;<br>&nbsp; 
  opacity: 0.9;<br>}<br><br>
  button:hover {<br>&nbsp; opacity:1;<br>}<br><br>/* Extra styles for the cancel button 
  */<br>.cancelbtn {<br>&nbsp; padding: 14px 20px;<br>&nbsp; background-color: 
  #f44336;<br>}<br><br>/* Float cancel and signup buttons and add an equal width 
  */<br>.cancelbtn, .signupbtn {<br>&nbsp; float: left;<br>&nbsp; width: 50%;<br>
  }<br><br>/* 
  Add padding to container elements */<br>.container {<br>&nbsp; padding: 
  16px;<br>}<br><br>/* The Modal (background) */<br>.modal {<br>&nbsp; display: none; /* 
  Hidden by default */<br>&nbsp; position: fixed; /* Stay in place */<br>&nbsp; 
  z-index: 1; /* Sit on top */<br>&nbsp; left: 0;<br>&nbsp; top: 0;<br>&nbsp; 
  width: 100%; /* Full width */<br>&nbsp; height: 100%; /* Full height */<br>&nbsp; 
  overflow: auto; /* Enable scroll if needed */<br>&nbsp; background-color: 
  #474e5d;<br>&nbsp; padding-top: 50px;<br>}<br><br>/* Modal 
  Content/Box */<br>.modal-content {<br>&nbsp; background-color: #fefefe;<br>&nbsp; 
  margin: 5% auto 15% auto; /* 5% from the top, 15% from the bottom and centered 
  */<br>&nbsp; border: 1px solid #888;<br>&nbsp; width: 80%; /* Could be more or 
  less, depending on screen size */<br>}<br><br>/* Style the horizontal ruler */<br>hr {<br>&nbsp; 
  border: 1px solid #f1f1f1;<br>&nbsp; margin-bottom: 25px;<br>}<br><br>/* The Close Button (x) 
  */<br>.close {<br>&nbsp; position: absolute;<br>&nbsp; right: 35px;<br>&nbsp; 
  top: 15px;<br>&nbsp; font-size: 40px;<br>&nbsp; font-weight: bold;<br>&nbsp; 
  color: #f1f1f1;<br>}<br><br>.close:hover,<br>
  .close:focus {<br>&nbsp; color: #f44336;<br>&nbsp; cursor: pointer;<br>}<br><br>/* Clear 
  floats */<br>.clearfix::after {<br>&nbsp; content: &quot;&quot;;<br>&nbsp; clear: both;<br>&nbsp; 
  display: table;<br>}<br><br>/* Change styles for cancel button and signup button on 
  extra small screens */<br>@media screen and (max-width: 300px) {<br>&nbsp; .cancelbtn, 
  .signupbtn {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp; }<br>}</div>
</div>

<p><strong>Tip:</strong> You can also use the following javascript to close the modal by clicking outside of the modal content (and not just by using the "x" or "cancel" button to close it):</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script&gt;<br>// Get the modal<br>var modal = document.getElementById('id01');<br>
<br>// When the user clicks anywhere outside of the modal, close it<br>
window.onclick = function(event) {<br>&nbsp;&nbsp;&nbsp; if (event.target == 
modal) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; modal.style.display = 
&quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>
&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_signup_form_modal" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Go to our <a href="/html/html_forms.asp">HTML Form Tutorial</a> to learn 
more about HTML Forms.</p>

<p><strong>Tip:</strong> Go to our <a href="/css/css_form.asp">CSS Form Tutorial</a> to learn 
more about how to style form elements.</p>
<br>
