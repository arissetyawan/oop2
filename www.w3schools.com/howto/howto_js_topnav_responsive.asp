...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_topnav.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_navbar_icon.asp">Next &#10095;</a>
</div>
<hr>
...
<ul id="myUl" class="topnav2">
  <li><a href="javascript:void(0);" class="w3-green">Home</a></li>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_topnav" class="w3-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate htmlHigh">
  ...
  <br>&lt;div class="topnav" 
id="myTopnav"&gt;<br>&nbsp; &lt;a href=&quot;#home&quot; class=&quot;active&quot;&gt;Home&lt;/a&gt;<br>&nbsp; 
...
<p>The link with class="icon" is used to open and close the topnav on small 
screens.</p>
<hr>
...
/* 
  ...
  background-color: #333;<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>}<br><br>/* 
Style the links inside the navigation bar */<br>.topnav a {<br>&nbsp;&nbsp;&nbsp; 
  ...
  color: black;<br>}<br><br>/* Add an active class to highlight the current page 
  */<br>.active {<br>&nbsp;&nbsp;&nbsp; background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>}<br><br>/* Hide the link that should open and close the topnav on small screens */<br>
...
contains should open and close the topnav (.icon) */<br>@media screen and (max-width: 600px) {<br>&nbsp; .topnav 
  a:not(:first-child) 
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_topnav" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
