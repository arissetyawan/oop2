...
<html lang="en-US">
<head>
<title>How To Create a Length Converter With HTML and JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - Length Converter</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_temperature_converter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_speed_converter.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a Length converter with HTML and JavaScript.</p>
<hr>
...
<hr>
<h2>Create a Length Converter</h2>
<p>Create an input element that can convert a value from one Length measurement to another.</p>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example - Feet to Meter</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;p&gt;<br>&nbsp; &lt;label&gt;Feet&lt;/label&gt;<br>&nbsp; &lt;input id="inputFeet" type="number" placeholder="Feet"<br>&nbsp; oninput="lengthConverter(this.value)" onchange="lengthConverter(this.value)"&gt;<br>&lt;/p&gt;<br>&lt;p&gt;cm: &lt;span id="outputMeters"&gt;&lt;/span&gt;&lt;/p&gt;</div>
</div>

<hr>

<h5>Step 2) Add JavaScript:</h5>
<div class="w3-example">
<h3>Example - Feet to Meter</h3>
<div class="w3-code notranslate jsHigh">
/* When the input field receives input, convert the value from feet to meters */<br>
 function lengthConverter(valNum) {<br>&nbsp; document.getElementById("outputMeters").innerHTML = valNum / 0.0022046;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_length_converter_feet_to_meters" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h2>Convert from Feet to other Measurements</h2>
<p>The table below shows how to convert from Feet to other Length 
measurements:</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>Convert from Feet to Meters</td>
    <td>m=ft/3.2808</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_feet_to_meters">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Feet to Inches</td>
    <td>in=ft*12</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_feet_to_inches">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Feet to cm</td>
    <td>cm=ft/0.032808</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_feet_to_cm">Try it</a></td>
  </tr>
    <tr>
    <td>Convert from Feet to Yards</td>
    <td>yd=ft*0.33333</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_feet_to_yards">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Feet to Kilometers</td>
    <td>km=ft/3280.8</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_feet_to_kilometers">Try it</a></td>
    </tr>
    <tr>
    <td>Convert from Feet to Miles</td>
    <td>mi=ft*0.00018939</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_feet_to_miles">Try it</a></td>
    </tr>
...
<h2>Convert from Meters to other Measurements</h2>
<p>The table below shows how to convert from Meters to other Length 
measurements:</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>Convert from Meters to Feet</td>
    <td>ft=m*3.2808</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_meters_to_feet">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Meters to Inches</td>
    <td>in=m*39.370</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_meters_to_inches">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Meters to cm</td>
    <td>cm=m/0.01</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_meters_to_cm">Try it</a></td>
  </tr>
    <tr>
    <td>Convert from Meters to Yards</td>
    <td>yd=m*1.0936</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_meters_to_yards">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Meters to Kilometers</td>
    <td>km=m/1000</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_meters_to_kilometers">Try it</a></td>
    </tr>
    <tr>
    <td>Convert from Meters to Miles</td>
    <td>mi=m*0.00062137</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_meters_to_miles">Try it</a></td>
    </tr>
...
<h2>Convert from Inches to other Measurements</h2>
<p>The table below shows how to convert from Inches to other Length 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from Inches to Feet</td>
    <td>ft=in*0.083333</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_inches_to_feet">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Inches to Meters</td>
    <td>m=in/39.370</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_inches_to_meters">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Inches to cm</td>
    <td>cm=in/0.39370</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_inches_to_cm">Try it</a></td>
  </tr>
    <tr>
    <td>Convert from Inches to Yards</td>
    <td>yd=in*0.027778</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_inches_to_yards">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Inches to Kilometers</td>
    <td>km=in/39370</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_inches_to_kilometers">Try it</a></td>
    </tr>
    <tr>
    <td>Convert from Inches to Miles</td>
    <td>mi=in*0.000015783</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_inches_to_miles">Try it</a></td>
    </tr>
...
<h2>Convert from cm to other Measurements</h2>
<p>The table below shows how to convert from cm to other Length 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from cm to Feet</td>
    <td>ft=cm*0.032808</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_cm_to_feet">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from cm to Meters</td>
    <td>m=cm/100</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_cm_to_meters">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from cm to Inches</td>
    <td>in=cm*0.39370</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_cm_to_inches">Try it</a></td>
  </tr>
    <tr>
    <td>Convert from cm to Yards</td>
    <td>yd=cm*0.010936</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_cm_to_yards">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from cm to Kilometers</td>
    <td>km=cm/100000</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_cm_to_kilometers">Try it</a></td>
    </tr>
    <tr>
    <td>Convert from cm to Miles</td>
    <td>mi=cm*0.0000062137</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_cm_to_miles">Try it</a></td>
    </tr>
...
<h2>Convert from Yards to other Measurements</h2>
<p>The table below shows how to convert from Yards to other Length 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from Yards to Feet</td>
    <td>ft=yd*3</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_yards_to_feet">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Yards to Meters</td>
    <td>m=yd/1.0936</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_yards_to_meters">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Yards to Inches</td>
    <td>in=yd*36</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_yards_to_inches">Try it</a></td>
  </tr>
    <tr>
    <td>Convert from Yards to cm</td>
    <td>cm=yd/0.010936</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_yards_to_cm">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Yards to Kilometers</td>
    <td>km=yd/1093.6</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_yards_to_kilometers">Try it</a></td>
    </tr>
    <tr>
    <td>Convert from Yards to Miles</td>
    <td>mi=yd*0.00056818</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_yards_to_miles">Try it</a></td>
    </tr>
</table>
<hr>
<h2>Convert from Kilometers to other Measurements</h2>
<p>The table below shows how to convert from Kilometers to other Length 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from Kilometers to Feet</td>
    <td>ft=km*3280.8</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_kilometers_to_feet">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Kilometers to Meters</td>
    <td>m=km*1000</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_kilometers_to_meters">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Kilometers to Inches</td>
    <td>in=km*39370</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_kilometers_to_inches">Try it</a></td>
  </tr>
    <tr>
    <td>Convert from Kilometers to cm</td>
    <td>cm=km*100000</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_kilometers_to_cm">Try it</a></td>
    </tr>
    <tr>
    <td>Convert from Kilometers to Yards</td>
    <td>mi=km*1093.6</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_kilometers_to_yards">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Kilometers to Miles</td>
    <td>mi=km*0.62137</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_kilometers_to_miles">Try it</a></td>
  </tr>
</table>
<hr>
<h2>Convert from Miles to other Measurements</h2>
<p>The table below shows how to convert from Miles to other Length 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from Miles to Feet</td>
    <td>ft=mi*5280</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_miles_to_feet">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Miles to Meters</td>
    <td>m=mi/0.00062137</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_miles_to_meters">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Miles to Inches</td>
    <td>in=mi*63360</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_miles_to_inches">Try it</a></td>
  </tr>
    <tr>
    <td>Convert from Miles to cm</td>
    <td>cm=mi/0.0000062137</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_miles_to_cm">Try it</a></td>
    </tr>
    <tr>
    <td>Convert from Miles to Yards</td>
    <td>yd=mi*1760</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_miles_to_yards">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Miles to Kilometers</td>
    <td>km=mi/0.62137</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_length_converter_miles_to_kilometers">Try it</a></td>
  </tr>
</table>
<hr>
