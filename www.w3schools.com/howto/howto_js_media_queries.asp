...
<html lang="en-US">
<head>
<title>How To Use Media Queries in JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - Media Queries with JavaScript</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_draggable.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_syntax_highlight.asp">Next &#10095;</a>
</div>
<hr>

<div class="w3-example">
<h3>Example</h3>
<p>If the viewport is less than, or equal to, 700 pixels wide, change the 
background color to yellow. If it is greater than 700, change it to pink</p>
<div class="w3-code notranslate jsHigh">
  function myFunction(x) {<br>&nbsp;&nbsp;&nbsp; if (x.matches) { // If media 
  query matches<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  document.body.style.backgroundColor = &quot;yellow&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  document.body.style.backgroundColor = &quot;pink&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>
  <br>var x = window.matchMedia(&quot;(max-width: 700px)&quot;)<br>myFunction(x) // Call 
  listener function at run time<br>x.addListener(myFunction) // Attach listener 
  function on state changes</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_matchmedia" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Using Media Queries With JavaScript</h2>
<p>Media queries was introduced in CSS3, and is one of the key ingredients for responsive web design. Media queries are used to determine the width and height of a viewport to make web pages look good on all devices (desktops, laptops, tablets, phones, etc).</p>
<p>The <a href="/jsref/met_win_matchmedia.asp">window.matchMedia()</a> method returns a MediaQueryList object representing the results of the specified CSS media query string.
The value of the matchMedia() method can be any of the media features of the <a href="/cssref/css3_pr_mediaquery.asp">CSS @media rule</a>, like min-height, min-width, orientation, etc.</p>

<div class="w3-note w3-panel">
<p>Learn more about media queries in our <a href="/css/css3_mediaqueries.asp">CSS Media Queries</a> Tutorial</p>
<p>Learn more about responsive design in our <a href="/css/css_rwd_intro.asp">Responsive Web Design</a> Tutorial</p>
<p>Learn more about the <a href="/jsref/met_win_matchmedia.asp">window.matchMedia()</a> method in our JavaScript Reference.</p>
</div>
