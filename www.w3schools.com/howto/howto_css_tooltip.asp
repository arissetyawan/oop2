...
<html lang="en-US">
<head>
<title>How To Create Tooltips</title>
<meta charset="utf-8">
...
<h1>How TO - Tooltip</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_rangeslider.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_popup.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create tooltips with CSS.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_tooltip" class="w3-btn">Try it Yourself &raquo;</a></p>
<p style="clear:both"></p>
<hr>

<h2>How To Create Tooltips</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;tooltip&quot;&gt;Hover over me<br>&nbsp; &lt;span class=&quot;tooltiptext&quot;&gt;Tooltip 
text&lt;/span&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
/* Tooltip container */<br>.tooltip {<br>&nbsp;&nbsp;&nbsp; position: 
relative;<br>&nbsp;&nbsp;&nbsp; display: inline-block;<br>&nbsp;&nbsp;&nbsp; 
border-bottom: 1px dotted black; /* If you want dots under the hoverable 
text */<br>}<br><br>/* Tooltip text */<br>.tooltip .tooltiptext 
{<br>&nbsp;&nbsp;&nbsp; visibility: hidden;<br>&nbsp;&nbsp;&nbsp; width: 
120px;<br>&nbsp;&nbsp;&nbsp; background-color: #555;<br>&nbsp;&nbsp;&nbsp; 
color: #fff;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>&nbsp;&nbsp;&nbsp; 
padding: 5px 0;<br>&nbsp;&nbsp;&nbsp; border-radius: 6px;<br><br>&nbsp;&nbsp;&nbsp; 
/* Position the tooltip text */<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
z-index: 1;<br>&nbsp;&nbsp;&nbsp; bottom: 125%;<br>&nbsp;&nbsp;&nbsp; left: 
50%;<br>&nbsp;&nbsp;&nbsp; margin-left: -60px;<br><br>&nbsp;&nbsp;&nbsp; /* 
Fade in tooltip */<br>&nbsp;&nbsp;&nbsp; opacity: 0;<br>&nbsp;&nbsp;&nbsp; 
transition: opacity 0.3s;<br>}<br><br>/* Tooltip arrow */<br>.tooltip .tooltiptext::after 
{<br>&nbsp;&nbsp;&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; position: 
absolute;<br>&nbsp;&nbsp;&nbsp; top: 100%;<br>&nbsp;&nbsp;&nbsp; left: 50%;<br>&nbsp;&nbsp;&nbsp; 
margin-left: -5px;<br>&nbsp;&nbsp;&nbsp; border-width: 5px;<br>&nbsp;&nbsp;&nbsp; 
border-style: solid;<br>&nbsp;&nbsp;&nbsp; border-color: #555 transparent 
transparent transparent;<br>}<br><br>/* Show the tooltip text when 
you mouse over the tooltip container */<br>.tooltip:hover .tooltiptext {<br>&nbsp;&nbsp;&nbsp; 
visibility: visible;<br>&nbsp;&nbsp;&nbsp; opacity: 1;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_tooltip" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Go to our <a href="/css/css_tooltip.asp">CSS Tooltip Tutorial</a> to learn more about 
tooltips.</p>
<p><strong>Tip:</strong> To create "clickable" tooltips, go to our <a href="howto_js_popup.asp">How To Create Popups Tutorial</a></p>
<p><strong>Tip:</strong> Modals are also similar to tooltips. Go to our <a href="howto_css_modals.asp">How To Create Modals Tutorial</a> to learn about 
modals.</p>
