...
<html lang="en-US">
<head>
<title>How To Create a Full Screen Search</title>
<meta charset="utf-8">
...
<h1>How TO - Fullscreen Search</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_search_button.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_input_navbar.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a full screen search box with CSS and JavaScript.</p>
<hr>

<iframe src="tryhow_js_fullscreen_search_ifr.htm" style="width:100%;border:8px solid #f1f1f1;height:300px;padding:0"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_js_fullscreen_search" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Create a Fullscreen Search Box</h2>
<h5>Step 1) Add HTML:</h5>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div id=&quot;myOverlay&quot; class=&quot;overlay&quot;&gt;<br>&nbsp; &lt;span class=&quot;closebtn&quot; onclick=&quot;closeSearch()&quot; 
  title=&quot;Close Overlay&quot;&gt;x&lt;/span&gt;<br>&nbsp; &lt;div class=&quot;overlay-content&quot;&gt;<br>
  &nbsp;&nbsp;&nbsp; &lt;form action=&quot;action_page.php&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input 
  type=&quot;text&quot; placeholder=&quot;Search..&quot; name=&quot;search&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;button type=&quot;submit&quot;&gt;&lt;i class=&quot;fa fa-search&quot;&gt;&lt;/i&gt;&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;/form&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* The overlay effect with black background */<br>.overlay {<br>&nbsp; height: 100%;<br>&nbsp; width: 100%;<br>&nbsp; display: none;<br>&nbsp; position: 
  fixed;<br>&nbsp; z-index: 1;<br>&nbsp; top: 0;<br>&nbsp; left: 0;<br>&nbsp; background-color: rgb(0,0,0);<br>
  &nbsp;
  background-color: rgba(0,0,0, 0.9); /* Black with a little bit see-through */<br>}<br>
  <br>/* The content */<br>.overlay-content {<br>
  &nbsp;
  position: relative;<br>&nbsp; top: 46%;<br>&nbsp; width: 80%;<br>&nbsp; text-align: center;<br>
  &nbsp;
  margin-top: 30px;<br>&nbsp; margin: auto;<br>}<br><br>/* Close button */<br>.overlay .closebtn {<br>
  &nbsp;
  position: absolute;<br>&nbsp; top: 20px;<br>&nbsp; right: 45px;<br>&nbsp; font-size: 60px;<br>
  &nbsp;
  cursor: pointer;<br>&nbsp; color: white;<br>}<br><br>.overlay .closebtn:hover {<br>&nbsp; color: 
  #ccc;<br>}<br><br>/* Style the search field */<br>.overlay input[type=text] {<br>&nbsp; padding: 15px;<br>&nbsp; font-size: 
  17px;<br>&nbsp; border: none;<br>&nbsp; float: left;<br>&nbsp; width: 80%;<br>&nbsp; background: white;<br>
  }<br><br>.overlay input[type=text]:hover {<br>&nbsp; background: #f1f1f1;<br>}<br>
  <br>/* Style the submit button */<br>.overlay button {<br>&nbsp; float: left;<br>&nbsp; width: 20%;<br>&nbsp; padding: 15px;<br>
  &nbsp;
  background: #ddd;<br>&nbsp; font-size: 17px;<br>&nbsp; border: none;<br>&nbsp; cursor: pointer;<br>
  }<br><br>.overlay button:hover {<br>&nbsp; background: #bbb;<br>}<br></div>
</div>
<hr>
...
<p>Use JavaScript to turn on and off the overlay/fullscreen effect:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  // Open the full screen search box <br>function openSearch() {<br>&nbsp; document.getElementById(&quot;myOverlay&quot;).style.display 
  = &quot;block&quot;;<br>}<br><br>// Close the full screen search box <br>function closeSearch() {<br>&nbsp; 
  document.getElementById(&quot;myOverlay&quot;).style.display = &quot;none&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_fullscreen_search" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
