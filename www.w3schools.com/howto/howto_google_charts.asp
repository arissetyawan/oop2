...
<html lang="en-US">
<head>
<title>How To Google Charts</title>
<meta charset="utf-8">
...
<h1>How TO - Google Charts</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_google_translate.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_google_fonts.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add Google Charts to your web page.</p>
<hr>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-padding w3-white notranslate">
<iframe style="width:100%;height:450px;border:none;" scrolling="no" src="tryhow_google_pie_chart.htm"></iframe>
</div>
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryhow_google_pie_chart" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Add a &lt;div&gt; element with the id "piechart":</p>
...
<p>Add a reference to the Chart API at google.com:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;script type=&quot;text/javascript&quot; src=&quot;https://www.gstatic.com/charts/loader.js&quot;&gt;&lt;/script&gt;</div>
</div>

<p>And add a JavaScript function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;script type=&quot;text/javascript&quot;&gt;<br>// Load google charts<br>google.charts.load('current', 
  {'packages':['corechart']});<br>google.charts.setOnLoadCallback(drawChart);<br>
  <br>// Draw the chart and set the chart values<br>function drawChart() {<br>&nbsp; var data = 
  google.visualization.arrayToDataTable([<br>&nbsp; ['Task', 'Hours per Day'],<br>&nbsp; 
  ['Work', 8],<br>&nbsp; ['Friends', 2],<br>&nbsp; ['Eat', 2],<br>&nbsp; ['TV', 
  2],<br>&nbsp; ['Gym', 2],<br>&nbsp; ['Sleep', 8]<br>]);<br><br>&nbsp; // Optional; add 
  a title and set the width and height of the chart<br>&nbsp; var options = {'title':'My 
  Average Day', 'width':550, 'height':400};<br><br>&nbsp; // Display the chart 
  inside the &lt;div&gt; element with id=&quot;piechart&quot;<br>&nbsp; var chart = new 
  google.visualization.PieChart(document.getElementById('piechart'));<br>&nbsp; 
  chart.draw(data, options);<br>}<br>&lt;/script&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_google_pie_chart" target="_blank">Try it Yourself &raquo;</a>
</div>
