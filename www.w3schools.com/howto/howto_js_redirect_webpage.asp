...
<html lang="en-US">
<head>
<title>How To Redirect to Another Webpage</title>
<meta charset="utf-8">
...
<h1>How TO - Redirect to Another Webpage</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_check_hidden.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_zoom_hover.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to redirect to another webpage using JavaScript.</p>
<hr>
<h2>Redirect a Webpage</h2>
<p>There are a couple of ways to redirect to another webpage with JavaScript. The most popular ones are <code class="w3-codespan">location.href</code> and <code class="w3-codespan">location.replace</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  // Simulate 
  a mouse click:<br>window.location.href = &quot;http://www.w3schools.com&quot;;<br>
  <br>// Simulate an HTTP redirect:<br>window.location.replace(&quot;http://www.w3schools.com&quot;);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_redirect_webpage" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> The difference between href and replace, is that <code class="w3-codespan">replace()</code> removes the URL of the current document from the document history, meaning that it is not possible to use the "back" button to navigate back to the original document.</p>

<div class="w3-note w3-panel">
  <p><strong>Tip:</strong> For more information about the Location Object, read our <a href="/jsref/obj_location.asp">Location Object Reference</a>.</p>
</div>
