...
<h1>How TO - Flip an Image</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_image_sticky.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_shake_image.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to flip an image (add a mirror effect) with CSS.</p>
<hr>

<p>Move your mouse over the image:</p>
<img src="img_paris.jpg" class="testimg" alt="Paris" style="width:40%;min-width:300px;">
<hr>

<h2>How To Flip an Image</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>img:hover {<br>&nbsp;&nbsp;&nbsp; -webkit-transform: scaleX(-1);<br>&nbsp;&nbsp;&nbsp; 
  transform: scaleX(-1);<br>}<br>&lt;/style&gt;<br><br>&lt;img src=&quot;paris.jpg&quot; 
  alt=&quot;Paris&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_flip_image" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<!--
<hr>

<h2>Add Transition</h2>
<p>You can also add a transition effect to "fade" the flip:</p>
<img src="img_paris.jpg" class="testimg2" alt="Paris" style="width:40%;min-width:300px;">
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>img:hover {<br>&nbsp;&nbsp;&nbsp; -webkit-transform: scaleX(-1);<br>&nbsp;&nbsp;&nbsp; 
  transform: scaleX(-1);<br>&nbsp;&nbsp;&nbsp; transition: 1s; /* The animation 
  takes 1 second */<br>}<br>&lt;/style&gt;<br><br>&lt;img src=&quot;paris.jpg&quot; 
  alt=&quot;Paris&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_flip_image2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
-->

<p><strong>Note:</strong> This example does not work on tablets or mobile phones.</p>
...
<h2>3D Flip Image with Text</h2>
<p>Learn how to do an animated 3D flip of an image with text:</p>
<div class="flip-box" style="margin-bottom:23px">
  <div class="flip-box-inner">
    <div class="flip-box-front">
      <img src="img_paris.jpg" alt="Paris" style="width:300px;height:200px">
    </div>
    <div class="flip-box-back">      <h2>Paris</h2>
...
<div class="w3-code notranslate htmlHigh">
  ...
  &lt;div class=&quot;flip-box-front&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;img src=&quot;img_paris.jpg&quot; 
  alt=&quot;Paris&quot; style=&quot;width:300px;height:200px&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div 
  class=&quot;flip-box-back&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;h2&gt;Paris&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;p&gt;What an amazing city&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; 
...
<div class="w3-code notranslate cssHigh">
  ...
  backface-visibility: hidden;<br>}<br><br>/* Style the front side (fallback if 
  image is missing) */<br>.flip-box-front {<br>&nbsp; background-color: #bbb;<br>&nbsp; 
