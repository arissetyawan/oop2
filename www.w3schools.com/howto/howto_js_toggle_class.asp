...
<html lang="en-US">
<head>
<title>How To Toggle Between Class Names</title>
<meta charset="utf-8">
...
<h1>How TO - Toggle Class</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_toggle_text.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_add_class.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Toggle between adding and removing a class name from an element with JavaScript.</p>
<hr>
<button onclick="myFunction()" class="w3-btn w3-dark-grey w3-hover-black" style="box-shadow:none">Toggle Class</button>
...
<p>Toggle between adding a class name to the div element with id="myDIV" (in this example we use a button to toggle the class name).</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;button onclick=&quot;myFunction()&quot;&gt;Try it&lt;/button&gt;<br><br>&lt;div id=&quot;myDIV&quot;&gt;<br>&nbsp; 
This is a DIV element.<br>&lt;/div&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>Add a class name to toggle:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .mystyle {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; padding: 
  25px;<br>&nbsp;&nbsp;&nbsp; background-color: coral;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>&nbsp;&nbsp;&nbsp; font-size: 25px;<br>}</div>
</div>
<hr>
...
<p>Get the &lt;div&gt; element with id="myDIV" and toggle between the "mystyle" class:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function myFunction() {<br>&nbsp;&nbsp;&nbsp; var element = document.getElementById(&quot;myDIV&quot;);<br>
  &nbsp;&nbsp;&nbsp; element.classList.toggle(&quot;mystyle&quot;);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_toggle_class" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Cross-browser solution</h2>
<p><strong>Note:</strong> The classList property is not supported in Internet Explorer 9. The following 
example uses a cross-browser solution/fallback code for IE9:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  var element = document.getElementById(&quot;myDIV&quot;);<br><br>if (element.classList) { <br>&nbsp;&nbsp;&nbsp; 
  element.classList.toggle(&quot;mystyle&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; // For IE9<br>&nbsp;&nbsp;&nbsp; 
  var classes = element.className.split(&quot; &quot;);<br>&nbsp;&nbsp;&nbsp; var i = 
  classes.indexOf(&quot;mystyle&quot;);<br><br>&nbsp;&nbsp;&nbsp; if (i &gt;= 0) <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  classes.splice(i, 1);<br>&nbsp;&nbsp;&nbsp; else <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  classes.push(&quot;mystyle&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  element.className = classes.join(&quot; &quot;); <br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_toggle_class_crossbrowser" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Also see <a href="howto_js_add_class.asp">How To Add A Class</a>.</p>
<p><strong>Tip:</strong> Also see <a href="howto_js_remove_class.asp">How To Remove A Class</a>.</p>
<p><strong>Tip:</strong> Learn more about the <a href="/jsref/prop_element_classlist.asp">classList</a> property in our JavaScript Reference.</p>
