...
<html lang="en-US">
<head>
<title>How To Search for Items in a Dropdown</title>
<meta charset="utf-8">
...
<h1>How TO - Search/Filter Dropdown</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_filter_elements.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_sort_list.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to search for items in a dropdown menu with CSS and JavaScript.</p>
<hr>
<h2>Filter Dropdown Menu</h2>

<iframe src="tryhow_js_filter_dropdown_ifr.htm" style="width:100%;border:none;height:405px;"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_css_js_dropdown_filter" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>
<h2>Create a Clickable Dropdown</h2>
<p>Create a dropdown menu that appears when the user clicks on a button.</p>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;dropdown&quot;&gt;<br>&nbsp; &lt;button onclick=&quot;myFunction()&quot; class=&quot;dropbtn&quot;&gt;Dropdown&lt;/button&gt;<br>&nbsp; 
  &lt;div id=&quot;myDropdown&quot; class=&quot;dropdown-content&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input 
  type=&quot;text&quot; placeholder=&quot;Search..&quot; id=&quot;myInput&quot; onkeyup=&quot;filterFunction()&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;a href=&quot;#about&quot;&gt;About&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#base&quot;&gt;Base&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;a href=&quot;#blog&quot;&gt;Blog&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;a href=&quot;#custom&quot;&gt;Custom&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#support&quot;&gt;Support&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;a href=&quot;#tools&quot;&gt;Tools&lt;/a&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
...
border: none;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>}<br><br>/* Dropdown 
button on hover &amp; focus */<br>.dropbtn:hover, .dropbtn:focus {<br>&nbsp;&nbsp;&nbsp; 
background-color: #3e8e41;<br>}<br><br>/* The search field */<br>#myInput {<br>&nbsp; 
  border-box: box-sizing;<br>&nbsp; background-image: url('searchicon.png');<br>&nbsp; 
  background-position: 14px 12px;<br>&nbsp; background-repeat: no-repeat;<br>&nbsp; 
  font-size: 16px;<br>&nbsp; padding: 14px 20px 12px 45px;<br>&nbsp; border: 
  none;<br>&nbsp; border-bottom: 1px solid #ddd;<br>}<br><br>/* The search field 
  when it gets focus/clicked on */<br>#myInput:focus {outline: 3px solid #ddd;}<br><br>/* The 
...
absolute;<br>&nbsp;&nbsp;&nbsp; background-color: #f6f6f6;<br>&nbsp;&nbsp;&nbsp; 
min-width: 230px;<br>&nbsp;&nbsp;&nbsp; border: 1px solid #ddd;<br>&nbsp;&nbsp;&nbsp; z-index: 1;<br>}<br><br>/* Links inside the dropdown */<br>
...
.dropdown-content a:hover {background-color: #f1f1f1}<br><br>/* Show the dropdown menu (use JS to add this class to the .dropdown-content 
container when the user clicks on the dropdown button) */<br>.show {display:block;}</div>
</div>
<h3>Example Explained</h3>
<p>We have styled the dropdown button with a background-color, padding, hover 
effect, etc.</p>
...
<p>The <code class="w3-codespan">.dropdown-content</code> class holds the actual dropdown menu. It 
is hidden by default, and will be displayed on hover (see below). Note the <code class="w3-codespan">min-width</code> is set to 
...
<p>The search field (#myInput) is styled to fit inside the dropdown menu. We 
have added a search icon, which is placed to the left inside the search field to 
indicate that this is actually a search field.</p>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  the dropdown content */<br>function myFunction() {<br>&nbsp; 
  document.getElementById(&quot;myDropdown&quot;).classList.toggle(&quot;show&quot;);<br>}<br><br>
  function filterFunction() {<br>&nbsp; var input, filter, ul, li, a, i;<br>&nbsp; 
  input = document.getElementById(&quot;myInput&quot;);<br>&nbsp; filter = 
  input.value.toUpperCase();<br>&nbsp; div = document.getElementById(&quot;myDropdown&quot;);<br>&nbsp; 
  a = div.getElementsByTagName(&quot;a&quot;);<br>&nbsp; for (i = 0; i &lt; a.length; i++) {<br>&nbsp;&nbsp;&nbsp; 
  if (a[i].innerHTML.toUpperCase().indexOf(filter) &gt; -1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  a[i].style.display = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  a[i].style.display = &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_js_dropdown_filter" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
dropdowns.</p>
<p><strong>Tip:</strong> Go to our <a href="howto_css_dropdown.asp">Hoverable Dropdowns</a> to learn more about hoverable dropdowns</p>
