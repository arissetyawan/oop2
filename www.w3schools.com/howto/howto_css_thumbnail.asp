...
<html lang="en-US">
<head>
<title>How To Create a Thumbnail</title>
<meta charset="utf-8">
...
<h1>How TO - Thumbnail</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_image_center.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_team.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a thumbnail image.</p>
<hr>

<h2>Thumbnail Image</h2>
<p>A thumbnail is a small image that represents a larger image (when clicked on), and is often recognized with a border around it:</p>
<a target="_blank" href="img_forest.jpg">
  <img src="img_forest.jpg" alt="Paris" class="thumbimg">
</a>
<hr>

<h2>How To Create a Thumbnail Image</h2>
<p>Use an &lt;img&gt; element and wrap an &lt;a&gt; element around it. Style the image with 
a border and add a hover effect:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>img {<br>&nbsp;&nbsp;&nbsp; border: 1px solid #ddd; /* Gray 
  border */<br>&nbsp;&nbsp;&nbsp; border-radius: 4px;&nbsp; /* Rounded border */<br>&nbsp;&nbsp;&nbsp; 
  padding: 5px; /* Some padding */<br>&nbsp;&nbsp;&nbsp; width: 150px; /* Set a 
  small width */<br>}<br><br>/* Add a hover effect (blue shadow) */<br>img:hover 
  {<br>&nbsp;&nbsp;&nbsp; box-shadow: 0 0 2px 1px rgba(0, 140, 186, 0.5);<br>}<br>&lt;/style&gt;<br>
  &lt;body&gt;<br><br>&lt;a target=&quot;_blank&quot; href=&quot;img_forest.jpg&quot;&gt;<br>&nbsp; &lt;img 
  src=&quot;img_forest.jpg&quot; alt=&quot;Forest&quot;&gt;<br>&lt;/a&gt;<br><br>&lt;/body&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_thumbnail_image" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
