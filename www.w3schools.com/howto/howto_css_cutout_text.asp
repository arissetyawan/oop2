...
<html lang="en-US">
<head>
<title>How To Create Cutout Text</title>
<meta charset="utf-8">
...
<h1>How TO - Cutout Text</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_responsive_text.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_glowing_text.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive cutout/knockout text with CSS.</p>
<hr>
<p>A cutout text (or knockout text) is a see-through text that appears cut out on top of a background image:</p>

<div class="image-container">
  <div class="text">NATURE</div>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_cutout_text" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<p><strong>Note:</strong> This example does not work in Internet Explorer or Edge.</p>
<hr>

<h2>How To Create a Cutout Text</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;image-container&quot;&gt;<br>&nbsp; &lt;div class=&quot;text&quot;&gt;NATURE&lt;/div&gt;<br>
  &lt;/div&gt;</div>
</div>
<hr>
...
<p>The <code class="w3-codespan">mix-blend-mode</code> property makes it possible to add the cutout text to the image. However, it is not supported in IE or Edge:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .image-container {<br>&nbsp; background-image: url(&quot;img_nature.jpg&quot;); 
  /* The image used - important! */<br>
  &nbsp;
  background-size: cover; <br>&nbsp; position: relative; /* Needed to position 
  the cutout text in the middle of the image */<br>&nbsp; height: 300px; /* Some 
  height */<br>}<br><br>
  .text {<br>&nbsp; background-color: white;<br>&nbsp; color: black;<br>&nbsp; font-size: 10vw; 
  /* Responsive font size */<br>
  &nbsp;
  font-weight: bold;<br>&nbsp; margin: 0 auto; /* Center the text container */<br>&nbsp; padding: 10px;<br>&nbsp; width: 50%;<br>
  &nbsp;
  text-align: center; /* Center text */<br>&nbsp; position: absolute; /* Position text */<br>&nbsp; 
  top: 50%; /* Position text in the middle */<br>&nbsp; left: 50%; /* Position 
  text in the middle */<br>
  &nbsp;
  transform: translate(-50%, -50%); /* Position text in the middle */<br>&nbsp; mix-blend-mode: screen; 
  /* This makes the cutout text possible */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_cutout_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>If you want a black container text, change the mix-blend-mode to "multiply" and background-color to black, and color to white:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .text {<br>&nbsp; background-color: black;<br>&nbsp; color: white;<br>&nbsp; mix-blend-mode: 
  multiply;<br>&nbsp; ....<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_cutout_text2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
