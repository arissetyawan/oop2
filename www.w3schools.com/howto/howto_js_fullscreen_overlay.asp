...
<html lang="en-US">
<head>
<title>How To Create a Full screen Overlay Navigation</title>
<meta charset="utf-8">
...
<h1>How TO - Full screen Overlay Navigation</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_sidebar_responsive.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_off-canvas.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a full screen overlay navigation menu.</p>
<hr>
<p>Click on the buttons below to see how it works:</p>
...
<div id="myNav3" class="hhoverlay">
  ...
  <button class="w3-btn w3-padding-large w3-dark-grey w3-mobile" onclick="openNav()">Slide Right</button><p class="w3-hide-large w3-hide-medium"></p>
  <button class="w3-btn w3-padding-large w3-dark-grey w3-mobile" onclick="openNav2()">Slide Down</button><p class="w3-hide-large w3-hide-medium"></p>
  <button class="w3-btn w3-padding-large w3-dark-grey w3-mobile" onclick="openNav3()">Show (No animation)</button>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_overlay" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>

<h2>Create a Full screen Overlay Navigation</h2>
...
#f1f1f1;<br>}<br><br>/* Position the close button (top right corner) */<br>
.overlay .closebtn {<br>&nbsp;&nbsp;&nbsp; position: 
absolute;<br>&nbsp;&nbsp;&nbsp; top: 20px;<br>&nbsp;&nbsp;&nbsp; right: 
45px;<br>&nbsp;&nbsp;&nbsp; font-size: 60px;<br>}<br><br>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_overlay" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_overlay2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>This example opens the navigation menu without animation:</p>
<div class="w3-example">
<h3>Open the menu without animation</h3>
<div class="w3-code notranslate jsHigh">
/* Open */<br>function openNav() {<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myNav&quot;).style.display 
= &quot;block&quot;;<br>}<br><br>/* Close */<br>function closeNav() {<br>&nbsp;&nbsp;&nbsp; 
document.getElementById(&quot;myNav&quot;).style.display = &quot;none&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_overlay_no-anim" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
