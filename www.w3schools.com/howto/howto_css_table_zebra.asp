...
<html lang="en-US">
<head>
<title>How To Create A Zebra Striped Table</title>
<meta charset="utf-8">
...
<h1>How TO - Zebra Striped Table</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_sort_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_table_responsive.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a zebra striped table with CSS.</p>
<hr>
<h2>Zebra Striping a Table</h2>
...
<p>To create a zebra-striped table, use the <code class="w3-codespan">nth-child()</code> selector and add a background-color to all even (or odd) table rows:</p><div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  tr:nth-child(even) {<br>&nbsp;&nbsp;&nbsp; background-color: #f2f2f2<br>}<br></div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_css_table_zebra" target="_blank">Try it Yourself &raquo;</a>
</div>
<p>Go to our <a href="/css/css_table.asp">CSS Tables Tutorial</a> to learn more about how to style tables.</p>
<p>Go to our <a href="/cssref/sel_nth-child.asp">CSS Selector Reference</a> to learn more about the nth-child() selector.</p>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_sort_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_table_responsive.asp">Next &#10095;</a>
