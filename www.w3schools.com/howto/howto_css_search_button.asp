...
<html lang="en-US">
<head>
<title>How To Create a Search Button</title>
<meta charset="utf-8">
...
<h1>How TO - Search Button</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_animated_search.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_fullscreen_search.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a search button with CSS.</p>
<hr>

<p>Full-width:</p>
<div class="w3-clear">
  <input type="text" placeholder="Search.." name="search" class="r">
  <button type="button" class="r"><i class="fa fa-search"></i></button>
</div>

 <p class="w3-center">Centered inside a form with max-width:</p>

<div class="w3-clear" style="max-width:300px;margin:auto">
 <input type="text" placeholder="Search.." name="search" class="r">
  <button type="button" class="r"><i class="fa fa-search"></i></button>
</div>

<a target="_blank" href="tryit.asp?filename=tryhow_css_search_button" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Create a Search Button</h2>
<h5>Step 1) Add HTML:</h5>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Load icon library --&gt;<br>&lt;link rel=&quot;stylesheet&quot; href=&quot;https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css&quot;&gt;<br>
  <br>&lt;!-- The form --&gt;<br>&lt;form class=&quot;example&quot; action=&quot;action_page.php&quot;&gt;<br>&nbsp; 
  &lt;input type=&quot;text&quot; placeholder=&quot;Search..&quot; name=&quot;search&quot;&gt;<br>&nbsp; &lt;button 
  type=&quot;submit&quot;&gt;&lt;i class=&quot;fa fa-search&quot;&gt;&lt;/i&gt;&lt;/button&gt;<br>&lt;/form&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp; box-sizing: border-box;<br>}<br><br>/* Style the search field */<br>form.example input[type=text] {<br>&nbsp; 
  padding: 10px;<br>&nbsp; font-size: 17px;<br>&nbsp; border: 1px solid grey;<br>&nbsp; 
  float: left;<br>&nbsp; width: 80%;<br>&nbsp; background: #f1f1f1;<br>}<br><br>
  /* Style the submit button */<br>form.example button {<br>&nbsp; 
  float: left;<br>&nbsp; width: 20%;<br>&nbsp; padding: 10px;<br>&nbsp; 
  background: #2196F3;<br>&nbsp; color: white;<br>&nbsp; font-size: 17px;<br>&nbsp; 
  border: 1px solid grey;<br>&nbsp; border-left: none; /* Prevent double borders 
  */<br>&nbsp; cursor: pointer;<br>}<br><br>form.example 
  button:hover {<br>&nbsp; background: #0b7dda;<br>}<br><br>/* Clear floats */<br>form.example::after {<br>&nbsp; 
  content: &quot;&quot;;<br>&nbsp; clear: both;<br>&nbsp; display: table;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_search_button" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
