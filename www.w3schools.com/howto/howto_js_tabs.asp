...
<html lang="en-US">
<head>
<title>How To Create Tabs</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="howto_js_accordion.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_vertical_tabs.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create tabs with CSS and JavaScript.</p>
<hr>
<h2>Tabs</h2>
<p>Tabs are perfect for single page web applications, or for web pages capable 
of displaying different subjects:</p>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_tabs" class="w3-btn">Try it Yourself &raquo;</a></p>
...
<h2>Create Toggleable Tabs</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Tab links --&gt;<br>&lt;div class=&quot;tab&quot;&gt;<br>&nbsp; &lt;button class=&quot;tablinks&quot; onclick=&quot;openCity(event, 
...
&lt;/div&gt;<br><br>&lt;!-- Tab content --&gt;<br>&lt;div id=&quot;London&quot; class=&quot;tabcontent&quot;&gt;<br>&nbsp; &lt;h3&gt;London&lt;/h3&gt;<br>&nbsp; 
...
<div class="w3-code notranslate cssHigh">
  /* Style the tab */<br>.tab {<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>&nbsp;&nbsp;&nbsp; 
  border: 1px solid #ccc;<br>&nbsp;&nbsp;&nbsp; background-color: #f1f1f1;<br>}<br>
  <br>/* Style the buttons that are used to open the tab content */<br>.tab button {<br>&nbsp;&nbsp;&nbsp; 
  background-color: inherit;<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; 
  border: none;<br>&nbsp;&nbsp;&nbsp; outline: none;<br>&nbsp;&nbsp;&nbsp; 
  cursor: pointer;<br>&nbsp;&nbsp;&nbsp; padding: 14px 16px;<br>&nbsp;&nbsp;&nbsp; 
  transition: 0.3s;<br>}<br><br>/* Change background color of buttons on hover 
  */<br>.tab button:hover {<br>&nbsp;&nbsp;&nbsp; background-color: #ddd;<br>
  }<br><br>/* Create an active/current tablink class */<br>.tab button.active 
  {<br>&nbsp;&nbsp;&nbsp; background-color: #ccc;<br>}<br><br>/* Style the tab content */<br>.tabcontent {<br>&nbsp;&nbsp;&nbsp; 
  display: none;<br>&nbsp;&nbsp;&nbsp; padding: 6px 12px;<br>&nbsp;&nbsp;&nbsp; 
  border: 1px solid #ccc;<br>&nbsp;&nbsp;&nbsp; border-top: none;<br>}</div>
</div>
<hr>
...
// Get all elements with class=&quot;tabcontent&quot; and hide them<br>&nbsp;&nbsp;&nbsp; tabcontent 
= document.getElementsByClassName(&quot;tabcontent&quot;);<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; tabcontent.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; tabcontent[i].style.display = &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>
<br>&nbsp;&nbsp;&nbsp; // Get all elements with class=&quot;tablinks&quot; and remove 
the class &quot;active&quot;<br>
&nbsp;&nbsp;&nbsp;
...
<br>&nbsp;&nbsp;&nbsp; // Show the current tab, and add an &quot;active&quot; class to 
the button that opened the tab<br>
&nbsp;&nbsp;&nbsp;
document.getElementById(cityName).style.display = &quot;block&quot;;<br>
&nbsp;&nbsp;&nbsp;
evt.currentTarget.className += &quot; active&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_tabs" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
.tabcontent {<br>&nbsp;&nbsp;&nbsp; 
animation: fadeEffect 1s; /* Fading effect takes 1 second */<br>}<br><br>/* Go 
  from zero to full opacity */<br>@keyframes fadeEffect {<br>&nbsp;&nbsp;&nbsp; from 
{opacity: 0;}<br>&nbsp;&nbsp;&nbsp; to {opacity: 1;}<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_tabs_fade" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Show a tab by default</h2>
<p>To open a specific tab on page load, use JavaScript to "click" on the specified tab 
button:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button class=&quot;tablinks&quot; onclick=&quot;openCity(event, 'London')&quot; id=&quot;defaultOpen&quot;&gt;London&lt;/button&gt;<br><br>&lt;script&gt;<br>
 // Get the element with id=&quot;defaultOpen&quot; and click on it<br>
 document.getElementById(&quot;defaultOpen&quot;).click();<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_tabs_open" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;!-- Click on the &lt;span&gt; element to close the tab --&gt;<br><br>&lt;div id=&quot;London&quot; class=&quot;tabcontent&quot;&gt;<br>&nbsp; &lt;h3&gt;London&lt;/h3&gt;<br>&nbsp; &lt;p&gt;London is the capital city of England.&lt;/p&gt;<br>&nbsp; &lt;span onclick=&quot;this.parentElement.style.display='none'&quot;&gt;x&lt;/span&gt;
 <br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_tabs_close" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Also check out <a href="howto_js_vertical_tabs.asp">How To - Vertical Tabs</a>.</p>
