...
<html lang="en-US">
<head>
<title>How To Make a Website with Bootstrap 4</title>
<meta charset="utf-8">
...
<h1>How TO - Make a Website with Bootstrap 4</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_website_bootstrap.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_center_website.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive website with Bootstrap 4.</p>
<hr>
<h2>Create a Website with Bootstrap 4</h2>
<div class="w3-content" style="max-width:1500px">
<iframe src="tryhow_website_bootstrap4_ifr.htm" class="w3-round" style="width:100%;border:5px solid #e9e9e9;height:600px"></iframe>
<div class="w3-row-padding" style="margin:16px -16px 0 -16px">
  <div class="w3-col m6">
    <a href="tryhow_website_bootstrap4.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey w3-block">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="tryit.asp?filename=tryhow_website_bootstrap4" target="_blank" class="w3-btn w3-padding-large w3-green w3-block">Try it Yourself</a>
  </div>
</div>
</div>
<div class="w3-note w3-panel" style="margin-top:24px">
...
<p>Bootstrap 4 is the newest version of Bootstrap.</p>
<p><strong>Note:</strong> If you don't know Bootstrap, we suggest that you read our <a href="/bootstrap/default.asp">Bootstrap Tutorial</a>, or our <a href="/bootstrap4/default.asp">Bootstrap 4 Tutorial</a>.</p>
</div>
<!--
<hr>
...
<div class="w3-code notranslate htmlHigh">
 &lt;!DOCTYPE html&gt;<br>
&lt;html&gt;<br>&lt;head&gt;<br>&lt;title&gt;Page Title&lt;/title&gt;<br>&lt;meta 
...
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
  /* Column container */<br>.row { <br>&nbsp;&nbsp;&nbsp; display: -ms-flexbox; 
  /* IE10 */<br>&nbsp;&nbsp;&nbsp; display: flex;<br>&nbsp;&nbsp;&nbsp; -ms-flex-wrap: 
  wrap; /* IE10 */<br>&nbsp;&nbsp;&nbsp; flex-wrap: wrap;<br>}<br><br>/* Create 
...
<div class="w3-code notranslate cssHigh">
  ...
  @media (max-width: 400px) {<br>&nbsp;&nbsp;&nbsp; .navbar a {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<p>Congratulations! You have built a website from scratch.</p>
