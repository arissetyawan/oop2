...
<html lang="en-US">
<head>
<title>How To Create Text Buttons</title>
<meta charset="utf-8">
...
<h1>How TO - Text Buttons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_block_buttons.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_round_buttons.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style text buttons with CSS.</p>
<hr>
...
<h2>How To Style Text Buttons</h2>
...
<p>To get the "text button" look, we remove the default background color and border:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .btn {<br>&nbsp;&nbsp;&nbsp; border: none;<br>&nbsp;&nbsp;&nbsp; 
  background-color: inherit;<br>&nbsp;&nbsp;&nbsp; padding: 14px 28px;<br>&nbsp;&nbsp;&nbsp; 
  font-size: 16px;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>&nbsp;&nbsp;&nbsp; 
  display: inline-block;<br>}<br><br>/* On mouse-over */<br>.btn:hover 
  {background: #eee;}<br><br>.success {color: green;}<br>.info {color: 
  dodgerblue;}<br>.warning {color: orange;}<br>.danger {color: red;}<br>.default {color: black;}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_text_buttons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Text Buttons with Individual Backgrounds</h2>
<p>Text buttons with a specific background color on hover:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .btn {<br>&nbsp;&nbsp;&nbsp; border: none;<br>&nbsp;&nbsp;&nbsp; 
  background-color: inherit;<br>&nbsp;&nbsp;&nbsp; padding: 14px 28px;<br>&nbsp;&nbsp;&nbsp; 
  font-size: 16px;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>&nbsp;&nbsp;&nbsp; 
  display: inline-block;<br>}<br><br>/* 
  Green */<br>.success {<br>&nbsp;&nbsp;&nbsp; color: green;<br>}<br><br>.success:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; color: white;<br>}<br><br>/* Blue */<br>.info {<br>&nbsp;&nbsp;&nbsp; 
  color: dodgerblue;<br>}<br><br>.info:hover {<br>&nbsp;&nbsp;&nbsp; background: 
  #2196F3;<br>&nbsp;&nbsp;&nbsp; color: white;<br>}<br><br>/* Orange */<br>.warning {<br>&nbsp;&nbsp;&nbsp; color: 
  orange;<br>}<br><br>.warning:hover 
  {<br>&nbsp;&nbsp;&nbsp; background: #ff9800;<br>&nbsp;&nbsp;&nbsp; color: 
  white;<br>}<br><br>/* Red */<br>.danger {<br>&nbsp;&nbsp;&nbsp; color: red;<br>}<br><br>.danger:hover {<br>&nbsp;&nbsp;&nbsp; 
  background: #f44336;<br>&nbsp;&nbsp;&nbsp; color: white;<br>}<br><br>/* Gray */<br>.default 
  {<br>&nbsp;&nbsp;&nbsp; color: black;<br>}<br><br>.default:hover {<br>&nbsp;&nbsp;&nbsp; background: 
  #e7e7e7;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_text_buttons2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
