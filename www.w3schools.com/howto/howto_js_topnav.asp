...
<html lang="en-US">
<head>
<title>How To Create a Top Navigation Bar</title>
<meta charset="utf-8">
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_topnav" class="w3-btn">Try it Yourself &raquo;</a></p>
...
Style the links inside the navigation bar */<br>.topnav a {<br>&nbsp;&nbsp;&nbsp; 
  ...
  font-size: 17px;<br>}<br><br>/* Change the color of links on hover */<br>.topnav a:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #ddd;<br>&nbsp;&nbsp;&nbsp; color: black;<br>}<br><br>/* Add 
  a color to the active/current link */<br>.topnav 
  a.active {<br>&nbsp;&nbsp;&nbsp; background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_topnav" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
