...
<html lang="en-US">
<head>
<title>How To Create a Responsive Header</title>
<meta charset="utf-8">
...
<h1>How TO - Responsive Header</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_pill_nav.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_slideshow.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive header with CSS.</p>
<hr>

<h2>Responsive Header</h2>
<p>Change the design of the header depending on the screen size. Resize the browser window to see the effect.</p>
<div class="header">
  <a href="javascript:void(0)" class="logo">CompanyLogo</a>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_header" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create A Responsive Header</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;header&quot;&gt;<br>&nbsp; &lt;a href=&quot;#default&quot; class=&quot;logo&quot;&gt;CompanyLogo&lt;/a&gt;<br>&nbsp; 
  &lt;div class=&quot;header-right&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a class=&quot;active&quot; href=&quot;#home&quot;&gt;Home&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; 
...
<div class="w3-code notranslate cssHigh">
  /* Style the header with a grey background and some padding */<br>.header {<br>&nbsp; 
  overflow: hidden;<br>&nbsp; background-color: #f1f1f1;<br>&nbsp; padding: 20px 
  10px;<br>}<br><br>/* Style the header links */<br>.header a {<br>&nbsp; float: 
  left;<br>&nbsp; color: black;<br>&nbsp; text-align: center;<br>&nbsp; padding: 
  12px;<br>&nbsp; text-decoration: none;<br>&nbsp; font-size: 18px; <br>&nbsp; 
  ...
  prevent the header to increase when the font gets bigger */<br>
  .header a.logo 
  {<br>&nbsp; font-size: 25px;<br>&nbsp; font-weight: bold;<br>}<br><br>/* 
  Change the background color on mouse-over */<br>.header a:hover {<br>&nbsp; 
  background-color: #ddd;<br>&nbsp; color: black;<br>}<br><br>/* Style the 
  active/current link*/<br>.header a.active {<br>&nbsp; 
  background-color: dodgerblue;<br>&nbsp; color: white;<br>}<br><br>/* Float the 
  link section to the right */<br>.header-right {<br>&nbsp; 
  float: right;<br>}<br><br>/* Add media queries for responsiveness - when the 
  screen is 500px wide or less, stack the links on top of each other */ <br>
  @media screen and (max-width: 500px) {<br>&nbsp; 
  .header a {<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp;&nbsp;&nbsp; display: 
  block;<br>&nbsp;&nbsp;&nbsp; text-align: left;<br>&nbsp; }<br>&nbsp; 
  .header-right {<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp; }<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_header" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
