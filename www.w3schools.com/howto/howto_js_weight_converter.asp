...
<html lang="en-US">
<head>
<title>How To Create a Weight Converter With HTML and JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - Weight Converter</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_google_fonts.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_temperature_converter.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a weight converter with HTML and JavaScript.</p>
<hr>
...
<hr>
<h2>Create a Weight Converter</h2>
<p>Create an input element that can convert a value from one weight measurement to another.</p>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example - Pounds to Kilogram</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;p&gt;<br>&nbsp; &lt;label&gt;Pounds&lt;/label&gt;<br>&nbsp; &lt;input id="inputPounds" type="number" placeholder="Pounds"<br>&nbsp; oninput="weightConverter(this.value)" onchange="weightConverter(this.value)"&gt;<br>&lt;/p&gt;<br>&lt;p&gt;Grams: &lt;span id="outputGrams"&gt;&lt;/span&gt;&lt;/p&gt;</div>
</div>
...
/* When the input field receives input, convert the value from pounds to kilograms */<br>
 function weightConverter(valNum) {<br>&nbsp; document.getElementById("outputGrams").innerHTML = valNum / 0.0022046;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_weight_converter_pounds_to_kilograms" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h2>Convert from Pounds to other Measurements</h2>
<p>The table below shows how to convert from Pounds to other weight 
measurements:</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>Convert from Pounds to Kilograms</td>
    <td>kg=lb/2.2046</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_pounds_to_kilograms">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Pounds to Ounces</td>
    <td>oz=lb*16</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_pounds_to_ounces">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Pounds to Grams</td>
    <td>g=lb/0.0022046</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_pounds_to_grams">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Pounds to Stones</td>
    <td>st=lb*0.071429</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_pounds_to_stones">Try it</a></td>
  </tr>
...
<h2>Convert from Kilograms to other Measurements</h2>
<p>The table below shows how to convert from Kilograms to other weight 
measurements:</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>Convert from Kilograms to Pounds</td>
    <td>lb=kg*2.2046</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_kilograms_to_pounds">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Kilograms to Ounces</td>
    <td>oz=kg*35.274</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_kilograms_to_ounces">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Kilograms to Grams</td>
    <td>g=kg*1000</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_kilograms_to_grams">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Kilograms to Stones</td>
    <td>st=kg*0.1574</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_kilograms_to_stones">Try it</a></td>
  </tr>
...
<h2>Convert from Ounces to other Measurements</h2>
<p>The table below shows how to convert from Ounces to other weight 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from Ounces to Pounds</td>
    <td>lb=oz*0.0625</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_ounces_to_pounds">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Ounces to Kilograms</td>
    <td>kg=oz/35.274</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_ounces_to_kilograms">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Ounces to Grams</td>
    <td>g=oz/0.035274</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_ounces_to_grams">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Ounces to Stones</td>
    <td>st=oz*0.0044643</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_ounces_to_stones">Try it</a></td>
  </tr>
...
<h2>Convert from Grams to other Measurements</h2>
<p>The table below shows how to convert from Grams to other weight 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from Grams to Pounds</td>
    <td>lb=g*0.0022046</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_grams_to_pounds">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Grams to Kilograms</td>
    <td>kg=g/1000</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_grams_to_kilograms">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Grams to Ounces</td>
    <td>oz=g*0.035274</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_grams_to_ounces">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Grams to Stones</td>
    <td>st=g*0.00015747</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_grams_to_stones">Try it</a></td>
  </tr>
...
<h2>Convert from Stones to other Measurements</h2>
<p>The table below shows how to convert from Stones to other weight 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from Stones to Pounds</td>
    <td>lb=st*14</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_stones_to_pounds">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Stones to Kilograms</td>
    <td>kg=st/0.15747</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_stones_to_kilograms">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Stones to Ounces</td>
    <td>oz=st*224</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_stones_to_ounces">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Stones to Grams</td>
    <td>g=st/0.00015747</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_weight_converter_stones_to_grams">Try it</a></td>
  </tr>
