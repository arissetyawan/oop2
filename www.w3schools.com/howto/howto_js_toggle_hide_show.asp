...
<html lang="en-US">
<head>
<title>How To Toggle Between Hiding And Showing an Element</title>
<meta charset="utf-8">
...
<h1>How TO - Toggle Hide and Show</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_toggle_like.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_toggle_text.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Toggle between hiding and showing an element with JavaScript.</p>
<hr>
<button onclick="myFunction()" class="w3-btn w3-hover-black w3-dark-grey" style="box-shadow:none">Toggle Hide and Show</button>
...
<h2>Toggle (Hide/Show) an Element</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;button onclick=&quot;myFunction()&quot;&gt;Click Me&lt;/button&gt;<br><br>&lt;div id=&quot;myDIV&quot;&gt;<br>&nbsp; 
This is my DIV element.<br>&lt;/div&gt;</div>
</div>
<hr>
...
function myFunction() {<br>&nbsp;&nbsp;&nbsp; var x = document.getElementById(&quot;myDIV&quot;);<br>&nbsp;&nbsp;&nbsp; if (x.style.display 
=== &quot;none&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.style.display = &quot;block&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.style.display = 
  &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_toggle_hide_show" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
