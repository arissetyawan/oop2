...
<html lang="en-US">
<head>
<title>How To Create Vertical Tabs</title>
<meta charset="utf-8">
...
<h1>How TO - Vertical Tabs</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_tabs.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_tab_header.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a vertical tab menu with CSS and JavaScript.</p>
<hr>
<h2>Vertical Tabs</h2>
<p style="font-family: 'Lato', sans-serif;font-size:16px">Tabs are perfect for single page web applications, or for web pages capable 
of displaying different subjects.</p>

<iframe src="tryhow_js_vertical_tabs.htm" style="width:100%;height:425px;border:1px solid #f1f1f1;xmargin:0 -8px"></iframe>
<p style="margin-top:7px"><a target="_blank" href="tryit.asp?filename=tryhow_js_vertical_tabs" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>Create Togglable Vertical Tabs</h2>
...
<p>Create buttons to open the specific 
...
<div class="w3-code notranslate cssHigh">
  ...
  color: black;<br>&nbsp;&nbsp;&nbsp; padding: 22px 16px;<br>&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp;&nbsp;&nbsp; border: none;<br>&nbsp;&nbsp;&nbsp; 
  outline: none;<br>&nbsp;&nbsp;&nbsp; text-align: left;<br>&nbsp;&nbsp;&nbsp; 
  cursor: pointer;<br>&nbsp;&nbsp;&nbsp; transition: 0.3s;<br>}<br><br>/* Change 
  background color of buttons on hover */<br>.tab button:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #ddd;<br>}<br><br>/* Create an active/current &quot;tab button&quot; 
  class */<br>.tab button.active {<br>&nbsp;&nbsp;&nbsp; background-color: 
  #ccc;<br>}<br><br>/* Style the tab content */<br>.tabcontent {<br>&nbsp;&nbsp;&nbsp; 
  float: left;<br>&nbsp;&nbsp;&nbsp; padding: 0px 12px;<br>&nbsp;&nbsp;&nbsp; 
  border: 1px solid #ccc;<br>&nbsp;&nbsp;&nbsp; width: 70%;<br>&nbsp;&nbsp;&nbsp; 
  border-left: none;<br>&nbsp;&nbsp;&nbsp; height: 300px;<br>}</div>
</div>
<hr>
...
the link that opened the tab<br>
&nbsp;&nbsp;&nbsp;
document.getElementById(cityName).style.display = &quot;block&quot;;<br>
&nbsp;&nbsp;&nbsp;
evt.currentTarget.className += &quot; active&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_vertical_tabs" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Also check out <a href="howto_js_tabs.asp">How To - Horizontal Tabs</a>.</p>
