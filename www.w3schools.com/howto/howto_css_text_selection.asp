...
<h1>How TO - Change Text Selection Color</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_placeholder.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_bullet_color.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to override the default text selection color with CSS.</p>
<hr>
<h2>Text Selection Color</h2>
<p>Select the following text:</p>
<div class="w3-row-padding" style="margin:0 -8px">
<div class="w3-half w3-border">
<p>Default text selection color</p>
</div>
<div class="w3-half w3-border">
<p class="cust">Custom text selection color</p>
</div>
</div>
...
<h2>How To Change Text Selection Color</h2>
<p>Use the <code class="w3-codespan">::selection</code> selector to override the default text selection color:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  ::-moz-selection { /* Code for Firefox */<br>&nbsp; color: red;<br>&nbsp; 
  background: yellow;<br>}<br><br>::selection {<br>&nbsp; color: red;<br>&nbsp; background: 
  yellow;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_text_selection" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Read more about the ::selection selector in our CSS Reference: <a href="/cssref/sel_selection.asp">CSS ::selection Property</a>.</p>
<br>
