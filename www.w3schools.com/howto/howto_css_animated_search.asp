...
<html lang="en-US">
<head>
<title>How To Make an Animated Search Form</title>
<meta charset="utf-8">
...
<h1>How TO - Animated Search Form</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_copy_clipboard.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_search_button.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an animated search form with CSS.</p>
<hr>
<h2>How To Create an Animated Search Form</h2>
...
<div class="w3-code notranslate cssHigh">
  input[type=text] {<br>&nbsp;&nbsp;&nbsp; width: 130px;<br>&nbsp;&nbsp;&nbsp; 
-webkit-transition: width 0.4s ease-in-out;<br>&nbsp;&nbsp;&nbsp; 
transition: width 0.4s ease-in-out;<br>}<br><br>/* When the input field gets 
focus, change its width to 100% */<br>input[type=text]:focus {<br>
&nbsp;&nbsp;&nbsp;
width: 100%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_anim_search" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Go to our <a href="/html/html_forms.asp">HTML Form Tutorial</a> to learn 
more about HTML Forms.</p>

<p>Go to our <a href="/css/css_form.asp">CSS Forms Tutorial</a> to learn more about how to style HTML Forms.</p>
<br>
