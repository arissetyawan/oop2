...
<h1>How TO - Fixed Sidebar</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_searchbar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_sidenav.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a fixed side navigation menu with CSS.</p>
<hr>
<div class="w3-row-padding" style="margin:0 -16px">
<div class="w3-half">
<p>Full height:</p>
<iframe src="tryhow_css_sidenav_ifr.htm" style="width:100%;border:5px solid #ddd;height:300px"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_css_sidenav_fixed" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
</div>
<div class="w3-half">
<p>Auto height:</p>
<iframe src="tryhow_css_sidenav_ifr2.htm" style="width:100%;border:5px solid #ddd;height:300px"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_css_sidenav_fixed2" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
</div>
</div>
...
<h2>Create a Fixed Sidebar</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Side navigation --&gt;<br>&lt;div class=&quot;sidenav&quot;&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;About&lt;/a&gt;<br>&nbsp; 
&lt;a href=&quot;#&quot;&gt;Services&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Clients&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Contact&lt;/a&gt;<br>
&lt;/div&gt;<br><br>&lt;!-- Page content --&gt;<br>&lt;div class=&quot;main&quot;&gt;<br>&nbsp; ...<br>&lt;/div&gt;</div>
</div>
<hr>
...
/* The sidebar menu */<br>.sidenav {<br>&nbsp;&nbsp;&nbsp; height: 100%; /* 
Full-height: remove this if you want &quot;auto&quot; height */<br>&nbsp;&nbsp;&nbsp; width: 160px; 
  /* Set the width of the sidebar */<br>&nbsp;&nbsp;&nbsp; position: fixed; /* 
  Fixed Sidebar (stay in place on scroll) 
*/<br>&nbsp;&nbsp;&nbsp; z-index: 1; /* Stay on top */<br>&nbsp;&nbsp;&nbsp; 
top: 0; /* Stay at the top */<br>&nbsp;&nbsp;&nbsp; left: 0;<br>&nbsp;&nbsp;&nbsp; 
background-color: #111; /* Black */<br>&nbsp;&nbsp;&nbsp; 
overflow-x: hidden; /* Disable horizontal scroll */<br>&nbsp;&nbsp;&nbsp; 
  padding-top: 20px;<br>
}<br><br>/* The navigation menu links */<br>.sidenav a {<br>&nbsp;&nbsp;&nbsp; padding: 
  6px 8px 6px 16px;<br>&nbsp;&nbsp;&nbsp; 
text-decoration: none;<br>&nbsp;&nbsp;&nbsp; font-size: 25px;<br>&nbsp;&nbsp;&nbsp; 
color: #818181;<br>&nbsp;&nbsp;&nbsp; display: block;<br>}<br><br>/* When you mouse over the navigation links, 
change their color */<br>.sidenav a:hover {<br>&nbsp;&nbsp;&nbsp; 
color: #f1f1f1;<br>}<br>
<br>/* Style page content */<br>.main {<br>&nbsp;&nbsp;&nbsp; margin-left: 
  160px; /* Same as the width of the sidebar */<br>&nbsp;&nbsp;&nbsp; padding: 
  0px 10px;<br>}<br><br>/* On smaller screens, where height is less than 
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_sidenav_fixed" class="w3-btn w3-margin-bottom">Try it Yourself (Full Height) &raquo;</a>
<a target="_blank" href="tryit.asp?filename=tryhow_css_sidenav_fixed2" class="w3-btn w3-margin-bottom">Try it Yourself (Auto Height) &raquo;</a>

</div>
<hr>


<p><strong>Tip:</strong> Go to our <a href="/css/css_navbar.asp">CSS Navbar</a> tutorial to learn more about navigation bars.</p>
<p><strong>Tip:</strong> Go to our <a href="howto_js_sidenav.asp">How To - Side Navigation</a> tutorial to learn how to create an animated, closable side navigation.</p>
