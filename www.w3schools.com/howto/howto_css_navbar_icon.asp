...
<html lang="en-US">
<head>
<title>How To Create a Responsive Navigation Menu with Icons</title>
...
<h1>How TO - Navbar with Icons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_topnav_responsive.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_search_menu.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive navigation menu with icons, using CSS.</p>
<hr>
<h2>Navigation Bar With Icons</h2>

<div class="navbar">
  <a class="activenavbara" href="javascript:void(0)"><i class="fa fa-fw fa-home"></i> Home</a> 
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_navbar_icon" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create A Responsive Navbar with Icons</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Load an icon library --&gt;<br>
  ...
  fa-fw fa-home&quot;&gt;&lt;/i&gt; 
  Home&lt;/a&gt; <br>&nbsp; &lt;a href=&quot;#&quot;&gt;&lt;i class=&quot;fa fa-fw fa-search&quot;&gt;&lt;/i&gt; Search&lt;/a&gt; <br>&nbsp; 
  &lt;a href=&quot;#&quot;&gt;&lt;i class=&quot;fa fa-fw fa-envelope&quot;&gt;&lt;/i&gt; Contact&lt;/a&gt; <br>&nbsp; &lt;a href=&quot;#&quot;&gt;&lt;i 
  class=&quot;fa fa-fw fa-user&quot;&gt;&lt;/i&gt; Login&lt;/a&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style the navigation bar */<br>.navbar {<br>&nbsp; width: 100%;<br>&nbsp; 
  background-color: #555;<br>&nbsp; overflow: auto;<br>}<br>
  <br>/* Navbar links */<br>.navbar a {<br>&nbsp; float: left;<br>&nbsp; 
  text-align: center;<br>&nbsp; padding: 12px;<br>&nbsp; color: white;<br>&nbsp; 
  text-decoration: none;<br>&nbsp; font-size: 17px;<br>}<br><br>/* Navbar links on 
  mouse-over */<br>.navbar a:hover {<br>&nbsp; background-color: #000;<br>}<br><br>/* Current/active navbar link */<br>
  .active {<br>&nbsp; background-color: #4CAF50;<br>}<br><br>/* Add responsiveness - will automatically display the 
  navbar vertically instead of horizontally on screens less than 500 pixels */<br>
  @media screen and (max-width: 500px) {<br>&nbsp; .navbar a {<br>&nbsp;&nbsp;&nbsp; 
  float: none;<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_navbar_icon" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
