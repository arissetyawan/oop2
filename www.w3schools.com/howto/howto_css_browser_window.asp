...
<html lang="en-US">
<head>
<title>How To Create a Browser Window with CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Browser Window CSS</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_div_full_height.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_custom_scrollbar.asp">Next &#10095;</a>
</div>
<hr>

<p class="intro">Learn how to create a browser window example with CSS.</p>
<hr>
<h2>Browser Window</h2>
<div class="w3-row-padding" style="margin:0 -24px">
  <div class="w3-third">
    <iframe src="tryhow_css_browser_window_ifr.htm" style="border:none;width:100%;height:195px"></iframe>
    <a target="_blank" href="tryit.asp?filename=tryhow_css_browser_window" class="w3-btn" style="margin-left:10px">Try it Yourself &raquo;</a>
  </div>
  <div class="w3-twothird">
    <iframe src="tryhow_css_browser_window_ifr2.htm" style="border:none;width:100%;height:195px"></iframe>
    <a target="_blank" href="tryit.asp?filename=tryhow_css_browser_window2" class="w3-btn" style="margin-left:10px">Try it Yourself &raquo;</a>
 </div>
</div>
<hr>
<br>
