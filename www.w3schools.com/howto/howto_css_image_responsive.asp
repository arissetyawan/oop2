...
<html lang="en-US">
<head>
<title>How To Create Responsive Images</title>
<meta charset="utf-8">
...
<h1>How TO - Responsive Images</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_image_avatar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_center.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an responsive image with CSS.</p>
<hr>

<p>Responsive images will automatically adjust to fit the size of the screen.</p>
<p>Resize the browser window to see the responsive effect:</p>
<img src="img_nature_wide.jpg" alt="Lights" class="responsive"><hr>

<h2>How To Create Responsive Images</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;img src=&quot;nature.jpg&quot; alt=&quot;Nature&quot; class=&quot;responsive&quot;&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>If you want the image to scale both up and down on responsiveness, set the CSS <code class="w3-codespan">width</code> property to 100% and <code class="w3-codespan">height</code> to auto:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .responsive {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; height: auto;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_responsive" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>If you want an image to scale down if it has to, but never scale up to be larger than its original size, use <code class="w3-codespan">max-width: 100%</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .responsive {<br>&nbsp;&nbsp;&nbsp; max-width: 100%;<br>&nbsp;&nbsp;&nbsp; height: auto;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_responsive2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>If you want to restrict a responsive image to a maximum size, use the <code class="w3-codespan">max-width</code> property, with a 
pixel value of your choice:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .responsive {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; max-width: 
  400px;<br>&nbsp;&nbsp;&nbsp; height: auto;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_responsive3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Go to our <a href="/css/css3_images.asp">CSS Images Tutorial</a> to learn 
more about how to style images.</p>
<p>Go to our <a href="/css/css_rwd_intro.asp">CSS RWD Tutorial</a> to learn 
more about responsive web design.</p>
