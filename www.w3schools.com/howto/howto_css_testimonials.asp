...
<html lang="en-US">
<head>
<title>How To Create Testimonials</title>
<meta charset="utf-8">
...
<h1>How TO - Testimonials</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_split_screen.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_section_counter.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create responsive testimonials with CSS.</p>
<hr>

<p>A testimonial is often used to let people know what other people think of you or your product.</p>
<div class="container">
  <img src="/w3images/bandmember.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:90px">
  <p><span>Chris Fox.</span> CEO at Mighty Schools.</p>
  <p>John Doe saved us from a web disaster.</p>
</div>

<div class="container">
  <img src="/w3images/avatar_g2.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:90px">
  <p><span >Rebecca Flex.</span> CEO at Company.</p>
  <p>No one is better than John Doe.</p>
</div>

<div class="container">
  <img src="img_avatar2.png" alt="Avatar" class="w3-left w3-circle w3-margin-right w3-grayscale" style="width:90px">
  <p><span >Julia Roberts.</span> Actor.</p>
  <p>Simply love Johnny Boy.</p>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_testimonials" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Style Testimonials</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;img src=&quot;bandmember.jpg&quot; alt=&quot;Avatar&quot; 
  style=&quot;width:90px&quot;&gt;<br>&nbsp; &lt;p&gt;&lt;span&gt;Chris Fox.&lt;/span&gt; CEO at Mighty 
  Schools.&lt;/p&gt;<br>&nbsp; &lt;p&gt;John Doe saved us from a web disaster.&lt;/p&gt;<br>&lt;/div&gt;<br><br>&lt;div 
  class=&quot;container&quot;&gt;<br>&nbsp; &lt;img src=&quot;avatar_g2.jpg&quot; alt=&quot;Avatar&quot; 
  style=&quot;width:90px&quot;&gt;<br>&nbsp; &lt;p&gt;&lt;span &gt;Rebecca Flex.&lt;/span&gt; CEO at 
  Company.&lt;/p&gt;<br>&nbsp; &lt;p&gt;No one is better than John Doe.&lt;/p&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  and margin */<br>.container {<br>&nbsp;&nbsp;&nbsp; border: 2px solid #ccc;<br>&nbsp;&nbsp;&nbsp; 
  background-color: #eee;<br>&nbsp;&nbsp;&nbsp; border-radius: 5px;<br>&nbsp;&nbsp;&nbsp; 
  padding: 16px;<br>&nbsp;&nbsp;&nbsp; margin: 16px 0;<br>}<br><br>/* Clear 
  floats after containers */<br>.container::after {<br>&nbsp;&nbsp;&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
  clear: both;<br>&nbsp;&nbsp;&nbsp; display: table;<br>}<br><br>/* Float images 
  inside the container to the left. Add a right margin, and style the image as a 
  circle */<br>.container img {<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; 
  margin-right: 20px;<br>&nbsp;&nbsp;&nbsp; border-radius: 50%;<br>}<br><br>/* 
  Increase the font-size of a span element */<br>.container span {<br>&nbsp;&nbsp;&nbsp; font-size: 20px;<br>&nbsp;&nbsp;&nbsp; 
  margin-right: 15px;<br>}<br><br>/* Add media queries for responsiveness. This 
  will center both the text and the image inside the container */<br>@media 
  (max-width: 500px) {<br>&nbsp; .container {<br>&nbsp;&nbsp;&nbsp; 
  text-align: center;<br>&nbsp; }<br><br>&nbsp; .container img {<br>&nbsp;&nbsp;&nbsp; 
  margin: auto;<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp;&nbsp;&nbsp; 
  display: block;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_testimonials" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
