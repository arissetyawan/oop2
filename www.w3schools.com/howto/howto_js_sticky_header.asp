...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_bg_gradient_scroll.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_shrink_header_scroll.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a fixed/sticky header on scroll with CSS and JavaScript.</p>
<hr>
<iframe src="tryhow_js_sticky_header.htm" style="width:100%;border:2px solid #e9e9e9;height:400px;padding:0"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_sticky_header" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style the header */<br>.header {<br>&nbsp; padding: 
  10px 16px;<br>&nbsp; background: #555;<br>&nbsp; color: #f1f1f1;<br>}<br><br>/* Page content */<br>.content {<br>&nbsp; padding: 16px;<br>}<br><br>/* 
...
<div class="w3-code notranslate jsHigh">
  ...
  function() {myFunction()};<br><br>// Get the header<br>var header = document.getElementById(&quot;myHeader&quot;);<br>
  <br>// 
  Get the offset position of the navbar<br>var sticky = 
  header.offsetTop;<br><br>// Add the sticky class to the header when you reach 
  its scroll position. Remove &quot;sticky&quot; when you leave the scroll position<br>function myFunction() {<br>&nbsp; if (window.pageYOffset 
  &gt; sticky) {<br>&nbsp;&nbsp;&nbsp; header.classList.add(&quot;sticky&quot;);<br>&nbsp; } 
  else {<br>&nbsp;&nbsp;&nbsp; header.classList.remove(&quot;sticky&quot;);<br>&nbsp; }<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_sticky_header" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
