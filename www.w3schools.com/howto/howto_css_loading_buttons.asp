...
<html lang="en-US">
<head>
<title>How To Create Loading Buttons</title>
<meta charset="utf-8">
...
<h1>How TO - Loading Buttons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_read_more.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_download_button.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create loading buttons with CSS.</p>
<hr>
...
<button class="buttonload"><i class="fa fa-refresh fa-spin"></i>Loading</button>
<br>

<hr>

<h2>How To Style Loading Buttons</h2>
...
&lt;!-- Add icon library --&gt;<br>&lt;link rel=&quot;stylesheet&quot; href=&quot;https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css&quot;&gt;<br>
  <br>&lt;!-- Add font awesome icons to buttons (note that the fa-spin class 
  rotates the icon) --&gt;<br>&lt;button class=&quot;buttonload&quot;&gt;<br>&nbsp; &lt;i class=&quot;fa fa-spinner fa-spin&quot;&gt;&lt;/i&gt;Loading<br>
  &lt;/button&gt;<br><br>&lt;button class=&quot;buttonload&quot;&gt;<br>&nbsp; &lt;i class=&quot;fa fa-circle-o-notch 
  fa-spin&quot;&gt;&lt;/i&gt;Loading<br>&lt;/button&gt;<br><br>&lt;button class=&quot;buttonload&quot;&gt;<br>&nbsp; &lt;i 
  class=&quot;fa fa-refresh fa-spin&quot;&gt;&lt;/i&gt;Loading<br>&lt;/button&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style buttons */<br>.buttonload {<br>&nbsp;&nbsp;&nbsp; 
  ...
  font-size: 16px /* Set a font size */<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_loading_buttons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Go to our <a href="/icons/default.asp">Icons Tutorial</a> to learn more about icons.</p>
<p><strong>Tip:</strong> Go to our <a href="howto_css_loader.asp">How To - CSS Loader</a> to learn how to create a loader with CSS (without an icon library).</p>
