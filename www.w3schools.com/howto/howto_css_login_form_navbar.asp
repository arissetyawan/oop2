...
<html lang="en-US">
<head>
<title>How To Create a Login Form in Navbar</title>
<style>
.topnav3 {
  overflow: hidden;
...
<h1>How TO - Login Form in a Menu</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_input_navbar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_custom_checkbox.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive navigation menu with a login form inside of it.</p>
<hr>
<div class="topnav3">
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_login_form_navbar" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Add a Login Form in Navbar</h2>
<h5>Step 1) Add HTML:</h5>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;topnav&quot;&gt;<br>&nbsp; &lt;a class=&quot;active&quot; href=&quot;#home&quot;&gt;Home&lt;/a&gt;<br>&nbsp; 
  &lt;a href=&quot;#about&quot;&gt;About&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>&nbsp; 
  &lt;div class=&quot;login-container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;form action=&quot;/action_page.php&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;text&quot; placeholder=&quot;Username&quot; name=&quot;username&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;text&quot; placeholder=&quot;Password&quot; name=&quot;psw&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;button type=&quot;submit&quot;&gt;Login&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/form&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box;}<br><br>/* Style the navbar */<br>.topnav {<br>&nbsp; overflow: hidden;<br>&nbsp; 
  background-color: #e9e9e9;<br>}<br><br>/* Navbar links */<br>.topnav a {<br>&nbsp; float: left;<br>&nbsp; 
  display: block;<br>&nbsp; color: black;<br>&nbsp; text-align: center;<br>&nbsp; 
  padding: 14px 16px;<br>&nbsp; text-decoration: none;<br>&nbsp; font-size: 
  17px;<br>}<br><br>/* Navbar links on mouse-over */<br>.topnav a:hover {<br>&nbsp; 
  background-color: #ddd;<br>&nbsp; color: black;<br>}<br><br>/* Active/current 
  link */<br>.topnav a.active {<br>&nbsp; 
  background-color: #2196F3;<br>&nbsp; color: white;<br>}<br><br>/* Style the 
  input container */<br>.topnav 
  .login-container {<br>&nbsp; float: right;<br>}<br><br>/* Style the input 
  field inside the navbar */<br>.topnav input[type=text] {<br>&nbsp; 
  padding: 6px;<br>&nbsp; margin-top: 8px;<br>&nbsp; font-size: 17px;<br>&nbsp; 
  border: none;<br>&nbsp; width: 150px; /* adjust as needed (as long as it doesn't 
  break the topnav) */<br>}<br>
  <br>/* Style the button inside the input container */<br>.topnav .login-container button {<br>&nbsp; float: right;<br>&nbsp; 
  padding: 6px;<br>&nbsp; margin-top: 8px;<br>&nbsp; margin-right: 16px;<br>&nbsp; 
  background: #ddd;<br>&nbsp; font-size: 17px;<br>&nbsp; border: none;<br>&nbsp; 
  cursor: pointer;<br>}<br><br>.topnav 
  .login-container button:hover {<br>&nbsp; background: #ccc;<br>}<br><br>/* 
  Add responsiveness - On small screens, display the navbar vertically instead 
  of horizontally */<br>@media 
  screen and (max-width: 600px) {<br>&nbsp; .topnav .login-container {<br>&nbsp;&nbsp;&nbsp; 
  float: none;<br>&nbsp; }<br>&nbsp; .topnav a, .topnav input[type=text], .topnav 
  .login-container button {<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp;&nbsp;&nbsp; 
  display: block;<br>&nbsp;&nbsp;&nbsp; text-align: left;<br>&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp;&nbsp;&nbsp; margin: 0;<br>&nbsp;&nbsp;&nbsp; padding: 
  14px;<br>&nbsp; }<br>&nbsp; .topnav input[type=text] {<br>&nbsp;&nbsp;&nbsp; 
  border: 1px solid #ccc; <br>&nbsp; }<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_login_form_navbar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
