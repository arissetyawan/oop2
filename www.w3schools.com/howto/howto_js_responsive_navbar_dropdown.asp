...
<html lang="en-US">
<head>
<title>How To Create a Responsive Navbar with Dropdown</title>
<meta charset="utf-8">
...
<h1>How TO - Responsive Navbar with Dropdown</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_dropdown_sidenav.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_subnav.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive navigation bar with dropdown.</p>
<hr>
<h2>Responsive Topnav with Dropdown</h2>

<iframe src="tryhow_js_responsive_navbar_dropdown_ifr.htm" class="w3-border" style="width:100%;" id="myifr"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_responsive_navbar_dropdown" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create A Responsive Topnav with Dropdown</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;topnav&quot; id=&quot;myTopnav&quot;&gt;<br>&nbsp; &lt;a href=&quot;#home&quot; 
  class=&quot;active&quot;&gt;Home&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#news&quot;&gt;News&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>&nbsp; 
  ...
  &lt;a href=&quot;#&quot;&gt;Link 1&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#&quot;&gt;Link 
  2&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#&quot;&gt;Link 3&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;/div&gt;<br>&nbsp; &lt;/div&gt; <br>&nbsp; &lt;a href=&quot;#about&quot;&gt;About&lt;/a&gt;<br>&nbsp; &lt;a 
  href=&quot;javascript:void(0);&quot; class=&quot;icon&quot; onclick=&quot;myFunction()&quot;&gt;&amp;#9776;&lt;/a&gt;<br>
  &lt;/div&gt;</div>
</div>
...
<div class="w3-code notranslate cssHigh">
  /* Add a black background color to the top navigation */<br>.topnav {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #333;<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>}<br><br>/* Style the 
  links inside the navigation bar */<br>.topnav a {<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; 
  display: block;<br>&nbsp;&nbsp;&nbsp; color: #f2f2f2;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>&nbsp;&nbsp;&nbsp; 
  padding: 14px 16px;<br>&nbsp;&nbsp;&nbsp; text-decoration: none;<br>&nbsp;&nbsp;&nbsp; font-size: 17px;<br>}<br>
  <br>/* Add an active class to highlight the current page */<br>.active {<br>
  &nbsp;&nbsp;&nbsp; background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; color: white;<br>}<br><br>/* Hide the 
  link that should open and close the topnav on small screens */<br>.topnav 
  .icon {<br>&nbsp;&nbsp;&nbsp; display: none;<br>}<br><br>/* Dropdown container - needed to 
  position the dropdown content */<br>.dropdown {<br>&nbsp;&nbsp;&nbsp; float: 
  left;<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>}<br><br>/* Style the 
  dropdown button to fit inside the topnav */<br>.dropdown .dropbtn {<br>&nbsp;&nbsp;&nbsp; 
  font-size: 17px; <br>&nbsp;&nbsp;&nbsp; border: none;<br>&nbsp;&nbsp;&nbsp; 
  outline: none;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
  padding: 14px 16px;<br>&nbsp;&nbsp;&nbsp; background-color: inherit;<br>&nbsp;&nbsp;&nbsp; 
  font-family: inherit;<br>&nbsp;&nbsp;&nbsp; margin: 0;<br>}<br><br>/* Style 
  the dropdown content (hidden by default) */<br>.dropdown-content {<br>&nbsp;&nbsp;&nbsp; display: none;<br>&nbsp;&nbsp;&nbsp; 
  position: absolute;<br>&nbsp;&nbsp;&nbsp; background-color: #f9f9f9;<br>&nbsp;&nbsp;&nbsp; 
  min-width: 160px;<br>&nbsp;&nbsp;&nbsp; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);<br>&nbsp;&nbsp;&nbsp; 
  z-index: 1;<br>}<br><br>/* Style the links inside the dropdown */<br>
  .dropdown-content a {<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp;&nbsp;&nbsp; 
  color: black;<br>&nbsp;&nbsp;&nbsp; padding: 12px 16px;<br>&nbsp;&nbsp;&nbsp; 
  text-decoration: none;<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; 
  text-align: left;<br>}<br><br>/* Add a dark background on topnav links and the 
  dropdown button on hover */<br>.topnav a:hover, .dropdown:hover .dropbtn {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #555;<br>&nbsp;&nbsp;&nbsp; color: white;<br>}<br><br>/* Add 
  a grey background to dropdown links on hover */<br>.dropdown-content a:hover {<br>&nbsp;&nbsp;&nbsp; background-color: #ddd;<br>&nbsp;&nbsp;&nbsp; 
  color: black;<br>}<br><br>/* Show the dropdown menu when the user moves the 
  mouse over the dropdown button */<br>.dropdown:hover 
  .dropdown-content {<br>&nbsp;&nbsp;&nbsp; display: block;<br>}<br><br>/* When the screen is less than 600 pixels wide, hide all links, except 
for the first one ("Home"). Show the link that 
contains should open and close the topnav (.icon) */<br>@media screen and 
  (max-width: 600px) {<br>&nbsp; .topnav a:not(:first-child), .dropdown .dropbtn 
  {<br>&nbsp;&nbsp;&nbsp; display: none;<br>&nbsp; }<br>&nbsp; .topnav a.icon {<br>&nbsp;&nbsp;&nbsp; 
  float: right;<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp; }<br>}<br><br>
...
screens (display the links vertically instead of horizontally) */<br>@media screen and (max-width: 600px) {<br>&nbsp; 
...
display: block;<br>&nbsp;&nbsp;&nbsp; text-align: left;<br>&nbsp; }<br>&nbsp; .topnav.responsive 
  .dropdown {float: none;}<br>&nbsp; .topnav.responsive .dropdown-content 
  {position: relative;}<br>&nbsp; .topnav.responsive .dropdown .dropbtn {<br>&nbsp;&nbsp;&nbsp; 
  display: block;<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; 
  text-align: left;<br>&nbsp; }<br>}</div>
</div>
<hr>
...
var x = document.getElementById("myTopnav");<br>&nbsp;&nbsp;&nbsp; if (x.className 
=== "topnav") {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.className += " 
responsive";<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.className = "topnav";<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_responsive_navbar_dropdown" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
navbars.</p>
<p><strong>Tip:</strong> Go to our <a href="howto_js_sidenav.asp">Side Navigation Tutorial</a> to learn about how to create closable side navigations.</p>
<br>
