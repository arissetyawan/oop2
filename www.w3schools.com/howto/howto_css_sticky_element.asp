...
<html lang="en-US">
<head>
<title>How To Create a Sticky Element</title>
<meta charset="utf-8">
...
<h1>How TO - Sticky Element</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_fixed_footer.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_equal_height.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a sticky element with CSS.</p>
<hr>

<iframe src="tryhow_css_sticky_element.htm" style="border:none;width:100%;height:288px;border:6px solid #f1f1f1"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_sticky_element" class="w3-btn">Try it Yourself &raquo;</a></p>
<p><strong>Note:</strong> This example does not work in Internet Explorer or Edge 15 and earlier versions.</p>
<hr>
...
<div class="w3-code notranslate cssHigh">
  div.sticky {<br>&nbsp;&nbsp;&nbsp; position: -webkit-sticky; /* Safari */<br>&nbsp;&nbsp;&nbsp; 
  position: sticky;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_sticky_element" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
