...
<html lang="en-US">
<head>
<title>How To Create a Dropup Menu</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_subnav.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_mega_menu.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a dropup menu with CSS.</p>
<hr>
<h2>Dropup</h2>

<p>A dropup menu is a toggleable menu that allows the user to choose one value from a predefined list:</p>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_dropup_hover" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>
<h2>Create A Hoverable Dropup</h2>
<p>Create a dropup menu that appears when the user moves the mouse over an 
element.</p>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class="dropup"&gt;<br>&nbsp; &lt;button class="dropbtn"&gt;Dropup&lt;/button&gt;<br>&nbsp; 
&lt;div class="dropup-content"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href="#"&gt;Link 
1&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;a href="#"&gt;Link 2&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href="#"&gt;Link 3&lt;/a&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>

<h3>Example Explained</h3>
<p>Use any element to open the dropup menu, e.g. a &lt;button&gt;, &lt;a&gt; 
or &lt;p&gt; element.</p>
<p>Use a container element (like &lt;div&gt;) to create the dropup menu and add the 
dropup links inside 
it.</p>
<p>Wrap a &lt;div&gt; element around the button and the &lt;div&gt; to position the 
dropup menu correctly with CSS.</p>
<hr>
<h5>Step 2) Add CSS:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
/* Dropup Button */<br>.dropbtn {<br>&nbsp;&nbsp;&nbsp; background-color: #3498DB;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
padding: 16px;<br>&nbsp;&nbsp;&nbsp; font-size: 16px;<br>&nbsp;&nbsp;&nbsp; 
border: none;<br>}<br><br>/* The 
container &lt;div&gt; - needed to position the dropup content */<br>.dropup {<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; display: 
inline-block;<br>}<br><br>/* Dropup content (Hidden by Default) */<br>
.dropup-content {<br>&nbsp;&nbsp;&nbsp; display: none;<br>&nbsp;&nbsp;&nbsp; position: 
absolute;<br>&nbsp;&nbsp;&nbsp; bottom: 50px;<br>&nbsp;&nbsp;&nbsp; background-color: #f1f1f1;<br>&nbsp;&nbsp;&nbsp; 
min-width: 160px;<br>&nbsp;&nbsp;&nbsp; box-shadow: 
0px 8px 16px 0px rgba(0,0,0,0.2);<br>&nbsp;&nbsp;&nbsp; z-index: 1;<br>}<br><br>/* Links inside the 
  dropup */<br>
.dropup-content a {<br>&nbsp;&nbsp;&nbsp; color: black;<br>&nbsp;&nbsp;&nbsp; 
padding: 12px 16px;<br>&nbsp;&nbsp;&nbsp; text-decoration: none;<br>&nbsp;&nbsp;&nbsp; 
display: block;<br>}<br><br>/* Change color of dropup links on hover */<br>
.dropup-content a:hover {background-color: #ddd}<br><br>/* Show the 
  dropup menu on hover */<br>.dropup:hover .dropup-content {<br>&nbsp;&nbsp;&nbsp; 
display: block;<br>}<br><br>/* Change the background color of the dropup button when the 
  dropup content is shown */<br>.dropup:hover .dropbtn {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #2980B9;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_dropup_hover" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
<p>We have styled the dropup button with a background-color, padding, etc.</p>
<p>The <code class="w3-codespan">.dropup</code> class uses <code class="w3-codespan">position:relative</code>, which is needed when we want the 
dropup content to be placed on top of the dropup button (using <code class="w3-codespan">position:absolute</code>).</p>
<p>The <code class="w3-codespan">.dropup-content</code> class holds the actual 
...
this. <strong>Tip:</strong> If you want the width of the dropup content to be 
as wide as the dropup button, set the <code class="w3-codespan">width</code> to 100% (and <code class="w3-codespan">overflow:auto</code> to 
...
<p>The <code class="w3-codespan">:hover</code> selector is used to show the 
dropup menu when the user moves the 
mouse over the dropup button.</p>
