...
<html lang="en-US">
<head>
<title>How To Create a Side Navigation Dropdown</title>
<meta charset="utf-8">
...
<h1>How TO - Dropdown Sidebar</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_dropdown_navbar.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_responsive_navbar_dropdown.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to add a dropdown menu inside a side navigation.</p>
<hr>
<h2>Dropdown Menu in Sidenav</h2>

<div style="padding:10px;border:3px solid #f1f1f1">
<iframe src="tryhow_js_sidenav_dropdown_ifr.htm" style="width:100%;border:none;height:330px;"></iframe>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav_dropdown" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create A Dropdown Sidebar</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;sidenav&quot;&gt;<br>&nbsp; &lt;a href=&quot;#about&quot;&gt;About&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#services&quot;&gt;Services&lt;/a&gt;<br>&nbsp; 
  &lt;a href=&quot;#clients&quot;&gt;Clients&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>&nbsp; 
  &lt;button class=&quot;dropdown-btn&quot;&gt;Dropdown <br>&nbsp;&nbsp;&nbsp; &lt;i class=&quot;fa fa-caret-down&quot;&gt;&lt;/i&gt;<br>&nbsp; 
  &lt;/button&gt;<br>&nbsp; &lt;div class=&quot;dropdown-container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a 
  href=&quot;#&quot;&gt;Link 1&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#&quot;&gt;Link 2&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;a href=&quot;#&quot;&gt;Link 3&lt;/a&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;a href=&quot;#contact&quot;&gt;Search&lt;/a&gt;<br>
  &lt;/div&gt;</div>
</div>
...
it. We will use the same styling for all links inside the sidenav.</p>
<hr>
<h5>Step 2) Add CSS:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Fixed sidenav, full height */<br>.sidenav {<br>&nbsp; height: 100%;<br>&nbsp; 
  width: 200px;<br>&nbsp; position: fixed;<br>&nbsp; z-index: 1;<br>&nbsp; top: 
  0;<br>&nbsp; left: 0;<br>&nbsp; background-color: #111;<br>&nbsp; overflow-x: 
  hidden;<br>&nbsp; padding-top: 20px;<br>}<br>
  <br>/* Style the sidenav links and the dropdown button */<br>.sidenav a, 
  .dropdown-btn {<br>&nbsp; padding: 6px 8px 6px 16px;<br>&nbsp; 
  text-decoration: none;<br>&nbsp; font-size: 20px;<br>&nbsp; color: #818181;<br>&nbsp; 
  display: block;<br>&nbsp; border: none;<br>&nbsp; background: none;<br>&nbsp; 
  width:100%;<br>&nbsp; text-align: left;<br>&nbsp; cursor: pointer;<br>&nbsp; 
  outline: none;<br>}<br><br>/* On mouse-over */<br>.sidenav a:hover, .dropdown-btn:hover 
  {<br>&nbsp; color: #f1f1f1;<br>}<br><br>/* Main content */<br>.main {<br>&nbsp; 
  margin-left: 200px; /* Same as the width of the sidenav */<br>&nbsp; 
  font-size: 20px; /* Increased text to enable scrolling */<br>&nbsp; padding: 
  0px 10px;<br>}<br><br>/* Add an active 
  class to the active dropdown button */<br>.active {<br>&nbsp; 
  background-color: green;<br>&nbsp; color: white;<br>}<br><br>/* Dropdown container (hidden by default). 
  Optional: add a lighter background color and some left padding to change the 
  design of the dropdown content */<br>.dropdown-container {<br>&nbsp; display: 
  none;<br>&nbsp; background-color: #262626;<br>&nbsp; padding-left: 8px;<br>}<br><br>/* Optional: 
  Style the caret down icon */<br>.fa-caret-down {<br>&nbsp; float: right;<br>&nbsp; 
  padding-right: 8px;<br>}</div>
...
<div class="w3-code notranslate jsHigh">
  ...
  conflict */<br>var dropdown = document.getElementsByClassName(&quot;dropdown-btn&quot;);<br>
  var i;<br><br>for (i = 0; i &lt; dropdown.length; i++) {<br>&nbsp; dropdown[i].addEventListener(&quot;click&quot;, 
  function() {<br>&nbsp;&nbsp;&nbsp; this.classList.toggle(&quot;active&quot;);<br>&nbsp;&nbsp;&nbsp; 
  var dropdownContent = this.nextElementSibling;<br>&nbsp;&nbsp;&nbsp; if (dropdownContent.style.display 
  === &quot;block&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; dropdownContent.style.display 
  = &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  dropdownContent.style.display = &quot;block&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; });<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_sidenav_dropdown" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
