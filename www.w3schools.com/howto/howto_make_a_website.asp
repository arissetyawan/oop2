...
<a class="w3-left w3-btn" href="howto_js_element_iframe.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_website.asp">Next &#10095;</a>
</div>
<hr>
...
<iframe src="tryhow_make_a_website_ifr.htm" class="w3-round" style="width:100%;border:6px solid #e9e9e9;height:600px"></iframe>
<div class="w3-row-padding" style="margin:16px -16px 0 -16px">
  <div class="w3-col m6">
    <a href="tryhow_make_a_website.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey w3-block">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="tryit.asp?filename=tryhow_make_a_website" target="_blank" class="w3-btn w3-padding-large w3-green w3-block">Try it Yourself</a>
  </div>
</div>
</div>
<hr>
<h2>A &quot;Layout Draft&quot;</h2>
<p>It can be wise to draw a layout draft of the page design before creating a website:</p>

<div class="w3-border">

<div class="w3-display-container w3-dark-grey" style="height:250px">
<div class="w3-display-middle w3-xlarge">Header</div>
</div>
...
<div class="w3-col s4 w3-light-grey w3-padding" style="height:300px">
<h3>Side Content</h3>
...
<hr>
<h2>First Step - Basic HTML Page</h2>
<p>HTML is the standard markup language for creating websites and CSS is the language that describes the style of an HTML document. We will combine HTML and CSS to create a basic web page.</p>
<p><strong>Note:</strong> If you don't know HTML and CSS, <a href="/html/default.asp">we suggest that you read out HTML Tutorial</a>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;!DOCTYPE html&gt;<br>
&lt;html lang=&quot;en&quot;&gt;<br>&lt;head&gt;<br>&lt;title&gt;Page Title&lt;/title&gt;<br>&lt;meta 
  charset=&quot;UTF-8&quot;&gt;<br>&lt;meta name=&quot;viewport&quot; content=&quot;width=device-width, 
  initial-scale=1&quot;&gt;<br>&lt;style&gt;<br>body {<br>&nbsp;&nbsp;&nbsp; 
  font-family: Arial, Helvetica, sans-serif;<br>}<br>&lt;/style&gt;<br>
 &lt;/head&gt;<br>
&lt;body&gt;<br><br>&lt;h1&gt;My Website&lt;/h1&gt;<br>&lt;p&gt;A website created by me.&lt;/p&gt;<br><br>
    &lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_make_a_website_intro" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
page</li>
 ...
 <li>The <code class="w3-codespan">&lt;meta&gt;</code> element should define the character set to be UTF-8</li>
 <li>The <code class="w3-codespan">&lt;meta&gt;</code> element with name="viewport" makes the website look good on all devices and screen resolutions</li>
 <li>The <code class="w3-codespan">&lt;style&gt;</code> element contains the styles for the website (layout/design)</li>
...
<p>Inside the <code class="w3-codespan">&lt;body&gt;</code> element of our website, we will use our &quot;Layout 
Draft&quot; 
and create:</p>
<ul>
 <li>A header</li>
...
<p>A header is usually located at the top of the website (or right below a top 
navigation menu). It often contains a logo or the website name:</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;header&quot;&gt;<br>&nbsp; &lt;h1&gt;My Website&lt;/h1&gt;<br>&nbsp; &lt;p&gt;A website 
  created by me.&lt;/p&gt;<br>&lt;/div&gt;</div>
<p>
</div>

<p>Then we use CSS to style the header:</p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
  .header {<br>&nbsp;&nbsp;&nbsp; padding: 80px; /* some padding */<br>&nbsp;&nbsp;&nbsp; 
  text-align: center; /* center the text */<br>&nbsp;&nbsp;&nbsp; background: #1abc9c; 
  /* green background */<br>&nbsp;&nbsp;&nbsp; 
  color: white; /* white text color */<br>}<br><br>/* Increase the font size of the &lt;h1&gt; element */<br>
  .header h1 {<br>&nbsp;&nbsp;&nbsp; font-size: 40px;<br>}</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryhow_make_a_website_header" target="_blank">Try it Yourself &raquo;</a></p>
</div>
...
<p>A navigation bar contains a list of links to help visitors navigating through 
your website:</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;navbar&quot;&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Link&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot;&gt;Link&lt;/a&gt;<br>&nbsp; 
  &lt;a href=&quot;#&quot;&gt;Link&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#&quot; class=&quot;right&quot;&gt;Link&lt;/a&gt;<br>&lt;/div&gt;</div>
</div>

<p>Use CSS to style the navigation bar:</p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
  /* Style the top navigation bar */<br>.navbar {<br>&nbsp;&nbsp;&nbsp; 
  overflow: hidden; /* Hide overflow */<br>&nbsp;&nbsp;&nbsp; background-color: #333; 
  /* Dark background color */<br>}<br><br>/* Style the navigation bar links */<br>.navbar 
  a {<br>&nbsp;&nbsp;&nbsp; float: left; /* Make sure that the links stay 
  side-by-side */<br>&nbsp;&nbsp;&nbsp; display: block; /* Change the display to 
  block, for responsive reasons (see below) */<br>&nbsp;&nbsp;&nbsp; 
  color: white; /* White text color */<br>&nbsp;&nbsp;&nbsp; text-align: center; 
  /* Center the text */<br>&nbsp;&nbsp;&nbsp; 
  padding: 14px 20px; /* Add some padding */<br>&nbsp;&nbsp;&nbsp; text-decoration: none; 
  /* Remove underline */<br>}<br><br>/* 
  Right-aligned link */<br>.navbar a.right {<br>&nbsp;&nbsp;&nbsp; float: right; 
  /* Float a link to the right */<br>
  }<br><br>/* 
  Change color on hover/mouse-over */<br>.navbar a:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #ddd; /* Grey background color */<br>&nbsp;&nbsp;&nbsp; color: black; 
  /* Black text color */<br>}<br></div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryhow_make_a_website_navbar" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<hr>

<h2>Content</h2>

<p>Create a 2-column layout, divided into a &quot;side content&quot; and a &quot;main content&quot;.</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;row&quot;&gt;<br>&nbsp; &lt;div class=&quot;side&quot;&gt;...&lt;/div&gt;<br>&nbsp; &lt;div 
  class=&quot;main&quot;&gt;...&lt;/div&gt;<br>&lt;/div&gt;</div>
</div>

<p>We use CSS Flexbox to handle the layout:</p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
  /* Ensure proper sizing */<br>* {<br>&nbsp; box-sizing: border-box;<br>}<br><br>/* Column container */<br>.row { <br>&nbsp;&nbsp;&nbsp; display: flex;<br>&nbsp;&nbsp;&nbsp; flex-wrap: wrap;<br>}<br><br>/* Create 
  two unequal columns that sits next to each other */<br>/* Sidebar/left column 
  */<br>.side {<br>&nbsp;&nbsp;&nbsp; flex: 30%; /* Set the width of the sidebar 
  */<br>&nbsp;&nbsp;&nbsp; background-color: #f1f1f1; /* Grey background color 
  */<br>&nbsp;&nbsp;&nbsp; padding: 20px; /* Some padding */<br>}<br><br>/* Main column */<br>.main {
  <br>&nbsp;&nbsp;&nbsp; flex: 70%; /* Set the width of the main content */<br>&nbsp;&nbsp;&nbsp; 
  background-color: white; /* White background color */<br>&nbsp;&nbsp;&nbsp; 
  padding: 20px; /* Some padding */<br>}<br></div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryhow_make_a_website_content" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<p>Then add media queries to make the layout responsive. This will make sure 
that your website looks good on all devices (desktops, laptops, tablets and 
phones). Resize the browser window to see the result.</p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
  /* Responsive layout - when the screen is less than 700px wide, make the two 
  columns stack on top of each other instead of next to each other */<br>@media 
  screen and (max-width: 700px) {<br>&nbsp;&nbsp;&nbsp; .row { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  flex-direction: column;<br>&nbsp;&nbsp;&nbsp; }<br>}<br><br>/* 
  Responsive layout - when the screen is less than 400px wide, make the 
  navigation links stack on top of each other instead of next to each other */<br>
  @media screen and (max-width: 400px) {<br>&nbsp;&nbsp;&nbsp; .navbar a {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  float: none;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; 
  }<br>}<br></div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryhow_make_a_website_content_responsive" target="_blank">Try it Yourself &raquo;</a></p>
</div>

<div class="w3-note w3-panel">
<p><strong>Tip:</strong> To create a different kind of layout, just change the flex width (but make sure that it adds up to 100%).</p>
<p><strong>Tip:</strong> Do you wonder how the @media rule works? <a href="/css/css3_mediaqueries.asp">Read more about 
it in our CSS Media Queries chapter</a>.</p>
<p><strong>Tip:</strong> To learn more about the Flexible Box Layout Module, <a href="/css/css3_flexbox.asp"> read our  
...
<p>You can read more about the box-sizing property in our <a href="/css/css3_box-sizing.asp">CSS Box Sizing Tutorial</a>.</p>
</div>
<hr>

<h2>Footer</h2>

<p>At last, we will add a footer.</p>

<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;footer&quot;&gt;<br>&nbsp; &lt;h2&gt;Footer&lt;/h2&gt;<br>&lt;/div&gt;</div>
<p>
</div>
<p>And style it:</p>
<div class="w3-example">
<div class="w3-code notranslate cssHigh">
  .footer {<br>&nbsp;&nbsp;&nbsp; padding: 20px; /* Some padding */<br>&nbsp;&nbsp;&nbsp; 
  text-align: center; /* Center text*/<br>&nbsp;&nbsp;&nbsp; background: #ddd; 
  /* Grey background */<br>}</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=tryhow_make_a_website_footer" target="_blank">Try it Yourself &raquo;</a></p>
</div>
<p>Congratulations! You have built a responsive website from scratch.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_element_iframe.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_website.asp">Next &#10095;</a>
