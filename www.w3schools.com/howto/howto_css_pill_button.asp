...
<html lang="en-US">
<head>
<title>How To Create a Pill Button</title>
<meta charset="utf-8">
...
<h1>How TO - Pill Buttons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_download_button.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_notification_button.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create pill buttons with CSS.</p>
<hr>

<button class="button">Square Button</button>
<button class="button pill">Pill Button</button>
<hr>

<h2>How To Create a Pill Button</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button class=&quot;button&quot;&gt;Pill Button&lt;/button&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .button {<br>&nbsp; background-color: #ddd;<br>&nbsp; border: none;<br>&nbsp; 
  color: black;<br>&nbsp; padding: 10px 20px;<br>&nbsp; text-align: center;<br>&nbsp; 
  text-decoration: none;<br>&nbsp; display: inline-block;<br>&nbsp; margin: 4px 
  2px;<br>&nbsp; cursor: pointer;<br>&nbsp; <strong>border-radius: 16px;</strong><br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_pill_button" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
