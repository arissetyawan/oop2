...
<html lang="en-US">
<head>
<title>How To Create a Callout Message Box</title>
<meta charset="utf-8">
...
<h1>How TO - Callout Message</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_alert.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_notes.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create callout messages with CSS.</p>
<hr>
<h2>Callout</h2>
<p>A callout message is often positioned at the bottom of a page to notify the user about something special: tips/tricks, discounts, action needed, other.</p>

<iframe src="tryhow_js_callout.htm" style="width:100%;height:330px;border:3px solid #ddd;padding:5px"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_callout" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>Create a Callout</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;callout&quot;&gt;<br>&nbsp; &lt;div class=&quot;callout-header&quot;&gt;Callout 
  Header&lt;/div&gt;<br>&nbsp; &lt;span class=&quot;closebtn&quot; onclick=&quot;this.parentElement.style.display='none';&quot;&gt;&amp;times;&lt;/span&gt;<br>&nbsp; 
  &lt;div class=&quot;callout-container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Some text...&lt;/p&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
<p>If you want the ability to close the callout message, add a &lt;span&gt; element with 
...
<p>Style the callout box and the close button:</p>
<div class="w3-example">
<h3>Example</h3>
  <div class="w3-code notranslate cssHigh">
    /* Callout box 
    - fixed position at the bottom of the page */<br>.callout {<br>&nbsp; position: fixed;<br>&nbsp; bottom: 35px;<br>&nbsp; 
    right: 20px;<br>&nbsp; margin-left: 20px;<br>&nbsp; max-width: 300px;<br>}<br><br>/* Callout header */<br>
    .callout-header {<br>&nbsp; padding: 25px 
    15px;<br>&nbsp; background: #555;<br>&nbsp; font-size: 30px;<br>&nbsp; 
    color: white;<br>}<br><br>/* Callout container/body */<br>.callout-container 
    {<br>&nbsp; padding: 15px;<br>&nbsp; background-color: 
    #ccc;<br>&nbsp; color: black<br>}<br><br>/* Close button */<br>.closebtn {<br>&nbsp; position: 
    absolute;<br>&nbsp; top: 5px;<br>&nbsp; right: 15px;<br>&nbsp; color: white;<br>&nbsp; 
    font-size: 30px;<br>&nbsp; cursor: pointer;<br>}<br><br>/* Change color on 
    mouse-over */<br>.closebtn:hover {<br>&nbsp; color: lightgrey;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_callout" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Also check out <a href="howto_js_alert.asp">Alert Messages</a>.</p>
