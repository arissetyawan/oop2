...
<html lang="en-US">
<head>
<title>How To Create Custom Select Menus</title>
<meta charset="utf-8">
...
<h1>How TO - Custom Select Box</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_custom_checkbox.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_switch.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create custom select boxes with CSS and JavaScript.</p>
<hr>
<h2>Custom Select Box</h2>
<div class="w3-row" style="padding:10px 16px 20px 16px;border:4px solid #f1f1f1;">
<div class="w3-col m6">
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_custom_select" class="w3-btn">Try it Yourself &raquo;</a></p>
...
<h2>Create a Custom Select Menu</h2>
<h5>Step 1) Add HTML:</h5>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!--surround the select box within a &quot;custom-select&quot; DIV element.<br>Remember 
  to set the width:--&gt;<br>&lt;div class=&quot;custom-select&quot; style=&quot;width:200px;&quot;&gt;<br>&nbsp; 
  &lt;select&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option value=&quot;0&quot;&gt;Select car:&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;option value=&quot;1&quot;&gt;Audi&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
  value=&quot;2&quot;&gt;BMW&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
  value=&quot;3&quot;&gt;Citroen&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
  value=&quot;4&quot;&gt;Ford&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option value=&quot;5&quot;&gt;Honda&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;option value=&quot;6&quot;&gt;Jaguar&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option value=&quot;7&quot;&gt;Land 
  Rover&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option value=&quot;8&quot;&gt;Mercedes&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;option value=&quot;9&quot;&gt;Mini&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
  value=&quot;10&quot;&gt;Nissan&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
  value=&quot;11&quot;&gt;Toyota&lt;/option&gt;<br>&nbsp;&nbsp;&nbsp; &lt;option 
  value=&quot;12&quot;&gt;Volvo&lt;/option&gt;<br>&nbsp; &lt;/select&gt;<br>&lt;/div&gt;<br></div>
</div>
...
<div class="w3-code notranslate cssHigh">
  /*the container must be positioned relative:*/<br>.custom-select {<br>&nbsp; 
  position: relative;<br>&nbsp; font-family: Arial;<br>}<br>.custom-select select {<br>&nbsp; 
  display: none; /*hide original SELECT element:*/<br>}<br>.select-selected {<br>&nbsp; 
  background-color: DodgerBlue;<br>}<br>/*style the arrow inside the select 
  element:*/<br>.select-selected:after {<br>&nbsp; position: absolute;<br>&nbsp; 
  content: &quot;&quot;;<br>&nbsp; top: 14px;<br>&nbsp; right: 10px;<br>&nbsp; width: 0;<br>&nbsp; 
  height: 0;<br>&nbsp; border: 6px solid transparent;<br>&nbsp; border-color: #fff 
  transparent transparent transparent;<br>}<br>
  /*point the arrow upwards when the select box is open (active):*/<br>.select-selected.select-arrow-active:after 
  {<br>&nbsp; border-color: transparent transparent #fff transparent;<br>&nbsp; 
  top: 7px;<br>}<br>
  /*style the items (options), including the selected item:*/<br>.select-items 
  div,.select-selected {<br>&nbsp; color: #ffffff;<br>&nbsp; padding: 8px 16px;<br>&nbsp; 
  border: 1px solid transparent;<br>&nbsp; border-color: transparent transparent 
  rgba(0, 0, 0, 0.1) transparent;<br>&nbsp; cursor: pointer;<br>}<br>/*style items (options):*/<br>
  .select-items {<br>&nbsp; position: absolute;<br>&nbsp; background-color: 
  DodgerBlue;<br>&nbsp; top: 100%;<br>&nbsp; left: 0;<br>&nbsp; right: 0;<br>&nbsp; 
  z-index: 99;<br>}<br>/*hide the items 
  when the select box is closed:*/<br>.select-hide {<br>&nbsp; display: none;<br>
  }<br>
  .select-items div:hover, .same-as-selected {<br>&nbsp; background-color: rgba(0, 0, 0, 0.1);<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var x, i, j, selElmnt, a, b, c;<br>/*look for any elements with the class 
  &quot;custom-select&quot;:*/<br>x = document.getElementsByClassName(&quot;custom-select&quot;);<br>
  for (i = 0; i &lt; x.length; i++) {<br>&nbsp; selElmnt = x[i].getElementsByTagName(&quot;select&quot;)[0];<br>&nbsp; /*for each element, create a new 
  DIV that will act as the selected item:*/<br>&nbsp; 
  a = document.createElement(&quot;DIV&quot;);<br>&nbsp; a.setAttribute(&quot;class&quot;, 
  &quot;select-selected&quot;);<br>&nbsp; a.innerHTML = selElmnt.options[selElmnt.selectedIndex].innerHTML;<br>&nbsp; 
  x[i].appendChild(a);<br>&nbsp; /*for each element, create a new DIV that will 
  contain the option list:*/<br>&nbsp; b = document.createElement(&quot;DIV&quot;);<br>&nbsp; 
  b.setAttribute(&quot;class&quot;, &quot;select-items select-hide&quot;);<br>&nbsp; for (j = 
  1; j &lt; selElmnt.length; j++) {<br>&nbsp;&nbsp;&nbsp; /*for each option in the 
  original select element,<br>&nbsp;&nbsp;&nbsp; create a new DIV that will act 
  as an option item:*/<br>&nbsp;&nbsp;&nbsp; c = document.createElement(&quot;DIV&quot;);<br>&nbsp;&nbsp;&nbsp; 
  c.innerHTML = selElmnt.options[j].innerHTML;<br>&nbsp;&nbsp;&nbsp; 
  c.addEventListener(&quot;click&quot;, function(e) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /*when an item is clicked, update the original select box,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  and the selected item:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var y, 
  i, k, s, h;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; s = 
  this.parentNode.parentNode.getElementsByTagName(&quot;select&quot;)[0];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  h = this.parentNode.previousSibling;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  for (i = 0; i &lt; s.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  if (s.options[i].innerHTML == this.innerHTML) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  s.selectedIndex = i;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  h.innerHTML = this.innerHTML;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  y = this.parentNode.getElementsByClassName(&quot;same-as-selected&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  for (k = 0; k &lt; y.length; k++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  y[k].removeAttribute(&quot;class&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  this.setAttribute(&quot;class&quot;, &quot;same-as-selected&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  break;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; h.click();<br>&nbsp;&nbsp;&nbsp; 
  });<br>&nbsp;&nbsp;&nbsp; b.appendChild(c);<br>&nbsp; }<br>&nbsp; x[i].appendChild(b);<br>&nbsp; 
  a.addEventListener(&quot;click&quot;, function(e) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /*when the select box is clicked, close any other select boxes,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  and open/close the current select box:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  e.stopPropagation();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; closeAllSelect(this);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  this.nextSibling.classList.toggle(&quot;select-hide&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  this.classList.toggle(&quot;select-arrow-active&quot;);<br>&nbsp; });<br>}<br>function closeAllSelect(elmnt) {<br>&nbsp; /*a function that will 
  close all select boxes in the document,<br>&nbsp; except the current select 
  box:*/<br>&nbsp; var x, y, i, arrNo = [];<br>&nbsp; x = 
  document.getElementsByClassName(&quot;select-items&quot;);<br>&nbsp; y = 
  document.getElementsByClassName(&quot;select-selected&quot;);<br>&nbsp; for (i = 0; i &lt; 
  y.length; i++) {<br>&nbsp;&nbsp;&nbsp; if (elmnt == y[i]) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  arrNo.push(i)<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  y[i].classList.remove(&quot;select-arrow-active&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; 
  }<br>&nbsp; for (i = 0; i &lt; x.length; i++) {<br>&nbsp;&nbsp;&nbsp; if (arrNo.indexOf(i)) 
  {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x[i].classList.add(&quot;select-hide&quot;);<br>&nbsp;&nbsp;&nbsp; 
  }<br>&nbsp; }<br>}<br>/*if the user clicks anywhere outside the select box,<br>then 
  close all select boxes:*/<br>document.addEventListener(&quot;click&quot;, closeAllSelect);</div>
<a target="_blank" href="tryit.asp?filename=tryhow_custom_select" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
