...
<html lang="en-US">
<head>
<title>How To Create a Responsive Inline Form With CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Inline Form</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_popup_form.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_html_clear_input.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive inline form with CSS.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_inline_form" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>
<h2>How To Create an Inline Form</h2>
...
<div class="w3-code notranslate htmlHigh">
  &lt;form class=&quot;form-inline&quot; action=&quot;/action_page.php&quot;&gt;<br>&nbsp; &lt;label 
  for=&quot;email&quot;&gt;Email:&lt;/label&gt;<br>&nbsp; &lt;input type=&quot;email&quot; id=&quot;email&quot; 
  placeholder=&quot;Enter email&quot; name=&quot;email&quot;&gt;<br>&nbsp; &lt;label for=&quot;pwd&quot;&gt;Password:&lt;/label&gt;<br>&nbsp; 
  &lt;input type=&quot;password&quot; id=&quot;pwd&quot; placeholder=&quot;Enter password&quot; name=&quot;pswd&quot;&gt;<br>&nbsp;&nbsp;&lt;label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;input type=&quot;checkbox&quot; name=&quot;remember&quot;&gt; Remember me<br>&nbsp;&nbsp;&lt;/label&gt;<br>&nbsp; &lt;button type=&quot;submit&quot;&gt;Submit&lt;/button&gt;<br>&lt;/form&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style the form - display items horizontally */<br>.form-inline { <br>&nbsp; display: flex;<br>&nbsp; flex-flow: row wrap;<br>&nbsp; 
  align-items: center;<br>}<br><br>/* Add some margins for each label */<br>.form-inline label {<br>&nbsp; margin: 5px 10px 5px 0;<br>
  }<br>
  <br>/* Style the input fields */<br>.form-inline input {<br>&nbsp; vertical-align: middle;<br>&nbsp; margin: 
  5px 10px 5px 0;<br>&nbsp; padding: 10px;<br>&nbsp; background-color: #fff;<br>&nbsp; 
  border: 1px solid #ddd;<br>}<br>
  <br>/* Style the submit button */<br>
  .form-inline button {<br>&nbsp; padding: 10px 20px;<br>&nbsp; background-color: dodgerblue;<br>
  &nbsp;
  border: 1px solid #ddd;<br>&nbsp; color: white;<br>}<br><br>.form-inline button:hover 
  {<br>&nbsp; background-color: royalblue;<br>}<br><br>/* Add responsiveness - 
  display the form controls vertically instead of horizontally on screens that 
  are less than 800px wide */<br>@media (max-width: 800px) {<br>
  &nbsp; .form-inline input {<br>&nbsp;&nbsp;&nbsp; margin: 10px 0;<br>&nbsp; }<br><br>
  &nbsp;
  .form-inline {<br>&nbsp;&nbsp;&nbsp; flex-direction: column;<br>&nbsp;&nbsp;&nbsp; align-items: stretch;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_inline_form" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
