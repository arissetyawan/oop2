...
<html lang="en-US">
<head>
<title>How To Create a Quotes Slideshow</title>
<meta charset="utf-8">
...
<h1>How TO - Quotes Slideshow</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_section_counter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_close_list_items.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a quotes slideshow with CSS and JavaScript.</p>
<hr>
<h2>Quotes Slideshow</h2>
...
function showSlides(n) {
  ...
  <p><a target="_blank" href="tryit.asp?filename=tryhow_js_quotes_slideshow" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>Create A Quotes Slideshow</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Slideshow container --&gt;<br>&lt;div class=&quot;slideshow-container&quot;&gt;<br><br>&nbsp; 
  &lt;!-- Full-width slides/quotes --&gt;<br>&nbsp; &lt;div class=&quot;mySlides&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;q&gt;I love you the more in that I believe you had liked me for my own sake and 
  for nothing else&lt;/q&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p class=&quot;author&quot;&gt;- John Keats&lt;/p&gt;<br>&nbsp; 
  &lt;/div&gt;<br><br>&nbsp; &lt;div class=&quot;mySlides&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;q&gt;But man 
  is not made for defeat. A man can be destroyed but not defeated.&lt;/q&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;p class=&quot;author&quot;&gt;- Ernest Hemingway&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br><br>&nbsp; &lt;div 
  class=&quot;mySlides&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;q&gt;I have not failed. I've just found 
  10,000 ways that won't work.&lt;/q&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p class=&quot;author&quot;&gt;- 
  Thomas A. Edison&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br><br>&nbsp; &lt;!-- Next/prev buttons --&gt;<br>&nbsp; 
  &lt;a class=&quot;prev&quot; onclick=&quot;plusSlides(-1)&quot;&gt;&amp;#10094;&lt;/a&gt;<br>&nbsp; &lt;a 
  class=&quot;next&quot; onclick=&quot;plusSlides(1)&quot;&gt;&amp;#10095;&lt;/a&gt;<br>&lt;/div&gt;<br><br>&lt;!-- 
  Dots/bullets/indicators --&gt;<br>&lt;div class=&quot;dot-container&quot;&gt;<br>&nbsp; &lt;span 
  class=&quot;dot&quot; onclick=&quot;currentSlide(1)&quot;&gt;&lt;/span&gt; <br>&nbsp; &lt;span class=&quot;dot&quot; 
  onclick=&quot;currentSlide(2)&quot;&gt;&lt;/span&gt; <br>&nbsp; &lt;span class=&quot;dot&quot; onclick=&quot;currentSlide(3)&quot;&gt;&lt;/span&gt;
  <br>&lt;/div&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>Style the slides, buttons, dots, etc:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Slideshow container */<br>.slideshow-container {<br>&nbsp; position: 
  relative;<br>&nbsp; background: #f1f1f1f1;<br>}<br><br>/* Slides */<br>.mySlides {<br>&nbsp; 
  display: none;<br>&nbsp; padding: 80px;<br>&nbsp; text-align: center;<br>}<br><br>/* Next &amp; previous buttons */<br>.prev, 
  .next {<br>&nbsp; cursor: pointer;<br>&nbsp; position: absolute;<br>&nbsp; 
  top: 50%;<br>&nbsp; width: auto;<br>&nbsp; margin-top: -30px;<br>&nbsp; 
  padding: 16px;<br>&nbsp; color: #888;<br>&nbsp; font-weight: bold;<br>&nbsp; 
  font-size: 20px;<br>&nbsp; border-radius: 0 3px 3px 0;<br>&nbsp; user-select: 
  none;<br>}<br><br>/* Position the &quot;next button&quot; to the right */<br>.next {<br>&nbsp; 
  position: absolute;<br>&nbsp; right: 0;<br>&nbsp; border-radius: 3px 0 0 3px;<br>
  }<br><br>/* On hover, 
  add a black background color with a little bit see-through */<br>.prev:hover, 
  .next:hover {<br>&nbsp; background-color: rgba(0,0,0,0.8);<br>&nbsp; color: 
  white;<br>}<br>
  <br>/* The dot/bullet/indicator container */<br>.dot-container {<br>&nbsp; 
  text-align: center;<br>&nbsp; padding: 20px;<br>&nbsp; background: #ddd;<br>}<br><br>/* The 
  dots/bullets/indicators */<br>.dot {<br>&nbsp; cursor: pointer;<br>&nbsp; 
  height: 15px;<br>&nbsp; width: 15px;<br>&nbsp; margin: 0 2px;<br>&nbsp; 
  background-color: #bbb;<br>&nbsp; border-radius: 50%;<br>&nbsp; display: 
  inline-block;<br>&nbsp; transition: background-color 0.6s ease;<br>}<br>
  <br>/* Add a background color to the active dot/circle */<br>.active, .dot:hover 
  {<br>&nbsp; background-color: #717171;<br>}<br><br>/* Add an italic font style to all 
  quotes */<br>q {font-style: italic;}<br><br>/* Add a blue color to the author 
  */<br>.author {color: cornflowerblue;}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var slideIndex = 1;<br>showSlides(slideIndex);<br><br>function plusSlides(n) {<br>&nbsp; 
  showSlides(slideIndex += n);<br>}<br><br>function currentSlide(n) {<br>&nbsp; 
  ...
  slides[i].style.display = &quot;none&quot;; <br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; 
  for (i = 0; i &lt; dots.length; i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; dots[i].className 
  = dots[i].className.replace(&quot; active&quot;, &quot;&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; 
  slides[slideIndex-1].style.display = &quot;block&quot;; <br>&nbsp; dots[slideIndex-1].className 
  += &quot; active&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_quotes_slideshow" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Also check out <a href="howto_js_slideshow.asp">How To - Image Slideshow</a> and <a href="howto_js_lightbox.asp">How To - Lightbox</a>.</p>
