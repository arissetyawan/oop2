...
<html lang="en-US">
<head>
<title>How To Create a Button Group</title>
<meta charset="utf-8">
...
<h1>How TO - Button Group</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_breadcrumbs.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_button_group_vertical.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a &quot;button group&quot; with CSS.</p>
<hr>

<h2>Horizontal Button Groups</h2>
...
<button class="button" style="width:33.3%">Apple</button>
<button class="button" style="width:33.3%">Samsung</button>
<button class="button" style="width:33.3%">Sony</button>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_button_group" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Button Group</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;btn-group&quot;&gt;<br>&nbsp; &lt;button&gt;Apple&lt;/button&gt;<br>&nbsp; 
  &lt;button&gt;Samsung&lt;/button&gt;<br>&nbsp; &lt;button&gt;Sony&lt;/button&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .btn-group button {<br>&nbsp;&nbsp;&nbsp; background-color: #4CAF50; /* Green 
  background */<br>&nbsp;&nbsp;&nbsp; border: 1px solid green; /* Green border 
  */<br>&nbsp;&nbsp;&nbsp; color: white; /* White text */<br>&nbsp;&nbsp;&nbsp; padding: 10px 
  24px; /* Some padding */<br>&nbsp;&nbsp;&nbsp; cursor: pointer; /* 
  Pointer/hand icon */<br>&nbsp;&nbsp;&nbsp; float: left; /* Float the 
  buttons side by side */<br>}<br><br>.btn-group button:not(:last-child) {<br>&nbsp;&nbsp;&nbsp; 
  border-right: none; /* Prevent double borders */<br>}<br><br>/* Clear floats (clearfix hack) */<br>.btn-group:after {<br>&nbsp;&nbsp;&nbsp; 
  content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; clear: both;<br>&nbsp;&nbsp;&nbsp; display: 
  table;<br>}<br><br>/* Add a background color on hover */<br>.btn-group button:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #3e8e41;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_button_group" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Justified / Full-width Button Group:</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Three buttons in a group --&gt;<br>&lt;div class=&quot;btn-group&quot; style=&quot;width:100%&quot;&gt;<br>&nbsp; &lt;button 
  style=&quot;width:33.3%&quot;&gt;Apple&lt;/button&gt;<br>&nbsp; 
  &lt;button style=&quot;width:33.3%&quot;&gt;Samsung&lt;/button&gt;<br>&nbsp; &lt;button 
  style=&quot;width:33.3%&quot;&gt;Sony&lt;/button&gt;<br>&lt;/div&gt;<br><br>&lt;!-- 
  Four buttons in a group --&gt;<br>&lt;div class=&quot;btn-group&quot; style=&quot;width:100%&quot;&gt;<br>&nbsp; &lt;button 
  style=&quot;width:25%&quot;&gt;Apple&lt;/button&gt;<br>&nbsp; 
  &lt;button style=&quot;width:25%&quot;&gt;Samsung&lt;/button&gt;<br>&nbsp; &lt;button 
  style=&quot;width:25%&quot;&gt;Sony&lt;/button&gt;<br>&nbsp; &lt;button 
  style=&quot;width:25%&quot;&gt;HTC&lt;/button&gt;<br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_button_group_justified" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>


<p><strong>Tip:</strong> Go to our <a href="/css/css3_buttons.asp">CSS Buttons Tutorial</a> to learn 
