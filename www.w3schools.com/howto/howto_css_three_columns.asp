...
<html lang="en-US">
<head>
<title>How To Create a Three Column Layout</title>
<meta charset="utf-8">
...
<h1>How TO - Three Column Layout</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_two_columns.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_four_columns.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a 3-column layout grid with CSS.</p>
<hr>

<div class="w3-row">
<div class="w3-col s4" style="height:320px;padding:20px;background-color:#bbb">
<div class="w3-hide-small">
<h2>Column 1</h2>
<p>Some text..</p>
</div></div>
<div class="w3-col s4" style="height:320px;padding:20px;background-color:#ccc">
<div class="w3-hide-small">
<h2>Column 2</h2>
<p>Some text..</p>
</div></div>
<div class="w3-col s4" style="height:320px;padding:20px;background-color:#ddd">
<div class="w3-hide-small">
<h2>Column 3</h2>
<p>Some text..</p>
</div>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_three_columns" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Create a Three Column Layout</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;row&quot;&gt;<br>&nbsp; &lt;div class=&quot;column&quot;&gt;&lt;/div&gt;<br>&nbsp; &lt;div 
  class=&quot;column&quot;&gt;&lt;/div&gt;<br>&nbsp; &lt;div 
...
<p>In this example, we will create three <strong>equal</strong> columns:</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_three_columns" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>In this example, we will create three <strong>unequal</strong> columns:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .column {<br>&nbsp;&nbsp;&nbsp; float: left;<br>}<br><br>.left, .right {<br>&nbsp;&nbsp;&nbsp; width: 25%;<br>
  }<br><br>.middle {<br>&nbsp;&nbsp;&nbsp; 
  width: 50%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_three_columns_unequal" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>In this example, we will create a <strong>responsive</strong> three column layout:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  ...
  width: 100%;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_three_columns_responsive" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
