...
<html lang="en-US">
<head>
<title>How To Shrink a Navigation Menu on Scroll</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_navbar_hide_scroll.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_navbar_sticky.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to resize a navigation bar on scroll with CSS and JavaScript.</p>
<hr>
<iframe src="tryhow_js_navbar_shrink_scroll.htm" style="width:100%;border:3px solid #e9e9e9;height:410px;padding:0"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_navbar_shrink_scroll" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Shrink Navbar on Scroll</h2>
<h5>Step 1) Add HTML:</h5>
<p>Create a navigation bar:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div id=&quot;navbar&quot;&gt;<br>&nbsp; &lt;a href=&quot;#default&quot; id=&quot;logo&quot;&gt;CompanyLogo&lt;/a&gt;<br>&nbsp; 
  &lt;div id=&quot;navbar-right&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a class=&quot;active&quot; href=&quot;#home&quot;&gt;Home&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; 
...
<div class="w3-code notranslate cssHigh">
  /* Create a sticky/fixed navbar */<br>#navbar {<br>&nbsp; overflow: hidden;<br>&nbsp; 
  background-color: #f1f1f1;<br>&nbsp; padding: 90px 10px; /* Large padding 
  which will shrink on scroll (using JS) */<br>&nbsp; transition: 0.4s; /* Adds 
  a transition effect when the padding is decreased */<br>&nbsp; position: 
  fixed; /* Sticky/fixed navbar */<br>&nbsp; width: 100%;<br>&nbsp; top: 0; /* 
  At the top */<br>&nbsp; z-index: 99; <br>}<br><br>/* Style the navbar links */<br>
  #navbar a {<br>&nbsp; 
  float: left;<br>&nbsp; color: black;<br>&nbsp; text-align: center;<br>&nbsp; 
  padding: 12px;<br>&nbsp; text-decoration: none;<br>&nbsp; font-size: 18px; <br>&nbsp; 
  line-height: 25px;<br>&nbsp; border-radius: 4px;<br>}<br><br>/* Style the logo 
  */<br>#navbar 
  #logo {<br>&nbsp; font-size: 35px;<br>&nbsp; font-weight: bold;<br>&nbsp; 
  transition: 0.4s;<br>}<br><br>/* Links on mouse-over */<br>#navbar a:hover {<br>&nbsp; 
  background-color: #ddd;<br>&nbsp; color: black;<br>}<br><br>/* Style the 
  active/current link */<br>#navbar 
  a.active {<br>&nbsp; background-color: dodgerblue;<br>&nbsp; color: white;<br>
  }<br><br>/* Display some links to the right */<br>#navbar-right {<br>&nbsp; float: right;<br>}<br><br>/* Add 
  responsiveness - on screens less than 580px wide, display the navbar 
  vertically instead of horizontally */<br>@media screen and (max-width: 580px) 
  {<br>&nbsp; #navbar {<br>&nbsp;&nbsp;&nbsp; padding: 20px 10px !important; /* Use 
  !important to make sure that JavaScript doesn't override the padding on small 
  screens */<br>&nbsp; }<br>&nbsp; #navbar a {<br>&nbsp;&nbsp;&nbsp; float: 
  none;<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; text-align: 
  left;<br>&nbsp; }<br>&nbsp; #navbar-right {<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp; 
  }<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  navbar's padding and the logo's font size<br>window.onscroll = function() {scrollFunction()};<br>
  <br>function scrollFunction() {<br>&nbsp; if (document.body.scrollTop &gt; 80 || 
  document.documentElement.scrollTop &gt; 80) {<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById(&quot;navbar&quot;).style.padding = &quot;30px 10px&quot;;<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById(&quot;logo&quot;).style.fontSize = &quot;25px&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById(&quot;navbar&quot;).style.padding = &quot;80px 10px&quot;;<br>&nbsp;&nbsp;&nbsp; 
  document.getElementById(&quot;logo&quot;).style.fontSize = &quot;35px&quot;;<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_navbar_shrink_scroll" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
