...
<html lang="en-US">
<head>
<title>How To Create a Responsive Bottom Navigation Menu</title>
<meta charset="utf-8">
...
<h1>How TO - Responsive Bottom Navigation</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_bottom_nav.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_navbar_border.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive bottom navigation menu with CSS and JavaScript.</p>
<hr>
<h2>Responsive Bottom Navigation</h2>

<p><strong>Resize</strong> the browser window to see how the responsive navigation menu works:</p>

<iframe src="tryhow_js_bottom_nav_tutorial.htm" style="height:300px;width:100%;border:3px solid #f1f1f1"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_bottom_nav" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create A Responsive Bottom Navbar</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class="navbar" 
id="myNavbar"&gt;<br>&nbsp; &lt;a href=&quot;#home&quot;&gt;Home&lt;/a&gt;<br>&nbsp; 
&lt;a href=&quot;#news&quot;&gt;News&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>&nbsp; 
&lt;a href=&quot;#about&quot;&gt;About&lt;/a&gt;<br>&nbsp;&nbsp;&lt;a href="javascript:void(0);" 
  class=&quot;icon&quot; onclick="myFunction()"&gt;&amp;#9776;&lt;/a&gt;<br>&lt;/div&gt;</div>
</div>

<p>The link with class="icon" is used to open and close the navbar on small 
screens.</p>
<hr>
...
/* Place the navbar at the bottom of the page, and make it stick */<br>.navbar {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #333;<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>&nbsp;&nbsp;&nbsp; 
  position: fixed;<br>&nbsp;&nbsp;&nbsp; bottom: 0;<br>&nbsp;&nbsp;&nbsp; width: 
  100%;<br>}<br><br>/* 
Style the links inside the navigation bar */<br>.navbar a {<br>&nbsp;&nbsp;&nbsp; 
  float: left;<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; 
  color: #f2f2f2;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>&nbsp;&nbsp;&nbsp; 
  padding: 14px 16px;<br>&nbsp;&nbsp;&nbsp; text-decoration: none;<br>&nbsp;&nbsp;&nbsp; 
  font-size: 17px;<br>}<br><br>/* Change the color of links on hover */<br>
  .navbar a:hover {<br>&nbsp;&nbsp;&nbsp; background-color: #ddd;<br>&nbsp;&nbsp;&nbsp; 
  color: black;<br>}<br><br>/* Add a green background color to the active link 
  */<br>.navbar 
  a.active {<br>&nbsp;&nbsp;&nbsp; background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>}<br><br>/* Hide the link that should open and close the 
  navbar on small screens */<br>
...
contains should open and close the navbar (.icon) */<br>@media screen and (max-width: 600px) {<br>&nbsp; .navbar 
  a:not(:first-child) 
{display: none;}<br>&nbsp; .navbar a.icon {<br>&nbsp;&nbsp;&nbsp; float: 
...
screens (display the links vertically instead of horizontally) */<br>@media screen and (max-width: 600px) {<br>&nbsp; .navbar.responsive a.icon {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
...
var x = document.getElementById("myNavbar");<br>&nbsp;&nbsp;&nbsp; if (x.className 
=== "navbar") {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.className += " 
responsive";<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x.className = "navbar";<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_bottom_nav" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
