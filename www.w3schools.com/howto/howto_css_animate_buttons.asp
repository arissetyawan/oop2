...
<html lang="en-US">
<head>
<title>How To Animate Buttons With CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Animate Buttons</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_button_split.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_fading_buttons.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to animate buttons using CSS.</p>
<hr>
...
<button class="pressed" style="margin:5px;width:170px;padding:20px;font-size:28px;"><span>
Click </span></button>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_buttons_animate3" class="w3-btn w3-margin-top w3-margin-bottom">
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_buttons_animate1" class="w3-btn w3-margin-top w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
</div>
...
<div class="w3-padding w3-white">
<button class="w3-btn rippleripple" style="margin:5px;width:170px;padding:20px;font-size:28px;"><span>
Click </span></button>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_buttons_animate2" class="w3-btn w3-margin-top w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
</div>
</div>
