...
<html lang="en-US">
<head>
<title>How To Create an Image with Transparent Text</title>
<meta charset="utf-8">
...
<h1>How TO - Image with Transparent Text</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_image_text_blocks.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_full_page.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an image with a transparent (see-through) background text, using CSS.</p>
<hr>

<h2>Transparent Image Text</h2>
<div class="container">
  <img src="/w3images/notebook.jpg" alt="Norway" style="width:100%;">
  <div class="content">
    <h1>Heading</h1>
    <p>Lorem ipsum dolor sit amet, an his etiam torquatos. <span class="w3-hide-small">Tollit soleat phaedrum te duo, eum cu recteque expetendis neglegentur. Cu mentitum maiestatis persequeris pro, pri ponderum tractatos ei.</span></p>
  </div>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_transparent_bottom" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Create a Transparent Image Text</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;img src=&quot;notebook.jpg&quot; 
  alt=&quot;Notebook&quot; style=&quot;width:100%;&quot;&gt;<br>&nbsp; &lt;div class=&quot;content&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;h1&gt;Heading&lt;/h1&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Lorem ipsum..&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br>
  &lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .container {<br>&nbsp;&nbsp;position: relative; <br>&nbsp;&nbsp;max-width: 800px; 
  /* Maximum width */<br>&nbsp;&nbsp;margin: 0 auto; /* Center it */<br>
  }<br><br>.container .content {<br>
  &nbsp;&nbsp;position: absolute; /* Position the background text */<br>&nbsp;&nbsp;bottom: 0; 
  /* At the bottom. Use top:0 to append it to the top */<br>&nbsp; background: 
  rgb(0, 0, 0); /* Fallback color */<br>&nbsp;&nbsp;background: rgba(0, 0, 0, 0.5); 
  /* Black background with 0.5 opacity */<br>&nbsp;&nbsp;color: #f1f1f1; 
  /* Grey text */<br>&nbsp;&nbsp;width: 100%; /* Full width */<br>&nbsp;&nbsp;padding: 20px; 
  /* Some padding */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_transparent_bottom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
