...
<html lang="en-US">
<head>
<title>How To Change Background Gradient on Scroll</title>
<meta charset="utf-8">
...
<h1>How TO - Background Gradient on Scroll</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_smooth_scroll.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_sticky_header.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a gradient background color on scroll.</p>
<hr>

<h2>Background Gradient</h2>
<iframe src="tryhow_css_bg_gradient_scroll.htm" style="width:100%;height:300px;border:3px solid #ddd"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_css_bg_gradient_scroll" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Create a Gradient Background on Scroll</h2>
<p>Create a linear gradient background color that starts from the top. It starts from teal/green to blue:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  body {<br>&nbsp; height: 3000px; /* Used to enable scrolling */<br>&nbsp; 
  background: linear-gradient(55deg, #0fb8ad 0%, #1fc8db 51%, #2cb5e8 85%);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_bg_gradient_scroll" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> To learn more about gradient backgrounds, <a href="/css/css3_gradients.asp">go to our CSS Gradients Tutorial</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_smooth_scroll.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_sticky_header.asp">Next &#10095;</a>
