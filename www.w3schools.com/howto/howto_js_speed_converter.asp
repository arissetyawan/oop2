...
<html lang="en-US">
<head>
<title>How To Create a Speed Converter With HTML and JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - Speed Converter</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_length_converter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="default.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a speed converter with HTML and JavaScript.</p>
<hr>
...
<hr>
<h2>Create a Speed Converter</h2>
<p>Create an input element that can convert a value from one speed measurement to another.</p>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example - MPH to KPH</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;p&gt;<br>&nbsp; &lt;label&gt;MPH&lt;/label&gt;<br>&nbsp; &lt;input id="inputMPH" type="number" placeholder="MPH"<br>&nbsp; oninput="speedConverter(this.value)"<br>&nbsp; onchange="speedConverter(this.value)"&gt;<br>
 &lt;/p&gt;<br>
 &lt;p&gt;KPH: &lt;span id="outputKPH"&gt;&lt;/span&gt;&lt;/p&gt;</div>
</div>
...
/* When the input field receives input, convert the value from mph to kph */<br>
 function speedConverter(valNum) {<br>&nbsp; valNum = parseFloat(valNum);<br>&nbsp; document.getElementById("outputKPH").innerHTML = valNum * 1.609344;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_speed_converter_mph_to_kph" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h2>Convert from MPH to other Measurements</h2>
<p>The table below shows how to convert from MPH to other speed 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from MPH to KPH</td>
    <td>KPH=MPH*1.609344</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_mph_to_kph">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from MPH to Knots</td>
    <td>knots=MPH/1.150779</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_mph_to_knots">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from MPH to Mach</td>
    <td>Mach=MPH/761.207</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_mph_to_mach">Try it</a></td>
  </tr>
</table>

<hr>

<h2>Convert from KPH to other Measurements</h2>
<p>The table below shows how to convert from KPH to other speed 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from KPH to MPH</td>
    <td>MPH=KPH/1.609344</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_kph_to_mph">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from KPH to Knots</td>
    <td>knots=KPH/1.852</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_kph_to_knots">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from KPH to Mach</td>
    <td>Mach=KPH/1225.044</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_kph_to_mach">Try it</a></td>
  </tr>
</table>

<hr>
<h2>Convert from Knots to other Measurements</h2>
<p>The table below shows how to convert from Knots to other speed 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from Knots to MPH</td>
    <td>MPH=knots*1.150779</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_knots_to_mph">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Knots to KPH</td>
    <td>KPH=knots*1.852</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_knots_to_kph">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Knots to Mach</td>
    <td>Mach=knots/661.4708</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_knots_to_mach">Try it</a></td>
  </tr>
</table>

<hr><h2>Convert from Mach to other Measurements</h2>
<p>The table below shows how to convert from Mach to other speed 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>Convert from Mach to MPH</td>
    <td>MPH=Mach*761.207</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_mach_to_mph">Try it</a></td>
    </tr>
    <tr>
    <td>Convert from Mach to KPH</td>
    <td>KPH=Mach*1225.044</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_mach_to_kph">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Mach to Knots</td>
    <td>knots=Mach*661.4708</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_speed_converter_mach_to_knots">Try it</a></td>
    </tr>
</table>
