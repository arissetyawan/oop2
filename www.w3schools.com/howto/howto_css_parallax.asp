...
<html lang="en-US">
<head>
<title>How To Create a Parallax Scrolling Effect</title>
<meta charset="utf-8">
...
<h1>How TO - Parallax Scrolling</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_pricing_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_aspect_ratio.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a &quot;parallax&quot; scrolling effect with CSS.</p>
<hr>

<h2>Parallax</h2>
<p>Parallax scrolling is a web site trend where the background content (i.e. an image) is moved 
at a different speed than the foreground content while scrolling. Click on the links below to see the difference between a website with and 
without parallax scrolling.</p>
<p>
<a href="tryhow_css_parallax_demo.htm" class="w3-btn w3-green" target="_blank">Demo with parallax scrolling</a></p>
<p>
<a href="tryhow_css_parallax_demo_none.htm" class="w3-btn w3-red" target="_blank">Demo without parallax scrolling</a></p>
<div class="w3-note w3-panel">
<p><strong>Note:</strong> Parallax scrolling does not always work on mobile 
devices/smart phones. However, you can use media queries to turn off the effect on mobile devices (see last example on this page).</p>
</div>
<hr>

<h2>How To Create a Parallax Scrolling Effect</h2>
<p>Use a container element and add a background image to the container with a specific height. Then use 
the <code class="w3-codespan">background-attachment: fixed</code> to create the actual parallax 
effect. The other background properties are used to center and scale the image 
perfectly:</p>

<div class="w3-example">
<h3>Example with pixels</h3>
<div class="w3-code notranslate htmlHigh">
&lt;style&gt;<br>.parallax { <br>&nbsp;&nbsp;&nbsp; /* The image used */<br>&nbsp;&nbsp;&nbsp; 
background-image: url(&quot;img_parallax.jpg&quot;);<br><br>&nbsp;&nbsp;&nbsp; /* Set 
a specific height */<br>&nbsp;&nbsp;&nbsp; height: 500px; <br><br>&nbsp;&nbsp;&nbsp; 
/* Create the parallax scrolling effect */<br>&nbsp;&nbsp;&nbsp; 
background-attachment: fixed;<br>&nbsp;&nbsp;&nbsp; background-position: 
center;<br>&nbsp;&nbsp;&nbsp; background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; 
background-size: cover;<br>}<br>&lt;/style&gt;<br><br>&lt;!-- Container element 
--&gt;<br>&lt;div class=&quot;parallax&quot;&gt;&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_parallax" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>The example above used pixels to set the height of the image. If you want to 
use percent, for example 100%, to make the image fit the whole screen, set the 
height of the parallax container to 100%. <strong>Note:</strong> You must also 
apply <code class="w3-codespan">height: 100%</code> to both &lt;html&gt; and &lt;body&gt;:</p>

<div class="w3-example">
<h3>Example with percent</h3>
<div class="w3-code notranslate cssHigh">
body, html {<br>&nbsp;&nbsp;&nbsp; height: 100%;<br>}<br><br>.parallax { <br>&nbsp;&nbsp;&nbsp; 
/* The image used */<br>&nbsp;&nbsp;&nbsp; background-image: url(&quot;img_parallax.jpg&quot;);<br>
<br>&nbsp;&nbsp;&nbsp; /* Full height */<br>&nbsp;&nbsp;&nbsp; 
height: 100%; <br><br>&nbsp;&nbsp;&nbsp; /* Create the parallax 
scrolling effect */<br>&nbsp;&nbsp;&nbsp; background-attachment: fixed;<br>&nbsp;&nbsp;&nbsp; 
background-position: center;<br>&nbsp;&nbsp;&nbsp; background-repeat: 
no-repeat;<br>&nbsp;&nbsp;&nbsp; background-size: cover;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_parallax_percent" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Some mobile devices have a problem with <code class="w3-codespan">background-attachment: fixed</code>. However, you can use media queries to turn off the parallax effect for mobile devices:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Turn off parallax scrolling for all tablets and phones. Increase/decrease the pixels if 
  needed */<br>@media only screen and (max-device-width: 1366px) {<br>&nbsp;&nbsp;&nbsp; .parallax {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  background-attachment: scroll;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_parallax_device" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
