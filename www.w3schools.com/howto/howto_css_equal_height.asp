...
<html lang="en-US">
<head>
<title>How To Create Equal Height Columns</title>
<meta charset="utf-8">
...
<h1>How TO - Equal Height</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_sticky_element.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_clearfix.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create equal height columns with CSS.</p>
<hr>
<h2>How To Create Equal Height Columns</h2>
<p>When you have columns that should appear side by side, you'll often want them to be of equal height (matching the height of the tallest).</p>
<div class="w3-row-padding" style="margin:0 -16px 32px">
<div class="w3-half">
<h3 class="w3-center">The Problem:</h3>
<div class="w3-row-padding" style="margin:0 8px 0 -16px">
  <div class="w3-col s4">
    <div style="height:200px" class="w3-green"></div>
  </div>
  <div class="w3-col s4">
    <div style="height:100px" class="w3-blue"></div>
  </div>
  <div class="w3-col s4">
    <div style="height:160px" class="w3-green"></div>
  </div>
</div>
</div>
<div class="w3-half">
<h3 class="w3-center">The Desire:</h3>
<div class="w3-row-padding" style="margin:0 -16px 0 8px">
  <div class="w3-col s4">
    <div style="height:200px" class="w3-green"></div>
  </div>
  <div class="w3-col s4">
    <div style="height:200px" class="w3-blue"></div>
  </div>
  <div class="w3-col s4">
    <div style="height:200px" class="w3-green"></div>
  </div>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_equal_height" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class="col-container"&gt;<br>&nbsp; &lt;div class=&quot;col"&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;h2&gt;Column 1&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Hello World&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br>
  <br>&nbsp; &lt;div class="col"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;h2&gt;Column 2&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;p&gt;Hello World!&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Hello World!&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;p&gt;Hello World!&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Hello World!&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br>
  <br>&nbsp; &lt;div class="col"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;h2&gt;Column 3&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;p&gt;Some other text..&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Some other text..&lt;/p&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
...
<div class="w3-code notranslate cssHigh">
  .col-container {<br>&nbsp;&nbsp;&nbsp; display: table; /* Make the 
  container element behave like a table */<br>&nbsp;&nbsp;&nbsp; width: 100%; /* 
  Set full-width to expand the whole page */<br>}<br><br>.col {<br>&nbsp;&nbsp;&nbsp; 
  display: table-cell; /* Make elements inside the container behave like table 
  cells */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_equal_height" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div style="display:table;width:100%;">
  <div class="w3-container w3-red" style="display:table-cell;padding:16px;">
    <p>Hello World.</p>
  </div>
  <div class="w3-container w3-green" style="display:table-cell;padding:16px;">
    <p>Hello World.</p>
    <p>Hello World.</p>
    <p>Hello World.</p>
  </div>
  <div class="w3-container w3-blue" style="display:table-cell;padding:16px;">
    <p>Hello World.</p>
  </div>
</div>
...
<p>To achieve this, add a media query and specify a breakpoint pixel value for when this should happen:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* If the browser window is smaller than 600px, make the columns stack on top 
  of each other */<br>@media only screen and (max-width: 600px) {<br>&nbsp;&nbsp;&nbsp; .col {
  <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_equal_height_media" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Equal Height and Width using Flexbox</h2>
<p>You can also use Flexbox to create equal height boxes:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .col-container {<br>&nbsp; display: flex;<br>&nbsp; width: 100%;<br>}<br>.col {<br>&nbsp; 
  flex: 1;<br>&nbsp; padding: 16px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_equal_height_flexbox" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> Flexbox is not supported in Internet Explorer 10 and earlier versions.</p>
<p><strong>Tip:</strong> Read more about flexible boxes in our <a href="/css/css3_flexbox.asp">CSS Flexbox Tutorial</a>.</p>
<br>
