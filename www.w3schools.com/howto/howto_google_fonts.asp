...
<html lang="en-US">
<head>
<title>How To Google Fonts</title>
<meta charset="utf-8">
...
<h1>How TO - Google Fonts</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_google_charts.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_weight_converter.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to use Google Fonts on your web page.</p>
<hr>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate">
<h1 style="font-family:'Sofia';">Use this font for free!</h1>
<p style="font-family:'Sofia';font-size:22px">All of Google fonts are free and easy to use.</p>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?font=Sofia" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2><span id="spancount">810</span> Google Fonts</h2>
<p>Currently there are <span id="spancount2">810</span> fonts available at Google:</p>
<div style="position:relative"><div id="searchicon" class="fa">&#xe802;</div></div>
  <input type="text" id="searchstring" name="search" placeholder="Search.." oninput="filterSearch()">
<br>
<br>

<div class="w3-responsive" id="fonttable">
</div>
<div id="noresultdiv" class="w3-text-red" style="display:none;">Your search did not match any fonts.</div>
<script>
var fontjson;
...
function drawtable() {
  ...
  txt = "<table class='w3-table w3-border w3-bordered'><tr class='w3-light-grey'><th style='width:180px'>Font Family</th><th>Example</th><th></th></tr>";
  for (i = 0; i < l; i++) {
    ff = fontjson.items[i].family;
    txt += "<tr><td>" + ff + "</td>";
    txt += "<td contenteditable style='font-size:22px;font-family:" + ff + "'>Lorem ipsum dolor sit amet</td>";
    txt += "<td><a target='_blank' class='w3-btn' href='tryit.asp?font=" + ff + "'>Try it</a></td>";
    txt += "</tr>";
  }
  txt += "</table>";        
  document.getElementById("fonttable").innerHTML = txt;
}
function downloadfonts() {
  var i, j, l, ff, linkrel, fonts;
  if (!fontjson) {return false;}
  l = fontjson.items.length;    
  i = 0;
  while (i < l) {
    fonts = "";
    ...
    linkrel.setAttribute("href", "https://fonts.googleapis.com/css?family=" + fonts);
...
function filterSearch() {
  var a, b, i, j, c, r, tr, td;
  a = document.getElementById("fonttable");
