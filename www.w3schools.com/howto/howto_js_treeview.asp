...
<html lang="en-US">
<head>
<title>How To Create a Tree View</title>
<meta charset="utf-8">
...
<h1>How TO - Tree View</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_active_element.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_remove_property_object.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a tree view with CSS and JavaScript.</p>
<hr>
...
<ul id="myUL">
  <li><span class="caret" id="myclickx">Beverages</span>
    <ul class="nested">
      <li>Water</li>
      <li>Coffee</li>
...
for (i = 0; i < toggler.length; i++) {
  toggler[i].addEventListener("click", function() {
    this.parentElement.querySelector(".nested").classList.toggle("activexx");
    this.classList.toggle("caret-down");
  });
}
</script>
<script>
var mybtn = document.getElementById("myclickx");
mybtn.click();
</script>

<a target="_blank" href="tryit.asp?filename=tryhow_js_treeview" class="w3-btn" style="margin-top:20px">Try it Yourself &raquo;</a>
<hr>
...
<div class="w3-code notranslate htmlHigh">
  &lt;ul id=&quot;myUL&quot;&gt;<br>&nbsp; &lt;li&gt;&lt;span class=&quot;caret&quot;&gt;Beverages&lt;/span&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;ul class=&quot;nested&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;li&gt;Water&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;li&gt;Coffee&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;li&gt;&lt;span 
  class=&quot;caret&quot;&gt;Tea&lt;/span&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;ul 
  class=&quot;nested&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;li&gt;Black Tea&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;li&gt;White Tea&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;li&gt;&lt;span class=&quot;caret&quot;&gt;Green Tea&lt;/span&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;ul class=&quot;nested&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;li&gt;Sencha&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;li&gt;Gyokuro&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;li&gt;Matcha&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
<div class="w3-code notranslate cssHigh">
  /* Remove default bullets */<br>ul, #myUL {<br>&nbsp; list-style-type: none;<br>
  }<br><br>/* Remove margins and padding from the parent ul */<br>#myUL {<br>&nbsp; 
  margin: 0;<br>&nbsp; padding: 0;<br>}<br><br>/* Style the caret/arrow */<br>
  .caret {<br>&nbsp; cursor: pointer; <br>&nbsp; 
  user-select: none; /* Prevent text selection */<br>}<br><br>/* Create the caret/arrow with a unicode, and 
  style it */<br>.caret::before {<br>&nbsp; content: &quot;\25B6&quot;;<br>&nbsp; color: black;<br>&nbsp; 
  display: inline-block;<br>&nbsp; margin-right: 6px;<br>}<br><br>/* Rotate the 
  caret/arrow icon when clicked on (using JavaScript) */<br>.caret-down::before {<br>&nbsp; 
  transform: rotate(90deg); <br>}<br><br>/* Hide the nested list */<br>.nested {<br>&nbsp; display: none;<br>}<br>
  <br>/* Show the nested list when the user clicks on the caret/arrow (with 
  JavaScript) */<br>.active {<br>&nbsp; display: block;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  var toggler = document.getElementsByClassName(&quot;caret&quot;);<br>var i;<br><br>for 
  (i = 0; i &lt; toggler.length; i++) {<br>&nbsp; toggler[i].addEventListener(&quot;click&quot;, 
  function() {<br>&nbsp;&nbsp;&nbsp; this.parentElement.querySelector(&quot;.nested&quot;).classList.toggle(&quot;active&quot;);<br>&nbsp;&nbsp;&nbsp; 
  this.classList.toggle(&quot;caret-down&quot;);<br>&nbsp; });<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_treeview" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Checkbox Tree View</h2>
<p>In this example, we use a "ballot box" unicode instead of a caret:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-white w3-padding">
<iframe src="tryhow_js_treeview2_ifr.htm" style="width:100%;height:240px;border:none"></iframe>

</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_treeview2" class="w3-btn w3-margin-bottom w3-margin-top">Try it Yourself &raquo;</a>
</div>
