...
<html lang="en-US">
<head>
<title>How To Create a Popup Form With CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Popup Form</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_responsive_form.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_inline_form.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a popup form with CSS and JavaScript.</p>
<hr>

<iframe src="tryhow_js_popup_form_ifr.htm" style="border:3px solid #ddd;overflow:hidden;height:430px;width:100%;"></iframe>
<a target="_blank" href="tryit.asp?filename=tryhow_js_popup_form" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>
<h2>How To Create a Popup Form</h2>
...
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;form-popup&quot; id=&quot;myForm&quot;&gt;<br>&nbsp; &lt;form action=&quot;/action_page.php&quot; 
  class=&quot;form-container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;h1&gt;Login&lt;/h1&gt;<br><br>&nbsp;&nbsp;&nbsp; 
  &lt;label for=&quot;email&quot;&gt;&lt;b&gt;Email&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input 
  type=&quot;text&quot; placeholder=&quot;Enter Email&quot; name=&quot;email&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp; 
  &lt;label for=&quot;psw&quot;&gt;&lt;b&gt;Password&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input 
  type=&quot;password&quot; placeholder=&quot;Enter Password&quot; name=&quot;psw&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp; 
  &lt;button type=&quot;submit&quot; class=&quot;btn&quot;&gt;Login&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; &lt;button 
  type=&quot;submit&quot; class=&quot;btn cancel&quot; onclick=&quot;closeForm()&quot;&gt;Close&lt;/button&gt;<br>&nbsp; 
  &lt;/form&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  {box-sizing: border-box;}<br><br>/* Button used to open the contact form - 
  fixed at the bottom of the page */<br>.open-button {<br>&nbsp; 
  background-color: #555;<br>&nbsp; color: white;<br>&nbsp; padding: 16px 20px;<br>&nbsp; 
  border: none;<br>&nbsp; cursor: pointer;<br>&nbsp; opacity: 0.8;<br>&nbsp; 
  position: fixed;<br>&nbsp; bottom: 23px;<br>&nbsp; right: 28px;<br>&nbsp; 
  width: 280px;<br>}<br><br>/* The popup form - hidden 
  by default */<br>.form-popup {<br>&nbsp; display: none;<br>&nbsp; position: 
  fixed;<br>&nbsp; bottom: 0;<br>&nbsp; right: 15px;<br>&nbsp; border: 3px solid 
  #f1f1f1;<br>&nbsp; z-index: 9;<br>}<br><br>/* Add 
  styles to the form container */<br>.form-container {<br>&nbsp; max-width: 
  300px;<br>&nbsp; padding: 10px;<br>&nbsp; background-color: white;<br>}<br><br>/* Full-width input 
  fields */<br>.form-container input[type=text], .form-container 
  input[type=password] {<br>&nbsp; width: 100%;<br>&nbsp; padding: 15px;<br>&nbsp; 
  margin: 5px 0 22px 0;<br>&nbsp; border: none;<br>&nbsp; background: #f1f1f1;<br>
  }<br><br>/* When the inputs get 
  focus, do something */<br>.form-container input[type=text]:focus, 
  .form-container input[type=password]:focus {<br>&nbsp; background-color: #ddd;<br>&nbsp; 
  outline: none;<br>}<br><br>/* Set a style for the submit/login button */<br>
  .form-container .btn {<br>&nbsp; background-color: #4CAF50;<br>&nbsp; color: 
  white;<br>&nbsp; padding: 16px 20px;<br>&nbsp; border: none;<br>&nbsp; cursor: 
  pointer;<br>&nbsp; width: 100%;<br>&nbsp; margin-bottom:10px;<br>&nbsp; 
  opacity: 0.8;<br>}<br><br>/* Add a red background color 
  to the cancel button */<br>.form-container .cancel {<br>&nbsp; 
  background-color: red;<br>}<br><br>/* Add some hover effects to buttons */<br>.form-container .btn:hover, 
  .open-button:hover {<br>&nbsp; opacity: 1;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  function openForm() {<br>&nbsp; document.getElementById(&quot;myForm&quot;).style.display 
  = &quot;block&quot;;<br>}<br><br>function closeForm() {<br>&nbsp; document.getElementById(&quot;myForm&quot;).style.display 
  = &quot;none&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_popup_form" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
