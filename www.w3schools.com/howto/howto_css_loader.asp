...
<a class="w3-left w3-btn" href="howto_js_todolist.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_star_rating.asp">Next &#10095;</a>
</div>
<hr>
...
<p style="margin-top:26px"><a target="_blank" href="tryit.asp?filename=tryhow_css_loader" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_loader" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
<p>The <code class="w3-codespan">border</code> property specifies the border size and the border color of the loader. 
The <code class="w3-codespan">border-radius</code> property transforms the loader into a circle.</p>
<p>The blue thing that spins around inside the border is specified with the 
<code class="w3-codespan">border-top</code> property. You can also include <code class="w3-codespan">border-bottom</code>, <code class="w3-codespan">border-left</code> and/or
<code class="w3-codespan">border-right</code> if you want more "spinners" (see example below).</p>
<p>The size of the loader is specified with the <code class="w3-codespan">width</code> and <code class="w3-codespan">height</code> properties.</p>
<p>At last, we add an <code class="w3-codespan">animation</code> that makes the blue thing spin forever with a 2 
second animation speed.</p>
<p><strong>Note: </strong>You should also include a -webkit- prefix for 
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_loader2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
</div>
<div class="w3-third">
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_loader3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
</div>
<div class="w3-third">
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_loader4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
</div>
...
<iframe src="tryhow_css_loader5_iframe.htm" style="width:100%;border:none;height:300px;"></iframe>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_loader5" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
