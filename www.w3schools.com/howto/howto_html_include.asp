...
<html lang="en-US">
<head>
<title>How To Include HTML</title>
<meta charset="utf-8">
...
<h1>How TO - Include HTML</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_calendar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_todolist.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to include HTML snippets in HTML.</p>
...
&lt;a href=&quot;howto_google_maps.asp&quot;&gt;Google Maps&lt;/a&gt;&lt;br&gt;<br>
&lt;a href=&quot;howto_css_animate_buttons.asp&quot;&gt;Animated Buttons&lt;/a&gt;&lt;br&gt;<br>
&lt;a href=&quot;howto_css_modals.asp&quot;&gt;Modal Boxes&lt;/a&gt;&lt;br&gt;<br>
&lt;a href=&quot;howto_js_animate.asp&quot;&gt;Animations&lt;/a&gt;&lt;br&gt;<br>
&lt;a href=&quot;howto_js_progressbar.asp&quot;&gt;Progress Bars&lt;/a&gt;&lt;br&gt;<br>
&lt;a href=&quot;howto_css_dropdown.asp&quot;&gt;Hover Dropdowns&lt;/a&gt;&lt;br&gt;<br>
&lt;a href=&quot;howto_js_dropdown.asp&quot;&gt;Click Dropdowns&lt;/a&gt;&lt;br&gt;<br>
...
<h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
   &lt;script&gt;<br>function includeHTML() {<br>&nbsp; var z, i, elmnt, file, xhttp;<br>&nbsp; 
   /*loop through a collection of all HTML elements:*/<br>&nbsp; z = 
   document.getElementsByTagName(&quot;*&quot;);<br>&nbsp; for (i = 0; i &lt; z.length; i++) 
   {<br>&nbsp;&nbsp;&nbsp; elmnt = z[i];<br>&nbsp;&nbsp;&nbsp; /*search for 
   elements with a certain atrribute:*/<br>&nbsp;&nbsp;&nbsp; file = 
   elmnt.getAttribute(&quot;w3-include-html&quot;);<br>&nbsp;&nbsp;&nbsp; if (file) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   /*make an HTTP request using the attribute value as the file name:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   xhttp = new XMLHttpRequest();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   xhttp.onreadystatechange = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   if (this.readyState == 4) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   if (this.status == 200) {elmnt.innerHTML = this.responseText;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   if (this.status == 404) {elmnt.innerHTML = &quot;Page not found.&quot;;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   /*remove the attribute, and call this function once more:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   elmnt.removeAttribute(&quot;w3-include-html&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   includeHTML();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   } <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xhttp.open(&quot;GET&quot;, file, true);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   xhttp.send();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /*exit the function:*/<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
   return;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}<br>&lt;/script&gt;
</div>
</div>

<p>Call includeHTML() at the bottom of the page:</p>
<div class="w3-example">
<h3>Example</h3>
 <div class="w3-code notranslate htmlHigh">
&lt;script&gt;<br>includeHTML();<br>&lt;/script&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_html_include_1" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div w3-include-html=&quot;h1.html&quot;&gt;&lt;/div&gt; <br>&lt;div 
 w3-include-html=&quot;content.html&quot;&gt;&lt;/div&gt;</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_html_include_2" target="_blank">Try it Yourself &raquo;</a>
</div>
