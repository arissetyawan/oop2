...
<html lang="en-US">
<head>
<title>How To Create a Pill Navigation</title>
<meta charset="utf-8">
...
.pill-nav-vertical a:hover {
  background-color: #ddd;
  color: black;
}

.pill-nav-vertical a.active {
  background-color: dodgerblue;
  color: white;
}
</style>
...
<h1>How TO - Pill Navigation</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_sticky_social_bar.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_responsive_header.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a pill navigation menu with CSS.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_pill_nav" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create a Pill Navigation</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class="pill-nav&quot;&gt;<br>&nbsp; &lt;a class=&quot;active&quot; href=&quot;#home&quot;&gt;Home&lt;/a&gt;<br>&nbsp; 
&lt;a href=&quot;#news&quot;&gt;News&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>&nbsp; 
&lt;a href=&quot;#about&quot;&gt;About&lt;/a&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style the links inside the pill navigation menu */<br>.pill-nav a {<br>&nbsp; 
  display: inline-block;<br>&nbsp; color: black;<br>&nbsp; text-align: center;<br>&nbsp; 
  padding: 14px;<br>&nbsp; text-decoration: none;<br>&nbsp; font-size: 17px;<br>&nbsp; 
  border-radius: 5px;<br>}<br><br>/* Change the color of links on mouse-over */<br>
  .pill-nav a:hover {<br>&nbsp; background-color: #ddd;<br>&nbsp; color: black;<br>
  }<br><br>/* Add a color to the active/current link */<br>
  .pill-nav a.active {<br>&nbsp; background-color: dodgerblue;<br>&nbsp; color: 
  white;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_pill_nav" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Vertical Pill Navigation</h2>
<p>Add <code class="w3-codespan">display: block</code> to the links, and they will appear vertically instead of horizontally:</p>
<div class="w3-example">
<h3>Example</h3>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_pill_nav_vertical" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>


<p><strong>Tip:</strong> See also <a href="howto_js_topnav.asp">How To Create a Top Navigation Menu</a>.</p>
