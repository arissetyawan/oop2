...
<html lang="en-US">
<head>
<title>How To Create a Notification Button</title>
<meta charset="utf-8">
...
<h1>How TO - Notification Buttons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_pill_button.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_icon_buttons.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create notification buttons with CSS.</p>
<hr>
...
<h2>How To Create a Notification Button</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;a href=&quot;#&quot; class=&quot;notification&quot;&gt;<br>&nbsp; &lt;span&gt;Inbox&lt;/span&gt;<br>&nbsp; &lt;span 
  class=&quot;badge&quot;&gt;3&lt;/span&gt;<br>&lt;/a&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .notification {<br>&nbsp; background-color: #555;<br>&nbsp; color: white;<br>&nbsp; 
  text-decoration: none;<br>&nbsp; padding: 15px 26px;<br>&nbsp; position: 
  relative;<br>&nbsp; display: inline-block;<br>&nbsp; border-radius: 2px;<br>}<br><br>.notification:hover 
  {<br>&nbsp; background: red;<br>}<br><br>.notification .badge {<br>&nbsp; position: 
  absolute;<br>&nbsp; top: -10px;<br>&nbsp; right: -10px;<br>&nbsp; padding: 5px 
  10px;<br>&nbsp; border-radius: 50%;<br>&nbsp; background: red;<br>&nbsp; 
  color: white;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_buttons_notification" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
