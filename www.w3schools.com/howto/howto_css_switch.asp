...
<html lang="en-US">
<head>
<title>How To Create a Toggle Switch</title>
<meta charset="utf-8">
...
<h1>How TO - Toggle Switch</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_custom_select.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_display_checkbox_text.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a &quot;toggle switch&quot; (on/off button) with CSS.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_switch" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Toggle Switch</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;!-- Rectangular switch --&gt;<br>&lt;label class=&quot;switch&quot;&gt;<br>&nbsp; &lt;input type=&quot;checkbox&quot;&gt;<br>&nbsp; &lt;span class=&quot;slider&quot;&gt;&lt;/span&gt;<br>&lt;/label&gt;<br><br>&lt;!-- 
Rounded switch --&gt;<br>&lt;label class=&quot;switch&quot;&gt;<br>&nbsp; &lt;input type=&quot;checkbox&quot;&gt;<br>&nbsp; &lt;span class=&quot;slider round&quot;&gt;&lt;/span&gt;<br>&lt;/label&gt;</div>
</div>
<hr>
...
/* The switch - the box around the slider */<br>.switch {<br>&nbsp; position: relative;<br>&nbsp; display: inline-block;<br>&nbsp; width: 60px;<br>
&nbsp;
height: 34px;<br>}<br><br>/* Hide default HTML checkbox */<br>.switch input 
{display:none;}<br><br>/* The slider */<br>.slider {<br>&nbsp; position: absolute;<br>&nbsp; cursor: 
pointer;<br>&nbsp; top: 0;<br>&nbsp; left: 0;<br>&nbsp; right: 0;<br>&nbsp; bottom: 0;<br>
&nbsp;
background-color: #ccc;<br>&nbsp; -webkit-transition: .4s;<br>&nbsp; transition: .4s;<br>}<br>
<br>.slider:before {<br>&nbsp; position: absolute;<br>&nbsp; content: &quot;&quot;;<br>&nbsp; height: 26px;<br>
&nbsp;
width: 26px;<br>&nbsp; left: 4px;<br>&nbsp; bottom: 4px;<br>&nbsp; background-color: white;<br>&nbsp; -webkit-transition: 
.4s;<br>&nbsp; transition: .4s;<br>}<br><br>input:checked + .slider {<br>
&nbsp;
background-color: #2196F3;<br>}<br><br>input:focus + .slider {<br>&nbsp; 
box-shadow: 0 0 1px #2196F3;<br>}<br><br>input:checked + .slider:before {<br>&nbsp; -webkit-transform: 
translateX(26px);<br>&nbsp; -ms-transform: translateX(26px);<br>&nbsp; transform: 
translateX(26px);<br>}<br><br>/* Rounded sliders */<br>.slider.round {<br>&nbsp; 
border-radius: 34px;<br>}<br><br>.slider.round:before {<br>&nbsp; 
border-radius: 50%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_switch" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_custom_select.asp">&#10094; Previous</a>
