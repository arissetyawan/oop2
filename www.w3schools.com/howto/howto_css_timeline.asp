...
<html lang="en-US">
<head>
<title>How To Create a Timeline</title>
<meta charset="utf-8">
...
<h1>How TO - Timeline</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_modals.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_scroll_indicator.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive "timeline" with CSS.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_timeline" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Create a Timeline</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;timeline&quot;&gt;<br>&nbsp; &lt;div class=&quot;container left&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;div class=&quot;content&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;h2&gt;2017&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;p&gt;Lorem ipsum..&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; 
  &lt;div class=&quot;container right&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;content&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;h2&gt;2016&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Lorem ipsum..&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; 
...
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp; box-sizing: border-box;<br>}<br><br>/* Set a background color */<br>
  body {<br>&nbsp; background-color: 
  #474e5d;<br>&nbsp; font-family: Helvetica, sans-serif;<br>}<br><br>/* The actual 
  timeline (the vertical ruler) */<br>.timeline {<br>&nbsp; position: relative;<br>&nbsp; 
  max-width: 1200px;<br>&nbsp; margin: 0 auto;<br>}<br><br>/* The actual timeline (the 
  vertical ruler) */<br>.timeline::after {<br>&nbsp; content: '';<br>&nbsp; 
  position: absolute;<br>&nbsp; width: 6px;<br>&nbsp; background-color: white;<br>&nbsp; 
  top: 0;<br>&nbsp; bottom: 0;<br>&nbsp; left: 50%;<br>&nbsp; margin-left: -3px;<br>
  }<br><br>/* Container around content */<br>
  .container {<br>&nbsp; padding: 10px 40px;<br>&nbsp; position: relative;<br>&nbsp; 
  background-color: inherit;<br>&nbsp; width: 50%;<br>}<br><br>/* The circles on the 
  timeline */<br>.container::after {<br>&nbsp; content: '';<br>&nbsp; position: 
  absolute;<br>&nbsp; width: 25px;<br>&nbsp; height: 25px;<br>&nbsp; right: 
  -17px;<br>&nbsp; background-color: white;<br>&nbsp; border: 4px solid #FF9F55;<br>&nbsp; 
  top: 15px;<br>&nbsp; border-radius: 50%;<br>&nbsp; z-index: 1;<br>}<br><br>/* Place the container to the left */<br>.left {<br>&nbsp; left: 0;<br>
  }<br>
  <br>/* Place the container to the right */<br>.right {<br>&nbsp; left: 50%;<br>
  }<br>
  <br>/* Add arrows to the left container (pointing right) */<br>.left::before {<br>&nbsp; 
  content: &quot; &quot;;<br>&nbsp; height: 0;<br>&nbsp; position: absolute;<br>&nbsp; 
  top: 22px;<br>&nbsp; width: 0;<br>&nbsp; z-index: 1;<br>&nbsp; right: 30px;<br>&nbsp; 
  border: medium solid white;<br>&nbsp; border-width: 10px 0 10px 10px;<br>&nbsp; 
  border-color: transparent transparent transparent white;<br>}<br><br>/* Add arrows to the right container (pointing left) */<br>
  .right::before {<br>&nbsp; content: &quot; &quot;;<br>&nbsp; height: 0;<br>&nbsp; 
  position: absolute;<br>&nbsp; top: 22px;<br>&nbsp; width: 0;<br>&nbsp; 
  z-index: 1;<br>&nbsp; left: 30px;<br>&nbsp; border: medium solid white;<br>&nbsp; 
  border-width: 10px 10px 10px 0;<br>&nbsp; border-color: transparent white 
  transparent transparent;<br>}<br><br>/* Fix the circle for containers on the 
  right side */<br>.right::after {<br>&nbsp; left: -16px;<br>}<br><br>/* The actual 
  content */<br>.content {<br>&nbsp; padding: 20px 30px;<br>&nbsp; 
  background-color: white;<br>&nbsp; position: relative;<br>&nbsp; 
  border-radius: 6px;<br>}<br><br>/* Media queries - 
  Responsive timeline on screens less than 600px wide */<br>@media screen and 
  (max-width: 600px) {<br>/* Place the timelime to the left */<br>&nbsp; 
  .timeline::after {<br>&nbsp;&nbsp;&nbsp; left: 31px;<br>&nbsp; }<br><br>/* 
  Full-width containers */<br>&nbsp; .container {<br>&nbsp;&nbsp;&nbsp; width: 
  100%;<br>&nbsp;&nbsp;&nbsp; padding-left: 70px;<br>&nbsp;&nbsp;&nbsp; 
  padding-right: 25px;<br>&nbsp; }<br><br>/* Make sure that all arrows are 
  pointing leftwards */<br>&nbsp; .container::before {<br>&nbsp;&nbsp;&nbsp; 
  left: 60px;<br>&nbsp;&nbsp;&nbsp; border: medium solid white;<br>&nbsp;&nbsp;&nbsp; 
  border-width: 10px 10px 10px 0;<br>&nbsp;&nbsp;&nbsp; border-color: 
  transparent white transparent transparent;<br>&nbsp; }<br><br>/* Make sure all 
  circles are at the same spot */<br>&nbsp; .left::after, .right::after {<br>&nbsp;&nbsp;&nbsp; 
  left: 15px;<br>&nbsp; }<br><br>/* Make all right containers behave like the 
  left ones */<br>&nbsp; .right {<br>&nbsp;&nbsp;&nbsp; left: 0%;<br>&nbsp; }<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_timeline" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
