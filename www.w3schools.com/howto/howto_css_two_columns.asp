...
<h1>How TO - Two Column Layout</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_example_website.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_three_columns.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a 2-column layout grid with CSS.</p>
<hr>

<div class="w3-row">
<div class="w3-col s6" style="height:320px;padding:20px;background-color:#bbb">
<h2>Column 1</h2>
<p>Some text..</p>
</div>
<div class="w3-col s6" style="height:320px;padding:20px;background-color:#ccc">
<h2>Column 2</h2>
<p>Some text..</p>
</div>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_two_columns" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Two Column Layout</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;row&quot;&gt;<br>&nbsp; &lt;div class=&quot;column&quot;&gt;&lt;/div&gt;<br>&nbsp; &lt;div 
  class=&quot;column&quot;&gt;&lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<p>In this example, we will create two <strong>equal</strong> columns:</p>
<div class="w3-example">
<h3>Float Example</h3>
<div class="w3-code notranslate cssHigh">
  .column {<br>&nbsp;&nbsp;&nbsp; 
  float: left;<br>&nbsp;&nbsp;&nbsp; width: 50%;<br>}<br><br>/* Clear floats after the 
  columns */<br>.row:after {<br>&nbsp;&nbsp;&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
  display: table;<br>&nbsp;&nbsp;&nbsp; clear: both;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_two_columns" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>A modern way of creating two columns, is to use <a href="/css/css3_flexbox.asp">CSS Flexbox</a>. However, it is not supported in Internet Explorer 10 and earlier versions.</p>
<div class="w3-example">
<h3>Flex Example</h3>
  <div class="w3-code notranslate cssHigh">
    .row {<br>&nbsp;&nbsp;&nbsp; 
    display: flex;<br>}<br><br>.column {<br>&nbsp;&nbsp;&nbsp; flex: 50%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_two_columns_flex" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-note w3-panel">
<p>It is up to you if you want to use floats or flex to create a two-column layout. However, if you need support for IE10 and down, you should use float.</p>
...
<p>In this example, we will create two <strong>unequal</strong> columns:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .column {<br>&nbsp;&nbsp;&nbsp; float: left;<br>}<br><br>.left {<br>&nbsp;&nbsp;&nbsp; width: 25%;<br>
  }<br><br>.right {<br>&nbsp;&nbsp;&nbsp; 
  width: 75%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_two_columns_unequal" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>In this example, we will create a <strong>responsive</strong> two column layout:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  ...
  screen and (max-width: 600px) {<br>&nbsp;&nbsp;&nbsp; .column {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_two_columns_responsive" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
