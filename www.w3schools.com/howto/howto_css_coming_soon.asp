...
<html lang="en-US">
<head>
<title>How To Create a Coming Soon Page</title>
<meta charset="utf-8">
...
<h1>How TO - Coming Soon Page</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_typewriter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_chat.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a &quot;coming soon page&quot; with CSS and JavaScript.</p>
<hr>

<iframe scrolling="no" src="tryhow_css_coming_soon_ifr.htm" style="width:100%;border:none;height:600px;overflow:hidden"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_coming_soon" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Coming Soon Page</h2>
<h5>Step 1) Add HTML:</h5>
<p>In our example, we will use a background image that covers the entire page 
and place some text in the image to let the user know what's going on.</p>
<p>This example shows how to create a &quot;Coming Soon Page&quot; with just HTML and CSS. 
Look at the next example to find out how to add a &quot;countdown timer&quot; with 
JavaScript as well.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;bgimg&quot;&gt;<br>&nbsp; &lt;div class=&quot;topleft&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;p&gt;Logo&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;middle&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;h1&gt;COMING SOON&lt;/h1&gt;<br>&nbsp;&nbsp;&nbsp; &lt;hr&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;35 
  days&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;bottomleft&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
...
<div class="w3-code notranslate cssHigh">
  ...
  cover the whole page: */<br>body, html {<br>&nbsp;&nbsp;&nbsp; height: 100%<br>}<br><br>.bgimg {<br>&nbsp;&nbsp;&nbsp; 
  /* Background image */<br>&nbsp;&nbsp;&nbsp; 
  background-image: url('/w3images/forestbridge.jpg');<br>&nbsp;&nbsp;&nbsp; /* 
  Full-screen */<br>&nbsp;&nbsp;&nbsp; 
  height: 100%;<br>&nbsp;&nbsp;&nbsp; /* Center the background image */<br>&nbsp;&nbsp;&nbsp; background-position: center;<br>&nbsp;&nbsp;&nbsp; 
  /* Scale and zoom in the image */<br>&nbsp;&nbsp;&nbsp; 
  background-size: cover;<br>&nbsp;&nbsp;&nbsp; /* Add position: relative to 
  enable absolutely positioned elements inside the image (place text) */<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; 
  /* Add a white text color to all elements inside the .bgimg container */<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>&nbsp;&nbsp;&nbsp; /* Add a font */<br>&nbsp;&nbsp;&nbsp; font-family: &quot;Courier New&quot;, Courier, 
  monospace;<br>&nbsp;&nbsp;&nbsp; /* Set the font-size to 25 pixels */<br>&nbsp;&nbsp;&nbsp; font-size: 25px;<br>}<br><br>/* Position text 
  in the top-left corner */<br>.topleft {<br>&nbsp;&nbsp;&nbsp; 
  position: absolute;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; left: 
  16px;<br>}<br><br>/* Position text in the bottom-left corner */<br>.bottomleft {<br>&nbsp;&nbsp;&nbsp; 
  position: absolute;<br>&nbsp;&nbsp;&nbsp; bottom: 0;<br>&nbsp;&nbsp;&nbsp; 
  left: 16px;<br>}<br><br>/* Position text in the middle */<br>.middle {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
  top: 50%;<br>&nbsp;&nbsp;&nbsp; left: 50%;<br>&nbsp;&nbsp;&nbsp; transform: 
  translate(-50%, -50%);<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>}<br><br>
  /* Style the &lt;hr&gt; element */<br>
  hr {<br>&nbsp;&nbsp;&nbsp; margin: auto;<br>&nbsp;&nbsp;&nbsp; width: 40%;<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_coming_soon" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h5>Step 3) Add JavaScript</h5>
<p>Add JavaScript to create a countdown timer:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  // Set the date we're counting down to<br>
  var countDownDate = new Date(&quot;Jan 5, 2019 15:37:25&quot;).getTime();<br><br>// 
  Update the count down every 1 second<br>var x = setInterval(function() {<br>
  <br>&nbsp; // Get todays date and time<br>&nbsp; var now = new Date().getTime();<br>
  <br>&nbsp; // Find the distance between now an the count down date<br>&nbsp; 
  var distance = countDownDate - now;<br><br>&nbsp; // Time calculations for 
  days, hours, minutes and seconds<br>&nbsp; var days = Math.floor(distance / 
  (1000 * 60 * 60 * 24));<br>&nbsp; var hours = Math.floor((distance % (1000 * 
  60 * 60 * 24)) / (1000 * 60 * 60));<br>&nbsp; var minutes = Math.floor((distance 
  % (1000 * 60 * 60)) / (1000 * 60));<br>&nbsp; var seconds = Math.floor((distance 
  % (1000 * 60)) / 1000);<br><br>&nbsp; // Display the result in an element with 
  id=&quot;demo&quot;<br>&nbsp; document.getElementById(&quot;demo&quot;).innerHTML = days + &quot;d &quot; + 
  hours + &quot;h &quot;<br>&nbsp; + minutes + &quot;m &quot; + seconds + &quot;s &quot;;<br><br>&nbsp; // If 
  the count down is finished, write some text <br>&nbsp; if (distance &lt; 0) {<br>&nbsp;&nbsp;&nbsp; 
  clearInterval(x);<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;demo&quot;).innerHTML 
  = &quot;EXPIRED&quot;;<br>&nbsp; }<br>}, 1000);</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_coming_soon_js" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
