...
<html lang="en-US">
<head>
<title>How To Create a Responsive Pricing Table</title>
<meta charset="utf-8">
...
<h1>How TO - Responsive Pricing Table</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_shrink_header_scroll.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_parallax.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive pricing table with CSS.</p>
<hr>
...
<div class="w3-third">
  <ul class="price" style="width:100%">
    ...
    <li>10 Domains</li>
    <li>1GB Bandwidth</li>
    <li class="grey"><a href="javascript:void(0)" class="button w3-hover-green">Sign Up</a></li>
  </ul>
</div>
<div class="w3-third">
  <ul class="price">
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_pricing_table" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Create a Responsive Pricing Table</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;columns&quot;&gt;<br>&nbsp; &lt;ul class=&quot;price&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;li 
class=&quot;header&quot;&gt;Basic&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp; &lt;li class=&quot;grey&quot;&gt;$ 9.99 / 
year&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp; &lt;li&gt;10GB Storage&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;li&gt;10 Emails&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp; &lt;li&gt;10 Domains&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;li&gt;1GB Bandwidth&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp; &lt;li class=&quot;grey&quot;&gt;&lt;a href=&quot;#&quot; 
class=&quot;button&quot;&gt;Sign Up&lt;/a&gt;&lt;/li&gt;<br>&nbsp; &lt;/ul&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
* {<br>&nbsp;&nbsp;&nbsp; box-sizing: border-box;<br>}<br><br>/* Create 
three columns of equal width */<br>.columns {<br>&nbsp;&nbsp;&nbsp; 
float: left;<br>&nbsp;&nbsp;&nbsp; width: 33.3%;<br>&nbsp;&nbsp;&nbsp; 
padding: 8px;<br>}<br><br>/* Style the list */<br>.price {<br>&nbsp;&nbsp;&nbsp; 
list-style-type: none;<br>&nbsp;&nbsp;&nbsp; border: 1px solid #eee;<br>&nbsp;&nbsp;&nbsp; 
margin: 0;<br>&nbsp;&nbsp;&nbsp; padding: 0;<br>&nbsp;&nbsp;&nbsp; -webkit-transition: 
0.3s;<br>&nbsp;&nbsp;&nbsp; 
transition: 0.3s;<br>}<br><br>/* Add shadows on hover */<br>.price:hover {<br>&nbsp;&nbsp;&nbsp; box-shadow: 0 8px 
12px 0 rgba(0,0,0,0.2)<br>}<br><br>/* Pricing header */<br>.price .header {<br>&nbsp;&nbsp;&nbsp; background-color: #111;<br>&nbsp;&nbsp;&nbsp; 
color: white;<br>&nbsp;&nbsp;&nbsp; font-size: 25px;<br>}<br><br>/* List 
items */<br>.price li {<br>&nbsp;&nbsp;&nbsp; 
border-bottom: 1px solid #eee;<br>&nbsp;&nbsp;&nbsp; padding: 20px;<br>&nbsp;&nbsp;&nbsp; 
text-align: center;<br>}<br><br>/* Grey list item */<br>.price .grey {<br>&nbsp;&nbsp;&nbsp; 
background-color: #eee;<br>&nbsp;&nbsp;&nbsp; font-size: 20px;<br>}<br><br>
/* The &quot;Sign Up&quot; button */<br>.button {<br>&nbsp;&nbsp;&nbsp; 
background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; border: none;<br>&nbsp;&nbsp;&nbsp; 
color: white;<br>&nbsp;&nbsp;&nbsp; padding: 10px 25px;<br>&nbsp;&nbsp;&nbsp; 
text-align: center;<br>&nbsp;&nbsp;&nbsp; text-decoration: none;<br>&nbsp;&nbsp;&nbsp; 
font-size: 18px;<br>}<br><br>/* Change the width of the three columns to 
100% <br>(to stack horizontally on small screens) */<br>@media only screen and (max-width: 600px) {<br>&nbsp;&nbsp;&nbsp; 
.columns {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; 
}<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_pricing_table" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_shrink_header_scroll.asp">&#10094; Previous</a>
