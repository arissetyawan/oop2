...
<html lang="en-US">
<head>
<title>How To Create Outline Buttons</title>
<meta charset="utf-8">
...
<h1>How TO - Outline Buttons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_alert_buttons.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_button_split.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style outline buttons with CSS.</p>
...
<div>
<button class="btnout2 outsuccess">Success</button>
<button class="btnout2 outinfo">Info</button>
<button class="btnout2 outwarning">Warning</button>
<button class="btnout2 outdanger">Danger</button>
<button class="btnout2 outdefault">Default</button>
</div>

<a target="_blank" href="tryit.asp?filename=tryhow_css_outline_buttons" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>

<h2>How To Style Outline Buttons</h2>
...
<div class="w3-code notranslate cssHigh">
  .btn {<br>&nbsp;&nbsp;&nbsp; border: 2px solid black;<br>&nbsp;&nbsp;&nbsp; 
  background-color: white;<br>&nbsp;&nbsp;&nbsp; color: black;<br>&nbsp;&nbsp;&nbsp; 
  padding: 14px 28px;<br>&nbsp;&nbsp;&nbsp; font-size: 16px;<br>&nbsp;&nbsp;&nbsp; 
  cursor: pointer;<br>}<br>
  <br>/* Green */<br>.success {<br>&nbsp;&nbsp;&nbsp; border-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; 
  color: green;<br>}<br>
  <br>.success:hover {<br>&nbsp;&nbsp;&nbsp; background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>}<br>
  <br>/* Blue */<br>.info {<br>&nbsp;&nbsp;&nbsp; border-color: #2196F3;<br>&nbsp;&nbsp;&nbsp; 
  color: dodgerblue<br>}<br>
  <br>.info:hover {<br>&nbsp;&nbsp;&nbsp; background: #2196F3;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>}<br><br>/* 
  Orange */<br>.warning {<br>&nbsp;&nbsp;&nbsp; border-color: #ff9800;<br>&nbsp;&nbsp;&nbsp; 
  color: orange;<br>}<br>
  <br>.warning:hover {<br>&nbsp;&nbsp;&nbsp; background: #ff9800;<br>&nbsp;&nbsp;&nbsp; 
  color: white;<br>}<br><br>/* 
  Red */<br>.danger {<br>&nbsp;&nbsp;&nbsp; border-color: #f44336;<br>&nbsp;&nbsp;&nbsp; 
  color: red<br>}<br><br>.danger:hover 
  {<br>&nbsp;&nbsp;&nbsp; background: #f44336;<br>&nbsp;&nbsp;&nbsp; color: 
  white;<br>}<br><br>/* Gray */<br>.default 
  {<br>&nbsp;&nbsp;&nbsp; border-color: #e7e7e7;<br>&nbsp;&nbsp;&nbsp; color: 
  black;<br>}<br><br>.default:hover {<br>&nbsp;&nbsp;&nbsp; 
  background: #e7e7e7;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_outline_buttons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Add the <code class="w3-codespan">border-radius</code> property to create rounded outline buttons:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .btn {<br>&nbsp;&nbsp;&nbsp; border-radius: 5px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_outline_buttons2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
