...
<html lang="en-US">
<head>
<title>How To Create a List Group with CSS</title>
<meta charset="utf-8">
...
<h1>How TO - List Group</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_coupon.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_responsive_text.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to transform a basic list into a "list group" with CSS.</p>
<hr>
<h2>List Group</h2>
<ul class="gr">
  <li>Adele</li>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_list_group" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a List Group</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;ul&gt;<br>&nbsp; &lt;li&gt;Adele&lt;/li&gt;<br>&nbsp; &lt;li&gt;Agnes&lt;/li&gt;<br>&nbsp; 
  &lt;li&gt;Billy&lt;/li&gt;<br>&nbsp; &lt;li&gt;Bob&lt;/li&gt;<br>&nbsp; &lt;li&gt;Calvin&lt;/li&gt;<br>&nbsp; 
  &lt;li&gt;Christina&lt;/li&gt;<br>&nbsp; &lt;li&gt;Cindy&lt;/li&gt;<br>&lt;/ul&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ul {<br>&nbsp; list-style-type: none; /* Remove bullets */<br>&nbsp; padding: 
  0; /* Remove padding */<br>&nbsp; margin: 0; /* Remove margins */<br>}<br><br>ul li {<br>&nbsp; border: 1px solid #ddd; /* Add a thin border 
  to each list item */<br>&nbsp; margin-top: -1px; /* Prevent double borders */<br>&nbsp; 
  background-color: #f6f6f6; /* Add a grey background color */<br>&nbsp; 
  padding: 12px; /* Add some padding */<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_list_group" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Go to our <a href="/css/css_list.asp">CSS List Tutorial</a> to learn more about HTML lists and how to style them.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_coupon.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_responsive_text.asp">Next &#10095;</a>
