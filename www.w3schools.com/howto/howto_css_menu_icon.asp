...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_icon_bar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_accordion.asp">Next &#10095;</a>
</div>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_menu_icon" class="w3-btn">Try it Yourself &raquo;</a></p>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_menu_icon_js" class="w3-btn">Try it Yourself &raquo;</a></p>
</div>
</div>
<script>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_menu_icon" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
<p>The <code class="w3-codespan">width</code> and the <code class="w3-codespan">height</code> property specifies the width and height 
of each bar.</p>
<p>We have added a black <code class="w3-codespan">background-color</code>, and the top and bottom <code class="w3-codespan">margin</code> 
is used to 
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_menu_icon_js" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
