...
<html lang="en-US">
<head>
<title>How To Create a Vertical Button Group</title>
<meta charset="utf-8">
...
<h1>How TO - Vertical Button Group</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_button_group.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_sticky_social_bar.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a vertical &quot;button group&quot; with CSS.</p>
<hr>

<h2>Vertical Button Groups</h2>
<p>Group a series of buttons in a vertical button group:</p>
<div class="btngroup">
<div class="btn-group">
  <button>Apple</button>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_button_group_vertical" class="w3-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate cssHigh">
  ...
  */<br>&nbsp;&nbsp;&nbsp; color: white; /* White text */<br>&nbsp;&nbsp;&nbsp; 
  padding: 10px 24px; /* Some padding */<br>&nbsp;&nbsp;&nbsp; cursor: pointer; 
  /* Pointer/hand icon */<br>&nbsp;&nbsp;&nbsp; width: 50%; /* Set a width if 
  needed */<br>&nbsp;&nbsp;&nbsp; display: block; /* Make the buttons appear 
  below each other */<br>}<br><br>.btn-group 
  button:not(:last-child) {<br>&nbsp;&nbsp;&nbsp; border-bottom: none; /* 
  Prevent double borders */<br>}<br><br>/* Add a background color on hover */<br>.btn-group button:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #3e8e41;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_button_group_vertical" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
