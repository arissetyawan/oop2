...
<html lang="en-US">
<head>
<title>How To Create an Image Magnifier Glass</title>
<meta charset="utf-8">
...
<h1>How TO - Image Magnifier Glass</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_image_zoom.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_image_comparison.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an image magnifier glass.</p>
<hr>
<h2>Image Magnifier Glass</h2>
<p>Mouse over the image:</p>

<div class="img-magnifier-container">
  <img id="mymagnifyimage" src="img_girl.jpg" width="600" height="400">
</div>
...
<br>
<br>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_image_magnifier_glass" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>Create an Image Magnifier Glass</h2>
<h5>Step 1) Add HTML:</h5>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;img-magnifier-container&quot;&gt;<br>&nbsp; &lt;img id=&quot;myimage&quot; src=&quot;img_girl.jpg&quot; 
  width=&quot;600&quot; height=&quot;400&quot; alt=&quot;Girl&quot;&gt;<br>&lt;/div&gt;<br></div>
</div>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box;}<br><br>.img-magnifier-container {<br>&nbsp; position: 
  relative;<br>}<br><br>.img-magnifier-glass {<br>&nbsp; position: absolute;<br>&nbsp; border: 
  3px solid #000;<br>&nbsp; border-radius: 50%;<br>&nbsp; cursor: none;<br>&nbsp; /*Set the size of the 
  magnifier glass:*/<br>&nbsp; width: 100px;<br>&nbsp; height: 100px;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  function magnify(imgID, zoom) {<br>&nbsp; var img, glass, w, h, bw;<br>&nbsp; 
  img = document.getElementById(imgID);<br><br>&nbsp; /*create magnifier glass:*/<br>&nbsp; 
  glass = document.createElement(&quot;DIV&quot;);<br>&nbsp; glass.setAttribute(&quot;class&quot;, &quot;img-magnifier-glass&quot;);<br><br>&nbsp; 
  /*insert magnifier glass:*/<br>&nbsp; img.parentElement.insertBefore(glass, 
  img);<br><br>&nbsp; /*set background properties for the magnifier glass:*/<br>&nbsp; 
  glass.style.backgroundImage = &quot;url('&quot; + img.src + &quot;')&quot;;<br>&nbsp; 
  glass.style.backgroundRepeat = &quot;no-repeat&quot;;<br>&nbsp; 
  glass.style.backgroundSize = (img.width * zoom) + &quot;px &quot; + (img.height * zoom) 
  + &quot;px&quot;;<br>&nbsp; bw = 3;<br>&nbsp; w = glass.offsetWidth / 2;<br>&nbsp; h = 
  glass.offsetHeight / 2;<br><br>&nbsp; /*execute a function when someone moves the 
  magnifier glass over the image:*/<br>&nbsp; glass.addEventListener(&quot;mousemove&quot;, 
  moveMagnifier);<br>&nbsp; img.addEventListener(&quot;mousemove&quot;, moveMagnifier);<br><br>&nbsp; /*and 
  also for touch screens:*/<br>&nbsp; glass.addEventListener(&quot;touchmove&quot;, 
  moveMagnifier);<br>&nbsp; img.addEventListener(&quot;touchmove&quot;, moveMagnifier);<br>&nbsp; 
  function moveMagnifier(e) {<br>&nbsp;&nbsp;&nbsp; var pos, x, y;<br>&nbsp;&nbsp;&nbsp; 
  /*prevent any other actions that may occur when moving over the image*/<br>&nbsp;&nbsp;&nbsp; 
  e.preventDefault();<br>&nbsp;&nbsp;&nbsp; 
  /*get the cursor's x and y positions:*/<br>&nbsp;&nbsp;&nbsp; pos = 
  getCursorPos(e);<br>&nbsp;&nbsp;&nbsp; x = pos.x;<br>&nbsp;&nbsp;&nbsp; y = 
  pos.y;<br>&nbsp;&nbsp;&nbsp; /*prevent the magnifier glass from being 
  positioned outside the image:*/<br>&nbsp;&nbsp;&nbsp; if (x &gt; img.width - (w / 
  zoom)) {x = img.width - (w / zoom);}<br>&nbsp;&nbsp;&nbsp; if (x &lt; w / zoom) 
  {x = w / zoom;}<br>&nbsp;&nbsp;&nbsp; if (y &gt; img.height - (h / zoom)) {y = 
  img.height - (h / zoom);}<br>&nbsp;&nbsp;&nbsp; if (y &lt; h / zoom) {y = h / 
  zoom;}<br>&nbsp;&nbsp;&nbsp; /*set the position of the magnifier glass:*/<br>&nbsp;&nbsp;&nbsp; 
  glass.style.left = (x - w) + &quot;px&quot;;<br>&nbsp;&nbsp;&nbsp; glass.style.top = (y 
  - h) + &quot;px&quot;;<br>&nbsp;&nbsp;&nbsp; /*display what the magnifier glass 
  &quot;sees&quot;:*/<br>&nbsp;&nbsp;&nbsp; glass.style.backgroundPosition = &quot;-&quot; + ((x * 
  zoom) - w + bw) + &quot;px -&quot; + ((y * zoom) - h + bw) + &quot;px&quot;;<br>&nbsp; }<br><br>&nbsp; 
  function getCursorPos(e) {<br>&nbsp;&nbsp;&nbsp; var a, x = 0, y = 0;<br>&nbsp;&nbsp;&nbsp; 
  e = e || window.event;<br>&nbsp;&nbsp;&nbsp; /*get the x and y positions of 
  the image:*/<br>&nbsp;&nbsp;&nbsp; a = img.getBoundingClientRect();<br>&nbsp;&nbsp;&nbsp; 
  /*calculate the cursor's x and y coordinates, relative to the image:*/<br>&nbsp;&nbsp;&nbsp; 
  x = e.pageX - a.left;<br>&nbsp;&nbsp;&nbsp; y = e.pageY - a.top;<br>&nbsp;&nbsp;&nbsp; 
  /*consider any page scrolling:*/<br>&nbsp;&nbsp;&nbsp; x = x - 
  window.pageXOffset;<br>&nbsp;&nbsp;&nbsp; y = y - window.pageYOffset;<br>&nbsp;&nbsp;&nbsp; 
  return {x : x, y : y};<br>&nbsp; }<br>}<br></div>
</div>
<hr>

<h5>Step 4) Initiate the Magnify Function</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;script&gt;<br>
  /*Execute the magnify function:*/<br>
  magnify("myimage&quot;, 3);<br>/*Specify the id of the 
  image, and the strength of the magnifier glass:*/ <br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_image_magnifier_glass" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
