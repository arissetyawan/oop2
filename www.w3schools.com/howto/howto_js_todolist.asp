...
<h1>How TO - Create a To Do List</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_html_include.asp">&#10094; Previous</a>
	<a class="w3-right w3-btn" href="howto_css_loader.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a "to-do list" with CSS and JavaScript.</p>
<hr>
<h2>The To Do List</h2>
<p>Use CSS and JavaScript to create a "to-do list" to organize and prioritize your tasks.</p>
<div class="w3-content">
<iframe src="tryhow_js_todo.htm" style="border:none;width:100%;height:450px;overflow:hidden;"></iframe>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_todo" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>Create The To Do List</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div id=&quot;myDIV&quot; class=&quot;header&quot;&gt;<br>&nbsp; &lt;h2&gt;My To Do List&lt;/h2&gt;<br>&nbsp; 
&lt;input type=&quot;text&quot; id=&quot;myInput&quot; placeholder=&quot;Title...&quot;&gt;<br>&nbsp; &lt;span 
onclick=&quot;newElement()&quot; class=&quot;addBtn&quot;&gt;Add&lt;/span&gt;<br>&lt;/div&gt;<br><br>&lt;ul id=&quot;myUL&quot;&gt;<br>&nbsp; &lt;li&gt;Hit 
the gym&lt;/li&gt;<br>&nbsp; &lt;li class=&quot;checked&quot;&gt;Pay bills&lt;/li&gt;<br>&nbsp; 
&lt;li&gt;Meet George&lt;/li&gt;<br>&nbsp; &lt;li&gt;Buy eggs&lt;/li&gt;<br>&nbsp; &lt;li&gt;Read a 
book&lt;/li&gt;<br>&nbsp; &lt;li&gt;Organize office&lt;/li&gt;<br>&lt;/ul&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>Style the header and the list:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
/* Include the padding and border in an element's total width and height */<br>* {<br>&nbsp;&nbsp;&nbsp; box-sizing: border-box;<br>}<br>
<br>/* Remove margins and padding from the list */<br>ul {<br>&nbsp;&nbsp;&nbsp; 
margin: 0;<br>&nbsp;&nbsp;&nbsp; padding: 0;<br>}<br><br>/* Style the list 
items */<br>ul li {<br>&nbsp;&nbsp;&nbsp; 
cursor: pointer;<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; 
padding: 12px 8px 12px 40px;<br>&nbsp;&nbsp;&nbsp; background: #eee;<br>&nbsp;&nbsp;&nbsp; 
font-size: 18px;<br>&nbsp;&nbsp;&nbsp; transition: 0.2s;<br><br>&nbsp;&nbsp;&nbsp; /* 
make the list items unselectable */<br>&nbsp;&nbsp;&nbsp; -webkit-user-select: none;<br>&nbsp;&nbsp;&nbsp; 
-moz-user-select: none;<br>&nbsp;&nbsp;&nbsp; -ms-user-select: none;<br>&nbsp;&nbsp;&nbsp; 
user-select: none;<br>}<br><br>/* Set all odd list items to a different 
color (zebra-stripes) */<br>ul 
li:nth-child(odd) {<br>&nbsp;&nbsp;&nbsp; background: #f9f9f9;<br>}<br><br>
/* Darker background-color on hover */<br>
ul li:hover {<br>&nbsp;&nbsp;&nbsp; background: #ddd;<br>}<br><br>/* When 
clicked on, add a background color and strike out text */<br>ul 
li.checked {<br>&nbsp;&nbsp;&nbsp; background: #888;<br>&nbsp;&nbsp;&nbsp; 
color: #fff;<br>&nbsp;&nbsp;&nbsp; text-decoration: line-through;<br>}<br>
<br>/* Add a &quot;checked&quot; mark when clicked on */<br>ul li.checked::before {<br>&nbsp;&nbsp;&nbsp; content: '';<br>&nbsp;&nbsp;&nbsp; 
position: absolute;<br>&nbsp;&nbsp;&nbsp; border-color: #fff;<br>&nbsp;&nbsp;&nbsp; 
border-style: solid;<br>&nbsp;&nbsp;&nbsp; border-width: 0 2px 2px 0;<br>&nbsp;&nbsp;&nbsp; 
top: 10px;<br>&nbsp;&nbsp;&nbsp; left: 16px;<br>&nbsp;&nbsp;&nbsp; 
transform: rotate(45deg);<br>&nbsp;&nbsp;&nbsp; height: 15px;<br>&nbsp;&nbsp;&nbsp; 
width: 7px;<br>}<br><br>/* Style the close button */<br>.close {<br>&nbsp;&nbsp;&nbsp; 
position: absolute;<br>&nbsp;&nbsp;&nbsp; right: 0;<br>&nbsp;&nbsp;&nbsp; 
top: 0;<br>&nbsp;&nbsp;&nbsp; padding: 12px 16px 12px 16px;<br>}<br><br>.close:hover {<br>&nbsp;&nbsp;&nbsp; background-color: #f44336;<br>&nbsp;&nbsp;&nbsp; 
color: white;<br>}<br>
<br>/* Style the header */<br>.header {<br>&nbsp;&nbsp;&nbsp; background-color: #f44336;<br>&nbsp;&nbsp;&nbsp; 
padding: 30px 40px;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
text-align: center;<br>}<br><br>/* Clear floats after the header */<br>.header:after {<br>&nbsp;&nbsp;&nbsp; 
content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; display: table;<br>&nbsp;&nbsp;&nbsp; 
clear: both;<br>}<br><br>/* Style the input */<br>input {<br>&nbsp;&nbsp;&nbsp; 
  margin: 0;<br>&nbsp;&nbsp;&nbsp; 
border: none;<br>&nbsp;&nbsp;&nbsp; border-radius: 0;<br>&nbsp;&nbsp;&nbsp; width: 75%;<br>&nbsp;&nbsp;&nbsp; 
padding: 10px;<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; 
font-size: 16px;<br>}<br>
<br>/* Style the &quot;Add&quot; button */<br>.addBtn {<br>&nbsp;&nbsp;&nbsp; padding: 10px;<br>&nbsp;&nbsp;&nbsp; 
width: 25%;<br>&nbsp;&nbsp;&nbsp; background: #d9d9d9;<br>&nbsp;&nbsp;&nbsp; 
color: #555;<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; 
text-align: center;<br>&nbsp;&nbsp;&nbsp; font-size: 16px;<br>&nbsp;&nbsp;&nbsp; 
cursor: pointer;<br>&nbsp;&nbsp;&nbsp; transition: 0.3s;<br>&nbsp;&nbsp;&nbsp; 
  border-radius: 0;<br>}<br><br>.addBtn:hover {<br>&nbsp;&nbsp;&nbsp; 
background-color: #bbb;<br>}<br></div>
</div>
<hr>
...
// Create a &quot;close&quot; button and append it to each list item<br>var myNodelist = document.getElementsByTagName(&quot;LI&quot;);<br>var i;<br>for (i = 
0; i &lt; myNodelist.length; i++) {<br>&nbsp; var span = document.createElement(&quot;SPAN&quot;);<br>
&nbsp;
var txt = document.createTextNode(&quot;\u00D7&quot;);<br>&nbsp; span.className = &quot;close&quot;;<br>
&nbsp;
span.appendChild(txt);<br>&nbsp; myNodelist[i].appendChild(span);<br>}<br>
<br>// Click on a close button to hide the current list item<br>var 
close = document.getElementsByClassName(&quot;close&quot;);<br>var i;<br>for (i = 
0; i &lt; close.length; i++) {<br>&nbsp; close[i].onclick = function() {<br>&nbsp;&nbsp;&nbsp; var div = 
this.parentElement;<br>&nbsp;&nbsp;&nbsp; div.style.display = &quot;none&quot;;<br>&nbsp; }<br>}<br>
<br>// Add a &quot;checked&quot; symbol when clicking on a list item<br>var list 
= document.querySelector('ul');<br>list.addEventListener('click', function(ev) 
{<br>&nbsp; if (ev.target.tagName === 'LI') {<br>&nbsp;&nbsp;&nbsp; ev.target.classList.toggle('checked');<br>
&nbsp;
}<br>}, false);<br><br>// Create a new list item when clicking on the &quot;Add&quot; 
button<br>function newElement() {<br>&nbsp; var li = 
document.createElement(&quot;li&quot;);<br>&nbsp; var inputValue = document.getElementById(&quot;myInput&quot;).value;<br>
&nbsp;
var t = document.createTextNode(inputValue);<br>&nbsp; li.appendChild(t);<br>&nbsp; if (inputValue 
=== '') {<br>&nbsp;&nbsp;&nbsp; alert(&quot;You must write something!&quot;);<br>&nbsp; } else {<br>
&nbsp;&nbsp;&nbsp;
document.getElementById(&quot;myUL&quot;).appendChild(li);<br>&nbsp; }<br>
&nbsp;
document.getElementById(&quot;myInput&quot;).value = &quot;&quot;;<br><br>&nbsp; var span = 
document.createElement(&quot;SPAN&quot;);<br>&nbsp; var txt = document.createTextNode(&quot;\u00D7&quot;);<br>
&nbsp;
span.className = &quot;close&quot;;<br>&nbsp; span.appendChild(txt);<br>&nbsp; li.appendChild(span);<br>
<br>&nbsp; for (i = 0; i &lt; close.length; i++) {<br>&nbsp;&nbsp;&nbsp; close[i].onclick = function() {<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
var div = this.parentElement;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; div.style.display = &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_todo" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
