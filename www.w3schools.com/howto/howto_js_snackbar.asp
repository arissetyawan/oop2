...
<html lang="en-US">
<head>
<title>How To Create a Snackbar / Toast</title>
<meta charset="utf-8">
...
<h1>How TO - Snackbar / Toast</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_responsive_floats.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_fullscreen.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a snackbar / toast with CSS and JavaScript.</p>
<hr>
<h2>Snackbar / Toast</h2>
<p>Snackbars are often used as tooltips/popups to show a message at the bottom of the screen.</p>
<p>Click on the button to show the snackbar. It will disappear after 3 seconds.</p>

<button onclick="myFunction()" class="w3-btn w3-dark-grey">Show Snackbar</button>

<div id="myDIV">Some text some message..</div>
...
<h2>Create a Snackbar</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;!-- Use a button to open the snackbar --&gt;<br>&lt;button onclick=&quot;myFunction()&quot;&gt;Show 
Snackbar&lt;/button&gt;<br><br>&lt;!-- The actual snackbar --&gt;<br>&lt;div 
id=&quot;snackbar&quot;&gt;Some text some message..&lt;/div&gt;</div>
</div>
<hr>
...
<p>Style the snackbar and add animations:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
/* The snackbar 
- position it at the bottom and in the middle of the screen */<br>#snackbar {<br>&nbsp;&nbsp;&nbsp; visibility: hidden; 
/* Hidden by default. Visible on click */<br>&nbsp;&nbsp;&nbsp; 
min-width: 250px; /* Set a default minimum width */<br>&nbsp;&nbsp;&nbsp; 
margin-left: -125px; /* Divide value of min-width by 2 */<br>&nbsp;&nbsp;&nbsp; background-color: #333; 
/* Black background color */<br>&nbsp;&nbsp;&nbsp; 
color: #fff; /* White text color */<br>&nbsp;&nbsp;&nbsp; text-align: center; 
/* Centered text */<br>&nbsp;&nbsp;&nbsp; 
border-radius: 2px; /* Rounded borders */<br>&nbsp;&nbsp;&nbsp; padding: 16px; 
/* Padding */<br>&nbsp;&nbsp;&nbsp; 
position: fixed; /* Sit on top of the screen */<br>&nbsp;&nbsp;&nbsp; z-index: 1; 
/* Add a z-index if needed */<br>&nbsp;&nbsp;&nbsp; 
left: 50%; /* Center the snackbar */<br>&nbsp;&nbsp;&nbsp; bottom: 30px; /* 
30px from the bottom */<br>}<br><br>/* Show the snackbar when clicking on a 
button (class added with JavaScript) */<br>#snackbar.show {<br>&nbsp;&nbsp;&nbsp; 
visibility: visible; /* Show the snackbar */<br>&nbsp;&nbsp;&nbsp; /* Add 
animation: Take 0.5 seconds to fade in and out the snackbar. <br>&nbsp;&nbsp; However, 
delay the fade out process for 2.5 seconds */<br>&nbsp;&nbsp;&nbsp;-webkit-animation: 
fadein 0.5s, fadeout 0.5s 2.5s;<br>&nbsp;&nbsp;&nbsp;animation: fadein 
0.5s, fadeout 0.5s 2.5s;<br>}<br><br>/* Animations to fade the snackbar in 
and out */<br>@-webkit-keyframes fadein {<br>&nbsp;&nbsp;&nbsp; 
from {bottom: 0; opacity: 0;} <br>&nbsp;&nbsp;&nbsp; to {bottom: 30px; 
opacity: 1;}<br>}<br><br>@keyframes fadein {<br>&nbsp;&nbsp;&nbsp; from {bottom: 0; opacity: 
0;}<br>&nbsp;&nbsp;&nbsp; to {bottom: 30px; opacity: 1;}<br>}<br><br>@-webkit-keyframes fadeout {<br>&nbsp;&nbsp;&nbsp; 
from {bottom: 30px; opacity: 1;} <br>&nbsp;&nbsp;&nbsp; to {bottom: 0; 
opacity: 0;}<br>}<br><br>@keyframes 
fadeout {<br>&nbsp;&nbsp;&nbsp; from {bottom: 30px; opacity: 1;}<br>&nbsp;&nbsp;&nbsp; 
to {bottom: 0; opacity: 0;}<br>}</div>
</div>
<hr>

<h5>Step 3) Add JavaScript:</h5>
<p>Use JavaScript to add the "show" class to the snackbar container with a click of a button:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
   function myFunction() {<br>&nbsp;&nbsp;&nbsp; // Get the snackbar DIV<br>&nbsp;&nbsp;&nbsp; 
var x = document.getElementById(&quot;snackbar&quot;);<br><br>&nbsp;&nbsp;&nbsp; // Add 
the &quot;show&quot; class to DIV<br>&nbsp;&nbsp;&nbsp; x.className = &quot;show&quot;;<br><br>&nbsp;&nbsp;&nbsp; 
// After 3 seconds, remove the show class from DIV<br>&nbsp;&nbsp;&nbsp; 
setTimeout(function(){ x.className = x.className.replace(&quot;show&quot;, &quot;&quot;); }, 
3000);<br>}</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_snackbar" target="_blank">Try it Yourself &raquo;</a>
</div>
