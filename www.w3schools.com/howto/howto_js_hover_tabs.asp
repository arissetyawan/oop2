...
<html lang="en-US">
<head>
<title>How To Change Tabs on Hover</title>
<meta charset="utf-8">
...
<h1>How TO - Hover Tabs</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_full_page_tabs.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_topnav.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to change tabs on hover, with CSS and JavaScript.</p>
<hr>
<h2>Hover Tabs</h2>
<p>Move the mouse over one of the menu buttons to show the tab content:</p>

<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'London');" onmouseover="openCity(event, 'London')" id="defaultOpen">London</button>
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_hover_tabs" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a></p>

<hr>

<h2>Create Hoverable Vertical Tabs</h2>
...
<div class="w3-code notranslate cssHigh">
  ...
  cursor: pointer;<br>}<br><br>/* Change 
...
<a target="_blank" href="tryit.asp?filename=tryhow_js_hover_tabs" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
