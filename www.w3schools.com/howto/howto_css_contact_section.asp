...
<html lang="en-US">
<head>
<title>How To Create a Contact Section</title>
<meta charset="utf-8">
...
<h1>How TO - Contact Section</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_center_website.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_style_header.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive contact section for web pages.</p>
<hr>
<h2>Contact Section</h2>
<iframe src="tryhow_css_contact_section_ifr.htm" style="border:none;width:100%;height:700px"></iframe>

<a target="_blank" href="tryit.asp?filename=tryhow_css_contact_section" class="w3-btn">Try it Yourself &raquo;</a>
<hr>

<h2>Create a Contact Section</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;div style=&quot;text-align:center&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;h2&gt;Contact Us&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Swing by for a cup of coffee, or 
  leave us a message:&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;row&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;div class=&quot;column&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div id=&quot;map&quot; 
  style=&quot;width:100%;height:500px&quot;&gt;&lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;div class=&quot;column&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;form action=&quot;/action_page.php&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  &lt;/select&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;label 
  for=&quot;subject&quot;&gt;Subject&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;textarea 
  ...
  &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;!-- Initialize Google Maps --&gt;<br>
  &lt;script&gt;<br>function myMap() {<br>&nbsp; var myCenter = new google.maps.LatLng(51.508742,-0.120850);<br>&nbsp; 
  var mapCanvas = document.getElementById(&quot;map&quot;);<br>&nbsp; var mapOptions = 
  {center: myCenter, zoom: 12};<br>&nbsp; var map = new google.maps.Map(mapCanvas, 
  mapOptions);<br>&nbsp; var marker = new google.maps.Marker({position:myCenter});<br>&nbsp; 
  marker.setMap(map);<br>}<br>
  &lt;/script&gt;<br><br>&lt;script src=&quot;https://maps.googleapis.com/maps/api/js?key=AIzaSyBu-916DdpKAjTmJNIgngS6HL_kDIKU0aU&amp;callback=myMap&quot;&gt;&lt;/script&gt;<br>
  &lt;!--<br>To use this code on your website, get a free API key from Google.<br>
  Read more at: https://www.w3schools.com/graphics/google_maps_basic.asp<br>--&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp;&nbsp;&nbsp; box-sizing: border-box;<br>}<br><br>/* Style inputs */<br>input[type=text], select, textarea {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; 
  padding: 12px;<br>&nbsp;&nbsp;&nbsp; border: 1px solid #ccc;<br>&nbsp;&nbsp;&nbsp; margin-top: 6px;<br>&nbsp;&nbsp;&nbsp; 
  margin-bottom: 16px;<br>&nbsp;&nbsp;&nbsp; resize: vertical;<br>}<br><br>input[type=submit] {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
  padding: 12px 20px;<br>&nbsp;&nbsp;&nbsp; border: none;<br>&nbsp;&nbsp;&nbsp; 
  cursor: pointer;<br>}<br><br>input[type=submit]:hover {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #45a049;<br>}<br><br>/* Style the container/contact section 
  */<br>.container {<br>&nbsp;&nbsp;&nbsp; border-radius: 5px;<br>&nbsp;&nbsp;&nbsp; 
  background-color: #f2f2f2;<br>&nbsp;&nbsp;&nbsp; padding: 10px;<br>}<br><br>/* Create two columns that float next to eachother 
  */<br>.column {<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; 
  width: 50%;<br>&nbsp;&nbsp;&nbsp; margin-top: 6px;<br>&nbsp;&nbsp;&nbsp; 
  padding: 20px;<br>}<br><br>/* Clear floats after the columns */<br>.row:after {<br>&nbsp;&nbsp;&nbsp; 
  content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; display: table;<br>&nbsp;&nbsp;&nbsp; 
  clear: both;<br>}<br><br>/* Responsive 
  layout - when the screen is less than 600px wide, make the two columns stack 
  on top of each other instead of next to each other */<br>@media screen and (max-width: 
  600px) {<br>&nbsp;&nbsp;&nbsp; .column, input[type=submit] {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  width: 100%;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; margin-top: 0;<br>&nbsp;&nbsp;&nbsp; 
  }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_contact_section" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
