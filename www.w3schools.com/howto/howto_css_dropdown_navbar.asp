...
<html lang="en-US">
<head>
<title>How To Create a Dropdown Navigation Bar</title>
<meta charset="utf-8">
...
<h1>How TO - Dropdown Navbar</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_dropdown.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_dropdown_sidenav.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a dropdown navigation bar.</p>
<hr>
<h2>Dropdown Menu in Navbar</h2>

<div style="padding:10px;border:3px solid #f1f1f1">
<iframe src="tryhow_css_dropdown_navbar.htm" style="width:100%;border:none;height:200px;"></iframe>
</div>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_dropdown_navbar" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr style="clear:both;">
<h2>Create A Dropdown Navbar</h2>
...
<div class="w3-code notranslate cssHigh">
  ...
  padding: 14px 16px;<br>&nbsp; background-color: inherit;<br>&nbsp; font-family: 
  inherit; /* Important for vertical align on mobile phones */<br>&nbsp; margin: 
  0; /* Important for vertical align on mobile phones */<br>}<br><br>/* Add a 
  ...
  z-index: 1;<br>}<br><br>/* Links inside the dropdown */<br>.dropdown-content a 
  {<br>&nbsp; float: none;<br>&nbsp; color: black;<br>&nbsp; 
  padding: 12px 16px;<br>&nbsp; text-decoration: none;<br>&nbsp; display: block;<br>&nbsp; 
  text-align: left;<br>}<br><br>/* Add a grey background color to dropdown links 
  on hover */<br>.dropdown-content a:hover {<br>&nbsp; background-color: #ddd;<br>}<br><br>/* 
  Show the dropdown menu on hover */<br>.dropdown:hover .dropdown-content {<br>&nbsp; display: block;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_dropdown_navbar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
...
<p>The <code class="w3-codespan">.dropdown-content</code> class holds the actual dropdown menu. It is hidden by 
...
<h2>Clickable Dropdown in Navbar</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-white w3-padding notranslate">
<iframe src="tryhow_css_dropdown_navbar_click.htm" style="width:100%;border:none;height:230px;"></iframe>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_dropdown_navbar_click" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
