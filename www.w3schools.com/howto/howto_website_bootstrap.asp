...
<html lang="en-US">
<head>
<title>How To Make a Website with Bootstrap</title>
<meta charset="utf-8">
...
<h1>How TO - Make a Website with Bootstrap</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_website.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_website_bootstrap4.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive website with the Bootstrap CSS Framework.</p>
<hr>
<h2>Create a Website with Bootstrap</h2>
<div class="w3-content" style="max-width:1500px">
<iframe src="tryhow_website_bootstrap_ifr.htm" class="w3-round" style="width:100%;border:5px solid #e9e9e9;height:600px"></iframe>
<div class="w3-row-padding" style="margin:16px -16px 0 -16px">
  <div class="w3-col m6">
    <a href="tryhow_website_bootstrap.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey w3-block">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="tryit.asp?filename=tryhow_website_bootstrap" target="_blank" class="w3-btn w3-padding-large w3-green w3-block">Try it Yourself</a>
  </div>
</div>
</div>
...
<p><strong>Note:</strong> If you don't know Bootstrap, <a href="/bootstrap/default.asp">we suggest that you read our Bootstrap Tutorial</a>.</p>
</div>
<!--
<hr>
