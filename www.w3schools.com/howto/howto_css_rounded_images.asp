...
<h1>How TO - Rounded Images</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_images_side_by_side.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_avatar.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create rounded and circular images with CSS.</p>
<hr>

<div class="w3-row-padding" style="max-width:300px;">
<img src="img_avatar.png" alt="Avatar" class="w3-col s6" style="border-radius:50%;">
<img src="img_avatar2.png" alt="Avatar" class="w3-col s6" style="border-radius:50%;">
</div>
<hr>

<h2>How To Create Rounded Images</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;img src=&quot;img_avatar.png&quot; alt=&quot;Avatar&quot;&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>Use the <code class="w3-codespan">border-radius</code> property to add rounded corners to an image. 50% will make the image circular:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  img {<br>&nbsp;&nbsp;&nbsp; border-radius: 50%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_rounded_images" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
