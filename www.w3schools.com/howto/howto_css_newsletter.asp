...
<html lang="en-US">
<head>
<title>How To Create an Email Newsletter with CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Email Newsletter</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_form_icon.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_stacked_form.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an email newsletter with CSS.</p>
<hr>

<div class="x" style="border-radius:5px">

  <div class="container">
    <h2>Subscribe to our Newsletter</h2>
    <p>Lorem ipsum text about why you should subscribe to our newsletter blabla. Lorem ipsum text about why you should subscribe to our newsletter blabla. Lorem ipsum text about why you should subscribe to our newsletter blabla.</p>
  </div>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_newsletter" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Newsletter</h2>
...
inputs for each field, together with a "submit" button:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;form action=&quot;action_page.php&quot;&gt;<br>&nbsp; &lt;div class=&quot;container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;h2&gt;Subscribe to our Newsletter&lt;/h2&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Lorem ipsum..&lt;/p&gt;<br>&nbsp; 
  &lt;/div&gt;<br><br>&nbsp; &lt;div class=&quot;container&quot; style=&quot;background-color:white&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;text&quot; placeholder=&quot;Name&quot; name=&quot;name&quot; required&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;text&quot; placeholder=&quot;Email address&quot; name=&quot;mail&quot; required&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input type=&quot;checkbox&quot; checked=&quot;checked&quot; 
  name=&quot;subscribe&quot;&gt; Daily Newsletter<br>&nbsp;&nbsp;&nbsp; 
  &lt;/label&gt;<br>&nbsp; &lt;/div&gt;<br>
  <br>&nbsp; &lt;div class=&quot;container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input type=&quot;submit&quot; 
  value=&quot;Subscribe&quot;&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/form&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  around it */<br>form {<br>&nbsp;&nbsp;&nbsp; border: 4px solid #f1f1f1;<br>}<br>
  <br>/* Add some padding and a grey background color to containers */<br>.container {<br>&nbsp;&nbsp;&nbsp; padding: 20px;<br>&nbsp;&nbsp;&nbsp; 
  background-color: #f1f1f1;<br>}<br><br>/* Style the input elements and the 
  submit button */<br>
  input[type=text], input[type=submit] {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>
  &nbsp;&nbsp;&nbsp; padding: 12px;<br>&nbsp;&nbsp;&nbsp; margin: 8px 0;<br>&nbsp;&nbsp;&nbsp; 
  display: inline-block;<br>&nbsp;&nbsp;&nbsp; border: 1px solid #ccc;<br>&nbsp;&nbsp;&nbsp; 
  box-sizing: border-box;<br>}<br><br>/* Add margins to the checkbox */<br>
  input[type=checkbox] {<br>&nbsp;&nbsp;&nbsp; 
  margin-top: 16px;<br>}<br>
  <br>/* Style the submit button */<br>input[type=submit] {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
  border: none;<br>}<br><br>input[type=submit]:hover {<br>&nbsp;&nbsp;&nbsp; 
  opacity: 0.8;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_newsletter" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
