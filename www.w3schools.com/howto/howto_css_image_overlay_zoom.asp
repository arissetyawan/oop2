...
<html lang="en-US">
<head>
<title>How To Create an Image Overlay Zoom Effect</title>
<meta charset="utf-8">
...
<h1>How TO - Image Overlay Zoom</h1>
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="howto_css_image_overlay_slide.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_overlay_title.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an image overlay zoom effect on hover.</p>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_zoom" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>

<hr>

<h2>How To Create an Overlay Zoom Effect</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;img src=&quot;img_avatar.png&quot; alt=&quot;Avatar&quot; 
  class=&quot;image&quot;&gt;<br>&nbsp; &lt;div class=&quot;overlay&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div 
  class=&quot;text&quot;&gt;Hello World&lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Container 
  needed to position the overlay. Adjust the width as needed */<br>.container {<br>&nbsp; position: relative;<br>&nbsp; width: 50%;<br>}<br>
  ...
  over the image */<br>.overlay {<br>&nbsp; 
  position: absolute;<br>&nbsp; bottom: 0;<br>&nbsp; left: 0;<br>&nbsp; right: 
  0;<br>&nbsp; background-color: #008CBA;<br>&nbsp; overflow: hidden;<br>&nbsp; 
  width: 100%;<br>&nbsp; height: 100%;<br>&nbsp; transform: scale(0);<br>&nbsp; 
  transition: .3s ease;<br>}<br><br>/* When you mouse over the container, the 
  overlay text will &quot;zoom&quot; in display */<br>.container:hover .overlay {<br>&nbsp; transform: 
  scale(1);<br>}<br><br>/* Some text inside the overlay, which is positioned in 
  the middle vertically and horizontally */<br>.text {<br>&nbsp; color: white;<br>&nbsp; 
  font-size: 20px;<br>&nbsp; position: absolute;<br>&nbsp; top: 50%;<br>&nbsp; 
  left: 50%;<br>&nbsp; transform: translate(-50%, -50%);<br>&nbsp; text-align: center;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_zoom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
