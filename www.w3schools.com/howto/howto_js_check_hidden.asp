...
<html lang="en-US">
<head>
<title>How To Find Out if an Element is Hidden</title>
<meta charset="utf-8">
...
<h1>How TO - Check if an Element is Hidden</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_offline_detection.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_redirect_webpage.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to find out if an element is hidden with JavaScript.</p>
<hr>
<h2>Check Hidden Element</h2>
<div class="w3-example">
<h3>Example</h3>
<p>If the &lt;div&gt; element is hidden, do something:</p>
<div class="w3-code notranslate jsHigh">
  function myFunction() {<br>&nbsp; var x = document.getElementById(&quot;myDIV&quot;);<br>&nbsp; 
  if (x.style.display = &quot;none&quot;) {<br>&nbsp;&nbsp;&nbsp; // Do something..<br>&nbsp; 
  }<br>}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_check_hidden" target="_blank">Try it Yourself &raquo;</a>
</div>
<p><b>Note:</b> When an element is hidden with <code class="w3-codespan">display:none</code> (like in the example above), the element will not take up any space.</p>
<p>To find out if an element is hidden with <code class="w3-codespan">visibility:hidden</code>, see the example below. This "hidden" element will take up space.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  function myFunction() {<br>&nbsp; var x = document.getElementById(&quot;myDIV&quot;);<br>&nbsp; 
  if (x.style.visibility = &quot;hidden&quot;) {<br>&nbsp;&nbsp;&nbsp; // Do something..<br>&nbsp; 
  }<br>}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_check_hidden2" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-note w3-panel">
<p><strong>Tip:</strong> Also check out <a href="howto_js_toggle_hide_show.asp">How To - Toggle Hide/Show</a>.</p>
</div>

<div class="w3-note w3-panel">
<p><strong>Tip:</strong> For more information about Display and Visibility, read our <a href="/css/css_display_visibility.asp">CSS Display Tutorial</a>.</p>
</div>
