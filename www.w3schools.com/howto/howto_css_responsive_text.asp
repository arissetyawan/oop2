...
<html lang="en-US">
<head>
<title>How To Create a Responsive Text</title>
<meta charset="utf-8">
...
<h1>How TO - Responsive Text</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_list_group.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_cutout_text.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create responsive typography with CSS.</p>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_text" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>
...
<div class="w3-code notranslate htmlHigh">
  &lt;h1 style=&quot;font-size:8vw;&quot;&gt;Hello World&lt;/h1&gt;<br>&lt;p 
  style=&quot;font-size:2vw;&quot;&gt;Resize the browser window to see how the font size 
  scales.&lt;/p&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>You could also use media queries to change the font size of an element on 
specific screen sizes:</p>
<div class="w3-light-grey w3-padding"><h1 class="fntzs">Variable Font Size.</h1></div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* If the screen size is 601px wide or 
  more, set the font-size of &lt;div&gt; to 80px */<br>@media screen and (min-width: 
  601px) {<br>&nbsp; div.example {<br>&nbsp;&nbsp;&nbsp; 
  font-size: 80px;<br>&nbsp; }<br>}<br><br>/* If the screen size is 600px wide or less, 
  set the font-size of &lt;div&gt; to 30px */<br>@media screen and (max-width: 600px) {<br>&nbsp; div.example {<br>&nbsp;&nbsp;&nbsp; 
  font-size: 30px;<br>&nbsp; }<br>}<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_responsive_text2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> <a href="/css/css_font.asp">Go to our CSS Font Tutorial</a> to learn more about fonts.</p>
