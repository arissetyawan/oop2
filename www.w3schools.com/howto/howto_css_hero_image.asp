...
<html lang="en-US">
<head>
<title>How To Create a Hero Image</title>
<meta charset="utf-8">
...
<h1>How TO - Hero Image</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_form_on_image.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_blurred_background.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a Hero Image with CSS.</p>
<hr>

<p>A Hero Image is a large image with text, often placed at the top of a webpage:</p>
<iframe src="tryhow_css_hero_image_ifr.htm" style="width:100%;border:none;height:400px;padding:3px 0 12px 0"></iframe>
<p style="margin-top:0"><a target="_blank" href="tryit.asp?filename=tryhow_css_hero_image" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Hero Image</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;hero-image&quot;&gt;<br>&nbsp; &lt;div class=&quot;hero-text&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;h1&gt;I am John Doe&lt;/h1&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;And I'm 
  a Photographer&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;button&gt;Hire me&lt;/button&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  body, html {<br>&nbsp;&nbsp;&nbsp; height: 100%;<br>}<br><br>/* The hero image 
  */<br>.hero-image {<br>&nbsp;&nbsp;&nbsp; /* Use &quot;linear-gradient&quot; to add a darken background effect 
  to the image (photographer.jpg). This will make the text 
  easier to read */<br>&nbsp;&nbsp;&nbsp; background-image: linear-gradient(rgba(0, 0, 0, 0.5), 
  rgba(0, 0, 0, 0.5)), url(&quot;photographer.jpg&quot;);<br><br>&nbsp;&nbsp;&nbsp; /* Set a specific height 
  */<br>&nbsp;&nbsp;&nbsp; height: 
  50%;<br><br>&nbsp;&nbsp;&nbsp; /* Position and center the image to scale 
  nicely on all screens */<br>&nbsp;&nbsp;&nbsp; background-position: center;<br>&nbsp;&nbsp;&nbsp; 
  background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; background-size: cover;<br>&nbsp;&nbsp;&nbsp; 
  position: relative;<br>
  }<br><br>/* Place text in the middle of the image */<br>
  .hero-text {<br>&nbsp;&nbsp;&nbsp; 
  text-align: center;<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
  top: 50%;<br>&nbsp;&nbsp;&nbsp; left: 50%;<br>&nbsp;&nbsp;&nbsp; transform: 
  translate(-50%, -50%);<br>&nbsp;&nbsp;&nbsp; color: white;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_hero_image" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
