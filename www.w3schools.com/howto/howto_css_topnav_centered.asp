...
<html lang="en-US">
<head>
<title>How To Create Centered Menu Links</title>
<meta charset="utf-8">
...
<h1>How TO - Centered Top Navigation</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_topnav_right.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_topnav_equal_width.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a navigation bar with a centered link/logo.</p>
<hr>
<h2>Centered Menu Link</h2>
...
<div class="extopnav">
  ...
  <a href="javascript:void(0)" class="w3-hide-small">Contact</a>
  
  <!-- Right-aligned links -->
  <div class="extopnav-right">
    <a href="javascript:void(0)" class="w3-hide-small">Search</a>
    <a href="javascript:void(0)">About</a>
  </div>
  
</div>

<p><a target="_blank" href="tryit.asp?filename=tryhow_css_topnav_centered" class="w3-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate htmlHigh">
  &lt;!-- Top navigation --&gt;<br>&lt;div class=&quot;topnav&quot;&gt;<br><br>&nbsp; &lt;!-- Centered 
  link --&gt;<br>&nbsp; &lt;div class=&quot;topnav-centered&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#home&quot; 
  class=&quot;active&quot;&gt;Home&lt;/a&gt;<br>&nbsp; &lt;/div&gt;<br><br>&nbsp; &lt;!-- Left-aligned links 
  (default) --&gt;<br>&nbsp; &lt;a href=&quot;#news&quot;&gt;News&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>
  <br>&nbsp; &lt;!-- Right-aligned links --&gt;<br>&nbsp; &lt;div class=&quot;topnav-right&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;a href=&quot;#search&quot;&gt;Search&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a href=&quot;#about&quot;&gt;About&lt;/a&gt;<br>&nbsp; 
  &lt;/div&gt;<br><br>&lt;/div&gt;</div>
</div>
<hr>
...
/* 
  ...
  <br>/* 
Style the links inside the navigation bar */<br>.topnav a {<br>&nbsp; float: 
  left;<br>&nbsp; color: #f2f2f2;<br>&nbsp; text-align: center;<br>&nbsp; 
  padding: 14px 16px;<br>&nbsp; text-decoration: none;<br>&nbsp; font-size: 
  17px;<br>}<br><br>/* Change the color of links on hover */<br>
  .topnav a:hover {<br>&nbsp; background-color: #ddd;<br>&nbsp; color: black;<br>
  }<br><br>/* Add 
  a color to the active/current link */<br>.topnav a.active {<br>&nbsp; 
  background-color: #4CAF50;<br>&nbsp; color: white;<br>}<br><br>/* Centered 
  section inside the top navigation */<br>.topnav-centered a {<br>&nbsp; float: 
  none;<br>&nbsp; position: absolute;<br>&nbsp; top: 50%;<br>&nbsp; left: 50%;<br>&nbsp; 
  transform: translate(-50%, -50%);<br>}<br><br>/* 
  Right-aligned section inside the top navigation */<br>.topnav-right {<br>&nbsp; 
  float: right;<br>}<br><br>/* Responsive navigation menu - display links on top 
  of each other instead of next to each other (for mobile devices) */<br>@media 
  screen and (max-width: 600px) {<br>&nbsp; .topnav a, .topnav-right {<br>&nbsp;&nbsp;&nbsp; 
  float: none;<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp; }<br><br>&nbsp; .topnav-centered 
  a {<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; 
  left: 0;<br>&nbsp;&nbsp;&nbsp; transform: none;<br>&nbsp; }<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_topnav_centered" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
