...
<html lang="en-US">
<head>
<title>How To Add an Input Field in Navbar</title>
<style>
.topnav3 {
  overflow: hidden;
...
<h1>How TO - Input Field in a Menu</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_fullscreen_search.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_login_form_navbar.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a navigation menu with an input field inside of it.</p>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_input_navbar" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Add an Input Field in Navbar</h2>
...
<div class="w3-code notranslate htmlHigh">
  ...
  &lt;div class=&quot;search-container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;form action=&quot;/action_page.php&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;input type=&quot;text&quot; placeholder=&quot;Search..&quot; name=&quot;search&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;button type=&quot;submit&quot;&gt;Submit&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/form&gt;<br>&nbsp; 
  &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box;}<br><br>/* Style the navbar */<br>.topnav {<br>&nbsp; overflow: hidden;<br>&nbsp; 
  ...
  .search-container {<br>&nbsp; float: right;<br>}<br><br>/* Style the input 
  field inside the navbar */<br>.topnav input[type=text] {<br>&nbsp; 
  padding: 6px;<br>&nbsp; margin-top: 8px;<br>&nbsp; font-size: 17px;<br>&nbsp; 
  border: none;<br>}<br>
  <br>/* Style the button inside the input container */<br>.topnav .search-container button {<br>&nbsp; float: right;<br>&nbsp; 
  ...
  .search-container button:hover {<br>&nbsp; background: #ccc;<br>}<br><br>/* 
  Add responsiveness - On small screens, display the navbar vertically instead 
  of horizontally */<br>@media 
  screen and (max-width: 600px) {<br>&nbsp; .topnav .search-container {<br>&nbsp;&nbsp;&nbsp; 
  float: none;<br>&nbsp; }<br>&nbsp; .topnav a, .topnav input[type=text], .topnav 
  .search-container button {<br>&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp;&nbsp;&nbsp; 
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_input_navbar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
