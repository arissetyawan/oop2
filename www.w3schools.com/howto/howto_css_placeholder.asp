...
<html lang="en-US">
<head>
<title>How To Change Input Placeholder Color</title>
<meta charset="utf-8">
...
<style>
.x::placeholder { /* WebKit, Blink, Edge */
    color: red;
   opacity: 1;
}
.x::-webkit-input-placeholder { /* WebKit, Blink, Edge */
    color: red;
}
.x:-moz-placeholder { /* Mozilla Firefox 4 to 18 */
   color:  red;
   opacity: 1;
}
.x::-moz-placeholder { /* Mozilla Firefox 19+ */
   color: red;
   opacity: 1;
}
.x:-ms-input-placeholder { /* Internet Explorer 10-11 */
   color: red;
}
.x::-ms-input-placeholder { /* Microsoft Edge */
   color: red;
}</style>
</head>
<body>
...
<h1>How TO - Change Placeholder Color</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_devices.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_text_selection.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to change the color of the placeholder attribute with CSS.</p>
<hr>
<h2>Placeholder Color</h2>
<input class="w3-input w3-border w3-section x" type="text" placeholder="A red placeholder text..">
<a target="_blank" href="tryit.asp?filename=tryhow_css_placeholder" class="w3-btn">Try it Yourself &raquo;</a>
<hr>
<h5>Step 1) Add HTML:</h5>
<p>Use an input element and add the placeholder attribute:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;input type=&quot;text&quot; placeholder=&quot;A red placeholder text..&quot;&gt;</div>
</div>

<h5>Step 2) Add CSS:</h5>
<p>In most browsers, the placeholder text is grey. To change this, style the placeholder with the non-standard <code class="w3-codespan">::placeholder</code> selector. Note that Firefox adds a lower opacity to the placeholder, so we use <code class="w3-codespan">opacity:</code> 1 to fix this.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  ::placeholder { 
  /* Chrome, Firefox, Opera, Safari 10.1+ */<br>&nbsp;&nbsp;&nbsp; color: red;<br>&nbsp;&nbsp;&nbsp; 
  opacity: 1; /* Firefox */<br>}<br><br>:-ms-input-placeholder { /* Internet 
  Explorer 10-11 */<br>&nbsp;&nbsp;&nbsp; color: red;<br>}<br><br>::-ms-input-placeholder 
  { /* Microsoft Edge */<br>&nbsp;&nbsp;&nbsp; color: red;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_placeholder" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Read more about the ::placeholder selector in our CSS Reference: <a href="/cssref/sel_placeholder.asp">CSS ::placeholder Property</a>.</p>
<br>
