...
<html lang="en-US">
<head>
<title>How To - Aspect Ratio / Height Equal to Width</title>
<meta charset="utf-8">
...
<h1>How TO - Aspect Ratio</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_parallax.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_toggle_like.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to maintain the aspect ratio of an element with CSS.</p>
<hr>

<h2>Aspect Ratio</h2>
<p>Create flexible elements that keep their aspect ratio (4:3, 16:9, etc.) when resized:</p>
<img src="aspect_ratio.png" style="max-width:100%;display:block;margin:auto">

<div class="w3-panel w3-note">
<p><strong>What is aspect ratio?</strong> <br><br>The aspect ratio of an element 
...
<h2>How To - Height Equal to Width</h2>
<h5>Step 1) Add HTML:</h5>
<p>Use a container element, like &lt;div&gt;, and if you want text inside of it, add a 
child element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;div class=&quot;container&quot;&gt; <br>&nbsp; &lt;div class=&quot;text&quot;&gt;Some text&lt;/div&gt; &lt;!-- If 
you want text inside the container --&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<p>Add a percentage value for <code class="w3-codespan">padding-top</code> to maintain the aspect ratio of the 
DIV. The following example will create an aspect ratio of 1:1 (the height and 
width is always equal):</p>

<div class="w3-example">
<h3>Example 1:1 Aspect Ratio</h3>
<div class="w3-code notranslate cssHigh">
.container {<br>&nbsp;&nbsp;&nbsp; background-color: red;<br>&nbsp;&nbsp;&nbsp; 
width: 100%;<br>&nbsp;&nbsp;&nbsp; padding-top: 100%; /* <strong>1:1 Aspect 
Ratio</strong> */<br>&nbsp;&nbsp;&nbsp; position: relative; /* If you want 
text inside of it */<br>}<br><br>/* If you 
want text inside of the container */<br>.text {<br>&nbsp;&nbsp;&nbsp; 
position: absolute;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; 
left: 0;<br>&nbsp;&nbsp;&nbsp; bottom: 0;<br>&nbsp;&nbsp;&nbsp; right: 0;<br>
}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_aspect_ratio" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>Other aspect ratios:</p>

<div class="w3-example">
<h3>Example 16:9 Aspect Ratio</h3>
<div class="w3-code notranslate cssHigh">
.container {<br>&nbsp;&nbsp;&nbsp; padding-top: 56.25%; /* <strong>
16:9 Aspect 
Ratio</strong> */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_aspect_ratio_169" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example 4:3 Aspect Ratio</h3>
<div class="w3-code notranslate cssHigh">
.container {<br>&nbsp;&nbsp;&nbsp; padding-top: 75%; /* <strong>
4:3 Aspect 
Ratio</strong> */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_aspect_ratio_43" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example 3:2 Aspect Ratio</h3>
<div class="w3-code notranslate cssHigh">
.container {<br>&nbsp;&nbsp;&nbsp; padding-top: 66.66%; /* <strong>
3:2 Aspect 
Ratio</strong> */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_aspect_ratio_32" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example 8:5 Aspect Ratio</h3>
<div class="w3-code notranslate cssHigh">
.container {<br>&nbsp;&nbsp;&nbsp; padding-top: 62.5%; /* <strong>
8:5 Aspect 
Ratio</strong> */<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_aspect_ratio_85" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
