...
<html lang="en-US">
<head>
<title>How To Create a Temperature Converter With HTML and JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - Temperature Converter</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_weight_converter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_length_converter.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a temperature converter with HTML and JavaScript.</p>
<hr>
...
<hr>
<h2>Create a Temperature Converter</h2>
<p>Create an input element that can convert a value from one temperature measurement to another.</p>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example - Fahrenheit to Celcius</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;p&gt;<br>&nbsp; &lt;label&gt;Fahrenheit&lt;/label&gt;<br>&nbsp; &lt;input id="inputFahrenheit" type="number" placeholder="Fahrenheit"<br>&nbsp; oninput="temperatureConverter(this.value)"<br>&nbsp; onchange="temperatureConverter(this.value)"&gt;<br>
 &lt;/p&gt;<br>
 &lt;p&gt;Celsius: &lt;span id="outputCelsius"&gt;&lt;/span&gt;&lt;/p&gt;</div>
</div>
...
/* When the input field receives input, convert the value from fahrenheit to celsius */<br>
 function temperatureConverter(valNum) {<br>&nbsp; valNum = parseFloat(valNum);<br>&nbsp; document.getElementById("outputCelsius").innerHTML = (valNum-32) / 1.8;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_temp_converter_fahrenheit_to_celsius" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Convert from Fahrenheit to other Measurements</h2>
<p>The table below shows how to convert from Fahrenheit to other temperature 
measurements:</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>&#8451;=(&#8457;-32)/1.8</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_temp_converter_fahrenheit_to_celsius">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Fahrenheit to Kelvin</td>
    <td>K=((&#8457;-32)/1.8)+273.15</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_temp_converter_fahrenheit_to_kelvin">Try it</a></td>
  </tr>
...
<h2>Convert from Celsius to other Measurements</h2>
<p>The table below shows how to convert from Celsius to other temperature 
measurements:</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>&#8457;=(&#8451;*1.8)+32</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_temp_converter_celsius_to_fahrenheit">Try it</a></td>
  </tr>
  <tr>
    <td>Convert from Celsius to Kelvin</td>
    <td>K=&#8451;+273.15</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_temp_converter_celsius_to_kelvin">Try it</a></td>
  </tr>
...
<h2>Convert from Kelvin to other Measurements</h2>
<p>The table below shows how to convert from Kelvin to other temperature 
measurements:</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_temp_converter_kelvin_to_fahrenheit">Try it</a></td>
    </tr>
  <tr>
    <td>Convert from Kelvin to Celsius</td>
    <td>&#8451;=K-273.15</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=tryhow_js_temp_converter_kelvin_to_celsius">Try it</a></td>
  </tr>
