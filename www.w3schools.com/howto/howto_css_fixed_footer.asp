...
<html lang="en-US">
<head>
<title>How To Create a Fixed Footer</title>
<meta charset="utf-8">
...
<h1>How TO - Fixed Footer</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_glowing_text.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_sticky_element.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a fixed/sticky footer with CSS.</p>
<hr>

<iframe src="tryhow_css_fixed_footer.htm" style="width:100%;height:300px;border:1px solid #999"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_css_fixed_footer" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Create a Fixed Footer</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;style&gt;<br>.footer {<br>&nbsp;&nbsp;&nbsp; position: fixed;<br>&nbsp;&nbsp;&nbsp; left: 
  0;<br>&nbsp;&nbsp;&nbsp; bottom: 0;<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; 
  background-color: red;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
  text-align: center;<br>}<br>&lt;/style&gt;<br><br>&lt;div class="footer"&gt;<br>&nbsp; &lt;p&gt;Footer&lt;/p&gt;<br>
  &lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_fixed_footer" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
