...
<title>How To Create a Smooth Scrolling Effect</title>
<meta charset="utf-8">
...
<h1>How TO - Smooth Scroll</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_scrolldrawing.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_bg_gradient_scroll.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a smooth scrolling effect with CSS.</p>
<hr>
<h2>Smooth Scrolling</h2>
<p><strong>Note:</strong> This example does not work in Internet Explorer, Edge or Safari (for a "cross-browser" solution, see example below).</p>
<div class="main w3-red" id="section1">
  <h2>Section 1</h2>
  <p>Click on the link to see the "smooth" scrolling effect.</p>
  <a href="#section2" class="w3-button w3-light-grey">Click Me to Smooth Scroll to Section 2 Below</a>
  <p>Note: Remove the scroll-behavior property to remove smooth scrolling.</p>
</div>

<div class="main w3-yellow" id="section2">
  <h2>Section 2</h2>
  <a href="#section1" class="w3-button w3-light-grey">Click Me to Smooth Scroll to Section 1 Above</a>
</div><hr>

<h2>Smooth Scrolling</h2>
<p>Add <code class="w3-codespan">scroll-behavior: smooth</code> to the &lt;html&gt; element to enable smooth scrolling for the whole page (note: it is also possible to add it to a specific element/scroll container):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  html {<br>&nbsp; scroll-behavior: smooth;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_smooth_scroll" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the scroll-behavior property.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">scroll-behavior</td>
    <td>61.0</td>
...
<p>For browsers that do not support the <code class="w3-codespan">scroll-behavior</code> property, you could use JavaScript or a JavaScript library, like <a href="/jquery/default.asp">jQuery</a>, to create a solution that will work for all browsers:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;script src=&quot;https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js&quot;&gt;&lt;/script&gt;<br>
  &lt;script&gt;<br>$(document).ready(function(){<br>&nbsp; // Add smooth scrolling to all 
  links<br>&nbsp; $(&quot;a&quot;).on('click', function(event) {<br><br>&nbsp;&nbsp;&nbsp; // Make sure this.hash 
  has a value before overriding default behavior<br>&nbsp;&nbsp;&nbsp; if (this.hash !== &quot;&quot;) {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  // Prevent default anchor click behavior<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; event.preventDefault();<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // 
  Store hash<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var hash = this.hash;<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Using jQuery's animate() method 
  to add smooth page scroll<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // The optional number (800) specifies the number 
  of milliseconds it takes to scroll to the specified area<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $('html, 
  body').animate({<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; scrollTop: $(hash).offset().top<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }, 800, function(){<br>
  <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // Add hash (#) to URL when done scrolling (default click behavior)<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  window.location.hash = hash;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; });<br>&nbsp;&nbsp;&nbsp; } // End if<br>&nbsp; });<br>});<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_smooth_scroll_jquery" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Read more about the scroll-behavior property in our CSS Reference: <a href="/cssref/pr_scroll-behavior.asp">CSS scroll-behavior Property</a>.</p>
