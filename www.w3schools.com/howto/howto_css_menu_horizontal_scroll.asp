...
<html lang="en-US">
<head>
<title>How To Create a Horizontal Scrolling Menu</title>
<meta charset="utf-8">
...
<h1>How TO - Horizontal Scroll Menu</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_sidebar_icons.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_vertical_menu.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a horizontal scrollable menu with CSS.</p>
<hr>
...
<p style="max-width:500px;margin:16px auto;"><a target="_blank" href="tryit.asp?filename=tryhow_css_menu_hor_scroll" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Horizontal Scrollable Menu</h2>
...
<p>The trick to make the navbar scrollable is by using <code class="w3-codespan">overflow:auto</code> and <code class="w3-codespan">white-space: nowrap</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
div.scrollmenu {<br>&nbsp;&nbsp;&nbsp; background-color: #333;<br>&nbsp;&nbsp;&nbsp; 
overflow: auto;<br>&nbsp;&nbsp;&nbsp; white-space: nowrap;<br>}<br><br>div.scrollmenu a {<br>&nbsp;&nbsp;&nbsp; display: inline-block;<br>&nbsp;&nbsp;&nbsp; 
color: white;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>&nbsp;&nbsp;&nbsp; 
padding: 14px;<br>&nbsp;&nbsp;&nbsp; text-decoration: none;<br>}<br><br>
div.scrollmenu a:hover {<br>&nbsp;&nbsp;&nbsp; background-color: #777;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_menu_hor_scroll" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
