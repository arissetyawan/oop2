...
<html lang="en-US">
<head>
<title>How To Change The Browser To Fullscreen with JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - Fullscreen</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_snackbar.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_scrolldrawing.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to make a fullscreen window with JavaScript.</p>
<hr>
<h2>Fullscreen Window</h2>
<p>How to use JavaScript to view an element in fullscreen mode.</p>

<div class="w3-light-grey w3-padding w3-padding-16">
<p style="margin-top:0px">Click on the button to open the video in fullscreen mode:</p>
<video width="320" controls id="myvideo">
  <source src="rain.mp4" type="video/mp4">
  <source src="rain.ogg" type="video/ogg">
  Your browser does not support the video tag.
</video><br><br>
<button onclick="openFullscreen();" class="w3-button w3-dark-grey" style="margin-bottom:8px">Open Video in Fullscreen</button>
</div>
<script>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_fullscreen" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>Fullscreen Video</h2>
<p>To open an element in fullscreen, we use the <code class="w3-codespan"><em>element</em>.requestFullscreen()</code> 
method:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script&gt;<br>/* Get the element you want displayed in fullscreen mode (a 
  video in this example): */<br>var elem = document.getElementById("myvideo");
  <br><br>/* When the openFullscreen() function is executed, open the video in 
  fullscreen.<br>Note that we must include prefixes for different browsers, as 
  they don't support the requestFullscreen method yet */<br>function openFullscreen() {<br>&nbsp; if (elem.requestFullscreen) {<br>&nbsp;&nbsp;&nbsp; 
  elem.requestFullscreen();<br>&nbsp; } else if (elem.mozRequestFullScreen) { /* 
  Firefox */<br>&nbsp;&nbsp;&nbsp; elem.mozRequestFullScreen();<br>&nbsp; } else 
  if (elem.webkitRequestFullscreen) { /* Chrome, Safari and Opera */<br>&nbsp;&nbsp;&nbsp; 
  elem.webkitRequestFullscreen();<br>&nbsp; } else if (elem.msRequestFullscreen) 
  { /* IE/Edge */<br>&nbsp;&nbsp;&nbsp; elem.msRequestFullscreen();<br>&nbsp; }<br>
  }<br>
&lt;/script&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_fullscreen" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Fullscreen Document</h2>
<p>To open the whole page in fullscreen, use the <code class="w3-codespan">document.documentElement</code> instead of <code class="w3-codespan">document.getElementById("<em>element</em>")</code>. 
In this example, we also use a close function to close the fullscreen:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;script&gt;<br>/* Get the documentElement (&lt;html&gt;) to display the page in fullscreen */<br>
  var elem = document.documentElement;<br><br>/* View in fullscreen */<br>function openFullscreen() {<br>&nbsp; 
  if (elem.requestFullscreen) {<br>&nbsp;&nbsp;&nbsp; elem.requestFullscreen();<br>&nbsp; 
  } else if (elem.mozRequestFullScreen) { /* Firefox */<br>&nbsp;&nbsp;&nbsp; 
  elem.mozRequestFullScreen();<br>&nbsp; } else if (elem.webkitRequestFullscreen) 
  { /* Chrome, Safari and Opera */<br>&nbsp;&nbsp;&nbsp; elem.webkitRequestFullscreen();<br>&nbsp; } else if (elem.msRequestFullscreen) 
  { /* IE/Edge */<br>&nbsp;&nbsp;&nbsp; elem.msRequestFullscreen();<br>&nbsp; }<br>}<br><br>/* 
  Close fullscreen */<br>function closeFullscreen() {<br>&nbsp; 
  if (document.exitFullscreen) {<br>&nbsp;&nbsp;&nbsp; document.exitFullscreen();<br>&nbsp; 
  } else if (document.mozCancelFullScreen) { /* Firefox */<br>&nbsp;&nbsp;&nbsp; 
  document.mozCancelFullScreen();<br>&nbsp; } else if (document.webkitExitFullscreen) 
  { /* Chrome, Safari and Opera */<br>&nbsp;&nbsp;&nbsp; document.webkitExitFullscreen();<br>&nbsp; 
  } else if (document.msExitFullscreen) { /* IE/Edge */<br>&nbsp;&nbsp;&nbsp; 
  document.msExitFullscreen();<br>&nbsp; }<br>}<br>
&lt;/script&gt;<br></div>
</div>
<p>You can also use CSS to style the page when it is in fullscreen mode:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  /* Chrome, Safari and Opera syntax */<br>:-webkit-full-screen {<br>&nbsp; 
  background-color: yellow;<br>}<br><br>/* Firefox syntax */<br>:-moz-full-screen {<br>&nbsp; 
  background-color: yellow;<br>}<br><br>/* IE/Edge syntax */<br>:-ms-fullscreen {<br>&nbsp; 
  background-color: yellow;<br>}<br><br>/* Standard syntax */<br>:fullscreen {<br>&nbsp; 
  background-color: yellow;<br>}<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_fullscreen2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>HTML DOM Reference: <a href="/jsref/met_element_requestfullscreen.asp">The requestFullscreen() method</a>.</p>
<p>HTML DOM Reference: <a href="/jsref/met_element_exitfullscreen.asp">The exitFullscreen() method</a>.</p>
<p>HTML DOM Reference: <a href="/jsref/prop_document_documentelement.asp">The documentElement property</a>.</p>
