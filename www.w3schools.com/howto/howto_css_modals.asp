...
<html lang="en-US">
<head>
<title>How To Make a Modal Box With CSS and JavaScript</title>
<meta charset="utf-8">
...
<h1>How TO - CSS/JS Modal</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_fullscreen_video.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_timeline.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a Modal Box with CSS and JavaScript.</p>
<hr>
<h2>How To Create a Modal Box</h2>

<p>A modal is a dialog box/popup window that is displayed on top of the current page:</p>

<button onclick="document.getElementById('id01').style.display='block'" class="w3-btn w3-dark-grey" style="font-size:17px;padding:12px 35px">Open Modal</button>
...
<p></p>
<a target="_blank" href="tryit.asp?filename=tryhow_css_modal" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
<hr>
...
&lt;!-- Trigger/Open The Modal --&gt;<br>&lt;button id="myBtn"&gt;Open Modal&lt;/button&gt;<br><br>&lt;!-- 
The Modal --&gt;<br>&lt;div id="myModal" class="modal"&gt;<br><br>&nbsp; &lt;!-- Modal 
content --&gt;<br>&nbsp; &lt;div class="modal-content"&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;span class="close"&gt;&amp;times;&lt;/span&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Some text in the 
Modal..&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br><br>&lt;/div&gt;</div>
</div>
<!--
...
<p>The &lt;div&gt; with <code class="w3-codespan">class="modal"</code> is a container element for the modal and 
the div with <code class="w3-codespan">class="modal-content"</code> is where you put your modal content 
(headings, paragraphs, images, etc).</p>
<p>The &lt;span&gt; element with <code class="w3-codespan">class="close"</code> should be used to close the modal.</p>
-->
<hr>
...
/* The Modal (background) */<br>.modal {<br>&nbsp;&nbsp;&nbsp; display: none; 
/* Hidden by default */<br>&nbsp;&nbsp;&nbsp; position: fixed; /* Stay in 
place */<br>&nbsp;&nbsp;&nbsp; z-index: 1; /* Sit on top */<br>&nbsp;&nbsp;&nbsp; 
left: 0;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; width: 100%; /* 
Full width */<br>&nbsp;&nbsp;&nbsp; 
height: 100%; /* Full height */<br>&nbsp;&nbsp;&nbsp; overflow: auto; /* 
Enable scroll if needed */<br>&nbsp;&nbsp;&nbsp; 
background-color: rgb(0,0,0); /* Fallback color */<br>&nbsp;&nbsp;&nbsp; background-color: rgba(0,0,0,0.4); 
/* Black w/ opacity */<br>
}<br>
<br>/* Modal Content/Box */<br>.modal-content {<br>&nbsp;&nbsp;&nbsp; 
background-color: #fefefe;<br>&nbsp;&nbsp;&nbsp; margin: 15% auto; /* 15% 
from the top and centered */<br>&nbsp;&nbsp;&nbsp; 
padding: 20px;<br>&nbsp;&nbsp;&nbsp; border: 1px 
solid #888;<br>&nbsp;&nbsp;&nbsp; width: 80%; /* Could be more or less, 
depending on screen size */<br>}<br>
<br>/* The Close Button */<br>
.close {<br>&nbsp;&nbsp;&nbsp; color: #aaa;<br>&nbsp;&nbsp;&nbsp; float: right;<br>&nbsp;&nbsp;&nbsp; 
font-size: 28px;<br>&nbsp;&nbsp;&nbsp; font-weight: bold;<br>}<br><br>
.close:hover,<br>
.close:focus {<br>&nbsp;&nbsp;&nbsp; color: black;<br>&nbsp;&nbsp;&nbsp; 
text-decoration: none;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>}</div>
</div>
<!--
<h3>Example Explained</h3>
<p><strong>The <code class="w3-codespan">.modal</code> class</strong></p>
<p>The <code class="w3-codespan">.modal</code> class represents the window BEHIND the actual modal box. The 
...
cover this later).</p>
<p><strong>The <code class="w3-codespan">.modal-content</code> class</strong></p>
...
<code class="w3-codespan">margin: 15% auto</code> is used to push the modal box down from the top (15%) and 
centering it (auto).</p>
<p>We also set the width to 400px - this could be more or less, depending on 
screen size. We 
will cover this later.</p>
<p><strong>The <code class="w3-codespan">.close</code> class</strong></p>
...
// Get the button that opens the modal<br>var btn = document.getElementById("myBtn");<br>
<br>// Get the &lt;span&gt; element that closes the modal<br>var span = 
document.getElementsByClassName("close")[0];<br><br>// When the user clicks 
on the button, open the modal <br>btn.onclick = function() {<br>&nbsp;&nbsp;&nbsp; modal.style.display = "block";<br>}<br><br>// 
When the user clicks on &lt;span&gt; (x), close the modal<br>span.onclick = 
function() {<br>&nbsp;&nbsp;&nbsp; 
modal.style.display = "none";<br>}<br><br>// When the user clicks anywhere 
outside of the modal, close it<br>window.onclick = function(event) {<br>&nbsp;&nbsp;&nbsp; 
if (event.target == modal) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
modal.style.display = "none";<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_modal" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Add a class for modal-header, modal-body and modal-footer:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;!-- Modal content --&gt;<br>&lt;div class="modal-content"&gt;<br>&nbsp; &lt;div 
class="modal-header"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;span class="close"&gt;&amp;times;&lt;/span&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;h2&gt;Modal Header&lt;/h2&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div class="modal-body"&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;p&gt;Some text in the Modal Body&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Some other 
text...&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div class="modal-footer"&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;h3&gt;Modal Footer&lt;/h3&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>

<p>Style the modal header, body and footer, and add animation (slide in the modal):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
/* Modal Header */<br>.modal-header {<br>&nbsp;&nbsp;&nbsp; padding: 2px 16px;<br>&nbsp;&nbsp;&nbsp; 
background-color: #5cb85c;<br>&nbsp;&nbsp;&nbsp; color: white;<br>}<br><br>
/* Modal Body */<br>
.modal-body {padding: 2px 16px;}<br><br>/* Modal Footer */<br>.modal-footer {<br>&nbsp;&nbsp;&nbsp; 
padding: 2px 16px;<br>&nbsp;&nbsp;&nbsp; background-color: #5cb85c;<br>&nbsp;&nbsp;&nbsp; 
color: white;<br>}<br><br>/* Modal Content */<br>.modal-content {<br>&nbsp;&nbsp;&nbsp; 
position: relative;<br>&nbsp;&nbsp;&nbsp; background-color: #fefefe;<br>&nbsp;&nbsp;&nbsp; 
margin: auto;<br>&nbsp;&nbsp;&nbsp; padding: 0;<br>&nbsp;&nbsp;&nbsp; 
border: 1px solid #888;<br>&nbsp;&nbsp;&nbsp; width: 80%;<br>&nbsp;&nbsp;&nbsp; 
box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19);<br>&nbsp;&nbsp;&nbsp; animation-name: animatetop;<br>&nbsp;&nbsp;&nbsp; 
animation-duration: 0.4s<br>}<br><br>/* Add Animation */<br>@keyframes animatetop {<br>&nbsp;&nbsp;&nbsp; 
from {top: -300px; opacity: 0}<br>&nbsp;&nbsp;&nbsp; to {top: 0; opacity: 1}<br>
}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_modal2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Bottom Modal ("Bottom sheets")</h2>
<p>An example on how to create a full-width modal that slides in from the bottom:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-white">
<iframe src="tryhow_css_modal_bottom_ifr.htm" style="width:100%;height:600px;border:none;margin-bottom:-5px;"></iframe></div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_modal_bottom" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Also check out <a href="howto_css_modal_images.asp">Modal Images</a> and <a href="howto_js_lightbox.asp">Lightbox</a>.</p>
<br>
