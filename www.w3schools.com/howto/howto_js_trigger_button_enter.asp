...
<title>How To Trigger Button Click on Enter</title>
<meta charset="utf-8">
...
<h1>How TO - Trigger Button Click on Enter</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_detect_capslock.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_password_validation.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Trigger a button click on keyboard "enter" with JavaScript.</p>
<hr>

<h2>Trigger a Button Click on Enter</h2>
...
<div class="w3-code notranslate jsHigh">
  ...
  <br>// Execute a function when the user releases a key on the keyboard<br>input.addEventListener(&quot;keyup&quot;, 
  function(event) {<br>&nbsp; // Cancel the default action, if needed<br>&nbsp; event.preventDefault();<br>&nbsp; 
  // Number 13 is the &quot;Enter&quot; key on the keyboard<br>&nbsp; if (event.keyCode === 
  13) {<br>&nbsp;&nbsp;&nbsp; // Trigger the button element with a click<br>&nbsp;&nbsp;&nbsp; document.getElementById(&quot;myBtn&quot;).click();<br>&nbsp; 
  }<br>});</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_trigger_button_enter" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> Learn more about the <a href="/jsref/event_key_keycode.asp">event.keyCode</a> property in our JavaScript Reference.</p>
