...
<html lang="en-US">
<head>
<title>How To Create Arrows/Triangles with CSS</title>
<meta charset="utf-8">
...
<h1>How TO - CSS Arrows</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_transition_hover.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_shapes.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create arrows/triangles with CSS.</p>
<hr>
...
<h2>How To Create Arrows</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;p&gt;Right arrow: &lt;i class=&quot;arrow right&quot;&gt;&lt;/i&gt;&lt;/p&gt;<br>&lt;p&gt;Left arrow: &lt;i 
  class=&quot;arrow left&quot;&gt;&lt;/i&gt;&lt;/p&gt;<br>&lt;p&gt;Up arrow: &lt;i class=&quot;arrow up&quot;&gt;&lt;/i&gt;&lt;/p&gt;<br>
  &lt;p&gt;Down arrow: &lt;i class=&quot;arrow down&quot;&gt;&lt;/i&gt;&lt;/p&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  i {<br>&nbsp;&nbsp;&nbsp; border: solid black;<br>&nbsp;&nbsp;&nbsp; 
  border-width: 0 3px 3px 0;<br>&nbsp;&nbsp;&nbsp; display: inline-block;<br>&nbsp;&nbsp;&nbsp; 
  padding: 3px;<br>}<br><br>.right {<br>&nbsp;&nbsp;&nbsp; 
  transform: rotate(-45deg);<br>&nbsp;&nbsp;&nbsp; -webkit-transform: 
  rotate(-45deg);<br>}<br><br>.left {<br>&nbsp;&nbsp;&nbsp; 
  transform: rotate(135deg);<br>&nbsp;&nbsp;&nbsp; -webkit-transform: 
  rotate(135deg);<br>}<br><br>
  .up {<br>&nbsp;&nbsp;&nbsp; transform: rotate(-135deg);<br>&nbsp;&nbsp;&nbsp; 
  -webkit-transform: rotate(-135deg);<br>}<br><br>.down {<br>&nbsp;&nbsp;&nbsp; transform: rotate(45deg);<br>&nbsp;&nbsp;&nbsp; 
  -webkit-transform: rotate(45deg);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_arrows" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
