...
<html lang="en-US">
<head>
<title>How To Sort a Table</title>
<meta charset="utf-8">
...
<h1>How TO - Sort a Table</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_sort_list.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_table_zebra.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to sort an HTML table, using JavaScript.</p>
<hr>

<p>Click the button to sort the table alphabetically, based on customer name:</p>
<button class="w3-btn w3-dark-grey" onclick="sortTable()">Sort</button>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_sort_table" class="w3-btn">Try it Yourself &raquo;</a></p>
...
<div class="w3-code notranslate jsHigh">
  function sortTable() {<br>&nbsp; var table, rows, switching, i, x, y, 
  shouldSwitch;<br>&nbsp; table = document.getElementById(&quot;myTable&quot;);<br>&nbsp; 
  switching = true;<br>&nbsp; /* Make a loop that will continue until<br>&nbsp; 
  no switching has been done: */<br>&nbsp; while (switching) {<br>&nbsp;&nbsp;&nbsp; 
  // Start by saying: no switching is done:<br>&nbsp;&nbsp;&nbsp; switching = 
  false;<br>&nbsp;&nbsp;&nbsp; rows = table.rows;<br>&nbsp;&nbsp;&nbsp; 
  /* Loop through all table rows (except the<br>&nbsp;&nbsp;&nbsp; first, which 
  contains table headers): */<br>&nbsp;&nbsp;&nbsp; for (i = 1; i &lt; (rows.length 
  ...
  x = rows[i].getElementsByTagName(&quot;TD&quot;)[0];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; y 
  = rows[i + 1].getElementsByTagName(&quot;TD&quot;)[0];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  switching = true;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}<br></div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_sort_table" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<table class="w3-table-all w3-margin-top" id="myTable2">
  <tr>
    <th onclick="sortTable2(0)" style="cursor:pointer" id="nameClick">Name</th>
    <th onclick="sortTable2(1)" style="cursor:pointer" id="countryClick">Country</th>
  </tr>
  <tr>
    <td>Berglunds snabbkop</td>
    <td>Sweden</td>
...
<div class="w3-code notranslate htmlHigh">
  &lt;table id=&quot;myTable2&quot;&gt;<br>&lt;tr&gt;<br>&lt;!--When a header is clicked, run the 
  sortTable function, with a parameter,<br>0 for sorting by names, 1 for sorting 
  by country: --&gt;<br>&lt;th onclick=&quot;sortTable(0)&quot;&gt;Name&lt;/th&gt;<br>&lt;th onclick=&quot;sortTable(1)&quot;&gt;Country&lt;/th&gt;<br>
  &lt;/tr&gt;<br>...<br><br>&lt;script&gt;<br>function sortTable(n) {<br>&nbsp; var table, 
  rows, switching, i, x, y, shouldSwitch, dir, switchcount = 0;<br>&nbsp; table 
  = document.getElementById(&quot;myTable2&quot;);<br>&nbsp; switching = true;<br>&nbsp; 
  // Set the sorting direction to ascending:<br>&nbsp; dir = &quot;asc&quot;; <br>&nbsp; 
  /* Make a loop that will continue until<br>&nbsp; no switching has been done: */<br>&nbsp; 
  while (switching) {<br>&nbsp;&nbsp;&nbsp; // Start by saying: no switching is 
  done:<br>&nbsp;&nbsp;&nbsp; switching = false;<br>&nbsp;&nbsp;&nbsp; rows = 
  table.rows;<br>&nbsp;&nbsp;&nbsp; /* Loop through all 
  table rows (except the<br>&nbsp;&nbsp;&nbsp; first, which contains table 
  headers): */<br>&nbsp;&nbsp;&nbsp; for (i = 1; i &lt; (rows.length - 1); i++) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // Start by saying there should be no switching:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  shouldSwitch = false;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /* Get the two elements 
  you want to compare,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; one from current row 
  and one from the next: */<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x = rows[i].getElementsByTagName(&quot;TD&quot;)[n];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  y = rows[i + 1].getElementsByTagName(&quot;TD&quot;)[n];<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  /* Check if the two rows should switch place,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  based on the direction, asc or desc: */<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (dir 
  == &quot;asc&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (x.innerHTML.toLowerCase() 
  &gt; y.innerHTML.toLowerCase()) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // If so, mark as a switch and break the loop:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  shouldSwitch = true;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  break;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  } else if (dir == &quot;desc&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (x.innerHTML.toLowerCase() 
  &lt; y.innerHTML.toLowerCase()) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  // If so, mark as a switch and break the loop:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  shouldSwitch = true;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  break;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  done, increase this count by 1:<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; switchcount 
  ++; <br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; /* If no 
  ...
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_sort_table_desc" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Sort Table Numerically</h2>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
  if (Number(x.innerHTML) &gt; Number(y.innerHTML)) {<br>&nbsp; shouldSwitch = true;<br>&nbsp;&nbsp;break;<br>}<br></div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhow_js_sort_table_number" target="_blank">Try it Yourself &raquo;</a>
</div>
