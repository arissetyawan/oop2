...
<h1>How TO - Image Overlay Title</h1>
<div class="w3-clear nextprev">
	<a class="w3-left w3-btn" href="howto_css_image_overlay_zoom.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_image_overlay_icon.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create an image overlay title on hover.</p>
<hr>
...
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_title" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<hr>

<h2>How To Create an Overlay Image Title</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;container&quot;&gt;<br>&nbsp; &lt;img src=&quot;img_avatar.png&quot; alt=&quot;Avatar&quot; 
  class=&quot;image&quot;&gt;<br>&nbsp; &lt;div class=&quot;overlay&quot;&gt;My Name is John&lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box}<br><br>/* Container 
  needed to position the overlay. Adjust the width as needed */<br>.container {<br>&nbsp; position: relative;<br>&nbsp; width: 
  50%;<br>&nbsp; max-width: 300px;<br>}<br>
  <br>/* Make the image to responsive */<br>.image {<br>&nbsp; display: block;<br>&nbsp; width: 100%;<br>&nbsp; height: auto;<br>}<br><br>/* 
  The overlay effect - lays on top of the container and 
  over the image */<br>.overlay {<br>&nbsp; position: absolute; <br>&nbsp; 
  bottom: 0; <br>&nbsp; background: rgb(0, 0, 0);<br>&nbsp; background: rgba(0, 
  0, 0, 0.5); /* Black see-through */<br>&nbsp; color: #f1f1f1; <br>&nbsp; 
  width: 100%;<br>&nbsp; transition: .5s ease;<br>&nbsp; opacity:0;<br>&nbsp; color: white;<br>&nbsp; 
  font-size: 20px;<br>&nbsp; padding: 20px;<br>&nbsp; text-align: center;<br>}<br><br>/* When you mouse over the container, fade 
  in the overlay title */<br>.container:hover .overlay {<br>&nbsp; opacity: 1;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_image_overlay_title" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
