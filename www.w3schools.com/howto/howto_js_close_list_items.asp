...
<html lang="en-US">
<head>
<title>How To Create Closable List Items</title>
<meta charset="utf-8">
...
<h1>How TO - Closable List Items</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_quotes_slideshow.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_media_query_breakpoints.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to close list items with JavaScript.</p>
<hr>
...
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_close_list_items" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create Closable List Items</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;ul&gt;<br>&nbsp; &lt;li&gt;Adele&lt;/li&gt;<br>&nbsp; &lt;li&gt;Agnes&lt;span 
  class=&quot;close&quot;&gt;x&lt;/span&gt;&lt;/li&gt;<br><br>&nbsp; &lt;li&gt;Billy&lt;span 
  class=&quot;close&quot;&gt;x&lt;/span&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;Bob&lt;span class=&quot;close&quot;&gt;x&lt;/span&gt;&lt;/li&gt;<br>
  <br>&nbsp; &lt;li&gt;Calvin&lt;span class=&quot;close&quot;&gt;x&lt;/span&gt;&lt;/li&gt;<br>&nbsp; 
  &lt;li&gt;Christina&lt;span class=&quot;close&quot;&gt;x&lt;/span&gt;&lt;/li&gt;<br>&nbsp; &lt;li&gt;Cindy&lt;/li&gt;<br>&lt;/ul&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {<br>&nbsp; box-sizing: border-box;<br>}<br><br>/* Style the list (remove 
  margins and bullets, etc) */<br>ul {<br>&nbsp; list-style-type: none;<br>&nbsp; 
  padding: 0;<br>&nbsp; margin: 0;<br>}<br><br>/* Style the list items */<br>ul 
  li {<br>&nbsp; border: 1px solid #ddd;<br>&nbsp; margin-top: -1px; /* Prevent 
  double borders */<br>&nbsp; background-color: #f6f6f6;<br>&nbsp; padding: 
  12px;<br>&nbsp; text-decoration: none;<br>&nbsp; font-size: 18px;<br>&nbsp; 
  color: black;<br>&nbsp; display: block;<br>&nbsp; position: relative;<br>}<br>
  <br>/* Add a light grey background color on hover */<br>ul li:hover {<br>&nbsp; 
  background-color: #eee;<br>}<br><br>/* Style the close button (span) */<br>.close {<br>&nbsp; 
  cursor: pointer;<br>&nbsp; position: absolute;<br>&nbsp; 
  top: 50%;<br>&nbsp; right: 0%;<br>&nbsp; padding: 12px 16px;<br>&nbsp; 
  transform: translate(0%, -50%);<br>}<br>
  <br>.close:hover {background: #bbb;}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  /* Get all elements with class=&quot;close&quot; */<br>var closebtns = 
  document.getElementsByClassName(&quot;close&quot;);<br>var i;<br><br>/* Loop through the 
  elements, and hide the parent, when clicked on */<br>for (i = 0; i &lt; closebtns.length; i++) {<br>&nbsp; closebtns[i].addEventListener(&quot;click&quot;, 
  function() {<br>&nbsp; this.parentElement.style.display = 'none';<br>});<br></div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_close_list_items" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
