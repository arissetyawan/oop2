...
<html lang="en-US">
<head>
<title>How To Create a Flip Card with CSS</title>
<meta charset="utf-8">
...
<h1>How TO - Flip Card</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_cards.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_profile_card.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a flip card with CSS.</p>
<hr>
<p>Move your mouse over the image below:</p>
<div class="flip-card">
...
<p style="margin-top:25px"><a target="_blank" href="tryit.asp?filename=tryhow_css_flip_card" class="w3-btn">Try it Yourself &raquo;</a></p>

<hr>

<h2>How To Create a Flip Card</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div class=&quot;flip-card&quot;&gt;<br>&nbsp; &lt;div class=&quot;flip-card-inner&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;div class=&quot;flip-card-front&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;img src=&quot;img_avatar.png&quot; 
  alt=&quot;Avatar&quot; style=&quot;width:300px;height:300px;&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;div class=&quot;flip-card-back&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;h1&gt;John 
  Doe&lt;/h1&gt; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Architect &amp; Engineer&lt;/p&gt; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;p&gt;We love that guy&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>
  &lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  ...
  the box on hover (remove perspective if you don't want the 3D effect */<br>.flip-card {<br>&nbsp; background-color: transparent;<br>&nbsp; width: 300px;<br>&nbsp; 
  ...
  .flip-card-inner {<br>&nbsp; position: relative;<br>&nbsp; width: 100%;<br>&nbsp; 
  height: 100%;<br>&nbsp; text-align: center;<br>&nbsp; transition: transform 
  0.8s;<br>&nbsp; transform-style: preserve-3d;<br>}<br><br>/* Do an horizontal 
  flip when you move the mouse over the flip box container */<br>.flip-card:hover .flip-card-inner {<br>&nbsp; 
  transform: rotateY(180deg);<br>}<br><br>/* Position the front and back side */<br>.flip-card-front, .flip-card-back {<br>&nbsp; 
  position: absolute;<br>&nbsp; width: 100%;<br>&nbsp; height: 100%;<br>&nbsp; 
  backface-visibility: hidden;<br>}<br><br>/* Style the front side (fallback if 
  image is missing) */<br>.flip-card-front {<br>&nbsp; background-color: #bbb;<br>&nbsp; 
  color: black;<br>}<br><br>/* Style the back side */<br>.flip-card-back {<br>&nbsp; background-color: dodgerblue;<br>&nbsp; 
  color: white;<br>&nbsp; transform: rotateY(180deg);<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_flip_card" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
