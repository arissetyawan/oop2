...
<html lang="en-US">
<head>
<title>How To Create a Card with CSS</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="howto_css_contact_chips.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_flip_card.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a &quot;card&quot; with CSS.</p>
<hr>
...
<div class="w3-col s6">
<div class="card" style="width:92%;max-width:300px;border-radius:5px">
  <img src="img_avatar2.png" alt="Avatar" style="width:100%;opacity:0.85;border-radius:5px 5px 0 0">
  <div class="container">
  <h5><b>Jane Doe</b></h5>    
...
<p style="margin-top:20px"><a target="_blank" href="tryit.asp?filename=tryhow_css_cards" class="w3-btn">Try it Yourself &raquo;</a></p>
...
&lt;div class=&quot;card&quot;&gt;<br>&nbsp; &lt;img src=&quot;img_avatar.png&quot; alt=&quot;Avatar&quot; 
style=&quot;width:100%&quot;&gt;<br>&nbsp; &lt;div class=&quot;container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;h4&gt;&lt;b&gt;John Doe&lt;/b&gt;&lt;/h4&gt; <br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Architect &amp; Engineer&lt;/p&gt;
<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
.card {<br>&nbsp;&nbsp;&nbsp; /* Add shadows to create the &quot;card&quot; effect */<br>&nbsp;&nbsp;&nbsp; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);<br>&nbsp;&nbsp;&nbsp; 
transition: 0.3s;<br>}<br><br>/* On mouse-over, add a deeper shadow */<br>.card:hover {<br>&nbsp;&nbsp;&nbsp; box-shadow: 
0 8px 16px 0 rgba(0,0,0,0.2);<br>}<br><br>/* Add some padding inside the card container */<br>.container {<br>&nbsp;&nbsp;&nbsp; 
padding: 2px 16px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_cards" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h5>With rounded corners:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
.card {<br>&nbsp;&nbsp;&nbsp; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);<br>&nbsp;&nbsp;&nbsp; 
transition: 0.3s;<br>&nbsp;&nbsp;&nbsp; border-radius: 5px; /* 5px rounded corners */<br>}<br><br>/* Add rounded corners to the top left and the top right corner of the image */<br>img {<br>&nbsp;&nbsp;&nbsp; 
border-radius: 5px 5px 0 0;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_cards2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Tip:</strong> Go to our <a href="/css/css3_shadows.asp">CSS Shadow Effects Tutorial</a> to learn more about 
shadows.</p>
