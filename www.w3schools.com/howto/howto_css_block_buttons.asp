...
<html lang="en-US">
<head>
<title>How To Create Full Width Buttons</title>
<meta charset="utf-8">
...
<h1>How TO - Full Width (Block) Buttons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_more_button.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_text_buttons.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style block buttons (full-width) with CSS.</p>
<hr>

<button class="w3-button w3-block w3-green" style="padding:14px 28px">Block Button</button>
<hr>

<h2>How To Style Block Buttons</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button 
  type=&quot;button&quot; class=&quot;block&quot;&gt;Block Button&lt;/button&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>To create a full-width button, add a width of 100% and make it into a block element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .block {<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; 
  border: none;<br>&nbsp;&nbsp;&nbsp; background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; 
  padding: 14px 28px;<br>&nbsp;&nbsp;&nbsp; font-size: 16px;<br>&nbsp;&nbsp;&nbsp; 
  cursor: pointer;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_block_buttons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
