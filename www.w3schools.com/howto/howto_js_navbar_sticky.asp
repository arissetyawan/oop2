...
<html lang="en-US">
<head>
<title>How To Create a Sticky Navbar</title>
<meta charset="utf-8">
...
<h1>How TO - Sticky/Affix Navbar</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_js_navbar_shrink_scroll.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_css_navbar_image.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a "sticky" navbar with CSS and JavaScript.</p>
<hr>
<iframe src="tryhow_js_navbar_sticky.htm" style="width:100%;border:3px solid #e9e9e9;height:400px;padding:0"></iframe>
<p><a target="_blank" href="tryit.asp?filename=tryhow_js_navbar_sticky" class="w3-btn">Try it Yourself &raquo;</a></p>
<hr>

<h2>How To Create a Sticky Navbar</h2>
<h5>Step 1) Add HTML:</h5>
<p>Create a navigation bar:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;div id=&quot;navbar&quot;&gt;<br>&nbsp; &lt;a href=&quot;#home&quot;&gt;Home&lt;/a&gt;<br>&nbsp; &lt;a href=&quot;#news&quot;&gt;News&lt;/a&gt;<br>&nbsp; 
  &lt;a href=&quot;#contact&quot;&gt;Contact&lt;/a&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  /* Style the navbar */<br>#navbar {<br>&nbsp; overflow: hidden;<br>&nbsp; 
  background-color: #333;<br>}<br><br>/* Navbar links */<br>#navbar a {<br>&nbsp; float: left;<br>&nbsp; 
  display: block;<br>&nbsp; color: #f2f2f2;<br>&nbsp; text-align: center;<br>&nbsp; 
  padding: 14px;<br>&nbsp; text-decoration: none;<br>}<br><br>/* Page content */<br>.content {<br>&nbsp; padding: 16px;<br>}<br><br>/* 
  The sticky class is added to the navbar with JS when it reaches its scroll 
  position */<br>.sticky {<br>&nbsp; 
  position: fixed;<br>&nbsp; top: 0;<br>&nbsp; width: 100%;<br>}<br><br>/* Add 
  ...
  top:0) */<br>.sticky + .content {<br>&nbsp; 
  padding-top: 60px;<br>}</div>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  // When the user scrolls the page, execute myFunction <br>window.onscroll = 
  function() {myFunction()};<br><br>// Get the navbar<br>var navbar = document.getElementById(&quot;navbar&quot;);<br><br>// 
  Get the offset position of the navbar<br>var sticky = navbar.offsetTop;<br>
  <br>// Add the sticky class to the navbar when you reach its scroll position. 
  Remove &quot;sticky&quot; when you leave the scroll position<br>function myFunction() {<br>&nbsp; 
  if (window.pageYOffset &gt;= sticky) {<br>&nbsp;&nbsp;&nbsp; navbar.classList.add(&quot;sticky&quot;)<br>&nbsp; 
  } else {<br>&nbsp;&nbsp;&nbsp; navbar.classList.remove(&quot;sticky&quot;);<br>&nbsp; }<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_navbar_sticky" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
