...
<h1>How TO - Login Form</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_js_scroll_to_top.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_signup_form.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive login form with CSS.</p>
<hr>

<p>Click on the button to open the login form:</p>
<button onclick="document.getElementById('id01').style.display='block'" class="w3-btn w3-blue w3-padding-large">Login</button>
...
<p>
<a target="_blank" href="tryit.asp?filename=tryhow_css_login_form_modal" class="w3-btn">Try it Yourself &raquo;</a>
</p>
<hr>

<h2>How To Create a Login Form</h2>
<h5>Step 1) Add HTML:</h5>
<p>Add an image inside a container and add inputs (with a matching label) for each field. Wrap a &lt;form&gt; element around them to process the input. You can learn more about how to process input in our <a href="/php/default.asp">PHP</a> tutorial. </p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;form action=&quot;action_page.php&quot;&gt;<br>&nbsp; &lt;div class=&quot;imgcontainer&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;img src=&quot;img_avatar2.png&quot; alt=&quot;Avatar&quot; 
class=&quot;avatar&quot;&gt;<br>&nbsp; &lt;/div&gt;<br><br>&nbsp; &lt;div 
class=&quot;container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;label for=&quot;uname&quot;&gt;&lt;b&gt;Username&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;input type=&quot;text&quot; placeholder=&quot;Enter Username&quot; name=&quot;uname&quot; required&gt;<br>
<br>&nbsp;&nbsp;&nbsp; &lt;label for=&quot;psw&quot;&gt;&lt;b&gt;Password&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;input type=&quot;password&quot; placeholder=&quot;Enter Password&quot; name=&quot;psw&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp; 
&lt;button type=&quot;submit&quot;&gt;Login&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; 
  &lt;label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input 
type=&quot;checkbox&quot; checked=&quot;checked&quot; name=&quot;remember&quot;&gt; Remember me<br>&nbsp;&nbsp;&nbsp; 
  &lt;/label&gt;<br>&nbsp; &lt;/div&gt;<br><br>&nbsp; 
&lt;div class=&quot;container&quot; style=&quot;background-color:#f1f1f1&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;button type=&quot;button&quot; class=&quot;cancelbtn&quot;&gt;Cancel&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;span class=&quot;psw&quot;&gt;Forgot &lt;a href=&quot;#&quot;&gt;password?&lt;/a&gt;&lt;/span&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/form&gt;</div>
</div>
<hr>
...
/* Bordered form */<br>form {<br>&nbsp;&nbsp;&nbsp; border: 3px solid #f1f1f1;<br>}<br>
<br>/* Full-width inputs */<br>
input[type=text], input[type=password] {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; padding: 12px 20px;<br>&nbsp;&nbsp;&nbsp; margin: 8px 0;<br>
&nbsp;&nbsp;&nbsp;
display: inline-block;<br>&nbsp;&nbsp;&nbsp; border: 1px solid #ccc;<br>&nbsp;&nbsp;&nbsp; box-sizing: border-box;<br>
}<br><br>/* Set a style for all buttons */<br>button {<br>&nbsp;&nbsp;&nbsp; background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; padding: 
14px 20px;<br>&nbsp;&nbsp;&nbsp; margin: 8px 0;<br>&nbsp;&nbsp;&nbsp; border: none;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>&nbsp;&nbsp;&nbsp; width: 
100%;<br>}<br><br>/* Add a hover effect for buttons */<br>button:hover {<br>&nbsp;&nbsp;&nbsp; 
  opacity: 0.8;<br>}<br><br>/* Extra style for the cancel button (red) */<br>.cancelbtn {<br>&nbsp;&nbsp;&nbsp; width: auto;<br>&nbsp;&nbsp;&nbsp; padding: 10px 18px;<br>
&nbsp;&nbsp;&nbsp;
background-color: #f44336;<br>}<br><br>/* Center the avatar image inside 
this container */<br>.imgcontainer {<br>&nbsp;&nbsp;&nbsp; text-align: 
center;<br>&nbsp;&nbsp;&nbsp; margin: 24px 0 12px 0;<br>}<br><br>/* Avatar 
image */<br>img.avatar {<br>&nbsp;&nbsp;&nbsp; width: 40%;<br>
&nbsp;&nbsp;&nbsp;
border-radius: 50%;<br>}<br><br>/* Add padding to containers */<br>.container {<br>&nbsp;&nbsp;&nbsp; padding: 16px;<br>}<br>
<br>/* The &quot;Forgot password&quot; text */<br>
span.psw {<br>&nbsp;&nbsp;&nbsp; float: right;<br>&nbsp;&nbsp;&nbsp; padding-top: 16px;<br>}<br>
<br>/* Change styles for span and cancel button on extra small screens */<br>
@media screen and (max-width: 300px) {<br>&nbsp;&nbsp;&nbsp; span.psw {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
display: block;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; float: none;<br>&nbsp;&nbsp;&nbsp; 
}<br>&nbsp;&nbsp;&nbsp; .cancelbtn {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
width: 100%;<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_login_form" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>How To Create a Modal Login Form</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;!-- Button to open the modal login form --&gt;<br>&lt;button onclick=&quot;document.getElementById('id01').style.display='block'&quot;&gt;Login&lt;/button&gt;<br>
<br>&lt;!-- The Modal --&gt;<br>&lt;div id=&quot;id01&quot; class=&quot;modal&quot;&gt;<br>&nbsp; 
&lt;span onclick=&quot;document.getElementById('id01').style.display='none'&quot; <br>
class=&quot;close&quot; title=&quot;Close Modal&quot;&gt;&amp;times;&lt;/span&gt;<br><br>&nbsp; &lt;!-- Modal Content --&gt;<br>&nbsp; 
&lt;form class=&quot;modal-content animate&quot; action=&quot;/action_page.php&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;div class=&quot;imgcontainer&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;img src=&quot;img_avatar2.png&quot; 
alt=&quot;Avatar&quot; class=&quot;avatar&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br><br>&nbsp;&nbsp;&nbsp; &lt;div 
class=&quot;container&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
&lt;label for=&quot;uname&quot;&gt;&lt;b&gt;Username&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input 
type=&quot;text&quot; placeholder=&quot;Enter Username&quot; name=&quot;uname&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
&lt;label for=&quot;psw&quot;&gt;&lt;b&gt;Password&lt;/b&gt;&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input 
type=&quot;password&quot; placeholder=&quot;Enter Password&quot; name=&quot;psw&quot; required&gt;<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
&lt;button type=&quot;submit&quot;&gt;Login&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input type=&quot;checkbox&quot; checked=&quot;checked&quot; 
  name=&quot;remember&quot;&gt; Remember me<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  &lt;/label&gt;<br>&nbsp;&nbsp;&nbsp; 
&lt;/div&gt;<br><br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;container&quot; 
style=&quot;background-color:#f1f1f1&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;button 
type=&quot;button&quot; onclick=&quot;document.getElementById('id01').style.display='none'&quot; 
class=&quot;cancelbtn&quot;&gt;Cancel&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
&lt;span class=&quot;psw&quot;&gt;Forgot &lt;a href=&quot;#&quot;&gt;password?&lt;/a&gt;&lt;/span&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; 
&lt;/form&gt;<br>&lt;/div&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
/* The Modal (background) */<br>.modal {<br>&nbsp;&nbsp;&nbsp; display: 
none; /* Hidden by default */<br>&nbsp;&nbsp;&nbsp; position: fixed; /* Stay 
in place */<br>&nbsp;&nbsp;&nbsp; z-index: 1; /* Sit on top */<br>&nbsp;&nbsp;&nbsp; 
left: 0;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; width: 100%; /* 
Full width */<br>&nbsp;&nbsp;&nbsp; height: 100%; /* Full height */<br>&nbsp;&nbsp;&nbsp; 
...
padding-top: 60px;<br>}<br><br>/* Modal Content/Box */<br>.modal-content 
{<br>&nbsp;&nbsp;&nbsp; background-color: #fefefe;<br>&nbsp;&nbsp;&nbsp; 
margin: 5px auto; /* 15% from the top and centered */<br>&nbsp;&nbsp;&nbsp; 
border: 1px solid #888;<br>&nbsp;&nbsp;&nbsp; width: 80%; /* Could be more 
or less, depending on screen size */<br>}<br><br>/* The Close Button */<br>
.close {<br>&nbsp;&nbsp;&nbsp; /* Position it in the top right corner 
outside of the modal */<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
right: 25px;<br>&nbsp;&nbsp;&nbsp; top: 0; <br>&nbsp;&nbsp;&nbsp; color: 
#000;<br>&nbsp;&nbsp;&nbsp; font-size: 35px;<br>&nbsp;&nbsp;&nbsp; 
font-weight: bold;<br>}<br><br>/* 
Close button on hover */<br>.close:hover,<br>.close:focus 
{<br>&nbsp;&nbsp;&nbsp; color: red;<br>&nbsp;&nbsp;&nbsp; cursor: pointer;<br>
}<br><br>/* Add Zoom Animation */<br>
.animate {<br>&nbsp;&nbsp;&nbsp; -webkit-animation: animatezoom 0.6s;<br>&nbsp;&nbsp;&nbsp; 
animation: animatezoom 0.6s<br>}<br><br>@-webkit-keyframes animatezoom {<br>&nbsp;&nbsp;&nbsp; from 
{-webkit-transform: scale(0)} <br>&nbsp;&nbsp;&nbsp; to {-webkit-transform: 
scale(1)}<br>}<br><br>@keyframes 
animatezoom {<br>&nbsp;&nbsp;&nbsp; from {transform: scale(0)} <br>&nbsp;&nbsp;&nbsp; 
to {transform: scale(1)}<br>}</div>
</div>
...
&quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>
&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_login_form_modal" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
