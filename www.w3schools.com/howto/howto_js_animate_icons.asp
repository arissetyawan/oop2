...
<html lang="en-US">
<head>
<title>How To Animate Icons</title>
<meta charset="utf-8">
...
<h1>How TO - Animate Icons</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_vertical_line.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_js_countdown.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to use icons to make an animated effect.</p>
<hr>
<h2>Battery Charging</h2>
<div id="charging" class="fa faicons"></div><br>
<a target="_blank" href="tryit.asp?filename=tryhow_js_animate_charging" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
...
&lt;div id="charging" class="fa"&gt;&lt;/div&gt;</div>
</div>

<h5>Step 2) Include the Font Awesome Icon Library:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"&gt;</div>
</div>
<p>Read more about Font Awesome in our 
<a href="/icons/fontawesome_icons_intro.asp">Font Awesome Tutorial</a>.</p>
<h5>Step 3) Add a JavaScript:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;script&gt;<br>function chargebattery() {<br>&nbsp; var a;<br>&nbsp; a = document.getElementById("charging");<br>&nbsp; a.innerHTML = "&amp;#xf244;";<br>
 &nbsp;
 setTimeout(function () {<br>&nbsp;&nbsp;&nbsp; a.innerHTML = "&amp;#xf243;";<br>&nbsp; }, 1000);<br>
 &nbsp;
 setTimeout(function () {<br>&nbsp;&nbsp;&nbsp; a.innerHTML = "&amp;#xf242;";<br>&nbsp; }, 2000);<br>
 &nbsp;
 setTimeout(function () {<br>&nbsp;&nbsp;&nbsp; a.innerHTML = "&amp;#xf241;";<br>&nbsp; }, 3000);<br>
 &nbsp;
 setTimeout(function () {<br>&nbsp;&nbsp;&nbsp; a.innerHTML = "&amp;#xf240;";<br>&nbsp; }, 4000);<br>}<br>
 chargebattery();<br>setInterval(chargebattery, 5000);<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_animate_charging" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<h3>Example Explained</h3>
<p>The example gives an impression of a battery getting charged, but 
instead it is five different icons being displayed.</p>
<p>A function called <code class="w3-codespan">chargebattery()</code> does all 
the replacing and displaying of icons.</p>
<p>The function starts by displaying an empty battery icon:</p>
<i class="fa faicons">&#xf244;</i>
<p>After one second, the icon is replaced by a new icon:</p>
<i class="fa faicons">&#xf243;</i>
<p>The icon is replaced by a new icon each second, until "the battery is fully charged":</p>
<i class="fa faicons">&#xf242;</i><br>
<i class="fa faicons">&#xf241;</i><br>
<i class="fa faicons">&#xf240;</i>

<p>This process is repeated every 5 second, making it seems like the battery is 
charging.</p>

<hr>
<h2>More Animated Icons</h2>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate">
<br>
<div id="hourglass" class="fa faicons"></div>
<br>
<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_animate_hourglass" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate">
<br>
<div id="chain" class="fa faicons"></div>
<br>
<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_animate_brake_chain" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate">
<br>
<div id="star" class="fa faicons"></div>
<br>
<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_animate_ratestar" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate">
<br>
<div id="folder" class="fa faicons"></div>
<br>
<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_animate_folder" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate">
<br>
<div id="smiley" class="fa faicons"></div>
<br>
<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_animate_smile" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate">
<br>
<div id="hand" class="fa faicons"></div>
<br>
<br>
</div>
<a target="_blank" href="tryit.asp?filename=tryhow_js_animate_hand" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
function hand() {
  var a;
  a = document.getElementById("hand");
  a.innerHTML = "&#xf25a;";
  setTimeout(function () {
      a.innerHTML = "&#xf256;";
    }, 500);
