...
<html lang="en-US">
<head>
<title>How To Create Round Buttons</title>
<meta charset="utf-8">
...
<h1>How TO - Round Buttons</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="howto_css_text_buttons.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="howto_js_scroll_to_top.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to style round buttons with CSS.</p>
<hr>
...
<h2>How To Style Round Buttons</h2>
<h5>Step 1) Add HTML:</h5>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;button class=&quot;button button1&quot;&gt;2px&lt;/button&gt;<br>&lt;button class=&quot;button 
  button2&quot;&gt;4px&lt;/button&gt;<br>&lt;button class=&quot;button button3&quot;&gt;8px&lt;/button&gt;<br>
  &lt;button class=&quot;button button4&quot;&gt;12px&lt;/button&gt;<br>&lt;button class=&quot;button 
  button5&quot;&gt;50%&lt;/button&gt;</div>
</div>
<hr>
<h5>Step 2) Add CSS:</h5>
<p>Add rounded corners to a button with the <code class="w3-codespan">border-radius</code> property:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  .button {<br>&nbsp;&nbsp;&nbsp; background-color: #4CAF50;<br>&nbsp;&nbsp;&nbsp; 
  border: none;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; 
  padding: 20px;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>&nbsp;&nbsp;&nbsp; 
  text-decoration: none;<br>&nbsp;&nbsp;&nbsp; display: inline-block;<br>&nbsp;&nbsp;&nbsp; 
  font-size: 16px;<br>&nbsp;&nbsp;&nbsp; margin: 4px 2px;<br>}<br><br>.button1 {border-radius: 2px;}<br>.button2 
  {border-radius: 4px;}<br>.button3 {border-radius: 8px;}<br>.button4 
  {border-radius: 12px;}<br>.button5 {border-radius: 50%;}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_round_buttons" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
