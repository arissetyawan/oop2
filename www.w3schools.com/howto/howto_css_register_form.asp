...
<html lang="en-US">
<head>
<title>How To Create a Register Form</title>
<meta charset="utf-8">
...
<h1>How TO - Register Form</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_social_login.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_form_icon.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a register form with CSS.</p>
<hr>
<div style="border:2px solid #f1f1f1;font-family: Arial, Helvetica, sans-serif;font-size:17px;">
    ...
    <hr style="border: 1px solid #f1f1f1;margin-bottom: 25px;">
      ...
      <div class="w3-section">
        ...
        <input class="w3-input w3-light-grey w3-margin-bottom x" style="border-bottom:0;padding:12px" type="text" placeholder="Enter email">
      </div>
      <div class="w3-section">
      
        <label><b>Password</b></label>
        <input class="w3-input w3-light-grey w3-margin-bottom x" type="text" style="border-bottom:0;padding:12px" placeholder="Enter Password">  
      </div>
      <div class="w3-section">
       
        <label><b>Repeat Password</b></label>
        <input class="w3-input  w3-light-grey w3-margin-bottom x" style="border-bottom:0;padding:12px" type="text" placeholder="Repeat Password">
      <p>By creating an account you agree to our <a href="javascript:void(0)" style="color:dodgerblue">Terms & Privacy</a>.</p>
       </div>
      <button class="w3-button w3-block w3-green w3-padding-16 w3-hover-green w3-opacity-min w3-hover-opacity-off">Register</button></div>
      <div class="w3-container w3-center w3-light-grey" style="margin-top:30px"> 
      <p>Already have an account? <a href="javascript:void(0)" style="color:dodgerblue">Sign in</a></p>
</div>
</div>
<p>
<a target="_blank" href="tryit.asp?filename=tryhow_css_register_form" class="w3-btn">Try it Yourself &raquo;</a>
</p>
<hr>

<h2>How To Create a Register Form</h2>
...
<h3>Example</h3>
  <div class="w3-code notranslate htmlHigh">
    &lt;form action=&quot;action_page.php&quot;&gt;<br>&nbsp; &lt;div 
    class=&quot;container&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;h1&gt;Register&lt;/h1&gt;<br>&nbsp;&nbsp;&nbsp; 
    ...
    &lt;hr&gt;<br><br>&nbsp;&nbsp;&nbsp; &lt;p&gt;By creating an account you agree to 
    our &lt;a href=&quot;#&quot;&gt;Terms &amp; Privacy&lt;/a&gt;.&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;button type=&quot;submit&quot; class=&quot;registerbtn&quot;&gt;Register&lt;/button&gt;<br>&nbsp; &lt;/div&gt;<br>
    <br>&nbsp; &lt;div class=&quot;container signin&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;p&gt;Already 
    have an account? &lt;a href=&quot;#&quot;&gt;Sign in&lt;/a&gt;.&lt;/p&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/form&gt;</div>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  * {box-sizing: border-box}<br><br>/* Add padding to containers */<br>.container {<br>&nbsp; 
  padding: 16px;<br>}<br><br>/* Full-width input fields */<br>input[type=text], 
  input[type=password] {<br>&nbsp; width: 100%;<br>&nbsp; padding: 15px;<br>&nbsp; 
  margin: 5px 0 22px 0;<br>&nbsp; display: inline-block;<br>&nbsp; border: none;<br>&nbsp; 
  background: #f1f1f1;<br>}<br>
  <br>input[type=text]:focus, input[type=password]:focus {<br>&nbsp; 
  background-color: #ddd;<br>&nbsp; outline: none;<br>}<br><br>/* Overwrite default styles of hr */<br>hr 
  {<br>&nbsp; border: 1px solid #f1f1f1;<br>&nbsp; margin-bottom: 25px;<br>}<br><br>/* Set a 
  style for the submit/register button */<br>.registerbtn {<br>&nbsp; background-color: 
  #4CAF50;<br>&nbsp; color: white;<br>&nbsp; padding: 16px 20px;<br>&nbsp; 
  margin: 8px 0;<br>&nbsp; border: none;<br>&nbsp; cursor: pointer;<br>&nbsp; 
  width: 100%;<br>&nbsp; opacity: 0.9;<br>}<br><br>.registerbtn:hover 
  {<br>&nbsp; opacity:1;<br>}<br><br>/* Add a blue text color to links */<br>a {<br>&nbsp; 
  color: dodgerblue;<br>}<br><br>/* Set a grey background color and center the 
  text of the &quot;sign in&quot; section */<br>.signin {<br>&nbsp; background-color: 
  #f1f1f1;<br>&nbsp; text-align: center;<br>}</div>
<a target="_blank" href="tryit.asp?filename=tryhow_css_register_form" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
