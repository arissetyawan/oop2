...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 libxml Functions</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">libxml</span> Functions</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_ref_http.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_ref_mail.asp">Next &#10095;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Set the streams context for the next libxml document load or write</td>
  </tr>
  <tr>
    <td><a href="func_libxml_use_internal_errors.asp">libxml_use_internal_errors()</a></td>
    <td>Disable libxml errors and allow user to fetch error information as needed</td>
  </tr>
   </table>

<h2>PHP 5 Predefined libxml Constants</h2>
<table class="w3-table-all notranslate">
  <tr>
