...
<h1>PHP 5 <span class="color_h1">Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_functions.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_arrays_sort.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_array_num">Run example &raquo;</a>
</div>
<hr>
...
<p>In PHP, the <code class="w3-codespan">array()</code> function is used to create an array:</p>
<div class="w3-code w3-border notranslate"><div>
 array();</div></div>
...
always starts at 0), like this:</p>
<div class="w3-code w3-border notranslate"><div>
...
<p>The <code class="w3-codespan">count()</code> function is used to return the length (the number of elements) of 
an array:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_array_length">Run example &raquo;</a>
</div>
<hr>

<h2>Loop Through an Indexed Array</h2>
<p>To loop through and print all the values of an indexed array, you could use a <code class="w3-codespan">for</code> loop, like this:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_array_num_loop">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_array_assoc">Run example &raquo;</a>
</div>
<hr>

<h2>Loop Through an Associative Array</h2>
<p>To loop through and print all the values of an associative array, you could use a <code class="w3-codespan">foreach</code> loop, like this:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_array_assoc_loop">Run example &raquo;</a>
</div>
<hr>
