...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 SimpleXML Functions</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="php_ref_mysqli.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_ref_string.asp">Next &#10095;</a>
</div>
<hr>
<h2>PHP SimpleXML Introduction</h2>
<p>SimpleXML is an extension that allows us to easily manipulate and get XML 
data.</p>
<p>SimpleXML provides an easy way of getting an element's name, attributes and 
textual content if you know the XML document's structure or layout.</p>
