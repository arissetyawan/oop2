...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Limit Data Selections From MySQL</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Limit Data Selections From MySQL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_mysql_update.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_xml_parsers.asp">Next &#10095;</a>
</div>
<hr>

<h2>Limit Data Selections From a MySQL Database</h2>
<p>MySQL provides a LIMIT clause that is used to specify the number of records 
to return.</p>
<p>The LIMIT clause makes it easy to code multi page results or pagination with 
SQL, and is very useful on large tables. Returning a large number of records can 
impact on performance.</p>
<p>Assume we wish to select all records from 1 - 30 (inclusive) from a table 
...
<p>The SQL query below says "return only 10 records, start on record 16 (OFFSET 
15)":</p>
