...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Select Data From MySQL</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Select Data From MySQL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_mysql_prepared_statements.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_mysql_delete.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The following example selects the id, firstname and lastname columns from the MyGuests 
table and displays it on the page:</p>

<div class="w3-example">
<h3>Example (MySQLi Object-oriented)</h3>
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>$password = &quot;password&quot;;<br>$dbname = &quot;myDB&quot;;<br><br>// Create connection<br>$conn = new mysqli($servername, $username, $password, $dbname);<br>// Check connection<br>if ($conn-&gt;connect_error) {<br>&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . $conn-&gt;connect_error);<br>
 } <br><br>$sql = &quot;SELECT id, firstname, lastname FROM MyGuests&quot;;<br>$result = $conn-&gt;query($sql);<br><br>if ($result-&gt;num_rows &gt; 0) {<br>&nbsp;&nbsp;&nbsp; // output data of each row<br>&nbsp;&nbsp;&nbsp; while($row = $result-&gt;fetch_assoc()) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;id: &quot; . $row[&quot;id&quot;]. &quot; - Name: &quot; . $row[&quot;firstname&quot;]. &quot; &quot; . $row[&quot;lastname&quot;]. &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;0 results&quot;;<br>}<br>
 $conn-&gt;close();<br>
?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpfile.asp?filename=demo_db_select_oo">Run example &raquo;</a>
</div>

<p>Code lines to explain from the example above:</p>
<p>First, we set up an SQL query that selects the id, firstname and lastname columns from the MyGuests 
table. The next line of code runs the query and puts the resulting data into a 
variable called $result.</p>
<p>Then, the <code class="w3-codespan">function num_rows()</code> checks if there are more than zero 
rows returned.</p>
<p>If there are more than zero rows returned, the 
function <code class="w3-codespan">fetch_assoc()</code> puts all the results into an associative array that we can loop 
through. The <code class="w3-codespan">while()</code> loop loops through the result set and outputs the data from 
the id, firstname and lastname columns.</p>
<p>The following example shows the same as the example above, in the MySQLi 
procedural way:</p>

<div class="w3-example">
<h3>Example (MySQLi Procedural)</h3>
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>$password = &quot;password&quot;;<br>$dbname = &quot;myDB&quot;;<br><br>// Create connection<br>
$conn = mysqli_connect($servername, $username, $password, $dbname);<br>
 // Check connection<br>
 if (!$conn)&nbsp;{<br>
&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . mysqli_connect_error());<br>}<br><br>$sql = &quot;SELECT id, firstname, lastname FROM MyGuests&quot;;<br>$result = mysqli_query($conn, $sql);<br><br>if (mysqli_num_rows($result) &gt; 0) {<br>&nbsp;&nbsp;&nbsp; // output data of each row<br>&nbsp;&nbsp;&nbsp; while($row = mysqli_fetch_assoc($result)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;id: &quot; . $row[&quot;id&quot;]. &quot; - Name: &quot; . $row[&quot;firstname&quot;]. &quot; &quot; . $row[&quot;lastname&quot;]. &quot;&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;0 results&quot;;<br>}<br>
 <br>mysqli_close($conn);<br>
?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpfile.asp?filename=demo_db_select_proc">Run example &raquo;</a>
</div>
<hr>
...
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>$password = &quot;password&quot;;<br>$dbname = &quot;myDB&quot;;<br><br>// Create connection<br>$conn = new mysqli($servername, $username, $password, $dbname);<br>// Check connection<br>if ($conn-&gt;connect_error) {<br>&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . $conn-&gt;connect_error);<br>
 } <br><br>$sql = &quot;SELECT id, firstname, lastname FROM MyGuests&quot;;<br>$result = $conn-&gt;query($sql);<br><br>if ($result-&gt;num_rows &gt; 0) {<br>&nbsp;&nbsp;&nbsp; echo &quot;&lt;table&gt;&lt;tr&gt;&lt;th&gt;ID&lt;/th&gt;&lt;th&gt;Name&lt;/th&gt;&lt;/tr&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; // output data of each row<br>&nbsp;&nbsp;&nbsp; while($row = $result-&gt;fetch_assoc()) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;&lt;tr&gt;&lt;td&gt;&quot;.$row[&quot;id&quot;].&quot;&lt;/td&gt;&lt;td&gt;&quot;.$row[&quot;firstname&quot;].&quot; &quot;.$row[&quot;lastname&quot;].&quot;&lt;/td&gt;&lt;/tr&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; echo &quot;&lt;/table&gt;&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;0 results&quot;;<br>}<br>
 $conn-&gt;close();<br>
?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpfile.asp?filename=demo_db_select_oo_table">Run example &raquo;</a>
</div>
...
<p>It selects the id, firstname and lastname columns from the MyGuests table and 
displays it in an HTML table:</p>
<div class="w3-example">
<h3>Example (PDO)</h3>
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>echo &quot;&lt;table style='border: solid 1px black;'&gt;&quot;;<br>
 echo &quot;&lt;tr&gt;&lt;th&gt;Id&lt;/th&gt;&lt;th&gt;Firstname&lt;/th&gt;&lt;th&gt;Lastname&lt;/th&gt;&lt;/tr&gt;&quot;;<br><br>class TableRows extends RecursiveIteratorIterator {
 <br>&nbsp;&nbsp;&nbsp; function __construct($it) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; parent::__construct($it, self::LEAVES_ONLY); <br>&nbsp;&nbsp;&nbsp; }<br>
 <br>&nbsp;&nbsp;&nbsp; function current() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return &quot;&lt;td style='width:150px;border:1px solid black;'&gt;&quot; . parent::current(). &quot;&lt;/td&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br><br>&nbsp;&nbsp;&nbsp; function beginChildren() { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;&lt;tr&gt;&quot;; <br>&nbsp;&nbsp;&nbsp; } <br><br>&nbsp;&nbsp;&nbsp; function endChildren() { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;&lt;/tr&gt;&quot; . &quot;\n&quot;;<br>&nbsp;&nbsp;&nbsp; } <br>} <br><br>$servername = &quot;localhost&quot;;<br>
 $username = &quot;username&quot;;<br>$password = &quot;password&quot;;<br>$dbname = &quot;myDBPDO&quot;;<br><br>
 try {<br>&nbsp;&nbsp;&nbsp; $conn = new PDO(&quot;mysql:host=$servername;dbname=$dbname&quot;, $username, $password);<br>&nbsp;&nbsp;&nbsp; $conn-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);<br>&nbsp;&nbsp;&nbsp; $stmt = $conn-&gt;prepare(&quot;SELECT id, firstname, lastname FROM MyGuests&quot;); <br>&nbsp;&nbsp;&nbsp; $stmt-&gt;execute();<br>
 <br>&nbsp;&nbsp;&nbsp; // set the resulting array to associative<br>&nbsp;&nbsp;&nbsp; $result = $stmt-&gt;setFetchMode(PDO::FETCH_ASSOC); <br>&nbsp;&nbsp;&nbsp; foreach(new TableRows(new RecursiveArrayIterator($stmt-&gt;fetchAll())) as $k=&gt;$v) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo $v;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>catch(PDOException $e) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error: &quot; . $e-&gt;getMessage();<br>}<br>$conn = null;<br>echo &quot;&lt;/table&gt;&quot;;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphpfile.asp?filename=demo_db_select_pdo">Run example &raquo;</a>
</div>
