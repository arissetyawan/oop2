...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP SimpleXML - Get Node/Attribute Values</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">SimpleXML - Get Node/Attribute Values</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_xml_simplexml_read.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_xml_parser_expat.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">SimpleXML is a PHP extension that allows us to easily 
manipulate and get XML data.</p>
<hr>

<h2>PHP SimpleXML - Get Node Values</h2>
<p>Get the node values from the &quot;<a href="note.xml" target="_blank">note.xml</a>&quot; file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;?php<br>$xml=simplexml_load_file(&quot;note.xml&quot;) or die(&quot;Error: Cannot create object&quot;);<br>echo $xml-&gt;to . &quot;&lt;br&gt;&quot;;<br>
 echo $xml-&gt;from . &quot;&lt;br&gt;&quot;;<br>echo $xml-&gt;heading . &quot;&lt;br&gt;&quot;;<br>echo $xml-&gt;body;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_simplexml_get_one">Run example &raquo;</a>
</div>
...
<h2>Another XML File</h2>
<p>Assume we have an XML file called &quot;<a href="books.xml" target="_blank">books.xml</a>&quot;, 
that looks like this:&nbsp;</p>
<div class="w3-code w3-border notranslate"><div>
 &lt;?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot;?&gt;<br>&lt;bookstore&gt;<br>&nbsp; &lt;book category=&quot;COOKING&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;title lang=&quot;en&quot;&gt;Everyday Italian&lt;/title&gt;<br>&nbsp;&nbsp;&nbsp; &lt;author&gt;Giada De Laurentiis&lt;/author&gt;<br>&nbsp;&nbsp;&nbsp; &lt;year&gt;2005&lt;/year&gt;<br>
 &nbsp;&nbsp;&nbsp;
 &lt;price&gt;30.00&lt;/price&gt;<br>&nbsp; &lt;/book&gt;<br>&nbsp; &lt;book category=&quot;CHILDREN&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;title lang=&quot;en&quot;&gt;Harry Potter&lt;/title&gt;<br>&nbsp;&nbsp;&nbsp; &lt;author&gt;J K. Rowling&lt;/author&gt;<br>&nbsp;&nbsp;&nbsp; &lt;year&gt;2005&lt;/year&gt;<br>
 &nbsp;&nbsp;&nbsp;
 &lt;price&gt;29.99&lt;/price&gt;<br>&nbsp; &lt;/book&gt;<br>&nbsp; &lt;book category=&quot;WEB&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;title lang=&quot;en-us&quot;&gt;XQuery Kick Start&lt;/title&gt;<br>&nbsp;&nbsp;&nbsp; &lt;author&gt;James McGovern&lt;/author&gt;<br>&nbsp;&nbsp;&nbsp; &lt;year&gt;2003&lt;/year&gt;<br>&nbsp;&nbsp;&nbsp; &lt;price&gt;49.99&lt;/price&gt;<br>&nbsp; &lt;/book&gt;<br>
 &nbsp;
 &lt;book category=&quot;WEB&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;title lang=&quot;en-us&quot;&gt;Learning XML&lt;/title&gt;<br>
 &nbsp;&nbsp;&nbsp;
 &lt;author&gt;Erik T. Ray&lt;/author&gt;<br>
 &nbsp;&nbsp;&nbsp;
 &lt;year&gt;2003&lt;/year&gt;<br>&nbsp;&nbsp;&nbsp; &lt;price&gt;39.95&lt;/price&gt;<br>&nbsp; &lt;/book&gt;<br>&lt;/bookstore&gt;
</div></div>
<hr>
...
<h2>PHP SimpleXML - Get Node Values of Specific Elements</h2>
<p>The following example gets the node value of the &lt;title&gt; element in the first 
and second &lt;book&gt; elements in the &quot;books.xml&quot; file:&nbsp;</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;?php<br>$xml=simplexml_load_file(&quot;books.xml&quot;) or die(&quot;Error: Cannot create object&quot;);<br>echo $xml-&gt;book[0]-&gt;title . &quot;&lt;br&gt;&quot;;<br>echo $xml-&gt;book[1]-&gt;title; <br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_simplexml_get_many1">Run example &raquo;</a>
</div>
<p>The output of the code above will be:</p>
<div class="w3-code w3-border notranslate"><div>
...
<h2>PHP SimpleXML - Get Node Values - Loop</h2>
<p>The following example loops through all the &lt;book&gt; elements in the &quot;books.xml&quot; file, 
and gets the node values of the &lt;title&gt;, &lt;author&gt;, &lt;year&gt;, and &lt;price&gt; elements:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;?php<br>$xml=simplexml_load_file(&quot;books.xml&quot;) or die(&quot;Error: Cannot create object&quot;);<br>foreach($xml-&gt;children() as $books) { <br>&nbsp;&nbsp;&nbsp; echo $books-&gt;title . &quot;, &quot;; <br>&nbsp;&nbsp;&nbsp; echo $books-&gt;author . &quot;, &quot;; <br>&nbsp;&nbsp;&nbsp; echo $books-&gt;year . &quot;, &quot;;<br>&nbsp;&nbsp;&nbsp; echo $books-&gt;price . &quot;&lt;br&gt;&quot;; <br>} <br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_simplexml_get_many2">Run example &raquo;</a>
</div>
<p>The output of the code above will be:</p>
<div class="w3-code w3-border notranslate"><div>
 Everyday Italian, Giada De Laurentiis, 2005, 30.00<br>Harry Potter, J K. Rowling, 2005, 29.99<br>XQuery Kick Start, James McGovern, 2003, 49.99<br>
 Learning XML, Erik T. Ray, 2003, 39.95
</div></div>
<hr>

<h2>PHP SimpleXML - Get Attribute Values</h2>
<p>The following example gets the attribute value of the &quot;category&quot; attribute of 
the first &lt;book&gt; element and the attribute value of the &quot;lang&quot; attribute 
of the &lt;title&gt; element in the second &lt;book&gt; element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;?php<br>$xml=simplexml_load_file(&quot;books.xml&quot;) or die(&quot;Error: Cannot create object&quot;);<br>echo $xml-&gt;book[0]['category'] . &quot;&lt;br&gt;&quot;;<br>echo $xml-&gt;book[1]-&gt;title['lang']; <br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_simplexml_get_attr1">Run example &raquo;</a>
</div>
<p>The output of the code above will be:</p>
<div class="w3-code w3-border notranslate"><div>
 COOKING<br>en</div></div>
<hr>

<h2>PHP SimpleXML - Get Attribute Values - Loop</h2>
<p>The following example gets the attribute values of the &lt;title&gt; elements in the &quot;books.xml&quot; file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;?php<br>$xml=simplexml_load_file(&quot;books.xml&quot;) or die(&quot;Error: Cannot create object&quot;);<br>foreach($xml-&gt;children() as $books) { <br>&nbsp;&nbsp;&nbsp; echo $books-&gt;title['lang'];<br>&nbsp;&nbsp;&nbsp; echo &quot;&lt;br&gt;&quot;; <br>} <br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_simplexml_get_attr2">Run example &raquo;</a>
</div>
<p>The output of the code above will be:</p>
<div class="w3-code w3-border notranslate"><div>
 en<br>en<br>en-us<br>en-us</div></div>
<hr>


<h2>More PHP SimpleXML</h2>
<p>For more information about the PHP SimpleXML functions, visit our
<a href="php_ref_simplexml.asp">PHP SimpleXML Reference.</a></p>
