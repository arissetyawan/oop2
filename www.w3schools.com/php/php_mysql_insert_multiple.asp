...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Insert Multiple Records Into MySQL</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Insert Multiple Records Into MySQL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_mysql_insert_lastid.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_mysql_prepared_statements.asp">Next &#10095;</a>
</div>
<hr>
<h2>Insert Multiple Records Into MySQL Using MySQLi and PDO</h2>
<p>Multiple SQL statements must be executed with the <code class="w3-codespan">mysqli_multi_query()</code> function.</p>
...
<br>
 ...
 <br>if ($conn-&gt;multi_query($sql) === TRUE) {<br>&nbsp;&nbsp;&nbsp; echo &quot;New records created successfully&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error: &quot; . $sql . &quot;&lt;br&gt;&quot; . $conn-&gt;error;<br>}<br><br>$conn-&gt;close();<br>
?&gt;
</div>
<br>
</div>
...
<p>Note that each SQL statement must be separated by a semicolon.</p>
</div>
<hr>
...
&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . mysqli_connect_error());<br>}<br><br>$sql = &quot;INSERT INTO MyGuests (firstname, lastname, email)<br>
 ...
 $sql .= &quot;INSERT INTO MyGuests (firstname, lastname, email)<br>
 VALUES ('Julie', 'Dooley', 'julie@example.com')&quot;;<br>
 <br>if (mysqli_multi_query($conn, $sql)) {<br>&nbsp;&nbsp;&nbsp; echo &quot;New records created successfully&quot;;<br>} else {<br>&nbsp; &nbsp; echo &quot;Error: &quot; . $sql . &quot;&lt;br&gt;&quot; . mysqli_error($conn);<br>}<br><br>mysqli_close($conn);<br>
?&gt;
</div>
<br>
</div>
...
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>
 $password = &quot;password&quot;;<br>$dbname = &quot;myDBPDO&quot;;<br><br>try {<br>&nbsp;&nbsp;&nbsp; $conn = new PDO(&quot;mysql:host=$servername;dbname=$dbname&quot;, $username, $password);<br>&nbsp;&nbsp;&nbsp; // set the PDO error mode to exception<br>&nbsp;&nbsp;&nbsp; $conn-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);<br><br>&nbsp;&nbsp;&nbsp; // begin the transaction<br>&nbsp;&nbsp;&nbsp; $conn-&gt;beginTransaction();<br>&nbsp;&nbsp;&nbsp; // our SQL statements<br>&nbsp;&nbsp;&nbsp; $conn-&gt;exec(&quot;INSERT INTO MyGuests (firstname, lastname, email) <br>&nbsp;&nbsp;&nbsp; VALUES ('John', 'Doe', 'john@example.com')&quot;);<br>&nbsp;&nbsp;&nbsp; $conn-&gt;exec(&quot;INSERT INTO MyGuests (firstname, lastname, email) <br>&nbsp;&nbsp;&nbsp; VALUES ('Mary', 'Moe', 'mary@example.com')&quot;);<br>&nbsp;&nbsp;&nbsp; $conn-&gt;exec(&quot;INSERT INTO MyGuests (firstname, lastname, email) <br>&nbsp;&nbsp;&nbsp; VALUES ('Julie', 'Dooley', 'julie@example.com')&quot;);<br><br>&nbsp;&nbsp;&nbsp; // commit the transaction<br>&nbsp;&nbsp;&nbsp; $conn-&gt;commit();<br>&nbsp;&nbsp;&nbsp; echo &quot;New records created successfully&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>catch(PDOException $e)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; // roll back the transaction if something failed<br>&nbsp;&nbsp;&nbsp; $conn-&gt;rollback();<br>&nbsp;&nbsp;&nbsp; echo &quot;Error: &quot; . $e-&gt;getMessage();<br>&nbsp;&nbsp;&nbsp; }<br>
 <br>$conn = null;<br>
?&gt;
</div>
<br>
