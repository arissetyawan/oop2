...
<a class="w3-left w3-btn" href="php_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_exam.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Good luck!</p>
<p><button onclick="document.location='/quiztest/quiztest.asp?qtest=PHP'" class="w3-btn w3-orange w3-text-white" style="margin-top:10px;padding:17px;font-size:17px">Start the PHP Quiz &#10095;</button></p>
</div>
<div class="w3-note w3-panel">
  <p>If you don't know PHP, we suggest that you read our <a href="default.asp">PHP Tutorial</a> from scratch.</p>
</div>
<hr>
<div class="w3-row">
