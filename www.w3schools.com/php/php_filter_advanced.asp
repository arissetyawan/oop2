...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Filters Advanced</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Filters Advanced</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_filter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_error.asp">Next &#10095;</a>
</div>
<hr>

<h2>Validate an Integer Within a Range</h2>
<p>The following example uses the <code class="w3-codespan">filter_var()</code> function to check if a variable 
is both of type INT, and between 1 and 200:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$int = 122;<br>$min = 1;<br>$max = 200;<br><br>if (filter_var($int, FILTER_VALIDATE_INT, array(&quot;options&quot; =&gt; array(&quot;min_range&quot;=&gt;$min, &quot;max_range&quot;=&gt;$max))) === false) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;Variable value is not within the legal range&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;Variable value is within the legal range&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_filter_adv1">Run example &raquo;</a>
</div>
<hr>

<h2>Validate IPv6 Address</h2>
<p>The following example uses the <code class="w3-codespan">filter_var()</code> function to check if the variable $ip is a valid 
IPv6 address:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$ip = &quot;2001:0db8:85a3:08d3:1319:8a2e:0370:7334&quot;;<br><br>if (!filter_var($ip, FILTER_VALIDATE_IP, FILTER_FLAG_IPV6) === false) {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$ip is a valid IPv6 address&quot;);<br>} else {<br>&nbsp;&nbsp;&nbsp; echo(&quot;$ip is not a valid IPv6 address&quot;);<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_filter_adv2">Run example &raquo;</a>
</div>
<hr>
...
<p>The following example uses the <code class="w3-codespan">filter_var()</code> function to check if the variable $url is a 
URL with a querystring:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$url = "https://www.w3schools.com";<br><br>if (!filter_var($url, FILTER_VALIDATE_URL, FILTER_FLAG_QUERY_REQUIRED) === false) {<br>&nbsp;&nbsp;&nbsp; echo("$url is a valid URL");<br>} else {<br>&nbsp;&nbsp;&nbsp; echo("$url is not a valid URL");<br>}<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_filter_adv3">Run example &raquo;</a>
</div>
<hr>

<h2>Remove Characters With ASCII Value &gt; 127</h2>
<p>The following example uses the <code class="w3-codespan">filter_var()</code> function to sanitize a string. It 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_filter_adv4">Run example &raquo;</a>
</div>
<hr>
