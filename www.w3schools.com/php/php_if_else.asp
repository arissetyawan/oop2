...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 if...else...elseif Statements</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">if...else...elseif</span> Statements</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_operators.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_switch.asp">Next &#10095;</a>
</div>
<hr>
...
different conditions. You can use conditional statements in your code to do this.</p>
<p>In PHP we have the following conditional statements:</p>
<ul>
  <li><code class="w3-codespan">if</code> statement - executes some code if one condition is true</li>
  <li><code class="w3-codespan">if...else</code> statement - executes some code if a condition is true and another code if that condition is false</li>
  <li><code class="w3-codespan">if...elseif....else</code> statement  - executes different codes for more than two conditions</li>
  <li><code class="w3-codespan">switch</code> statement - selects one of many blocks of code to be executed</li>
</ul>
<hr>

<h2>PHP - The if Statement</h2>
<p>The <code class="w3-codespan">if</code> statement executes some code if one condition is true.</p>

<h3>Syntax</h3>
<div class="w3-code w3-border notranslate"><div>
if (<i>condition</i>) {<i><br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_if">Run example &raquo;</a>
</div>
<hr>
...
<p>The <code class="w3-codespan">if....else</code> statement executes some code if a condition is true and 
another code if that condition is false.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_if_else">Run example &raquo;</a>
</div>
<hr>

<h2>PHP - The if...elseif....else Statement</h2>
<p>The <code class="w3-codespan">if....elseif...else</code> statement executes different codes for more than two 
conditions.</p>
<h3>Syntax</h3>
<div class="w3-code w3-border notranslate"><div>
if (<i>condition</i>) {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_if_elseif">Run example &raquo;</a>
</div>
<hr>
<h2>PHP - The switch Statement</h2>
<p>The <code class="w3-codespan">switch</code> statement will be explained in the next chapter.</p>
