...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Multidimensional Arrays</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Multidimensional Arrays</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_form_complete.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_date.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Earlier in this tutorial, we have described arrays that are a 
single list of key/value pairs.</p>
<p class="intro">However, sometimes you want to store values with more than one 
key.</p>
<p class="intro">This can be stored in multidimensional arrays.</p>
<hr>

<h2>PHP - Multidimensional Arrays</h2>
<p>A multidimensional array is an array containing one or more arrays.</p>
<p>PHP understands multidimensional arrays that are two, three, four, five, or 
more levels deep. However, arrays more than three levels deep are hard to manage for most people.</p>

<div class="w3-panel w3-note"><p>
<strong>The dimension of an array indicates the number of indices you need to select an element.</strong>
</p><ul>
...
<div class="w3-code w3-border notranslate"><div>
 $cars = array<br>&nbsp; (<br>&nbsp; array(&quot;Volvo&quot;,22,18),<br>&nbsp; array(&quot;BMW&quot;,15,13),<br>&nbsp; array(&quot;Saab&quot;,5,2),<br>&nbsp; array(&quot;Land Rover&quot;,17,15)<br>&nbsp; );</div></div>

<p>Now the two-dimensional $cars array contains four arrays, and it has two indices: row and column.</p>
<p>To get access to the elements of the $cars array we must point to the two 
indices (row and column):</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_array_multi">Run example &raquo;</a>
</div>
<p>We can also put a <code class="w3-codespan">for</code> loop inside another <code class="w3-codespan">for</code> loop to get the elements of the 
$cars array (we still have to point to the two indices):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_array_multi2">Run example &raquo;</a>
</div>
