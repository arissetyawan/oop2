...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Global Variables - Superglobals</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Global Variables</span> - Superglobals</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_arrays_sort.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_forms.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>PHP $GLOBALS</h2>
<p>$GLOBALS is a PHP super global variable which is used to access global variables from anywhere in the PHP script (also from within 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_global_global">Run example &raquo;</a>
</div>

<p>In the example above, since z is a variable present within the $GLOBALS 
array, it is also accessible from outside the function! </p>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_global_server">Run example &raquo;</a>
</div>
...
<br>
 ...
 &lt;/form&gt;<br><br>&lt;?php<br>if ($_SERVER[&quot;REQUEST_METHOD&quot;] == &quot;POST&quot;) {<br>&nbsp;&nbsp;&nbsp; // collect value of input field<br>&nbsp;&nbsp;&nbsp; $name = $_REQUEST['fname'];<br>&nbsp;&nbsp;&nbsp; if (empty($name)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;Name is empty&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo $name;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>?&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_global_request" target="_blank">Run example &raquo;</a>
</div>
<hr>
...
<br>
 &lt;form method=&quot;post&quot; action=&quot;&lt;?php echo $_SERVER['PHP_SELF'];?&gt;&quot;&gt;<br>&nbsp; Name: &lt;input type=&quot;text&quot; name=&quot;fname&quot;&gt;<br>&nbsp; &lt;input type=&quot;submit&quot;&gt;<br>
 &lt;/form&gt;<br><br>&lt;?php<br>if ($_SERVER[&quot;REQUEST_METHOD&quot;] == &quot;POST&quot;) {<br>&nbsp;&nbsp;&nbsp; // collect value of input field<br>&nbsp;&nbsp;&nbsp; $name = $_POST['fname'];<br>&nbsp;&nbsp;&nbsp; if (empty($name)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;Name is empty&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo $name;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>?&gt;<br>
<br>
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_global_post" target="_blank">Run example &raquo;</a>
</div>
<hr>
...
&lt;/body&gt;<br>
&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_global_get" target="_blank">Run example &raquo;</a>
</div>
