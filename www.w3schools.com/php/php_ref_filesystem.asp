...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Filesystem Functions</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="php_ref_error.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_ref_filter.asp">Next &#10095;</a>
</div>
<hr>
...
<p>When specifying a path on Unix platforms, a forward slash (/) is used as directory separator.</p>
<p>On Windows platforms, both 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>delete()</td>
    <td>See <a href="func_filesystem_unlink.asp">unlink()</a> or unset()</td>
  </tr>
  <tr>
