...
<h1>PHP 5 <span class="color_h1">File Handling</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_includes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_file_open.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">File handling is an important part of any web application. You 
often need to open and process a file for different tasks.</p>
<hr>
...
<p><strong>Be careful when manipulating files!</strong></p>When you are manipulating files you must be very careful. 
<p>You can do a 
...
<p>The <code class="w3-codespan">readfile()</code> function reads a file and writes it to the output buffer.</p>
<p>Assume we have a text file called &quot;webdictionary.txt&quot;, stored on the 
server, that looks like this:</p>
...
<p>The PHP code to read the file and write it to the output buffer is as follows 
(the <code class="w3-codespan">readfile()</code> function returns the number of bytes read on success):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>echo readfile(&quot;webdictionary.txt&quot;);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_file_readfile">Run example &raquo;</a>
</div>
<p>The <code class="w3-codespan">readfile()</code> function is useful if all you want to do is open up a file and read its contents.</p>
<p>The next chapters will teach you more about file handling.</p>
