...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Variables</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="php_syntax.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_echo_print.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_var">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_var2">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_var3">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_var4">Run example &raquo;</a>
</div>
<p><strong>Note:</strong> You will learn more about the <code class="w3-codespan">echo</code> statement and how 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_var_global">Run example &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>function myTest() {<br>&nbsp;&nbsp;&nbsp; $x = 5; // local scope<br>&nbsp;&nbsp;&nbsp; echo &quot;&lt;p&gt;Variable x inside function is: $x&lt;/p&gt;&quot;;<br>} <br>myTest();<br><br>// using x outside the function will generate an error<br>echo &quot;&lt;p&gt;Variable x outside function is: $x&lt;/p&gt;&quot;;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_var_local">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_var_global_keyword">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_var_globals">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_var_static">Run example &raquo;</a>
</div>
