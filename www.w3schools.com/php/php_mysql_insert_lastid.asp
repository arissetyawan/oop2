...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Get ID of Last Inserted Record</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Get ID of Last Inserted Record</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_mysql_insert.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_mysql_insert_multiple.asp">Next &#10095;</a>
</div>
<hr>
<h2>Get ID of The Last Inserted Record</h2>
<p>If we perform an INSERT or UPDATE on a table with an AUTO_INCREMENT field, we can 
get the ID of the last inserted/updated record immediately.</p>
<p>In the table &quot;MyGuests&quot;, the &quot;id&quot; column is an AUTO_INCREMENT 
field:</p>
...
<p>The following examples are equal to the examples from the previous page (<a href="php_mysql_insert.asp">PHP Insert Data Into 
MySQL</a>), except that we have added one single line of code to retrieve the ID 
of the last inserted record. We also echo the last inserted ID:</p>

<div class="w3-example">
<h3>Example (MySQLi Object-oriented)</h3>
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>$password = &quot;password&quot;;<br>$dbname = &quot;myDB&quot;;<br><br>// Create connection<br>$conn = new mysqli($servername, $username, $password, $dbname);<br>
 // Check connection<br>
 if ($conn-&gt;connect_error)&nbsp;{<br>
&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . $conn-&gt;connect_error);<br>}
<br>
 <br>$sql = &quot;INSERT INTO MyGuests (firstname, lastname, email)<br>
 VALUES ('John', 'Doe', 'john@example.com')&quot;;<br>
 <br>if ($conn-&gt;query($sql) === TRUE) {<br>&nbsp;&nbsp;&nbsp; $last_id = $conn-&gt;insert_id;<br>&nbsp;&nbsp;&nbsp; echo &quot;New record created successfully. Last inserted ID is: &quot; . $last_id;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error: &quot; . $sql . &quot;&lt;br&gt;&quot; . $conn-&gt;error;<br>}<br><br>$conn-&gt;close();<br>
?&gt;
</div>
<br>
</div>
...
$conn = mysqli_connect($servername, $username, $password, $dbname);<br>
 // Check connection<br>
 if (!$conn)&nbsp;{<br>
&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . mysqli_connect_error());<br>}<br><br>$sql = &quot;INSERT INTO MyGuests (firstname, lastname, email)<br>
 VALUES ('John', 'Doe', 'john@example.com')&quot;;<br>
 <br>if (mysqli_query($conn, $sql)) {<br>&nbsp;&nbsp;&nbsp; $last_id = mysqli_insert_id($conn);<br>&nbsp;&nbsp;&nbsp; echo &quot;New record created successfully. Last inserted ID is: &quot; . $last_id;<br>} else {<br>&nbsp; &nbsp; echo &quot;Error: &quot; . $sql . &quot;&lt;br&gt;&quot; . mysqli_error($conn);<br>}<br><br>mysqli_close($conn);<br>
?&gt;
</div>
<br>
</div>
...
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>
 $password = &quot;password&quot;;<br>$dbname = &quot;myDBPDO&quot;;<br><br>try {<br>&nbsp;&nbsp;&nbsp; $conn = new PDO(&quot;mysql:host=$servername;dbname=$dbname&quot;, $username, $password);<br>&nbsp;&nbsp;&nbsp; // set the PDO error mode to exception<br>&nbsp;&nbsp;&nbsp; $conn-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);<br>&nbsp;&nbsp;&nbsp; $sql = &quot;INSERT INTO MyGuests (firstname, lastname, email)<br>
 &nbsp;&nbsp;&nbsp;
 VALUES ('John', 'Doe', 'john@example.com')&quot;;<br>
 &nbsp;&nbsp;&nbsp; // use exec() because no results are returned<br>&nbsp;&nbsp;&nbsp; $conn-&gt;exec($sql);<br>&nbsp;&nbsp;&nbsp; $last_id = $conn-&gt;lastInsertId();<br>&nbsp;&nbsp;&nbsp; echo &quot;New record created successfully. Last inserted ID is: &quot; . $last_id;<br>&nbsp;&nbsp;&nbsp; }<br>catch(PDOException $e)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; echo $sql . &quot;&lt;br&gt;&quot; . $e-&gt;getMessage();<br>&nbsp;&nbsp;&nbsp; }<br>
 <br>$conn = null;<br>
?&gt;
</div>
<br>
