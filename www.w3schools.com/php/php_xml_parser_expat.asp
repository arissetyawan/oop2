...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP XML Expat Parser</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="php_xml_simplexml_get.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_xml_dom.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The built-in XML Expat Parser makes it possible to process XML 
documents in PHP.</p>
<hr>

<h2>The XML Expat Parser</h2>
...
<h2>The XML File</h2>
<p>The XML file &quot;note.xml&quot; will be used in the example below:</p>
<div class="w3-code w3-border notranslate"><div>
...
<h2>Initializing the XML Expat Parser</h2>
<p>We want to initialize the XML Expat Parser in PHP, define some handlers for different 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_xml">Run example &raquo;</a>
</div>

<p>Example explained:</p>
<ol>
  <li>Initialize the XML parser with the <code class="w3-codespan">xml_parser_create()</code> function</li>
  <li>Create functions to use with the different event handlers</li>
  <li>Add the <code class="w3-codespan">xml_set_element_handler()</code> function to specify which function will be executed when the parser encounters the opening and closing tags</li>
  <li>Add the <code class="w3-codespan">xml_set_character_data_handler()</code> function to specify which function will execute when the parser encounters character data</li>
  <li>Parse the file &quot;note.xml&quot; with the <code class="w3-codespan">xml_parse()</code> function</li>
  <li>In case of an error, add <code class="w3-codespan">xml_error_string()</code> function to convert an XML error to a textual description</li>
  <li>Call the <code class="w3-codespan">xml_parser_free()</code> function to release the memory allocated with the <code class="w3-codespan">xml_parser_create()</code> function</li>
</ol>
<hr>

<h2>More PHP XML Expat Parser</h2>
