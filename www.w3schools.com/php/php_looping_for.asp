...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 for loops</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">for</span> Loops</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_looping.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_functions.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">PHP <code class="w3-codespan">for</code> loops execute a block of code a specified number of times.</p>
<hr>

<h2>The PHP for Loop</h2>
<p>The <code class="w3-codespan">for</code> loop is used when you know in advance how many times the script should run.</p>
<h3>Syntax</h3>
...
{<br>
 &nbsp;&nbsp;&nbsp; echo &quot;The number is: $x &lt;br&gt;&quot;;<br>} <br>?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_loop_for">Run example &raquo;</a>
</div>
<hr>

<h2>The PHP foreach Loop</h2>
<p>The <code class="w3-codespan">foreach</code> loop works only on arrays, and is used to loop through each key/value pair in an array.</p>
<h3>Syntax</h3>
<div class="w3-code w3-border notranslate"><div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_loop_foreach">Run example &raquo;</a>
</div>
