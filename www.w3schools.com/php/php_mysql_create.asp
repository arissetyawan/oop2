...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Create MySQL Database</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Create a MySQL Database</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_mysql_connect.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_mysql_create_table.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">A database consists of one or more tables. </p>
<p class="intro">You will need special CREATE privileges to create or to delete a MySQL 
database.</p>
<hr>
...
<br>
 <br>// Create database<br>
 $sql = &quot;CREATE DATABASE myDB&quot;;<br>if ($conn-&gt;query($sql) === TRUE) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Database created successfully&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error creating database: &quot; . $conn-&gt;error;<br>}<br><br>$conn-&gt;close();<br>
?&gt;
</div>
<br>
</div>
...
<p><strong>Note:</strong> When you create a new database, you must only specify 
the first three arguments to the mysqli object (servername, username and 
password).<br><br><strong>Tip:</strong> If you have to use a specific port,
add an empty string for the database-name argument, like this: new mysqli(&quot;localhost&quot;, 
&quot;username&quot;, &quot;password&quot;, &quot;&quot;, port)</p>
</div>
<hr>
...
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>$password = &quot;password&quot;;<br><br>// Create connection<br>
$conn = mysqli_connect($servername, $username, $password);<br>
 // Check connection<br>
 if (!$conn)&nbsp;{<br>
&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . mysqli_connect_error());<br>}<br><br>// Create database<br>
 $sql = &quot;CREATE DATABASE myDB&quot;;<br>
 if (mysqli_query($conn, $sql)) {<br>&nbsp; &nbsp; echo &quot;Database created successfully&quot;;<br>} else {<br>&nbsp; &nbsp; echo &quot;Error creating database: &quot; . mysqli_error($conn);<br>}<br><br>mysqli_close($conn);<br>
?&gt;
</div>
<br>
</div>
<p><strong>Note:</strong> The following PDO example create a database named &quot;myDBPDO&quot;:</p>
<div class="w3-example">
<h3>Example (PDO)</h3>
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>
 $password = &quot;password&quot;;<br><br>try {<br>&nbsp;&nbsp;&nbsp; $conn = new PDO(&quot;mysql:host=$servername&quot;, $username, $password);<br>&nbsp;&nbsp;&nbsp; // set the PDO error mode to exception<br>&nbsp;&nbsp;&nbsp; $conn-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);<br>&nbsp;&nbsp;&nbsp; $sql = &quot;CREATE DATABASE myDBPDO&quot;;<br>&nbsp;&nbsp;&nbsp; // use exec() because no results are returned<br>&nbsp;&nbsp;&nbsp; $conn-&gt;exec($sql);<br>&nbsp;&nbsp;&nbsp; echo &quot;Database created successfully&lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>catch(PDOException $e)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; echo $sql . &quot;&lt;br&gt;&quot; . $e-&gt;getMessage();<br>&nbsp;&nbsp;&nbsp; }<br>
 <br>$conn = null;<br>
?&gt;
</div>
<br>
</div>
<p><strong>Tip:</strong> A great benefit of PDO is that it has exception class to handle any problems that may 
