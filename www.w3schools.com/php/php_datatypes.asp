...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Data Types</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Data Types</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_echo_print.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_string.asp">Next &#10095;</a>
</div>
<hr>
<h2>PHP Data Types</h2>
<p>Variables can store data of different types, and different data types can do 
different things.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_datatypes_string">Run example &raquo;</a></div>
<hr>

<h2>PHP Integer</h2>
<p>An integer data type is a non-decimal number between -2,147,483,648 and 
2,147,483,647.</p>
...
<p>In the following example $x is an integer. The PHP var_dump() 
function returns the data type and value:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php <br>$x = 5985;<br>var_dump($x);<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_datatypes_integer">Run example &raquo;</a></div>
<hr>
...
<p>In the following example $x is a float. The PHP var_dump() 
function returns the data type and value:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php <br>$x = 10.365;<br>var_dump($x);<br>?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_datatypes_float">Run example &raquo;</a></div>
<hr>
...
<p>In the following example $cars is an array. The PHP var_dump() 
function returns the data type and value:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 ...
 ?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_datatypes_array">Run example &raquo;</a></div>
...
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>class Car {<br>&nbsp;&nbsp;&nbsp; function Car() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $this-&gt;model = &quot;VW&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br><br>// create an object<br>
 $herbie = new Car();<br><br>// show object properties<br>echo $herbie-&gt;model;<br>?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_datatypes_object">Run example &raquo;</a></div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_datatypes_null">Run example &raquo;</a></div>
<hr>

<h2>PHP Resource</h2>
<p>The special resource type is not an actual data type. It is the storing of a 
reference to functions and resources external to PHP.</p>
<p>A common example of 
using the resource data type is a database call.</p>
