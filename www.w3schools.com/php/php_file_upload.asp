...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 File Upload</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">File Upload</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_file_create.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_cookies.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">With PHP, it is easy to upload files to the server.</p>
<p class="intro">However, with ease comes danger, so always be careful when 
allowing file uploads!</p>
<hr>

<h2>Configure The &quot;php.ini&quot; File</h2>
<p>First, ensure that PHP is configured to allow file uploads.</p>
<p>In your &quot;php.ini&quot; file, search for the <code class="w3-codespan">file_uploads</code> directive, and set it to On:</p>
...
enctype=&quot;multipart/form-data&quot;&gt;<br>&nbsp;&nbsp;&nbsp; Select image to upload:<br>&nbsp;&nbsp;&nbsp; &lt;input type=&quot;file&quot; name=&quot;fileToUpload&quot; id=&quot;fileToUpload&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;input type=&quot;submit&quot; value=&quot;Upload Image&quot; name=&quot;submit&quot;&gt;<br>
...
&lt;?php<br>$target_dir = &quot;uploads/&quot;;<br>$target_file = $target_dir . basename($_FILES[&quot;fileToUpload&quot;][&quot;name&quot;]);<br>$uploadOk = 1;<br>$imageFileType = 
  strtolower(pathinfo($target_file,PATHINFO_EXTENSION));<br>// Check if image file is a actual image or fake image<br>if(isset($_POST[&quot;submit&quot;])) {<br>&nbsp;&nbsp;&nbsp; $check = getimagesize($_FILES[&quot;fileToUpload&quot;][&quot;tmp_name&quot;]);<br>&nbsp;&nbsp;&nbsp; if($check !== false) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;File is an image - &quot; . $check[&quot;mime&quot;] . &quot;.&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $uploadOk = 1;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;File is not an image.&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $uploadOk = 0;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>?&gt;
</div>
</div>
...
<p><strong>Note:</strong> You will need to create a new directory called 
&quot;uploads&quot; in the 
...
<p>First, we will check if the file already exists in the &quot;uploads&quot; folder. If 
it does, an error message is displayed, and $uploadOk is set to 0:</p>
<div class="w3-example">
<div class="w3-code htmlHigh notranslate">
// Check if file already exists<br>if (file_exists($target_file)) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Sorry, file already exists.&quot;;<br>&nbsp;&nbsp;&nbsp; $uploadOk = 0;<br>
 } </div>
</div>
<hr>
...
// Check file size<br>if ($_FILES[&quot;fileToUpload&quot;][&quot;size&quot;] &gt; 500000) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Sorry, your file is too large.&quot;;<br>&nbsp;&nbsp;&nbsp; $uploadOk = 0;<br>
 } </div>
</div>
<hr>

<h2>Limit File Type</h2>
<p>The code below only allows users to upload JPG, JPEG, PNG, and GIF files. All other 
file types gives an error message before setting $uploadOk to 0:</p>
<div class="w3-example">
<div class="w3-code phpHigh notranslate">
// Allow certain file formats<br>if($imageFileType != &quot;jpg&quot; &amp;&amp; $imageFileType  != &quot;png&quot; &amp;&amp; $imageFileType != &quot;jpeg&quot;<br>&amp;&amp; $imageFileType != &quot;gif&quot; ) {<br>&nbsp;&nbsp;&nbsp;  echo &quot;Sorry, only JPG, JPEG, PNG &amp; GIF files are allowed.&quot;;<br>&nbsp;&nbsp;&nbsp;  $uploadOk = 0;<br>}
</div>
</div>
<hr>
...
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>$target_dir = &quot;uploads/&quot;;<br>$target_file = $target_dir . basename($_FILES[&quot;fileToUpload&quot;][&quot;name&quot;]);<br>$uploadOk = 1;<br>$imageFileType = 
  strtolower(pathinfo($target_file,PATHINFO_EXTENSION));<br>// Check if image file is a actual image or fake image<br>if(isset($_POST[&quot;submit&quot;])) {<br>&nbsp;&nbsp;&nbsp; $check = getimagesize($_FILES[&quot;fileToUpload&quot;][&quot;tmp_name&quot;]);<br>&nbsp;&nbsp;&nbsp; if($check !== false) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;File is an image - &quot; . $check[&quot;mime&quot;] . &quot;.&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $uploadOk = 1;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;File is not an image.&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $uploadOk = 0;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>// Check if file already exists<br>if (file_exists($target_file)) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Sorry, file already exists.&quot;;<br>&nbsp;&nbsp;&nbsp; $uploadOk = 0;<br>}<br>
 // Check file size<br>if ($_FILES[&quot;fileToUpload&quot;][&quot;size&quot;] &gt; 500000) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Sorry, your file is too large.&quot;;<br>&nbsp;&nbsp;&nbsp; $uploadOk = 0;<br>
 }<br>// Allow certain file formats<br>if($imageFileType != &quot;jpg&quot; &amp;&amp; $imageFileType != &quot;png&quot; &amp;&amp; $imageFileType != &quot;jpeg&quot;<br>&amp;&amp; $imageFileType != &quot;gif&quot; ) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Sorry, only JPG, JPEG, PNG &amp; GIF files are allowed.&quot;;<br>&nbsp;&nbsp;&nbsp; $uploadOk = 0;<br>}<br>// Check if $uploadOk is set to 0 by an error<br>if ($uploadOk == 0) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Sorry, your file was not uploaded.&quot;;<br>// if everything is ok, try to upload file<br>} else {<br>&nbsp;&nbsp;&nbsp; if (move_uploaded_file($_FILES[&quot;fileToUpload&quot;][&quot;tmp_name&quot;], $target_file)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;The file &quot;. basename( $_FILES[&quot;fileToUpload&quot;][&quot;name&quot;]). &quot; has been uploaded.&quot;;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;Sorry, there was an error uploading your file.&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>?&gt;
</div>
</div>
<hr>
