...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 File Open/Read/Close</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">File Open/Read/Close</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_file.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_file_create.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">In this chapter we will teach you how to open, read, and close a file 
on the server.</p>
<hr>

<h2>PHP Open File - fopen()</h2>
<p>A better method to open files is with the <code class="w3-codespan">fopen()</code> function. This function gives you more 
options than the <code class="w3-codespan">readfile()</code> function.</p>
...
<p>The first parameter of <code class="w3-codespan">fopen()</code> contains the name of the file to be opened and the 
second parameter specifies in which mode the file should be opened. The following example 
also generates a message if the fopen() function is unable to open the specified file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$myfile = fopen(&quot;webdictionary.txt&quot;, &quot;r&quot;) or die(&quot;Unable to open file!&quot;);<br>echo fread($myfile,filesize(&quot;webdictionary.txt&quot;));<br>
 fclose($myfile);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_file_fopen">Run example &raquo;</a>
</div>
<p><strong>Tip:</strong> The <code class="w3-codespan">fread()</code> and the <code class="w3-codespan">fclose()</code> functions will be 
explained below.</p>
...
<p>The <code class="w3-codespan">fread()</code> function reads from an open file.</p>
<p>The first parameter of <code class="w3-codespan">fread()</code> contains the name of the file to read from and 
the second parameter specifies the maximum number of bytes to read.</p>
...
<p>The <code class="w3-codespan">fclose()</code> function is used to close an open file.</p>

<div class="w3-panel w3-note">
<p>It's a good programming practice to close all files after you have finished with them. 
You don't want an open file running around on your 
server taking up resources!</p>
</div>

<p>The <code class="w3-codespan">fclose()</code> requires the name of the file (or a variable that holds the 
filename) we want to close:</p>
<div class="w3-code w3-border notranslate htmlHigh">
 <div>
&lt;?php<br>
 $myfile = fopen(&quot;webdictionary.txt&quot;, &quot;r&quot;);<br>// some code to be executed....<br>
 fclose($myfile);<br>
?&gt;
</div></div>
<hr>
...
<p>The <code class="w3-codespan">fgets()</code> function is used to read a single line from a file.</p>
<p>The example below outputs the first line of the &quot;webdictionary.txt&quot; file:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$myfile = fopen(&quot;webdictionary.txt&quot;, &quot;r&quot;) or die(&quot;Unable to open file!&quot;);<br>echo fgets($myfile);<br>
 fclose($myfile);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_file_fgets">Run example &raquo;</a>
</div>
<p><b>Note:</b> After a call to the <code class="w3-codespan">fgets()</code> function, the file pointer has moved to the next line.</p>
<hr>

<h2>PHP Check End-Of-File - feof()</h2>
<p>The <code class="w3-codespan">feof()</code> function checks if the &quot;end-of-file&quot; (EOF) has been reached.</p>
<p>The <code class="w3-codespan">feof()</code> function is useful for looping through data of unknown length.</p>
<p>The example below reads the &quot;webdictionary.txt&quot; file line by line, until end-of-file is reached:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$myfile = fopen(&quot;webdictionary.txt&quot;, &quot;r&quot;) or die(&quot;Unable to open file!&quot;);<br>// Output one line until end-of-file<br>while(!feof($myfile)) {<br>&nbsp;&nbsp;echo fgets($myfile) . &quot;&lt;br&gt;&quot;;<br>}<br>fclose($myfile);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_file_feof">Run example &raquo;</a>
</div>
<hr>

<h2>PHP Read Single Character - fgetc()</h2>
<p>The <code class="w3-codespan">fgetc()</code> function is used to read a single character from a file.</p>
<p>The example below reads the &quot;webdictionary.txt&quot; file character by 
character, until end-of-file is reached:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$myfile = fopen(&quot;webdictionary.txt&quot;, &quot;r&quot;) or die(&quot;Unable to open file!&quot;);<br>// Output one character until end-of-file<br>while(!feof($myfile)) {<br>&nbsp;&nbsp;echo fgetc($myfile);<br>}<br>fclose($myfile);<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_file_fgetc">Run example &raquo;</a>
</div>
<p><b>Note:</b> After a call to the <code class="w3-codespan">fgetc()</code> function, the file pointer moves to the next character.</p>
<hr>
