...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Create MySQL Table</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Create MySQL Tables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_mysql_create.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_mysql_insert.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">A database table has its own unique name and consists of 
columns and rows.</p>
<hr>

<h2>Create a MySQL Table Using MySQLi and PDO</h2>
<p>The CREATE TABLE statement is used to create a table in MySQL.</p>
<p>We will create a table named &quot;MyGuests&quot;, with 
five columns: &quot;id&quot;, &quot;firstname&quot;, &quot;lastname&quot;, &quot;email&quot; and &quot;reg_date&quot;:</p>
...
<p><b>Notes on the table above:</b></p>
...
<a href="/sql/sql_datatypes.asp">Data Types reference</a>.</p>
<p>After the data type, you can specify other optional attributes for each 
column:</p>
<ul>
...
<p>Each table should have a primary key column (in this case: the &quot;id&quot; column). 
Its value must be unique for each record in the table.</p>
...
<br>
 <br>// sql to create table<br>
 $sql = &quot;CREATE TABLE MyGuests (<br>id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, <br>firstname VARCHAR(30) NOT NULL,<br>lastname VARCHAR(30) NOT NULL,<br>email VARCHAR(50),<br>reg_date TIMESTAMP<br>)&quot;;<br>
 <br>if ($conn-&gt;query($sql) === TRUE) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Table MyGuests created successfully&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error creating table: &quot; . $conn-&gt;error;<br>}<br><br>$conn-&gt;close();<br>
?&gt;
</div>
<br>
</div>
...
$conn = mysqli_connect($servername, $username, $password, $dbname);<br>
 // Check connection<br>
 if (!$conn)&nbsp;{<br>
&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . mysqli_connect_error());<br>}<br><br>// sql to create table<br>
 $sql = &quot;CREATE TABLE MyGuests (<br>id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, <br>firstname VARCHAR(30) NOT NULL,<br>lastname VARCHAR(30) NOT NULL,<br>email VARCHAR(50),<br>reg_date TIMESTAMP<br>)&quot;;<br>
 <br>if (mysqli_query($conn, $sql)) {<br>&nbsp; &nbsp; echo &quot;Table MyGuests created successfully&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error creating table: &quot; . mysqli_error($conn);<br>}<br><br>mysqli_close($conn);<br>
?&gt;
</div>
<br>
</div>
...
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>
 $password = &quot;password&quot;;<br>$dbname = &quot;myDBPDO&quot;;<br><br>try {<br>&nbsp;&nbsp;&nbsp; $conn = new PDO(&quot;mysql:host=$servername;dbname=$dbname&quot;, $username, $password);<br>&nbsp;&nbsp;&nbsp; // set the PDO error mode to exception<br>&nbsp;&nbsp;&nbsp; $conn-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);<br><br>&nbsp;&nbsp;&nbsp; // sql to create table<br>
 &nbsp;&nbsp;&nbsp;
 $sql = &quot;CREATE TABLE MyGuests (<br>&nbsp;&nbsp;&nbsp; id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, <br>&nbsp;&nbsp;&nbsp; firstname VARCHAR(30) NOT NULL,<br>&nbsp;&nbsp;&nbsp; lastname VARCHAR(30) NOT NULL,<br>&nbsp;&nbsp;&nbsp; email VARCHAR(50),<br>&nbsp;&nbsp;&nbsp; reg_date TIMESTAMP<br>&nbsp;&nbsp;&nbsp; )&quot;;<br>
 <br>&nbsp;&nbsp;&nbsp; // use exec() because no results are returned<br>&nbsp;&nbsp;&nbsp; $conn-&gt;exec($sql);<br>&nbsp;&nbsp;&nbsp; echo &quot;Table MyGuests created successfully&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>catch(PDOException $e)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; echo $sql . &quot;&lt;br&gt;&quot; . $e-&gt;getMessage();<br>&nbsp;&nbsp;&nbsp; }<br>
 <br>$conn = null;<br>
?&gt;
</div>
<br>
