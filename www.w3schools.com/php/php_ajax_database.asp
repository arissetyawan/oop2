...
<a class="w3-left w3-btn" href="php_ajax_php.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_ajax_xml.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-padding w3-white w3-margin-bottom notranslate">
<form>
...
<p>In the example above, when a user selects a person in the dropdown list 
above, a function called &quot;showUser()&quot; is executed.</p>
<p>The function is triggered by the onchange event.</p>
<p>Here is the HTML code:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;html&gt;<br>&lt;head&gt;<br>&lt;script&gt;<br>function showUser(str) {<br>&nbsp;&nbsp;&nbsp; if (str == &quot;&quot;) {<br>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;txtHint&quot;).innerHTML = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return;<br>
 &nbsp;&nbsp;&nbsp; } else { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (window.XMLHttpRequest) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // code for IE7+, Firefox, Chrome, Opera, Safari<br>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xmlhttp = new XMLHttpRequest();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; // code for IE6, IE5<br>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xmlhttp = new ActiveXObject(&quot;Microsoft.XMLHTTP&quot;);<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xmlhttp.onreadystatechange = function() {<br>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (this.readyState == 4 &amp;&amp; this.status == 200) {<br>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;txtHint&quot;).innerHTML = this.responseText;<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; };<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xmlhttp.open(&quot;GET&quot;,&quot;getuser.php?q=&quot;+str,true);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; xmlhttp.send();<br>&nbsp;&nbsp;&nbsp; }<br>}<br>&lt;/script&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br><br>&lt;form&gt;<br>
 &lt;select name=&quot;users&quot; onchange=&quot;showUser(this.value)&quot;&gt;<br>&nbsp; &lt;option value=&quot;&quot;&gt;Select a person:&lt;/option&gt;<br>&nbsp; &lt;option value=&quot;1&quot;&gt;Peter Griffin&lt;/option&gt;<br>&nbsp; &lt;option value=&quot;2&quot;&gt;Lois Griffin&lt;/option&gt;<br>&nbsp; &lt;option value=&quot;3&quot;&gt;Joseph Swanson&lt;/option&gt;<br>&nbsp; &lt;option value=&quot;4&quot;&gt;Glenn Quagmire&lt;/option&gt;<br>&nbsp; &lt;/select&gt;<br>&lt;/form&gt;<br>&lt;br&gt;<br>&lt;div id=&quot;txtHint&quot;&gt;&lt;b&gt;Person info will be listed here...&lt;/b&gt;&lt;/div&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_ajax_mysql">Run example &raquo;</a>
</div>

<p>Code explanation:</p>
<p>First, check if person is selected. If no person is selected (str == &quot;&quot;), clear the 
content of txtHint and exit the function. If a person is selected, do the following:</p>
<ul>
...
<div class="w3-code htmlHigh notranslate">
 &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>&lt;style&gt;<br>table {<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; border-collapse: collapse;<br>}<br><br>
 table, td, th {<br>&nbsp;&nbsp;&nbsp; border: 1px solid black;<br>&nbsp;&nbsp;&nbsp; padding: 5px;<br>}<br><br>th {text-align: left;}<br>&lt;/style&gt;<br>&lt;/head&gt;<br>
 &lt;body&gt;<br><br>&lt;?php<br>$q = intval($_GET['q']);<br>
<br>
