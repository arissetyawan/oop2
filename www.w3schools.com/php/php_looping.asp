...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 while Loops</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">while</span>  Loops</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_switch.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_looping_for.asp">Next &#10095;</a>
</div>
<hr>
...
<ul>
  <li><code class="w3-codespan">while</code> - loops through a block of code as long as the specified condition is true</li>
  <li><code class="w3-codespan">do...while</code> - loops through a block of code once, and then repeats the loop 
  as long as the specified condition is true</li>
  <li><code class="w3-codespan">for</code> - loops through a block of code a specified number of times</li>
  <li><code class="w3-codespan">foreach</code> - loops through a block of code for each element in an 
  array</li>
</ul>
<hr>

<h2>The PHP while Loop</h2>
<p>The <code class="w3-codespan">while</code> loop executes a block of code as long as the specified condition is true.</p>
<h3>Syntax</h3>
...
<p>The example below first sets a variable $x to 1 ($x = 1). Then, the while loop will continue to run as long as $x is less than, or equal to 5 
($x &lt;= 5). $x will increase by 1 each time 
the loop runs ($x++):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php <br>$x = 1; <br><br>while($x &lt;= 5) {<br>&nbsp;&nbsp;&nbsp; echo &quot;The number is: $x &lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; $x++;<br>} <br>?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_loop_while">Run example &raquo;</a>
</div>
<hr>
...
<p>The <code class="w3-codespan">do...while</code> loop will always execute the block of code once, it 
...
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php <br>$x = 1; <br><br>do {<br>&nbsp;&nbsp;&nbsp; echo &quot;The number is: $x &lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; $x++;<br>} while ($x &lt;= 5);<br>?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_loop_do_while">Run example &raquo;</a>
</div>

<p>Notice that in a <code class="w3-codespan">do while</code> loop the condition is tested AFTER executing 
the statements within the loop. This means that the <code class="w3-codespan">do while</code> loop would execute 
its statements at least once, even if the condition is false the first time.</p>
<p>The example below sets the $x variable to 6, then it runs the loop, <strong>
and then the condition is checked</strong>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php <br>$x = 6;<br> <br>do {<br>&nbsp; &nbsp; echo &quot;The number is: $x &lt;br&gt;&quot;;<br>&nbsp;&nbsp;&nbsp; $x++;<br>} while ($x &lt;= 5);<br>?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_loop_do_while2">Run example &raquo;</a>
</div>

<p>The <code class="w3-codespan">for</code> loop and the <code class="w3-codespan">foreach</code> loop will be explained in the next chapter.</p>
