...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP SimpleXML Parser</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">SimpleXML Parser</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_xml_parsers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_xml_simplexml_get.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>The SimpleXML Parser</h2>
<p>SimpleXML is a tree-based parser.</p>
<p>SimpleXML provides an easy way of getting an element's name, attributes and textual 
content if you know the XML document's structure or layout.</p>
<p>SimpleXML turns an XML document into a data structure you can iterate through 
like a collection of arrays and objects.</p>
<p>Compared to DOM or the Expat parser, SimpleXML takes a fewer lines of code to 
read text data from an element.</p>
<hr>
...
<h2>PHP SimpleXML - Read From String</h2>
<p>The PHP <code class="w3-codespan">simplexml_load_string()</code> function is used to read XML data from a string.</p>
<p>Assume we have a variable that contains XML data, like this:</p>
<div class="w3-example">
<div class="w3-code htmlHigh notranslate">
$myXMLData = <br>&quot;&lt;?xml version='1.0' encoding='UTF-8'?&gt;<br>
&lt;note&gt;<br>
&lt;to&gt;Tove&lt;/to&gt;<br>
&lt;from&gt;Jani&lt;/from&gt;<br>
...
<p>The example below shows how to use the <code class="w3-codespan">simplexml_load_string()</code> function to 
read XML data from a string:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>$myXMLData =<br>&quot;&lt;?xml version='1.0' encoding='UTF-8'?&gt;<br>
&lt;note&gt;<br>
&lt;to&gt;Tove&lt;/to&gt;<br>
&lt;from&gt;Jani&lt;/from&gt;<br>
&lt;heading&gt;Reminder&lt;/heading&gt;<br>
&lt;body&gt;Don't forget me this weekend!&lt;/body&gt;<br>
&lt;/note&gt;&quot;;<br><br>
$xml=simplexml_load_string($myXMLData) or die(&quot;Error: Cannot create object&quot;);<br>print_r($xml);<br>
?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_simplexml_read_string">Run example &raquo;</a>
</div>
<p>The output of the code above will be:</p>
<div class="w3-code w3-border notranslate"><div>
 SimpleXMLElement Object ( [to] =&gt; Tove [from] =&gt; Jani [heading] =&gt; Reminder [body] =&gt; Don't forget me this weekend! )
</div></div>
<p><strong>Error Handling Tip:</strong> Use the libxml functionality to retrieve 
all XML errors when loading the document and then iterate over the errors. The 
following example tries to load a broken XML string:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>libxml_use_internal_errors(true);<br>$myXMLData =<br>&quot;&lt;?xml version='1.0' encoding='UTF-8'?&gt; <br>&lt;document&gt; <br>&lt;user&gt;John Doe&lt;/wronguser&gt; <br>&lt;email&gt;john@example.com&lt;/wrongemail&gt;
 <br>&lt;/document&gt;&quot;; <br><br>$xml = simplexml_load_string($myXMLData);<br>if ($xml === false) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Failed loading XML: &quot;;<br>&nbsp;&nbsp;&nbsp; foreach(libxml_get_errors() as $error) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; echo &quot;&lt;br&gt;&quot;, $error-&gt;message;<br>&nbsp;&nbsp;&nbsp; }<br>} else {<br>&nbsp;&nbsp;&nbsp; print_r($xml);<br>}<br>
?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_simplexml_read_string_error">Run example &raquo;</a>
</div>
<p>The output of the code above will be:</p>
<div class="w3-code w3-border notranslate"><div>
 Failed loading XML: <br>Opening and ending tag mismatch: user line 3 and wronguser<br>Opening and ending tag mismatch: email line 4 and wrongemail
</div></div>
<hr>
...
<h2>PHP SimpleXML - Read From File</h2>
<p>The PHP <code class="w3-codespan">simplexml_load_file()</code> function is used to read XML data from a file.</p>
<p>Assume we have an XML file called &quot;<a href="note.xml" target="_blank">note.xml</a>&quot;, 
...
<p>The example below shows how to use the <code class="w3-codespan">simplexml_load_file()</code> function to read 
XML data from a file:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;?php<br>
$xml=simplexml_load_file(&quot;note.xml&quot;) or die(&quot;Error: Cannot create object&quot;);<br>
 print_r($xml);<br>
?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_simplexml_read_file">Run example &raquo;</a>
</div>
<p>The output of the code above will be:</p>
<div class="w3-code w3-border notranslate"><div>
 SimpleXMLElement Object ( [to] =&gt; Tove [from] =&gt; Jani [heading] =&gt; Reminder [body] =&gt; Don't forget me this weekend! )
</div></div>
<p><strong>Tip:</strong> The next chapter shows how to get/retrieve node values 
from an XML file with SimpleXML!</p>
<hr>
