...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Update Data in MySQL</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Update Data in MySQL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_mysql_delete.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_mysql_select_limit.asp">Next &#10095;</a>
</div>
<hr>
...
<br>
 <br>$sql = &quot;UPDATE MyGuests SET lastname='Doe' WHERE id=2&quot;;<br>
 <br>if ($conn-&gt;query($sql) === TRUE) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Record updated successfully&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error updating record: &quot; . $conn-&gt;error;<br>}<br><br>$conn-&gt;close();<br>
?&gt;
</div>
<br>
</div>
...
$conn = mysqli_connect($servername, $username, $password, $dbname);<br>
 // Check connection<br>
 if (!$conn)&nbsp;{<br>
&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . mysqli_connect_error());<br>}<br><br>$sql = &quot;UPDATE MyGuests SET lastname='Doe' WHERE id=2&quot;;<br>
 <br>if (mysqli_query($conn, $sql)) {<br>&nbsp; &nbsp; echo &quot;Record updated successfully&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error updating record: &quot; . mysqli_error($conn);<br>}<br><br>mysqli_close($conn);<br>
?&gt;
</div>
<br>
</div>
...
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>
 $password = &quot;password&quot;;<br>$dbname = &quot;myDBPDO&quot;;<br><br>try {<br>&nbsp;&nbsp;&nbsp; $conn = new PDO(&quot;mysql:host=$servername;dbname=$dbname&quot;, $username, $password);<br>&nbsp;&nbsp;&nbsp; // set the PDO error mode to exception<br>&nbsp;&nbsp;&nbsp; $conn-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);<br><br>&nbsp;&nbsp;&nbsp;
 $sql = &quot;UPDATE MyGuests SET lastname='Doe' WHERE id=2&quot;;<br>
 <br>&nbsp;&nbsp;&nbsp; // Prepare statement<br>&nbsp;&nbsp;&nbsp; $stmt = $conn-&gt;prepare($sql);<br><br>&nbsp;&nbsp;&nbsp; // execute the query<br>&nbsp;&nbsp;&nbsp; $stmt-&gt;execute();<br><br>&nbsp;&nbsp;&nbsp; // echo a message to say the UPDATE succeeded<br>&nbsp;&nbsp;&nbsp; echo $stmt-&gt;rowCount() . &quot; records UPDATED successfully&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>catch(PDOException $e)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; echo $sql . &quot;&lt;br&gt;&quot; . $e-&gt;getMessage();<br>&nbsp;&nbsp;&nbsp; }<br>
 <br>$conn = null;<br>
?&gt;
</div>
<br>
