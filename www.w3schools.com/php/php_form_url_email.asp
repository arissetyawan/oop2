...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Forms Validate E-mail and URL</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Forms - Validate E-mail and URL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_form_required.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_form_complete.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">This chapter shows how to validate names, e-mails, and URLs.</p>
<hr>
...
if (!preg_match(&quot;/^[a-zA-Z ]*$/&quot;,$name)) {<br>&nbsp; $nameErr = &quot;Only letters and white space allowed&quot;; <br>}</div>
</div>

<div class="w3-panel w3-note"><p>
<p><strong>The preg_match() function searches a string for pattern, returning true if 
...
<p>The easiest and safest way to check whether an email address is well-formed 
is to use PHP's filter_var() function.</p>
