...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Cookies</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Cookies</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_file_upload.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_sessions.asp">Next &#10095;</a>
</div>
<hr>
...
<p>A cookie is created with the <code class="w3-codespan">setcookie()</code> function.</p>

<h3>Syntax</h3>
<div class="w3-code w3-border notranslate"><div>
setcookie(<em>name, value, expire, path, domain, secure, httponly</em>);</div></div>

<p>Only the <em>name</em> parameter is required. All other parameters are 
optional.</p>
<hr>

<h2>PHP Create/Retrieve a Cookie</h2>
<p>The following example creates a cookie named &quot;user&quot; with the value &quot;John 
...
$_COOKIE). We also use the <code class="w3-codespan">isset()</code> function to find out if the cookie is set:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_cookie1">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note"><p>
<p><strong><b>Note:</b></strong> The <code class="w3-codespan">setcookie()</code> function must appear BEFORE the &lt;html&gt; tag.</p>
</div>
...
URLencoding, use <code class="w3-codespan">setrawcookie()</code> instead).</p>
<hr>
...
<p>To modify a cookie, just set (again) the cookie using the <code class="w3-codespan">setcookie()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_cookie3">Run example &raquo;</a>
</div>
<hr>

<h2>Delete a Cookie</h2>
<p>To delete a cookie, use the <code class="w3-codespan">setcookie()</code> function with an expiration date in 
the past:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>// set the expiration date to one hour ago<br>setcookie(&quot;user&quot;, &quot;&quot;, time() - 3600);<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>echo &quot;Cookie 'user' is deleted.&quot;;<br>?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_cookie4">Run example &raquo;</a>
</div>
<hr>

<h2>Check if Cookies are Enabled</h2>
<p>The following example creates a small script that checks whether cookies are 
enabled. First, try to create a test cookie with the <code class="w3-codespan">setcookie()</code> function, then 
count the $_COOKIE array variable:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>setcookie(&quot;test_cookie&quot;, &quot;test&quot;, time() + 3600, '/');<br>?&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;?php<br>if(count($_COOKIE) &gt; 0) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookies are enabled.&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Cookies are disabled.&quot;;<br>}<br>
 ?&gt;<br><br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_cookie5">Run example &raquo;</a>
</div>
<hr>

<h2>Complete PHP HTTP Reference</h2>
<p>For a complete reference of HTTP functions, go to our complete
<a href="php_ref_http.asp">PHP HTTP Reference</a>.</p>
