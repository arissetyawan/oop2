...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Delete Data From MySQL</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Delete Data From MySQL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_mysql_select.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_mysql_update.asp">Next &#10095;</a>
</div>
<hr>
...
<br>
 <br>// sql to delete a record<br>
 $sql = &quot;DELETE FROM MyGuests WHERE id=3&quot;;<br>
 <br>if ($conn-&gt;query($sql) === TRUE) {<br>&nbsp;&nbsp;&nbsp; echo &quot;Record deleted successfully&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error deleting record: &quot; . $conn-&gt;error;<br>}<br><br>$conn-&gt;close();<br>
?&gt;
</div>
<br>
</div>
...
$conn = mysqli_connect($servername, $username, $password, $dbname);<br>
 // Check connection<br>
 if (!$conn)&nbsp;{<br>
&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . mysqli_connect_error());<br>}<br><br>// sql to delete a record<br>
 $sql = &quot;DELETE FROM MyGuests WHERE id=3&quot;;<br>
 <br>if (mysqli_query($conn, $sql)) {<br>&nbsp; &nbsp; echo &quot;Record deleted successfully&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error deleting record: &quot; . mysqli_error($conn);<br>}<br><br>mysqli_close($conn);<br>
?&gt;
</div>
<br>
</div>
...
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>
 $password = &quot;password&quot;;<br>$dbname = &quot;myDBPDO&quot;;<br><br>try {<br>&nbsp;&nbsp;&nbsp; $conn = new PDO(&quot;mysql:host=$servername;dbname=$dbname&quot;, $username, $password);<br>&nbsp;&nbsp;&nbsp; // set the PDO error mode to exception<br>&nbsp;&nbsp;&nbsp; $conn-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);<br><br>&nbsp;&nbsp;&nbsp; // sql to delete a record<br>
 &nbsp;&nbsp;&nbsp;
 $sql = &quot;DELETE FROM MyGuests WHERE id=3&quot;;<br>
 <br>&nbsp;&nbsp;&nbsp; // use exec() because no results are returned<br>&nbsp;&nbsp;&nbsp; $conn-&gt;exec($sql);<br>&nbsp;&nbsp;&nbsp; echo &quot;Record deleted successfully&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>catch(PDOException $e)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; echo $sql . &quot;&lt;br&gt;&quot; . $e-&gt;getMessage();<br>&nbsp;&nbsp;&nbsp; }<br>
 <br>$conn = null;<br>
?&gt;
</div>
<br>
...
<p>After the record is deleted, the table will look like this:</p>
<div class="w3-responsive">
<table class="w3-table-all notranslate">
  <tr>
    <th>id</th>
