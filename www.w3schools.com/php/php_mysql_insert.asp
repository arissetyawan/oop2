...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Insert Data Into MySQL</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Insert Data Into MySQL</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_mysql_create_table.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_mysql_insert_lastid.asp">Next &#10095;</a>
</div>
<hr>
<h2>Insert Data Into MySQL Using MySQLi and PDO</h2>
<p>After a database and a table have been created, we can start adding data in 
them.</p>
...
<p>In the previous chapter we created an empty table named &quot;MyGuests&quot; with 
five columns: &quot;id&quot;, &quot;firstname&quot;, &quot;lastname&quot;, &quot;email&quot; and &quot;reg_date&quot;. 
Now, let us fill the table with data.</p>

<div class="w3-panel w3-note">
<p><strong>Note:</strong> If a column is AUTO_INCREMENT (like the &quot;id&quot; column) or TIMESTAMP 
(like the &quot;reg_date&quot; column), it is no need to be specified in 
the SQL query; MySQL will automatically add the value.</p>
</div>
...
<br>
 ...
 <br>if ($conn-&gt;query($sql) === TRUE) {<br>&nbsp;&nbsp;&nbsp; echo &quot;New record created successfully&quot;;<br>} else {<br>&nbsp;&nbsp;&nbsp; echo &quot;Error: &quot; . $sql . &quot;&lt;br&gt;&quot; . $conn-&gt;error;<br>}<br><br>$conn-&gt;close();<br>
?&gt;
</div>
<br>
</div>
...
&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . mysqli_connect_error());<br>}<br><br>$sql = &quot;INSERT INTO MyGuests (firstname, lastname, email)<br>
 VALUES ('John', 'Doe', 'john@example.com')&quot;;<br>
 <br>if (mysqli_query($conn, $sql)) {<br>&nbsp;&nbsp;&nbsp; echo &quot;New record created successfully&quot;;<br>} else {<br>&nbsp; &nbsp; echo &quot;Error: &quot; . $sql . &quot;&lt;br&gt;&quot; . mysqli_error($conn);<br>}<br><br>mysqli_close($conn);<br>
?&gt;
</div>
<br>
</div>
...
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>
 ...
 &nbsp;&nbsp;&nbsp;
 VALUES ('John', 'Doe', 'john@example.com')&quot;;<br>
 &nbsp;&nbsp;&nbsp; // use exec() because no results are returned<br>&nbsp;&nbsp;&nbsp; $conn-&gt;exec($sql);<br>&nbsp;&nbsp;&nbsp; echo &quot;New record created successfully&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>catch(PDOException $e)<br>&nbsp;&nbsp;&nbsp; {<br>&nbsp;&nbsp;&nbsp; echo $sql . &quot;&lt;br&gt;&quot; . $e-&gt;getMessage();<br>&nbsp;&nbsp;&nbsp; }<br>
 <br>$conn = null;<br>
?&gt;
</div>
<br>
