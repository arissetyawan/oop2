...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Error Functions</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Error </span> Functions</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_ref_directory.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_ref_filesystem.asp">Next &#10095;</a>
</div>
<hr>
<h2>PHP Error Introduction</h2>
<p>The error functions are used to deal with error handling and logging.</p>
<p>The error functions allow us to define own error handling rules, and modify 
the way the errors can be logged.</p>
<p>The logging functions allow us to send messages 
directly to other machines, emails, or system logs.</p>
<p>The error reporting functions allow us to customize what level and kind of 
error feedback is given. </p>
<hr>

<h2>Installation</h2>
<p>The PHP error functions are part of the PHP core. No installation is required 
to use these functions.</p>
<hr>

<h2>Runtime Configuration</h2>
<p>The behavior of the error functions is affected by settings in php.ini.</p>
<p>Errors and logging configuration options:</p>
...
<h2>PHP 5 Predefined Error and Logging Constants</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate">
  <tr>
