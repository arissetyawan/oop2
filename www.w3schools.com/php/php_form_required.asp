...
<h1>PHP 5 <span class="color_h1">Forms - Required Fields</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_form_validation.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_form_url_email.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">This chapter shows how to make input fields required and create error messages if needed.</p>
<hr>
...
required fields. We have also added an <code class="w3-codespan">if else</code> statement for each $_POST variable. This 
checks if the $_POST variable is empty (with the PHP <code class="w3-codespan">empty()</code> 
function). If it is empty, an error message is stored in the different error variables, 
and if it is not empty, it sends the user input data through the <code class="w3-codespan">test_input()</code> 
function:</p>
...
$website = &quot;&quot;;<br><br>if ($_SERVER[&quot;REQUEST_METHOD&quot;] == &quot;POST&quot;) {<br>
 &nbsp;
if (empty($_POST[&quot;name&quot;])) {<br>&nbsp;&nbsp;&nbsp; $nameErr = &quot;Name is required&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; $name = test_input($_POST[&quot;name&quot;]);<br>&nbsp; }<br><br>&nbsp; if (empty($_POST[&quot;email&quot;]))
{<br>&nbsp;&nbsp;&nbsp; $emailErr = &quot;Email is required&quot;;<br>&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; $email = test_input($_POST[&quot;email&quot;]);<br>&nbsp; }<br><br>&nbsp; if (empty($_POST[&quot;website&quot;]))
...
(empty($_POST[&quot;gender&quot;])) {<br>&nbsp;&nbsp;&nbsp; $genderErr = &quot;Gender is required&quot;;<br>&nbsp; } else
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_form_validation_required" target="_blank">Run example &raquo;</a>
</div>
