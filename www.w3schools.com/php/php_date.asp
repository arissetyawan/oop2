...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Date and Time</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Date and Time</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_arrays_multi.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_includes.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The PHP <code class="w3-codespan">date()</code> function is used to format a date and/or a time.</p>
<hr>

<h2>The PHP Date() Function</h2>
<p>The PHP <code class="w3-codespan">date()</code> function formats a timestamp to a more readable date and time.</p>
<h3>Syntax</h3>
...
<p>A timestamp is a sequence of 
characters, denoting the date and/or time at which a certain event occurred.</p>
</div>

<hr>

<h2>Get a Simple Date</h2>
<p>The required <i>format</i> parameter of the date() function specifies how to format the date 
(or time).</p>
...
characters to add additional formatting.</p>
<p>The example below formats today's date in three different ways:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>echo &quot;Today is &quot; . date(&quot;Y/m/d&quot;) . &quot;&lt;br&gt;&quot;;<br>echo &quot;Today is &quot; . date(&quot;Y.m.d&quot;) . &quot;&lt;br&gt;&quot;;<br>echo &quot;Today is &quot; . date(&quot;Y-m-d&quot;) . &quot;&lt;br&gt;&quot;;<br>
 echo &quot;Today is &quot; . date(&quot;l&quot;);<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_date1">Run example &raquo;</a>
</div>
<hr>
...
<p>Use the <code class="w3-codespan">date()</code> function to automatically update the copyright year on your 
website:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_date_copyright">Run example &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>echo &quot;The time is &quot; . date(&quot;h:i:sa&quot;);<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_date2">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note"><p>
<p>Note that the PHP date() function will return the current date/time of the 
server!</p>
</div>
...
<p>If the time you got back from the code is not the right 
time, it's probably because your server is in another country or set up 
for a different timezone.</p>
<p>So, if you need the time to be correct according to a specific 
location, you can set a timezone to use. </p>
<p>The example below sets the timezone to &quot;America/New_York&quot;, then outputs the current time in the specified format:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>date_default_timezone_set(&quot;America/New_York&quot;);<br>echo &quot;The time is &quot; . date(&quot;h:i:sa&quot;);<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_date3">Run example &raquo;</a>
</div>
<hr>
...
examples above).</p>
<p>The <code class="w3-codespan">mktime()</code> function returns the Unix timestamp for a date. The Unix timestamp contains the number of seconds between the Unix Epoch 
...
<p>The example below creates a date and time from a number of parameters in the 
<code class="w3-codespan">mktime()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$d=mktime(11, 14, 54, 8, 12, 2014);<br>echo &quot;Created date is &quot; . date(&quot;Y-m-d h:i:sa&quot;, $d);<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_date4">Run example &raquo;</a>
</div>
<hr>

<h2>Create a Date From a String With PHP strtotime()</h2>
<p>The PHP <code class="w3-codespan">strtotime()</code> function is used to convert a human readable string to a 
Unix time.</p>
<h3>Syntax</h3>
<div class="w3-code w3-border notranslate"><div>
 strtotime(<em>time,now</em>)</div></div>

<p>The example below creates a date and time from the <code class="w3-codespan">strtotime()</code> function:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$d=strtotime(&quot;10:30pm April 15 2014&quot;);<br>echo &quot;Created date is &quot; . date(&quot;Y-m-d h:i:sa&quot;, $d);<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_date5">Run example &raquo;</a>
</div>

<p>PHP is quite clever about converting a string to a date, so you can put in 
various values:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$d=strtotime(&quot;tomorrow&quot;);<br>echo date(&quot;Y-m-d h:i:sa&quot;, $d) . &quot;&lt;br&gt;&quot;;<br>
 <br>$d=strtotime(&quot;next Saturday&quot;);<br>echo date(&quot;Y-m-d h:i:sa&quot;, $d) . &quot;&lt;br&gt;&quot;;<br>
 <br>$d=strtotime(&quot;+3 Months&quot;);<br>echo date(&quot;Y-m-d h:i:sa&quot;, $d) . &quot;&lt;br&gt;&quot;;<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_date6">Run example &raquo;</a>
</div>
<p>However, <code class="w3-codespan">strtotime()</code> is not perfect, so remember to check the strings you put in there.</p>
<hr>
...
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$startdate = strtotime(&quot;Saturday&quot;);<br>$enddate = strtotime(&quot;+6 weeks&quot;, $startdate);<br><br>while ($startdate &lt; $enddate) {<br>&nbsp; echo date(&quot;M d&quot;, $startdate) . &quot;&lt;br&gt;&quot;;<br>&nbsp; $startdate = strtotime(&quot;+1 week&quot;, $startdate);<br>}<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_date7">Run example &raquo;</a>
</div>
...
<div class="w3-code htmlHigh notranslate">
 ...
 echo &quot;There are &quot; . $d2 .&quot; days until 4th of July.&quot;;<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_date8">Run example &raquo;</a>
</div>
<hr>

<h2>Complete PHP Date Reference</h2>
<p>For a complete reference of all date functions, go to our complete
<a href="php_ref_date.asp">PHP Date Reference</a>.</p>
