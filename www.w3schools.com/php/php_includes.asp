...
<h1>PHP 5 <span class="color_h1">Include Files</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_date.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_file.asp">Next &#10095;</a>
</div>
<hr>
...
<ul>
  <li><code class="w3-codespan">require</code> will produce a fatal error (E_COMPILE_ERROR) and stop the script</li>
  <li><code class="w3-codespan">include</code> will only produce a warning (E_WARNING) and the script will continue</li>
</ul>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_include1">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_include2">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_include3">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_include4">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_include5">Run example &raquo;</a>
</div>

<div class="w3-panel w3-note">
<p>Use <code class="w3-codespan">require</code> when the file is required by the application.</p>
<p>Use <code class="w3-codespan">include</code> when the file is not required and application 
should continue when file is not found.</p>
</div>
