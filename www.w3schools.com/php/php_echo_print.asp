...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Echo and Print Statements</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="php_variables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_datatypes.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">In PHP there are two basic ways to get output: <code class="w3-codespan">echo</code> and <code class="w3-codespan">print</code>.</p>
<p class="intro">In this tutorial we use <code class="w3-codespan">echo</code> (and <code class="w3-codespan">print</code>) in almost every 
example. So, this chapter contains a little more info about those two output 
statements.</p>
<hr>

<h2>PHP echo and print Statements</h2>
<p><code class="w3-codespan">echo</code> and <code class="w3-codespan">print</code> are more or less the same. They are both used to output data 
to the screen. </p>
<p>The differences are small: <code class="w3-codespan">echo</code> has no return value while <code class="w3-codespan">print</code> has a return value of 1 so it can be used in 
expressions. <code class="w3-codespan">echo</code> can take multiple parameters (although such usage is rare) 
while <code class="w3-codespan">print</code> can take one argument. <code class="w3-codespan">echo</code> is marginally 
faster than <code class="w3-codespan">print</code>.</p>
<hr>

<h2>The PHP echo Statement</h2>
<p>The <code class="w3-codespan">echo</code> statement can be used with or without parentheses: 
<code class="w3-codespan">echo</code> or <code class="w3-codespan">echo()</code>.</p>
<p><strong>Display Text</strong></p>
<p>The following example shows how to output text with the <code class="w3-codespan">echo</code> 
command (notice that the text can contain HTML markup):</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_echo1">Run example &raquo;</a>
</div>
<p><strong>Display Variables</strong></p>
<p>The following example shows how to output text and variables with the <code class="w3-codespan">echo</code> 
statement:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 ...
 $x = 5;<br>$y = 4;<br>
 <br>echo &quot;&lt;h2&gt;&quot; . $txt1 . &quot;&lt;/h2&gt;&quot;;<br>echo &quot;Study PHP at 
  &quot; . $txt2 . &quot;&lt;br&gt;&quot;;<br>echo $x + $y;<br>?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_echo2">Run example &raquo;</a>
</div>
<hr>
...
<p>The <code class="w3-codespan">print</code> statement can be used with or without 
parentheses: 
<code class="w3-codespan">print</code> or <code class="w3-codespan">print()</code>.</p>
<p><strong>Display Text</strong></p>
<p>The following example shows how to output text with the <code class="w3-codespan">print</code> 
command (notice that the text can contain HTML markup):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_print1">Run example &raquo;</a>
</div>
<p><strong>Display Variables</strong></p>
<p>The following example shows how to output text and variables with the 
<code class="w3-codespan">print</code> statement:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>$txt1 = &quot;Learn PHP&quot;;<br>$txt2 = &quot;W3Schools.com&quot;;<br>
 ...
 print &quot;Study PHP at &quot; . $txt2 . &quot;&lt;br&gt;&quot;;<br>print $x + $y;<br>?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_print2">Run example &raquo;</a>
</div>
