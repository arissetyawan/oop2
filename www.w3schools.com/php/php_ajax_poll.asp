...
<a class="w3-left w3-btn" href="php_ajax_rss_reader.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_examples.asp">Next &#10095;</a>
</div>
<hr>
<h2>AJAX Poll</h2>
...
<p>When a user chooses an option above, a function called &quot;getVote()&quot; is executed. The 
...
{<br>
&nbsp;
if (window.XMLHttpRequest) {<br>&nbsp;&nbsp;&nbsp; // code for IE7+, Firefox, Chrome, Opera, Safari<br>
&nbsp;
...
&nbsp;
&nbsp;
&nbsp;&nbsp;document.getElementById(&quot;poll&quot;).innerHTML=this.responseText;<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp; }<br>
&nbsp;
