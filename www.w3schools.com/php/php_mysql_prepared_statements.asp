...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Prepared Statements</title>
<meta charset="utf-8">
...
<h1>PHP <span class="color_h1">Prepared Statements</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_mysql_insert_multiple.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_mysql_select.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Prepared statements are very useful against SQL injections.</p>
<hr>
...
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>$password = &quot;password&quot;;<br>$dbname = &quot;myDB&quot;;<br><br>// Create connection<br>$conn = new mysqli($servername, $username, $password, $dbname);<br><br>// Check connection<br>if ($conn-&gt;connect_error) {<br>&nbsp;&nbsp;&nbsp; die(&quot;Connection failed: &quot; . $conn-&gt;connect_error);<br>
 }<br><br>// prepare and bind<br>$stmt = $conn-&gt;prepare(&quot;INSERT INTO MyGuests (firstname, lastname, email) VALUES (?, ?, ?)&quot;);<br>$stmt-&gt;bind_param(&quot;sss&quot;, $firstname, $lastname, $email);<br><br>// set parameters and execute<br>$firstname = &quot;John&quot;;<br>$lastname = &quot;Doe&quot;;<br>$email = &quot;john@example.com&quot;;<br>$stmt-&gt;execute();<br><br>$firstname = &quot;Mary&quot;;<br>$lastname = &quot;Moe&quot;;<br>$email = &quot;mary@example.com&quot;;<br>$stmt-&gt;execute();<br>
 <br>$firstname = &quot;Julie&quot;;<br>$lastname = &quot;Dooley&quot;;<br>$email = &quot;julie@example.com&quot;;<br>
 $stmt-&gt;execute();<br><br>echo &quot;New records created successfully&quot;;<br><br>$stmt-&gt;close();<br>
 $conn-&gt;close();<br>?&gt;
</div>
<br>
</div>
...
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>$servername = &quot;localhost&quot;;<br>$username = &quot;username&quot;;<br>$password = &quot;password&quot;;<br>$dbname = &quot;myDBPDO&quot;;<br><br>try {<br>&nbsp;&nbsp;&nbsp; $conn = new PDO(&quot;mysql:host=$servername;dbname=$dbname&quot;, $username, $password);<br>&nbsp;&nbsp;&nbsp; // set the PDO error mode to exception<br>&nbsp;&nbsp;&nbsp; $conn-&gt;setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);<br><br>&nbsp;&nbsp;&nbsp; // prepare sql and bind parameters<br>&nbsp;&nbsp;&nbsp; $stmt = $conn-&gt;prepare(&quot;INSERT INTO MyGuests (firstname, lastname, email)
 <br>&nbsp;&nbsp;&nbsp; VALUES (:firstname, :lastname, :email)&quot;);<br>&nbsp;&nbsp;&nbsp; $stmt-&gt;bindParam(':firstname', $firstname);<br>&nbsp;&nbsp;&nbsp; $stmt-&gt;bindParam(':lastname', $lastname);<br>&nbsp;&nbsp;&nbsp; $stmt-&gt;bindParam(':email', $email);<br>
 <br>&nbsp;&nbsp;&nbsp; // insert a row<br>&nbsp;&nbsp;&nbsp; $firstname = &quot;John&quot;;<br>&nbsp;&nbsp;&nbsp; $lastname = &quot;Doe&quot;;<br>&nbsp;&nbsp;&nbsp; $email = &quot;john@example.com&quot;;<br>&nbsp;&nbsp;&nbsp; $stmt-&gt;execute();<br><br>&nbsp;&nbsp;&nbsp; // insert another row<br>&nbsp;&nbsp;&nbsp; $firstname = &quot;Mary&quot;;<br>&nbsp;&nbsp;&nbsp; $lastname = &quot;Moe&quot;;<br>&nbsp;&nbsp;&nbsp; $email = &quot;mary@example.com&quot;;<br>&nbsp;&nbsp;&nbsp; $stmt-&gt;execute();<br><br>&nbsp;&nbsp;&nbsp; // insert another row<br>&nbsp;&nbsp;&nbsp; $firstname = &quot;Julie&quot;;<br>&nbsp;&nbsp;&nbsp; $lastname = &quot;Dooley&quot;;<br>&nbsp;&nbsp;&nbsp; $email = &quot;julie@example.com&quot;;<br>&nbsp;&nbsp;&nbsp; $stmt-&gt;execute();<br>
 <br>&nbsp;&nbsp;&nbsp; echo &quot;New records created successfully&quot;;<br>&nbsp;&nbsp;&nbsp; }<br>catch(PDOException $e)<br>&nbsp;&nbsp;&nbsp; {<br>
