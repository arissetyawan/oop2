...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Filter Functions</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="php_ref_filesystem.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_ref_ftp.asp">Next &#10095;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>Filter all $_GET, $_POST, $_COOKIE, $_REQUEST and $_SERVER data by this filter. Accepts the name of the filter you like to use by default. See the filter list for the list of the filter names</td>
    <td>&quot;unsafe_raw&quot;</td>
    <td>PHP_INI_PERDIR</td>
    </tr>
  <tr>
    <td>filter.default_flags</td>
    <td>Default flags to apply when the default filter is set. This is set to FILTER_FLAG_NO_ENCODE_QUOTES by default for backwards compatibility reasons</td>
    <td>NULL</td>
    <td>PHP_INI_PERDIR</td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Returns a list of all supported filters</td>
  </tr>
  <tr>
...
<h2>PHP 5 Predefined Filter Constants</h2>
<div class="w3-responsive">
<table class="w3-table-all notranslate">
  <tr>
    <th>Constant</th>
  ...
  <td>275</td>
  <td>Validates an IP address</td>
    </tr>
  <tr>
  <td><a href="filter_validate_regexp.asp">FILTER_VALIDATE_REGEXP</a></td>
  <td>272</td>
  <td>Validates a regular expression</td>
  </tr>
  <tr>
  ...
  <td>519</td>
  <td>Removes all characters except digits and + -</td>
    </tr>
  <tr>
