...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 Constants</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">Constants</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_string.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_operators.asp">Next &#10095;</a>
</div>
<hr>
...
<p>To create a constant, use the <code class="w3-codespan">define()</code> function.</p>
<h3>Syntax</h3>
<div class="w3-code w3-border notranslate"><div>
 define(<i>name</i>, <i>value</i>, <i>case-insensitive</i>)</div></div>

<p>Parameters:</p>
<ul>
  <li><i>name</i>: Specifies the name of the constant</li>
  <li><i>value</i>: Specifies the value of the constant</li>
  <li><i>case-insensitive</i>: Specifies whether the constant name should be case-insensitive. Default is false</li>
</ul>

<p>The example below creates a constant with a <strong>case-sensitive</strong> name:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_constant1">Run example &raquo;</a>
</div>

<p>The example below creates a constant with a <strong>case-insensitive</strong> name:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
&lt;?php<br>
 define(&quot;GREETING&quot;, &quot;Welcome to W3Schools.com!&quot;, true);<br>echo greeting;<br>?&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_constant2">Run example &raquo;</a>
</div>
<hr>

<h2>Constants are Global</h2>
<p>Constants are automatically global and can be used across 
the entire script.</p>
<p>The example below uses a constant inside a function, even if it is defined 
outside the function:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
 &lt;?php<br>define(&quot;GREETING&quot;, &quot;Welcome to W3Schools.com!&quot;);<br><br>function myTest() {<br>&nbsp;&nbsp;&nbsp; echo GREETING;<br>}<br>&nbsp;<br>myTest();<br>
 ?&gt; </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_constant3">Run example &raquo;</a>
</div>
