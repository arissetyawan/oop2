...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP Error Handling</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="php_filter_advanced.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_exception.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Since we want our custom function to handle all errors, the <code class="w3-codespan">set_error_handler()</code> 
...
illegal input occurs. In PHP, this is done by the <code class="w3-codespan">trigger_error()</code> function.</p>
...
using the <code class="w3-codespan">error_log()</code> function you can send error logs to a specified file or a remote destination.</p>
