...
<!DOCTYPE html>
<html lang="en-US">
<head><title>PHP 5 switch Statement</title>
<meta charset="utf-8">
...
<h1>PHP 5 <span class="color_h1">switch</span> Statement</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="php_if_else.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_looping.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Use the <code class="w3-codespan">switch</code> statement to <strong>select one of many blocks 
...
of code associated with that case is executed. Use <code class="w3-codespan">break</code> to prevent the
code from running into the next case automatically. The <code class="w3-codespan">default</code> statement is used if no 
match is found.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showphp.asp?filename=demo_switch">Run example &raquo;</a>
</div>
<br>
