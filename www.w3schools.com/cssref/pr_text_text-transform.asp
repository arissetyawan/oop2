...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS text-transform property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_text-shadow.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_pos_top.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    div.c {<br>&nbsp;&nbsp;&nbsp; text-transform: capitalize;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_text-transform" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">text-transform</code> property controls the capitalization of text.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>none</td>
    <td>No capitalization. The text renders as it is. This is default</td>
