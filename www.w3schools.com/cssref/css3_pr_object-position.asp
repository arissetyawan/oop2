...
<h1>CSS <span class="color_h1">object-position</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_object-fit.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_opacity.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Resize an image to fit its content box, and position the image 5px from the 
left and 10% from the top inside the content box:</p>
<div class="w3-code notranslate cssHigh"> 
    img.a {<br>&nbsp;&nbsp;&nbsp; width: 200px;<br>&nbsp;&nbsp;&nbsp; height: 
    400px;<br>&nbsp;&nbsp;&nbsp; object-fit: none;<br>&nbsp;&nbsp;&nbsp; 
    object-position: 5px 10%;<br>&nbsp;&nbsp;&nbsp; border: 5px solid red;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_object-position">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">object-position</code> property is used together with object-fit to specify how an &lt;img&gt; or &lt;video&gt; should 
be positioned with x/y coordinates inside its &quot;own content box&quot;.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    <th>Animatable:</th>
    <td>yes. <a href="css_animatable.asp">Read about <em>animatable</em></a> <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_object-position">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.objectPosition=&quot;0 10%&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_object-position">Try it</a>
</td>
  </tr>
</table>
</div>
...
object-fit: <em>position</em>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Specifies the position of the image or video inside its content box. First value controls the 
    x-asis and the second value controls the y-axis. Can be a string (left, 
    center or right), or a number (in px or %). Negative values are allowed</td>
  </tr>
  <tr>
    <td>initial</td>
...
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_object-fit.asp">CSS object-fit</a></p>
<p>CSS reference: <a href="/cssref/css3_pr_object-fit.asp">CSS object-fit</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_objectposition.asp">The objectPosition property</a></p>
<br>
