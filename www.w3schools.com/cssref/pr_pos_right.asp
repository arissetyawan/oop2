...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS right property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_resize.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_scroll-behavior.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">right</code> property affects the horizontal 
...
<ul>
  ...
  right</code> property sets the right edge of an element to a unit to the right 
  of the right edge of its nearest positioned ancestor.</li>
  <li>If position: relative; - the <code class="w3-codespan">right</code> 
  property sets the right edge of an element to a unit to the left/right of its 
  normal position.</li>
  <li>If position: sticky; - the <code class="w3-codespan">right</code> property behaves like its position is 
  relative when the element is inside the viewport, and like its position is 
  fixed when it is outside.</li>
  <li>If position: static; - the <code class="w3-codespan">right</code> property has no effect.</li>
</ul>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Lets the browser calculate the right edge position. This is default</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_right">Play it &raquo;</a></td>                         
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Sets the right edge position in px, cm, etc. Negative values are allowed. <a href="css_units.asp">Read about length units</a>
    </td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_right&preval=50px">Play it &raquo;</a></td>                                
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Sets the right edge position in % of containing element. Negative values are allowed </td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use the right property with a negative value and for an element with no 
positioned ancestors:</p>
<div class="w3-code notranslate cssHigh">
    div.b {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
    right: -20px;<br>&nbsp;&nbsp;&nbsp; width: 100px;<br>&nbsp;&nbsp;&nbsp; 
    height: 120px;<br>&nbsp;&nbsp;&nbsp; border: 3px solid blue;<br>} <br><br>
    div.c {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; 
    right: 150px;<br>&nbsp;&nbsp;&nbsp; width: 200px;<br>&nbsp;&nbsp;&nbsp; 
    height: 120px;<br>&nbsp;&nbsp;&nbsp; border: 3px solid green;<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_position_right2">Try it Yourself &raquo;</a>
</div>
<hr>
