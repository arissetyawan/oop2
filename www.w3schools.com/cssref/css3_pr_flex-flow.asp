...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS flex-flow property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_flex-direction.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_flex-grow.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">flex-flow</code> property is a shorthand property for:</p>
<ul>
  <li><a href="css3_pr_flex-direction.asp">flex-direction</a></li>
  <li><a href="css3_pr_flex-wrap.asp">flex-wrap</a></li>
</ul>
<p><b>Note:</b> If the elements are not flexible items, the <code class="w3-codespan">flex-flow</code> property has no effect.</p>
