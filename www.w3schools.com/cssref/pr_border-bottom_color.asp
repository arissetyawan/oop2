...
<a class="w3-left w3-btn" href="pr_border-bottom.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_border-bottom-left-radius.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
div {border-bottom-color: coral;}</div>
...
<p>The <code class="w3-codespan">border-bottom-color</code> property sets the color of an element's bottom border.</p>
<p><b>Note:</b> Always declare the <a href="pr_border-style.asp">border-style</a> or the 
<a href="pr_border-bottom_style.asp">border-bottom-style</a> property before the <code class="w3-codespan">border-bottom-color</code>
property. An element must have a border before you can change the color.</p>
...
<table class="w3-table-all notranslate">
 ...
 CSS Color Values</a> for a complete list of possible color values. Default color is the color of the element</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the bottom border with a HEX value:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-color: #92a8d1;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-color2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the bottom border with an RGB value:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-color: rgb(201, 76, 76);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-color3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the bottom border with an RGBA value:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-color: rgba(201, 76, 76, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-color4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the bottom border with a HSL value:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-color: hsl(89, 43%, 51%);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-color5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the bottom border with a HSLA value:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-color: hsla(89, 43%, 51%, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-color6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a transparent bottom border:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-color: transparent;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-color7" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
