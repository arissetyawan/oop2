...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS background-clip</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">background-clip</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_background-blend-mode.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_background-color.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">background-clip</code> property defines how far the background (color or image) 
should extend within an element.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>border-box</td>
    <td>Default value. The background extends behind the border</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-clip">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>padding-box</td>
    <td>The background extends to the inside edge of the border</td>
  ...
  <tr>
    <td>content-box</td>
    <td>The background extends to the edge of the content box</td>
