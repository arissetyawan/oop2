...
<html lang="en-US">
<head>
<title>CSS grid-template-areas property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">grid-template-areas</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-template.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-template-columns.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  ...
  &quot;myArea myArea . . .&quot;;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-template-areas" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-template-areas</code> property specifies 
areas within the grid layout.</p>
<p>You can name grid items by using the <a href="pr_grid-area.asp">grid-area</a> 
property, and then reference to the name in the <code class="w3-codespan">grid-template-areas</code> 
property.</p>
<p>Each area is defined by apostrophes. Use a period sign to refer to a grid item with no name.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-template-areas">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridTemplateAreas=&quot;. . . myArea myArea&quot;
<!--<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-template-areas">Try it</a>-->
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-template-areas</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-template-areas: none|<em>itemnames</em>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>none</td>
    <td>Default value. No named grid areas</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template-areas">Play it &raquo;</a></td> 

  </tr>
  <tr>
    <td><i>itemnames</i></td>
    <td>A sequence that specifies how each columns and row should display</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template-areas&preval='myArea myArea . . '">Play it &raquo;</a></td>
  </tr>
</table>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-area: myArea;<br>}<br>.grid-container {<br>&nbsp;&nbsp;display: grid;<br>&nbsp; grid-template-areas:<br>&nbsp;&nbsp;&nbsp; 
  'myArea myArea . . .'<br>&nbsp;&nbsp;&nbsp; 'myArea myArea . . .';<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-template-areas2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
  ...
  footer; }<br><br>.grid-container {<br>&nbsp;&nbsp;display: grid;<br>&nbsp; grid-template-areas:<br>&nbsp;&nbsp;&nbsp; 
  'header header header header header'<br>&nbsp;&nbsp;&nbsp; 
  'menu main main main right right'<br>&nbsp;&nbsp;&nbsp; 'menu footer footer 
  footer footer';<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-template-areas3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>CSS Reference: The <a href="pr_grid-template.asp">grid-template</a> property</p>
<br>
