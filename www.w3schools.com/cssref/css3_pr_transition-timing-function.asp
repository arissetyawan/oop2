...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS transition-timing-function Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">transition-timing-function </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_transition-property.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_text_unicode-bidi.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">transition-timing-function</code> property specifies the speed curve of the transition 
effect.</p>
...
transition-timing-function: linear|ease|ease-in|ease-out|ease-in-out|step-start|step-end|steps(int,start|end)|cubic-bezier(<i>n</i>,<i>n</i>,<i>n</i>,<i>n</i>)|initial|inherit;</div></div>
