...
<a class="w3-left w3-btn" href="sel_valid.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="css_selectors.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_visited">Try it Yourself &raquo;</a>
</div>
...
<p>Browsers limits the styles that can be set for a:visited links, due to 
security issues.</p>
<p>Allowed styles are:</p>
<ul>
  <li>color</li>
  <li>background-color</li>
  <li>border-color (and border-color for separate sides)</li>
  <li>outline color</li>
  <li>column-rule-color</li>
  <li>the color parts of fill and stroke</li>
</ul>
<p>All other styles are inherited from a:link.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> :visited</td>
    <td>4.0</td>
    <td>7.0</td>
    <td>2.0</td>
    <td>3.1</td>
...
:visited {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<hr>
