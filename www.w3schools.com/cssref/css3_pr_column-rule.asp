...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS column-rule property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">column-rule</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_column-gap.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_column-rule-color.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    div
 {<br>
 &nbsp;&nbsp;&nbsp; -webkit-column-rule: 4px double #ff00ff; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; -moz-column-rule: 4px 
...
<p>The <code class="w3-codespan">column-rule</code> property sets the width, style, and color of the rule between columns.</p>
<p>This property is a shorthand property for:</p>
<ul>
  <li><a href="css3_pr_column-rule-width.asp">column-rule-width</a></li>
  <li><a href="css3_pr_column-rule-style.asp">column-rule-style</a> (required)</li>
  <li><a href="css3_pr_column-rule-color.asp">column-rule-color</a></li>
</ul>
<p>If column-rule-color is omitted, the color applied will be the color of the 
text.</p>
<div class="w3-responsive">
<table class="w3-table-all">
  <tr>
    <th style="width:25%">Default value:</th>
    <td>medium none <em>color</em></td>
  </tr>
  <tr>
    <th>Inherited:</th>
    <td>no</td>
