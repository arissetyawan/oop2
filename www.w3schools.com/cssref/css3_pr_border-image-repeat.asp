...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-image-repeat property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">border-image-repeat</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_border-image-outset.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_border-image-slice.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">border-image-repeat</code> property specifies whether the border image should be repeated, rounded or stretched.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td> round</td>
    <td>The image is tiled (repeated) to fill the area. If it does not fill the area with a whole number of tiles, the image is rescaled so it fits</td>
  ...
  <tr>
    <td>space</td>
    <td>The image is tiled (repeated) to fill the area. If it does not fill the area with a whole number of tiles, the extra space is distributed around the tiles</td>
  <td></td>              
