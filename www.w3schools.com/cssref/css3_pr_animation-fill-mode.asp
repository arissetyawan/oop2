...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS animation-fill-mode Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">animation-fill-mode </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_animation-duration.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_animation-iteration-count.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Let the &lt;div&gt; element retain the style values from the last keyframe 
...
<p>The <code class="w3-codespan">animation-fill-mode</code> property specifies a style for the element when the animation is not playing (before 
it starts, after it ends, or both).</p>
<p>CSS animations do not affect the element before the first keyframe is played 
or after the last keyframe is played. The <code class="w3-codespan">animation-fill-mode</code> property can override this 
behavior. </p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>backwards</td>
    <td>The element will get the style values that is set by the first keyframe (depends on animation-direction), and retain this during 
    the 
    animation-delay period</td>
  </tr>
  <tr>
    <td>both</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Let the &lt;div&gt; element get the style values set by the first keyframe before 
the animation starts (during the animation-delay period):</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp;
animation-fill-mode: backwards;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-fill-mode2">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp;
animation-fill-mode: both;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-fill-mode3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_animations.asp">CSS Animations</a></p>
