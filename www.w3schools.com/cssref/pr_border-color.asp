...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-color property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-collapse.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_border-image.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">border-color</code> property sets the color of an element's four borders. This property can 
have from one to four values.</p>
<p><strong>If the border-color property has four values:</strong></p>
<ul>
  <li>border-color: red green blue pink; 
...
<p><strong>If the border-color property has three values:</strong></p>
<ul>
  <li>border-color: red green blue;
 <ul><li>top border is red</li>
  <li>right and left borders are green</li>
  <li>bottom border is blue</li></ul>
    </li>
</ul>
<p><strong>If the border-color property has two values:</strong></p>
<ul>
  <li>border-color: red green;
 <ul><li>top and bottom borders are red</li>
  <li>right and left borders are green</li></ul>
 </li>
</ul>
<p><strong>If the border-color property has one value:</strong></p>
<ul>
  <li>border-color: red;<ul><li>all four borders are red</li></ul>
 </li>
</ul>

<p><b>Note:</b> Always declare the <a href="pr_border-style.asp">border-style</a> property before the <code class="w3-codespan">border-color</code>
property. An element must have borders before you can change the color.</p>
<div class="w3-responsive">
<table class="w3-table-all">
  <tr>
    <th style="width:25%">Default value:</th>
    <td>The current color of the element</td>
  </tr>
  <tr>
    <th>Inherited:</th>
    <td>no</td>
...
<table class="w3-table-all notranslate">
 ...
 CSS Color Values</a> for a complete list of possible color values. Default color is black</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the border with a HEX value:</p>
<div class="w3-code notranslate cssHigh">
div {border-color: #92a8d1;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-color2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the border with an RGB value:</p>
<div class="w3-code notranslate cssHigh">
div {border-color: rgb(201, 76, 76);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-color3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the border with an RGBA value:</p>
<div class="w3-code notranslate cssHigh">
div {border-color: rgba(201, 76, 76, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-color4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the border with a HSL value:</p>
<div class="w3-code notranslate cssHigh">
div {border-color: hsl(89, 43%, 51%);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-color5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the border with a HSLA value:</p>
<div class="w3-code notranslate cssHigh">
div {border-color: hsla(89, 43%, 51%, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-color6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a different border-color for each side of an element:</p>
<div class="w3-code notranslate cssHigh">
  div.ex1 {border-color: #0000ff;}<br>div.ex2 {border-color: #ff0000 #0000ff;}<br>
  div.ex3 {border-color: #ff0000 #00ff00 #0000ff;}<br>div.ex4 {border-color: 
  #ff0000 #00ff00 #0000ff rgb(250,0,255);}
</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-color7" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
