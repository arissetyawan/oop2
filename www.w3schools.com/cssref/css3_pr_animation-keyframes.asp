...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS @keyframes Rule</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">@keyframes</span> Rule</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_justify-content.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_pos_left.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">@keyframes</code> rule specifies the animation code.</p>
...
<p><b>Note:</b> The !important rule is ignored in a keyframe (See last example on this page).</p>
<hr>
...
<table class="w3-table-all notranslate">
 ...
 from (same as 0%)<br>
 to (same as 100%)<p><b>Note:</b> You can have many keyframes-selectors in one animation.</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p><strong>Note:</strong> The !important rule is ignored in a keyframe:</p>
<div class="w3-code notranslate cssHigh">
    @keyframes myexample
 {<br>
 &nbsp;&nbsp;&nbsp;
 from {top: 0px;}<br>&nbsp;&nbsp;&nbsp; 50% {top: 100px !important;} /* ignored 
    */<br>
 &nbsp;&nbsp;&nbsp;
 to {top: 200px;}<br>
 }<br>
 </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_keyframes_important">Try it Yourself &raquo;</a>
</div>
