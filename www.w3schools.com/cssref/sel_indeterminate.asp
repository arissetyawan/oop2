...
<html lang="en-US">
<head>
<title>CSS :indeterminate Selector</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:indeterminate</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_in-range.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_invalid.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Add a red shadow color to indeterminate 
inputs:</p>
<div class="w3-code notranslate cssHigh">
  
    input:indeterminate {<br>&nbsp; box-shadow: 0 0 1px 1px red;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_sel_indeterminate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The :indeterminate selector selects form elements that are in an indeterminate state.</p>
<p>The :indeterminate selector can only be used on &lt;input type="checkbox"&gt;, &lt;input type="radio"&gt;, and 
&lt;progress&gt; elements.</p>
<p><strong>Note:</strong> Checkboxes cannot be indeterminate with HTML - it is a property of the checkbox object, which can 
be set to <strong>true</strong> by JavaScript.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;">:indeterminate</td>
    <td>39.0</td>
    <td>Yes</td>
    <td>51.0</td>
    <td>Yes</td>
...
:indeterminate {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<br>
