...
<a class="w3-left w3-btn" href="css3_pr_background.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_background-blend-mode.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">background-attachment</code> property sets whether a background image  
scrolls with the rest of the page, or is fixed.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>scroll</td>
    <td>The background image will scroll with the page. This is default</td>
  </tr>
  <tr>
    <td>fixed</td>
    <td>The background image will not scroll with the page</td>
  </tr>
  <tr>
    <td>local</td>
    <td>The background image will scroll with the element's contents</td>
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>A background-image that will scroll with the page (scroll). This is default:</p>
<div class="w3-code notranslate cssHigh"> 
body{<br>
 &nbsp;&nbsp;&nbsp;
 background-image: url(&quot;img_tree.gif&quot;);<br>
...
<a target="_blank" href="tryit.asp?filename=trycss_background-attachment2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
    ...
    .fixed-bg {<br>&nbsp;&nbsp;&nbsp; /* The background image */<br>&nbsp;&nbsp;&nbsp; background-image: url(&quot;img_tree.gif&quot;);<br>&nbsp;&nbsp;&nbsp; /* Set a specified height, or the minimum height for the background image */<br>&nbsp;&nbsp;&nbsp; min-height: 500px;<br>&nbsp;&nbsp;&nbsp; /* Set background image to fixed (don't scroll along with the page) */<br>&nbsp;&nbsp;&nbsp; background-attachment: fixed;<br>&nbsp;&nbsp;&nbsp; /* Center the background image */<br>&nbsp;&nbsp;&nbsp; background-position: center;<br>&nbsp;&nbsp;&nbsp; /* Set the background image to no repeat */<br>&nbsp;&nbsp;&nbsp; background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; /* Scale the background image to be as large as possible */<br>&nbsp;&nbsp;&nbsp; background-size: cover;<br>}
    </div>
