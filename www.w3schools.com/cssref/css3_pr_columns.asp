...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS columns property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">columns</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_column-width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_gen_content.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">columns</code> property is a shorthand property for:</p>
<ul>
  <li><a href="css3_pr_column-width.asp">column-width</a></li>
  <li><a href="css3_pr_column-count.asp">column-count</a></li>
</ul>
<p>The column-width part will define the minimum width for each column, while 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default value. Sets both the column-width and column-count to "auto"</td>
    </tr>
  <tr>
    <td><i><a href="css3_pr_column-width.asp">column-width</a></i></td>
    <td>Defines the minimum width for each column</td>
  </tr>
  <tr>
    <td><i><a href="css3_pr_column-count.asp">column-count</a></i></td>
    <td>Defines the maximum number of columns</td>
  </tr>
  <tr>
    <td>initial</td>
