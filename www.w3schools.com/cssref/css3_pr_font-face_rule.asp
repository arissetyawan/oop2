...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS @font-face Rule</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">@font-face</span> Rule</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_font_font.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_font_font-family.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>With the <code class="w3-codespan">@font-face</code> rule, web designers do not have to use one of the &quot;web-safe&quot; fonts 
anymore.</p>
<p>In the <code class="w3-codespan">@font-face</code> rule you must first define a name for the font (e.g. myFirstFont), and then point to the font file.</p>
...
<p>The <code class="w3-codespan">@font-face</code> rule is supported in Internet Explorer, Firefox, Opera, Chrome, and Safari.</p>
<p>The numbers in the table specifies the first browser version that fully supports the 
font format.</p>
<div class="w3-responsive">
<table class="browserref notranslate">
  <tr>
    <th style="width:20%;font-size:16px;text-align:left;">Font format</th>
...
<p>*Edge and IE: The font format only works when set to be &quot;installable&quot;.</p>
...
<table class="w3-table-all notranslate">
 ...
 extra-expanded<br>
 ultra-expanded</td>
    <td>Optional. Defines how the font should be stretched. Default value is &quot;normal&quot;</td>
  </tr>
  <tr>
    <td>font-style</td>
    <td>normal<br>
 italic<br>
 oblique</td>
    <td>Optional. Defines how the font should be styled. Default value is &quot;normal&quot;</td>
  </tr>
  <tr>
    <td>font-weight</td>
    <td>normal<br>
 ...
 900</td>
  ...
  <tr>
    ...
    <td>Optional. Defines the range of unicode characters the font supports. Default value is &quot;U+0-10FFFF&quot;</td>
  </tr>
  </table>
</div>
<hr>
...
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_fonts.asp">CSS Web Fonts</a></p>
<br>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_font_font.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
