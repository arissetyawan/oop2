...
<a class="w3-right w3-btn" href="css_default_values.asp">Next &#10095;</a>
</div>
<hr>
<h2>CSS Colors</h2>
...
<a target="_blank" href="tryit.asp?filename=trycss_color_hex" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>RGB Colors</h2>
<p>An RGB color value is specified with the <a href="func_rgb.asp">rgb() function</a>, which has the following syntax:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_color_rgb" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>An RGBA color is specified with the <a href="func_rgba.asp">rgba() function</a>, which has the following syntax:</p>
...
<div class="w3-code notranslate cssHigh">
 #p1 {background-color: rgba(255, 0, 0, 0.3);}&nbsp;&nbsp; /* red with opacity */<br>#p2 {background-color: rgba(0, 255, 0, 0.3);}&nbsp;&nbsp; /* green with opacity */<br>#p3 {background-color: rgba(0, 0, 255, 0.3);}&nbsp;&nbsp; /* blue with opacity */
</div>
<a target="_blank" href="tryit.asp?filename=trycss_color_rgba" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>HSL Colors</h2>
<p>HSL stands for hue, saturation, and lightness - and represents a cylindrical-coordinate representation of colors.</p>
<p>An HSL color value is specified with the <a href="func_hsl.asp">hsl() 
...
<div class="w3-code notranslate cssHigh">
 #p1 {background-color: hsl(120, 100%, 50%);}&nbsp;&nbsp; /* green */<br>#p2 {background-color: hsl(120, 100%, 75%);}&nbsp;&nbsp; /* light green */<br>#p3 {background-color: hsl(120, 100%, 25%);}&nbsp;&nbsp; /* dark green */<br>#p4 {background-color: hsl(120, 60%, 70%);}&nbsp;&nbsp;&nbsp; /* pastel green */
</div>
<a target="_blank" href="tryit.asp?filename=trycss_color_hsl" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>An HSLA color value is specified with the <a href="func_hsla.asp">hsla() 
function</a>, which has the following syntax:</p>
...
<div class="w3-code notranslate cssHigh">
 #p1 {background-color: hsla(120, 100%, 50%, 0.3);}&nbsp;&nbsp; /* green with opacity */<br>#p2 {background-color: hsla(120, 100%, 75%, 0.3);}&nbsp;&nbsp; /* light green with opacity */<br>#p3 {background-color: hsla(120, 100%, 25%, 0.3);}&nbsp;&nbsp; /* dark green with opacity */<br>#p4 {background-color: hsla(120, 60%, 70%, 0.3);}&nbsp;&nbsp;&nbsp; /* pastel green with opacity */
</div>
<a target="_blank" href="tryit.asp?filename=trycss_color_hsla" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Predefined/Cross-browser Color Names</h2>
<p>140 color names are predefined in the HTML and CSS color specification.</p>
<p>Look at the table of <a href="/colors/colors_names.asp">predefined color names</a>.</p>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="css_colors.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="css_default_values.asp">Next &#10095;</a>
