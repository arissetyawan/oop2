...
<a class="w3-left w3-btn" href="css3_pr_flex-wrap.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_font_font.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">float</code> property specifies how an element should float.</p>
<p><b>Note:</b> Absolutely positioned elements ignores the <code class="w3-codespan">float</code> property!</p>
<p><strong>Note:</strong> Elements after a floating element will flow around it. To avoid this, use the 
<a href="pr_class_clear.asp">clear</a> property or the clearfix hack (see example 
...
<div class="w3-example">
<h3>Example</h3>
<p>Let an image float to the left:</p>
<div class="w3-code notranslate cssHigh">
    img&nbsp;
 {<br>
 &nbsp;&nbsp;&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss_float2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Let image be displayed just where it occurs in the text (float: none):</p>
<div class="w3-code notranslate cssHigh">
    img&nbsp;
 {<br>
 &nbsp;&nbsp;&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss_float3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Let the first letter of a paragraph float to the left and style the letter:</p>
<div class="w3-code notranslate cssHigh">
    span {<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; width: 
    0.7em;<br>&nbsp;&nbsp;&nbsp; font-size: 400%;<br>&nbsp;&nbsp;&nbsp; 
    font-family: algerian, courier;<br>&nbsp;&nbsp;&nbsp; line-height: 80%;<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_float4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use float with a list of hyperlinks to create a horizontal menu:</p>
<div class="w3-code notranslate cssHigh">
    .header, .footer {<br>&nbsp;&nbsp;&nbsp; background-color: grey;<br>&nbsp;&nbsp;&nbsp; 
    color: white;<br>&nbsp;&nbsp;&nbsp; padding: 15px;<br>}<br><br>.column {<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; 
    padding: 15px;<br>}<br><br>
    .clearfix::after {<br>&nbsp;&nbsp;&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
    clear: both;<br>&nbsp;&nbsp;&nbsp; display: table;<br>}<br>
    <br>.menu {width: 25%;}<br>.content {width: 75%;} </div>
<a target="_blank" href="tryit.asp?filename=trycss_float5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use float to create a homepage with a header, footer, left content and main content:</p>
<div class="w3-code notranslate cssHigh">
    .header, .footer {<br>&nbsp;&nbsp;&nbsp; background-color: grey;<br>&nbsp;&nbsp;&nbsp; 
    color: white;<br>&nbsp;&nbsp;&nbsp; padding: 15px;<br>}<br><br>.column {<br>&nbsp;&nbsp;&nbsp; float: left;<br>&nbsp;&nbsp;&nbsp; 
    padding: 15px;<br>}<br><br>
    ...
    clear: both;<br>&nbsp;&nbsp;&nbsp; display: table;<br>}<br>
    <br>.menu {width: 25%;}<br>.content {width: 75%;} </div>
<a target="_blank" href="tryit.asp?filename=trycss_float6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Do not allow floating elements on the left or the right side of a specified 
&lt;p&gt; element:</p>
<div class="w3-code notranslate cssHigh">
    img {<br>&nbsp;&nbsp;&nbsp; float: left;<br>}<br><br>p.clear {<br>&nbsp;&nbsp;&nbsp; 
    clear: both;<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_float_clear" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>If a floating element is taller than the containing element, it will overflow outside its container. 
It is possible to fix this with the "clearfix hack&quot;:</p>
<div class="w3-code notranslate cssHigh">
    .clearfix::after {<br>&nbsp;&nbsp;&nbsp; content: &quot;&quot;;<br>&nbsp;&nbsp;&nbsp; 
    clear: both;<br>&nbsp;&nbsp;&nbsp; display: table;<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_float_clear_overflow" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
