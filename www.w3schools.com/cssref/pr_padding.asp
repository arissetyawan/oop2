...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS padding property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_overflow-y.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_padding-bottom.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>An element's padding is the space between its content and its border.</p>
<p>The <code class="w3-codespan">padding</code> property is a shorthand property for:</p>
<ul>
...
<p><strong>Note:</strong> Padding creates extra space within an element, while 
margin creates extra space around an element.</p>
<p>This property can have from one to four values.</p>
<p><strong>If the padding property has four values:</strong></p>
<ul>
  <li>padding:10px 5px 15px 20px;
 <ul><li>top padding is 10px</li>
  <li>right padding is 5px</li>
  <li>bottom padding is 15px</li>
  <li>left padding is 20px</li>
  </ul>
 </li>
</ul>
<p><strong>If the padding property has three values:</strong></p>
<ul>
  <li>padding:10px 5px 15px;<ul><li>top padding is 10px</li>
  <li>right and left padding are 5px</li>
  <li>bottom padding is 15px</li>
  </ul>
    </li>
</ul>
<p><strong>If the padding property has two values:</strong></p>
<ul>
  <li>padding:10px 5px;<ul>
    <li>top and bottom padding are 10px</li>
    <li>right and left padding are 5px</li>
  </ul>
  </li>
</ul>
<p><strong>If the padding property has one value:</strong></p>
<ul>
  <li>padding:10px;<ul>
    <li>all four paddings are 10px</li>
  </ul>
  </li>
</ul>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Specifies the padding in px, pt, cm, etc. Default value is 0. <a href="css_units.asp">Read about length units</a></td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_padding">Play it &raquo;</a></td>                    
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Specifies the padding in percent of the width of the containing element</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the padding for a &lt;p&gt; element to 35 pixels for top and bottom, and to 70 
pixels for right and left:</p>
<div class="w3-code notranslate cssHigh">
p {<br>
&nbsp;&nbsp;&nbsp; padding: 35px 70px;<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_padding2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the padding for a &lt;p&gt; element to 35 pixels for top, 70 
pixels for right and left, and to 50 pixels for bottom:</p>
<div class="w3-code notranslate cssHigh">
p {<br>
&nbsp;&nbsp;&nbsp; padding: 35px 70px 50px;<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_padding3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
p {<br>
&nbsp;&nbsp;&nbsp; padding: 35px 70px 50px 90px;<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_padding4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
