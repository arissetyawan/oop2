...
<h1>CSS <span class="color_h1">grid-area</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-auto-columns.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-area: 2 / 1 / span 2 / span 3;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-area" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">grid-area</code> property specifies a grid 
item's size and location in a grid layout, and is a shorthand property for the 
following properties:</p>
<ul>
  <li><a href="pr_grid-row-start.asp">grid-row-start</a></li>
  <li><a href="pr_grid-column-start.asp">grid-column-start</a></li>
  <li><a href="pr_grid-row-end.asp">grid-row-end</a></li>
  <li><a href="pr_grid-column-end.asp">grid-column-end</a></li>
</ul>
<p>The <code class="w3-codespan">grid-area</code> property can also be used to assign a name to a grid item. 
Named grid items can then be referenced to by the 
<a href="pr_grid-template-areas.asp">grid-template-areas</a> property of the 
grid container. See examples below.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-area">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridArea=&quot;1 / 2 / span 2 / span 3&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-area">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-area</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-area: <i>grid-row-start / grid-column-start / grid-row-end / 
  grid-column-end </i>|<em> itemname</em>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i><a href="pr_grid-row-start.asp">grid-row-start</a></i></td>
    <td>Specifies on which row to start displaying the item.</td>
  </tr>
  <tr>
    <td><i><a href="pr_grid-column-start.asp">grid-column-start</a></i></td>
    <td>Specifies on which column to start displaying the item.</td>
  </tr>
  <tr>
    <td><i><a href="pr_grid-row-end.asp">grid-row-end</a></i></td>
    <td>Specifies on which row-line to stop displaying the item, or how many rows to span.</td>
  </tr>
  <tr>
    <td><i><a href="pr_grid-column-end.asp">grid-column-end</a></i></td>
    <td>Specifies on which column-line to stop displaying the item, or how many columns to span.</td>
  </tr>
  <tr>
    <td><em>itemname</em></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Item1 gets the name &quot;myArea&quot;, and spans all five columns in a five columns 
grid layout:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-area: myArea;<br>}<br>.grid-container {<br>&nbsp; display: 
  grid;<br>&nbsp; grid-template-areas: 'myArea myArea myArea myArea myArea';<br>
  }</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-area_named1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-area: myArea;<br>}<br>.grid-container {<br>&nbsp; display: 
  grid;<br>&nbsp; grid-template-areas: 'myArea myArea . . .';<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-area_named2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
  .grid-container {<br>&nbsp; grid-template-areas: 'myArea myArea . . .' 'myArea 
  myArea . . .';<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-area_named3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
  ...
  footer';<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-area_named4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_grid.asp">CSS Grid Layout</a></p>
<br>
