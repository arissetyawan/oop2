...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS word-break property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">word-break</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_dim_width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_text_word-spacing.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">word-break</code> property specifies how words 
should break when reaching the end of a line.</p>
...
word-break: normal|break-all|keep-all|break-word|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>normal</td>
    <td>Default value. Uses default line break rules</td>
  </tr>
  <tr>
    <td>break-all</td>
    <td>To prevent overflow, word may be broken at any character</td>
  </tr>
  <tr>
    <td>keep-all&nbsp;</td>
    <td>Word breaks should not be used for Chinese/Japanese/Korean (CJK) text. 
    Non-CJK text behavior is the same as value &quot;normal&quot;</td>
  </tr>
  <tr>
    <td>break-word</td>
    <td>To prevent overflow, word may be broken at arbitrary points</td>
    </tr>
  <tr>
    <td>initial</td>
