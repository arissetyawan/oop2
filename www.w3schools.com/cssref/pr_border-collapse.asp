...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-collapse property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-bottom_width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-color.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=trycss_border-collapse" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">border-collapse</code> property sets whether table borders should collapse into a single border or 
be separated as in standard HTML.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>separate</td>
    <td>Borders are separated; each cell will display its own borders. This is default.</td>
  ...
  <tr>
    <td>collapse</td>
    <td>Borders are collapsed into a single border when possible (border-spacing and empty-cells properties 
    have no effect)</td>
...
<div class="w3-code notranslate cssHigh">
    ...
    border-spacing: 10px;<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_border-collapse2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>When using &quot;border-collapse: collapse&quot;, the cell that appears first 
in the code will &quot;win&quot;:</p>
<div class="w3-code notranslate cssHigh">
    table, td, th {<br>&nbsp;&nbsp;&nbsp; border: 3px solid red;<br>}<br><br>#table1 {<br>&nbsp;&nbsp;&nbsp; border-collapse: 
    collapse;<br>&nbsp;&nbsp;&nbsp; 
    border-color: blue;<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_border-collapse3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
