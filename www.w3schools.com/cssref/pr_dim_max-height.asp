...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS max-height property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_margin-top.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_dim_max-width.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">max-height</code> property defines the maximum height of an element.</p>
<p>If the content is larger than the maximum height, it will overflow. How the 
container will handle the overflowing content is defined by the
<a href="pr_pos_overflow.asp">overflow</a> property.</p>
<p>If the content is smaller than the maximum height, the <code class="w3-codespan">
max-height</code> property 
has no effect. </p>
<p><strong>Note:</strong> This prevents the value of the
<a href="pr_dim_height.asp">height</a> property from becoming larger than 
<code class="w3-codespan">max-height</code>. The value of the <code class="w3-codespan">
max-height</code> property overrides
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines the maximum height in px, cm, etc. <a href="css_units.asp">Read about length units</a></td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_max-height&preval=50px">Play it &raquo;</a></td>                
  </tr>
  <tr>
    <td><i>%</i></td>
