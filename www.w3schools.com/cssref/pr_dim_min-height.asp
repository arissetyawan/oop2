...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS min-height Property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_mediaquery.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_dim_min-width.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">min-height</code> property defines the minimum height of an element.</p>
<p>If the content is smaller than the minimum height, the minimum height will be 
applied. </p>
<p>If the content is larger than the minimum height, the <code class="w3-codespan">
min-height</code> property 
has no effect.</p>
<p><strong>Note:</strong> This prevents the value of the
<a href="pr_dim_height.asp">height</a> property from becoming smaller than 
<code class="w3-codespan">min-height</code>.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Default value is 0. Defines the minimum height in px, cm, etc. <a href="css_units.asp">Read about length units</a></td>
