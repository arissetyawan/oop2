...
<a class="w3-left w3-btn" href="sel_attribute.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_attribute_value_contains.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_attribute_value">Try it Yourself &raquo;</a>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> [<i>attribute</i>=<i>value</i>]</td>
    <td>4.0</td>
    <td>7.0</td>
    <td>2.0</td>
    <td>3.1</td>
...
<p><b>Note:</b> For [<i>attribute</i>=<i>value</i>] to work in IE8 and earlier, a <a href="/tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> must be declared.</p>
<hr>
<h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
[<em>attribute</em> = <em>value</em>] {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
<a target="_blank" class="w3-btn btnsmall" href="trysel.asp?selector=[id=my-Address]">Demo</a>
</div></div>
<hr>
...
250px:</p>
<div class="w3-code notranslate cssHigh">
    input[type=text] {<br>&nbsp;&nbsp;&nbsp; width: 100px;<br>&nbsp;&nbsp;&nbsp; transition: ease-in-out, width .35s ease-in-out;<br>}<br><br>
