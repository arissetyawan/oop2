...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS pointer-events property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">pointer-events </span> Property</h1>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="css3_pr_perspective-origin.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="pr_class_position.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  div.ex1 {<br>&nbsp;&nbsp;&nbsp; pointer-events: none;<br>}<br><br>div.ex2 {<br>&nbsp;&nbsp;&nbsp; 
  pointer-events: auto;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_pointer-events">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">pointer-events</code> property defines whether or not an element reacts to 
pointer events.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.pointerEvents=&quot;none&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_pointer-events">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">pointer-events</td>
    <td>2.0</td>
    <td>11.0</td>
    <td>3.6</td>
    <td>4.0</td>
...
pointer-events: auto|none;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>The element reacts to pointer events, like :hover and click. This is 
    default</td>
  </tr>
  <tr>
    <td>none</td>
    <td>The element does not react to pointer events </td>
  </tr>
  <tr>
    <td>initial</td>
