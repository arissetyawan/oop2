...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS isolation property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">isolation</span> Property</h1>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="pr_import_rule.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="css3_pr_justify-content.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  #e {<br>&nbsp; isolation: isolate;<br>} </div>
  <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_isolation" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">isolation</code> property defines whether an element 
must create a new stacking content.</p>
<p><b>Note:</b> The <code class="w3-codespan">isolation</code> property is 
helpful when used with <a href="pr_background-blend-mode.asp">
background-blend-mode</a> or mix-blend-mode.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    ...
    <td><i>object</i>.style.isolation=&quot;isolate&quot;
    <a class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_isolation" target="_blank">Try it</a>
</td>
  </tr>
</table>
</div>
...
<div class="w3-code w3-border notranslate"><div>
  isolation: auto|isolate|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. A new stacking context is created only if one of the properties applied to the element requires it</td>
  </tr>
  <tr>
    <td>isolate</td>
    <td>A new stacking context must be created</td>
  </tr>
  <tr>
    <td>initial</td>
...
<hr>
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/prop_style_isolation.asp">The isolation property</a></p>
<br>
