...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS transition Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">transition </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_transform-style.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_transition-delay.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">transition</code> property is a shorthand property for:</p>
<ul>
  <li><a href="css3_pr_transition-property.asp">transition-property</a></li>
  <li><a href="css3_pr_transition-duration.asp">transition-duration</a></li>
  <li><a href="css3_pr_transition-timing-function.asp">transition-timing-function</a></li>
  <li><a href="css3_pr_transition-delay.asp">transition-delay</a></li>
</ul>
<p><b>Note:</b> Always specify the <a href="css3_pr_transition-duration.asp">transition-duration</a> property, otherwise the duration 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Specifies how many seconds or milliseconds the transition effect takes to complete</td>
  </tr>
  <tr>
...
<div class="w3-example">
<h3>Example</h3>
<p>When an &lt;input type=&quot;text&quot;&gt; gets focus, gradually change the width from 100px to 
250px:</p>
<div class="w3-code notranslate cssHigh">
    input[type=text] {<br>&nbsp;&nbsp;&nbsp; width: 100px;<br>&nbsp;&nbsp;&nbsp; transition: width .35s ease-in-out;<br>}<br><br>
 input[type=text]:focus {<br>&nbsp;&nbsp;&nbsp; width: 250px;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_dim_width_inputfocus">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_transitions.asp">CSS Transitions</a></p>
