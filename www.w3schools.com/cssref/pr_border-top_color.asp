...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-top-color property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-top.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_border-top-left-radius.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
div {border-top-color: coral;}</div>
...
<p>The <code class="w3-codespan">border-top-color</code> property sets the color of an element's top border.</p>
<p><b>Note:</b> Always declare the <a href="pr_border-style.asp">border-style</a> or the 
<a href="pr_border-top_style.asp">border-top-style</a> property before the <code class="w3-codespan">border-top-color</code>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the top border with a HEX value:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-color: #92a8d1;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-color2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the top border with an RGB value:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-color: rgb(201, 76, 76);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-color3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the top border with an RGBA value:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-color: rgba(201, 76, 76, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-color4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the top border with a HSL value:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-color: hsl(89, 43%, 51%);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-color5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the top border with a HSLA value:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-color: hsla(89, 43%, 51%, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-color6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a transparent top border:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-color: transparent;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-color7" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
