...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS max-width property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_dim_max-height.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_mediaquery.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">max-width</code> property defines the maximum width of an element.</p>
<p>If the content is larger than the maximum width, it will automatically change 
the height of the element.</p>
<p>If the content is smaller than the maximum width, the <code class="w3-codespan">
max-width</code> property 
has no effect.</p>
<p><strong>Note:</strong> This prevents the value of the
<a href="pr_dim_width.asp">width</a> property from becoming larger than 
<code class="w3-codespan">max-width</code>. The value of the <code class="w3-codespan">
max-width</code> property overrides
the width property.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines the maximum width in px, cm, etc. <a href="css_units.asp">Read about length units</a></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the maximum width of a &lt;p&gt; element to 50% of the container:</p>
<div class="w3-code notranslate cssHigh">
p.ex1 {<br>
 &nbsp;&nbsp;&nbsp;
 max-width: 50%;<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_dim_max-width2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
