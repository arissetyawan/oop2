...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS tab-size property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_scroll-behavior.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_tab_table-layout.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
pre {-moz-tab-size: 16;} /* Firefox */<br>pre {tab-size: 16;}<br>
...
<p>The <code class="w3-codespan">tab-size</code> property specifies the width of a tab character.</p>
<p>In HTML, the tab character is usually displayed as a single space-character, except for some elements,
like &lt;textarea&gt; and &lt;pre&gt;, and the result of the tab-size property will only be visible for those elements.</p>
...
<p><strong>Note:</strong> No browser is currently supporting the length unit 
value.</p>
<hr>
<h2>CSS Syntax</h2>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><em>number</em></td>
    <td>The number of space-characters to be displayed for each tab-character. 
    Default value is 8</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_tab-size&preval=8">Play it &raquo;</a></td>          
    </tr>
    <tr>
    <td><em>length</em></td>
    <td>The length of a tab-character. This property value is not supported in any of the major browsers</td>
  <td></td>
    </tr>
  <tr>
    <td>initial</td>
