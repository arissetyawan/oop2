    ...
    <div class="textarea">
      <div style="overflow:auto;">
        <div class="headerText">
          ...
          <span class="largedevice">Click a selector to see which element(s)   that gets selected in the result:</span>
        </div>
      </div>
...
<br>
  ...
  <div class="footerText">Click the CSS Selectors and see the specified element(s) get selected. &copy; <a href="https://www.w3schools.com">w3schools.com</a></div>      
</div>
