...
<h1>CSS <span class="color_h1">mix-blend-mode</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_dim_min-width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_object-fit.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>A container with a red background and an image that blends with the red container 
(darken):</p>
<div class="w3-code notranslate cssHigh"> 
    .container {<br>&nbsp; background-color: red;<br>}<br><br>
    .container img {<br>&nbsp; mix-blend-mode: darken;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_mix-blend-mode" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">mix-blend-mode</code> property specifies how an 
element's content should blend with its direct parent background.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    ...
    <td><i>object</i>.style.mixBlendMode = &quot;darken&quot;
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_mixblendmode">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">mix-blend-mode</td>
    <td>41.0</td>
...
mix-blend-mode: normal|multiply|screen|overlay|darken|lighten|color-dodge|color-burn|difference|exclusion|hue|saturation|color|luminosity;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>color-burn</td>
    <td>Sets the blending mode to color-burn</td>
    </tr>
   <tr>
    <td>difference</td>
    <td>Sets the blending mode to difference</td>
    </tr>
   <tr>
    <td>exclusion</td>
    <td>Sets the blending mode to exclusion</td>
    </tr>
 <tr>
    <td>hue</td>
    <td>Sets the blending mode to hue</td>
    </tr>
 <tr>
    <td>saturation</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>A demonstration of all values:</p>
<div class="w3-code notranslate cssHigh"> 
    .normal {mix-blend-mode: normal;}<br>.multiply {mix-blend-mode: multiply;}<br>
    .screen {mix-blend-mode: screen;}<br>.overlay {mix-blend-mode: overlay;}<br>
    .darken {mix-blend-mode: darken;}<br>.lighten {mix-blend-mode: lighten;}<br>
    .color-dodge {mix-blend-mode: color-dodge;}<br>.color-burn {mix-blend-mode: 
    color-burn;}<br>.difference {mix-blend-mode: difference;}<br>.exclusion 
    {mix-blend-mode: exclusion;}<br>.hue {mix-blend-mode: hue;}<br>.saturation 
    {mix-blend-mode: saturation;}<br>.color {mix-blend-mode: color;}<br>
    .luminosity {mix-blend-mode: luminosity;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_mix-blend-mode-all" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Using mix-blend-mode to create a responsive cutout/knockout text:</p>
<div class="w3-code notranslate cssHigh"> 
    .image-container {<br>&nbsp; background-image: url(&quot;paris.jpg&quot;);<br>&nbsp; 
    background-size: cover;<br>&nbsp; position: relative;<br>&nbsp; height: 
    300px;<br>}<br>
    <br>.text {<br>&nbsp; background-color: white;<br>&nbsp; color: black;<br>&nbsp; 
    font-size: 10vw; <br>&nbsp; font-weight: bold;<br>&nbsp; margin: 0 auto;<br>&nbsp; 
    padding: 10px;<br>&nbsp; width: 50%;<br>&nbsp; text-align: center;<br>&nbsp; 
    position: absolute;<br>&nbsp; top: 50%;<br>&nbsp; left: 50%;<br>&nbsp; 
    transform: translate(-50%, -50%);<br>&nbsp; mix-blend-mode: screen;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_mix-blend-mode_cutout" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Related Pages</h2>
<p>CSS reference: <a href="/cssref/pr_background-blend-mode.asp">CSS background-blend-mode Property</a></p>
