...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS width property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_text_white-space.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_word-break.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=trycss_dim_width" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">width</code> property sets the width of an element.</p>
<p>The width of an element does not include padding, borders, or margins!</p>
<p><b>Note:</b> The <a href="pr_dim_min-width.asp">min-width</a> and
<a href="pr_dim_max-width.asp">max-width</a> properties override the <code class="w3-codespan">width</code> 
property.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines the width in px, cm, etc. <a href="css_units.asp">Read about length units</a></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the width of an &lt;input type="text"&gt; element to 100px. However, when 
it gets focus, make it 250px wide:</p>
<div class="w3-code notranslate cssHigh">
    input[type=text] {<br>&nbsp;&nbsp;&nbsp; width: 100px;<br>}<br><br>
