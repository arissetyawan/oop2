...
<html lang="en-US">
<head>
<title>CSS grid-template property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">grid-template</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-row-start.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-template-areas.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=trycss_grid-template" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-template</code> property is a shorthand property for the 
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-template">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridTemplate=&quot;250px / auto auto&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-template">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-template</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-template: none|<em>grid-template-rows</em> / 
  <em>grid-template-columns</em>|<em>grid-template-areas</em>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>grid-template-areas</i></td>
    <td>Specifies the grid layout using named items</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template2">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-area: myArea;<br>}<br>.grid-container {<br>&nbsp;&nbsp;display: grid;<br>&nbsp; grid-template:<br>&nbsp;&nbsp;&nbsp; 
  'myArea myArea . . .'<br>&nbsp;&nbsp;&nbsp; 'myArea myArea . . .';<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-template2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
  ...
  footer; }<br><br>.grid-container {<br>&nbsp;&nbsp;display: grid;<br>&nbsp; grid-template:<br>&nbsp;&nbsp;&nbsp; 
  'header header header header header header'<br>&nbsp;&nbsp;&nbsp; 
  'menu main main main right right'<br>&nbsp;&nbsp;&nbsp; 'menu footer footer 
  footer footer';<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-template3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="/css/css_grid_item.asp">CSS Grid Item</a></p>
<p>CSS Reference: The <a href="pr_grid-area.asp">grid-area</a> property</p>
