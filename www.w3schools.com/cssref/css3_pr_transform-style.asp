...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS transform-style property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">transform-style </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_transform-origin.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_transition.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">transform-style</code> property specifies how nested elements are rendered in 3D 
space.</p>
<p><b>Note:</b> This property must be used together with the 
<a href="css3_pr_transform.asp">transform</a> 
property.</p>
<p>To better understand the <code class="w3-codespan">transform-style</code> property,
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>flat</td>
    <td>Specifies that child elements will NOT preserve its 3D position. This is default</td>
  </tr>
  <tr>
    <td>preserve-3d</td>
