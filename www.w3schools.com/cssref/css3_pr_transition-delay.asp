...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS transition-delay  Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">transition-delay </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_transition.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_transition-duration.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">transition-delay</code> property specifies when the transition effect will start.</p>
<p>The <code class="w3-codespan">transition-delay</code> value is defined in seconds (s) or milliseconds (ms).</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>time</i></td>
    <td>Specifies the number of seconds or milliseconds to wait before the transition effect will start</td>
  </tr>
  <tr>
    <td>initial</td>
