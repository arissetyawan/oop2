...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS box-decoration-break property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">box-decoration-break</span> Property</h1>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="pr_pos_bottom.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="css3_pr_box-shadow.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    span.ex1 { <br>&nbsp;&nbsp;&nbsp; -webkit-box-decoration-break: clone;<br>&nbsp;&nbsp;&nbsp; 
    -o-box-decoration-break: clone;<br>&nbsp;&nbsp;&nbsp; box-decoration-break: 
    clone;<br>}<br><br>
    span.ex2 { <br>&nbsp;&nbsp;&nbsp; -webkit-box-decoration-break: slice;<br>&nbsp;&nbsp;&nbsp; 
    -o-box-decoration-break: slice;<br>&nbsp;&nbsp;&nbsp; box-decoration-break: 
    slice;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_box-decoration-break">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">box-decoration-break</code> property specifies how the background, padding, 
border, border-image, box-shadow, margin, and clip-path of an element is applied 
when the box for the element is fragmented.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.boxDecorationBreak=&quot;clone&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_box-decoration-break">Try it</a>
</td>
  </tr>
 </table>
</div>
...
<p>Numbers followed by -webkit- or -o- specify the first version that worked with a prefix.</p>
<div class="w3-responsive">
...
box-decoration-break: slice|clone|initial|inherit|unset;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td> slice</td>
    <td>Default. Box decorations are applied to the element as a whole and break at 
    the edges of the element fragments </td>
  </tr>
  <tr>
    <td> clone</td>
    <td>Box decorations apply to each fragment of the element as if the 
