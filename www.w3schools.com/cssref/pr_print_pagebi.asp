...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS page-break-inside property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_print_pagebb.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_perspective.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">page-break-inside</code> property sets whether a page-break should be avoided inside a specified element.</p>
<p><strong>Tip:</strong> The properties: <a href="pr_print_pagebb.asp">
page-break-before</a>, <a href="pr_print_pageba.asp">page-break-after</a> and 
page-break-inside help to define how a document should behave when printed.</p>
