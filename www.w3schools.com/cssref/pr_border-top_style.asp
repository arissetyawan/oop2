...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-top-style property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_border-top-right-radius.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-top_width.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
div {border-top-style: dotted;}</div>
...
<p>The <code class="w3-codespan">border-top-style</code> property sets the style of an element's top border.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">border-top-style</td>
    <td>1.0</td>
    <td>5.5</td>
    <td>1.0</td>
    <td>1.0</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>A dashed top border:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-style: dashed;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-style2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A solid top border:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-style: solid;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-style3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A double top border:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-style: double;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-style4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Remove the top border:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-style: none;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-style5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A groove top border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-top-style: groove;<br>&nbsp;&nbsp;&nbsp; border-top-color: coral;<br>&nbsp;&nbsp;&nbsp; border-top-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-style6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A ridge top border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-top-style: ridge;<br>&nbsp;&nbsp;&nbsp; border-top-color: coral;<br>&nbsp;&nbsp;&nbsp; border-top-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-style7" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>An inset top border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-top-style: inset;<br>&nbsp;&nbsp;&nbsp; border-top-color: coral;<br>&nbsp;&nbsp;&nbsp; border-top-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-style8" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>An outset top border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-top-style: outset;<br>&nbsp;&nbsp;&nbsp; border-top-color: coral;<br>&nbsp;&nbsp;&nbsp; border-top-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-style9" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
