...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS counter-reset property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_gen_counter-increment.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_class_cursor.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">counter-reset</code> property creates or resets one or more CSS counters.</p>
<p>The <code class="w3-codespan">counter-reset</code> property is usually used together with the 
<a href="pr_gen_counter-increment.asp">counter-increment</a> property and the 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>id number</i></td>
    <td>The <i>id</i> defines which counter to reset. The <i>number</i> sets the value the counter is
      reset to on each occurrence of the selector. The default <em>number</em> value is 0</td>
  </tr>
  <tr>
    <td>initial</td>
...
body
 ...
 <br>
 h2::before {<br>&nbsp;&nbsp;&nbsp; /* Increment &quot;subsection&quot; by 1 */<br>
 &nbsp;&nbsp;&nbsp;
