...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS overflow property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_outline-width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_overflow-x.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">overflow</code> property specifies what should happen if content overflows an element's box.</p>
<p>This property specifies whether to clip content or to add scrollbars when an 
element's content is too big to fit in a specified area.</p>
