...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS outline-width Property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_outline-style.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_pos_overflow.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">outline-width</code> specifies the width of an outline.</p>
<p><b>Note:</b> Always declare the <a href="pr_outline-style.asp">outline-style</a> property before the <code class="w3-codespan">
outline-width</code> property. An element must have an outline before you change the width of it.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.outlineWidth=&quot;12px&quot;
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Allows you to define the thickness of the outline. <a href="css_units.asp">Read about length units</a></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the outline to medium (this is default):</p>
<div class="w3-code notranslate cssHigh">
div {outline-width: medium;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-width2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the outline to thin:</p>
<div class="w3-code notranslate cssHigh">
div {outline-width: thin;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-width3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the outline to 1px:</p>
<div class="w3-code notranslate cssHigh">
div {outline-width: 1px;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-width4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the outline to 15px:</p>
<div class="w3-code notranslate cssHigh">
div {outline-width: 15px;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-width5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
