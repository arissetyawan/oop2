...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS user-select property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">user-select</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_text_unicode-bidi.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_pos_vertical-align.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    div
 {<br>
 &nbsp;&nbsp;&nbsp; -webkit-user-select: none; /* Safari 3.1+ */<br>&nbsp;&nbsp;&nbsp; 
    -moz-user-select: none; /* Firefox 2+ */<br>&nbsp;&nbsp;&nbsp; -ms-user-select: 
    none; /* IE 10+ */<br>&nbsp;&nbsp;&nbsp; user-select: none; /* Standard 
    syntax */<br>
 }
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_user-select">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">user-select</code> property specifies whether the text of an element can be selected.</p>
<p>In web browsers, if you double-click on some text it will be selected/highlighted. This property can be used to prevent this.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    ...
    <td><i>object</i>.style.userSelect=&quot;none&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_user-select">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    ...
    <td>54.0<br>6.0&nbsp;-webkit-</td>
    <td>10.0 -ms-</td>
    <td>2.0 -moz-</td>
    <td>3.1 -webkit-</td>
    <td>41.0<br>15.0 -webkit-</td>
  </tr>
</table>
</div>
<hr>
...
<div class="w3-code w3-border notranslate"><div>
  user-select: auto|none|text|all;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default. Text can be selected if the browser allows it</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_user-select&preval=auto">Play it &raquo;</a></td>            
  </tr>
  <tr>
    <td>none</td>
    <td>Prevent text selection</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_user-select&preval=none">Play it &raquo;</a></td>            
  </tr>
  <tr>
    <td>text</td>
    <td>The text can be selected by the user</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_user-select&preval=text">Play it &raquo;</a></td>            
    </tr>
  <tr>
    <td>all</td>
    <td>Text selection is made with one click instead of a double-click</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_user-select&preval=all">Play it &raquo;</a></td>            
    </tr>
  </table>
</div>
<hr>
...
<h2>Related Pages</h2>
<p>HTML DOM reference: <a href="/jsref/prop_style_userselect.asp">userSelect property</a></p>
<br>
