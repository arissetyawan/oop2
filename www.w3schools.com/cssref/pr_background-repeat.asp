...
<a class="w3-left w3-btn" href="pr_background-position.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_background-size.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">background-repeat</code> property sets if/how a background image will be 
repeated.</p>
<p>By default, a <a href="pr_background-image.asp">background-image</a> is repeated both vertically and horizontally.</p>
<p><b>Tip: </b>The background image is placed according to the 
<a href="pr_background-position.asp">background-position</a> property. If no background-position is specified, the image 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    The first and last images are pinned to either side of the element, and 
    whitespace is distributed evenly between the images</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-repeat&preval=space">Play it &raquo;</a></td>        
  </tr>
  <tr>
    <td>round</td>
    <td>The background-image is repeated and squished or stretched to fill the 
    space (no gaps)</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_background-repeat&preval=round">Play it &raquo;</a></td>        
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Repeat a background image both vertically and horizontally (this is default):</p>
<div class="w3-code notranslate cssHigh">
    body
 {<br>
 &nbsp;&nbsp;&nbsp;
...
<div class="w3-example">
<h3>Example</h3>
<p>Do not repeat a background image. The image will only be shown once:</p>
<div class="w3-code notranslate cssHigh">
    body
 {<br>
 &nbsp;&nbsp;&nbsp;
...
<div class="w3-example">
<h3>Example</h3>
<p>Using background-repeat: space and background-repeat: round:</p>
<div class="w3-code notranslate cssHigh">
    #example2 {<br>&nbsp;&nbsp;&nbsp; border: 2px solid black;<br>&nbsp;&nbsp;&nbsp; 
    padding: 25px;<br>&nbsp;&nbsp;&nbsp; background: url(&quot;w3css.gif&quot;);<br>&nbsp;&nbsp;&nbsp; 
    background-repeat: space;<br>}<br><br>#example3 {<br>&nbsp;&nbsp;&nbsp; 
    border: 1px solid black;<br>&nbsp;&nbsp;&nbsp; padding: 25px;<br>&nbsp;&nbsp;&nbsp; 
    background: url(&quot;w3css.gif&quot;);<br>&nbsp;&nbsp;&nbsp; background-repeat: round;<br>
    } </div>
<a target="_blank" href="tryit.asp?filename=trycss_background-repeat_space" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
