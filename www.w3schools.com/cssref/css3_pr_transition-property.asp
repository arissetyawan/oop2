...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS transition-property Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">transition-property </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_transition-duration.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_transition-timing-function.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">transition-property</code> property specifies the name of the CSS property the transition 
...
<p><b>Note:</b> Always specify the <a href="css3_pr_transition-duration.asp">transition-duration</a> property, otherwise the duration is 0, and the transition will have no effect.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>property</i></td>
    <td>Defines a comma separated list of CSS property names the transition effect is for</td>
  </tr>
  <tr>
    <td>initial</td>
...
transition effect:</p>
<div class="w3-code notranslate cssHigh">
    div {<br>&nbsp;&nbsp;&nbsp; transition-property: width, height;<br>}<br>
 <br>div:hover {<br>&nbsp;&nbsp;&nbsp; width: 300px;<br>&nbsp;&nbsp;&nbsp; height: 300px;<br>}</div>
