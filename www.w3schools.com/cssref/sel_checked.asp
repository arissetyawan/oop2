...
<h1>CSS <span class="color_h1">:checked</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_before.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_default.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Set the height and width for all checked &lt;input&gt; elements:</p>
<div class="w3-code notranslate cssHigh">
  
    input:checked {<br>&nbsp;&nbsp;&nbsp; height: 50px;<br>&nbsp;&nbsp;&nbsp; width: 50px;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_checked">Try it Yourself &raquo;</a>
</div>
...
matches every checked &lt;input&gt; element (only for radio buttons and checkboxes) 
and &lt;option&gt; element.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> :checked</td>
    <td>4.0</td>
    <td>9.0</td>
    <td>3.5</td>
    <td>3.2</td>
...
:checked {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
<a target="_blank" class="w3-btn btnsmall" href="trysel.asp?selector=:checked">Demo</a>
</div></div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the height and width for all checked &lt;option&gt; elements:</p>
<div class="w3-code notranslate cssHigh">
  
    option:checked {<br>&nbsp;&nbsp;&nbsp; height: 100px;<br>&nbsp;&nbsp;&nbsp; width: 100px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_checked2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS Selector Reference: <a href="sel_disabled.asp">CSS :disabled selector</a></p>
<p>CSS Selector Reference: <a href="sel_enabled.asp">CSS :enabled selector</a></p>
<br>
