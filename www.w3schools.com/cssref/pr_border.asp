...
<a class="w3-left w3-btn" href="css3_pr_background-size.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-bottom.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">border</code> property is a shorthand property for:</p>
<ul>
  <li><a href="pr_border-width.asp">border-width</a></li>
  <li><a href="pr_border-style.asp">border-style</a> (required)</li>
  <li><a href="pr_border-color.asp">border-color</a></li>
</ul>
<p>If border-color is omitted, the color applied will be the color of the text.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Specifies the color of the border. Default value is the color of the 
    text</td>
  </tr>
  <tr>
    <td>initial</td>
