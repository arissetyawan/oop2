...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS hanging-punctuation property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">hanging-punctuation</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-template-rows.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_dim_height.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">hanging-punctuation</code> property specifies whether a punctuation mark may be placed outside the line box 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">hanging-punctuation</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>none</td>
    <td>No punctuation mark may be placed outside the line box at the start or at the end of a full line of text</td>
  </tr>
  <tr>
    <td>first</td>
    <td>Punctuation may hang outside the start edge of the first line</td>
  </tr>
  <tr>
    <td>last</td>
    <td>Punctuation may hang outside the end edge of the last line</td>
  </tr>
  <tr>
    <td>allow-end</td>
    <td>Punctuation may hang outside the end edge of all lines if the punctuation does not otherwise fit prior to justification</td>
  </tr>
  <tr>
    <td>force-end</td>
    <td>Punctuation may hang outside the end edge of all lines. If justification is enabled on this line, then it will force the punctuation to hang</td>
  </tr>
  <tr>
    <td>initial</td>
