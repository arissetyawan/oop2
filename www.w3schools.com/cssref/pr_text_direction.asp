...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS direction property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_class_cursor.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_class_display.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">direction</code> property specifies the text direction/writing direction within 
a block-level element.</p>
<p><strong>Tip:</strong> Use this property together with the <a href="pr_text_unicode-bidi.asp">
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;">direction&nbsp;</td>
    <td>2.0</td>
    <td>5.5</td>
    <td>1.0</td>
    <td>1.3</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>ltr</td>
    <td>Text direction goes from left-to-right. This is default</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_direction">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>rtl</td>
    <td>Text direction goes from right-to-left</td>
