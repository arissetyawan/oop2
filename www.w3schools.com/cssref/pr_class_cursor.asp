...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS cursor property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_gen_counter-reset.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_text_direction.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">cursor</code> property specifies the mouse cursor to be displayed when pointing over an element.</p>
...
<table class="w3-table-all notranslate">
  ...
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_cursor&preval=url(myBall.cur),auto">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>vertical-text</td>
