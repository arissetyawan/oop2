...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS column-count property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">column-count</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_text_color.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_column-fill.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>number</i></td>
    <td>The optimal number of columns into which the content of the element will be flowed</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-count">Play it &raquo;</a></td>   
  </tr>
  <tr>
    <td>auto</td>
    <td>Default value. The number of columns will be determined by other properties, like e.g. &quot;column-width&quot;</td>
