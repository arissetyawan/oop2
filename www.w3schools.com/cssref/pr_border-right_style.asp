...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-right-style property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-right_color.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-right_width.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
div {border-right-style: dotted;}</div>
...
<p>The <code class="w3-codespan">border-right-style</code> property sets the style of an element's right border.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>A dashed right border:</p>
<div class="w3-code notranslate cssHigh">
div {border-right-style: dashed;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-style2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A solid right border:</p>
<div class="w3-code notranslate cssHigh">
div {border-right-style: solid;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-style3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A double right border:</p>
<div class="w3-code notranslate cssHigh">
div {border-right-style: double;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-style4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Remove the right border:</p>
<div class="w3-code notranslate cssHigh">
div {border-right-style: none;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-style5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A groove right border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-right-style: groove;<br>&nbsp;&nbsp;&nbsp; border-right-color: coral;<br>&nbsp;&nbsp;&nbsp; border-right-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-style6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A ridge right border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-right-style: ridge;<br>&nbsp;&nbsp;&nbsp; border-right-color: coral;<br>&nbsp;&nbsp;&nbsp; border-right-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-style7" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>An inset right border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-right-style: inset;<br>&nbsp;&nbsp;&nbsp; border-right-color: coral;<br>&nbsp;&nbsp;&nbsp; border-right-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-style8" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>An outset right border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-right-style: outset;<br>&nbsp;&nbsp;&nbsp; border-right-color: coral;<br>&nbsp;&nbsp;&nbsp; border-right-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-style9" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
