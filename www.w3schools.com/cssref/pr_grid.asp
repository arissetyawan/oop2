...
<h1>CSS <span class="color_h1">grid</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_font_weight.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-area.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  ...
  / auto auto auto;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">grid</code> property is a shorthand property for:</p>
<ul>
  <li><a href="pr_grid-template-rows.asp">grid-template-rows</a></li>
  <li><a href="pr_grid-template-columns.asp">grid-template-columns</a></li>
  <li><a href="pr_grid-template-areas.asp">grid-template-areas</a></li>
  <li><a href="pr_grid-auto-rows.asp">grid-auto-rows</a></li>
  <li><a href="pr_grid-auto-columns.asp">grid-auto-columns</a></li>
  <li><a href="pr_grid-auto-flow.asp">grid-auto-flow</a></li>
</ul>
<div class="w3-responsive">
<table class="w3-table-all">
  <tr>
    <th style="width:25%">Default value:</th>
    <td>none none none auto auto row</td>
  </tr>
  <tr>
    <th>Inherited:</th>
    <td>no</td>
  ...
  <tr>
    <th>Animatable:</th>
    <td>yes, <em>see individual properties</em>. <a href="css_animatable.asp">Read about <em>animatable</em></a>
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.grid=&quot;250px / auto auto auto&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid">Try it</a>
</td>
  </tr>
</table>
</div>
...
<div class="w3-code w3-border notranslate"><div>
  grid: none|<em>grid-template-rows</em> / 
  <em>grid-template-columns</em>|<em>grid-template-areas</em>|<em>grid-template-rows</em> 
  / <em>[grid-auto-flow] grid-auto-columns</em>|<em>[grid-auto-flow] grid-auto-rows</em> / <em>grid-template-columns</em>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>none</td>
    <td>Default value. No specific sizing of the columns or rows</td>
    <td></td> 
  </tr>
  <tr>
    <td><i>grid-template rows / grid-template-columns</i></td>
    <td>Specifies the size(s) of the columns and rows</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>grid-template-areas</i></td>
    <td>Specifies the grid layout using named items</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid2">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>grid-template rows / grid-auto-columns</i></td>
    <td>Specifies the size (height) of the rows, and the auto size of the 
    columns</td>
    <td></td>
  </tr>
  <tr>
    <td><i>grid-auto-rows / grid-template-columns</i></td>
    <td>Specifies the auto size of the rows, and sets the grid-template-columns 
    property</td>
    <td></td>
  </tr>
  <tr>
    <td><i>grid-template rows / grid-auto-flow grid-auto-columns</i></td>
    <td>Specifies the size (height) of the rows, and how to place auto-placed 
    items, and the auto size of the 
    columns</td>
    <td></td>
  </tr>
  <tr>
    <td><i>grid-auto flow grid-auto-rows / grid-template-columns</i></td>
    <td>Specifies how to place auto-placed items, and the auto size of the rows, and sets the grid-template-columns 
    property</td>
    <td></td>
  </tr>
  <tr>
    <td>initial</td>
    <td>Sets this property to its default value. <em><a href="css_initial.asp">
    Read about initial</a></em></td>
    <td></td>
  </tr>
  <tr>
    <td>inherit</td>
    <td>Inherits this property from its parent element. Read about <em>
    <a href="css_inherit.asp">inherit</a></em></td>
    <td></td>
  </tr>
</table>
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Specify two rows, where &quot;item1&quot; spans the first two columns in the first two 
rows (in a five columns grid layout):</p>
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-area: myArea;<br>}<br>.grid-container {<br>&nbsp;&nbsp;display: grid;<br>&nbsp; grid:<br>&nbsp;&nbsp;&nbsp; 
  'myArea myArea . . .'<br>&nbsp;&nbsp;&nbsp; 'myArea myArea . . .';<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
  .item1 {&nbsp;grid-area: header; }<br>.item2 {&nbsp;grid-area: 
  menu; }<br>.item3 {&nbsp;grid-area: 
  main; }<br>.item4 {&nbsp;grid-area: 
  right; }<br>.item5 {&nbsp;grid-area: 
  footer; }<br><br>.grid-container {<br>&nbsp;&nbsp;display: grid;<br>&nbsp; grid:<br>&nbsp;&nbsp;&nbsp; 
  'header header header header header'<br>&nbsp;&nbsp;&nbsp; 
  'menu main main main right right'<br>&nbsp;&nbsp;&nbsp; 'menu footer footer 
  footer footer';<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="/css/css_grid_container.asp">CSS Grid Container</a></p>
<p>CSS Reference: The <a href="pr_grid-template-areas.asp">grid-template-areas</a> property</p>
<p>CSS Reference: The <a href="pr_grid-template-rows.asp">grid-template-rows</a> property</p>
<p>CSS Reference: The <a href="pr_grid-template-columns.asp">grid-template-columns</a> property</p>
<p>CSS Reference: The <a href="pr_grid-auto-rows.asp">grid-auto-rows</a> property</p>
<p>CSS Reference: The <a href="pr_grid-auto-columns.asp">grid-auto-columns</a> property</p>
<p>CSS Reference: The <a href="pr_grid-auto-flow.asp">grid-auto-flow</a> property</p>
<p>CSS Reference: The <a href="pr_grid-row-gap.asp">grid-row-gap</a> property</p>
<p>CSS Reference: The <a href="pr_grid-column-gap.asp">grid-column-gap</a> property</p>
