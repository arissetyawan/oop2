...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS all property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_align-self.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_animation.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">all</code> property resets all properties, apart from unicode-bidi and 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>initial</td>
    <td>Changes all the properties applied to the element or the element's parent to their initial value</td>
    </tr>
  <tr>
    <td>inherit</td>
    <td>Changes all the properties applied to the element or the element's parent to their parent value</td>
    </tr>
  <tr>
    <td>unset</td>
    <td>Changes all the properties applied to the element or the element's parent to their parent value if they are inheritable or to their initial value if not</td>
    </tr>
  </table>
</div>
