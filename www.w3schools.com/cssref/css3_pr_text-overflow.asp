...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS text-overflow property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">text-overflow</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_text-justify.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_text-shadow.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">text-overflow</code> property specifies how overflowed content that is not 
displayed should be signaled to the user. It can be clipped, display an ellipsis 
(...), or display a custom string.</p>
<p>Both of the following properties are required for text-overflow:</p>
<ul>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>clip</td>
    <td>Default value. The text is clipped and not accessible</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-overflow">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>ellipsis</td>
    <td>Render an ellipsis (&quot;...&quot;) to represent the clipped text</td>
  ...
  <tr>
    <td><i>string</i></td>
    <td>Render the given string to represent the clipped text</td>
    <td></td>
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Text-overflow with a hover effect (show entire text on hover):</p>
<div class="w3-code notranslate cssHigh">
    div.a {<br>&nbsp;&nbsp;&nbsp; white-space: nowrap; <br>&nbsp;&nbsp;&nbsp; 
    overflow: hidden;<br>&nbsp;&nbsp;&nbsp;
 text-overflow: ellipsis;<br>}<br><br>div.a:hover {<br>&nbsp;&nbsp;&nbsp; 
    overflow: visible;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-overflow_hover">Try it Yourself &raquo;</a>
</div>
<hr>
