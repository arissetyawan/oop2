...
<h1>CSS <span class="color_h1">grid-column-end</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-column.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-column-gap.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-column-end: span 3;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-column-end" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-column-end</code> property defines how many columns an item will span, or 
on which column-line the item will end (see example at the end of this page).</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-column-end">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridColumnEnd=&quot;5&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-column-end">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-column-end</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-column-end: 
  auto|<i>column-line</i>|span <em>n</em>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default value. The item will span one column.</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-column-end">Play it &raquo;</a></td> 
  </tr>
  <tr>
    <td>span <em>n</em></td>
    <td>Specifies the number of columns the item will span.</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-column-end&preval=span 3">Play it &raquo;</a></td> 
  </tr>
  <tr>
    <td><i>column-line</i></td>
    <td>Specifies on which column to end the display of the item.</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-column-end&preval=5">Play it &raquo;</a></td> 
  </tr>
  </table>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>You can use column-line values instead numbers of columns to span:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-column-end: 3;<br>}<br></div>
  <a target="_blank" href="tryit.asp?filename=trycss_grid-column-end2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
