...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS color property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_pos_clip.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_column-count.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">color</code> property specifies the color of text.</p>
<p><b>Tip:</b> Use a background color combined with a text color that makes the text easy to read.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>color</i></td>
    <td>Specifies the text color. Look at <a href="css_colors_legal.asp">CSS Color Values</a> for a complete list of possible color values.</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the text color with a HEX value:</p>
<div class="w3-code notranslate cssHigh">
  body {color: #92a8d1;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_color2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the text color with an RGB value:</p>
<div class="w3-code notranslate cssHigh">
  body {color: rgb(201, 76, 76);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_color3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the text color with an RGBA value:</p>
<div class="w3-code notranslate cssHigh">
  body {color: rgba(201, 76, 76, 0.6);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_color4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the text color with a HSL value:</p>
<div class="w3-code notranslate cssHigh">
  body {color: hsl(89, 43%, 51%);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_color5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the text color with a HSLA value:</p>
<div class="w3-code notranslate cssHigh">
  body {color: hsla(89, 43%, 51%, 0.6);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_color6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
