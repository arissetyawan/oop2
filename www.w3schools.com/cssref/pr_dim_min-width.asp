...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS min-width property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_dim_min-height.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="pr_mix-blend-mode.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">min-width</code> property defines the minimum width of an element.</p>
<p>If the content is smaller than the minimum width, the minimum width will be 
applied. </p>
<p>If the content is larger than the minimum width, the <code class="w3-codespan">
min-width</code> property 
has no effect.</p>
<p><strong>Note:</strong> This prevents the value of the
<a href="pr_dim_width.asp">
width</a> property from becoming smaller than 
<code class="w3-codespan">min-width</code>.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Default value is 0. Defines the minimum width in px, cm, etc. <a href="css_units.asp">Read about length units</a></td>
