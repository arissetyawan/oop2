...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS white-space property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_class_visibility.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_dim_width.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    p.a {<br>&nbsp;&nbsp;&nbsp; white-space: nowrap;<br>}<br><br>p.b {<br>&nbsp;&nbsp;&nbsp; 
    white-space: normal;<br>}<br><br>p.c {<br>&nbsp;&nbsp;&nbsp; white-space: 
    pre;<br>}
...
<p>The <code class="w3-codespan">white-space</code> property specifies how white-space inside an element is handled.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>nowrap</td>
    <td>Sequences of whitespace will collapse into a single whitespace. Text will never wrap to the next line. The text continues on the same line until
