...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS perspective-origin property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">perspective-origin </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_perspective.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="css3_pr_pointer-events.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
 ...
 &nbsp;&nbsp;&nbsp;
 -webkit-perspective-origin: left; /* Safari 4-8 */<br>
 &nbsp;&nbsp;&nbsp;
...
<p>The <code class="w3-codespan">perspective-origin</code> property defines at from which position the user is 
looking at the 3D-positioned element.</p>
<p>When defining the <code class="w3-codespan">perspective-origin</code> property for an element, it is the CHILD elements 
that will get the effect, NOT the element itself.</p>
<p><b>Note:</b> This property must be used in conjunction with the 
<a href="css3_pr_perspective.asp">perspective</a> property!</p>
