...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS word-spacing property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_word-break.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_word-wrap.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">word-spacing</code> property increases or decreases the white space between words.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>normal</td>
    <td>Defines normal space between words (0.25em)&nbsp;. This is default</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_word-spacing">Play it &raquo;</a></td>                 
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Defines an additional space between words (in px, pt, cm, em, etc). Negative values are allowed. <a href="css_units.asp">Read about length units</a></td>
