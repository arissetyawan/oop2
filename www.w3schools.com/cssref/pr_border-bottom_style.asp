...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-bottom-style property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_border-bottom-right-radius.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-bottom_width.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
div {border-bottom-style: dotted;}</div>
...
<p>The <code class="w3-codespan">border-bottom-style</code> property sets the style of an element's bottom border.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>A dashed bottom border:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-style: dashed;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-style2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A solid bottom border:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-style: solid;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-style3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A double bottom border:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-style: double;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-style4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Remove the bottom border:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-style: none;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-style5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A groove bottom border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-bottom-style: groove;<br>&nbsp;&nbsp;&nbsp; border-bottom-color: coral;<br>&nbsp;&nbsp;&nbsp; border-bottom-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-style6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A ridge bottom border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-bottom-style: ridge;<br>&nbsp;&nbsp;&nbsp; border-bottom-color: coral;<br>&nbsp;&nbsp;&nbsp; border-bottom-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-style7" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>An inset bottom border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-bottom-style: inset;<br>&nbsp;&nbsp;&nbsp; border-bottom-color: coral;<br>&nbsp;&nbsp;&nbsp; border-bottom-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-style8" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>An outset bottom border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-bottom-style: outset;<br>&nbsp;&nbsp;&nbsp; border-bottom-color: coral;<br>&nbsp;&nbsp;&nbsp; border-bottom-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-style9" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
