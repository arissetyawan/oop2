...
<style>
a.testback {text-decoration:none;color:#8AC007;font-size:14px;}
a.testback:hover {text-decoration:underline;}
</style>
</head>
<body>
...
<a class="w3-left w3-btn" href="css_selectors.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_id.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_class">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <i>.class</i> selector selects elements with a specific class attribute.</p>
...
To do this, start with the element name, then write the period (.) character, followed by the name of the class 
(look at Example 1 below).</p>

<p>HTML elements 
can also refer to more than one class (look at Example 2 below).&nbsp;</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"><em>.class</em></td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_class_more" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example 2</h3>
<p>This &lt;p&gt; element will be styled according to class=&quot;center&quot; 
AND to class=&quot;large&quot;:</p>
<div class="w3-code notranslate htmlHigh">
 &lt;p class=&quot;center large&quot;&gt;This paragraph refers to two classes.&lt;/p&gt;</div>
<a target="_blank" href="tryit.asp?filename=trycss_sel_class_more2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
