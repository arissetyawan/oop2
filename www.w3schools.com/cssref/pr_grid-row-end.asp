...
<html lang="en-US">
<head>
<title>CSS grid-row-end property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">grid-row-end</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-row.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-row-gap.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-row-end: span 3;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-row-end" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">grid-row-end</code> property defines how many rows an item will span, or 
on which row-line the item will end (see example at the end of this page).</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-row-end">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridRowEnd=&quot;4&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-row-end">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-row-end</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-row-end: 
  auto|<i>row-line</i>|span <em>n</em>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default value. The item will span one row.</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-row-end">Play it &raquo;</a></td> 
  </tr>
  <tr>
    <td>span <em>n</em></td>
    <td>Specifies the number of rows the item will span.</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-row-end&preval=span 3">Play it &raquo;</a></td> 
  </tr>
  <tr>
    <td><i>column-line</i></td>
    <td>Specifies on which row to end the display of the item.</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-row-end&preval=5">Play it &raquo;</a></td> 
  </tr>
  </table>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>You can use row-line values instead numbers of rows to span:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-row-end: 3;<br>}<br></div>
  <a target="_blank" href="tryit.asp?filename=trycss_grid-row-end2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
