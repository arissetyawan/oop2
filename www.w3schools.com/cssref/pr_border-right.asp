...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-right property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_border-radius.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-right_color.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">border-right</code> property is a shorthand 
property for (in the following order):</p>
<ul>
  <li><a href="pr_border-right_width.asp">border-right-width</a></li>
  <li><a href="pr_border-right_style.asp">border-right-style</a> (required)</li>
  <li><a href="pr_border-right_color.asp">border-right-color</a></li>
</ul>
<p>If border-right-color is omitted, the color applied will be the color of the 
text.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the width of the right border. Default value is 
    &quot;medium&quot;</td>
  </tr>
  <tr>
    <td><i><a href="pr_border-right_style.asp">border-right-style</a></i></td>
    <td>Required. Specifies the style of the right border. Default value is 
    &quot;none&quot;</td>
  </tr>
  <tr>
    <td><i><a href="pr_border-right_color.asp">border-right-color</a></i></td>
    <td>Optional. Specifies the color of the right border. Default value is the 
