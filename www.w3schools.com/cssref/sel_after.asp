...
<a class="w3-left w3-btn" href="sel_active.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_before.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Insert some text after the content of each &lt;p&gt; element:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_after">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The ::after selector inserts something after the content of each selected element(s).</p>
<p>Use the <a href="pr_gen_content.asp">content</a> property to specify the content 
to insert.</p>
<p>Use the <a href="sel_before.asp">::before</a> selector to insert something before the content.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> ::after</td>
    <td>4.0</td>
...
syntax (:after). Newer versions support the standard, double-colon syntax 
(::after).</p>
<p><strong>Note:</strong> For :after to work in IE8, a <a href="/tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> 
must be declared.</p>
<hr>
...
::after {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_after_style" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
