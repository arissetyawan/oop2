...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS margin-top property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_margin-right.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_dim_max-height.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">margin-top</code> property sets the top margin of an element.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Specifies a fixed top margin in px, pt, cm, etc. Default value is 0px. 
    Negative values are allowed. <a href="css_units.asp">Read about length units</a></td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin-top&preval=0">Play it &raquo;</a></td>                    
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Specifies a top margin in percent of the width of the containing element</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the top margin for a &lt;p&gt; element to 10% of the width of the 
container:</p>
<div class="w3-code notranslate cssHigh">
p.ex1 {<br>
&nbsp;&nbsp;&nbsp; margin-top: 10%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_margin-top2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the top margin for a &lt;p&gt; element to 2 em:</p>
<div class="w3-code notranslate cssHigh">
p.ex1 {<br>
&nbsp;&nbsp;&nbsp; margin-top: 2em;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_margin-top3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
