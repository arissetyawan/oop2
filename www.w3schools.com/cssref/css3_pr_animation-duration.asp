...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS animation-duration Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">animation-duration </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_animation-direction.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_animation-fill-mode.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">animation-duration</code> property defines how long an animation should take to complete one cycle.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>time</i></td>
    <td>Specifies the length of time an 
animation should take to complete one cycle. This can be specified in seconds or 
    milliseconds. Default value is 0, which means that no animation will occur</td>
