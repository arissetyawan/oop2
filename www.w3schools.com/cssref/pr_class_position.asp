...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS position property</title>
<meta charset="utf-8">
...
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="css3_pr_pointer-events.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_gen_quotes.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">position</code> property specifies the type of positioning method used for an 
element (static, relative, absolute, fixed, or sticky).</p>
...
<p><strong>Note:</strong> The <code class="w3-codespan">sticky</code> value is not supported in Internet Explorer or Edge 15 and earlier versions.</p>
</div>
<hr>
...
position: static|absolute|fixed|relative|sticky|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>relative</td>
    <td>The element is positioned relative to its normal position, so &quot;left:20px&quot;
  ...
  <tr>
    <td>sticky</td>
    <td>The element is positioned based on the user's scroll position 
    ...
    <strong>Note:</strong> Not supported in IE/Edge 15 or earlier. Supported in Safari from version 6.1 with a -webkit- prefix.</td>
  <td><a target="_blank" class="w3-btn btnplayit w3-green" href="tryit.asp?filename=trycss_position_sticky">Try it &raquo;</a></td>                      
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-code notranslate cssHigh">
    h2.pos_left {<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; left: -20px;<br>}<br><br>h2.pos_right {<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; left: 20px;<br>}</div>
...
<div class="w3-code notranslate cssHigh">
    #parent1 {<br>&nbsp;&nbsp;&nbsp; position: static;<br>&nbsp;&nbsp;&nbsp; 
    border: 1px solid blue;<br>&nbsp;&nbsp;&nbsp; width: 300px;<br>&nbsp;&nbsp;&nbsp; 
    height: 100px;<br>}<br><br>#child1 {<br>&nbsp;&nbsp;&nbsp; position: 
    absolute;<br>&nbsp;&nbsp;&nbsp; border: 1px solid red;<br>&nbsp;&nbsp;&nbsp; 
    top: 70px;<br>&nbsp;&nbsp;&nbsp; right: 15px;<br>}<br><br>#parent2 {<br>&nbsp;&nbsp;&nbsp; 
    position: relative;<br>&nbsp;&nbsp;&nbsp; border: 1px solid blue;<br>&nbsp;&nbsp;&nbsp; 
    width: 300px;<br>&nbsp;&nbsp;&nbsp; height: 100px;<br>}<br><br>#child2 {<br>&nbsp;&nbsp;&nbsp; 
    position: absolute;<br>&nbsp;&nbsp;&nbsp; border: 1px solid red;<br>&nbsp;&nbsp;&nbsp; 
    top: 70px;<br>&nbsp;&nbsp;&nbsp; right: 15px;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_position2">Try it Yourself &raquo;</a>
</div>
<hr>
