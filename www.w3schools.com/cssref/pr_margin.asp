...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS margin property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_list-style-type.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_margin-bottom.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">margin</code> property sets the margins for an 
element, and is a shorthand property for the following properties:</p>
<ul>
  <li><a href="pr_margin-top.asp">margin-top</a></li>
  <li><a href="pr_margin-right.asp">margin-right</a></li>
  <li><a href="pr_margin-bottom.asp">margin-bottom</a></li>
  <li><a href="pr_margin-left.asp">margin-left</a></li>
</ul>
<p><strong>If the margin property has four values:</strong></p>
<ul>
  <li>margin: 10px 5px 15px 20px;
 <ul><li>top margin is 10px</li>
  <li>right margin is 5px</li>
  <li>bottom margin is 15px</li>
  <li>left margin is 20px</li>
  </ul>
 </li>
</ul>
<p><strong>If the margin property has three values:</strong></p>
<ul>
  <li>margin: 10px 5px 15px;<ul><li>top margin is 10px</li>
  <li>right and left margins are 5px</li>
  <li>bottom margin is 15px</li>
  </ul>
    </li>
</ul>
<p><strong>If the margin property has two values:</strong></p>
<ul>
  <li>margin: 10px 5px;<ul><li>top and bottom margins are 10px</li>
  <li>right and left margins are 5px</li>
  </ul>
 </li>
</ul>
<p><strong>If the margin property has one value:</strong></p>
<ul>
  <li>margin: 10px;<ul><li>all four margins are 10px</li></ul>
 </li>
</ul>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Specifies a margin in px, pt, cm, etc. Default value is 0. Negative 
    values are allowed. <a href="css_units.asp">Read about length units</a></td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_margin&preval=0">Play it &raquo;</a></td>                    
  </tr>
  <tr>
    <td><i>%</i></td>
...
<p>This does not happen on horizontal (left and right) margins! Only vertical 
(top and bottom) 
margins!</p>
...
<h3>Example</h3>
<div class="w3-code notranslate cssHigh">
  p.a {<br>&nbsp;&nbsp;&nbsp; margin: 30px 0;<br>}<br><br>p.b {<br>&nbsp;&nbsp;&nbsp; margin: 20px 0;<br>}</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_margin_collapse" target="_blank">Try it Yourself &raquo;</a>
</div>

<p>In the example above, the &lt;p class=&quot;a&quot;&gt; element has a top and bottom margin of 30px. The &lt;p 
class=&quot;b&quot;&gt; 
element has a top and bottom margin of 20px.</p>
<p>This means that the vertical margin between &lt;p class=&quot;a&quot;&gt; and &lt;p class=&quot;b&quot;&gt; 
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the margin for a &lt;p&gt; element to 35 pixels for top and bottom, and to 70 
pixels for right and left:</p>
<div class="w3-code notranslate cssHigh">
p {<br>
&nbsp;&nbsp;&nbsp; margin: 35px 70px;<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_margin2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the margin for a &lt;p&gt; element to 35 pixels for top, 70 
pixels for right and left, and to 50 pixels for bottom:</p>
<div class="w3-code notranslate cssHigh">
p {<br>
&nbsp;&nbsp;&nbsp; margin: 35px 70px 50px;<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_margin3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the margin for a &lt;p&gt; element to 35 pixels for top, 70 
pixels for right, 50 pixels for bottom, and to 90 pixels for left:</p>
<div class="w3-code notranslate cssHigh">
p {<br>
&nbsp;&nbsp;&nbsp; margin: 35px 70px 50px 90px;<br>
}</div>
<a target="_blank" href="tryit.asp?filename=trycss_margin4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
