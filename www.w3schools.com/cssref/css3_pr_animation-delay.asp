...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS animation-delay Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">animation-delay</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_animation.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_animation-direction.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>time</i></td>
    <td>Optional. Defines the number of seconds (s) or milliseconds (ms) to wait before the animation will start. Default value is 0. Negative values are allowed. 
    If you use negative values, the animation will start as if it had already 
    been playing for <em>N</em> seconds/milliseconds.</td>
