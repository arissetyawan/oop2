...
<a class="w3-left w3-btn" href="css3_pr_user-select.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_class_visibility.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    img.a {<br>&nbsp;&nbsp;&nbsp; vertical-align: baseline;<br>}<br><br>img.b {<br>&nbsp;&nbsp;&nbsp; 
    vertical-align: text-top;<br>}<br><br>img.c {<br>&nbsp;&nbsp;&nbsp; 
    vertical-align: text-bottom;<br>}<br><br>img.d {<br>&nbsp;&nbsp;&nbsp; 
    vertical-align: sub;<br>}<br><br>img.e {<br>&nbsp;&nbsp;&nbsp; 
    vertical-align: super;<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_vertical-align" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">vertical-align</code> property sets the vertical alignment of an element.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Raises or lower an element by the specified length. Negative values are allowed. <a href="css_units.asp">Read about length units</a></td>
  ...
  <tr>
    <td>sub</td>
    <td>The element is aligned with the subscript baseline of the parent</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_vertical-align&preval=sub">Play it &raquo;</a></td>                 
  </tr>
  <tr>
    <td>super</td>
    <td>The element is aligned with the superscript baseline of the parent</td>
  ...
  <tr>
    <td>top</td>
    <td>The element is aligned with the top of the 
  ...
  <tr>
    <td>text-top</td>
    <td>The element is aligned with the top of
  ...
  <tr>
    <td>bottom</td>
    <td>The element is aligned with the
...
<p>HHTML DOM reference: <a href="/jsref/prop_style_verticalalign.asp">verticalAlign property</a></p>
<br>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_user-select.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
