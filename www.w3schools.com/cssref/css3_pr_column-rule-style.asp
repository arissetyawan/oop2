...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS column-rule-style property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">column-rule-style</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_column-rule-color.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_column-rule-width.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">column-rule-style</code> property specifies the style of the rule between columns.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td> groove</td>
    <td>Specifies a 3D grooved rule. The effect depends on the width and color values</td>
  ...
  <tr>
    <td> ridge</td>
    <td>Specifies a 3D ridged rule. The effect depends on the width and color values</td>
  ...
  <tr>
    <td> inset</td>
    <td>Specifies a 3D inset rule. The effect depends on the width and color values</td>
  ...
  <tr>
    <td> outset</td>
    <td>Specifies a 3D outset rule. The effect depends on the width and color values</td>
