...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-image-width property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">border-image-width</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_border-image-source.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-left.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">border-image-width</code> property specifies the width of the border image.</p>
...
<p><b>Note:</b> The <code class="w3-codespan">border-image-width</code> property can take from one to four values 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>%</i></td>
    <td>Refers to the size of the border image area: the width of the area for horizontal offsets, the height for vertical offsets</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-image-width3">Play it &raquo;</a></td>              
  </tr>
  <tr>
    <td>auto</td>
    <td>If specified, the width is the intrinsic width or height of the corresponding image slice</td>
