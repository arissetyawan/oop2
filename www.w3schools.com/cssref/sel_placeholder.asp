...
<html lang="en-US">
<head>
<title>CSS ::placeholder Selector</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">::placeholder</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_out-of-range.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_read-only.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Change the color of the placeholder text of an input field:</p>
<div class="w3-code notranslate cssHigh">
 ::-moz-placeholder
 { /* Code for Firefox */<br>&nbsp;&nbsp;&nbsp; color: red;<br>}<br>
 <br>::-webkit-input-placeholder
 { /* Chrome, Edge, Safari and Opera */<br>&nbsp;&nbsp;&nbsp; color: red;<br>}<br><br>:-ms-input-placeholder
 { /* Internet Explorer 10-11 */<br>&nbsp;&nbsp;&nbsp; color: red;<br>}<br>
 <br>::placeholder
 {<br>&nbsp;&nbsp;&nbsp; color: red;<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_placeholder">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The ::placeholder selector selects form elements with placeholder text.</p>
<p>The placeholder text is set with the placeholder attribute, which specifies a 
hint that describes the expected value of an input field.</p>
<p><strong>Tip:</strong> The default color of the placeholder text is light grey 
in most browsers.</p>
<hr>

<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that fully supports the selector.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;">::placeholder</td>
    <td>57.0<br>4.0 -webkit-</td>
    <td>12.0 -webkit-<br>10.0 -ms-</td>
    <td>51.0<br>4.0 -moz-</td>
    <td>10.1<br>5.0 -webkit-</td>
    <td>44.0<br>15.0 -webkit-</td>
  </tr>
</table>
</div>
<p><strong>Note:</strong> Most browsers have their own non-standard implementation of the <code class="w3-codespan">::placeholder</code> selector:</p>
<ul>
<li>Chrome, Edge, Safari and Opera use <code class="w3-codespan">::-webkit-input-placeholder</code></li>
<li>Internet Explorer 10 and 11 use <code class="w3-codespan">:-ms-input-placeholder</code> (<strong>Note:</strong> only one ":" colon)</li>
<li>Firefox use <code class="w3-codespan">::-moz-placeholder</code></li>
</ul>
<hr>
<h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
::placeholder {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<br>
