...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS text-justify property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">text-justify</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_text_text-indent.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_text-overflow.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Set the justification method to &quot;inter-word&quot; when text-align is set to 
&quot;justify&quot;:</p>
...
<p>The <code class="w3-codespan">text-justify</code> property specifies the justification method 
of text when text-align is set to &quot;justify&quot;.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;">text-justify</td>
    <td>Yes*</td>
    <td>11.0</td>
    <td>55.0</td>
    <td>10.0.3</td>
...
<p>*This feature is behind the <strong>Enable Experimental Web Platform Features</strong> preference (needs to be set to 
...
text-justify: auto|inter-word|inter-character|none|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>inter-character</td>
    <td>Increases/Decreases the space between characters</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-justify&preval=inter-character">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>none</td>
    <td>Disables justification methods</td>
