...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS text-decoration-color property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_text_text-decoration.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_text-decoration-line.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">text-decoration-color</code> property specifies the color of the text-decoration (underlines, overlines, linethroughs).</p>

<div class="w3-responsive">
<table class="w3-table-all">
  <tr>
    <th style="width:25%">Default value:</th>
    <td><em>currentColor</em></td>
  </tr>
  <tr>
    <th>Inherited:</th>
    <td>no</td>
