...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS Border-left Property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_border-image-width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-left_color.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh"> 
    ...
    border-left: 4px dotted blue;<br>}<br><br>div {<br>&nbsp;&nbsp;&nbsp; 
    border-left: double;<br>} 
</div>
...
<p>The <code class="w3-codespan">border-left</code> property is a shorthand 
property for (in the following order):</p>
<ul>
  <li><a href="pr_border-left_width.asp">border-left-width</a></li>
  <li><a href="pr_border-left_style.asp">border-left-style</a> (required)</li>
  <li><a href="pr_border-left_color.asp">border-left-color</a></li>
</ul>
<p>If border-left-color is omitted, the color applied will be the color of the 
text.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the width of the left border. Default value is 
    &quot;medium&quot;</td>
  </tr>
  <tr>
    <td><i><a href="pr_border-left_style.asp">border-left-style</a></i></td>
    <td>Required. Specifies the style of the left border. Default value is 
    &quot;none&quot;</td>
  </tr>
  <tr>
    <td><i><a href="pr_border-left_color.asp">border-left-color</a></i></td>
    <td>Optional. Specifies the color of the left border. Default value is the 
