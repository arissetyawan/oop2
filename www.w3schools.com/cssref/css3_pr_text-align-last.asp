...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS text-align-last property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_text_text-align.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_text_text-decoration.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
{<br>
&nbsp;&nbsp;&nbsp;
text-align: justify;&nbsp; /* For Edge */<br>&nbsp;&nbsp;&nbsp;
...
<p>The <code class="w3-codespan">text-align-last</code> property specifies how to align the last line of a text.</p>
<p>Notice that the <code class="w3-codespan">text-align-last</code> property 
sets the alignment for all last lines within the selected element. So, if you 
have a &lt;div&gt; with three paragraphs in it, <code class="w3-codespan">text-align-last</code> 
will apply to the last line of EACH of the paragraphs. To use <code class="w3-codespan">text-align-last</code> 
on only the last paragraph in the container, you can use :last child, see 
example below.</p>
<p><strong>Note:</strong> In Edge/Internet Explorer the <code class="w3-codespan">text-align-last</code> property only works on text that 
...
<table class="browserref notranslate">
  ...
  <tr>
    ...
    <td>47.0</td>
    <td>5.5</td>
    <td>54.0<br>12.0&nbsp;-moz-</td>
    <td><span class="deprecated">Not supported</span></td>
    <td>34.0</td>
  </tr>
  </table>
</div>
<p><strong>Note:</strong> In Edge/Internet Explorer, the &quot;start&quot; and &quot;end&quot; values 
are not supported.</p>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Use text-align-last on only the very last line in the container:</p>
<div class="w3-code notranslate cssHigh">
div.b p:last-child {<br>&nbsp;&nbsp;&nbsp; text-align-last: center;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-align-last2">Try it Yourself &raquo;</a>
</div>
<hr>
