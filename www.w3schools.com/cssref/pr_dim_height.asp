...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS height property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_hanging-punctuation.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="css3_pr_hyphens.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    1px solid black;<br>}<br><br>div.b {<br>&nbsp;&nbsp;&nbsp; height: 50px;<br>&nbsp;&nbsp;&nbsp; 
    border: 1px solid black; <br>}</div>
...
<p>The <code class="w3-codespan">height</code> property sets the height of an element.</p>
<p>The height of an element does not include padding, borders, or margins!</p>
<p>If <code class="w3-codespan">height: auto;</code> the element will automatically adjust its height to allow 
its content to be displayed correctly.</p>
<p>If <code class="w3-codespan">height</code> is set to a numeric value (like pixels, (r)em, percentages) then if 
...
<a href="pr_pos_overflow.asp">overflow</a> property.</p>
<p><b>Note:</b> The <a href="pr_dim_min-height.asp">min-height</a> and
<a href="pr_dim_max-height.asp">max-height</a> properties override the <code class="w3-codespan">
height</code> property.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines the height in px, cm, etc. <a href="css_units.asp">Read about length units</a></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the height of an element to 50% of the height of the parent element:</p>
<div class="w3-code notranslate cssHigh">
    #parent {<br>&nbsp;&nbsp;&nbsp; height: 100px;<br>}<br><br>#child {<br>&nbsp;&nbsp;&nbsp; 
    height: 50%;<br>}
</div>
...
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_dimension.asp">CSS Height and Width</a></p>
