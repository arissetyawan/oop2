...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-top-width property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-top_style.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-width.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">border-top-width</code> property sets the width of an element's top border.</p>

<p><b>Note:</b> Always declare the <a href="pr_border-style.asp">border-style</a> or the 
<a href="pr_border-top_style.asp">border-top-style</a> property before the <code class="w3-codespan">border-top-width</code>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Allows you to define the thickness of the top border. <a href="css_units.asp">Read about length units</a></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the top border to medium:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-width: medium;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-width2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the top border to thick:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-width: thick;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-width3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the top border to 1px:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-width: 1px;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-width4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the top border to 15px:</p>
<div class="w3-code notranslate cssHigh">
div {border-top-width: 15px;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-top-width5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
