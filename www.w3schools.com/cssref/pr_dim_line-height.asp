...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS line-height property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_text_letter-spacing.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_list-style.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    80%;<br>}<br><br>div.d {<br>&nbsp;&nbsp;&nbsp; line-height: 200%;<br>} </div>
...
<p>The <code class="w3-codespan">line-height</code> property specifies the 
height of a line.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the line height in pixels and centimeters for different &lt;div&gt; elements:</p>
<div class="w3-code notranslate cssHigh">
    div.a {<br>&nbsp;&nbsp;&nbsp; line-height: 10px;<br>}<br><br>div.b {<br>&nbsp;&nbsp;&nbsp; 
    line-height: 30px;<br>}<br><br>div.c {<br>&nbsp;&nbsp;&nbsp; line-height: 
    0.5cm;<br>}<br><br>div.d {<br>&nbsp;&nbsp;&nbsp; line-height: 1cm;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_line-height2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the line height as a number for different &lt;div&gt; elements:</p>
<div class="w3-code notranslate cssHigh">
  div.a {<br>&nbsp;&nbsp;&nbsp; line-height: 0.5;<br>}<br><br>div.b {<br>&nbsp;&nbsp;&nbsp; 
  line-height: 1.6;<br>}<br><br>div.c {<br>&nbsp;&nbsp;&nbsp; line-height: 2;<br>
  }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_line-height3">Try it Yourself &raquo;</a>
</div>
<hr>
