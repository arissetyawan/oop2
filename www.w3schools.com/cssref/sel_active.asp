...
<a class="w3-left w3-btn" href="sel_attr_contain.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_after.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_active">Try it Yourself &raquo;</a>
</div>
...
<p><strong>Tip:</strong> The :active selector can be used on all elements, not 
only links.</p>
...
<p><strong>Note:</strong> IE8 and newer versions support the :active 
selector on all elements. IE7 only supports the :active selector on 
links.</p>
<hr>
<h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
:active {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Select and style a &lt;p&gt;, &lt;h1&gt; and &lt;a&gt; element when you click on it:</p>
<div class="w3-code notranslate cssHigh">
  
    p:active, h1:active, a:active {<br>&nbsp;&nbsp;&nbsp; background-color: yellow;<br>
 }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_active2">Try it Yourself &raquo;</a>
</div>
<br>
