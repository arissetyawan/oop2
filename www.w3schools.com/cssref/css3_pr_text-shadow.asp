...
<h1>CSS <span class="color_h1">text-shadow</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_text-overflow.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_text_text-transform.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-shadow&preval=5px 5px 5px red">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td><i>color</i></td>
    <td>Optional. The color of the shadow. Look at <a href="css_colors_legal.asp">CSS Color Values</a> for a complete list of possible color values</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_text-shadow&preval=5px 5px 10px blue">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>none</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Text-shadow with a blur effect:</p>
<div class="w3-code notranslate cssHigh">
...
<div class="w3-example">
<h3>Example</h3>
<p>Text-shadow on a white text:</p>
<div class="w3-code notranslate cssHigh">
h1 {<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; text-shadow: 2px 2px 4px #000000;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-shadow_white">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Text-shadow with a red neon glow:</p>
<div class="w3-code notranslate cssHigh">
...
<div class="w3-example">
<h3>Example</h3>
<p>Text-shadow with a red and blue neon glow:</p>
<div class="w3-code notranslate cssHigh">
h1 {<br>&nbsp;&nbsp;&nbsp; text-shadow: 0 0 3px #FF0000, 0 0 5px #0000FF;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_text-shadow_neon2">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_text_effects.asp">CSS Text Effects</a></p>
