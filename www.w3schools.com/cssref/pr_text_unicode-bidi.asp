...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS unicode-bidi property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_transition-timing-function.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_user-select.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">unicode-bidi</code> property is used together with the
...
unicode-bidi: normal|embed|bidi-override|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>normal</td>
    <td>The element does not open an additional level of embedding. This is default</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_unicode-bidi">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>embed</td>
    <td>For inline elements, this value opens an additional level of embedding</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_unicode-bidi&preval=embed">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td>bidi-override</td>
    <td>For inline elements, this creates an override. For block elements, this 
  ...
  <tr>
    <td>isolate</td>
    <td>The element is isolated from its siblings</td>
  <td>&nbsp;</td>    
    </tr>
  <tr>
