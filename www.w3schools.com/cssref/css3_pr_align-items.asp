...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS align-items property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_align-content.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_align-self.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    div
 {<br>&nbsp;&nbsp;&nbsp; display: -webkit-flex; /* Safari */<br>&nbsp;&nbsp;&nbsp; -webkit-align-items: center; /* Safari 7.0+ */<br>
 &nbsp;&nbsp;&nbsp;
...
<p><b>Tip:</b> Use the <a href="css3_pr_align-self.asp">align-self</a> property of each item to override the <code class="w3-codespan">align-items</code> property.</p>
