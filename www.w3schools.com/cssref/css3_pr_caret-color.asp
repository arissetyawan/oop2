...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS caret-color property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">caret-color</span> Property</h1>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="pr_tab_caption-side.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="pr_charset_rule.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_caret-color">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">caret-color</code> property specifies the color of the cursor (caret) in inputs, textareas, or any element that is editable.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    <th>Animatable:</th>
    <td>&nbsp;<a href="css_animatable.asp">Read about <em>animatable</em></a>
  </td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.caretColor=&quot;red&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss3_js_caret-color">Try it</a>    
</td>
  </tr>
 </table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">caret-color</td>
    <td>57.0</td>
...
<div class="w3-code w3-border notranslate"><div>
  caret-color: auto|<em>color</em>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td> auto</td>
    <td>Default. Browsers uses the currentColor for the caret</td>
  </tr>
  <tr>
    <td> <em>color</em></td>
    <td>Specifies a color to use for the caret. All legal color values can be used (rgb, 
    hex, named-color, etc). For more information on legal values, read our <a href="/css/css_colors.asp">CSS 
    Colors Tutorial</a></td>
  </tr>
  </table>
</div>
