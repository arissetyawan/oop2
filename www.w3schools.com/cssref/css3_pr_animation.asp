...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS animation Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">animation </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_all.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_animation-delay.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">animation</code> property is a shorthand property for:</p>
<ul>
  <li><a href="css3_pr_animation-name.asp">animation-name</a></li>
  <li><a href="css3_pr_animation-duration.asp">animation-duration</a></li>
  <li><a href="css3_pr_animation-timing-function.asp">animation-timing-function</a></li>
  <li><a href="css3_pr_animation-delay.asp">animation-delay</a></li>
  <li><a href="css3_pr_animation-iteration-count.asp">animation-iteration-count</a></li>
  <li><a href="css3_pr_animation-direction.asp">animation-direction</a></li>
  <li><a href="css3_pr_animation-fill-mode.asp">animation-fill-mode</a></li>
  <li><a href="css3_pr_animation-play-state.asp">animation-play-state</a></li>
</ul>
<p><b>Note:</b> Always specify the <a href="css3_pr_animation-duration.asp">animation-duration</a> property, otherwise the duration is 0, and will never be played.</p>
