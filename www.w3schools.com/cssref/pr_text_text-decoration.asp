...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS text-decoration property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_text-align-last.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_text-decoration-color.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
h3 {<br>&nbsp;&nbsp;&nbsp; text-decoration: underline;<br>}<br><br>h3 {<br>&nbsp;&nbsp;&nbsp; text-decoration: underline 
  overline;<br>}<br>
</div>
...
<p>The <code class="w3-codespan">text-decoration</code> property specifies the decoration added to text, 
and is a shorthand 
property for:</p>
<ul>
...
text-decoration: <em>text-decoration-line</em> <em>text-decoration-color</em>
  <em>text-decoration-style</em>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Sets the kind of text decoration to use (like underline, overline, 
    line-through)</td>
  </tr>
  <tr>
    <td>
<a href="css3_pr_text-decoration-color.asp">text-decoration-color</a></td>
    <td>Sets the color of the text decoration</td>
  </tr>
  <tr>
    <td> <a href="css3_pr_text-decoration-style.asp">text-decoration-style</a></td>
    <td>Sets the style of the text decoration (like solid, wavy, dotted, dashed, 
    double)</td>
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Add more text decoration:</p>
<div class="w3-code notranslate cssHigh">
  h1 {<br>&nbsp;&nbsp;&nbsp; text-decoration: underline overline dotted red;<br>
  }<br><br>h2 {<br>&nbsp;&nbsp;&nbsp; text-decoration: underline overline wavy 
  blue;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_text-decoration2">Try it Yourself &raquo;</a>
</div>
<hr>
