...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-left-style property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-left_color.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-left_width.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
div {border-left-style: dotted;}</div>
...
<p>The <code class="w3-codespan">border-left-style</code> property sets the style of an element's left border.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>A dashed left border:</p>
<div class="w3-code notranslate cssHigh">
div {border-left-style: dashed;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-style2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A solid left border:</p>
<div class="w3-code notranslate cssHigh">
div {border-left-style: solid;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-style3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A double left border:</p>
<div class="w3-code notranslate cssHigh">
div {border-left-style: double;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-style4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
div {border-left-style: none;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-style5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A groove left border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-left-style: groove;<br>&nbsp;&nbsp;&nbsp; border-left-color: coral;<br>&nbsp;&nbsp;&nbsp; border-left-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-style6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>A ridge left border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-left-style: ridge;<br>&nbsp;&nbsp;&nbsp; border-left-color: coral;<br>&nbsp;&nbsp;&nbsp; border-left-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-style7" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>An inset left border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-left-style: inset;<br>&nbsp;&nbsp;&nbsp; border-left-color: coral;<br>&nbsp;&nbsp;&nbsp; border-left-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-style8" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>An outset left border:</p>
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp; border-left-style: outset;<br>&nbsp;&nbsp;&nbsp; border-left-color: coral;<br>&nbsp;&nbsp;&nbsp; border-left-width: 7px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-style9" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
