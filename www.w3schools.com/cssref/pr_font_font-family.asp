...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS font-family property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_font-face_rule.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="css3_pr_font-kerning.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">font-family</code> property specifies the font for an element.</p>
<p>The <code class="w3-codespan">font-family</code> property can hold several font names as a &quot;fallback&quot; system. 
...
<table class="w3-table-all">
  <tr>
    ...
    <td><i>depends on the browser</i></td>
  </tr>
  <tr>
    <th>Inherited:</th>
    <td>yes</td>
...
font-family: <i>family-name</i>|<em>generic-family</em>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>family-name<br>
      generic-family</i></td>
    <td>A prioritized list of font family names and/or generic family names</td>
