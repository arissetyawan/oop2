...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS @charset Rule</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">@charset</span> Rule</h1>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="css3_pr_caret-color.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="pr_class_clear.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">@charset</code> rule specifies the character encoding used in the style sheet.</p>
<p>The <code class="w3-codespan">@charset</code> rule must be the first element in the style sheet and not be 
preceded by any character. If several <code class="w3-codespan">@charset</code> rules are defined, only the first one is used. The 
<code class="w3-codespan">@charset</code> rule cannot be used inside a style attribute (on an HTML element), or 
inside the &lt;style&gt; element where the character set of the HTML page is relevant.</p>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    ...
    <td>2.0</td>
    <td><span class="deprecated">No support in Edge</span><br>5.5</td>
    <td>1.5</td>
    <td>4.0</td>
    <td>9.0</td>
  </tr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>charset</em></td>
    <td>Specifies the character encoding to use</td>
  </tr>
  </table>
</div>
