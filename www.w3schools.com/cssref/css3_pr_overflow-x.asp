...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS overflow-x property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">overflow-x</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_pos_overflow.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_overflow-y.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_overflow-x">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">overflow-x</code> property specifies whether to clip the content, add a scroll 
bar, or display overflow content of a block-level element, when it overflows at 
the left and right edges.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>visible</td>
    <td>The content is not clipped, and it may be rendered outside the left and 
    right edges. This is default</td>
