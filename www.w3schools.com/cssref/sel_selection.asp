...
<h1>CSS <span class="color_h1">::selection</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_root.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_target.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
 ::-moz-selection
 { /* Code for Firefox */<br>&nbsp;&nbsp;&nbsp; color: red;<br>&nbsp;&nbsp;&nbsp; background: yellow;<br>}<br>
 <br>::selection
 {<br>&nbsp;&nbsp;&nbsp; color: red; <br>&nbsp;&nbsp;&nbsp; background: yellow;<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_selection">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> The ::selection pseudo-element was drafted for CSS Selectors Level 3, 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;">::selection</td>
    <td>4.0</td>
    <td>9.0</td>
    <td>2.0 -moz-</td>
    <td>3.1</td>
...
::selection {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<br>
