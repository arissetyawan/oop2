...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS quotes property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_class_position.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_resize.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">quotes</code> property sets the type of quotation marks for quotations.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.quotes=&quot;'\253' '\273'"
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>none</td>
    <td>Specifies that the "open-quote" and "close-quote" values of the "content" property will not produce any quotation marks</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_quotes">
 Play it &raquo;</a></td>                
  </tr>
  <tr>
    <td><i>string string string string</i></td>
    <td>Specifies which quotation marks to use. The first two values specifies the first level of quotation embedding, the next two values specifies the next level of quote embedding, etc</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_quotes&preval='\2039' '\203A' '\00AB' '\00BB'">
 Play it &raquo;</a></td>                      
  </tr>
  <tr>
    <td>initial</td>
