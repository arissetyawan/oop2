...
<html lang="en-US">
<head>
<title>CSS grid-row property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">grid-row</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-gap.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-row-end.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Make &quot;item1&quot; start on row 1 and span 2 columns:</p>
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-row: 1 / span 2;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-row" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The <code class="w3-codespan">grid-row</code> property specifies a grid 
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-row">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridRow=&quot;2 / span 2&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-row">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-row</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-row: <i>grid-row-start / 
  grid-row-end</i>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em><a href="pr_grid-row-start.asp">grid-row-start</a></em></td>
    <td>Specifies on which row to start displaying the item.</td>
  </tr>
  <tr>
    <td><i><a href="pr_grid-row-end.asp">grid-row-end</a></i></td>
    <td>Specifies on which row-line to stop displaying the item, or how many 
    rows to span.</td>
  </tr>
  </table>
</div>
...
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-row: 1 / 3;<br>}<br></div>
  <a target="_blank" href="tryit.asp?filename=trycss_grid-row2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
