...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS animation-play-state Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">animation-play-state </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_animation-name.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_animation-timing-function.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">animation-play-state</code> property specifies whether the animation is running or paused.</p>
<p><b>Note:</b> Use this property in a JavaScript to pause an animation in the middle of a cycle.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Pause an animation on hover:</p>
<div class="w3-code notranslate cssHigh">
  div:hover {<br>&nbsp;&nbsp;&nbsp; animation-play-state: paused;<br>
 }<br>
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-play-state_hover">Try it Yourself &raquo;</a>
</div>
<br>
