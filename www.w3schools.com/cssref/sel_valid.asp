...
<html lang="en-US">
<head>
<title>CSS :valid Selector</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:valid</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_target.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_visited.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Select and style only if the value of the &lt;input&gt; element is valid:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_valid" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The :valid selector selects form elements with a value that validates according to the element's settings.</p>
<p><strong>Note:</strong> The :valid selector only works for form elements with limitations, such as input elements with min and max attributes, email fields with a legal email, or number fields with a numeric value, etc.</p>
<p><strong>Tip:</strong> Use the <a href="sel_invalid.asp">:invalid</a> selector 
to select form elements with a value that does not validate according to the 
element's settings.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> :valid</td>
    <td>10.0</td>
    <td>10.0</td>
    <td>4.0</td>
    <td>5.0</td>
...
:valid {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
<a target="_blank" class="w3-btn btnsmall" href="trysel.asp?selector=input:valid">Demo</a>
</div></div>
<hr>

<h2>Related Pages</h2>
<p>CSS Selector <a href="sel_invalid.asp">:invalid</a></p>
<br>
