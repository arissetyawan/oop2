...
<html lang="en-US">
<head>
<title>CSS :read-only Selector</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:read-only</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_placeholder.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_read-write.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Select and style only if the input element is "readonly":</p>
<div class="w3-code notranslate cssHigh">
  
    input:-moz-read-only { /* For Firefox */<br>&nbsp;&nbsp;&nbsp; background-color: yellow;<br>}<br><br>input:read-only
 { <br>
 &nbsp;&nbsp;&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_read-only" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The :read-only selector selects elements which are "readonly".</p>
<p>Form elements with a "readonly" attribute are defined as "readonly".</p>
<p><strong>Note:</strong> Currently, in most browsers, the :read-only selector only applies to input and textarea elements, but it should apply to all elements which are "readonly".</p>
...
<p>Internet Explorer does not support the :read-only selector.</p>
<p>Firefox supports an alternative, the :-moz-read-only selector.</p>
...
:read-only {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<hr>

<h2>Related Pages</h2>
<p>CSS Selector <a href="sel_read-write.asp">:read-write</a></p>
<br>
