...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS flex property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_filter.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_flex-basis.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    #main div {<br>&nbsp;&nbsp;&nbsp; -webkit-flex: 1; /* Safari 6.1+ */<br>&nbsp;&nbsp;&nbsp; -ms-flex: 1; /* IE 10 */ <br>&nbsp;&nbsp;&nbsp; flex: 1;<br>}</div>
...
<p>The <code class="w3-codespan">flex</code> property is a shorthand property for:</p>
<ul>
  <li><a href="css3_pr_flex-grow.asp">flex-grow</a></li>
  <li><a href="css3_pr_flex-shrink.asp">flex-shrink</a></li>
  <li><a href="css3_pr_flex-basis.asp">flex-basis</a></li>
</ul>
<p>The <code class="w3-codespan">flex</code> property sets the flexible length on flexible items.</p>

<p><b>Note:</b> If the element is not a flexible item, the <code class="w3-codespan">flex</code> property has no effect.</p>
...
<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="/css/css3_flexbox.asp">CSS Flexible Box</a></p>
