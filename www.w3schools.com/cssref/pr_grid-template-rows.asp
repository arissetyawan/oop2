...
<h1>CSS <span class="color_h1">grid-template-rows</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-template-columns.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_hanging-punctuation.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  ...
  100px 300px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-template-rows" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-template-rows</code> property specifies the number 
(and the heights) of the rows in a grid layout.</p>
<p>The values are a space-separated list, where each value specifies the height of the respective row.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-template-rows">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridTemplateRows=&quot;50px 200px&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-template-rows">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-template-rows</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-template-rows: none|auto|max-content|min-content|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>none</td>
    <td>No size is set. Rows are created if needed</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template-rows">Play it &raquo;</a></td> 

  </tr>
  <tr>
    <td>auto</td>
    <td>The size of the rows is determined by the size of the container, and on 
    the size of the content of the items in the row</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template-rows&preval=auto">Play it &raquo;</a></td> 

  </tr>
  <tr>
    <td>max-content</td>
    <td>Sets the size of each row to depend on the largest item in the row</td>
    <td></td>
  </tr>
  <tr>
    <td>min-content</td>
  ...
  <tr>
    <td><i>length</i></td>
    <td>Sets the size of the rows, by using a legal length value. <a href="css_units.asp">Read about length units</a></td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template-rows&preval=100px 100px">Play it &raquo;</a></td>
  </tr>
  </table>
</div>
<hr>
...
<p>CSS Reference: The <a href="pr_grid-template-columns.asp">grid-columns</a> property</p>
