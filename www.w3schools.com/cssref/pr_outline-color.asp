...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS outline-color property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_outline.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_outline-offset.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">outline-color</code> property specifies the color of an
outline.</p>

<p><b>Note:</b> Always declare the <a href="pr_outline-style.asp">outline-style</a> property before the 
<code class="w3-codespan">outline-color</code> property. An element must have an outline before you change the 
color of it.</p>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <td>invert</td>
    <td>Performs a color inversion. This ensures that the outline is visible, regardless of color background. This is default</td>
 ...
 <a href="css_colors_legal.asp">CSS Color Values</a> for a complete list of possible color values.</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the outline with a HEX value:</p>
<div class="w3-code notranslate cssHigh">
div {outline-color: #92a8d1;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-color2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the outline with an RGB value:</p>
<div class="w3-code notranslate cssHigh">
div {outline-color: rgb(201, 76, 76);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-color3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the outline with an RGBA value:</p>
<div class="w3-code notranslate cssHigh">
div {outline-color: rgba(201, 76, 76, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-color4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the outline with a HSL value:</p>
<div class="w3-code notranslate cssHigh">
div {outline-color: hsl(89, 43%, 51%);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-color5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the outline with a HSLA value:</p>
<div class="w3-code notranslate cssHigh">
div {outline-color: hsla(89, 43%, 51%, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_outline-color6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
