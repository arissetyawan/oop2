...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-radius property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">border-radius</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_border-left_width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-right.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">border-radius</code> property defines the radius of the 
element's corners.</p>
...
<p><strong>Four values - border-radius: 15px 50px 30px 5px; </strong>(first value applies to top-left 
corner, second value applies to top-right corner, third value applies to bottom-right corner, and fourth value applies to bottom-left corner):</p>
<p id="rcorners4" class="w3-theme"></p>

<p><strong>Three values - border-radius: 15px 50px 30px;</strong> (first value applies to top-left 
corner, second value applies to top-right and bottom-left corners, and third value applies to bottom-right corner):</p>
<p id="rcorners5" class="w3-theme"></p>

<p><strong>Two values - border-radius: 15px 50px; </strong>(first value applies to top-left and bottom-right corners, and the second value applies to top-right and bottom-left corners):</p>
<p id="rcorners6" class="w3-theme"></p>

<p><strong>One value - border-radius: 15px; </strong>(the value applies to all four corners, which are rounded equally:</p>
...
<p><b>Note:</b> The four values for each radius are given in the order top-left, top-right, 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines the shape of the corners. Default value is 0. <a href="css_units.asp">Read about length units</a></td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-radius">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Defines the shape of the corners in %</td>
...
<div class="w3-example">
<h3>Example</h3>
 <p>Set rounded corners for an element with a background color:</p>
<div class="w3-code notranslate cssHigh">
    #rcorners1 {<br>&nbsp;&nbsp;&nbsp; border-radius: 25px;<br>&nbsp;&nbsp;&nbsp; background: #73AD21;<br>&nbsp;&nbsp;&nbsp; padding: 20px; <br>&nbsp;&nbsp;&nbsp; width: 200px;<br>&nbsp;&nbsp;&nbsp; height: 150px; <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-radius2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Set rounded corners for an element with a border:</p>
<div class="w3-code notranslate cssHigh">
    #rcorners2 {<br>&nbsp;&nbsp;&nbsp; border-radius: 25px;<br>&nbsp;&nbsp;&nbsp; border: 2px solid #73AD21;<br>&nbsp;&nbsp;&nbsp; padding: 20px; <br>&nbsp;&nbsp;&nbsp; width: 200px;<br>&nbsp;&nbsp;&nbsp; height: 150px; <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-radius3">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
 <p>Set rounded corners for an element with a background image:&nbsp;</p>
<div class="w3-code notranslate cssHigh">
    #rcorners3 {<br>&nbsp;&nbsp;&nbsp; border-radius: 25px;<br>&nbsp;&nbsp;&nbsp; background: url(paper.gif);<br>&nbsp;&nbsp;&nbsp; background-position: left top;<br>&nbsp;&nbsp;&nbsp; background-repeat: repeat;<br>&nbsp;&nbsp;&nbsp; padding: 20px; <br>&nbsp;&nbsp;&nbsp; width: 200px;<br>&nbsp;&nbsp;&nbsp; height: 150px; <br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-radius4">Try it Yourself &raquo;</a>
</div>
...
border-radius: 2em / 5em;<br>}<br>/*is equivalent to:<br>border-top-left-radius: 2em 5em;<br>
border-top-right-radius: 2em 5em;<br>
border-bottom-right-radius: 2em 5em;<br>
border-bottom-left-radius: 2em 5em;*/<br><br>#example2 {<br>&nbsp;&nbsp;&nbsp; border-radius: 2em 1em 4em / 0.5em 3em;<br>
  }<br>/*is equivalent to:<br>border-top-left-radius: 2em 0.5em;<br>
border-top-right-radius: 1em 3em;<br>
border-bottom-right-radius: 4em 0.5em;<br>
border-bottom-left-radius: 1em 3em;*/</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_border-radius5">Try it Yourself &raquo;</a>
</div>
