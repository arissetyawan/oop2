...
<a class="w3-left w3-btn" href="pr_background-color.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_background-origin.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_background-image">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
body {<br>&nbsp;&nbsp;&nbsp; background-image: url(&quot;img_tree.gif&quot;), url(&quot;paper.gif&quot;);<br>&nbsp;&nbsp;&nbsp; background-color: #cccccc;<br>}<br>
</div>
...
<p>The <code class="w3-codespan">background-image</code> property sets one or more background images for an element.</p>
...
<p><strong>Tip:</strong> The background of an element is the total size of the element, including 
padding and border (but not the margin).</p>
<p><b>Tip: </b>Always set a <a href="pr_background-color.asp">background-color</a> to be used if the image is unavailable.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.backgroundImage=&quot;url(img_tree.gif)&quot;
...
<p><b>Note:</b> IE8 and earlier do not support multiple background images.</p>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Sets two background images for the &lt;body&gt; element. Let the first 
image appear only once (with no-repeat), and let the second image be repeated:</p>
<div class="w3-code notranslate cssHigh">
body {<br>&nbsp;&nbsp;&nbsp; background-image: url(&quot;img_tree.gif&quot;), url(&quot;paper.gif&quot;);<br>&nbsp;&nbsp;&nbsp; 
  background-repeat: no-repeat, repeat;<br>&nbsp;&nbsp;&nbsp; background-color: #cccccc;<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background_multiple2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use different background properties to create a &quot;hero&quot; image:</p>
<div class="w3-code notranslate cssHigh">
  .hero-image {<br>&nbsp; background-image: url(&quot;photographer.jpg&quot;); /* The 
  image used */<br>&nbsp; background-color: #cccccc; /* Used if the image is 
  unavailable */<br>&nbsp; height: 500px; /* You must set a specified height */<br>&nbsp; 
  background-position: center; /* Center the image */<br>&nbsp; 
  background-repeat: no-repeat; /* Do not repeat the image */<br>&nbsp; 
  background-size: cover; /* Resize the background image to cover the entire container */<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background_hero">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Sets a linear-gradient (two colors) as a background image for a &lt;div&gt; element:</p>
<div class="w3-code notranslate cssHigh">
  #grad1 {<br>&nbsp;&nbsp;&nbsp; height: 200px;<br>&nbsp;&nbsp;&nbsp; background-color: #cccccc;<br>&nbsp;&nbsp;&nbsp; background-image: 
  linear-gradient(red, yellow);<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background_linear-grad">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Sets a linear-gradient (three colors) as a background image for a &lt;div&gt; element:</p>
<div class="w3-code notranslate cssHigh">
  #grad1 {<br>&nbsp;&nbsp;&nbsp; height: 200px;<br>&nbsp;&nbsp;&nbsp; background-color: #cccccc;<br>&nbsp;&nbsp;&nbsp; background-image: 
  linear-gradient(red, yellow, green);<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background_linear-grad2">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
  #grad1 {<br>&nbsp;&nbsp;&nbsp; height: 200px;<br>&nbsp;&nbsp;&nbsp; background-color: #cccccc;<br>&nbsp;&nbsp;&nbsp; background-image: 
  repeating-linear-gradient(red, yellow 10%, green 20%);<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background_linear-grad3">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Sets a radial-gradient (two colors) as a background image for a &lt;div&gt; element:</p>
<div class="w3-code notranslate cssHigh">
  #grad1 {<br>&nbsp;&nbsp;&nbsp; height: 200px;<br>&nbsp;&nbsp;&nbsp; background-color: #cccccc;<br>&nbsp;&nbsp;&nbsp; background-image: 
  radial-gradient(red, yellow);<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background_radial-grad">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Sets a radial-gradient (three colors) as a background image for a &lt;div&gt; element:</p>
<div class="w3-code notranslate cssHigh">
  #grad1 {<br>&nbsp;&nbsp;&nbsp; height: 200px;<br>&nbsp;&nbsp;&nbsp; background-color: #cccccc;<br>&nbsp;&nbsp;&nbsp; background-image: 
  radial-gradient(red, yellow, green);<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background_radial-grad2">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background_radial-grad3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_background.asp">CSS Background</a>,
<a href="/css/css3_backgrounds.asp">CSS Backgrounds (advanced)</a>,
<a href="/css/css3_gradients.asp">CSS Gradients</a></p>
<p>HTML DOM reference: <a href="/jsref/prop_style_backgroundimage.asp">backgroundImage property</a></p>
<br>
