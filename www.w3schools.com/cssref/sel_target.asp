...
<h1>CSS <span class="color_h1">:target</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_selection.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_valid.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_target">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> :target</td>
    <td>4.0</td>
    <td>9.0</td>
    <td>3.5</td>
    <td>3.2</td>
...
:target {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Create a tabbed menu:</p>
<div class="w3-code notranslate cssHigh">
  
    .tab div {<br>&nbsp;&nbsp;&nbsp; display: none;<br>}<br><br>.tab div:target {<br>&nbsp;&nbsp;&nbsp; display: block;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_target_tab">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-example">
<h3>Example</h3>
<p>Create a modal (dialog box):</p>
<div class="w3-code notranslate cssHigh">
  
    /* The modal's background */<br>.modal {<br>&nbsp;&nbsp;&nbsp; display: none;<br>&nbsp;&nbsp;&nbsp; left: 0;<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; height: 100%;<br>&nbsp;&nbsp;&nbsp; overflow: auto;<br>&nbsp;&nbsp;&nbsp; background-color: rgb(0, 0, 0);<br>&nbsp;&nbsp;&nbsp; background-color: rgba(0, 0, 0, 0.4);<br>}<br><br>/* Display the modal when targeted */<br>.modal:target {<br>&nbsp;&nbsp;&nbsp; display: table;<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>}<br><br>/* The modal box */<br>
 .modal-dialog {<br>&nbsp;&nbsp;&nbsp; display: table-cell;<br>&nbsp;&nbsp;&nbsp; vertical-align: middle;<br>}<br>
 <br>/* The modal's content */<br>.modal-dialog .modal-content {<br>&nbsp;&nbsp;&nbsp; margin: auto;<br>&nbsp;&nbsp;&nbsp; background-color: #f3f3f3;<br>&nbsp;&nbsp;&nbsp; position: relative;<br>&nbsp;&nbsp;&nbsp; padding: 0;<br>&nbsp;&nbsp;&nbsp; outline: 0;<br>&nbsp;&nbsp;&nbsp; border: 1px #777 solid;<br>&nbsp;&nbsp;&nbsp; text-align: justify;<br>&nbsp;&nbsp;&nbsp; width: 80%;<br>&nbsp;&nbsp;&nbsp; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_target_modal">Try it Yourself &raquo;</a>
</div>
