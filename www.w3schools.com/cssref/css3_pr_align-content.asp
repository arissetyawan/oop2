...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS align-content property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css_entities.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_align-items.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">  
    div
 {<br>&nbsp;&nbsp;&nbsp; width: 70px;<br>&nbsp;&nbsp;&nbsp; height: 300px;<br>&nbsp;&nbsp;&nbsp; border: 1px solid #c3c3c3;<br>&nbsp;&nbsp;&nbsp; display: -webkit-flex;<br>&nbsp;&nbsp;&nbsp; display: flex;<br>&nbsp;&nbsp;&nbsp; -webkit-flex-wrap: wrap;<br>&nbsp;&nbsp;&nbsp; flex-wrap: wrap;<br>&nbsp;&nbsp;&nbsp; -webkit-align-content: center;<br>&nbsp;&nbsp;&nbsp; align-content: center;<br>}
</div>
...
<p>The <code class="w3-codespan">align-content</code> property modifies the behavior of the 
<a href="css3_pr_flex-wrap.asp">flex-wrap</a> property. It is similar to
<a href="css3_pr_align-items.asp">align-items</a>, but 
instead of aligning flex items, it aligns flex lines.</p>
<p><strong>Note:</strong> There must be multiple lines of items for this 
property to have any effect!</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>space-around</td>
    <td>Lines are evenly distributed in the flex container, with half-size spaces on either end</td>
