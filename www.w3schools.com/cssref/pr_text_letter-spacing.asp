...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS letter-spacing property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_pos_left.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_dim_line-height.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    letter-spacing: 2px;<br>}<br><br>h3 {<br>&nbsp;&nbsp;&nbsp; letter-spacing: 
    -1px;<br>}
</div>
...
<p>The <code class="w3-codespan">letter-spacing</code> property increases or decreases the space between characters in a text.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines an extra space between characters (negative values are allowed). <a href="css_units.asp">Read about length units</a></td>
