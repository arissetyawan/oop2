...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS scroll-behavior property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">scroll-behavior</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_pos_right.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_tab-size.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=trycss_scroll_behavior" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">scroll-behavior</code> property specifies 
whether to smoothly animate the scroll position, instead of a straight jump, 
when the user clicks on a link within a scrollable box.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    <th>Version:</th>
    <td>CSSOM View Module (Working Draft)</td>
  </tr>
  <tr>
    <th>JavaScript syntax:</th>
    <td><i>object</i>.style.scrollBehavior=&quot;smooth&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_scrollbehavior">Try it</a>
</td>
  </tr>
</table>
</div>
...
scroll-behavior:  auto|smooth|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Allows a straight jump "scroll effect" between elements within the scrolling box. This is default</td>
  </tr>
  <tr>
    <td>smooth</td>
    <td>Allows a smooth animated "scroll effect" between elements within the scrolling box.</td>
  </tr>
  <tr>
    <td>initial</td>
