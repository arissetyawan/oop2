...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS list-style-image property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_list-style.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_list-style-position.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">list-style-image</code> property replaces the list-item marker with an image.</p>
<p><b>Note: </b>Always specify the <a href="pr_list-style-type.asp">list-style-type</a> property in addition. This property is used if the image for some reason is unavailable.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>none</td>
    <td>No image will be displayed. Instead, the list-style-type property will define what type of list marker will be rendered. This is default</td>
