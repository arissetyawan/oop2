...
<html lang="en-US">
<head>
<title>CSS :read-write Selector</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:read-write</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_read-only.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_required.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Select and style only if the input element is not "readonly":</p>
<div class="w3-code notranslate cssHigh">
  
    input:-moz-read-write { /* For Firefox */<br>&nbsp;&nbsp;&nbsp; background-color: yellow;<br>}<br><br>input:read-write
 { <br>
 &nbsp;&nbsp;&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_read-write" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The :read-write selector selects form elements which are "readable" and "writeable".</p>
<p>Form elements with no "readonly" attribute, and no "disabled" attribute are defined as "read-" and "write-able".</p>
<p><strong>Note:</strong> Currently, in most browsers, the :read-write selector only applies to input and textarea elements, where the "readonly" attribute is not present, regardless if the element is disabled or not.</p>
...
<p>The :read-only selector is supported in Chrome, Safari and Opera.</p>
<p>Internet Explorer does not support the :read-write selector.</p>
<p>Firefox supports an alternative, the :-moz-read-write selector.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> :read-only</td>
    <td>Yes</td>
...
:read-write {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<hr>

<h2>Related Pages</h2>
<p>CSS Selector <a href="sel_read-only.asp">:read-only</a></p>
<br>
