...
<html lang="en-US">
<head>
<title>CSS :in-range Selector</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:in-range</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_hover.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_indeterminate.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Select and style only if the value of the &lt;input&gt; element is "in range":</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_in-range" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The :in-range selector selects all elements with a value that is within a specified range.</p>
<p><strong>Note:</strong> The :in-range selector only works for elements with range limitations, such as input elements with min and max attributes.</p>
<p><strong>Tip:</strong> Use the <a href="sel_out-of-range.asp">:out-of-range</a> 
selector to select all elements with a value that is outside a specified range.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> :in-range</td>
    <td>10.0</td>
...
:in-range {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
<a target="_blank" class="w3-btn btnsmall" href="trysel.asp?selector=input:in-range">Demo</a>
</div></div>
<hr>

<h2>Related Pages</h2>
<p>CSS Selector <a href="sel_out-of-range.asp">:out-of-range</a></p>
<br>
