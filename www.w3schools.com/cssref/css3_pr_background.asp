...
<a class="w3-left w3-btn" href="css3_pr_backface-visibility.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_background-attachment.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">background</code> property is a shorthand property 
for:</p>
<ul>
  <li><a href="pr_background-color.asp">background-color</a></li>
  <li><a href="pr_background-image.asp">background-image</a></li>
  <li><a href="pr_background-position.asp">background-position</a></li>
  <li><a href="css3_pr_background-size.asp">background-size</a></li>
  <li><a href="pr_background-repeat.asp">background-repeat</a></li>
  <li><a href="css3_pr_background-origin.asp">background-origin</a></li>
  <li><a href="css3_pr_background-clip.asp">background-clip</a></li>
  <li><a href="pr_background-attachment.asp">background-attachment</a></li>
</ul>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_background">Try it</a>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.background=&quot;red url(smiley.gif) top left no-repeat&quot;
...
background: <i>bg-color bg-image position/bg-size bg-repeat bg-origin bg-clip bg-attachment </i>initial|inherit;</div></div>
<p><strong>Note:</strong> If one of the properties in the shorthand declaration is the bg-size property,
you must use a / (slash) to separate it from the bg-position property, e.g. background:url(smiley.gif) 10px 20px/50px 50px;
will result in a background image, positioned 10 pixels from the left, 20 pixels from the top, and the size of the image will be 50 pixels wide and 50 pixels high.</p>
<p><strong>Note:</strong> If using multiple background-image sources but also 
...
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_background.asp">CSS Background</a>, <a href="/css/css3_backgrounds.asp">CSS Backgrounds (advanced)</a></p>
