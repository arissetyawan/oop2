...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS filter Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">filter</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_tab_empty-cells.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_flex.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_grayscale">Try it Yourself &raquo;</a>
</div>
<p><strong>Tip:</strong> More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">filter</code> property defines visual effects (like blur and saturation) to an element 
(often &lt;img&gt;).</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>blur(<em>px</em>)</td>
    <td>Applies a blur effect to the image. A larger value will create more blur. <br><br>If no value is specified, 0 is used.</td>
  ...
  <tr>
    ...
    <td>Adjusts the brightness of the image. <br><br>0% will make the image completely black.<br>100% (1) is default and represents the original image.<br>
 Values over 100% will provide brighter results.</td>
  ...
  <tr>
    ...
    <td>Adjusts the contrast of the image.<br><br>0% will make the image completely black.<br>100% (1) is default and represents the original image.<br>
 Values over 100% will provide results with less contrast.</td>
  ...
  <tr>
    ...
    <td>Applies a drop shadow effect to the image. <br><br><strong>Possible values:</strong><br><em>h-shadow</em> - Required. Specifies a pixel value for the horizontal shadow. Negative values place the shadow to the left of the image.<br><br><em>v-shadow</em> - Required. Specifies a pixel value for the vertical shadow. Negative values place the shadow above the image.<br><br><em>blur</em> - Optional. This is the third value, and must be in pixels. Adds a blur effect to the shadow. A larger value will create more blur (the shadow becomes bigger and lighter). Negative values are not allowed. If no value is specified, 0 is used (the shadow's edge is sharp).<br><br><em>spread</em> - Optional. This is the fourth value, and must be in pixels. Positive values will cause the shadow to expand and grow bigger, and negative values will cause the shadow to shrink. If not specified, it will be 0 (the shadow will be the same size as the element). <br><strong>Note:</strong> Chrome, Safari and Opera, and maybe other browsers, do not support this 4th length; it will not render if added.<br><br><em>color</em> - Optional. Adds a color to the shadow. If not specified, the color depends on the browser (often black).<br><br>An example of creating a red shadow, which is 8px big both horizontally and vertically, with a blur effect of 10px:<br><br>filter: drop-shadow(8px 8px 10px red);<br><br><strong>Tip:</strong> This filter is similar to the
 <a href="css3_pr_box-shadow.asp">box-shadow</a> property.</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_filter&preval=drop-shadow(8px 8px 10px red)">Play it &raquo;</a></td>           
  </tr>
  <tr>
    <td>grayscale(<em>%</em>)</td>
    <td>Converts the image to grayscale. <br><br>0% (0) is default and represents the original image.<br>
 100% will make the image completely gray (used for black and white images).<br><br><strong>Note:</strong> Negative values are not allowed.</td>
  ...
  <tr>
    ...
    <td>Applies a hue rotation on the image. The value defines the number of degrees around the color circle the image samples will be adjusted. 0deg is default, and represents the original image.<br> <br><strong>Note:</strong> Maximum value is 360deg.</td>
 ...
 <br>0% is completely transparent.<br>100% (1) is default and represents the original image (no transparency).<br> <br><strong>Note:</strong> Negative values are not allowed.<br><strong>Tip:</strong> This filter is similar to
 the
 <a href="css3_pr_opacity.asp">opacity</a> property.</td>
  ...
  <tr>
    ...
    <td>Saturates the image. <br><br>0% (0) will make the image completely un-saturated.<br>100% is default and represents the original image.<br>Values over 100% provides super-saturated results. <br> <br>
 <strong>Note:</strong> Negative values are not allowed.</td>
  ...
  <tr>
    <td>sepia(<em>%</em>)</td>
    <td>Converts the image to sepia. <br><br>0% (0) is default and represents the original image. <br>100% will make the image completely sepia.<br> <br><strong>Note:</strong> Negative values are not allowed.</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_filter&preval=sepia(100%25)">Play it &raquo;</a></td>           
  </tr>
  <tr>
    <td>url()</td>
    <td>The url() function takes the location of an XML file that specifies an SVG filter, and may include an anchor to a specific filter element. Example:<br>
 <br>filter: url(svg-url#element-id)</td>
  <td></td>           
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: blur(5px); /* Safari */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_blur" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">blur(5px)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_blur">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Blur Example 2</h3>
<p>Apply a blurred background image:</p>
<div class="w3-code notranslate cssHigh"> 
img.background {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: blur(35px); /* Safari */<br>&nbsp;&nbsp;&nbsp;
filter: blur(35px);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_background">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: brightness(200%); /* Safari */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_brightness" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">brightness(200%)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_brightness">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: contrast(200%); /* Safari */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_contrast" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">contrast(200%)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_contrast">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: drop-shadow(8px 8px 10px gray); /* Safari */<br>&nbsp;&nbsp;&nbsp; filter: drop-shadow(8px 8px 10px 
gray);<br>}</div>
<!--
<br>
<div class="w3-padding w3-white notranslate"> 
...
<div class="img">
 <img class="w3-image filter_dropshadow" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">drop-shadow(8px 8px 10px gray)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_dropshadow">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: grayscale(50%); /* Safari */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_grayscale2" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">grayscale(50%)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_grayscale2">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: hue-rotate(90deg); /* Safari */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_hue" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">hue-rotate(90deg)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_huerotate">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: invert(100%); /* Safari */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_invert" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">invert(100%)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_invert">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: opacity(30%); /* Safari */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_opacity" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">opacity(30%)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_opacity">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: saturate(800%); /* Safari */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_saturate" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">saturate(800%)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_saturate">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: sepia(100%); /* Safari */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_sepia" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">sepia(100%)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_sepia">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Using Multiple Filters</h3>
<p>To use multiple filters, separate each filter with a space. Notice that the order is important (i.e. using grayscale() 
after sepia() will result in a completely gray image):</p>
<div class="w3-code notranslate cssHigh"> 
img {<br>&nbsp;&nbsp;&nbsp; -webkit-filter:&nbsp;contrast(200%) brightness(150%);&nbsp; /* Safari */<br>&nbsp;&nbsp;&nbsp;
...
<div class="img">
 <img class="w3-image filter_multiple" src="pineapple.jpg" alt="Mountain View">
 <div class="desc">contrast(200%) brightness(150%)</div>
</div>
<p style="clear:both;"></p>
</div>
-->
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_multiple">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh"> 
.blur {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: blur(4px);<br>&nbsp;&nbsp;&nbsp; filter: blur(4px);<br>}<br><br>.brightness {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: brightness(0.30);<br>&nbsp;&nbsp;&nbsp; filter: brightness(0.30);<br>}<br><br>.contrast {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: contrast(180%);<br>&nbsp;&nbsp;&nbsp; filter: contrast(180%);<br>}<br><br>.grayscale {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: grayscale(100%);<br>&nbsp;&nbsp;&nbsp; filter: grayscale(100%);<br>}<br><br>.huerotate {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: hue-rotate(180deg);<br>&nbsp;&nbsp;&nbsp; filter: hue-rotate(180deg);<br>}<br><br>.invert {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: invert(100%);<br>&nbsp;&nbsp;&nbsp; filter: invert(100%);<br>}<br><br>.opacity {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: opacity(50%);<br>&nbsp;&nbsp;&nbsp; filter: opacity(50%);<br>}<br><br>.saturate {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: saturate(7);<br>&nbsp;&nbsp;&nbsp; filter: saturate(7);<br>}<br><br>.sepia {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: sepia(100%);<br>&nbsp;&nbsp;&nbsp; filter: sepia(100%);<br>}<br><br>.shadow {<br>&nbsp;&nbsp;&nbsp; -webkit-filter: drop-shadow(8px 8px 10px green);<br>&nbsp;&nbsp;&nbsp; filter: drop-shadow(8px 8px 10px green);<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_filter_all">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="/css/css3_images.asp">CSS Images</a></p>
