...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS background-size property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">background-size</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_background-repeat.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    no-repeat;<br>&nbsp;&nbsp;&nbsp; background-size: 300px 100px;<br>}</div>
...
<p>The <code class="w3-codespan">background-size</code> property specifies the size of the background images.</p>
<p>There are four different syntaxes you can use with this property: the keyword 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>length</em></td>
    <td>Sets the width and height of the background image. The first value sets the width, the second value sets the height. If only one value is given, the second is set to &quot;auto&quot;. <a href="css_units.asp">Read about length units</a></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Specify the size of a background image with percent:</p>
<div class="w3-code notranslate cssHigh">
    #example1 {<br>&nbsp;&nbsp;&nbsp; background: url(mountain.jpg);<br>&nbsp;&nbsp;&nbsp; 
    background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; background-size: 100% 
    100%;<br>}<br><br>
    #example2 {<br>&nbsp;&nbsp;&nbsp; background: url(mountain.jpg);<br>&nbsp;&nbsp;&nbsp; 
    background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; background-size: 75% 
    50%;<br>}</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Specify the size of a background image with &quot;cover&quot;:</p>
<div class="w3-code notranslate cssHigh">
    #example1 {<br>&nbsp;&nbsp;&nbsp; background: url(mountain.jpg);<br>&nbsp;&nbsp;&nbsp; 
    background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; background-size: cover;<br>
    }</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Specify the size of a background image with &quot;contain&quot;:</p>
<div class="w3-code notranslate cssHigh">
    #example1 {<br>&nbsp;&nbsp;&nbsp; background: url(mountain.jpg);<br>&nbsp;&nbsp;&nbsp; 
    background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; background-size: 
    contain;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background-size4">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Here we have two background images. We specify the size of the first background image with &quot;contain&quot;, 
and the second background-image with &quot;cover&quot;:</p>
<div class="w3-code notranslate cssHigh">
    #example1 {<br>&nbsp;&nbsp;&nbsp; background: url(img_tree.gif), url(mountain.jpg);<br>&nbsp;&nbsp;&nbsp; 
    background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; background-size: 
    contain, cover;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background-size5">Try it Yourself &raquo;</a>
</div>
...
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_backgrounds.asp">CSS Backgrounds</a></p>
