...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS transition-duration Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">transition-duration </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_transition-delay.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_transition-property.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">transition-duration</code> property specifies how many seconds (s) or milliseconds 
(ms) a 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>time</i></td>
    <td>Specifies how many seconds or milliseconds a transition effect takes to complete. Default value is 0s, meaning there will be no effect</td>
  </tr>
  <tr>
    <td>initial</td>
