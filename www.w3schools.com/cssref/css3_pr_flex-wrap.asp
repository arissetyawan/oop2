...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS flex-wrap property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_flex-shrink.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_class_float.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
 div {<br>&nbsp;&nbsp;&nbsp; display: -webkit-flex; /* Safari */<br>&nbsp;&nbsp;&nbsp; -webkit-flex-wrap: wrap; /* Safari 6.1+ */<br>&nbsp;&nbsp;&nbsp;
...
<p>The <code class="w3-codespan">flex-wrap</code> property specifies whether the flexible items should wrap or not.</p>

<p><b>Note:</b> If the elements are not flexible items, the <code class="w3-codespan">flex-wrap</code> property has no effect.</p>
