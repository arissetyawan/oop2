...
<a class="w3-left w3-btn" href="pr_border.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-bottom_color.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh"> 
    ...
    border-bottom: 4px dotted blue;<br>}<br><br>div {<br>&nbsp;&nbsp;&nbsp; 
    border-bottom: double;<br>} 
</div>
...
<p>The <code class="w3-codespan">border-bottom</code> property is a shorthand 
property for (in the following order):</p>
<ul>
  <li><a href="pr_border-bottom_width.asp">border-bottom-width</a></li>
  <li><a href="pr_border-bottom_style.asp">border-bottom-style</a></li>
  <li><a href="pr_border-bottom_color.asp">border-bottom-color</a></li>
</ul>
<p>If border-bottom-color is omitted, the color applied will be the color of the 
text.&nbsp;</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_border-bottom">Try it</a>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.borderBottom=&quot;15px dotted lightblue&quot;
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the width of the bottom border. Default value is 
    &quot;medium&quot;</td>
  </tr>
  <tr>
    <td><i><a href="pr_border-bottom_style.asp">border-bottom-style</a></i></td>
    <td>Required. Specifies the style of the bottom border. Default value is 
    &quot;none&quot;</td>
  </tr>
  <tr>
    <td><i><a href="pr_border-bottom_color.asp">border-bottom-color</a></i></td>
    <td>Optional. Specifies the color of the bottom border. Default value is the 
