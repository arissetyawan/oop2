...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS overflow-y property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">overflow-y</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_overflow-x.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_padding.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    div.ex1 {<br>&nbsp;&nbsp;&nbsp; overflow-y: scroll;<br>}<br><br>div.ex2 {<br>&nbsp;&nbsp;&nbsp; 
    overflow-y: hidden;<br>}<br><br>div.ex3 {<br>&nbsp;&nbsp;&nbsp; overflow-y: 
    auto;<br>}<br><br>div.ex4 {<br>&nbsp;&nbsp;&nbsp; overflow-y: visible;<br>}
  
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_overflow-y">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">overflow-y</code> property specifies whether to clip the content, add a scroll 
...
<p>Numbers followed by -ms-, specify the first version that worked with a 
prefix.&nbsp;</p>
<div class="w3-responsive">
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>visible</td>
    <td>The content is not clipped, and it may be rendered outside the content box. 
    This is default</td>
...
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_overflow.asp">CSS Overflow</a></p>
