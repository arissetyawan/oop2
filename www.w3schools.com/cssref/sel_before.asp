...
<a class="w3-left w3-btn" href="sel_after.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_checked.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Insert some text before the content of each &lt;p&gt; element:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_before">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The ::before selector inserts something before the content of each selected element(s).</p>
<p>Use the <a href="pr_gen_content.asp">content</a> property to specify the content to insert.</p>
<p>Use the <a href="sel_after.asp">::after</a> selector to insert something after the content.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> ::before</td>
    <td>4.0</td>
    <td>9.0<br><span class="deprecated">Partial from 8.0</span></td>
    <td>3.5</td>
    <td>3.1</td>
    <td>7.0<br><span class="deprecated">Partial from 4.0</span></td>
  </tr>
</table>
</div>
<p><strong>Note:</strong> IE8 and Opera 4-6 only support the old, single-colon CSS 
syntax (:before). Newer versions support the standard, double-colon CSS syntax 
(::before).</p>
<p><strong>Note:</strong> For :before to work in IE8, a <a href="/tags/tag_doctype.asp">&lt;!DOCTYPE&gt;</a> must be 
declared.</p>
<hr>
<h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
::before {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_before_style" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
