...
<a class="w3-left w3-btn" href="sel_firstchild.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_firstline.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_firstletter">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> ::first-letter</td>
    <td>1.0</td>
    <td>9.0<br><span class="deprecated">Partial from 5.5</span></td>
    <td>1.0</td>
    <td>1.0</td>
    <td>7.0<br><span class="deprecated">Partial from 3.5</span></td>
  </tr>
</table>
</div>
<p><strong>Note:</strong> IE 5.5-8 and Opera 4-6 only support the old, single-colon CS S2 
syntax (:first-letter). Newer versions support the standard, double-colon syntax 
(::first-letter).</p>
<hr>
<h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
::first-letter {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
<a target="_blank" class="w3-btn btnsmall" href="trysel.asp?selector=p::first-letter">Demo</a>
</div></div>
<hr>
