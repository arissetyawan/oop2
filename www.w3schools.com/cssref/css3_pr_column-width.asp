...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS column-width property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">column-width</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_column-span.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_columns.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">column-width</code> property specifies the column width.</p>
<p>The number of columns will be the minimum number of columns needed to show 
all the content across the element.</p>
<p><code class="w3-codespan">column-width</code> is a flexible property. Think of 
<code class="w3-codespan">column-width</code> as a <em>minimum 
width suggestion</em> for the browser. Once the browser cannot fit at least two 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default value. The column width will be determined by the browser </td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_column-width">Play it &raquo;</a></td>   
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>A length that specifies the width of the columns. The number of columns 
    will be the minimum number of columns needed to show all the content across 
    the element. <a href="css_units.asp">Read about length units</a></td>
...
<div class="w3-code notranslate cssHigh">
    div
 {<br>&nbsp;&nbsp;&nbsp; -webkit-column-gap: 40px; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; -moz-column-gap: 40px; /* Firefox */<br>&nbsp;&nbsp;&nbsp; column-gap: 40px;<br>
 }
</div>
...
<div class="w3-code notranslate cssHigh">
    div
 {<br>&nbsp;&nbsp;&nbsp; -webkit-column-rule: 4px double #ff00ff; /* Chrome, Safari, Opera */<br>&nbsp;&nbsp;&nbsp; -moz-column-rule: 4px 
    double #ff00ff; /* Firefox */<br>&nbsp;&nbsp;&nbsp; column-rule: 4px double #ff00ff;<br>
 }
</div>
...
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_multiple_columns.asp">CSS Multiple Columns</a></p>
