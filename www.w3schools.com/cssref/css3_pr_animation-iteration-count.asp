...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS animation-iteration-count Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">animation-iteration-count </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_animation-fill-mode.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_animation-name.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
div {<br>&nbsp;&nbsp;&nbsp;
animation-iteration-count: 2;<br>}</div>
...
<p>The <code class="w3-codespan">animation-iteration-count</code> property specifies the number of times an animation should be played.</p>
...
<div class="w3-code notranslate cssHigh">
div {<br>&nbsp;&nbsp;&nbsp;
animation-iteration-count: infinite;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-iteration-count2">Try it Yourself &raquo;</a>
</div>
<hr>
