...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS @import Rule</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">@import</span> Rule</h1>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="css3_pr_hyphens.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="css3_pr_isolation.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    @import 
    &quot;navigation.css&quot;; /* Using a string */<br><br>or<br><br>@import 
    url(&quot;navigation.css&quot;); /* Using a url */</div>
</div>
<p>More examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">@import</code> rule allows you to import a style sheet into another style sheet.</p>
<p>The <code class="w3-codespan">@import</code> rule must be at the top of the document (but after any 
<a href="pr_charset_rule.asp">@charset</a> 
declaration).</p>
<p>The <code class="w3-codespan">@import</code> rule also supports media queries, so you can allow the import to 
be media-dependent.</p>
<hr>
...
@import <em>url</em>|<em>string list-of-mediaqueries</em>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>url</em>|<em>string</em></td>
    <td>A url or a string representing the location of the resource to import. 
    The url may be absolute or relative</td>
  </tr>
  <tr>
    <td><em>list-of-mediaqueries</em></td>
    <td>A comma-separated list of media queries conditioning the application of 
    the CSS rules defined in the linked URL</td>
  </tr>
  </table>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Import the &quot;printstyle.css&quot; style sheet  
ONLY if the media is print:</p>
<div class="w3-code notranslate cssHigh">
    @import 
    &quot;printstyle.css&quot; print;</div>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Import the &quot;mobstyle.css&quot; style sheet  
ONLY if the media is screen and the viewport is maximum 768 pixels:</p>
<div class="w3-code notranslate cssHigh">
    @import 
    &quot;mobstyle.css&quot; screen and (max-width: 768px);</div>
</div>
<br>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="css3_pr_hyphens.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
