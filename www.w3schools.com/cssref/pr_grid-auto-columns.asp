...
<h1>CSS <span class="color_h1">grid-auto-columns</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-area.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-auto-flow.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  .grid-container {<br>&nbsp;&nbsp;display: grid;<br>&nbsp; grid-auto-columns: 50px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-auto-columns" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-auto-columns</code> property sets a size for the columns in a grid container.</p>
<p>This property affects only columns with the size not set.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-auto-columns">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridAutoColumns=&quot;120px&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-auto-columns">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-auto-columns</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default value. The size of the columns is determined by the size of the 
    container</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-columns">Play it &raquo;</a></td> 

  </tr>
  <tr>
    <td>max-content</td>
    <td>Sets the size of each column to depend on the largest item in the column</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-columns&preval=max-content">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>min-content</td>
    <td>Sets the size of each column to depend on the largest item in the column</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-columns&preval=min-content">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Sets the size of the columns, by using a legal length value. <a href="css_units.asp">Read about length units</a></td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-columns&preval=50px">Play it &raquo;</a></td>
  </tr>
  </table>
</div>
<hr>
