...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-top property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-style.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-top_color.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    h1 {<br>&nbsp;&nbsp;&nbsp; border-top: 5px solid red;<br>}<br><br>h2 {<br>&nbsp;&nbsp;&nbsp; 
    border-top: 4px dotted blue;<br>}<br><br>div {<br>&nbsp;&nbsp;&nbsp; 
...
<p>The <code class="w3-codespan">border-top</code> shorthand property sets all the top border properties in one declaration.</p>
<p>The properties that can be set must be in the following order:</p>
<ul>
  <li><a href="pr_border-top_width.asp">border-top-width</a></li>
  <li><a href="pr_border-top_style.asp">border-top-style</a> (required)</li>
  <li><a href="pr_border-top_color.asp">border-top-color</a></li>
</ul>
<p>If border-top-color is omitted, the color applied will be the color of the 
text.</p>
<div class="w3-responsive">
<table class="w3-table-all">
  <tr>
    <th style="width:25%">Default value:</th>
    <td>medium none <i>color</i></td>
  </tr>
  <tr>
    <th>Inherited:</th>
    <td>no</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Required. Specifies the width of the top border. Default value is 
    &quot;medium&quot;</td>
  </tr>
  <tr>
    <td><i><a href="pr_border-top_style.asp">border-top-style</a></i></td>
    <td>Required. Specifies the style of the top border. Default value is &quot;none&quot;</td>
  </tr>
  <tr>
    <td><i><a href="pr_border-top_color.asp">border-top-color</a></i></td>
    <td>Optional. Specifies the color of the top border. Default value is the 
