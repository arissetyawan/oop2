...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS @media Rule</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">@media</span> Rule</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_dim_max-width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_dim_min-height.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Change the background color of the &lt;body&gt; element to 
&quot;lightblue&quot; when the browser window is 600px wide or less:</p>
<div class="w3-code notranslate cssHigh">
  @media only screen and (max-width: 600px) {<br>&nbsp;&nbsp;&nbsp; body {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  background-color: lightblue;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_media_bg">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">@media</code> rule is used in media queries to apply different styles for different media types/devices.</p>
...
sheet (responsive web design) to desktops, laptops, tablets, and mobile phones.</p>
...
<p>In addition to media types, there are also media features. Media features 
...
@media not|only <i>mediatype </i>and<i> (media feature </i> and|or|not<i> 
  mediafeature)</i> {<i><br>&nbsp;&nbsp;&nbsp; CSS-Code;<br></i>}</div></div>

<div class="w3-note w3-panel">
<p>meaning of the <strong>not</strong>, <strong>only</strong> and <strong>and</strong> keywords:</p>
<p><strong>not:</strong> The not keyword reverts the meaning of an entire media 
query.</p> 
<p><strong>only:</strong> The only keyword prevents older browsers that do not support media queries with media features from applying the specified styles. 
<strong>It has no effect on modern browsers.</strong></p>
<p><strong>and:</strong> The and keyword combines a media feature with a media 
type or other media features.</p>
  <p>They are all optional. However, if you use <strong>not</strong> or <strong>
  only</strong>, you must also specify a media type.</p>
</div>
<p>You can also have different <em>stylesheets</em> for different media, like 
this:</p>
<div class="w3-code w3-border notranslate htmlHigh"><div>
&lt;link rel=&quot;stylesheet&quot; media=&quot;screen and (min-width: 
  900px)&quot; href=&quot;widescreen.css&quot;&gt;<br>&lt;link rel=&quot;stylesheet&quot; media=&quot;screen and (max-width: 
  600px)&quot; href=&quot;smallscreen.css&quot;&gt;<br>....</div></div>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>any-hover</td>
    <td>Does any available input mechanism allow the user to hover over 
    elements? (added in Media Queries Level 4)</td>
    </tr>
    <tr>
    <td>any-pointer</td>
    <td>Is any available input mechanism a pointing device, and if so, how 
    accurate is it? (added in Media Queries Level 4)</td>
    </tr>
    <tr>
    <td>aspect-ratio</td>
  ...
  <tr>
    <td>color-gamut</td>
    <td>The approximate range of colors that are supported by the user agent and 
    output device (added in Media Queries Level 4)</td>
    </tr>
  <tr>
    <td>color-index</td>
  ...
  <tr>
    <td>hover</td>
    <td>Does the primary input mechanism allow the user to hover over elements? 
    (added in Media Queries Level 4)</td>
    </tr>
  <tr>
    <td>inverted-colors</td>
    <td>Is the browser or underlying OS inverting colors? (added in Media 
    Queries Level 4)</td>
    </tr>
  <tr>
    <td>light-level</td>
  ...
  <tr>
    <td>pointer</td>
    <td>Is the primary input mechanism a pointing device, and if so, how 
    accurate is it? (added in Media Queries Level 4)</td>
    </tr>
  <tr>
    <td>resolution</td>
  ...
  <tr>
    <td>scripting</td>
    <td>Is scripting (e.g. JavaScript) available? (added in Media Queries Level 
    4)</td>
    </tr>
  <tr>
    <td>update</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Hide an element when the browser's width is 600px wide or less:</p>
<div class="w3-code notranslate cssHigh">
  @media screen and (max-width: 600px) {<br>&nbsp; div.example {<br>&nbsp;&nbsp;&nbsp; display: 
  none;<br>&nbsp; 
  }<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_media_hide">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use mediaqueries to set the background-color to lavender if the viewport is 
800 pixels wide or wider, to lightgreen if the viewport is between 400 and 799 pixels wide. 
If the viewport is smaller than 400 pixels, the background-color is lightblue:</p>
<div class="w3-code notranslate cssHigh">
  body {<br>&nbsp;&nbsp;&nbsp; background-color: lightblue;<br>}<br><br>@media screen and (min-width: 
  400px) {<br>&nbsp;&nbsp;&nbsp; body {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  background-color: lightgreen;<br>&nbsp;&nbsp;&nbsp; }<br>}<br><br>@media 
  screen and (min-width: 800px) {<br>&nbsp;&nbsp;&nbsp; body {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  background-color: lavender;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_media2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Create a responsive navigation menu (displayed horizontally on large screens and vertically on small screens):</p>
<div class="w3-code notranslate cssHigh">
    @media screen and (max-width: 600px) {<br>&nbsp;&nbsp;&nbsp; .topnav a {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    float: none;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; 
    }<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_media_menu">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use media queries to create a responsive column layout:</p>
<div class="w3-code notranslate cssHigh">
    /* On screens that are 992px wide or less, go from four columns to two 
    columns */<br>@media screen and (max-width: 992px) {<br>&nbsp;&nbsp;&nbsp; .column {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    width: 50%;<br>&nbsp;&nbsp;&nbsp; }<br>}<br><br>/* On screens that are 600px wide or less, make the columns stack 
    on top of each other instead of next to each other */<br>@media screen and (max-width: 
    600px) {<br>&nbsp;&nbsp;&nbsp; .column {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    width: 100%;<br>&nbsp;&nbsp;&nbsp; }<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_media_columns">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use media queries to create a responsive website:</p>
<iframe src="/css/trycss3_flexbox_website_ifr.htm" style="border:2px solid #ddd;width:100%;height:625px;"></iframe>
<a target="_blank" class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=trycss3_media3">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="tryit.asp?filename=trycss3_media_orientation" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Use mediaqueries to set the text color to green when the document is 
displayed on the screen, and to black when it is printed:</p>
<div class="w3-code notranslate cssHigh">
  @media screen {<br>&nbsp;&nbsp;&nbsp; body {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  color: green; <br>&nbsp;&nbsp;&nbsp; }<br>}<br><br>@media print {<br>&nbsp;&nbsp;&nbsp; 
  body {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; color: black; <br>&nbsp;&nbsp;&nbsp; 
  }<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_media">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p><strong>Comma separated list</strong>: add an additional media query to an already existing one, using a comma (this will behave like an OR operator):</p>
<div class="w3-code notranslate cssHigh">
    /* When the width is between 600px and 900px OR above 1100px - change the 
    appearance of &lt;div&gt; */<br>@media screen and (max-width: 900px) and 
    (min-width: 600px), (min-width: 1100px) {<br>&nbsp; div.example {<br>&nbsp;&nbsp;&nbsp; 
    font-size: 50px;<br>&nbsp;&nbsp;&nbsp; padding: 50px;<br>&nbsp;&nbsp;&nbsp; 
    border: 8px solid black;<br>&nbsp;&nbsp;&nbsp; background: yellow;<br>&nbsp; 
    }<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_media_comma">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="/css/css3_mediaqueries.asp">CSS Media Queries</a></p>
<p>CSS Tutorial: <a href="/css/css3_mediaqueries_ex.asp">CSS Media Queries Examples</a></p>
<p>RWD Tutorial: <a href="/css/css_rwd_mediaqueries.asp">Responsive Web Design with Media Queries</a></p>
<p>JavaScript Tutorial: <a href="/jsref/met_win_matchmedia.asp">The window.matchMedia() method</a></p>
<br>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_dim_max-width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
