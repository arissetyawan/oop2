...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS counter-increment property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_gen_content.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_gen_counter-reset.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Create a counter (&quot;my-sec-counter&quot;) and increase it by one for each 
occurrence of the &lt;h2&gt; selector:</p>
<div class="w3-code notranslate cssHigh">
  
    body {<br>&nbsp;&nbsp;&nbsp; /* Set &quot;my-sec-counter&quot; to 0 */<br>&nbsp;&nbsp;&nbsp; 
    counter-reset: my-sec-counter;<br>}<br><br>h2::before {<br>&nbsp;&nbsp;&nbsp; 
    /* Increment &quot;my-sec-counter&quot; by 1 */<br>&nbsp;&nbsp;&nbsp; counter-increment: 
    my-sec-counter;<br>&nbsp;&nbsp;&nbsp; content: &quot;Section &quot; 
    counter(my-sec-counter) &quot;. &quot;;<br>}&nbsp;
</div>
<a target="_blank" href="tryit.asp?filename=trycss_counter-reset" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">counter-increment</code> property increases or decreases the value of one or 
more CSS counters.</p>
<p>The <code class="w3-codespan">counter-increment</code> property is usually used together with the 
<a href="pr_gen_counter-reset.asp">counter-reset</a> property and the 
<a href="pr_gen_content.asp">content</a> property.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>id number</i></td>
    <td>The <i>id</i> defines which counter to increment. The <i>number</i> sets how much the counter will increment on each occurrence of the selector. The default increment is 1. 
    Negative values are allowed. If <i>id</i> refers to a counter that has not been initialized by counter-reset, the default initial value is 0</td>
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Create a counter (&quot;my-sec-counter&quot;) and decrease it by one for each 
occurrence of the &lt;h2&gt; selector:</p>
<div class="w3-code notranslate cssHigh">
  
    body {<br>&nbsp;&nbsp;&nbsp; /* Set &quot;my-sec-counter&quot; to 0 */<br>&nbsp;&nbsp;&nbsp; 
    counter-reset: my-sec-counter;<br>}<br><br>h2::before {<br>&nbsp;&nbsp;&nbsp; 
    /* Decrement &quot;my-sec-counter&quot; by 1 */<br>&nbsp;&nbsp;&nbsp; counter-increment: 
    my-sec-counter -1;<br>&nbsp;&nbsp;&nbsp; content: &quot;Section &quot; 
    counter(my-sec-counter) &quot;. &quot;;<br>}&nbsp;
</div>
<a target="_blank" href="tryit.asp?filename=trycss_counter-reset2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Numbering sections and sub-sections with &quot;Section 1:", "1.1", "1.2", etc.:</p>
<div class="w3-code notranslate cssHigh">
body
 {<br>&nbsp;&nbsp;&nbsp;&nbsp; /* Set &quot;section&quot; to 0 */<br>
 &nbsp;&nbsp;&nbsp;
 counter-reset: section;<br>
 }<br>
 <br>
 h1
 {<br>&nbsp;&nbsp;&nbsp;&nbsp; /* Set &quot;subsection&quot; to 0 */<br>
 &nbsp;&nbsp;&nbsp;
 counter-reset: subsection;<br>
 }<br>
 <br>
 h1::before
 {<br>&nbsp;&nbsp;&nbsp; /* Increment &quot;section&quot; by 1 */<br>
 &nbsp;&nbsp;&nbsp;
...
<a target="_blank" href="tryit.asp?filename=trycss_counter-reset3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Create a counter and increase it by one (using Roman numerals) for each 
occurrence of the &lt;h2&gt; selector:</p>
<div class="w3-code notranslate cssHigh">
    ...
    counter-reset: my-sec-counter;<br>}<br><br>h2::before {<br>&nbsp;&nbsp;&nbsp; 
    /* Increment &quot;my-sec-counter&quot; by 1 */<br>&nbsp;&nbsp;&nbsp; counter-increment: 
    my-sec-counter;<br>&nbsp;&nbsp;&nbsp; content: counter(my-sec-counter, 
    upper-roman) &quot;. &quot;;<br>}   
</div>
<a target="_blank" href="tryit.asp?filename=trycss_counter-reset4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
