...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS table-layout property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_tab-size.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_text_text-align.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">table-layout</code> property defines the algorithm 
used to lay out table cells, rows, and columns.</p>
<p><strong>Tip:</strong> The main benefit of table-layout: fixed; is that the 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Browsers use an automatic table layout algorithm. The column width is set by the widest unbreakable content in the cells.
  ...
  <tr>
    <td>fixed</td>
    <td>Sets a fixed table layout algorithm. The table and column widths are set 
    ...
    regardless of content inside the cells</td>
