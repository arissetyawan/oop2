...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS box-shadow property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">box-shadow</span> Property</h1>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="css3_pr_box-decoration-break.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_box-sizing.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">box-shadow</code> property attaches one or more shadows to an element.</p>
...
box-shadow: none|<i>h-offset v-offset blur spread color </i>|inset|initial|inherit;</div></div>
<p><b>Note:</b> To attach more than one shadow to an 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>h-offset</i></td>
    <td>Required. The horizontal offset of the shadow. A positive value puts the 
    shadow on the right side of the box, a negative value puts the shadow on the 
    left side of the box</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow">Play it &raquo;</a></td>  
  </tr>
  <tr>
    <td><i>v-offset</i></td>
    <td>Required. The vertical offset of the shadow. A positive value puts the 
    shadow below the box, a negative value puts the shadow above the box</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow">Play it &raquo;</a></td>   
  </tr>
  <tr>
    <td><i>blur</i></td>
    <td>Optional. The blur radius. The higher the number, the more blurred the 
    shadow will be</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow&preval=20px 20px 10px grey">Play it &raquo;</a></td>      
  </tr>
  <tr>
    <td><i>spread</i></td>
    <td>Optional. The spread radius. A positive value increases the size of the 
    shadow, a negative value decreases the size of the shadow</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow&preval=20px 20px 50px 15px grey">Play it &raquo;</a></td>          
  </tr>
  <tr>
    <td><i>color</i></td>
    <td>Optional. The color of the shadow. The default value is the text color. Look at <a href="css_colors_legal.asp">CSS Color Values</a> for a complete list of possible color values.<br><br><strong>Note:</strong> In Safari (on PC) the color parameter is required. If you do not specify the color, the shadow is not displayed at all.</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow&preval=20px 20px 20px 10px red">Play it &raquo;</a></td>           
  </tr>
  <tr>
    <td>inset</td>
    <td>Optional. Changes the shadow from an outer shadow (outset) to an inner shadow</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_box-shadow&preval=20px 20px 50px 10px pink inset">Play it &raquo;</a></td>            
  </tr>
  <tr>
    <td>initial</td>
  ...
  <p><strong>Tip:</strong> <a href="css_units.asp">Read more about allowed values (CSS length units)</a></p>
</div>
<hr>
...
<div class="w3-code notranslate cssHigh">
    #example1 {<br>&nbsp;&nbsp;&nbsp; box-shadow: 10px 10px 8px #888888;<br>
    } </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_box-shadow2">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Define the spread radius of the shadow:</p>
<div class="w3-code notranslate cssHigh">
    #example1 {<br>&nbsp;&nbsp;&nbsp; box-shadow: 10px 10px 8px 10px #888888;<br>
    } </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_box-shadow3">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
    #example1 {<br>&nbsp;&nbsp;&nbsp; box-shadow: 5px 5px blue, 10px 10px 
    red, 15px 15px green;<br>
    } </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_box-shadow4">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Add the inset keyword:</p>
<div class="w3-code notranslate cssHigh">
    #example1 {<br>&nbsp;&nbsp;&nbsp; box-shadow: 5px 10px inset;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_box-shadow5">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Images thrown on the table. This example demonstrates how to create &quot;polaroid&quot; pictures and rotate the 
pictures:</p>
<div class="w3-code notranslate cssHigh">
    div.polaroid {<br>&nbsp;&nbsp;&nbsp; width: 284px;<br>&nbsp;&nbsp;&nbsp; 
    padding: 10px 10px 20px 10px;<br>&nbsp;&nbsp;&nbsp; border: 1px solid 
    #BFBFBF;<br>&nbsp;&nbsp;&nbsp; background-color: white;<br>&nbsp;&nbsp;&nbsp; 
    box-shadow: 10px 10px 5px #aaaaaa;<br>} </div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_image_gallery">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_borders.asp">CSS Rounded Corners</a></p>
