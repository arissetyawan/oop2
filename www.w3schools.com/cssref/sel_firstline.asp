...
<a class="w3-left w3-btn" href="sel_firstletter.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_first-of-type.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_firstline">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p><strong>Note:</strong> IE 5.5-8 and Opera 4-6 only support the old, single-colon CSS 
syntax (:first-line). Newer versions support the standard, double-colon syntax 
(::first-line).</p>
<hr>
<h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
::first-line {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
<a target="_blank" class="w3-btn btnsmall" href="trysel.asp?selector=p::first-line">Demo</a>
</div></div>
<hr>
