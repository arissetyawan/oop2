...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS opacity property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">opacity</span> Property</h1>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="css3_pr_object-position.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_order.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">opacity</code> property sets the opacity level for an element.</p>
...
<img src="/css/img_forest.jpg" style="width:100%;opacity:0.2;">
<p>opacity 0.2</p>
</div>

<div class="w3-third w3-center">
<img src="/css/img_forest.jpg" style="width:100%;opacity:0.5">
<p>opacity 0.5</p>
</div>

<div class="w3-third w3-center">
<img src="/css/img_forest.jpg" style="width:100%;">
<p>opacity 1<br>(default)</p>
</div>

</div>

<p><strong>Note:</strong> When using the <code class="w3-codespan">opacity</code> property to add transparency to 
...
instead (See &quot;More Examples&quot; below).</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>number</i></td>
    <td>Specifies the opacity. From 0.0 (fully transparent) to 1.0 (fully opaque) </td>
...
<div class="w3-example">
<h3>Example</h3>
<p>The opacity property adds transparency to the background of an element, and 
to all of its child elements as well. This makes the text inside a transparent element hard to read:</p>
<div class="w3-code notranslate cssHigh">
    div.first {<br>&nbsp;&nbsp;&nbsp; opacity: 0.1;<br>}<br><br>div.second {<br>&nbsp;&nbsp;&nbsp; 
    opacity: 0.3;<br>}<br><br>div.third {<br>&nbsp;&nbsp;&nbsp; opacity: 0.6;<br>
    }
</div>
<a target="_blank" href="tryit.asp?filename=trycss3_opacity_box" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>To not apply opacity to child elements (like in the example above) use <strong>RGBA</strong> color values 
instead. 
The following example sets the opacity for the background color, but not for the text:</p>
<div class="w3-code notranslate cssHigh">
    div.first {<br>&nbsp;&nbsp;&nbsp; background: rgba(76, 175, 80, 0.1);<br>}<br>
    <br>div.second {<br>&nbsp;&nbsp;&nbsp; background: rgba(76, 175, 80, 0.3);<br>
    }<br><br>div.third {<br>&nbsp;&nbsp;&nbsp; background: rgba(76, 175, 80, 
    0.6);<br>}
</div>
<a target="_blank" href="tryit.asp?filename=trycss3_opacity_box2" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
<p><strong>Tip:</strong> Learn more about RGBA Colors in <a href="/css/css3_colors.asp">CSS RGBA Colors</a>.</p>
</div>
...
<div class="w3-code notranslate jsHigh">
    function myFunction(x) {<br>// Return the text of the selected option<br>&nbsp;&nbsp;&nbsp; var opacity = x.options[x.selectedIndex].text;<br>&nbsp;&nbsp;&nbsp; var el = document.getElementById(&quot;p1&quot;);<br>&nbsp;&nbsp;&nbsp; if (el.style.opacity !== undefined) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; el.style.opacity = opacity;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; alert(&quot;Your browser doesn't support this example!&quot;);<br>&nbsp;&nbsp;&nbsp; }<br>
 }</div>
...
<h2>Related Pages</h2>
<p>CSS Tutorial: <a href="/css/css_image_transparency.asp">CSS Opacity / Transparency</a></p>
<p>CSS Tutorial: <a href="/css/css3_colors.asp">CSS RGBA Colors</a></p>
