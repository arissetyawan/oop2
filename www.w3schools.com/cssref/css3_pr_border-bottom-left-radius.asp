...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-bottom-left-radius property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">border-bottom-left-radius</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_border-bottom_color.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_border-bottom-right-radius.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">border-bottom-left-radius</code> property defines the radius of the 
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;">border-bottom-left-radius</td>
...
<p><b>Note:</b> If you set two values, the first one is for the bottom border, and the second one for
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines the shape of the bottom-left corner. Default value is 0. <a href="css_units.asp">Read about length units</a></td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-bottom-left-radius">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Defines the shape of the bottom-left corner in %</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Add rounded borders to the bottom-left corner in percent:</p>
<div class="w3-code notranslate cssHigh">
  #example1 {<br>&nbsp;&nbsp;&nbsp; border: 2px solid red;<br>&nbsp;&nbsp;&nbsp; 
  background: url(paper.gif);<br>&nbsp;&nbsp;&nbsp; padding: 10px;<br>&nbsp;&nbsp;&nbsp; 
  border-bottom-left-radius: 40%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_border-bottom-left-radius2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
