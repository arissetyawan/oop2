...
<a class="w3-left w3-btn" href="css3_pr_background-clip.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_background-image.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
body {background-color: coral;}</div>
...
<p>The <code class="w3-codespan">background-color</code> property sets the background color of an element.</p>
...
<table class="w3-table-all notranslate">
 ...
 CSS Color Values</a> for a complete list of possible color values.</td>
  ...
  <tr>
    <td>transparent</td>
    <td>Specifies that the background color should be transparent. This is default</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Specify the background color with a HEX value:</p>
<div class="w3-code notranslate cssHigh">
body {background-color: #92a8d1;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_background-color2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Specify the background color with an RGB value:</p>
<div class="w3-code notranslate cssHigh">
body {background-color: rgb(201, 76, 76);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_background-color3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Specify the background color with an RGBA value:</p>
<div class="w3-code notranslate cssHigh">
body {background-color: rgba(201, 76, 76, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_background-color4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Specify the background color with a HSL value:</p>
<div class="w3-code notranslate cssHigh">
body {background-color: hsl(89, 43%, 51%);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_background-color5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Specify the background color with a HSLA value:</p>
<div class="w3-code notranslate cssHigh">
body {background-color: hsla(89, 43%, 51%, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_background-color6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set background colors for different elements:</p>
<div class="w3-code notranslate cssHigh">
  body {<br>&nbsp;&nbsp;&nbsp; background-color: #fefbd8;<br>}<br><br>h1 {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #80ced6;<br>}<br><br>div {<br>&nbsp;&nbsp;&nbsp; background-color: #d5f4e6;<br>
  }<br><br>span {<br>&nbsp;&nbsp;&nbsp; 
  background-color: #f18973;<br>} </div>
