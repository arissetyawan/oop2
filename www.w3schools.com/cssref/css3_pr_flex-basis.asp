...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS flex-basis property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_flex.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_flex-direction.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
 div:nth-of-type(2) {<br>&nbsp;&nbsp;&nbsp; -webkit-flex-basis: 100px; /* Safari 6.1+ */<br>&nbsp;&nbsp;&nbsp; flex-basis: 
  100px;<br>}</div>
...
<p>The <code class="w3-codespan">flex-basis</code> property specifies the initial length of a flexible item.</p>
<p><b>Note:</b> If the element is not a flexible item, the <code class="w3-codespan">flex-basis</code> property has no effect.</p>
