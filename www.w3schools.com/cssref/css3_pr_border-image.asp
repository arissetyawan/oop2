...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-image property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">border-image</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_border-color.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_border-image-outset.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">border-image</code> property allows you to specify an image to be used as the border around an element.</p>
<p>The border-image property is a shorthand property for:</p>
<ul>
  <li><a href="css3_pr_border-image-source.asp">border-image-source</a></li>
  <li><a href="css3_pr_border-image-slice.asp">border-image-slice</a></li>
  <li><a href="css3_pr_border-image-width.asp">border-image-width</a></li>
  <li><a href="css3_pr_border-image-outset.asp">border-image-outset</a></li>
  <li><a href="css3_pr_border-image-repeat.asp">border-image-repeat</a></li>
</ul>
...
<div class="w3-code notranslate cssHigh">
    #borderimg1 {<br>&nbsp;&nbsp;&nbsp; border: 10px solid transparent;<br>&nbsp;&nbsp;&nbsp; padding: 15px;<br>&nbsp;&nbsp;&nbsp; border-image: url(border.png) 50 round;<br>}<br><br>#borderimg2 {<br>&nbsp;&nbsp;&nbsp; border: 10px solid transparent;<br>&nbsp;&nbsp;&nbsp; padding: 15px;<br>&nbsp;&nbsp;&nbsp; border-image: url(border.png) 20% round;<br>}<br><br>
 #borderimg3 {<br>&nbsp;&nbsp;&nbsp; border: 10px solid transparent;<br>&nbsp;&nbsp;&nbsp; padding: 15px;<br>&nbsp;&nbsp;&nbsp; border-image: url(border.png) 30% round;<br>} </div>
...
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_border_images.asp">CSS Border Images</a></p>
