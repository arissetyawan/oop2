...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS font-size property</title>
<meta charset="utf-8">
...
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="css3_pr_font-kerning.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_font-size-adjust.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">font-size</code> property sets the size of a font.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Sets the font-size to a fixed size in px, cm, etc. <a href="css_units.asp">Read about length units</a></td>
     <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_font-size&preval=10px">Play it &raquo;</a></td>    
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Sets the font-size to a percent of&nbsp; the parent element's font size</td>
...
<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css_font.asp">CSS Fonts</a></p>
