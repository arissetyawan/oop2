...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-spacing property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-right_width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-style.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    <br>#table2 {<br>&nbsp;&nbsp;&nbsp; border-collapse: separate;<br>&nbsp;&nbsp;&nbsp; 
    border-spacing: 15px 50px;<br>} </div>
<a target="_blank" href="tryit.asp?filename=trycss_border-spacing" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">border-spacing</code> property sets the distance between the borders of adjacent cells.</p>
<p><strong>Note:</strong> This property works only when 
<a href="pr_border-collapse.asp">border-collapse</a> is 
separate.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Specifies the distance between the borders of adjacent cells in px, cm, etc. Negative values are not allowed.<ul>
    <li>If one  value is specified, it defines both the horizontal and vertical spacing 
    between cells</li>
    <li>If two values are specified, the first sets the horizontal spacing and the second sets the vertical spacing</li>
 </ul>
  </td>
...
<p>HHTML DOM reference: <a href="/jsref/prop_style_borderspacing.asp">borderSpacing property</a></p>
<br>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_border-right_width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
