...
<html lang="en-US">
<head>
<title>CSS grid-auto-rows property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">grid-auto-rows</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-auto-flow.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-column.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  .grid-container {<br>&nbsp;&nbsp;display: grid;<br>&nbsp; grid-auto-rows: 150px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-auto-rows" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-auto-rows</code> property sets a size for the rows in a grid container.</p>
<p>This property affects only rows with the size not set.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-auto-rows">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridAutoRows=&quot;60px&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-auto-rows">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-auto-rows</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-auto-columns: auto|max-content|min-content|<i>length</i>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default value. The size of the rows is determined by the size of the 
    largest item in the row</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-rows">Play it &raquo;</a></td> 

  </tr>
  <tr>
    <td>max-content</td>
    <td>Sets the size of each row to depend on the largest item in the row</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-rows&preval=max-content">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>min-content</td>
    <td>Sets the size of each row to depend on the largest item in the row</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-rows&preval=min-content">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Sets the size of the rows, by using a legal length value. <a href="css_units.asp">Read about length units</a></td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-rows&preval=50px">Play it &raquo;</a></td>
  </tr>
  </table>
</div>
<hr>
