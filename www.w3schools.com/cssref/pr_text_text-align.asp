...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS text-align property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_tab_table-layout.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_text-align-last.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">text-align</code> property specifies the horizontal alignment of text in an element.</p>
<div class="w3-responsive">
<table class="w3-table-all">
  <tr>
    <th style="width:25%">Default value:</th>
    <td>left if direction is ltr, and right if direction is rtl</td>
  </tr>
  <tr>
    <th>Inherited:</th>
    <td>yes</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Another text-align example:</p>
<div class="w3-code notranslate cssHigh">
    h1 {<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>}<br><br>p.date {<br>&nbsp;&nbsp;&nbsp; text-align: right;<br>}<br>
 <br>p.main {<br>&nbsp;&nbsp;&nbsp; text-align: justify;<br>}</div>
