...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS background-origin property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">background-origin</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_background-image.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_background-position.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
#example1 {<br>
 &nbsp;&nbsp;&nbsp; border: 10px double black;<br>&nbsp;&nbsp;&nbsp; padding: 
...
<p>The <code class="w3-codespan">background-origin</code> property specifies the origin position (the background 
positioning area) of a background image.</p>
<p><b>Note:</b> This property has no effect if
<a href="pr_background-attachment.asp">background-attachment</a> is &quot;fixed&quot;.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set two background images for a &lt;div&gt; element. Let the &quot;paper.gif&quot; 
...
content:</p>
<div class="w3-code notranslate cssHigh">
  #example1 {<br>&nbsp;&nbsp;&nbsp; border: 10px double black;<br>&nbsp;&nbsp;&nbsp; 
  padding: 25px;<br>&nbsp;&nbsp;&nbsp; background: url(img_tree.gif), url(paper.gif);<br>&nbsp;&nbsp;&nbsp; 
  background-repeat: no-repeat;<br>&nbsp;&nbsp;&nbsp; background-origin: 
  content-box, padding-box;<br>}<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_background-origin2">Try it Yourself &raquo;</a>
</div>
<hr>
