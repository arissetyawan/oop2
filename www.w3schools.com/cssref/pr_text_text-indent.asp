...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS text-indent property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_text-decoration-style.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_text-justify.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    div.a {<br>&nbsp;&nbsp;&nbsp; text-indent: 50px;<br>}<br><br>div.b {<br>&nbsp;&nbsp;&nbsp; 
    text-indent: -2em;<br>}<br><br>div.c {<br>&nbsp;&nbsp;&nbsp; text-indent: 
    30%;<br>}
...
<p>The <code class="w3-codespan">text-indent</code> property specifies the indentation of the first line in a text-block.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines a fixed indentation in px, pt, cm, em, etc. Default value is 0. <a href="css_units.asp">Read about length units</a></td>
