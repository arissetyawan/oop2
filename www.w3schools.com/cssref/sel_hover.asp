...
<a class="w3-left w3-btn" href="sel_focus.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="css_selectors.asp"><span class="w3-hide-small">CSS </span> Selectors<span class="w3-hide-small"> Reference</span></a>
<a class="w3-right w3-btn" href="sel_in-range.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_hover">Try it Yourself &raquo;</a>
</div>
...
<p>The numbers in the table specifies the first browser version that fully supports the selector.</p>
<div class="w3-responsive">
<table class="browserref notranslate">
  <tr>
    <th style="width:20%;font-size:16px;text-align:left;">Selector</th>
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> :hover</td>
    <td>4.0</td>
    <td>7.0</td>
    <td>2.0</td>
    <td>3.1</td>
...
:hover {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
<a target="_blank" class="w3-btn btnsmall" href="trysel.asp?selector=h1:hover">Demo</a>
</div></div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Select and style a &lt;p&gt;, &lt;h1&gt; and &lt;a&gt; element when you mouse over it:</p>
<div class="w3-code notranslate cssHigh">
  
    p:hover, h1:hover, a:hover {<br>&nbsp;&nbsp;&nbsp; background-color: yellow;<br>
 }</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_sel_hover_more">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
    ...
    /* unvisited link */<br>a:link&nbsp;{<br>&nbsp;&nbsp;&nbsp; color: green;<br>}<br>
 <br>/* visited link */<br>
 a:visited {<br>&nbsp;&nbsp;&nbsp; color: green;<br>}<br><br>/* mouse over link */<br>
 a:hover&nbsp;{<br>&nbsp;&nbsp;&nbsp; color: red;<br>}<br><br>/* selected link */<br>
 a:active&nbsp;{<br>&nbsp;&nbsp;&nbsp; color: yellow;<br>}
  
</div>
<a target="_blank" href="tryit.asp?filename=trycss_sel_link_more1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
    ...
    a.ex1:hover, a.ex1:active {<br>&nbsp;&nbsp;&nbsp; color: red;<br>}<br><br>
 a.ex2:hover, a.ex2:active {<br>&nbsp;&nbsp;&nbsp; font-size: 150%;<br>}<br>

</div>
<a target="_blank" href="tryit.asp?filename=trycss_sel_link_more2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Hover over a &lt;span&gt; element to show a &lt;div&gt; element (like a tooltip):</p>
<div class="w3-code notranslate cssHigh">
  
    div {<br>&nbsp;&nbsp;&nbsp; display: none;<br>}<br>
 <br>span:hover + div {<br>&nbsp;&nbsp;&nbsp; display: block;<br>}<br>

</div>
<a target="_blank" href="tryit.asp?filename=trycss_sel_hover2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Show and hide a &quot;dropdown&quot; menu on mouse hover:</p>
<div class="w3-code notranslate cssHigh">
  
    ul {<br>&nbsp;&nbsp;&nbsp; display: inline;<br>&nbsp;&nbsp;&nbsp; margin: 0;<br>&nbsp;&nbsp;&nbsp; padding: 0;<br>}<br>ul li {display: inline-block;}<br>ul li:hover {background: #555;}<br>ul li:hover ul {display: block;}<br>ul li ul {<br>&nbsp;&nbsp;&nbsp; position: absolute;<br>&nbsp;&nbsp;&nbsp; width: 200px;<br>&nbsp;&nbsp;&nbsp; display: none;<br>}<br>ul li ul li { <br>&nbsp;&nbsp;&nbsp; background: #555; <br>&nbsp;&nbsp;&nbsp; display: block; <br>}<br>ul li ul li a {display:block !important;} <br>ul li ul li:hover {background: #666;}<br>

</div>
<a target="_blank" href="tryit.asp?filename=trycss_sel_hover_dropdown" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
