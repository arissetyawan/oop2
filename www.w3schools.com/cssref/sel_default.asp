...
<html lang="en-US">
<head>
<title>CSS :default Selector</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:default</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_checked.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_disabled.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Add a red shadow color to the default input element:</p>
<div class="w3-code notranslate cssHigh">
  
    input:default {<br>&nbsp; box-shadow: 0 0 1px 1px red;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_sel_default" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The :default selector selects the default form element in a group of related elements.</p>
<p>The :default selector can only be used on &lt;button&gt;, &lt;input type="checkbox"&gt;, &lt;input type="radio"&gt;, and 
&lt;option&gt; elements</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;">:default</td>
    <td>10.0</td>
    <td>12.0</td>
    <td>4.0</td>
    <td>5.0</td>
...
<p><strong>Note:</strong> The :default selector is not supported in Internet Explorer 11 and earlier versions.</p>
<hr>
<h2>CSS Syntax</h2>
<div class="w3-code w3-border notranslate"><div>
:default {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<br>
