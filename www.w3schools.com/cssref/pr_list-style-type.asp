...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS list-style-type property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_list-style-position.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_margin.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">list-style-type</code> specifies the type of list-item marker in a list.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    <th style="width: 25%">Animatable:</th>
...
<p><b>Note:</b> Internet Explorer/Edge and Opera 12 and earlier versions do not support 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ul_list-style-type&preval=disc">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>armenian</td>
    <td>The marker is traditional Armenian numbering</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=armenian">Play it &raquo;</a></td>                </tr>
  <tr>
    <td>circle</td>
    <td>The marker is a circle</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ul_list-style-type&preval=circle">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>cjk-ideographic</td>
    <td>The marker is plain ideographic numbers</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=cjk-ideographic">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>decimal</td>
    <td>The marker is a number</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=decimal">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>decimal-leading-zero</td>
    <td>The marker is a number with leading zeros (01, 02,  03, etc.)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=decimal-leading-zero">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>georgian</td>
    <td>The marker is traditional Georgian numbering</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=georgian">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>hebrew</td>
    <td>The marker is traditional Hebrew numbering</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=hebrew">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>hiragana</td>
    <td>The marker is traditional Hiragana numbering</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=hiragana">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>hiragana-iroha</td>
    <td>The marker is traditional Hiragana iroha numbering</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=hiragana-iroha">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>katakana</td>
    <td>The marker is traditional Katakana numbering</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=katakana">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>katakana-iroha</td>
    <td>The marker is traditional Katakana iroha numbering</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=katakana-iroha">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>lower-alpha</td>
    <td>The marker is lower-alpha (a, b, c, d, e, etc.)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=lower-alpha">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>lower-greek</td>
    <td>The marker is lower-greek</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=lower-greek">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>lower-latin</td>
    <td>The marker is lower-latin (a, b, c, d, e, etc.)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=lower-latin">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>lower-roman</td>
    <td>The marker is lower-roman (i, ii, iii, iv, v, etc.)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=lower-roman">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>none</td>
    <td>No marker is shown</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=none">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>square</td>
    <td>The marker is a square</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ul_list-style-type&preval=square">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>upper-alpha</td>
    <td>The marker is upper-alpha (A, B, C, D, E, etc.)&nbsp;</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=upper-alpha">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>upper-greek</td>
    <td>The marker is upper-greek</td>
    <td>
    <a class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&amp;preval=upper-greek" target="_blank">Play it &raquo;</a></td>                  
  </tr>
  <tr>
    <td>upper-latin</td>
    <td>The marker is upper-latin (A, B, C, D, E, etc.)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=upper-latin">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>upper-roman</td>
    <td>The marker is upper-roman (I, II, III, IV, V, etc.)</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_ol_list-style-type&preval=upper-roman">Play it &raquo;</a></td>                  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-code notranslate cssHigh">
    ul.a {list-style-type: circle;}<br>ul.b {list-style-type: disc;}<br>ul.c {list-style-type: square;}<br>
    <br>ol.d {list-style-type: armenian;}<br>ol.e {list-style-type: cjk-ideographic;}<br>ol.f {list-style-type: decimal;}<br>
 ol.g {list-style-type: decimal-leading-zero;}<br>ol.h {list-style-type: georgian;}<br>ol.i {list-style-type: hebrew;}<br>ol.j {list-style-type: hiragana;}<br>ol.k {list-style-type: hiragana-iroha;}<br>ol.l {list-style-type: katakana;}<br>ol.m {list-style-type: katakana-iroha;}<br>
 ...
 ol.r {list-style-type: upper-alpha;}<br>ol.s {list-style-type: upper-greek;}<br>ol.t {list-style-type: upper-latin;}<br>
 ol.u {list-style-type: upper-roman;}<br>ol.v {list-style-type: none;}<br>
 ol.w {list-style-type: inherit;}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_list-style-type_all">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>How to add bullet colors for &lt;ul&gt; or &lt;ol&gt; by removing their default bullets and adding a HTML entity that looks like bullets (&amp;bull;):</p>
<div class="w3-code notranslate cssHigh">
  
    ul {<br>&nbsp;&nbsp;&nbsp; list-style: none; /* Remove list bullets */<br>&nbsp;&nbsp;&nbsp; padding: 0;<br>&nbsp;&nbsp;&nbsp; margin: 0;<br>}<br><br>li { <br>&nbsp;&nbsp;&nbsp; padding-left: 16px; <br>}<br>
 <br>li:before {<br>&nbsp;&nbsp;&nbsp; content: &quot;&bull;&quot;; /* Insert content that looks like bullets */<br>&nbsp;&nbsp;&nbsp; padding-right: 8px;<br>&nbsp;&nbsp;&nbsp; color: blue; /* Or a color you prefer */<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_content_list-bullets">Try it Yourself &raquo;</a>
</div>
<hr>
