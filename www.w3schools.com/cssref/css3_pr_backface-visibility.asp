...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS backface-visibility property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">backface-visibility</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_animation-timing-function.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_background.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">backface-visibility</code> property defines whether or not the back face of an element 
should be visible when facing the user.</p>
<p>The back face of an element is a mirror image of the front face being 
displayed.</p>
<p>This property is useful when an element is rotated. It lets you choose if the 
user should see the back face or not.</p>
