...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS display property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_text_direction.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_tab_empty-cells.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=trycss_display" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">display</code> property specifies the display behavior 
(the type of rendering box) of an element.</p>
<p>In HTML, the default display property value is taken from the HTML specifications or from the browser/user default style sheet. The 
default value in XML is inline, including SVG elements.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;">display</td>
    <td>4.0</td>
    <td>8.0</td> 
    <td>3.0</td>
    <td>3.1</td>
...
<p><strong>Note:</strong> The values &quot;flex&quot; and &quot;inline-flex&quot; requires the -webkit- prefix to work in Safari.</p>
<p><strong>Note:</strong> &quot;display: contents&quot; does not work in Edge/Internet Explorer.</p>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td>inline</td>
    <td>Displays an element as an inline element (like &lt;span&gt;). 
    Any height and width properties will have no effect</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=inline">Play it &raquo;</a></td>          
    </tr>
  <tr>
    <td>block</td>
    <td>Displays an element as a block element (like &lt;p&gt;). It starts on a 
    new line, and takes up the whole width</td>
  ...
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=contents">Play it &raquo;</a></td>    
    </tr>
  <tr>
    <td>flex</td>
    <td>Displays an element as a block-level flex container</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=flex">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>grid</td>
    <td>Displays an element as a block-level grid container</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=grid">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>inline-block</td>
  ...
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=inline-block">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>inline-flex</td>
    <td>Displays an element as an inline-level flex container</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=inline-flex">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>inline-grid</td>
    <td>Displays an element as an inline-level grid container</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=inline-grid">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>inline-table</td>
    <td>The element is displayed as an inline-level table</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=inline-table">Play it &raquo;</a></td>     
    </tr>
  <tr>
    <td>list-item</td>
  ...
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=run-in">Play it &raquo;</a></td>    
  </tr>
    <tr>
    <td>table</td>
    <td>Let the element behave like a &lt;table&gt; element</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=table">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>table-caption</td>
    <td>Let the element behave like a &lt;caption&gt; element</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=table-caption">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>
      table-column-group</td>
    <td>Let the element behave like a &lt;colgroup&gt; element</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=table-column-group">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>table-header-group</td>
    <td>Let the element behave like a &lt;thead&gt; element</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=table-header-group">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>table-footer-group</td>
    <td>Let the element behave like a &lt;tfoot&gt; element</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=table-footer-group">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>table-row-group</td>
    <td>Let the element behave like a &lt;tbody&gt; element</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=table-row-group">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>table-cell</td>
    <td>Let the element behave like a &lt;td&gt; element</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=table-cell">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>table-column</td>
    <td>Let the element behave like a &lt;col&gt; element</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=table-column">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>table-row</td>
    <td>Let the element behave like a &lt;tr&gt; element</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_display&preval=table-row">Play it &raquo;</a></td>
    </tr>
  <tr>
    <td>none</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>A demonstration of how to use the contents property value. In the following 
example the .a container will disappear, and making the child elements (.b) 
children of the element the next level up in the DOM:</p>
<div class="w3-code notranslate cssHigh">
    .a {<br>&nbsp;&nbsp;&nbsp; display: contents;<br>&nbsp;&nbsp;&nbsp; border: 
    2px solid red;<br>&nbsp;&nbsp;&nbsp; background-color: #ccc;<br>&nbsp;&nbsp;&nbsp; 
    padding: 10px;<br>&nbsp;&nbsp;&nbsp; width: 200px;<br>}<br><br>.b {<br>&nbsp;&nbsp;&nbsp; 
    border: 2px solid blue;<br>&nbsp;&nbsp;&nbsp; background-color: lightblue;<br>&nbsp;&nbsp;&nbsp; 
    padding: 10px;<br>}</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss_display_contents">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate cssHigh">
    body {<br>&nbsp;&nbsp;&nbsp; display: inline;<br>}<br><br>p {<br>&nbsp;&nbsp;&nbsp; display: inherit;<br>}</div>
...
order:</p>
<div class="w3-code notranslate cssHigh">
    div {<br>&nbsp;&nbsp;&nbsp; display: -webkit-flex; /* Safari */<br>&nbsp;&nbsp;&nbsp; -webkit-flex-direction: row-reverse; /* Safari 6.1+ */<br>&nbsp;&nbsp;&nbsp; display: flex;<br>&nbsp;&nbsp;&nbsp; flex-direction: row-reverse;<br>}</div>
