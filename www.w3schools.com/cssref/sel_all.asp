...
<style>
a.testback {text-decoration:none;color:#555555;font-size:14px;}
...
<a class="w3-left w3-btn" href="sel_id.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_element.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Select all elements, and set their background color to yellow:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_all" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The * selector can also select all elements inside another element (See &quot;More 
Examples&quot;).</p>
...
* {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
<a target="_blank" class="w3-btn btnsmall" href="trysel.asp?selector=*">Demo</a>
</div></div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Select all elements inside &lt;div&gt; elements and set their background 
color to yellow:</p>
<div class="w3-code notranslate cssHigh">
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_all_div" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
