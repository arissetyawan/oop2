...
<h1>CSS <span class="color_h1">grid-gap</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-column-start.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-row.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  .grid-container {<br>&nbsp; grid-gap: 50px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-gap" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-gap</code> property defines the size of 
the gap between the rows <em>and</em> columns in a grid layout, and is a shorthand property for the 
following properties:</p>
<ul>
  <li><a href="pr_grid-row-gap.asp">grid-row-gap</a></li>
  <li><a href="pr_grid-column-gap.asp">grid-column-gap</a></li>
</ul>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-gap">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridGap=&quot;50px 100px&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-gap">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-gap</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-gap: <i>grid-row-gap grid-column-gap</i>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="pr_grid-row-gap.asp"><em>grid-row-gap</em></a></td>
    <td>Sets the size of the gap between the rows in a grid layout. 0 is the 
    default value</td>
    <td>&nbsp;</td> 
  </tr>
  <tr>
    <td><a href="pr_grid-column-gap.asp"><em>grid-column-gap</em></a></td>
    <td>Sets the size of the gap between the columns in a grid layout. 0 is the 
    default value</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-gap">Play it &raquo;</a></td> 
  </tr>
  </table>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the gap between rows to 20px, and the columns to 50px:</p>
<div class="w3-code notranslate cssHigh">
  .grid-container {<br>&nbsp; grid-gap: 20px 50px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-gap2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>CSS reference: The <a href="pr_grid-row-gap.asp">grip-row-gap</a> property</p>
<p>CSS reference: The <a href="pr_grid-column-gap.asp">grip-column-gap</a> property&nbsp;</p>
<br>
