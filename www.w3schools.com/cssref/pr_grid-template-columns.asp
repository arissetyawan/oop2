...
<h1>CSS <span class="color_h1">grid-template-columns</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-template-areas.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-template-rows.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  ...
  auto auto auto auto;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-template-columns" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-template-columns</code> property specifies the number 
(and the widths) of columns in a grid 
layout.</p>
<p>The values are a space separated list, where each value specifies the size of 
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-template-columns">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridTemplateColumns=&quot;50px 50px 50px&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-template-columns">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-template-columns</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-template-columns: none|auto|max-content|min-content|<i>length</i>|initial|inherit;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>none</td>
    <td>Default value. Columns are created if needed</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template-columns">Play it &raquo;</a></td> 

  </tr>
  <tr>
    <td>auto</td>
    <td>The size of the columns is determined by the size of the 
    container and on the size of the content of the items in the column</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template-columns">Play it &raquo;</a></td> 

  </tr>
  <tr>
    <td>max-content</td>
    <td>Sets the size of each column to depend on the largest item in the column</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template-columns&preval=max-content max-content">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>min-content</td>
    <td>Sets the size of each column to depend on the largest item in the column</td>
  ...
  <tr>
    <td><i>length</i></td>
    <td>Sets the size of the columns, by using a legal length value. <a href="css_units.asp">Read about length units</a></td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-template-columns&preval=50px 100px">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Make a 4 columns grid container, and specify a size for each column:</p>
<div class="w3-code notranslate cssHigh">
  .grid-container {<br>&nbsp;&nbsp;display: grid;<br>&nbsp; grid-template-columns: 
  30px 200px auto 100px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-template-columns2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
