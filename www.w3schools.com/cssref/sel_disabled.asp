...
<h1>CSS <span class="color_h1">:disabled</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_default.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_empty.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_enabled_disabled">Try it Yourself &raquo;</a>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> :disabled</td>
    <td>4.0</td>
    <td>9.0</td>
    <td>3.5</td>
    <td>3.2</td>
...
:disabled {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
<a target="_blank" class="w3-btn btnsmall" href="trysel.asp?selector=:disabled">Demo</a>
</div></div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_enabled_disabled2">Try it Yourself &raquo;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Set a background color for all disabled &lt;option&gt; elements:</p>
<div class="w3-code notranslate cssHigh">
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_disabled_option">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS Selector Reference: <a href="sel_checked.asp">CSS :checked selector</a></p>
