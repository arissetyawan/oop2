...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-bottom-width property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-bottom_style.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-collapse.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
div {border-bottom-width: thin;}</div>
...
<p>The <code class="w3-codespan">border-bottom-width</code> property sets the width of an element's bottom border.</p>

<p><b>Note:</b> Always declare the <a href="pr_border-style.asp">border-style</a> or the 
<a href="pr_border-bottom_style.asp">border-bottom-style</a> property before the <code class="w3-codespan">border-bottom-width</code>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Allows you to define the thickness of the bottom border. <a href="css_units.asp">Read about length units</a></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the bottom border to medium:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-width: medium;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-width2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the bottom border to thick:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-width: thick;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-width3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the bottom border to 1px:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-width: 1px;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-width4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the bottom border to 15px:</p>
<div class="w3-code notranslate cssHigh">
div {border-bottom-width: 15px;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-bottom-width5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
