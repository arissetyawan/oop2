...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-right-color property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-right.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_border-right_style.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
div {border-right-color: coral;}</div>
...
<p>The <code class="w3-codespan">border-right-color</code> property sets the color of an element's right border.</p>

<p><b>Note:</b> Always declare the <a href="pr_border-style.asp">border-style</a> or the 
<a href="pr_border-right_style.asp">border-right-style</a> 
property before the <code class="w3-codespan">border-right-color</code> property. An element must have a border 
...
<table class="w3-table-all notranslate">
 ...
 <a href="css_colors_legal.asp">CSS Color Values</a> for a complete list of possible color values. Default color is black</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the right border with a HEX value:</p>
<div class="w3-code notranslate cssHigh">
div {border-right-color: #92a8d1;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-color2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the right border with an RGB value:</p>
<div class="w3-code notranslate cssHigh">
div {border-right-color: rgb(201, 76, 76);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-color3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the right border with an RGBA value:</p>
<div class="w3-code notranslate cssHigh">
div {border-right-color: rgba(201, 76, 76, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-color4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the right border with a HSL value:</p>
<div class="w3-code notranslate cssHigh">
div {border-right-color: hsl(89, 43%, 51%);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-color5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a color for the right border with a HSLA value:</p>
<div class="w3-code notranslate cssHigh">
div {border-right-color: hsla(89, 43%, 51%, 0.3);}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-color6" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set a transparent right border:</p>
<div class="w3-code notranslate cssHigh">
div {border-right-color: transparent;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-right-color7" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
