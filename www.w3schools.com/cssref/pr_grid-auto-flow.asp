...
<html lang="en-US">
<head>
<title>CSS grid-auto-flow property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">grid-auto-flow</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-auto-columns.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-auto-rows.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  ...
  column;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-auto-flow" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-auto-flow</code> property controls how auto-placed items get inserted in the grid.</p>
<p><strong>Note:</strong> Add the value &quot;dense&quot; to fill any holes in the grid.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-auto-flow">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridAutoFlow=&quot;row dense&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-auto-flow">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-auto-flow</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-auto-flow: 
  row|columns|row dense|column dense;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>row</td>
    <td>Default value. Insert auto-placed items by filling each row</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-flow">Play it &raquo;</a></td> 

  </tr>
  <tr>
    <td>column</td>
    <td>&nbsp;Insert auto-placed items by filling each column</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-flow&preval=column">Play it &raquo;</a></td> 

  </tr>
  <tr>
    <td>row dense</td>
    <td>&nbsp;Insert auto-placed items by filling each row, and fill any holes 
    in the grid</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-flow&preval=row dense">Play it &raquo;</a></td> 

  </tr>
  <tr>
    <td>column dense</td>
    <td>&nbsp;Insert auto-placed items by filling each column, and fill any 
    holes in the grid</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-auto-flow&preval=column dense">Play it &raquo;</a></td> 
...
<div class="w3-example">
<h3>Example</h3>
<p>Fill any holes in the grid by adding the &quot;dense&quot; value:</p>
<div class="w3-code notranslate cssHigh">
  .grid-container {<br>&nbsp;&nbsp;display: grid;<br>&nbsp; grid-auto-flow: row 
  dense;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-auto-flow2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
