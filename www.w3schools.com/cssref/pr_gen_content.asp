...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS Content Property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_columns.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_gen_counter-increment.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>The following example inserts the value of the href attribute in parenthesis after each 
&lt;a&gt; element:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_content" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>More "Try it Yourself" examples below.</p>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">content</code> property is used with the 
<a href="sel_before.asp">::before</a> and <a href="sel_after.asp">::after</a> pseudo-elements, to insert generated content.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_normal">Try it &raquo;</a></td>  </tr>
  <tr>
    <td>none</td>
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn" style="padding-top:0px;padding-bottom:1px" href="tryit.asp?filename=trycss_content_inherit">Try it &raquo;</a></td>
    </tr>
  </table>
</div>
<hr>
...
<div class="w3-example">
<h3>Example</h3>
<p>How to add bullet colors for &lt;ul&gt; or &lt;ol&gt; by removing their default bullets and adding an HTML entity that looks like bullets (&amp;bull;):</p>
<div class="w3-code notranslate cssHigh">
  
    ul {<br>&nbsp;&nbsp;&nbsp; list-style: none; /* Remove HTML bullets */<br>&nbsp;&nbsp;&nbsp; padding: 0;<br>&nbsp;&nbsp;&nbsp; margin: 0;<br>}<br><br>li { <br>&nbsp;&nbsp;&nbsp; padding-left: 16px; <br>}<br>
