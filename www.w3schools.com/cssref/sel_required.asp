...
<html lang="en-US">
<head>
<title>CSS :required Selector</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">:required</span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_read-write.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_root.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Select and style only if the &lt;input&gt; element has a "required" attribute:</p>
...
<a target="_blank" href="tryit.asp?filename=trycss_sel_required" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The :required selector selects form elements which are required.</p>
<p>Form elements with a required attribute are defined as required.</p>
<p><strong>Note:</strong> The :required selector only applies to the form elements: input, select and textarea.</p>
<p><strong>Tip:</strong> Use the <a href="sel_optional.asp">:optional</a> 
selector to select form elements which are optional.</p>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> :required</td>
    <td>10.0</td>
    <td>10.0</td>
    <td>4.0</td>
    <td>5.0</td>
...
:required {<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
</div></div>
<hr>

<h2>Related Pages</h2>
<p>CSS Selector <a href="sel_optional.asp">:optional</a></p>
