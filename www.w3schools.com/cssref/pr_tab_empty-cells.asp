...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS Empty-cells Property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_class_display.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_filter.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" href="tryit.asp?filename=trycss_empty-cells" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">empty-cells</code> property sets whether or not to display borders on empty cells in a table.</p>
<p><strong>Note:</strong> This property has no effect if
<a href="pr_border-collapse.asp">border-collapse</a> is &quot;collapse&quot;.</p>
