...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS animation-direction Property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">animation-direction</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_animation-delay.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_animation-duration.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">animation-direction</code> property defines whether an animation should be played 
forwards, backwards or in alternate cycles.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>normal</td>
    <td>Default value. The animation is played as normal (forwards)</td>
  ...
  <tr>
    <td>reverse</td>
    <td>The animation is played in reverse direction (backwards)</td>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-direction2">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_animation-direction3">Try it Yourself &raquo;</a>
</div>
<hr>
