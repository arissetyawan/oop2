...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS visibility property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_pos_vertical-align.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_text_white-space.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    h2.a {<br>&nbsp;&nbsp;&nbsp; visibility: visible;<br>}<br><br>h2.b {<br>&nbsp;&nbsp;&nbsp; 
...
<p>The <code class="w3-codespan">visibility</code> property specifies whether or not an element is visible.</p>
<p><b>Tip:</b> Hidden elements take up space on the page. Use the 
<a href="pr_class_display.asp">display</a> property to both hide and remove an 
element from the document layout!</p>
