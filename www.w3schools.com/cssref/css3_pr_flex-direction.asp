...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS flex-direction property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_flex-basis.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_flex-flow.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">flex-direction</code> property specifies the direction of the flexible items.</p>

<p><b>Note:</b> If the element is not a flexible item, the <code class="w3-codespan">flex-direction</code> property has no effect.</p>
