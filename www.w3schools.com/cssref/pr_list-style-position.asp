...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS list-style-position property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_list-style-image.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_list-style-type.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
(bullet points).</p>
<p> <code class="w3-codespan">list-style-position: outside;</code> means that the bullet points will be outside 
the list item. The start of each line of a list item will be aligned vertically:</p>
...
<p> <code class="w3-codespan">list-style-position: inside;</code> means that the bullet points will be inside 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>inside</td>
    <td>The bullet points will be inside the list item</td>
  ...
  <tr>
    <td>outside</td>
    <td>The bullet points will be outside the list item. This is default</td>
