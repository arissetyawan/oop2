...
<html lang="en-US">
<head>
<title>CSS element1~element2 Selector</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1"><i>element1</i>~<i>element2</i></span> Selector</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="sel_element_pluss.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
...
<a class="w3-right w3-btn" href="sel_attribute.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_gen_sibling">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left; width: 20%;"> <i>element1</i>~<i>element2</i></td>
    <td>4.0</td>
    <td>7.0</td>
    <td>3.5</td>
    <td>3.2</td>
...
<em>element</em> ~ <em>element </em>{<br><em>&nbsp;&nbsp;&nbsp; css declarations</em>;<br>}
<a target="_blank" class="w3-btn btnsmall" href="trysel.asp?selector=ul ~ table">Demo</a>
</div></div>
<br>
