...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS align-self property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_align-items.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_all.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">align-self</code> property specifies the alignment for the selected item inside the flexible container.</p>
<p><b>Note:</b> The <code class="w3-codespan">align-self</code> property overrides the flexible container's 
<a href="css3_pr_align-items.asp">align-items</a> property.</p>
...
<table class="w3-table-all notranslate">
  ...
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_align-self&preval=center">Play it &raquo;</a></td>          
    ...
    <tr>
    <td>flex-start</td>
    <td>The element is positioned at the beginning of the container</td>
