...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS transform-origin property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">transform-origin </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_transform.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_transform-style.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">transform-origin</code> property allows you to change the position of transformed elements.</p>
...
<p>To better understand the <code class="w3-codespan">transform-origin</code> property,
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>x-axis</i></td>
    <td>Defines where the view is placed at the x-axis. Possible values:<ul>
    <li>left</li>
    <li>center</li>
    <li>right</li>
    <li><i>length</i></li>
  ...
  <tr>
    <td><i>y-axis</i></td>
    <td>Defines where the view is placed at the y-axis. Possible values:<ul>
    <li>top</li>
    <li>center</li>
    <li>bottom</li>
    <li><i>length</i></li>
  ...
  <tr>
    <td><i>z-axis</i></td>
    <td>Defines where the view is placed at the z-axis (for 3D transformations). Possible values:<ul>
    <li><i>length</i></li>
 </ul>
  </td>
  </tr>
