...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-image-slice property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">border-image-slice</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_border-image-repeat.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_border-image-source.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<p>The <code class="w3-codespan">border-image-slice</code> property specifies how to slice the image specified by
...
<p><b>Note:</b> The <code class="w3-codespan">border-image-slice</code> property can take from one to four values. If the fourth 
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td> <i>number</i></td>
    <td>The number(s) represent pixels for raster images or coordinates for vector images</td>
