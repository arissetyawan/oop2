...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS font-kerning property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">font-kerning</span> Property</h1>
<div class="w3-clear w3-center nextprev">
  <a class="w3-left w3-btn" href="pr_font_font-family.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="pr_font_font-size.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    div { <br>&nbsp;&nbsp;&nbsp; font-kerning: normal;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_font-kerning">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">font-kerning</code> property controls the usage of the kerning information 
stored in a font.</p>
<p><strong>Tip:</strong> Kerning defines how letters are spaced.</p>
<p><strong>Note:</strong> For fonts that do not include kerning data, this 
property will have no visible effect.</p>
...
<table class="w3-table-all">
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.fontKerning=&quot;normal&quot;    
</td>
  </tr>
 </table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">font-kerning</td>
    <td>32.0&nbsp;-webkit-</td>
    <td>10.0</td>
    <td>34.0</td>
    <td>7.0</td>
...
<div class="w3-code w3-border notranslate"><div>
  font-kerning: auto|normal|none;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td> auto</td>
    <td>Default. The browser determines whether font kerning should be applied or 
    not</td>
  </tr>
  <tr>
    <td> normal</td>
    <td>Specifies that font kerning is applied</td>
  </tr>
  <tr>
    <td> none</td>
    <td>Specifies that font kerning is not applied</td>
  </tr>
  </table>
</div>
