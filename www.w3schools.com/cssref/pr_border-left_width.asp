...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-left-width property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-left_style.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_border-radius.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
div {border-left-width: thin;}</div>
...
<p>The <code class="w3-codespan">border-left-width</code> property sets the width of an element's left border.</p>

<p><b>Note:</b> Always declare the <a href="pr_border-style.asp">border-style</a> or the 
<a href="pr_border-left_style.asp">border-left-style</a> property before the <code class="w3-codespan">border-left-width</code>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Allows you to define the thickness of the left border. <a href="css_units.asp">Read about length units</a></td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the left border to medium:</p>
<div class="w3-code notranslate cssHigh">
div {border-left-width: medium;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-width2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the left border to thick:</p>
<div class="w3-code notranslate cssHigh">
div {border-left-width: thick;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-width3" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the left border to 1px:</p>
<div class="w3-code notranslate cssHigh">
div {border-left-width: 1px;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-width4" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example</h3>
<p>Set the width of the left border to 15px:</p>
<div class="w3-code notranslate cssHigh">
div {border-left-width: 15px;}</div>
<a target="_blank" href="tryit.asp?filename=trycss_border-left-width5" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
