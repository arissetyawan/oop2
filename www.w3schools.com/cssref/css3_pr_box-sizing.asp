...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS box-sizing property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">box-sizing</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="css3_pr_box-shadow.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="pr_tab_caption-side.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Include padding and border in 
the 
...
<p>The <code class="w3-codespan">box-sizing</code> property defines how the width and height of an element are 
calculated: should they include padding and borders, or not.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td> content-box</td>
    <td>Default. The width and height properties (and min/max properties) includes only the content. Border 
    and padding are not included</td>
  </tr>
  <tr>
    <td> border-box</td>
    <td>The width and height properties (and min/max properties) includes 
    content, padding and border</td>
  </tr>
  <tr>
    <td>initial</td>
...
<div class="w3-code notranslate cssHigh">
 ...
 &nbsp;&nbsp;&nbsp;
 width: 50%;<br>&nbsp;&nbsp;&nbsp; border: 5px solid red;<br>&nbsp;&nbsp;&nbsp;
 float: left;<br>
 }
</div>
...
<div class="w3-example">
<h3>Example</h3>
<p>Set the &quot;universal box-sizing&quot;:</p>
<div class="w3-code notranslate cssHigh">
    * {<br>&nbsp;&nbsp;&nbsp; box-sizing: border-box;<br>}
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycss3_box-sizing3">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Related Pages</h2>
<p>CSS tutorial: <a href="/css/css3_box-sizing.asp">CSS Box Sizing</a></p>
