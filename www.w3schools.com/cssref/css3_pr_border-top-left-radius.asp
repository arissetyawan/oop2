...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS border-top-left-radius property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">border-top-left-radius</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_border-top_color.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_border-top-right-radius.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    border-top-left-radius: 25px;<br>}<br><br>#example2 {<br>&nbsp;&nbsp;&nbsp; 
    border: 2px solid red;<br>&nbsp;&nbsp;&nbsp; border-top-left-radius: 50px 
    20px;<br>}
</div>
...
<p>The <code class="w3-codespan">border-top-left-radius</code> property defines the radius of the top-left corner.</p>
...
<p><b>Note:</b> If you set two values, the first one is for the top border, and the second one for
the left border. If the second value is omitted, it is copied from the first. If either length is zero,
the corner is square, not rounded.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><i>length</i></td>
    <td>Defines the shape of the top-left corner. <a href="css_units.asp">Read about length units</a></td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_border-top-left-radius">Play it &raquo;</a></td>
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Defines the shape of the top-left corner in %</td>
...
<div class="w3-example">
<h3>Example</h3>
<p>Add rounded borders to the top-left corner in percent:</p>
<div class="w3-code notranslate cssHigh">
  #example1 {<br>&nbsp;&nbsp;&nbsp; border: 2px solid red;<br>&nbsp;&nbsp;&nbsp; 
  background: url(paper.gif);<br>&nbsp;&nbsp;&nbsp; padding: 10px;<br>&nbsp;&nbsp;&nbsp; 
  border-top-left-radius: 40%;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_border-top-left-radius2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
