...
<html lang="en-US">
<head>
<title>CSS grid-column-start property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">grid-column-start</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-column-gap.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-gap.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  .item1 {<br>&nbsp; grid-column-start: 2;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-column-start" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-column-start</code> property defines on which column-line the item will start.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-column-start">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridColumnStart=&quot;3&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-column-start">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-column-start</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-column-start: auto|<i>column-line</i>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Default value. The item will be placed following the flow.</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-column-start">Play it &raquo;</a></td> 
  </tr>
  <tr>
    <td><i>column-line</i></td>
    <td>Specifies on which column to <br>start the display of the item.</td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-column-start&preval=3">Play it &raquo;</a></td> 
  </tr>
  </table>
</div>
<hr>
...
<p>CSS reference: The <a href="pr_grid-column.asp">grid-column</a> Property</p>
<p>CSS reference: The <a href="pr_grid-column-end.asp">grid-column-end</a> Property</p>
<p>CSS reference: The <a href="pr_grid-row-start.asp">grid-row-start</a> Property</p>
<p>CSS reference: The <a href="pr_grid-row-end.asp">grid-row-end</a> Property</p>
<br>
