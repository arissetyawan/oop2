...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS bottom Property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="pr_border-width.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
  <a class="w3-right w3-btn" href="css3_pr_box-decoration-break.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>

<div class="w3-example">
<h3>Example</h3>
<p>Set the bottom edge of the &lt;div&gt; element to 10px above the 
bottom edge of its nearest parent element with some positioning:</p>
...
<p>The <code class="w3-codespan">bottom</code> property affects the vertical position of a positioned element. 
This property has no effect on non-positioned elements.</p>
<ul>
  <li>If position: absolute; or position: fixed; - the <code class="w3-codespan">bottom</code> property 
  sets the bottom edge of an element to a unit above/below the bottom edge of 
  its nearest positioned ancestor.</li>
  <li>If position: relative; - the <code class="w3-codespan">bottom</code> property makes the element's bottom 
  edge to move above/below its normal position.</li>
  <li>If position: sticky; - the <code class="w3-codespan">bottom</code> property behaves like its position is 
  relative when the element is inside the viewport, and like its position is 
  fixed when it is outside.</li>
  <li>If position: static; - the <code class="w3-codespan">bottom</code> property has no effect.</li>
</ul>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>auto</td>
    <td>Lets the browser calculate the bottom edge position. This is default</td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_bottom">Play it &raquo;</a></td>                    
  </tr>
  <tr>
    <td><i>length</i></td>
    <td>Sets the bottom edge position in px, cm, etc. Negative values are allowed. <a href="css_units.asp">Read about length units</a>
    </td>
  <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_bottom&preval=50px">Play it &raquo;</a></td>                    
  </tr>
  <tr>
    <td><i>%</i></td>
    <td>Sets the bottom edge position in % of containing element. Negative values are allowed </td>
