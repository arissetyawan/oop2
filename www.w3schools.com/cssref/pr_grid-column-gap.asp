...
<html lang="en-US">
<head>
<title>CSS grid-column-gap property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">grid-column-gap</span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_grid-column-end.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_grid-column-start.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
  .grid-container {<br>&nbsp; grid-column-gap: 50px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss_grid-column-gap" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The <code class="w3-codespan">grid-column-gap</code> property defines the size of the gap between the columns in a grid layout.</p>
...
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_anim_grid-column-gap">Try it</a>
</td>
  </tr>
  <tr>
    <th>Version:</th>
  ...
  <tr>
    ...
    <td>  <i>object</i>.style.gridColumnGap=&quot;50px&quot;
<a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trycss_js_grid-column-gap">Try it</a>
</td>
  </tr>
</table>
</div>
...
<table class="browserref notranslate">
  ...
  <tr>
    <td style="text-align:left;">grid-column-gap</td>
    <td>57</td>
    <td>16</td>
    <td>52</td>
    <td>10</td>
...
<div class="w3-code w3-border notranslate"><div>
  grid-column-gap: <i>length</i>;</div></div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><em>length</em></td>
    <td>Any legal length value, like px or %. 0 is the default value. <a href="css_units.asp">Read about length units</a></td>
    <td><a target="_blank" class="w3-btn btnplayit" href="playit.asp?filename=playcss_grid-column-gap">Play it &raquo;</a></td> 
  </tr>
  </table>
</div>
<hr>
...
<p>CSS reference: The <a href="pr_grid-gap.asp">grip-gap</a> property</p>
