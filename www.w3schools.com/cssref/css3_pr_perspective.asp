...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS perspective property</title>
<meta charset="utf-8">
...
<h1>CSS <span class="color_h1">perspective </span> Property</h1>
<div class="w3-clear w3-center nextprev">
<a class="w3-left w3-btn" href="pr_print_pagebi.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="css3_pr_perspective-origin.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
 ...
 {<br>
 &nbsp;&nbsp;&nbsp;
 -webkit-perspective: 100px; /* Safari 4-8 */<br>
 &nbsp;&nbsp;&nbsp;
...
<p>The <code class="w3-codespan">perspective</code> property is used to give a 3D-positioned element some 
perspective.</p>
<p>The <code class="w3-codespan">perspective</code> property defines how far the object is away from the user. 
So, a lower value will result in a more intensive 3D effect than a higher value.</p>
<p>When defining the <code class="w3-codespan">perspective</code> property for an element, it is the CHILD elements 
that get the perspective view, NOT the element itself.</p>
<p><b>Tip:</b> Also look at the <a href="css3_pr_perspective-origin.asp">perspective-origin</a> property, 
which defines at which position the user is looking at the 3D object.</p>
...
<div class="w3-example">
<h3>Example</h3>
<p>Create a cube and set different perspectives:</p>
<div class="w3-code notranslate cssHigh">
  .ex1 {<br>&nbsp;&nbsp;&nbsp; perspective: 800px;<br>}<br><br>.ex2 {<br>&nbsp;&nbsp;&nbsp; 
  perspective: 150px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trycss3_perspective2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
