...
<!DOCTYPE html>
<html lang="en-US">
<head><title>CSS outline Property</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="css3_pr_order.asp">&#10094;<span class="w3-hide-small"> Previous</span></a>
<a class="w3-btn" href="default.asp"><span class="w3-hide-small">Complete CSS </span>Reference</a>
<a class="w3-right w3-btn" href="pr_outline-color.asp"><span class="w3-hide-small">Next </span>&#10095;</a>
</div>
<br>
...
<div class="w3-code notranslate cssHigh">
    ...
    h2 {<br>&nbsp;&nbsp;&nbsp; outline: 5px dotted green;<br>}<br><br>div.a {<br>&nbsp;&nbsp;&nbsp; 
    outline: 2px dashed blue;<br>}
...
<p>The <code class="w3-codespan">outline</code> property is a shorthand property for:</p>
<ul>
<li><a href="pr_outline-width.asp">outline-width</a></li>
<li><a href="pr_outline-style.asp">outline-style</a> (required)</li>
<li><a href="pr_outline-color.asp">outline-color</a></li>
</ul>
<p>If outline-color is omitted, the color applied will be the color of the text.</p>
<p><strong>Note:</strong> The outline is not a part of the element's dimensions, therefore the element's width and height properties do not contain the width of the outline.</p>

<div class="w3-responsive">
<table class="w3-table-all">
  <tr>
    <th style="width:25%">Default value:</th>
    <td>medium invert <em>color</em></td>
  </tr>
  <tr>
    <th>Inherited:</th>
    <td>no</td>
...
outline: <i>outline-width</i> <i>outline-style</i> <i>outline-color</i>|initial|inherit;</div></div>
