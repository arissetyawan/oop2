...
<a class="w3-left w3-btn" href="asp_globalasa.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="asp_send_email.asp">Next &#10095;</a>
</div>
...
<p><img class="w3-image" alt="AJAX" src="ajax.gif"></p>
<hr>
...
<div class="w3-panel w3-note">
  <p>AJAX applications are browser- and platform-independent!</p>
</div>
<hr>
...
<p><a target="_blank" href="https://www.google.com/">Google Suggest</a> 
...
<p>If you want to learn more about AJAX, visit our <a href="/xml/ajax_intro.asp">AJAX tutorial</a>.</p>
...
<div class="w3-code notranslate">
    &lt;html&gt;<br>&lt;head&gt;<br>&lt;script&gt;<br>function showHint(str) {<br>&nbsp;&nbsp;&nbsp; 
    if (str.length == 0) { <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    document.getElementById(&quot;txtHint&quot;).innerHTML = &quot;&quot;;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    return;<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; var xmlhttp = new 
    XMLHttpRequest();<br>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; xmlhttp.onreadystatechange = function() 
    {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (this.readyState == 4 &amp;&amp; 
    this.status == 200) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.getElementById(&quot;txtHint&quot;).innerHTML = 
    this.responseText;<br>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; };<br>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; xmlhttp.open(&quot;GET&quot;, &quot;gethint.asp?q=&quot; + str, true);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xmlhttp.send();<br>&nbsp;&nbsp;&nbsp; 
    }<br>}<br>&lt;/script&gt;<br>&lt;/head&gt;<br>&lt;body&gt;<br><br>&lt;p&gt;&lt;b&gt;Start typing a name in the 
    input field below:&lt;/b&gt;&lt;/p&gt;<br>&lt;form&gt; <br>First name: &lt;input type=&quot;text&quot; 
    onkeyup=&quot;showHint(this.value)&quot;&gt;<br>&lt;/form&gt;<br>&lt;p&gt;Suggestions: &lt;span id=&quot;txtHint&quot;&gt;&lt;/span&gt;&lt;/p&gt;<br>
    &lt;/body&gt;<br>&lt;/html&gt;</div>
<a target="_blank" href="/xml/tryit.asp?filename=tryajax_suggest_asp" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<br>
<div id="txtCust">Customer info will be listed here...</div>
</div>
<p>
<a target="_blank" href="/xml/tryit.asp?filename=tryajax_database" class="w3-btn">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
&nbsp;&nbsp;&nbsp; {<br>
&nbsp;&nbsp;&nbsp; document.getElementById(&quot;txtHint&quot;).innerHTML=this.responseText;<br>
&nbsp;&nbsp;&nbsp; }<br>
&nbsp; }<br>
