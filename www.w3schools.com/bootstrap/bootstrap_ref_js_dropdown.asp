...
<html lang="en-US">
<head>
<title>Bootstrap JS Dropdown Reference</title>
...
<h1>Bootstrap <span class="color_h1">JS Dropdown</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_js_collapse.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_js_modal.asp">Next &#10095;</a>
</div>
<hr>

<h2>JS Dropdown (dropdown.js)</h2>
<p>A dropdown menu is a toggleable menu that allows the user to choose one value from a predefined list.</p>
<p>For a tutorial about Dropdowns, read our <a href="bootstrap_dropdowns.asp">Bootstrap Dropdowns Tutorial</a>.</p>
<hr>

<h2>The Dropdown Plugin Classes</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.dropdown</td>
    <td>Indicates a dropdown menu</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_dropdown-menu&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.dropdown-menu</td>
    <td>Builds the dropdown menu</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_dropdown-menu&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.dropdown-menu-right</td>
    <td>Right-aligns a dropdown menu</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_dropdown-menu-right&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.dropdown-header</td>
    <td>Adds a header inside the dropdown menu</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_dropdown-header&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.dropup</td>
    <td>Indicates a dropup menu</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_dropup&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.disabled</td>
    <td>Disables an item in the dropdown menu</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_dropdown_disabled&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.divider</td>
    <td>Separates items inside the dropdown menu with a horizontal line</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_dropdown_divider&stacked=h">Try it</a></td>
  </tr>
</table>
<hr>

<h2>Via data-* Attributes</h2>
<p>Add <code class="w3-codespan">data-toggle="dropdown"</code> to a link or a button to toggle a dropdown menu.</p>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_dropdown&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_dropdown_js&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<p>The following table lists all available dropdown methods.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_dropdown_toggle&stacked=h">Try it</a></td>
  </tr>
</table>
</div>

<h2>Dropdown Events</h2>
<p>The following table lists all available dropdown events.</p>
<div class="table-responsive">
<table class="w3-table-all notranslate">
  <tr>
    <th>Event</th>
  ...
  <tr>
    ...
    <td>Occurs when the dropdown is about to be shown.</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_dropdown_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>shown.bs.dropdown</td>
    <td>Occurs when the dropdown is fully shown (after CSS transitions have completed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_dropdown_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>hide.bs.dropdown</td>
    <td>Occurs when the dropdown is about to be hidden</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_dropdown_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>hidden.bs.dropdown</td>
    <td>Occurs when the dropdown is fully hidden (after CSS transitions have completed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_dropdown_events&stacked=h">Try it</a></td>
    </tr>
</table>
<p><strong>Tip:</strong> Use jQuery's <a href="/jquery/event_relatedtarget.asp">event.relatedTarget</a> 
to get the element which triggered the dropdown:</p>

<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 $(&quot;.dropdown&quot;).on(&quot;show.bs.dropdown&quot;, function(event){<br>&nbsp;&nbsp;&nbsp; var x = $(event.relatedTarget).text(); // Get the text of the element<br>&nbsp;&nbsp;&nbsp; alert(x);<br>});</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_dropdown_events2&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>More Examples</h2>
<h3>Change the caret icon to upside down</h3>
<p>The following example changes the caret icon from pointing downwards to 
upwards when clicking on the dropdown:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 /* CSS: */<br>&lt;style&gt;<br>.caret.caret-up {<br>&nbsp;&nbsp;&nbsp; border-top-width: 0;<br>&nbsp;&nbsp;&nbsp; border-bottom: 4px solid #fff;<br>
 }<br>&lt;/style&gt;<br><br>/* JS: */<br>&lt;script&gt;<br>$(document).ready(function(){<br>&nbsp; $(".dropdown").on("hide.bs.dropdown", function(){<br>&nbsp;&nbsp;&nbsp; $(".btn").html('Dropdown &lt;span class="caret"&gt;&lt;/span&gt;');<br>&nbsp; });<br>&nbsp; $(".dropdown").on("show.bs.dropdown", function(){<br>&nbsp;&nbsp;&nbsp; $(".btn").html('Dropdown &lt;span class="caret caret-up"&gt;&lt;/span&gt;');<br>&nbsp; });<br>});<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_dropdown_icon&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;nav class=&quot;navbar navbar-inverse&quot;&gt;<br>&nbsp; &lt;div class=&quot;container-fluid&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;navbar-header&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;a class=&quot;navbar-brand&quot; href=&quot;#&quot;&gt;WebSiteName&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;ul class=&quot;nav navbar-nav&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;li class=&quot;active&quot;&gt;&lt;a href=&quot;#&quot;&gt;Home&lt;/a&gt;&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;li class=&quot;dropdown&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;a class=&quot;dropdown-toggle&quot; data-toggle=&quot;dropdown&quot; href=&quot;#&quot;&gt;Page 1<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;span class=&quot;caret&quot;&gt;&lt;/span&gt;&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;ul class=&quot;dropdown-menu&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Page 1-1&lt;/a&gt;&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Page 1-2&lt;/a&gt;&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Page 1-3&lt;/a&gt;&lt;/li&gt; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/ul&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/li&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Page 2&lt;/a&gt;&lt;/li&gt; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;li&gt;&lt;a href=&quot;#&quot;&gt;Page 3&lt;/a&gt;&lt;/li&gt; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/ul&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/nav&gt;</div>
...
<p>The following example adds a dropdown menu with a login form in the navbar:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;ul class=&quot;nav navbar-nav navbar-right&quot;&gt;<br>&nbsp; &lt;li class=&quot;dropdown&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;a class=&quot;dropdown-toggle&quot; data-toggle=&quot;dropdown&quot; href=&quot;#&quot;&gt;Login &lt;span class=&quot;glyphicon glyphicon-log-in&quot;&gt;&lt;/span&gt;&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;dropdown-menu&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;form id=&quot;formlogin&quot; class=&quot;form container-fluid&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class=&quot;form-group&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;label for=&quot;usr&quot;&gt;Name:&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input type=&quot;text&quot; class=&quot;form-control&quot; id=&quot;usr&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class=&quot;form-group&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;label for=&quot;pwd&quot;&gt;Password:&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input type=&quot;password&quot; class=&quot;form-control&quot; id=&quot;pwd&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;button type=&quot;button&quot; id=&quot;btnLogin&quot; class=&quot;btn btn-block&quot;&gt;Login&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/form&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class=&quot;container-fluid&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;a class=&quot;small&quot; href=&quot;#&quot;&gt;Forgot password?&lt;/a&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt; <br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/li&gt;<br>&lt;/ul&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_dropdown_login&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Multi-Level Dropdowns</h3>
<p>In this example, we use jQuery to open multi-level dropdowns on click:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 &lt;script&gt;<br>
 $(document).ready(function(){<br>&nbsp; $('.dropdown-submenu a.test').on(&quot;click&quot;, function(e){<br>&nbsp;&nbsp;&nbsp; $(this).next('ul').toggle();<br>&nbsp;&nbsp;&nbsp; e.stopPropagation();<br>&nbsp;&nbsp;&nbsp; e.preventDefault();<br>&nbsp; });<br>
 });<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_dropdown_multilevel&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p>In this example, we have created a custom <code class="w3-codespan">.dropdown-submenu</code> class for multi-level dropdowns:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 &nbsp;/* CSS: */<br>&lt;style&gt;<br>.dropdown-submenu {<br>&nbsp;&nbsp;&nbsp; position: relative;<br>}<br><br>.dropdown-submenu .dropdown-menu {<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; left: 100%;<br>&nbsp;&nbsp;&nbsp; margin-top: -1px;<br>}<br>&lt;/style&gt;<br><br>/* JS: */<br>&lt;script&gt;<br>
 $(document).ready(function(){<br>&nbsp; $('.dropdown-submenu a.test').on(&quot;click&quot;, function(e){<br>&nbsp;&nbsp;&nbsp; $(this).next('ul').toggle();<br>&nbsp;&nbsp;&nbsp; e.stopPropagation();<br>&nbsp;&nbsp;&nbsp; e.preventDefault();<br>&nbsp; });<br>
 });<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_dropdown_multilevel_css&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
</div>
