...
<h1>Bootstrap <span class="color_h1">Navigation Components</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_comp_dropdowns.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_comp_glyphs.asp">Next &#10095;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.nav nav-tabs</td>
    <td>Creates navigation tabs</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_nav-tabs&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.nav nav-pills</td>
    <td>Creates navigation pills</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_nav-pills&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.nav nav-pills nav-stacked</td>
    <td>Creates vertical navigation pills</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_nav-stacked&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.nav-justified</td>
    <td>Makes navigation tabs/pills equal widths of their parent, at screens wider than 768px. On smaller screens, the nav tabs/pills are stacked</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_nav-justified&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.disabled</td>
    <td>Indicates a disabled (unclickable) tab/pill</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_nav_disabled&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td colspan="2">Navigation tabs with dropdown menu</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_nav-tabs_dropdown&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td colspan="2">Navigation pills with dropdown menu</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_nav-pills_dropdown&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.tab-content</td>
    <td>Together with .tab-pane and data-toggle="tab" (data-toggle="pill" for pills), it makes the tab/pill toggleable</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_nav-toggle&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.tab-pane</td>
    <td>Together with .tab-content and data-toggle="tab" (data-toggle="pill" for pills), it makes the tab/pill toggleable</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_nav-toggle&stacked=h">Try it</a></td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_navbar&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.navbar-brand</td>
    ...
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_navbar_btn&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_navbar_collapse&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.navbar-default</td>
    ...
    <tr>
      <td>.navbar-fixed-bottom</td>
      <td>Makes the navbar stay at the bottom of the screen (sticky/fixed)</td>
      <td>
        <a href="tryit.asp?filename=trybs_navbar_fixed_bottom&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_navbar_fixed&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.navbar-form</td>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_navbar_form&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.navbar-header</td>
    ...
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_navbar_inverse&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.navbar-left</td>
    ...
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_navbar_link&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.navbar-nav</td>
      <td>Used on a &lt;ul&gt; container that contains the list items with links inside a navigation bar</td>
      <td>
        <a href="tryit.asp?filename=trybs_navbar&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_navbar_right&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.navbar-static-top</td>
    ...
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_navbar_text&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.navbar-toggle</td>
...
<h2>Breadcrumbs and Pagination</h2>
<table class="w3-table-all notranslate">
  <tr>
    <th style="width:28%;">Class</th>
  ...
  <tr>
    <td>.breadcrumb</td>
    <td>Makes a breadcrumb</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_breadcrumb&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.pager</td>
    <td>Provides simple pagination links (Previous/Next)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_pager&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.previous</td>
    <td>Aligns the .pager previous button to the left</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_pager_prev&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.next</td>
    <td>Aligns the .pager next button to the right</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_pager_prev&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.disabled</td>
    <td>Indicates an unclickable link</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_pager_disabled&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.pagination</td>
    <td>Provides pagination links</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_pagination&stacked=h">Try it</a></td>
  </tr>
  <tr>
 
    <td>.pagination-lg</td>
    <td>Used together with the .pagination class to provide larger pagination links</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_pagination-lg&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.pagination-sm</td>
    <td>Used together with the .pagination class to provide smaller pagination links</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_pagination-lg&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.disabled</td>
    <td>Indicates an unclickable link</td>
    <td>
 <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_pg_disabled&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.active</td>
    <td>Indicates the current page</td>
    <td>
 <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_pg_disabled&stacked=h">Try it</a></td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Indicates a default grey label</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_label-default&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.label label-primary</td>
    <td>Indicates a blue label of type &quot;primary&quot;</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_label-primary&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.label label-success</td>
    <td>Indicates a green label of type &quot;success&quot;</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_label-success&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.label label-info</td>
    <td>Indicates a light blue label of type &quot;info&quot;</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_label-info&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.label label-warning</td>
    <td>Indicates a yellow label of type &quot;warning&quot;</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_label-warning&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.label label-danger</td>
    <td>Indicates a red label of type &quot;danger&quot;</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_label-danger&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.badge</td>
    <td>Indicates new or unread items</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_badge&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.jumbotron</td>
    <td>Indicates a big box for calling extra attention to featured content or information</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_jumbotron&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.jumbotron (extra)</td>
    <td>To let the .jumbotron box span the full width, and without rounded corners, place it outside the .container class</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_comp_jumbotron2&stacked=h">Try it</a></td>
  </tr>
</table>
