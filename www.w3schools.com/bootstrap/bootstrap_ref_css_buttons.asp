...
<html lang="en-US">
<head>
<title>Bootstrap CSS Buttons Reference</title>
...
<h1>Bootstrap <span class="color_h1">CSS Buttons Reference</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_css_text.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_css_forms.asp">Next &#10095;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_button_group&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.btn-group-justified</td>
      <td>Makes a group of buttons span the entire width of the screen</td>
      <td>
        <a href="tryit.asp?filename=trybs_button_group_justified&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.btn-group-lg</td>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_button_group_size&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.btn-group-sm</td>
    ...
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_button_group_v&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
</table>
