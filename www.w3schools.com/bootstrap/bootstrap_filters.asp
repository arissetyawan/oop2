...
<h1>Bootstrap <span class="color_h1">Filters (Advanced)</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_affix.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_grid_system.asp">Next &#10095;</a>
</div>
<hr>
<h2>Bootstrap Filters</h2>
<p>Bootstrap does not have a component that allows filtering. However, we can use <a href="/jquery/default.asp">jQuery</a> to filter / search for elements.</p>
<hr>
<h2>Filter Tables</h2>
<p>Perform a case-insensitive search for items in a table:</p>
...
<div class="w3-code notranslate htmlHigh">
  &lt;script&gt;<br>$(document).ready(function(){<br>&nbsp; $(&quot;#myInput&quot;).on(&quot;keyup&quot;, function() {<br>&nbsp;&nbsp;&nbsp; var 
  value = $(this).val().toLowerCase();<br>&nbsp;&nbsp;&nbsp; $(&quot;#myTable tr&quot;).filter(function() {<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $(this).toggle($(this).text().toLowerCase().indexOf(value) &gt; -1)<br>&nbsp;&nbsp;&nbsp; });<br>
  &nbsp;
  });<br>});<br>&lt;/script&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_filters_table&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><strong>Example explained:</strong> We use jQuery to loop through each table 
rows to check if there are any text values that matches the value of the input 
field. The <code class="w3-codespan">toggle</code> method hides the row (<code class="w3-codespan">display:none</code>) that does not match the 
search. We use the <code class="w3-codespan">toLowerCase()</code> method to convert the text to lower case, which 
makes the search case insensitive (allows &quot;john&quot;, &quot;John&quot;, and even &quot;JOHN&quot; on 
search).</p>
<hr>

<h2>Filter Lists</h2>
<p>Perform a case-insensitive search for items in a list:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-padding w3-white notranslate" style="width:100%">
<div style="width:100%">
  <p style="margin-top:14px">Type something in the input field to search the list for items:</p>  
  <input class="form-control" id="myInputList" type="text" placeholder="Search..">
  <br>
...
<a target="_blank" href="tryit.asp?filename=trybs_filters_list&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Filter Dropdowns</h2>
<p>Perform a case-insensitive search for items in a dropdown menu:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-padding w3-white notranslate" style="width:100%">
<div style="width:100%">
  <p style="margin-top:14px">Open the dropdown menu and type something in the input field to search for dropdown items:</p>  
  <div class="dropdown" style="margin-bottom:14px">
    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Dropdown Example
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <input class="form-control" id="myInputDrop" type="text" placeholder="Search..">
      <li><a href="#">HTML</a></li>
      <li><a href="#">CSS</a></li>
...
<a target="_blank" href="tryit.asp?filename=trybs_filters_dropdown&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Filter Anything</h2>
<p>Perform a case-insensitive search for text inside a div element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-padding w3-white notranslate" style="width:100%">
<div style="width:100%">
  <p style="margin-top:14px"></p>  
  <input class="form-control" id="myInputDiv" type="text" placeholder="Search..">
  <br>
  <div id="myDIV" style="margin-bottom:14px;">
    <p>I am a paragraph.</p>
    <div>I am a div element inside div.</div>
    <button class="btn" style="margin:8px 4px 8px 0">I am a button</button><button class="btn btn-info" style="margin:8px 0">Another button</button>
...
<a target="_blank" href="tryit.asp?filename=trybs_filters_anything&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
