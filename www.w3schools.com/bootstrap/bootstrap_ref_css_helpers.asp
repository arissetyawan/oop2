...
<html lang="en-US">
<head>
<title>Bootstrap CSS Helper Classes Reference</title>
...
<h1>Bootstrap <span class="color_h1">CSS Helper Classes Reference</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_css_forms.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_css_images.asp">Next &#10095;</a>
</div>
<hr>

<h2>Text</h2>
<p>Add meaning through text-colors with the classes below. Links will darken on hover:</p>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.text-muted</td>
    <td><span class="text-muted">Text styled with class "text-muted"</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_text-muted&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.text-primary</td>
    <td><span class="text-primary">Text styled with class "text-primary"</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_text-primary&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.text-success</td>
    <td><span class="text-success">Text styled with class "text-success"</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_text-success&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.text-info</td>
    <td><span class="text-info">Text styled with class "text-info"</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_text-info&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.text-warning</td>
    <td><span class="text-warning">Text styled with class "text-warning"</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_text-warning&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.text-danger</td>
    <td><span class="text-danger">Text styled with class "text-danger"</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_text-danger&stacked=h">Try it</a></td>
  </tr>
</table>

<h2>Background</h2>
<p>Add meaning through background-colors with the classes below. Links will darken on hover just like text classes:</p>
<table class="w3-table-all notranslate">
  <tr>
    <th style="width:20%;">Class</th>
    <th style="width:72%;">Description</th>
  ...
  <tr>
    <td>.bg-primary</td>
    <td class="bg-primary">Table cell is styled with class "bg-primary"</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_bg-primary&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.bg-success</td>
    <td class="bg-success">Table cell is styled with class "bg-success"</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_bg-success&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.bg-info</td>
    <td class="bg-info">Table cell is styled with class "bg-info"</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_bg-info&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.bg-warning</td>
    <td class="bg-warning">Table cell is styled with class "bg-warning"</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_bg-warning&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.bg-danger</td>
    <td class="bg-danger">Table cell is styled with class "bg-danger"</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_bg-danger&stacked=h">Try it</a></td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_pull-left&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.pull-right</td>
  ...
  <tr>
    <td>.center-block</td>
    <td>Sets an element to display:block with margin-right:auto and margin-left:auto</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_center-block&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.clearfix</td>
    <td>Clears floats</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_grid_ex7&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.show</td>
    <td>Forces an element to be shown (display:block)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_hidden&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.hidden</td>
    <td>Forces an element to be hidden (display:none)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_hidden&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.invisible</td>
    <td>Forces an element to be invisible (visibility:hidden). Will take up space on page even though it is invisible</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_hidden&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.sr-only</td>
    <td>Hides an element to all devices except screen readers</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_sr-only&stacked=h">Try it</a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_text-hide&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.close</td>
    <td>Indicates a close icon</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_close&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.caret</td>
    <td>Indicates dropdown functionality (will reverse automatically in dropup menus)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_hlp_caret&stacked=h">Try it</a></td>
  </tr>
</table>
<hr>
...
<p>These classes are used to show and/or hide content by device via media queries.</p>
<p>Use one or a combination of the available classes for toggling content across viewport breakpoints:</p>
<div class="table-responsive">
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <tr>
          <th scope="row" class="auto-style1">.visible-xs-*</th>
          <td class="shown">Visible</td>
          <td>Hidden</td>
          <td>Hidden</td>
          <td>Hidden</td>
        </tr>
        <tr>
          <th scope="row" class="auto-style1">.visible-sm-*</th>
          <td>Hidden</td>
          <td class="shown">Visible</td>
          <td>Hidden</td>
          <td>Hidden</td>
        ...
        <tr>
          <th scope="row" class="auto-style1">.visible-md-*</th>
          <td>Hidden</td>
          <td>Hidden</td>
          <td class="shown">Visible</td>
          <td>Hidden</td>
        ...
        <tr>
          <th scope="row" class="auto-style1">.visible-lg-*</th>
          <td>Hidden</td>
          <td>Hidden</td>
          <td>Hidden</td>
          <td class="shown">Visible</td>
      ...
      <tbody>
        <tr>
          <th scope="row" class="auto-style1">.hidden-xs</th>
          <td>Hidden</td>
          <td class="shown">Visible</td>
          <td class="shown">Visible</td>
          <td class="shown">Visible</td>
        ...
        <tr>
          <th scope="row" class="auto-style1">.hidden-sm</th>
          <td class="shown">Visible</td>
          <td>Hidden</td>
          <td class="shown">Visible</td>
          <td class="shown">Visible</td>
        ...
        <tr>
          <th scope="row" class="auto-style1">.hidden-md</th>
          <td class="shown">Visible</td>
          <td class="shown">Visible</td>
          <td>Hidden</td>
          <td class="shown">Visible</td>
        ...
        <tr>
          <th scope="row" class="auto-style1">.hidden-lg</th>
          <td class="shown">Visible</td>
          <td class="shown">Visible</td>
          <td class="shown">Visible</td>
          <td>Hidden</td>
...
<h2>Hidden</h2>
<p>Hide elements depending on screen size:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;h2&gt;Example&lt;/h2&gt;<br>&lt;p&gt;Resize this page to see how the text below changes:&lt;/p&gt;<br>&lt;h1 class=&quot;hidden-xs bg-danger&quot;&gt;This text is hidden on an EXTRA SMALL screen.&lt;/h1&gt;<br>&lt;h1 class=&quot;hidden-sm bg-info&quot;&gt;This text is hidden on a SMALL screen.&lt;/h1&gt;<br>&lt;h1 class=&quot;hidden-md bg-warning&quot;&gt;This is text hidden on a MEDIUM screen.&lt;/h1&gt;<br>&lt;h1 class=&quot;hidden-lg bg-success&quot;&gt;This is text hidden on a LARGE screen.&lt;/h1&gt;</div>
<p>Result:</p>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_hlp_text-visible&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<br>

<p>As of v3.2.0, the <code class="w3-codespan">.visible-*-*</code> classes for come in three variations, one for each CSS <code class="w3-codespan">display</code> 
property value:</p>
<div class="table-responsive">
  <table class="table table-bordered table-striped">
      <thead>
      ...
      <tbody>
        <tr>
          <th scope="row" class="auto-style1">visible-*-block</th>
          <td>display: block;</td>
        </tr>
        <tr>
          <th scope="row" class="auto-style1">.visible-*-inline</th>
          <td>display: inline;</td>
        </tr>
        <tr>
          <th scope="row" class="auto-style1">.visible-*-inline-block</th>
          <td>display: inline-block;</td>
        </tr>
      </tbody>
  </table>
</div>
<p>E.g. for small (<code class="w3-codespan">sm</code>) screens, the available <code class="w3-codespan">.visible-*-*</code> classes are: <code class="w3-codespan">.visible-sm-block</code>, <code class="w3-codespan">.visible-sm-inline</code>, and <code class="w3-codespan">.visible-sm-inline-block</code>.</p>
<div class="w3-panel w3-note">
<p>The classes <code class="w3-codespan">.visible-xs</code>, <code class="w3-codespan">.visible-sm</code>, <code class="w3-codespan">.visible-md</code>, and <code class="w3-codespan">.visible-lg</code> are <strong>deprecated as of v3.2.0</strong>.</p>
</div>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;h2&gt;Example&lt;/h2&gt;<br>&lt;p&gt;Resize this page to see how the text below changes:&lt;/p&gt;<br>&lt;h1 class=&quot;visible-xs&quot;&gt;This text is shown only on an EXTRA SMALL screen.&lt;/h1&gt;<br>&lt;h1 class=&quot;visible-sm&quot;&gt;This text is shown only on a SMALL screen.&lt;/h1&gt;<br>&lt;h1 class=&quot;visible-md&quot;&gt;This text is shown only on a MEDIUM screen.&lt;/h1&gt;<br>&lt;h1 class=&quot;visible-lg&quot;&gt;This text is shown only on a LARGE screen.&lt;/h1&gt;</div>
<p>Result:</p>
<div class="w3-white w3-padding notranslate">
<h2>Example</h2>
  <p>Resize this page to see how the text below changes:</p>
  <h4 class="visible-xs">This text is shown only on an EXTRA SMALL screen.</h4>
  <h4 class="visible-sm">This text is shown only on a SMALL screen.</h4>
  <h4 class="visible-md">This text is shown only on a MEDIUM screen.</h4>
  <h4 class="visible-lg">This text is shown only on a LARGE screen.</h4>
<br>
</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_hlp_text-visible&stacked=h" class="w3-btn w3-margin-top  w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
