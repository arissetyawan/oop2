...
<html lang="en-US">
<head>
<title>Bootstrap CSS Basic Text Reference</title>
...
<h1>Bootstrap <span class="color_h1">CSS Typography Reference</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_all_classes.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_css_buttons.asp">Next &#10095;</a>
</div>
<hr>
<h2>Bootstrap's Default Settings</h2>
<p>Bootstrap's global default font-size is 14px, with a line-height of 1.428.</p>
<p>This is applied to the &lt;body&gt; and all paragraphs.</p>
<p>In addition, all &lt;p&gt; elements have a bottom margin that equals half 
their computed line-height (10px by default).</p>
<hr>

<h2>Typography</h2>
<p>The elements below are HTML elements that will be styled a little 
bit differently by Bootstrap than browser defaults. Look at the &quot;Try it&quot; examples to see the result/differences.</p>
<p>The classes below is used to style the elements further.</p>

<table class="w3-table-all notranslate">
  <tr>
    <th style="width:20%;">Element/Class</th>
    <th style="width:70%;">Description</th>
    <th style="width:8%;">Example</th>
  </tr>
  <tr>
    <td>&lt;h1&gt; - &lt;h6&gt;<br>or<br>.h1 - .h6</td>
    <td>h1 - h6 headings</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_hn&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;small&gt;</td>
    <td>Creates a lighter, secondary text in any heading
    <h2>Heading <small>(secondary text)</small></h2></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_hn&stacked=h">Try it</a></td>
  </tr>
    <tr>
    <td>.small</td>
    <td>Indicates smaller text (set to 85% of the size of the parent): <span class="small">Smaller text</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_small&stacked=h">Try it</a></td>
    </tr>
  <tr>
    <td>.lead</td>
    <td>Makes a text stand out: <span class="lead">Stand out text</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_lead&stacked=h">Try it</a></td>
    </tr>
  <tr>
    <td>&lt;mark&gt;<br>or<br>.mark</td>
    <td>Highlights text: <span class="mark">Highlighted text</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_mark&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;del&gt;</td>
    <td>Indicates deleted text: <del>Deleted text</del></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_del&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;s&gt;</td>
    <td>Indicates no longer relevant text: <s>No longer relevant text</s></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_s&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;ins&gt;</td>
    <td>Indicates inserted text: <ins>Inserted text</ins></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_ins&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;u&gt;</td>
    <td>Indicates underlined text: <u>Underlined text</u></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_u&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;strong&gt;</td>
    <td>Indicates bold text: <strong>Bold text</strong></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_strong&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;em&gt;</td>
    <td>Indicates italic text: <em>Italic text</em></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_em&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.text-left</td>
  ...
  <tr>
    ...
    <td>Indicates lowercased text: <span class="text-lowercase">LOWERCASED TEXT</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_text-lowercase&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.text-uppercase</td>
    <td>Indicates uppercased text: <span class="text-uppercase">uppercased text</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_text-lowercase&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.text-capitalize</td>
    <td>Indicates capitalized text: <span class="text-capitalize">capitalized text</span></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_text-lowercase&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;abbr&gt;</td>
    <td>The &lt;abbr&gt; element indicates an abbreviation or acronym. Abbreviations with a title attribute have a dotted bottom border and a help cursor on hover, providing additional context on hover.</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_abbr&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.initialism</td>
    <td>Displays the text inside the &lt;abbr&gt; element in a slightly smaller font size</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_abbr2&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;address&gt;</td>
    <td>Presents contact information</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_address&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;blockquote&gt;</td>
    <td>Indicates blocks of content from another source</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_blockquote&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.blockquote-reverse</td>
    <td>Indicates a blockquote with right-aligned content</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_blockquote2&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;ul&gt;</td>
    <td>Indicates an unordered list</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_ul&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;ol&gt;</td>
    <td>Indicates an ordered list</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_ol&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.list-unstyled</td>
    <td>Removes the default list-style and left margin on list items (works on both &lt;ul&gt; and &lt;ol&gt;). This class only applies to immediate children list items (to remove the default list-style from any nested lists, apply this class to any nested lists as well)</td>
  ...
  <tr>
    <td>&lt;dl&gt;</td>
    <td>Indicates a description list</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_dl&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.dl-horizontal</td>
    <td>Lines up the terms and descriptions in the &lt;dl&gt; element side-by-side. Starts off like default &lt;dl&gt;s, but when the browser window expands, it will line up side-by-side</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_dl-horizontal&stacked=h">Try it</a></td>
  </tr>
</table>
<hr>
<h2>Code</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>&lt;var&gt;</td>
    <td>Indicates variables: <var>x</var> = <var>a</var><var>b</var> + <var>y</var></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_var&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;kbd&gt;</td>
    <td>Indicates input that is typically entered via the keyboard: <kbd>CTRL + P</kbd></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_kbd&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;pre&gt;</td>
    <td>Indicates multiple lines of code</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_pre&stacked=h">Try it</a></td>
  </tr>
    <tr>
    <td>&lt;pre class=&quot;pre-scrollable&quot;&gt;</td>
    <td>Indicates multiple lines of code with scrollbar</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_pre&stacked=h">Try it</a></td>
    </tr>
  <tr>
    <td>&lt;samp&gt;</td>
    <td>Indicates sample output from a computer program: <samp>Sample output</samp></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_samp&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>&lt;code&gt;</td>
    <td>Indicates inline snippets of code: <code class="w3-codespan">span</code>, <code class="w3-codespan">div</code> </td>
    <td><a  target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_txt_code&stacked=h">Try it</a></td>
  </tr>
</table>
