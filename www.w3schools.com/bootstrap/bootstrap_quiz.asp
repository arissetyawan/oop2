...
<h1>Bootstrap <span class="color_h1">Quiz</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_exam.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">You can test your Bootstrap skills with W3Schools' Quiz.</p>
<hr>
<h2>The Test</h2>
<p>The test contains 25 questions and there is no time limit.</p>
<p>The test is not official, it's just a nice way to see how much you know, or don't know, about Bootstrap.</p>
...
<div class="w3-light-grey w3-padding w3-margin-top">
<h2>Start the Quiz</h2>
<p>Good luck!</p>
<p><button onclick="document.location='/quiztest/quiztest.asp?qtest=Bootstrap'" class="w3-btn w3-orange w3-text-white" style="margin-top:10px;padding:17px;font-size:17px">Start the Bootstrap Quiz &#10095;</button></p>
</div>
<div class="w3-note w3-panel">
  <p>If you don't know Bootstrap, we suggest that you read our <a href="default.asp">Bootstrap Tutorial</a> from scratch.</p>
</div>
