...
<h1>Bootstrap <span class="color_h1">Progress Bars</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_badges_labels.asp">&#10094; Previous</a>
...
process.</p>
<p>Bootstrap provides several types of progress bars.</p>
<p>A default progress bar in Bootstrap looks like this:</p>
<div class="progress">
...
<p>To create a default progress bar, add a <code class="w3-codespan">.progress</code> class to a <code class="w3-codespan">&lt;div&gt;</code> element:</p>                  
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar&quot; role=&quot;progressbar&quot; aria-valuenow=&quot;70&quot;<br>&nbsp; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:70%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; &lt;span class=&quot;sr-only&quot;&gt;70% Complete&lt;/span&gt;<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
...
<p><strong>Note: </strong>Progress bars are not supported in Internet Explorer 9 and 
earlier (because they use CSS3 transitions and animations to achieve some of 
their effects).<br><br><strong>Note:</strong> To help improve accessibility for 
people using screen readers, you should include the aria-* attributes.</p>
</div>
<hr>

<h2>Progress Bar With Label</h2>
<p>A progress bar with a label looks like this:</p>
<div class="progress">
  <div class="progress-bar" role="progressbar" aria-valuenow="70"
  aria-valuemin="0" aria-valuemax="100" style="width:70%">
    70%
...
<p>Remove the <code class="w3-codespan">.sr-only</code> class from the progress bar to show a visible percentage:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar&quot; role=&quot;progressbar&quot; aria-valuenow=&quot;70&quot;<br>&nbsp; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:70%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 70%<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
...
<p>Contextual classes are used to provide &quot;meaning through colors&quot;.</p>
<p>The contextual classes that can be used with progress bars are:</p>
<ul>
  <li><code class="w3-codespan">.progress-bar-success</code></li>
  <li><code class="w3-codespan">.progress-bar-info</code></li>
  <li><code class="w3-codespan">.progress-bar-warning</code></li>
  <li><code class="w3-codespan">.progress-bar-danger</code></li>
</ul>
<div class="progress">
...
<p>The following example shows how to create progress bars with the different 
contextual classes:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-success&quot; role=&quot;progressbar&quot; aria-valuenow=&quot;40&quot;<br>&nbsp; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:40%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 40% Complete (success)<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-info&quot; role=&quot;progressbar&quot; aria-valuenow=&quot;50&quot;<br>&nbsp; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:50%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 50% Complete (info)<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-warning&quot; role=&quot;progressbar&quot; aria-valuenow=&quot;60&quot;<br>&nbsp; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:60%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 60% Complete (warning)<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-danger&quot; role=&quot;progressbar&quot; aria-valuenow=&quot;70&quot;<br>&nbsp; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:70%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 70% Complete (danger)<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
...
<p>Progress bars can also be striped:</p>
<div class="progress">
...
<p>Add class <code class="w3-codespan">.progress-bar-striped</code> to add stripes to the progress bars:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-success progress-bar-striped&quot; role=&quot;progressbar&quot;<br>&nbsp; aria-valuenow=&quot;40&quot; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:40%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 40% Complete (success)<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-info progress-bar-striped&quot; role=&quot;progressbar&quot;<br>&nbsp; aria-valuenow=&quot;50&quot; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:50%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 50% Complete (info)<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-warning progress-bar-striped&quot; role=&quot;progressbar&quot;<br>&nbsp; aria-valuenow=&quot;60&quot; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:60%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 60% Complete (warning)<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br><br>&lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-danger progress-bar-striped&quot; role=&quot;progressbar&quot;<br>&nbsp; aria-valuenow=&quot;70&quot; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:70%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 70% Complete (danger)<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
...
<p>Add class <code class="w3-codespan">.active</code> to animate the progress bar:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-striped active&quot; role=&quot;progressbar&quot;<br>&nbsp; aria-valuenow=&quot;40&quot; aria-valuemin=&quot;0&quot; aria-valuemax=&quot;100&quot; style=&quot;width:40%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; 40%<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
...
<p>Create a stacked progress bar by placing multiple bars into the same <code class="w3-codespan">&lt;div class=&quot;progress&quot;&gt;</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;progress&quot;&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-success&quot; role=&quot;progressbar&quot; style=&quot;width:40%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; Free Space<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-warning&quot; role=&quot;progressbar&quot; style=&quot;width:10%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; Warning<br>&nbsp; &lt;/div&gt;<br>&nbsp; &lt;div class=&quot;progress-bar progress-bar-danger&quot; role=&quot;progressbar&quot; style=&quot;width:20%&quot;&gt;<br>&nbsp;&nbsp;&nbsp; Danger<br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;</div>
...
<p>
<a class="w3-btn" href="exercise.asp?filename=exercise_progressbars1" target="_blank">Exercise 1 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_progressbars2" target="_blank">Exercise 2 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_progressbars3" target="_blank">Exercise 3 &raquo;</a>&nbsp;
<a class="w3-btn" href="exercise.asp?filename=exercise_progressbars4" target="_blank">Exercise 4 &raquo;</a>
</p>
