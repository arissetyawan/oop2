...
<h1>Bootstrap <span class="color_h1">Tables</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_typography.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_images.asp">Next &#10095;</a>
</div>
<hr>

<h2>Bootstrap Basic Table</h2>
<p>A basic Bootstrap table has a light padding and only horizontal dividers.</p>
...
<p>The <code class="w3-codespan">.table-condensed</code> class makes a table more compact by cutting cell padding in half:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-padding w3-white notranslate">
...
<a target="_blank" href="tryit.asp?filename=trybs_table_condensed&stacked=h" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Contextual Classes</h2>
<p>Contextual classes can be used to color table rows (<code class="w3-codespan">&lt;tr&gt;</code>) or table cells (<code class="w3-codespan">&lt;td&gt;</code>):</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-padding w3-white notranslate">
  <table class="table">
...
<p>The <code class="w3-codespan">.table-responsive</code> class creates a responsive table. The table will then 
...
<h2>Complete Bootstrap Table Reference</h2>
<p>For a complete reference of all table classes, go to our complete
<a href="bootstrap_ref_css_tables.asp">Bootstrap Tables Reference</a>.</p>
