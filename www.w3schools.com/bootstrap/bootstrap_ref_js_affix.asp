...
<html lang="en-US">
<head>
<title>Bootstrap JS Affix Reference</title>
...
<h1>Bootstrap <span class="color_h1">JS Affix</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_comp_glyphs.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_js_alert.asp">Next &#10095;</a>
</div>
<hr>

<h2>JS Affix (affix.js)</h2>
<p>The Affix plugin allows an element to become affixed (locked) to an area on the page. This is often used with navigation menus or social icon buttons, to make them "stick" at a specific area while scrolling up and down the page.</p>

<p>The plugin toggles this behavior on and off (changes the value of CSS position from static to fixed), depending on scroll position.</p>

<p>The affix plugin toggles between three classes: <code class="w3-codespan">.affix</code>, <code class="w3-codespan">.affix-top</code>, and 
<code class="w3-codespan">.affix-bottom</code>. Each class represents a particular state. You must add CSS 
properties to handle the actual positions, with the exception of <code class="w3-codespan">position:fixed</code> 
on the <code class="w3-codespan">.affix</code> class.</p>
<p>For more information, read our <a href="bootstrap_affix.asp">Bootstrap 
Affix Tutorial</a>.</p>
<p><strong>Tip:</strong> The Affix plugin is often used together with the
<a href="bootstrap_ref_js_scrollspy.asp">Scrollspy</a> plugin.</p>
<hr>

<h2>Via data-* Attributes</h2>
<p>Add <code class="w3-codespan">data-spy=&quot;affix&quot;</code> to the element you want to spy on, 
and the <code class="w3-codespan">data-offset-top|bottom=&quot;<em>number</em>&quot;</code> 
attribute to calculate the position of the scroll.</p>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_affix_nav&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_affix_js&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
append the option name to data-, as in data-offset=&quot;&quot;.</p>
<table class="w3-table-all notranslate">
 ...
 Specifies the number of pixels to offset from screen when calculating position of scroll. When using a single number, the offset is added to both top and bottom directions. If you only want to control the top or the bottom, use an object, like <code class="w3-codespan">offset: {top:25}</code><br><br>For multiple offsets, use <code class="w3-codespan">offset: {top:25, bottom:50}</code><br><br><strong>Tip:</strong> Use a function to dynamically provide an offset (can be useful for responsive designs)</td>
  ...
  <tr>
    ...
    <td>
 Specifies the target element of the affix</td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Occurs before fixed positioning is added to the element (e.g, when the <code class="w3-codespan">.affix-top</code> class is about to be replaced with the <code class="w3-codespan">.affix</code> class)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_affix_event_affix&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>affixed.bs.affix</td>
    <td>Occurs after fixed positioning is added to the element (e.g., after the <code class="w3-codespan">.affix-top</code> class is replaced with the <code class="w3-codespan">.affix</code> class)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_affix_event_affixed&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>affix-top.bs.affix</td>
    <td>Occurs before the top element returns to its original (non-fixed) position (e.g., the <code class="w3-codespan">.affix</code> class is about to be replaced with <code class="w3-codespan">.affix-top</code>)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_affix_event_affixtop&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>affixed-top.bs.affix</td>
    <td>Occurs after the top element returns to its original (non-fixed) position (e.g., the <code class="w3-codespan">.affix</code> class has been replaced with <code class="w3-codespan">.affix-top</code>)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_affix_event_affixedtop&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>affix-bottom.bs.affix</td>
    <td>Occurs before the bottom element returns to its original (non-fixed) position (e.g., the <code class="w3-codespan">.affix</code> class is about to be replaced with <code class="w3-codespan">.affix-bottom</code>)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_affix_event_affixbottom&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>affixed-bottom.bs.affix</td>
    <td>Occurs after the bottom element returns to its original (non-fixed) position (e.g., the <code class="w3-codespan">.affix</code> class has been replaced with <code class="w3-codespan">.affix-bottom</code>)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_affix_event_affixedbottom&stacked=h">Try it</a></td>
  </tr>
</table>
</div>
<hr>
...
<h3>Affixed navbar</h3>
<p>Create a horizontal affixed navigation menu:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;nav class=&quot;navbar navbar-inverse&quot; data-spy=&quot;affix&quot; data-offset-top=&quot;197&quot;&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_affix&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Using jQuery to automatically affix a navbar</h3>
<p>Use jQuery's <a href="/jquery/html_outerheight.asp">outerHeight()</a> method to affix the navbar after the user has scrolled passed a 
specified 
element (&lt;header&gt;):</p>
<div class="w3-example">
 <h3>Example</h3>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_affix_outerheight&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Scrollspy & Affix</h3>
<p>Using the Affix plugin together with the <a href="bootstrap_scrollspy.asp">Scrollspy</a> 
plugin:</p>
<div class="w3-example">
<h3>Horizontal Menu (Navbar)</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;body data-spy=&quot;scroll&quot; data-target=&quot;.navbar&quot; data-offset=&quot;50&quot;&gt;<br><br>&lt;nav class=&quot;navbar navbar-inverse&quot; data-spy=&quot;affix&quot; data-offset-top=&quot;197&quot;&gt;<br>
 ...<br>&lt;/nav&gt;<br><br>&lt;/body&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_scrollspy_affix&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Vertical Menu (Sidenav)</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;body data-spy=&quot;scroll&quot; data-target=&quot;#myScrollspy&quot; data-offset=&quot;15&quot;&gt;<br><br>
 &lt;nav class=&quot;col-sm-3&quot; id=&quot;myScrollspy&quot;&gt;<br>&nbsp; &lt;ul class=&quot;nav nav-pills nav-stacked&quot; data-spy=&quot;affix&quot; data-offset-top=&quot;205&quot;&gt;<br>&nbsp; ...<br>&lt;/nav&gt;<br>
 <br>&lt;/body&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_scrollspy_affix2&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Animated navbar on affix</h3>
<p>Use CSS to manipulate the different .affix classes:</p>
<div class="w3-example">
<h3>Example - Change background color and padding of navbar on scroll</h3>
<div class="w3-code notranslate cssHigh">
 .affix {<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; -webkit-transition: all .5s ease-in-out;<br>&nbsp;&nbsp;&nbsp; transition: all .5s ease-in-out;<br>&nbsp;&nbsp;&nbsp; background-color: #F44336;<br>&nbsp;&nbsp;&nbsp; border-color: #F44336;<br>}<br><br>.affix a {<br>&nbsp;&nbsp;&nbsp; color: #fff !important;<br>&nbsp;&nbsp;&nbsp; padding: 15px !important;<br>&nbsp;&nbsp;&nbsp; -webkit-transition: all .5s ease-in-out;<br>&nbsp;&nbsp;&nbsp; transition: all .5s ease-in-out;<br>}<br><br>.affix-top a {<br>&nbsp;&nbsp;&nbsp; padding: 25px !important;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_affix_transition&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-example">
<h3>Example - Slide in the navbar</h3>
<div class="w3-code notranslate cssHigh">
 .affix {<br>&nbsp;&nbsp;&nbsp; top: 0;<br>&nbsp;&nbsp;&nbsp; width: 100%;<br>&nbsp;&nbsp;&nbsp; -webkit-transition: all .5s ease-in-out;<br>&nbsp;&nbsp;&nbsp; transition: all .5s ease-in-out;<br>}<br><br>.affix-top {<br>&nbsp;&nbsp;&nbsp; position: static;<br>&nbsp;&nbsp;&nbsp; top: -35px;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_affix_transition2&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
