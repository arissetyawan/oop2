...
<html lang="en-US">
<head>
<title>Bootstrap JS Scrollspy Reference</title>
...
<h1>Bootstrap <span class="color_h1">JS Scrollspy</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_js_popover.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_js_tab.asp">Next &#10095;</a>
</div>
<hr>

<h2>JS Scrollspy (scrollspy.js)</h2>
<p>The Scrollspy plugin is used to automatically update links in a navigation 
list based on scroll position.</p>
<p>For a tutorial about Scrollspy, read our <a href="bootstrap_scrollspy.asp">Bootstrap Scrollspy Tutorial</a>.</p>
<p><strong>Tip:</strong> The Scrollspy plugin is often used together with the
<a href="bootstrap_ref_js_affix.asp">Affix</a> plugin.</p>
<hr>

<h2>Via data-* Attributes</h2>

<p>Add <code class="w3-codespan">data-spy="scroll"</code> to the element that should be used as the scrollable 
area (often this is the <code class="w3-codespan">&lt;body&gt;</code> element).</p>
<p>Then add the <code class="w3-codespan">data-target</code> attribute with a value of the id or the class name 
of the navigation bar (<code class="w3-codespan">.navbar</code>). This is to make sure that the navbar 
is connected with the scrollable area.</p>
<p>Note that scrollable elements must match the ID of the links inside the navbar's 
list items 
(<code class="w3-codespan">&lt;div id="section1"&gt;</code> matches <code class="w3-codespan">&lt;a href="#section1"&gt;</code>).</p>
<p>The optional <code class="w3-codespan">data-offset</code> attribute specifies the number of pixels to offset 
...
when jumping to the scrollable elements. Default is 10 pixels.</p>

<div class="w3-panel w3-note">
  <p><strong>Requires relative positioning: </strong>The element with 
data-spy=&quot;scroll&quot; 
requires the CSS <strong>position</strong> property, with a value of &quot;relative&quot; 
to work properly.</p>
</div>
...
&lt;!-- The scrollable area --&gt;<br>&lt;body data-spy="scroll" 
data-target=".navbar" data-offset="50"&gt;<br><br>&lt;!-- The navbar - The 
&lt;a&gt; elements are used to jump to a section in the scrollable area --&gt;<br>&lt;nav 
class="navbar navbar-inverse navbar-fixed-top"&gt;<br>...<br>&nbsp; &lt;ul class="nav 
navbar-nav"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;li&gt;&lt;a href="#section1"&gt;Section 1&lt;/a&gt;&lt;/li&gt;<br>&nbsp;&nbsp;&nbsp; 
...<br>&lt;/nav&gt;<br><br>&lt;!-- Section 1 
--&gt;<br>&lt;div id="section1"&gt;<br>&nbsp;&nbsp;&lt;h1&gt;Section 1&lt;/h1&gt;<br>&nbsp;&nbsp;&lt;p&gt;Try to scroll this page and look at 
the navigation bar while scrolling!&lt;/p&gt;<br>&lt;/div&gt;<br>...<br><br>
&lt;/body&gt;
</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_scrollspy&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_scrollspy_js&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>10</td>
    <td>
 Specifies the number of pixels to offset from top when calculating the position of scroll</td>
  <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_scrollspy_offset&stacked=h">Try it</a></td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.scrollspy(&quot;refresh&quot;)</td>
    <td>When adding and removing elements from the scrollspy, this method can be used to refresh the document</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_scrollspy_refresh&stacked=h">Try it</a></td>
  </tr>
</table>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Occurs when a new item becomes activated by the scrollspy</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_scrollspy_activate&stacked=h">Try it</a></td>
  </tr>
</table>
</div>
<hr>
...
<h3>Scrollspy with animated scroll</h3>
<p>How to add a smooth page scroll to an anchor on the same page:</p>
<div class="w3-example">
<h3>Smooth scrolling</h3>
<div class="w3-code notranslate jsHigh">
 // Add scrollspy to &lt;body&gt;<br>$('body').scrollspy({target: &quot;.navbar&quot;, offset: 50});<br><br>// Add smooth scrolling on all links inside the navbar<br>
 $(&quot;#myNavbar a&quot;).on('click', function(event) {<br><br>&nbsp; // Make sure this.hash has a value before overriding default behavior<br>&nbsp; if (this.hash !== &quot;&quot;) {<br><br>&nbsp;&nbsp;&nbsp; // Prevent default anchor click behavior<br>&nbsp;&nbsp;&nbsp; event.preventDefault();<br><br>&nbsp;&nbsp;&nbsp; // Store hash<br>&nbsp;&nbsp;&nbsp; var hash = this.hash;<br><br>&nbsp;&nbsp;&nbsp; // Using jQuery's animate() method to add smooth page scroll<br>&nbsp;&nbsp;&nbsp; // The optional number (800) specifies the number of milliseconds it takes to scroll to the specified area<br>&nbsp;&nbsp;&nbsp; $('html, body').animate({<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; scrollTop: $(hash).offset().top<br>&nbsp;&nbsp;&nbsp; }, 800, function(){<br>
 <br>&nbsp;&nbsp;&nbsp; // Add hash (#) to URL when done scrolling (default click behavior)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; window.location.hash = hash;<br>&nbsp;&nbsp;&nbsp; });<br><br>&nbsp; } // End if<br><br>});</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_scrollspy_animate&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<h3>Scrollspy &amp; Affix</h3>
<p>Using the <a href="bootstrap_affix.asp">Affix</a> plugin together with the Scrollspy plugin:</p>
<div class="w3-example">
