...
<html lang="en-US">
<head>
<title>Bootstrap JS Tooltip Reference</title>
...
<h1>Bootstrap <span class="color_h1">JS Tooltip</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_js_tab.asp">&#10094; Previous</a>
...
<p>For a tutorial about Tooltips, read our <a href="bootstrap_tooltip.asp">Bootstrap Tooltip Tutorial</a>.</p>
<!--
<div class="w3-example">
<h3>Example</h3>
<div class="xexample_code notranslate htmlHigh">
<button style="margin:7px 15px 17px 0;" type="button" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Hooray!">Hover over me</button>
...
$(document).ready(function(){
 ...
 <div class="w3-code notranslate htmlHigh">
  ...
  <br>&lt;script&gt;<br>$(document).ready(function(){<br>&nbsp;&nbsp;&nbsp;  $('[data-toggle=&quot;tooltip&quot;]').tooltip(); <br>});<br>&lt;/script&gt;<br></div>
...
<p>The <code class="w3-codespan">data-toggle="tooltip&quot;</code> activates the tooltip.</p>
<p>The <code class="w3-codespan">title</code> attribute specifies the text that should be displayed 
inside the tooltip.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
&lt;a href=&quot;#&quot; data-toggle=&quot;tooltip&quot; title=&quot;Hooray!&quot;&gt;Hover over me&lt;/a&gt;
</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_tooltip&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Via JavaScript</h2>
<p>Tooltips are not CSS-only plugins, and must therefore be initialized with 
jQuery: select the specified element and call the <code class="w3-codespan">tooltip()</code> method.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
// Select all 
elements with data-toggle="tooltips" in the document<br>
$('[data-toggle=&quot;tooltip&quot;]').tooltip(); <br><br>// Select a specified 
element<br>$('#myTooltip').tooltip();
</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_tooltip&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>true</td>
    <td>
 <p>Specifies whether to add a CSS fade transition effect when showing and hiding the tooltip</p>
 <ul>
    <li>true - Add a fading effect</li>
    <li>false - Do not add a fading effect</li>
 </ul>
   </td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_animation&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>container</td>
    <td>string, or the boolean false</td>
    <td>false</td>
    <td>Appends the tooltip to a specific element. <br>Example: container: 'body'</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_container&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>delay</td>
    <td>number, or object</td>
    <td>0</td>
    <td>Specifies the number of milliseconds it will take to show and hide the tooltip.<br><br>To specify a delay for showing and another one for hiding, use the object structure:<br><br>delay: {show: 500, hide: 100} - which will take 500 ms to show the tooltip, but only 100 ms to hide it</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_delay&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>html</td>
    <td>boolean&nbsp;</td>
    <td>false</td>
    <td>Specifies whether to accept HTML tags in the tooltip:<br>&nbsp;<ul>
 ...
 The HTML must be inserted in the title attribute (or using the title option). <br><br>When set to false (default), jQuery's <a href="/jquery/html_text.asp">text()</a> method will be used. Use this if you are worried about XSS attacks</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_html&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>placement</td>
    <td>string</td>
    <td>&quot;top&quot;</td>
    <td>Specifies the tooltip position. Possible values:<br><br><ul>
    <li>&quot;top&quot; - Tooltip on top</li>
    <li>&quot;bottom&quot; - Tooltip on bottom</li>
    <li>&quot;left&quot; - Tooltip on left</li>
    <li>&quot;right&quot; - Tooltip on right</li>
    <li>&quot;auto&quot; - Lets the browser decide the position of the tooltip. For  example, if the value is &quot;auto left&quot;, the tooltip will display on the  left side when possible, otherwise on the right. If the value is &quot;auto  bottom&quot;, the tooltip will display at the bottom when possible, otherwise  on the top</li>
 </ul>
   </td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_placement&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>selector</td>
    <td>string, or the boolean false</td>
    <td>false</td>
    <td>Adds the tooltip to a specified selector</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_selector&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>template</td>
    <td>string</td>
    <td>&nbsp;</td>
    <td>Base HTML to use when creating the tooltip. <br><br>The tooltip's title will be inserted into the element having the class .tooltip-inner and the element with the class .tooltip-arrow will become the tooltip's arrow.<br><br>The outermost wrapper element should have the .tooltip class.</td>
    <td></td>
  </tr>
  <tr>
    <td>title</td>
    <td>string</td>
    <td>&quot;"</td>
    <td>Specifies the text that should be displayed inside the tooltip</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_title&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>trigger</td>
    <td>string</td>
    <td>&quot;hover focus&quot;</td>
    <td>Specifies how the tooltip is triggered. Possible values:<br><br><ul>
    <li>&quot;click&quot; - Trigger the tooltip with a click</li>
    <li>&quot;hover&quot; - Trigger the tooltip on hover</li>
    <li>&quot;focus&quot; - Trigger the tooltip when it gets focus (by tabbing or  clicking .e.g)</li>
    <li>&quot;manual&quot; - Trigger the tooltip manually</li>
 </ul>
 <strong>Tip:</strong> To pass multiple values, separate them with a space</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_trigger&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>viewport</td>
    <td>string, or object</td>
    <td>{selector: &quot;body&quot;, padding: 0}</td>
    <td>Keeps the tooltip within the bounds of this element. <br><br>Example: viewport: '#viewport' or {selector: '#viewport', padding: 0}</td>
    <td></td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.tooltip(<em>options</em>)</td>
    <td>Activates the tooltip with an option. See options above for valid values</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_placement&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.tooltip(&quot;show&quot;)</td>
    <td>Shows the tooltip</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_methods&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.tooltip(&quot;hide&quot;)</td>
  ...
  <tr>
    <td>.tooltip(&quot;destroy&quot;)</td>
    <td>Hides and destroys the tooltip</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_methods&stacked=h">Try it</a></td>
  </tr>
</table>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Occurs when the tooltip is about to be shown</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>shown.bs.tooltip</td>
    <td>Occurs when the tooltip is fully shown (after CSS transitions have completed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>hide.bs.tooltip</td>
    <td>Occurs when the tooltip is about to be hidden</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_events&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>hidden.bs.tooltip</td>
    <td>Occurs when the tooltip is fully hidden (after CSS transitions have completed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_tooltip_events&stacked=h">Try it</a></td>
    </tr>
</table>
<hr>
...
<h2>More Examples</h2>
<h3>Custom Tooltip Design</h3>
<p>Use CSS to customize the look of the tooltip:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
 /* Tooltip */<br>.test + .tooltip &gt; .tooltip-inner {<br>&nbsp;&nbsp;&nbsp; background-color: #73AD21; <br>&nbsp;&nbsp;&nbsp; color: #FFFFFF; <br>&nbsp;&nbsp;&nbsp; border: 1px solid green;<br>&nbsp;&nbsp;&nbsp; padding: 15px;<br>&nbsp;&nbsp;&nbsp; font-size: 20px;<br>}<br><br>/* Tooltip on top */<br>.test + .tooltip.top &gt; .tooltip-arrow {<br>&nbsp;&nbsp;&nbsp; border-top: 5px solid green;<br>}<br>
 <br>/* Tooltip on bottom */<br>.test + .tooltip.bottom &gt; .tooltip-arrow {<br>&nbsp;&nbsp;&nbsp; border-bottom: 5px solid blue;<br>}<br>
 <br>/* Tooltip on left */<br>.test + .tooltip.left &gt; .tooltip-arrow {<br>&nbsp;&nbsp;&nbsp; border-left: 5px solid red;<br>}<br>
 <br>/* Tooltip on right */<br>.test + .tooltip.right &gt; .tooltip-arrow {<br>&nbsp;&nbsp;&nbsp; border-right: 5px solid black;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_tooltip_css&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
