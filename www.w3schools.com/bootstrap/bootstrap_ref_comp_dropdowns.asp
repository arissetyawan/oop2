...
<html lang="en-US">
<head>
<title>Bootstrap Dropdown Components</title>
...
<h1>Bootstrap <span class="color_h1">Dropdown Components</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_css_tables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_comp_navs.asp">Next &#10095;</a>
</div>
<hr>
<h2>Dropdowns</h2>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_collapsible&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.collapse .in</td>
    <td>Show the collapsible content by default</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_collapsible_in&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.panel-collapse</td>
    <td>Collapsible panel (toggle between hiding and showing panel(s))</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_collapsible_panel&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td></td>
    <td>Collapsible list group</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_collapsible_listgroup&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td></td>
    <td>Accordion</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_collapsible_accordion&stacked=h">Try it</a></td>
  </tr>
</table>
