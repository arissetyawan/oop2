...
<html lang="en-US">
<head>
<title>Bootstrap CSS Forms Reference</title>
...
<h1>Bootstrap <span class="color_h1">CSS Forms Reference</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_css_buttons.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_css_helpers.asp">Next &#10095;</a>
</div>
<hr>
<h2>Bootstrap's Default Settings</h2>
<p>Individual form controls automatically receive some global styling with Bootstrap.</p>
<p>All textual &lt;input&gt;, &lt;textarea&gt;,
and &lt;select&gt; elements with class=&quot;form-control&quot; are set to width: 100%; by default.</p>
...
<p>The following example creates a simple Bootstrap form with two input fields, one checkbox, and a submit button:</p>
...
<div class="w3-code notranslate htmlHigh">
 ...
 &lt;/form&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_form&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.form-inline</td>
    <td>Makes a &lt;form&gt; left-aligned with inline-block controls (This only applies to forms within viewports that are at least 768px wide)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_form-inline&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.form-horizontal</td>
    <td>Aligns labels and groups of form controls in a horizontal layout</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_form-horizontal&stacked=h">Try it</a></td>
  </tr>
    <tr>
      <td>.form-control</td>
      <td>Used on input, textarea, and select elements to span the entire width of the page and make them responsive</td>
      <td>
        <a href="tryit.asp?filename=trybs_form_basic&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.form-control-feedback</td>
      <td>Form validation class</td>
      <td>
        <a href="tryit.asp?filename=trybs_form_horizontal_all&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_form_horizontal_static&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.form-group</td>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_form_input_group&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_form_input_group_size&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Together with the .input-group class, this class makes it possible to add an icon or help text next to the input field</td>
      <td>
        <a href="tryit.asp?filename=trybs_form_input_group&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      ...
      <td>Together with the .input-group class, this class attaches a button next to an input. Often used as a search bar</td>
      <td>
        <a href="tryit.asp?filename=trybs_form_input_group_btn&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.input-lg</td>
      ...
      <td>
        <a href="tryit.asp?filename=trybs_input_height&stacked=h" class="w3-btn btnsmall" target="_blank">Try it</a>
      </td>
    </tr>
    <tr>
      <td>.input-sm</td>
