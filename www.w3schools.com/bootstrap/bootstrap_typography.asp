...
<html lang="en-US">
<head>
<title>Bootstrap Text/Typography</title>
...
<h1>Bootstrap <span class="color_h1">Text/Typography</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_grid_basic.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_tables.asp">Next &#10095;</a>
</div>
<hr>
<h2>Bootstrap's Default Settings</h2>
<p>Bootstrap's global default font-size is 14px, with a  
line-height of 1.428.</p>
<p>This is applied to the <code class="w3-codespan">&lt;body&gt;</code> element and all paragraphs 
(<code class="w3-codespan">&lt;p&gt;</code>).</p>
<p>In addition, all <code class="w3-codespan">&lt;p&gt;</code> elements have a bottom margin that equals half 
their computed line-height (10px by default).</p>
<hr>
<h2>Bootstrap vs. Browser Defaults</h2>
<p>In this chapter, we will look at some HTML elements that will be styled a 
little bit differently by Bootstrap than browser defaults.</p>
<hr>

<h2>&lt;h1&gt; - &lt;h6&gt;</h2>
<p>By default, Bootstrap will style the HTML headings (<code class="w3-codespan">&lt;h1&gt;</code> to
<code class="w3-codespan">&lt;h6&gt;</code>) in the following way:</p>
...
<a target="_blank" href="tryit.asp?filename=trybs_txt_blockquote2&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a></div>
<hr>
...
<code class="w3-codespan">.text-warning</code>, and <code class="w3-codespan">.text-danger</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate">
...
.bg-success</code>, <code class="w3-codespan">.bg-info</code>, <code class="w3-codespan">.bg-warning</code>, and <code class="w3-codespan">.bg-danger</code>:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate">
...
<p>The Bootstrap classes below can be added to style HTML elements further:</p>
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Lines up the terms (<code class="w3-codespan">&lt;dt&gt;</code>) and descriptions (<code class="w3-codespan">&lt;dd&gt;</code>) in
 <code class="w3-codespan">&lt;dl&gt;</code> elements side-by-side. Starts off like default <code class="w3-codespan">&lt;dl&gt;</code>s, but when the browser window expands, it will line up side-by-side</td>
...
<h2>Complete Bootstrap Typography Reference</h2>
<p>For a complete reference of all typography elements/classes, go to our complete
<a href="bootstrap_ref_css_text.asp">Bootstrap Typography Reference</a>.</p>
<p>Also look at our <a href="bootstrap_ref_css_helpers.asp">Bootstrap Helper 
Classes Reference</a> for more information about contextual classes.</p>
