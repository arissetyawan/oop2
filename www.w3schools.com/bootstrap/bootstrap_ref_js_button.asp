...
<html lang="en-US">
<head>
<title>Bootstrap JS Button Reference</title>
...
<h1>Bootstrap <span class="color_h1">JS Button</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_js_alert.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_js_carousel.asp">Next &#10095;</a>
</div>
<hr>

<h2>JS Button (button.js)</h2>
<p>Use this plugin if you want to have more control over your buttons.</p>
<p>For a tutorial about Buttons, read our <a href="bootstrap_buttons.asp">Bootstrap Buttons Tutorial</a>.</p>
<hr>
<h2>The Button Plugin Classes</h2>
<p>The classes below can be used to style any &lt;a&gt;, &lt;button&gt;, or &lt;input&gt; element:</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.btn</td>
    <td>Adds basic styling to any button</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-default</td>
    <td>Indicates a default/standard button</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-default&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-primary</td>
    <td>Provides extra visual weight and identifies the primary action in a set of buttons</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-primary&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-success</td>
    <td>Indicates a successful or positive action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-success&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-info</td>
    <td>Contextual button for informational alert messages</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-info&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-warning</td>
    <td>Indicates caution should be taken with this action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-warning&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-danger</td>
    <td>Indicates a dangerous or potentially negative action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-danger&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-link</td>
    <td>Makes a button look like a link (will still have button behavior)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-link&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-lg</td>
    <td>Makes a large button</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-lg&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-sm</td>
    <td>Makes a small button</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-sm&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-xs</td>
    <td>Makes an extra small button</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-xs&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.btn-block</td>
    <td>Makes a block-level button (spans the full width of the parent element)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn-block&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.active</td>
    <td>Makes the button appear pressed</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn_active&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.disabled</td>
    <td>Makes the button disabled</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_btn_disabled&stacked=h">Try it</a></td>
  </tr>
</table>
<hr>
...
<p><strong>Note:</strong> For this plugin, methods can also be passed via data 
attributes; append the method name to data-, as in data-toggle or data-loading.</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.button(&quot;toggle&quot;)</td>
    <td>Makes the button look pressed</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_button_toggle&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.button(&quot;loading&quot;)</td>
    <td>Disables the button and changes the button text to &quot;loading...&quot;</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_button_loading&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.button(&quot;reset&quot;)</td>
    <td>Changes the button text to original text (if changed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_button_reset&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.button(&quot;string&quot;)</td>
    <td>Specifies a new button text</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_button_string&stacked=h">Try it</a></td>
  </tr>
</table>
</div>
<hr>
...
<h2>More Examples</h2>
<h3>Using CSS to Customize Buttons</h3>
<p>How to remove the rounded borders:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
 .btn-default {<br>&nbsp;&nbsp;&nbsp; border-radius: 0;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_btn_noborder&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>How to add a specific color:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
 .btn-default {<br>&nbsp;&nbsp;&nbsp; background: #000;<br>&nbsp;&nbsp;&nbsp; color: #fff;<br>}<br><br>.btn-default:hover {<br>&nbsp;&nbsp;&nbsp; background: #fff;<br>&nbsp;&nbsp;&nbsp; color: #000;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_btn_black&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>How to add shadows:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
 .btn-default {<br>&nbsp;&nbsp;&nbsp; box-shadow: 1px 2px 5px #000000; <br>}</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_btn_shadow&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
