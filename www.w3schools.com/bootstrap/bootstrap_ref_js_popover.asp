...
<p>The Popover plugin is similar to tooltips; it is a pop-up box that appears 
when the user clicks on an element. The difference is that the popover can 
contain much more content.</p>
<p>Plugin dependency: Popovers require the tooltip plugin (tooltip.js) to be included in your 
...
<table class="w3-table-all notranslate">
 ...
 The HTML must be inserted in the title attribute (or using the title option). <br><br>When set to false (default), jQuery's <a href="/jquery/html_text.asp">text()</a> method will be used. Use this if you are worried about XSS attacks</td>
  ...
  <tr>
    ...
    <td>string</td>
    <td>&nbsp;</td>
    <td>Base HTML to use when creating the popover.<br><br>The popover's title will be injected into the .popover-title.<br><br>The popover's content will be injected into the .popover-content.<br><br>.arrow will become the popover's arrow.<br><br>The outermost wrapper element should have the .popover class.</td>
    <td></td>
  </tr>
  <tr>
    <td>title</td>
 ...
 <strong>Tip:</strong> To pass multiple values, separate them with a space</td>
  ...
  <tr>
    ...
    <td>Keeps the popover within the bounds of this element. <br><br>Example: viewport: '#viewport' or {selector: '#viewport', padding: 0}</td>
    <td></td>
  </tr>
</table>
...
<h2>More Examples</h2>
<h3>Custom Popover Design</h3>
<p>Use CSS to customize the look of the popover:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate cssHigh">
 &nbsp;/* Popover */<br>.popover {<br>&nbsp;&nbsp;&nbsp; border: 2px dotted red;<br>}<br><br>/* Popover Header */<br>.popover-title {<br>&nbsp;&nbsp;&nbsp; background-color: #73AD21; <br>&nbsp;&nbsp;&nbsp; color: #FFFFFF; <br>&nbsp;&nbsp;&nbsp; font-size: 28px;<br>&nbsp;&nbsp;&nbsp; text-align:center;<br>}<br><br>/* Popover Body */<br>.popover-content {<br>&nbsp;&nbsp;&nbsp; background-color: coral;<br>&nbsp;&nbsp;&nbsp; color: #FFFFFF;<br>&nbsp;&nbsp;&nbsp; padding: 25px;<br>}<br><br>/* Popover Arrow */<br>.arrow {<br>&nbsp;&nbsp;&nbsp; border-right-color: red !important;<br>}</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_popover_css&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
