...
<style>
.boxborder {
 box-shadow: 0 2px 4px 0 rgba(0,0,0,0.16),0 2px 10px 0 rgba(0,0,0,0.12) !important;border:1px solid #f2f2f2;padding:15px;transition: box-shadow 0.5s;
}
...
<h1>Bootstrap <span class="color_h1">Templates</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_grid_examples.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_theme_me.asp">Next &#10095;</a>
</div>
<hr>
<h2>W3Schools' Bootstrap Templates</h2>
<p>We have used Bootstrap's grid system to create some responsive HTML templates. They are completely free - Click on "Try It Yourself" to see the code and do whatever you want with it:</p>
<br>

<div class="row">
  <div class="col-sm-6">
    <div class="boxborder"><p>Blog:</p>
      <iframe src="trybs_temp_blog_ifr.htm" style="border:0;width:100%;overflow:hidden;height:245px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trybs_temp_blog&stacked=h" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="boxborder"><p>Portfolio:</p>
      <iframe src="trybs_temp_portfolio_ifr.htm" style="border:0;width:100%;overflow:hidden;height:245px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trybs_temp_portfolio&stacked=h" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
    <div class="boxborder"><p>Webpage:</p>
      <iframe src="trybs_temp_webpage_ifr.htm" style="border:0;width:100%;overflow:hidden;height:245px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trybs_temp_webpage&stacked=h" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="boxborder"><p>Social:</p>
      <iframe src="trybs_temp_social_ifr.htm" style="border:0;width:100%;overflow:hidden;height:245px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trybs_temp_social&stacked=h" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
    </div>
  </div>
</div>
<hr>
...
<div class="row">
  <div class="col-sm-6">
    <div class="boxborder"><p>Marketing:</p>
      <iframe src="trybs_temp_marketing_ifr.htm" style="border:0;width:100%;overflow:hidden;height:245px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trybs_temp_marketing&stacked=h" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="boxborder"><p>Marketing 2:</p>
      <iframe src="trybs_temp_marketing2_ifr.htm" style="border:0;width:100%;overflow:hidden;height:245px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trybs_temp_marketing2&stacked=h" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
    <div class="boxborder"><p>Analytics:</p>
      <iframe src="trybs_temp_analytics_ifr.htm" style="border:0;width:100%;overflow:hidden;height:245px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trybs_temp_analytics&stacked=h" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="boxborder"><p>Online Store:</p>
      <iframe src="trybs_temp_store_ifr.htm" style="border:0;width:100%;overflow:hidden;height:245px;"></iframe>
      <a target="_blank" href="tryit.asp?filename=trybs_temp_store&stacked=h" class="w3-btn w3-margin-top">Try it Yourself &raquo;</a>
    </div>
  </div>
</div>
