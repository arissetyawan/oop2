...
<html lang="en-US">
<head>
<title>Bootstrap JS Alert Reference</title>
...
<h1>Bootstrap <span class="color_h1">JS Alert</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_js_affix.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_js_button.asp">Next &#10095;</a>
</div>
<hr>

<h2>JS Alert (alert.js)</h2>
<p>The alert plugin include options and methods to close alert messages. </p>
<p>For a tutorial about Alerts, read our <a href="bootstrap_alerts.asp">Bootstrap Alerts Tutorial</a>.</p>
<hr>
<h2>The Alert Plugin Classes</h2>
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert1&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.alert-danger</td>
    <td>Red alert. Indicates a dangerous or potentially negative action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert_danger&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.alert-dismissible</td>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert_close2&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.alert-info</td>
    <td>Light-blue alert.Indicates a neutral informative change or action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert_info&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.alert-link</td>
    <td>Used on links inside alerts to provide matching colored links</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert_link&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.alert-success</td>
    <td>Green alert. Indicates a successful or positive action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert_success&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.alert-warning</td>
    <td>Yellow alert. Indicates caution should be taken with this action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert_warning&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.close</td>
    <td>Styles the close button for the alert message (floats right with a specified font-size, color, etc.)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert_close2&stacked=h">Try it</a></td>
  </tr>
</table>
<hr>
...
<p>Add <code class="w3-codespan">data-dismiss="alert&quot;</code> to a link or a button element to close the 
alert message.</p>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_alert&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_alert_js&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert_close&stacked=h">Try it</a></td>
  </tr>
</table>
</div>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td>Occurs when the alert message is about to be closed</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert_event_close&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>closed.bs.alert</td>
    <td>Occurs when the alert message has been closed</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_alert_event_closed&stacked=h">Try it</a></td>
  </tr>
</table>
</div>
<br>
