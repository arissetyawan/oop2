...
<html lang="en-US">
<head>
<title>Bootstrap JS Modal Reference</title>
...
<h1>Bootstrap <span class="color_h1">JS Modal</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_js_dropdown.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_js_popover.asp">Next &#10095;</a>
</div>
<hr>

<h2>JS Modal (modal.js)</h2>
<p>The Modal plugin is a dialog box/popup window that is displayed on top of the 
current page.</p>
<p>For a tutorial about Modals, read our <a href="bootstrap_modal.asp">Bootstrap 
Modal Tutorial</a>.</p>
<!--
<div class="w3-example">
<h3>Example</h3>
<div class="xexample_code notranslate htmlHigh">
<button style="margin:7px 15px 2px 0;" type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal">Click To Open Modal</button>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 ...
 <div class="w3-code notranslate htmlHigh">
  &lt;!-- Trigger the modal with a button --&gt;<br>&lt;button type=&quot;button&quot; class=&quot;btn btn-info btn-lg&quot; data-toggle=&quot;modal&quot; data-target=&quot;#myModal&quot;&gt;Open Modal&lt;/button&gt;<br><br>&lt;!-- Modal --&gt;<br>&lt;div id=&quot;myModal&quot; class=&quot;modal fade&quot; role=&quot;dialog&quot;&gt;<br>&nbsp; &lt;div class=&quot;modal-dialog&quot;&gt;<br><br>&nbsp;&nbsp;&nbsp; &lt;!-- Modal content--&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class=&quot;modal-content&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &lt;!-- Modal Header --&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class=&quot;modal-header&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;button type=&quot;button&quot; class=&quot;close&quot; data-dismiss=&quot;modal&quot;&gt;&amp;times;&lt;/button&gt;<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;h4 class=&quot;modal-title&quot;&gt;Modal Header&lt;/h4&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;!-- Modal Body --&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class=&quot;modal-body&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Some text in the modal.&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &lt;!-- Modal Footer --&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class=&quot;modal-footer&quot;&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;button type=&quot;button&quot; class=&quot;btn btn-default&quot; data-dismiss=&quot;modal&quot;&gt;Close&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br><br>&nbsp; &lt;/div&gt;<br>&lt;/div&gt;<br></div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_modal&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
-->
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.modal</td>
    <td>Creates a modal</td>
  </tr>
  <tr>
    <td>.modal-content</td>
    <td>Styles the modal properly with border, background-color, etc. Use this class to add the modal's header, body, and footer.</td>
  </tr>
  <tr>
    <td>.modal-header</td>
    <td>Defines the style for the header of the modal</td>
  </tr>
  <tr>
    <td>.modal-body</td>
    <td>Defines the style for the body of the modal</td>
  </tr>
  <tr>
    <td>.modal-footer</td>
    <td>Defines the style for the footer in the modal. <strong>Note:</strong> This area is right-aligned by default. To change this, overwrite CSS with text-align:left|center</td>
  </tr>
  <tr>
    <td>.modal-sm</td>
    <td>Specifies a small modal</td>
  </tr>
  <tr>
    <td>.modal-lg</td>
    <td>Specifies a large modal</td>
  </tr>
  <tr>
    <td>.fade</td>
    <td>Adds an animation/transition effect which fades the modal in and out</td>
  </tr>
</table>
<hr>

<h2>Trigger the Modal Via data-* Attributes</h2>
<p>Add <code class="w3-codespan">data-toggle=&quot;modal&quot;</code> and <code class="w3-codespan">data-target=&quot;#modalID&quot;</code> to 
any element.</p>
<p><strong>Note:</strong> For <code class="w3-codespan">&lt;a&gt;</code> elements, omit <code class="w3-codespan">data-target</code>, and use 
<code class="w3-codespan">href=&quot;#modalID&quot;</code> instead:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;!-- Buttons --&gt;<br>&lt;button type="button" data-toggle=&quot;modal&quot; data-target=&quot;#myModal&quot;&gt;Open Modal&lt;/button&gt;<br><br>&lt;!-- Links --&gt;<br>&lt;a data-toggle=&quot;modal&quot; href=&quot;#myModal&quot;&gt;Open Modal&lt;/a&gt;<br><br>&lt;!-- Other elements --&gt;<br>&lt;p data-toggle=&quot;modal&quot; data-target=&quot;#myModal&quot;&gt;Open Modal&lt;/p&gt;
</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_modal&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_modal_js&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Modal Options</h2>
<p>Options can be passed via data attributes or JavaScript. For data attributes, 
append the option name to data-, as in data-backdrop=&quot;&quot;.</p>
<table class="w3-table-all notranslate">
  <tr>
  ...
  <tr>
    ...
    <td>true</td>
    <td>
 Specifies whether the modal should have a dark overlay:<br><br>
 <ul>
  <li>true - dark overlay</li> 
  <li>false - no overlay (transparent)</li>
 </ul>
 <p>If you specify the value &quot;static&quot;, it is not possible to close the modal when clicking outside of it</p>
  </td>
    <td><a style="margin-bottom:5px;" target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_backdrop&stacked=h">Using JS</a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_backdrop_data&stacked=h">Using data</a></td>
  </tr>
  <tr>
    <td>keyboard</td>
    <td>boolean</td>
    <td>true</td>
    <td>Specifies whether the modal can be closed with the escape key (Esc):<br><br>
    <ul>
  <li>true - the modal can be closed with Esc</li> 
  <li>false - the modal cannot be closed with Esc</li>
 </ul>
  </td>
    <td><a style="margin-bottom:5px;" target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_keyboard&stacked=h">Using JS</a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_keyboard_data&stacked=h">Using data</a></td>
  </tr>
  <tr>
    <td>show</td>
    <td>boolean</td>
    <td>true</td>
    <td>Specifies whether to show the modal when initialized</td>
    <td><a style="margin-bottom:5px;" target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_show&stacked=h">Using JS</a>
    <a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_show_data&stacked=h">Using data</a></td>
  </tr>
</table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.modal(<em>options</em>)</td>
    <td>Activates the content as a modal. See options above for valid values</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_backdrop&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.modal(&quot;toggle&quot;)</td>
    <td>Toggles the modal</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_toggle&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.modal(&quot;show&quot;)</td>
    <td>Opens the modal</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_show_hide&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.modal(&quot;hide&quot;)</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>show.bs.modal</td>
    <td>Occurs when the modal is about to be shown</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_event_show&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>shown.bs.modal</td>
    <td>Occurs when the modal is fully shown (after CSS transitions have completed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_event_shown&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>hide.bs.modal</td>
    <td>Occurs when the modal is about to be hidden</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_event_hide&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>hidden.bs.modal</td>
    <td>Occurs when the modal is fully hidden (after CSS transitions have completed)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_js_modal_event_hidden&stacked=h">Try it</a></td>
    </tr>
</table>
<hr>
...
<h2>More Examples</h2>
<h3>Login Modal</h3>
<p>The following example creates a modal for login:</p>
<div class="w3-example">
 <h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class="container"&gt;<br>&nbsp; &lt;h2&gt;Modal Login Example&lt;/h2&gt;<br>&nbsp; &lt;!-- Trigger the modal with a button --&gt;<br>&nbsp; &lt;button type="button" class="btn btn-default btn-lg" id="myBtn"&gt;Login&lt;/button&gt;<br><br>&nbsp; &lt;!-- Modal --&gt;<br>&nbsp; &lt;div class="modal fade" id="myModal" role="dialog"&gt;<br>&nbsp;&nbsp;&nbsp; &lt;div class="modal-dialog"&gt;<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;!-- Modal content--&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class="modal-content"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class="modal-header"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;button type="button" class="close" data-dismiss="modal"&gt;&amp;times;&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;h4 style="color:red;"&gt;&lt;span class="glyphicon glyphicon-lock"&gt;&lt;/span&gt; Login&lt;/h4&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class="modal-body"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;form role="form"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class="form-group"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;label for="usrname"&gt;&lt;span class="glyphicon glyphicon-user"&gt;&lt;/span&gt; Username&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input type="text" class="form-control" id="usrname" placeholder="Enter email"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class="form-group"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;label for="psw"&gt;&lt;span class="glyphicon glyphicon-eye-open"&gt;&lt;/span&gt; Password&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;input type="text" class="form-control" id="psw" placeholder="Enter password"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class="checkbox"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;label&gt;&lt;input type="checkbox" value="" checked&gt;Remember me&lt;/label&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;button type="submit" class="btn btn-default btn-success btn-block"&gt;&lt;span class="glyphicon glyphicon-off"&gt;&lt;/span&gt; Login&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/form&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;div class="modal-footer"&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;button type="submit" class="btn btn-default btn-default pull-left" data-dismiss="modal"&gt;&lt;span class="glyphicon glyphicon-remove"&gt;&lt;/span&gt; Cancel&lt;/button&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Not a member? &lt;a href="#"&gt;Sign Up&lt;/a&gt;&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;p&gt;Forgot &lt;a href="#"&gt;Password?&lt;/a&gt;&lt;/p&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp;&nbsp;&nbsp; &lt;/div&gt;<br>&nbsp; &lt;/div&gt; <br>&lt;/div&gt;</div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_js_modal2&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
