...
<html lang="en-US">
<head>
<title>Bootstrap CSS Tables Reference</title>
...
<h1>Bootstrap <span class="color_h1">CSS Tables Reference</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_css_images.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_comp_dropdowns.asp">Next &#10095;</a>
</div>
<hr>
<h2>&lt;table&gt; Classes</h2>
<p>Use the classes below to style any table:&nbsp;</p>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_table&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.table-striped</td>
    <td>Adds zebra-striping to any table row within &lt;tbody&gt; (not available in IE8)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_table-striped&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.table-bordered</td>
    <td>Adds border on all sides of the table and cells</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_table-bordered&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.table-hover</td>
    <td>Enables a hover state on table rows within a &lt;tbody&gt;</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_table-hover&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.table-condensed</td>
    <td>Makes table more compact by cutting cell padding in half</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_table-condensed&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td colspan="2"><em>Combining all the table classes</em></td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_table-all&stacked=h">Try it</a></td>
  </tr>
</table>

<h2>&lt;tr&gt;, &lt;th&gt; and &lt;td&gt; Classes</h2>
<p>Use the classes below to color table rows or cells:</p>
<table class="w3-table-all notranslate">
  <tr>
    <th style="width:20%;">Class</th>
    <th style="width:72%;">Description</th>
  ...
  <tr>
    <td>.active</td>
    <td>Applies the hover color (light-grey) to a particular row or cell</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_tr_active&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.success</td>
    <td>Indicates a successful or positive action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_tr_success&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.info</td>
    <td>Indicates a neutral informative change or action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_tr_info&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.warning</td>
    <td>Indicates a warning that might need attention</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_tr_warning&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.danger</td>
    <td>Indicates a dangerous or potentially negative action</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_tr_danger&stacked=h">Try it</a></td>
  </tr>
</table>

<h2>Responsive Tables</h2>
<p>The .table-responsive class creates a responsive table. The table will then 
scroll horizontally on small devices (under 768px). When viewing on anything 
larger than 768px wide, there is no difference:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;div class=&quot;table-responsive&quot;&gt;<br>&nbsp; &lt;table class=&quot;table&quot;&gt;<br>&nbsp;&nbsp;&nbsp; ...<br>&nbsp; &lt;/table&gt;<br>&lt;/div&gt; </div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_table-responsive&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
