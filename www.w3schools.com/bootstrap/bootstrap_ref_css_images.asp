...
<html lang="en-US">
<head>
<title>Bootstrap CSS Images Reference</title>
...
<h1>Bootstrap <span class="color_h1">CSS Images Reference</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="bootstrap_ref_css_helpers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="bootstrap_ref_css_tables.asp">Next &#10095;</a>
</div>
<hr>
<h2>Bootstrap Images</h2>
<div style="float:left;width:33%">
<p>Rounded Corners:</p>
<img src="cinqueterre.jpg" class="img-responsive img-rounded" alt="Cinque Terre" style="width:204px;height:auto;">
</div>
<div style="float:left;width:33%">
<p>Circle:</p>
<img src="cinqueterre.jpg" class="img-responsive img-circle" alt="Cinque Terre" style="width:204px;height:auto;">
</div>
<div style="float:left;width:33%;">
<p>Thumbnail:</p>
<img src="cinqueterre.jpg" class="img-responsive img-thumbnail" alt="Cinque Terre" style="width:204px;height:auto;">
</div>
<div style="clear:both;margin-bottom:20px;"></div>
<hr>

<h2>&lt;img&gt; Classes</h2>
<p>The classes below can be used to style any image:</p>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td>.img-rounded</td>
    <td>Adds rounded corners to an image (not available in IE8)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_img-rounded&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.img-circle</td>
    <td>Shapes the image to a circle (not available in IE8)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_img-circle&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.img-thumbnail</td>
    <td>Shapes the image to a thumbnail</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_img-thumbnail&stacked=h">Try it</a></td>
  </tr>
  <tr>
    <td>.img-responsive</td>
    <td>Makes an image responsive (will scale nicely to the parent element)</td>
    <td><a target="_blank" class="w3-btn btnsmall" href="tryit.asp?filename=trybs_ref_img-responsive&stacked=h">Try it</a></td>
  </tr>
</table>
...
<p>The <code class="w3-codespan">.img-responsive</code> class applies <code class="w3-codespan">max-width: 100%</code>, <code class="w3-codespan">height: auto</code>, 
and <code class="w3-codespan">display:block</code> to the image:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;img src=&quot;cinqueterre.jpg&quot; class=&quot;img-responsive&quot; alt=&quot;Cinque Terre&quot;&gt; </div>
<a target="_blank" href="tryit.asp?filename=trybs_ref_img-responsive&stacked=h" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
