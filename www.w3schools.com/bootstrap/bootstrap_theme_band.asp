...
<div class="w3-padding w3-white text-center">
  <div class="row">
    <div class="col-sm-4">
      <p class="text-center"><strong>Name</strong></p><br>
      <a href="#demo" data-toggle="collapse"><img src="bandmember.jpg" class="img-circle person" alt="Random Name" width="350" height="350"></a>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>Name</strong></p><br>
      <a href="#demo2" data-toggle="collapse"><img src="bandmember.jpg" class="img-circle person" alt="Random Name" width="350" height="350"></a>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>Name</strong></p><br>
      <a href="#demo3" data-toggle="collapse"><img src="bandmember.jpg" class="img-circle person" alt="Random Name" width="350" height="350"></a>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <p style="font-style:italic">Need <a href="#" style="color:#337ab7;text-decoration:none;">help?</a></p>
        </div>
      </div>
...
<h2>Google Maps</h2>
<p>Add Google Maps (For more information, read our
<a href="/graphics/google_maps_intro.asp">Google Maps Tutorial</a>).</p>
<p>Use CSS to set the width, height and color of the map:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;style&gt;<br><span lang="no-bok">#googleMap {<br>&nbsp;&nbsp;&nbsp; width: 100%; /* Span the entire width of the screen */<br>&nbsp;&nbsp;&nbsp; height: 400px; /* Set the height to 400 pixels */<br>&nbsp;&nbsp;&nbsp; -webkit-filter: grayscale(100%);<br>&nbsp;&nbsp;&nbsp; filter: grayscale(100%); /* Change the color of the map to black and white * /<br>}<br>
 &lt;/style&gt;</span><br><br>&lt;!-- Add Google Maps --&gt;<br>&lt;div id=&quot;googleMap&quot;&gt;&lt;/div&gt;<br>
  &lt;script&gt;<br>function myMap() {<br>var myCenter = new google.maps.LatLng(41.878114, 
  -87.629798);<br>var mapProp = {center:myCenter, zoom:12, scrollwheel:false, 
  draggable:false, mapTypeId:google.maps.MapTypeId.ROADMAP};<br>var map = new 
  google.maps.Map(document.getElementById(&quot;googleMap&quot;),mapProp);<br>var marker = 
  new google.maps.Marker({position:myCenter});<br>marker.setMap(map);<br>}<br>
  &lt;/script&gt;<br>&lt;script src=&quot;https://maps.googleapis.com/maps/api/js?key=YOUR_KEY&amp;callback=myMap&quot;&gt;&lt;/script&gt;</div>
<p>Result:</p>
<div id="googleMap" style="height:400px;width:100%; -webkit-filter: grayscale(100%);filter:grayscale(100%)"></div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#myPage" style="text-decoration:none;">HOME</a></li>
        <li><a href="#band" style="text-decoration:none;">BAND</a></li>
        <li><a href="#tour" style="text-decoration:none;">TOUR</a></li>
        <li><a href="#contact" style="text-decoration:none;">CONTACT</a></li>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="text-decoration:none;">MORE
...
<a style="text-decoration:none !important" class="up-arrow" href="#myPage" data-toggle="tooltip" title="TO TOP">
