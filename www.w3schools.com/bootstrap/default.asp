...
<a href="bootstrap_get_started.asp" class="w3-btn w3-padding-large w3-hide-small" style="margin-top:5px">Start learning Bootstrap now &raquo;</a>
<a href="bootstrap_get_started.asp" class="w3-btn w3-block w3-hide-large w3-hide-medium" style="margin-top:5px;padding:8px 16px">Learn Bootstrap</a>
</div>
...
<p><a href="bootstrap_quiz.asp">Start Bootstrap Quiz!</a></p>
<hr>
...
<ul style="margin:24px 0">
  <li><a href="bootstrap_ref_all_classes.asp">Complete List of All Bootstrap Classes<span class="w3-margin-left w3-tag w3-blue">Popular</span></a></li>
  <br>
...
<p class="w3-center"><a href="bootstrap_theme_me.asp" class="w3-btn w3-padding-large w3-dark-grey w3-margin-top" style="min-width:30%">Browse Themes</a></p>
...
<p class="w3-center"><a href="bootstrap_templates.asp" class="w3-btn w3-padding-large w3-dark-grey w3-margin-top" style="min-width:30%">Browse Basic Templates</a></p>
</div>
<hr>

<h2>Bootstrap 3 vs. Bootstrap 4</h2>
<p><a href="/bootstrap4/default.asp">Bootstrap 4</a> is the newest version of Bootstrap; with new components, faster stylesheet and more responsiveness.</p>
...
<div class="w3-panel w3-note">
<p class="margin-bottom-remove"><strong>If you require IE8-9 support, use Bootstrap 3.</strong> It is the most 
...
<a href="/bootstrap4/default.asp" class="w3-btn w3-dark-grey">Go To Bootstrap 4 &raquo;</a>
<hr>

<h2>Did You Know?</h2>
<p>W3.CSS is an excellent alternative to Bootstrap.</p>
