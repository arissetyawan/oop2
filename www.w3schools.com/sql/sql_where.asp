...
<a class="w3-left w3-btn" href="sql_distinct.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_and_or.asp">Next &#10095;</a>
</div>
<hr>
...
<p><strong>Note:</strong> The WHERE clause is not only used in SELECT statement, it is also used in UPDATE,
DELETE statement, etc.!</p>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_where" class="w3-btn w3-margin-bottom">
...
<a target="_blank" href="trysql.asp?filename=trysql_select_where_number" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Exercise:</h2>
<p>Select all records where the <code class="w3-codespan">City</code> column has the value "Berlin".</p>
