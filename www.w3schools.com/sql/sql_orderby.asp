...
<a class="w3-left w3-btn" href="sql_and_or.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_insert.asp">Next &#10095;</a>
</div>
<hr>

<h2>The SQL ORDER BY Keyword</h2>
<p>The ORDER BY keyword is used to sort the result-set in ascending or 
descending order.</p>
...
ORDER BY <em>column1, column2, ... </em>ASC|DESC;</div></div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_orderby" class="w3-btn w3-margin-bottom">
...
<a target="_blank" href="trysql.asp?filename=trysql_select_orderby_desc" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_orderby2" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_orderby3" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<h2>Exercise:</h2>
<p>Select all records from the <code class="w3-codespan">Customers</code> table, sort the result alphabetically by the column <code class="w3-codespan">City</code>.</p>
