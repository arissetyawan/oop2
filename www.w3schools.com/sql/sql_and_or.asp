...
<html lang="en-US">
<head>
<title>SQL AND, OR, NOT Operators</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="sql_where.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_orderby.asp">Next &#10095;</a>
</div>
<hr>

<h2>The SQL AND, OR and NOT Operators</h2>
<p>The WHERE clause can be combined with AND, OR, and NOT operators.</p>
<p>The AND and OR operators are used to filter records based on more than one 
condition:</p>
<ul>
  <li>The AND operator displays a record if all the conditions separated by AND is TRUE.</li>
...
WHERE <em>condition1</em> AND <em>condition2</em> AND <em>condition3 ...</em>;</div></div>
...
SELECT <em>column1</em>,<em> column2, ...</em><br>
FROM <em>table_name</em><br>
WHERE <em>condition1</em> OR <em>condition2</em> OR <em>condition3 ...</em>;</div></div>
...
SELECT <em>column1</em>,<em> column2, ...</em><br>
FROM <em>table_name</em><br>
WHERE NOT <em>condition</em>;</div></div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_where_and" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_where_or" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_where_not" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_where_and_or" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_where_not_and" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Exercise:</h2>
<p>Select all records where the <code class="w3-codespan">City</code> column has the value 'Berlin' and the <code class="w3-codespan">PostalCode</code> column has the value 12209.</p>
