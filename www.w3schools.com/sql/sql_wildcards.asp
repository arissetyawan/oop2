...
<a class="w3-left w3-btn" href="sql_like.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_in.asp">Next &#10095;</a>
</div>
<hr>
<h2>SQL Wildcard Characters</h2>
<p>A wildcard character is used to substitute any other 
character(s) in a string.</p>
<p>Wildcard characters are used with the <a href="sql_like.asp">SQL LIKE</a> operator. 
...
<ul>
  <li>[<em>charlist</em>] - Defines sets and ranges of characters to match</li>
  <li>[^<em>charlist</em>] or [!<em>charlist</em>] - Defines sets and ranges of characters 
  NOT to match</li>
</ul>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_percent" class="w3-btn w3-margin-bottom">
...
<a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_percent_pattern" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_underscore" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<p>The following SQL statement selects all customers with a City starting with 
...
<a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_underscore2" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_charlist&ss=-1" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_charlist2&ss=-1" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_not_charlist&ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_wildcard_not_charlist2&ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Exercise:</h2>
<p>Select all records where the second letter of the <code class="w3-codespan">City</code> is an "a".</p>
