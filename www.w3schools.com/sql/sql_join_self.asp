...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_join_full.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_union.asp">Next &#10095;</a>
</div>
<hr>
<h2>SQL Self JOIN</h2>
...
FROM <em>table1 T1, table1 T2</em><br>
...
<div class="w3-code notranslate sqlHigh">
  ...
  A.City<br>FROM Customers A, Customers B<br>WHERE A.CustomerID &lt;&gt; B.CustomerID<br>
  AND A.City = B.City <br>ORDER BY A.City;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_join_self" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
