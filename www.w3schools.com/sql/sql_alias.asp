...
<a class="w3-left w3-btn" href="sql_between.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_join.asp">Next &#10095;</a>
</div>
<hr>
<h2>SQL Aliases</h2>
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT CustomerID AS ID, CustomerName AS Customer<br>
 FROM Customers;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_alias_column0" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate sqlHigh">
 ...
 FROM Customers;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_alias_column" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate sqlHigh">
  ...
  AS Address<br>
 FROM Customers;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_alias_column2&ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_alias_table" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_alias_no" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h2>Exercise:</h2>
<p>When displaying the <code class="w3-codespan">Customers</code> table,
make an ALIAS of the <code class="w3-codespan">PostalCode</code> column,
the column should be called <code class="w3-codespan">Pno</code> instead.</p>
