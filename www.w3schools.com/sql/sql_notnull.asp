...
<a class="w3-left w3-btn" href="sql_constraints.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_unique.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate sqlHigh">
  ...
  NOT NULL,<br>&nbsp;&nbsp;&nbsp; Age int<br>); </div>
<a target="_blank" href="trysql.asp?filename=trysql_create_constraint_not_null" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel w3-note">
<p><strong>Tip</strong><b>:</b> If the table has already been created, you can add a NOT NULL constraint to
a column with the <a href="sql_alter.asp">ALTER TABLE</a> statement.
</p>
</div>
