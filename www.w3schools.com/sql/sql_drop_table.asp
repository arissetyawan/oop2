...
<html lang="en-US">
<head>
<title>SQL DROP TABLE Statement</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_create_table.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_alter.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate sqlHigh">
  DROP TABLE <em>table_name</em>;</div>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_drop_table" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>SQL TRUNCATE TABLE</h2>
<p>The TRUNCATE TABLE statement is used to delete the data inside a table, but 
not the table itself.</p>

<h3>Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
  TRUNCATE TABLE <em>table_name</em>;</div>
</div>
<hr>
...
<h2>Exercise:</h2>
<p>Write the correct SQL statement to delete a table called <code class="w3-codespan">Persons</code>.</p>
