...
<a class="w3-left w3-btn" href="sql_quickref.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_exercises.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Good luck!</p>
<p><button onclick="document.location='/quiztest/quiztest.asp?qtest=SQL'" class="w3-btn w3-orange w3-text-white" style="margin-top:10px;padding:17px;font-size:17px">Start the SQL Quiz &#10095;</button></p>
</div>
