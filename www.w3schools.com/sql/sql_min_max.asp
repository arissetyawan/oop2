...
<html lang="en-US">
<head>
<title>SQL MIN() and MAX() Functions</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_top.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_count_avg_sum.asp">Next &#10095;</a>
</div>
<hr>
...
SELECT MIN(<em>column_name</em>)<br>
FROM <em>table_name</em><br>
WHERE <em>condition</em>;</div></div>
<h3>MAX() Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT MAX(<em>column_name</em>)<br>
FROM <em>table_name</em><br>
WHERE <em>condition</em>;</div></div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_min" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT MAX(Price) AS LargestPrice<br>FROM Products;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_max" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<h2>Exercise:</h2>
<p>Use the <code class="w3-codespan">MIN</code> function to select the record with the smallest value of the <code class="w3-codespan">Price</code> column.</p>
