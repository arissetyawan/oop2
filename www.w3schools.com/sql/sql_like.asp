...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_count_avg_sum.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_wildcards.asp">Next &#10095;</a>
</div>
<hr>
...
SELECT <em>column1, column2, ...</em><br>
FROM <em>table_name</em><br>
WHERE <em>columnN</em> LIKE <em>pattern</em>;</div></div>

<div class="w3-panel w3-note">
<p><strong>Tip:</strong> You can also combine any number of conditions using AND or OR operators.</p>
</div>
...
<div class="w3-code notranslate sqlHigh">
 ...
 WHERE CustomerName LIKE 'a%';</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_like" class="w3-btn w3-margin-bottom">
...
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
 WHERE CustomerName LIKE '%a'; </div>
<a target="_blank" href="trysql.asp?filename=trysql_select_like_ending" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_like_pattern" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_like_underscore" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<p>The following SQL statement selects all customers with a CustomerName that 
...
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
  WHERE CustomerName LIKE 'a_%_%';</div>
  <a class="w3-btn w3-margin-bottom" href="trysql.asp?filename=trysql_select_like_start_least" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Customers<br>
  WHERE ContactName LIKE 'a%o';</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_like_start_end" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_like_not" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Exercise:</h2>
<p>Select all records where the value of the <code class="w3-codespan">City</code> column starts with the letter "a".</p>
