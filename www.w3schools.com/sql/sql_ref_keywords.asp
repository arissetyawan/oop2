...
<html lang="en-US">
<head>
<title>SQL Keywords Reference</title>
<meta charset="utf-8">
...
<br>
<h2 class="left"><span class="left_h2">SQL</span> Test Yourself</h2>
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_hosting.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_ref_mysql.asp">Next &#10095;</a>
</div>
<hr>
...
<tr>
<td>ADD</td>
<td>Used with ALTER TABLE to add a column in a table</td>
</tr>
<tr>
<td>ADD CONSTRAINT</td>
<td>Used with ALTER TABLE to add a constraint in a table</td>
</tr>
<tr>
<td>ALTER COLUMN</td>
<td>Used with ALTER TABLE to change the data type of a column in a table</td>
</tr>
<tr>
...
<tr>
<td>ALL</td>
<td>Used with WHERE or HAVING and returns true if all subquery values meet a 
condition</td>
</tr>
<tr>
<td>AND</td>
<td>Used with WHERE to only include rows where both conditions is true</td>
</tr>
<tr>
<td>ANY</td>
<td>Used with WHERE or HAVING and returns true if any subquery value meet a 
condition</td>
</tr>
<tr>
<td>AS</td>
<td>Used to rename a column or table with an alias</td>
</tr>
<tr>
<td>ASC</td>
...
<tr>
<td>BETWEEN</td>
<td>Used with WHERE to select values within a given range</td>
</tr>
<tr>
<td>CASE</td>
<td>Used to create different outputs based on conditions</td>
</tr>
<tr>
<td>CHECK</td>
<td>A constraint that is used to limit the value range that can be placed in a 
column</td>
</tr>
<tr>
<td>CREATE DATABASE</td>
<td>Used to create a new SQL database</td>
</tr>
<tr>
<td>CREATE INDEX</td>
<td>Used to create an index on a table (allows duplicate values)</td>
</tr>
<tr>
<td><a href="sql_ref_view.asp">CREATE OR REPLACE VIEW</a></td>
<td>Used to update a view</td>
</tr>
<tr>
<td><a href="sql_ref_create_table.asp">CREATE TABLE</a></td>
<td>Used to create a new table in the database</td>
</tr>
<tr>
<td>CREATE PROCEDURE</td>
<td>Used to create a stored procedure</td>
</tr>
<tr>
<td>CREATE UNIQUE INDEX</td>
<td>Used to create an index on a table (no duplicate values)</td>
</tr>
<tr>
<td><a href="sql_ref_view.asp">CREATE VIEW</a></td>
<td>Used to create a view based on the result set of a SELECT statement</td>
</tr>
<tr>
<td>DEFAULT</td>
<td>A constraint that is used to provide a default value for a column</td>
</tr>
<tr>
<td>DELETE</td>
<td>Used to delete rows from a table</td>
</tr>
<tr>
<td>DESC</td>
...
<td>Used with SELECT to select only distinct (different) values</td>
</tr>
<tr>
<td>DROP COLUMN</td>
<td>Used with ALTER TABLE to delete a column in a table</td>
</tr>
<tr>
<td>DROP CONSTRAINT</td>
<td>Used to delete a constraint</td>
</tr>
<tr>
<td>DROP DATABASE</td>
<td>Used to delete an existing SQL database</td>
</tr>
<tr>
<td>DROP INDEX</td>
<td>Used to delete an index in a table</td>
</tr>
<tr>
<td><a href="sql_ref_drop_table.asp">DROP TABLE</a></td>
<td>Used to delete an existing table in the database</td>
</tr>
<tr>
<td><a href="sql_ref_view.asp">DROP VIEW</a></td>
<td>Used to delete a view</td>
</tr>
<tr>
<td>EXEC</td>
...
<tr>
<td>FROM</td>
<td>Specifies where to select data from</td>
</tr>
<tr>
<td>GROUP BY</td>
<td>Used with aggregate functions (COUNT, MAX, MIN, SUM, AVG) to group the 
result set</td>
</tr>
<tr>
<td>HAVING</td>
...
<tr>
<td>IN</td>
<td>Used with WHERE to specify multiple possible values for a column</td>
</tr>
<tr>
<td>INDEX</td>
<td>&nbsp;</td>
...
<tr>
<td>INSERT INTO</td>
<td>Used to insert new rows in a table</td>
</tr>
<tr>
<td>INSERT INTO SELECT</td>
<td>Used to copy data from one table into another table</td>
</tr>
<tr>
<td>IS NULL</td>
<td>Used with WHERE to test for empty values</td>
</tr>
<tr>
<td>IS NOT NULL</td>
<td>Used with WHERE to test for non-empty values</td>
</tr>
<tr>
<td>LEFT JOIN</td>
<td>Returns all rows from the left table, and the matched rows from the right 
table</td>
</tr>
<tr>
<td>LIKE</td>
<td>Used with WHERE to search for a pattern in a column</td>
</tr>
<tr>
<td>LIMIT</td>
<td>Used to specify the number of records to return in the result set</td>
</tr>
<tr>
<td class="auto-style1">NOT</td>
<td class="auto-style1">Used with WHERE to only include rows where a condition is not true</td>
</tr>
<tr>
<td>NOT NULL</td>
...
<tr>
<td>OR</td>
<td>Used with WHERE to include rows where either condition is true</td>
</tr>
<tr>
<td>ORDER BY</td>
...
<tr>
<td>OUTER JOIN</td>
<td>Returns all records when there is a match in either left or right table</td>
</tr>
<tr>
<td>PRIMARY KEY</td>
...
<tr>
<td>RIGHT JOIN</td>
<td>Returns all records from the right table, and the matched records from the 
left table</td>
</tr>
<tr>
...
<td>Used to select only distinct (different) values</td>
</tr>
<tr>
<td>SELECT INTO</td>
<td>Used to copy data from one table into a new table</td>
</tr>
<tr>
<td>SELECT TOP</td>
<td>Used to specify the number of records to return in the result set</td>
...
<tr>
<td>SET</td>
<td>Used with UPDATE to specify which columns and values that should be updated </td>
</tr>
<tr>
<td><a href="sql_ref_table.asp">TABLE</a></td>
<td>Used to create a table, or add, delete, or modify columns in a table, or 
delete a table, or delete data inside a table</td>
</tr>
<tr>
<td><a href="sql_ref_drop_table.asp">TRUNCATE TABLE</a></td>
<td>Used to delete the data inside a table, but not the table itself</td>
</tr>
<tr>
<td><a href="sql_ref_union.asp">UNION</a></td>
<td>Used to combine the result set of two or more SELECT statements (only 
distinct values)</td>
</tr>
<tr>
<td><a href="sql_ref_union.asp">UNION ALL</a></td>
<td>Used to combine the result set of two or more SELECT statements (allows 
duplicate values)</td>
</tr>
<tr>
<td>UNIQUE</td>
...
<tr>
<td>UPDATE</td>
<td>Used to update existing rows in a table</td>
</tr>
<tr>
<td>VALUES</td>
...
<td>Used to create, update, or delete a view</td>
</tr>
<tr>
<td><a href="sql_ref_where.asp">WHERE</a></td>
<td>Used to filter a result set to include only records that fulfill a specified 
condition</td>
</tr>
</table>
