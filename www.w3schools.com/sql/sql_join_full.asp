...
<a class="w3-left w3-btn" href="sql_join_right.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_join_self.asp">Next &#10095;</a>
</div>
<hr>

<h2>SQL FULL OUTER JOIN Keyword</h2>
<p>The FULL OUTER JOIN keyword return all records when there is a match in 
either left (table1) or right (table2) table records.</p>
<p><strong>Note:</strong> FULL OUTER JOIN can potentially return very large 
result-sets!</p>
...
<div class="w3-code notranslate sqlHigh">
 ...
 FULL OUTER JOIN <em>table2 </em>ON <em>table1.column_name </em>=<em> table2.column_name</em>;</div></div>
