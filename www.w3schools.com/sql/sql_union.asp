...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_join_self.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_groupby.asp">Next &#10095;</a>
</div>
<hr>
...
statements.</p>
<ul>
  <li>Each SELECT statement within UNION must have the same number 
of columns</li>
  <li>The columns must also have similar data types</li>
  <li>The columns in 
each SELECT statement must also be in the same order</li>
</ul>
...
duplicate values, use UNION ALL:</p>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
 SELECT <em>column_name(s)</em> FROM <em>table1</em><br>
 UNION ALL<br>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_union" class="w3-btn w3-margin-bottom">
...
<a target="_blank" href="trysql.asp?filename=trysql_select_union_all" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_union2" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_union_all2" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_union3" class="w3-btn w3-margin-bottom">
 Try it Yourself &raquo;</a>
</div>
