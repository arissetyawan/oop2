...
<a class="w3-left w3-btn" href="sql_wildcards.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_between.asp">Next &#10095;</a>
</div>
<hr>
...
SELECT <em>column_name(s)</em><br>
FROM <em>table_name</em><br>
WHERE <em>column_name</em> IN (<em>SELECT STATEMENT</em>);</div></div>
<hr>
...
<p>The following SQL statement selects all customers that are located in "Germany", "France" and "UK":</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
...
<a target="_blank" href="trysql.asp?filename=trysql_select_in" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_in_not" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_in2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Exercise:</h2>
<p>Use the <code class="w3-codespan">IN</code> operator to select all the records where <code class="w3-codespan">Country</code> is either "Norway" or "France".</p>
