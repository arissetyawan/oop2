...
<p>If a field in a table is optional, it is possible to insert a new record or update a record without adding a value to this 
field. Then, the field will be saved with a NULL value.</p>

<div class="w3-panel w3-note">
<p><b>Note:</b> It is very important to understand that a NULL value is 
different from a zero value or a field that contains spaces. A field with a NULL 
value is one that has been left blank during record creation!</p>
</div>
<hr>
...
WHERE <em>column_name</em> IS NULL;</div></div>

<h3>IS NOT NULL Syntax</h3>
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT <em>column_names<br></em>FROM <em>table_name</em><br>
WHERE <em>column_name</em> IS NOT NULL;</div></div>
<hr>

<h2>Demo Database</h2>
<p>Assume we have the following &quot;Persons&quot; table:</p>
...
<p>Suppose that the &quot;Address&quot; column in the &quot;Persons&quot; table is optional. 
If a record is inserted with no value for 
&quot;Address&quot;, the &quot;Address&quot; column will be saved with a NULL value.</p>
<hr>
...
<p>The following SQL statement uses the IS NULL operator to list all persons 
that have no address:</p>
...
<p>The following SQL statement uses the IS NOT NULL operator to list all persons 
that do have an address:</p>
...
<h2>Exercise:</h2>
<p>Select all records from the <code class="w3-codespan">Customers</code> where the <code class="w3-codespan">PostalCode</code> column is empty.</p>
