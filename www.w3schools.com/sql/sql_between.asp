...
<a class="w3-left w3-btn" href="sql_in.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_alias.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_between" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_not_between" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_between_in" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Products<br>WHERE ProductName BETWEEN 'Carnarvon Tigers' AND 'Mozzarella 
  di Giovanni'<br>ORDER BY ProductName;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_between_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>NOT BETWEEN Text Values Example</h2>
<p>The following SQL statement selects all products with a ProductName NOT BETWEEN 'Carnarvon 
Tigers' and 'Mozzarella di Giovanni':</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
 SELECT * FROM Products<br>WHERE ProductName NOT BETWEEN 'Carnarvon Tigers' AND 'Mozzarella 
  di Giovanni'<br>ORDER BY ProductName;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_not_between_text" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_between_date&ss=-1" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_between_date2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Exercise:</h2>
<p>Use the <code class="w3-codespan">BETWEEN</code> operator to select all the records where the value of the <code class="w3-codespan">Price</code> column is between 10 and 20.</p>
