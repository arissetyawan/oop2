...
<html lang="en-US">
<head>
<title>SQL CREATE VIEW, REPLACE VIEW, DROP VIEW Statements</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_dates.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_injection.asp">Next &#10095;</a>
</div>
<hr>
...
CREATE VIEW [Brazil 
  Customers] AS<br>
SELECT 
  CustomerName, ContactName<br>
FROM Customers<br>
WHERE 
  Country = &quot;Brazil&quot;;</div>
<a target="_blank" href="trysql.asp?filename=trysql_view1" class="w3-btn w3-margin-bottom">
...
SELECT * FROM [Brazil 
  Customers];</div>
<a target="_blank" href="trysql.asp?filename=trysql_view2" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_view3" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" href="trysql.asp?filename=trysql_view4" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
...
<p>A view can be updated with the CREATE OR REPLACE VIEW command.</p>
...
<a target="_blank" href="trysql.asp?filename=trysql_view5" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
<hr>

<h2>SQL Dropping a View</h2>
<p>A view is deleted with the DROP VIEW command.</p>
...
<a target="_blank" href="trysql.asp?filename=trysql_view6" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
