...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_union.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_having.asp">Next &#10095;</a>
</div>
<hr>

<h2>The SQL GROUP BY Statement</h2>
<p>The GROUP BY statement is often used with aggregate functions (COUNT, MAX, 
MIN, SUM, AVG) to group the result-set by one or more columns.</p>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_groupby" class="w3-btn w3-margin-bottom">
  Try it Yourself »</a>
</div>
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
  SELECT COUNT(CustomerID), Country<br>FROM Customers<br>GROUP BY Country<br>
  ORDER BY COUNT(CustomerID) DESC;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_groupby_orderby" class="w3-btn w3-margin-bottom">
  Try it Yourself »</a>
</div>
<hr>
...
<div class="w3-code notranslate sqlHigh">
  ...
  Orders<br>LEFT JOIN Shippers ON Orders.ShipperID = Shippers.ShipperID<br>
  GROUP BY ShipperName;
</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_groupby1" class="w3-btn w3-margin-bottom">
  Try it Yourself »</a>
</div>
<hr>
