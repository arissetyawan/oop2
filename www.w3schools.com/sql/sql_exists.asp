...
<html lang="en-US">
<head>
<title>SQL EXISTS Operator</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_having.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_any_all.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate sqlHigh">
  ...
  Products WHERE SupplierId = Suppliers.supplierId AND Price &lt; 20);</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_exists" class="w3-btn w3-margin-bottom">
...
<div class="w3-code notranslate sqlHigh">
  SELECT SupplierName<br>FROM Suppliers<br>WHERE EXISTS (SELECT ProductName FROM 
  Products WHERE SupplierId = Suppliers.supplierId AND Price = 22);</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_exists2" class="w3-btn w3-margin-bottom">
  Try it Yourself &raquo;</a>
</div>
