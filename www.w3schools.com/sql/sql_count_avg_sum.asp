...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_min_max.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_like.asp">Next &#10095;</a>
</div>
<hr>
...
SELECT COUNT(<em>column_name</em>)<br>
...
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT AVG(<em>column_name</em>)<br>
FROM <em>table_name</em><br>
WHERE <em>condition</em>;</div></div>
...
<div class="w3-example">
<div class="w3-code notranslate sqlHigh">
SELECT SUM(<em>column_name</em>)<br>
FROM <em>table_name</em><br>
WHERE <em>condition</em>;</div></div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_count" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_avg" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate sqlHigh">
SELECT SUM(Quantity)<br>FROM OrderDetails;</div>
<a target="_blank" href="trysql.asp?filename=trysql_select_sum" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Exercise:</h2>
<p>Use the <code class="w3-codespan">COUNT</code> function to count the number of records that have the <code class="w3-codespan">Price</code> value set to 18.</p>
<div class="exerciseprecontainer">
<pre>
SELECT <input name="ex1" maxlength="12" style="width: 128px;">
FROM Products
WHERE Price = 18;
</pre></div>
<br>
