...
<a class="w3-left w3-btn" href="sql_join_inner.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="sql_join_right.asp">Next &#10095;</a>
</div>
<hr>
...
LEFT JOIN <em>table2 </em>ON <em>table1.column_name </em>=<em> table2.column_name</em>;
</div></div>
...
<a target="_blank" href="trysql.asp?filename=trysql_select_join_left" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><strong>Note:</strong> The LEFT JOIN keyword returns all records from the 
