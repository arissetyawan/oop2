...
<html lang="en-US">
<head>
<title>SQL Data Types for MySQL, SQL Server, and MS Access</title>
<meta charset="utf-8">
...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="sql_operators.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn" href="sql_quickref.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">A data type defines what kind of value a column can hold: 
...
<table class="w3-table-all notranslate">
    ...
    <tr>
      <td>DATETIME()</td>
      <td>*A date and time combination. Format: YYYY-MM-DD HH:MI:SS<p><b>Note:</b> The supported range is from '1000-01-01 00:00:00' to '9999-12-31 23:59:59'</p></td>
    </tr>
    <tr>
      <td>TIMESTAMP()</td>
      <td>*A timestamp. TIMESTAMP values are stored as the number of seconds since the Unix epoch ('1970-01-01 00:00:00' UTC). Format: YYYY-MM-DD   HH:MI:SS<p><b>Note:</b> The supported range is from '1970-01-01 00:00:01'   UTC to '2038-01-09 03:14:07' UTC</p></td>
    </tr>
    <tr>
      <td>TIME()</td>
      <td>A time. Format: HH:MI:SS<p><b>Note:</b> The supported range is from '-838:59:59' to '838:59:59'</p></td>
    </tr>
    <tr>
      <td>YEAR()</td>
      <td>A year in two-digit or four-digit format.
      <p><b>Note:</b> Values allowed in four-digit format: 1901 to 2155. Values allowed in two-digit format: 70 to 69, representing years from 1970 to  2069</p></td>
    </tr>
</table>
...
like YYYYMMDDHHMISS, YYMMDDHHMISS, YYYYMMDD, or YYMMDD.</p>
<hr>
