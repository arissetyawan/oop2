...
<p>The <strong>w3-panel</strong> class is the perfect class to display alerts.</p>
...
<h2>Alerts in Other Colors</h2>
<p>Alerts are often displayed in a strong color, but any color can be used:</p>
<div class="w3-row-padding" style="margin:0px -16px">
<div class="w3-third">
<div class="w3-panel w3-pale-red">
<h3>Danger!</h3>
<p>Here w3-pale-red is used.</p>
</div>
...
<h3>Warning!</h3>
<p>Here w3-pale-yellow is used.</p>
</div>
<div class="w3-panel w3-orange w3-text-white">
<h3>w3-orange</h3>
</div>
</div>
<div class="w3-third">
...
<h3>Success!</h3>
<p>Here w3-pale-green is used.</p>
</div>
