...
<h2 class="w3-display-bottomleft w3-container">W3.CSS Version 4</h2>
</div>

<p>W3.CSS version 4 was released March 24. 2017.</p>
<p>Here are some design highlights:</p>
<ul class="w3-ul w3-green">
  <li>Twice as fast as version 3</li>
  <li>Redesigned to allow for separation of the color library</li>
  <li>Redesigned to allow for a smaller and faster mobile version</li>
</ul>
<p>Version 4 can be downloaded from <a href="w3css_downloads.asp">W3.CSS Downloads</a>.</p>
<div class="w3-panel w3-note">
  <p>Version 4 is now the default style sheet used in all the pages of W3Schools.</p>
</div>

<hr>

<h2>W3.CSS - Pro</h2>
<p>Version 4 comes with a professional version: <strong>w3pro.css</strong>.</p>
