...
<a class="w3-left w3-btn w3-green" href="whatis_json.asp">&#10094; Previous</a>
<a class="w3-right w3-btn w3-green" href="whatis_bootstrap.asp">Next &#10095;</a>
</div>

<hr>
<div class="w3-cell-row w3-card-2">
<div class="w3-cell w3-white w3-hide-small w3-center" style="padding:16px;width:150px">
 <i class="fa fa-car" style="font-size:32px;"></i><br>
 <i class="fa fa-car w3-text-dark-grey" style="font-size:64px;"></i><br>
 <i class="fa fa-car w3-text-red" style="font-size:96px;"></i>
</div>
<div class="w3-cell w3-container w3-light-gray w3-border-left w3-cell-top" style="padding:20px;">
<p>Icons come in scalable vector libraries that can be customized with CSS</p>
<p>Common libraries are:</p>
<ul>
...
<div class="w3-half">
<i class="fa fa-cloud w3-text-grey" style="font-size:36px;"></i>
<i class="fa fa-cloud w3-text-dark-grey" style="font-size:60px;"></i>
<i class="fa fa-cloud w3-text-black" style="font-size:72px;"></i>
</div>
<div class="w3-half">
<i class="fa fa-thumbs-o-up" style="font-size:36px;"></i>
<i class="fa fa-thumbs-o-up w3-text-green" style="font-size:60px;"></i>
...
<h2>How To?</h2>
<p>To use icons, just add a link to the icon library the <code class="w3-codespan">
&lt;head&gt;</code> section of your HTML page:</p>
<div class="w3-panel w3-note">
<p>No downloads or installations required!</p>
</div>

<p>To insert an icon, add the name of the icon class to any inline HTML element
like <code class="w3-codespan">&lt;i&gt;</code> or <code class="w3-codespan">&lt;span&gt;</code>.</p>
...
<h3>Font Awesome Example</h3>
 <div class="w3-code notranslate htmlHigh">
   ...
   &lt;/head&gt;<br>&lt;body&gt;<br><br>&lt;i class="fa fa-cloud"&gt;&lt;/i&gt;<br>&lt;i class="fa 
   fa-heart"&gt;&lt;/i&gt;<br>&lt;i class="fa fa-car"&gt;&lt;/i&gt;<br>&lt;i class="fa fa-file"&gt;&lt;/i&gt;<br>
   &lt;i class="fa fa-bars"&gt;&lt;/i&gt;<br><br>
   &lt;/body&gt;<br>&lt;/html&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_icons_awesome" target="_blank">
  Try It Yourself »</a>
</div>
<div class="w3-panel w3-note">
<p>For a complete list of icons (Font Awesome, Bootstrap and Google), visit W3School's
<a href="/icons/icons_reference.asp">Icon Reference</a>.</p>
</div>
...
<div class="w3-code notranslate htmlHigh">
  ...
  &lt;/head&gt;<br>&lt;body&gt;<br>
  <br>&lt;i class="glyphicon glyphicon-cloud"&gt;&lt;/i&gt;<br>&lt;i class="glyphicon 
  glyphicon-remove"&gt;&lt;/i&gt;<br>&lt;i class="glyphicon glyphicon-user"&gt;&lt;/i&gt;<br>&lt;i 
  class="glyphicon glyphicon-envelope"&gt;&lt;/i&gt;<br>&lt;i class="glyphicon 
  glyphicon-thumbs-up"&gt;&lt;/i&gt;<br><br>
  &lt;/body&gt;<br>&lt;/html&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_icons_bootstrap" target="_blank">
  Try It Yourself »</a></div>
...
<div class="w3-code notranslate htmlHigh">
  &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>
     &lt;link rel="stylesheet" 
  href="https://fonts.googleapis.com/icon?family=Material+Icons"&gt;<br>&lt;/head&gt;<br>
  &lt;body&gt;<br>
  <br>&lt;i class="material-icons"&gt;cloud&lt;/i&gt;<br>&lt;i 
  class="material-icons"&gt;favorite&lt;/i&gt;<br>&lt;i 
  class="material-icons"&gt;attachment&lt;/i&gt;<br>&lt;i 
  class="material-icons"&gt;computer&lt;/i&gt;<br>&lt;i class="material-icons"&gt;traffic&lt;/i&gt;<br><br>
  &lt;/body&gt;<br>&lt;/html&gt;
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_icons_google" target="_blank">
  Try It Yourself »</a>
</div>

<hr>
<h2>Full Icons Tutorial</h2>
<p>This has been a short description of Icons.</p>
<p>For a full Icons tutorial go to <a href="/icons/default.asp" >W3Schools Icons Tutorial</a>.</p>
<p>For a full Icons reference go to <a href="/icons/icons_reference.asp" >W3Schools Icons Reference</a>.</p>
