...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn w3-green" href="whatis_ajax.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn w3-green" href="whatis_icons.asp">Next &#10095;</a>
</div>

<hr>
<div class="w3-cell-row w3-card-2">
<div class="w3-cell w3-white w3-hide-small w3-center" style="padding:16px;width:150px">
  <img class="w3-img" alt="HTML" src="img_json.jpg" style="width:110px">
  <div class="w3-center w3-xlarge"><b>JSON</b></div> 
</div>
...
<h3>JSON Example</h3>
<p>This example defines an employees object: an array of 3 employee records (objects):</p>
...
<p><a class="w3-btn" href="/js/js_json_intro.asp">Learn JSON Now!</a></p>
</div>
...
<p>
<a target="_blank" class="w3-btn" href="tryit.asp?filename=trywhatis_json_parse">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<h2>Full JSON Tutorial</h2>
<p>This has been a short description of JSON.</p>
<p>For a full JSON tutorial go to <a href="/js/js_json_intro.asp" >W3Schools JSON Tutorial</a>.</p>
