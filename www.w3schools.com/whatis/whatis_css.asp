...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn w3-green" href="whatis_html.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn w3-green" href="whatis_js.asp">Next &#10095;</a>
</div>

<hr>
<div class="w3-cell-row w3-card-2">
<div class="w3-cell w3-white w3-hide-small w3-center" style="padding:16px;width:150px">
  <img class="w3-img"alt="HTML" src="img_css.jpg" style="width:110px">
</div>
...
<p>CSS describes how <b>HTML</b> elements are to be <b>displayed</b></p>
</div>
</div>
<hr>
<h2>CSS Demo - One HTML Page - Multiple Styles!</h2>
<p>Here we will show one HTML page displayed with 4 different stylesheets.</p>
<p>Click on the Stylesheet buttons (1-4) too see the page displayed with different styles.</p>

<div class="w3-example" style="text-align:center;padding:30px;">
<iframe style="width:100%;height:900px;background:#ffffff;border:none;" src="demo_css.htm"></iframe>
</div>
<hr>
...
<p>The selector points to the HTML element you want to style (h1).</p>
<p>The declaration block (surrounded by curly braces) contains one or more declarations separated by 
semicolons.</p>
<p>Each declaration includes a CSS property name and a value, separated by a colon.</p>
<p>In the following example all &lt;p&gt; elements will be 32px wide, center-aligned, 
and with red:</p>
...
{<br>
&nbsp;&nbsp;&nbsp;
  font-size: 32px;<br>&nbsp;&nbsp;&nbsp; color: red;<br>
&nbsp;&nbsp;&nbsp;
text-align: center;<br>
}
</div>
<a target="_blank" href="tryit.asp?filename=trywhatis_css" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code htmlHigh notranslate">
  &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br><br>&lt;style&gt;<br>body {background-color: orange;}<br>h1 
  {color: white;}<br>p {font-size: 20px;}<br>&lt;/style&gt;<br><br>&lt;body&gt;<br><br>&lt;h1&gt;My First CSS Example&lt;/h1&gt;<br>&lt;p&gt;This is 
  a paragraph.&lt;/p&gt;<br>&lt;p style=&quot;font-family:helvetica&quot;&gt;This is a paragraph.&lt;/p&gt;<br>
  &lt;p style=&quot;font-family:verdana&quot;&gt;This is a paragraph.&lt;/p&gt;<br><br>&lt;/body&gt;<br>
  &lt;/html&gt;
</div>
<p><a href="tryit.asp?filename=trywhatis_css_2" target="_blank"
class="w3-button w3-theme w3-hover-green w3-hover-shadow">Try it Yourself &raquo;</a>
</p>
</div>

<hr>
<h2>Full CSS Tutorial</h2>
<p>This has been a short description of CSS.</p>
<p>For a full CSS tutorial go to <a href="/css/default.asp" >W3Schools CSS Tutorial</a>.</p>
<p>For a full CSS reference go to <a href="/cssref/default.asp" >W3Schools CSS Reference</a>.</p>
