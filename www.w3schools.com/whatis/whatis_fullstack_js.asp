...
<html lang="en-US">
<head>
<title>What is Fullstack JavaScript</title>
<meta charset="utf-8">
...
<h1>What is Fullstack JavaScript?</h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn w3-green" href="whatis_fullstack.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn w3-green" href="whatis_sql.asp">Next &#10095;</a>
</div>
...
<p>Javascript has been around for over 20 years. It is the dominant programming language in web development.
<p>In the beginning JavaScript was a language for the web client (browser).
Then came the ability to use JavaScript on the web server (with Node.js).</p>
<p>Today a the hottest buzzword is "Full Stack JavaScript".</p>

<p>The idea of "Full Stack JavaScript" is that all sotware in a web application, both client side and server side,
should be written using JavaScript only.</p>
<div class="w3-panel w3-center w3-sand w3-card">
...
<p>A full stack JavaScript developer is a person who can develop both <b>client</b> and <b>server</b> software.</p>
<p>In addition to mastering HTM and CSS, he/she also knows how to:</p>
<ul>
...
<div class="w3-row">
<div class="w3-half">
<h2>Client Software<br>(Front End)</h2>
<ul>
<li><a href="whatis_html.asp">HTML</a></li>
<li><a href="whatis_css.asp">CSS</a></li>
<li><a href="whatis_bootstrap.asp">Bootstrap</a></li>
<li><a href="whatis_w3css.asp">W3.CSS</a></li>
<li><a href="whatis_js.asp">JavaScript</a></li>
<li><a href="whatis_es5.asp">ES5</a></li>
<li><a href="whatis_htmldom.asp">HTML DOM</a></li>
<li><a href="whatis_json.asp">JSON</a></li>
<li><a href="whatis_xml.asp">XML</a></li>
<li><a href="/jquery/default.asp">jQuery</li>
<li><a href="whatis_angularjs.asp">Angular</a></li>
<li><a href="whatis_react.asp">React</a></li>
<li>Backbone.js</li>
<li>Express.js</li>
<li>Ember.js</li>
<li>Redux</li>
<li><a target="_blank" href="https://storybook.js.org/basics/quick-start-guide/">Storybook</a></li>
<li>GraphQL</li>
<li>Meteor.js</li>
<li>Grunt</li>
<li>Gulp</li>
...
<div class="w3-half">
<h2>Server Software<br>(Back End)</h2>
<ul>
<li><s><a href="/php/default.asp">PHP</a></s></li>
<li><s><a href="/asp/default.asp">ASP</a></s></li>
<li><s>C++</s></li>
<li><s>C#</s></li>
<li><s>Java</s></li>
<li><s><a href="/python/default.asp">Python</a></s></li>
<li><a href="/nodejs/default.asp">Node.js</a></li>
<li>Ruby</li>
<li>REST</li>
<li>GO</li>
<li><a href="whatis_sql.asp">SQL</a></li>
<li><a href="/nodejs/nodejs_mongodb.asp">MongoDB</a></li>
<li>Firebase.com</li>
<li>Sass</li>
<li>Less</li>
<li>Parse.com</li>
<li>PaaS (Azure and Heroko)</li>
</ul>
</div>
</div>
<hr>

<h2>Full Stack JavaScript Benefits</h2>
<ul class="w3-ul">
<li>Code reuse. Shared libraries, templates, and models.</li>
<li>Best practice accumulated by 20 years of JavaScript.</li>
<li>JavaScript is an evolving standard with a bright future.</li>
<li>Good tutorials. Easy to learn.</li>
<li>No compilation!!! Faster development.</li>
<li>Great distrubution: npm.</li>
<li>GitHub repository. Git workflow.</li>
</ul>
