...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn w3-green" href="whatis_css.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn w3-green" href="whatis_es5.asp">Next &#10095;</a>
</div>

<hr>
<div class="w3-cell-row w3-card-2">
<div class="w3-cell w3-white w3-hide-small w3-center" style="padding:16px;width:150px">
  <img class="w3-img" alt="HTML" src="img_js.png" style="width:110px">
</div>
...
<p>JavaScript can <b>calculate</b>, <b>manipulate</b> and <b>validate</b> data</p>
</div>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_js_inner_html">Try it Yourself &raquo;</a>
</div>
...
<img id="myImage" border="0" src="img_bulboff.gif" style="width:100px">
<button onclick="document.getElementById('myImage').src='img_bulboff.gif'">Turn off the light</button>
</div>
<p>
<a class="w3-btn" href="tryit.asp?filename=trywhatis_js_lightbulb" target="_blank">Try it Yourself &raquo;</a>
</p>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_js_style">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_js_hide" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
 document.getElementById(&quot;demo&quot;).style.display = "block";<br>or<br>document.getElementById('demo').style.display = 
  'block';</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trywhatis_js_show" target="_blank">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Full JavaScript Tutorial</h2>
<p>This has been a short description of JavaScript.</p>
<p>For a full JavaScript tutorial go to <a href="/js/default.asp" >W3Schools JavaScript Tutorial</a>.</p>
<p>For a full JavaScript reference go to <a href="/jsref/default.asp" >W3Schools JavaScript Reference</a>.</p>
