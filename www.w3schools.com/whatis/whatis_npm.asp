...
<a class="w3-left w3-btn w3-green" href="whatis_cli.asp">&#10094; Previous</a>
<a class="w3-right w3-btn w3-green" href="whatis_github.asp">Next &#10095;</a>
</div>

<hr>
<div class="w3-cell-row w3-card-2">
<div class="w3-cell w3-white w3-center w3-hide-small" style="width:150px">
  <img class="w3-img" alt="HTML" src="img_npm.jpg" style="width:130px">
</div>
<div class="w3-cell w3-container w3-light-gray w3-border-left w3-cell-top" style="padding:20px;">
<p><b>npm</b> is the world's largest <b>Software Library</b> (Registry)</p>
<p><b>npm</b> is also a software <b>Package Manager</b> and <b>Installer</b></p>
</div>
</div>

<hr>
<h2>The World's Largest Software Registry (Library)</h2>
<p><b>npm</b> is the world's largest <b>Software Registry</b>.</p>
<p>The registry contains over 800,000 <b>code packages</b>.</p>
<p><b>Open-source</b> developers use <b>npm</b> to <b>share</b> software.</p>
<p>Many organizations also use npm to manage private development.</p>

<hr>
<h2>Using npm is Free</h2>
<p><b>npm</b> is free to use.</p>
<p>You can download all npm public sowtware packages without any registration or logon.</p>

<hr>
<h2>Command Line Client</h2>
<p><b>npm</b> includes a <b>CLI</b> (Command Line Client) that can be used to download and install software:</p> 
...
<p><b>npm</b> is installed with <b>Node.js</b></p>
<p>This means that you have to install Node.js to get npm installed on your computer.</p>
<p>Download Node.js from the official Node.js web site:
<a target="_blank" href="https://nodejs.org/">https://nodejs.org</a></p>

<hr>
<h2>Software Package Manager</h2>
<p>The name <b>npm</b> (Node Package Manager) stems from when npm first was created as a package manager for Node.js.</p>
<p>All <b>npm</b> packages are defined in files called <b>package.json</b>. </p>
<p>The content of package.json must be written in <b>JSON</b>.</p>
<p>At least two fields must be present in the definition file: <b>name</b> and <b>version</b>.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate w3-black w3-large">
{<br>
...
<p><b>npm</b> can manage <b>dependencies</b>.</p>
<p><b>npm</b> can (in one command line) install all the dependencies of a project.</p>
<p>Dependencies are also defined in <b>package.json</b>.</p>

<hr>
<h2>Sharing Your Software</h2>
<p>If you want to share your own software in the <b>npm registry</b>, you can sign in at:</p>
<p><a target="_blank" href="https://www.npmjs.com">https://www.npmjs.com</a></p>

<hr>
<h2>Publishing a Package</h2>
<p>You can publish <b>any directory</b> from your computer as long as the directory has a <b>package.json file</b>.</p>
<p>Check if npm is installed:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black w3-large">
C:\&gt;npm
</div>
...
<p>Check if you are logged in:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black w3-large">
C:\&gt;npm whoami
</div>
...
<div class="w3-example">
<div class="w3-code notranslate w3-black w3-large">
C:\&gt;npm login<br>Username: &lt;your username&gt;<br>Password: &lt;your password&gt;
</div>
</div>

<p>Navigate to your project and publish your project:</p>
<div class="w3-example">
<div class="w3-code notranslate w3-black w3-large">
C:\Users\myuser&gt;cd myproject<br>
