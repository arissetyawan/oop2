...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn w3-green" href="whatis_htmldom.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn w3-green" href="whatis_ajax.asp">Next &#10095;</a>
</div>
<hr>

<div class="w3-cell-row w3-card-2">
<div class="w3-cell w3-container w3-white w3-hide-small w3-center" style="padding:16px;width:150px">
  <img class="w3-img" alt="HTML" src="img_xml.jpg" style="width:110px">
</div>
<div class="w3-cell w3-container w3-light-gray w3-border-left w3-cell-top" style="padding:20px;">
<p>XML plays an important role in many different IT systems</p>
<p>XML is often used for distributing data over the Internet</p>
<p>It is important for all web developers to have a good understanding of XML</p>
</div>
</div>
...
<p>
<a href="javascript:void(0)" onclick="displayXML('note.xml')" class="w3-btn">Display the XML File &raquo;</a>
<a href="javascript:void(0)" onclick="loadXMLDoc()" class="w3-btn">Display the XML File as a Note &raquo;</a>
</p>
</div>
...
<p>
<a href="javascript:void(0)" onclick="displayXML('simple.xml')" class="w3-btn">Display the XML File &raquo;</a>
<a href="simple.xml" target="_blank "class="w3-btn">Open the XML File &raquo;</a>
<a target="_blank" href="simplexsl.xml" class="w3-btn">Display with XSLT &raquo;</a>
</p>
</div>
...
<hr>
<h2>Full XML Tutorial</h2>
<p>This has been a short introduction to XML.</p>
<p>For a full XML tutorial go to <a href="/xml/default.asp" >W3Schools XML Tutorial</a>.</p>
<br>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn w3-green" href="whatis_htmldom.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn w3-green" href="whatis_ajax.asp">Next &#10095;</a>
