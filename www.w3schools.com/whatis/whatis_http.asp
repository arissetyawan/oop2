...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn w3-green" href="default.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn w3-green" href="whatis_html.asp">Next &#10095;</a>
</div>
<hr>

<div class="w3-cell-row w3-card-2">
<div class="w3-cell w3-white w3-hide-small w3-center" style="padding:16px;width:150px">
  <img class="w3-img" alt="HTML" src="img_http.jpg" style="width:110px">
</div>
<div class="w3-cell w3-container w3-light-gray w3-border-left w3-cell-top" style="padding:20px;">
<p><b>HTTP</b> stands for <b>H</b>yper <b>T</b>ext <b>T</b>ransfer <b>P</b>rotocol</p>
<p><b>WWW</b> is about communication between web <b>clients</b> and <b>servers</b></p>
<p>Communication between clients and servers is done by <b>requests</b> and <b>responses</b></p>
</div>
</div>
...
<p>The World Wide Web is about communication between web <strong>clients</strong> and 
web <strong>servers</strong>.</p>
<p><strong>Clients</strong> are often browsers (Chrome, Edge, Safari), but they
can be any type of program or device. </p>
<p><strong>Servers</strong> are most often computers in the cloud.</p>
<hr>

<div class="w3-row">
<div class="w3-col m4 w3-center">
<i class="fa fa-desktop" style="font-size:70px"></i>
<i class="fa fa-arrows-h" style="font-size:70px"></i>
<br>Web Client
</div>
<div class="w3-col m4 w3-center">
<i class="fa fa-mixcloud" style="font-size:70px"></i>
<i class="fa fa-arrows-h" style="font-size:70px"></i>
<br>Cloud
</div>
<div class="w3-col m4 w3-center">
...
<p>Communication between clients and servers is done by <b>requests</b> and <b>responses</b>:</p>
<ol>
<li>A client (a browser) sends an <strong>HTTP request</strong> to the web</li>
<li>An web server receives the request</li>
<li>The server runs an application to process the request</li>
<li>The server returns an <strong>HTTP response</strong> (output) to the browser</li>
