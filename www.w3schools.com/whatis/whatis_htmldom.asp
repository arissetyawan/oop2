...
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn w3-green" href="whatis_es5.asp">&#10094; Previous</a>
  <a class="w3-right w3-btn w3-green" href="whatis_xml.asp">Next &#10095;</a>
</div>
<hr>
...
<p>The <b>HTML DOM</b> is an <b>Object Model</b> for <b>HTML</b>. It defines:</p>
<ul>
  <li>HTML elements as <b>objects</b>
  <li><b>Properties</b> for all HTML elements
  <li><b>Methods</b> for all HTML elements</li>
  <li><b>Events</b> for all HTML elements</li>
</ul>
</div>
</div>
<hr>
<div class="w3-cell-row w3-card-2">
<div class="w3-cell w3-white w3-hide-small w3-center" style="padding:16px;width:150px">
  <img class="w3-img" alt="HTML" src="img_js.png" style="width:110px"><br>
</div>
<div class="w3-cell w3-container w3-light-gray w3-border-left w3-cell-top" style="padding:20px;">
<p>The <b>HTML DOM</b> is an <b>API</b> (Programming Interface) for <b>JavaScript</b>:</p>
<ul>
...
<h3 class="w3-center">The HTML DOM Tree of Objects</h3>
<div class="w3-padding w3-white w3-center w3-margin-bottom notranslate">
<img style="max-width:100%" src="img_htmltree.gif" alt="DOM HTML tree">
</div>
</div>

<hr>
<h2>Finding HTML Elements</h2>
<p>When you want to access HTML elements with JavaScript, you have to find the elements first.</p>
...
<a class="w3-btn w3-margin-bottom" href="/js/tryit.asp?filename=tryjs_dom_getelementbyid" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="/js/tryit.asp?filename=tryjs_dom_getelementsbytagname2" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="/js/tryit.asp?filename=tryjs_dom_getelementsbytagname" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="/js/tryit.asp?filename=tryjs_dom_getelementsbyclassname" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="/js/tryit.asp?filename=tryjs_dom_queryselectorall" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>HTML object collections are also accessible:</p>
<ul>
  <li><a target="_blank" href="/js/tryit.asp?filename=tryjs_doc_anchors">document.anchors</a></li>
  <li><a target="_blank" href="/js/tryit.asp?filename=tryjs_doc_forms">document.forms</a></li>
  <li><a target="_blank" href="/js/tryit.asp?filename=tryjs_doc_images">document.images</a></li>
  <li><a target="_blank" href="/js/tryit.asp?filename=tryjs_doc_links">document.links</a></li>
  <li><a target="_blank" href="/js/tryit.asp?filename=tryjs_doc_scripts">document.scripts</a></li>
</ul>

<br>
<a href="/js/js_htmldom.asp" class="w3-button w3-block w3-theme w3-hover-green w3-hover-shadow">HTML DOM Tutorial</a>
<hr>
<h2>Full HTMLDOM Tutorial</h2>
<p>This has been a short introduction to HTMLDOM.</p>
<p>For a full HTMLDOM tutorial go to <a href="/js/js_htmldom.asp" >W3Schools HTMLDOM Tutorial</a>.</p>
