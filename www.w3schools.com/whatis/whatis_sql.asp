...
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="whatis_fullstack_js.asp">&#10094; Previous</a>
...
<div class="w3-cell w3-white w3-hide-small w3-center" style="padding:16px;width:150px">
  <img class="w3-img" alt="HTML" src="img_sql.jpg" style="width:110px">
</div>
<div class="w3-cell w3-container w3-light-gray w3-border-left w3-cell-top" style="padding:20px;">
<p>SQL stands for <b>S</b>tructured <b>Q</b>uery <b>L</b>anguage</p>
<p>SQL is a standard language for accessing databases</p>
<p>SQL has been an international standard (ISO) since 1987</p>
</div>
</div>

<hr>
<h2>SQL Statements</h2>
<p>To access a database, you use SQL statements.</p>
<p>The following SQL statement selects all records in a database table called "Customers":</p>
...
<a target="_blank" href="/sql/trysql.asp?filename=trysql_select_all" class="w3-btn w3-margin-bottom">
  Try it Yourself »</a>
</div>

<hr>
<h2>Database Tables</h2>
<p>A database most often contains one or more tables.</p>
<p>Each table is identified by a name like "Customers" or "Orders".<p>
<p>Below is a selection from a "Customers" table:</p>
...
<hr>
<h2>The Most Important SQL Statements:</h2>
<ul>
...
<div class="w3-panel w3-note">
  <p>SQL keywords are NOT case sensitive: select is the same as SELECT</p>
</div>

<hr>
<h2>Full SQL Tutorial</h2>
<p>This has been a short introduction to SQL.</p>
<p>For a full SQL tutorial go to <a href="/sql/default.asp" >W3Schools SQL Tutorial</a>.</p>
