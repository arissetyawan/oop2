...
<a class="w3-left w3-btn w3-green" href="whatis_react.asp">&#10094; Previous</a>
<a class="w3-right w3-btn w3-green" href="whatis_fullstack.asp">Next &#10095;</a>
</div>

<hr>
<div class="w3-cell-row w3-card-2">
<div class="w3-cell w3-white w3-hide-small w3-center" style="padding:16px;width:150px">
<img class="w3-margin-bottom" src="img_vue.jpg" alt="Vue" style="width:110px">
</div>
<div class="w3-cell w3-container w3-light-gray w3-border-left w3-cell-top" style="padding:20px;">
<p>Vue.js lets you <b>extend</b> HTML with HTML attributes called <b>directives</b></p>
<p>Vue.js directives offers <b>functionality</b> to HTML applications</p>
<p>Vue.js provides <b>built-in</b> directives and <b>user defined</b> directives</p>
</div>
</div>

<hr>
<h2>Vue.js Directives</h2>
<p>Vue.js uses double braces <code class="w3-codespan"><b>{{ }}</b></code> as place-holders for data.</p>
<p>Vue.js directives are HTML attributes with the prefix <code class="w3-codespan"><b>v-</b></code></p>
<hr>
<h2>Vue Example</h2>

<p>In the example below, a new Vue object is created with <b>new Vue()</b>.</p>
<p>The property <strong>el: '#app'</strong> binds the new Vue object to the HTML 
element with <strong>id=&quot;app&quot;</strong>.</p>
...
<div class="jsHigh">
var myObject = new Vue({<br>
&nbsp;&nbsp;&nbsp; el: '#app',<br>
&nbsp;&nbsp;&nbsp; data: {message: 'Hello Vue!'}<br>})<br>
</div>

<div class="htmlHigh">&lt;/script&gt;</div>
</div>
<p><a href="tryit.asp?filename=trywhatis_vue" target="_blank"
class="w3-button w3-theme w3-hover-green w3-hover-shadow">TTry it Yourself &raquo;</a></p>
</div>


<hr>
<h2>Vue.js Binding</h2>
<p>When a Vue object is bound to an HTML element, the HTML element will change 
when the Vue object changes:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate">
...
var myObject = new Vue({<br>
&nbsp;&nbsp;&nbsp; el: '#app',<br>
&nbsp;&nbsp;&nbsp; data: {message: 'Hello Vue!'}<br>})<br><br>function 
  myFunction() {<br>&nbsp;&nbsp;&nbsp; myObject.message = &quot;John Doe&quot;;<br>}<br>
</div>

<div class="htmlHigh">&lt;/script&gt;</div>
</div>
<p><a href="tryit.asp?filename=trywhatis_vue_1" target="_blank"
class="w3-button w3-theme w3-hover-green w3-hover-shadow">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Vue.js Two-Way Binding</h2>
<p>The <code class="w3-codespan"><b>v-model</b></code> directive binds the value of HTML elements to application data.</p>
...
<div class="htmlHigh">
&lt;div id=&quot;app&quot;&gt;<br>
&nbsp; &lt;p&gt;{{ message }}&lt;/p&gt;<br>&nbsp; &lt;p&gt;&lt;input v-model=&quot;message&quot;&gt;&lt;/p&gt;<br>
&lt;/div&gt;<br><br>
&lt;script&gt;
</div>
...
<p><a href="tryit.asp?filename=trywhatis_vue_2" target="_blank"
class="w3-button w3-theme w3-hover-green w3-hover-shadow">Try it Yourself &raquo;</a></p>
</div>
<hr>
<h2>Vue.js Loop Binding</h2>
<p>Using the <code class="w3-codespan"><b>v-for</b></code> directive to bind
an array of Vue objects to an "array" of HTML element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate">
...
<div class="htmlHigh">
&lt;div id=&quot;app&quot;&gt;<br>
&nbsp;&lt;ul&gt;<br>&nbsp;&nbsp; &lt;li v-for=&quot;x in todos&quot;&gt;<br>&nbsp;&nbsp; {{ 
  x.text }}<br>&nbsp;&nbsp; &lt;/li&gt;<br>&nbsp; &lt;/ul&gt;<br>&lt;/div&gt;<br><br>&lt;script&gt;
</div>

<div class="jsHigh">
  myObject =
  new Vue({<br>&nbsp;&nbsp;&nbsp; el: '#app',<br>&nbsp;&nbsp;&nbsp; data: {<br>&nbsp;&nbsp;&nbsp; 
  todos: [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; { text: 'Learn 
  JavaScript' },<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; { text: 'Learn 
  Vue.js' },<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; { text: 'Build 
  Something Awesome' }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ]<br>&nbsp;&nbsp;&nbsp; 
  }<br>})<br>&lt;/script&gt;</div>
</div>
<p><a href="tryit.asp?filename=trywhatis_vue_3" target="_blank"
class="w3-button w3-theme w3-hover-green w3-hover-shadow">Try it Yourself &raquo;</a></p>
</div>
