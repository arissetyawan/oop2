...
<a class="w3-left w3-btn w3-green" href="whatis_vue.asp">&#10094; Previous</a>
<a class="w3-right w3-btn w3-green" href="whatis_fullstack_js.asp">Next &#10095;</a>
</div>
<hr>

<h2>Full Stack Web Developer</h2>
<p>A full stack web developer is a person who can develop both <b>client</b> and 
<b>server</b> software.</p>
...
<li><a href="/asp/default.asp">ASP</a></li>
<li>C++</li>
<li>C#</li>
<li>Java</li>
<li><a href="/python/default.asp">Python</a></li>
...
<ul>
<li>JavaScript. Linux. Apache. MySQL. PHP. (LAMP Stack)</li>
<li>JavaScript. Linux. Nginx. MySQL. PHP. (LEMP Stack)</li>
<li>JavaScript. MongoDB. Express. AngularJS. Node.js. (MEAN Stack)</li>
<li>JavaScript. Python. Django. MySQL. (Dango Stack)</li>
<li>JavaScript. Ruby. SQLite, PHP. (Ruby on Rails)</li>
</ul>
<hr>
<h2>Advantages</h2>
