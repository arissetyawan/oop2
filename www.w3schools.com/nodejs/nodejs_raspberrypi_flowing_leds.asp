...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Raspberry Pi Flowing LEDs</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="nodejs_raspberrypi_led_pushbutton.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_raspberrypi_webserver_websocket.asp">Next &#10095;</a>
</div>
<hr>
...
<h3>flowingleds.js</h3>
<div class="w3-code notranslate jsHigh">
  var Gpio = require('onoff').Gpio; //include onoff to interact with the GPIO<br>
  var LED04 = new Gpio(4, 'out'), //use declare variables for all the GPIO 
  output pins<br>&nbsp; LED17 = new Gpio(17, 'out'),<br>&nbsp; LED27 = new Gpio(27, 
  'out'),<br>&nbsp; LED22 = new Gpio(22, 'out'),<br>&nbsp; LED18 = new Gpio(18, 
  'out'),<br>&nbsp; LED23 = new Gpio(23, 'out'),<br>&nbsp; LED24 = new Gpio(24, 
  'out'),<br>&nbsp; LED25 = new Gpio(25, 'out');<br><br>//Put all the LED 
  variables in an array<br>var leds = [LED04, 
  LED17, LED27, LED22, LED18, LED23, LED24, LED25];<br>var indexCount = 0; //a 
  counter<br>dir = &quot;up&quot;; //variable for flowing direction<br><br>var 
  flowInterval = setInterval(flowingLeds, 100); //run the flowingLeds function 
  every 100ms<br><br>function flowingLeds() { //function for flowing Leds<br>&nbsp; 
  leds.forEach(function(currentValue) { //for each item in array<br>&nbsp;&nbsp;&nbsp; 
  currentValue.writeSync(0); //turn off LED<br>&nbsp; });<br>&nbsp; if (indexCount 
  == 0) dir = &quot;up&quot;; //set flow direction to &quot;up&quot; if the count reaches zero<br>&nbsp; 
  if (indexCount &gt;= leds.length) dir = &quot;down&quot;; //set flow direction to &quot;down&quot; if 
  the count reaches 7<br>&nbsp; if (dir == &quot;down&quot;) indexCount--; //count 
  downwards if direction is down<br>&nbsp; leds[indexCount].writeSync(1); 
  //turn on LED that where array index matches count<br>&nbsp; if (dir == 
  &quot;up&quot;) indexCount++ //count upwards if direction is up<br>};<br><br>function unexportOnClose() { 
  //function to run when exiting program<br>&nbsp; clearInterval(flowInterval); 
  //stop flow interwal<br>&nbsp; leds.forEach(function(currentValue) { //for 
  each LED<br>&nbsp;&nbsp;&nbsp; currentValue.writeSync(0); //turn off LED<br>&nbsp;&nbsp;&nbsp; 
  currentValue.unexport(); //unexport GPIO<br>&nbsp; });<br>};<br><br>process.on('SIGINT', unexportOnClose); //function to 
  run when user closes using ctrl+cc</div>
</div>
