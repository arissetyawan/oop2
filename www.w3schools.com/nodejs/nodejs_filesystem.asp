...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js File System Module</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="nodejs_http.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_url.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  res.end();<br>&nbsp; });<br>}).listen(8080);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_readfile">Run example &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_fs_append">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
  ...
  file) {<br>&nbsp; if (err) throw err;<br>&nbsp; console.log('Saved!');<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_fs_open">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
  ...
  console.log('Saved!');<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_fs_writefile">Run example &raquo;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_fs_update">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
  ...
  console.log('Replaced!');<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_fs_replace">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
  ...
  if (err) throw err;<br>&nbsp; console.log('File deleted!');<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_fs_unlink">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
  ...
  if (err) throw err;<br>&nbsp; console.log('File Renamed!');<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_fs_rename">Run example &raquo;</a>
</div>
