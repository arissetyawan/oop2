...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js Events</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="nodejs_npm.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_uploadfiles.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_events_open">Run example &raquo;</a>
</div>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
  var events = require('events');<br>var eventEmitter = new events.EventEmitter();</div>
</div>
...
<div class="w3-code notranslate jsHigh">
  ...
  'scream' event:<br>eventEmitter.emit('scream');<br></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs_cmd.asp?filename=demo_eventemitter">Run example &raquo;</a>
</div>
