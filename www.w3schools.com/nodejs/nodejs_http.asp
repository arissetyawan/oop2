...
<!DOCTYPE html>
<html lang="en-US">
<head><title>Node.js HTTP Module</title>
<meta charset="utf-8">
...
<a class="w3-left w3-btn" href="nodejs_modules.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="nodejs_filesystem.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate jsHigh">
  ...
  server object listens on port 8080</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_http">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate jsHigh">
  ...
  World!');<br>&nbsp; res.end();<br>}).listen(8080);</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_http_header">Run example &raquo;</a>
</div>
...
/summer</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_querystring_summer">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate">
/winter</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_querystring_winter">Run example &raquo;</a>
</div>
...
<div class="w3-code notranslate">
2017 July</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="shownodejs.asp?filename=demo_querystring_query">Run example &raquo;</a>
</div>
