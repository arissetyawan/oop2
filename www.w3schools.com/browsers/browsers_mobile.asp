...
<html lang="en-US">
<head>
<title>Mobile Devices Statistics</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">Mobile Devices</span> Statistics</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="browsers_display.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="browsers_chrome.asp">Next &#10095;</a>
</div>
<hr>

<img src="pic_iphone.jpg" alt="Iphone" style="float:left;margin-right:20px;height:128px;width:128px;">
<p>Smartphones today have large touch screens, nice user interfaces, and are highly optimized for browsing the web.</p>
<p>From the statistics below, you can see the trends of mobile device usage.</p>
<div class="w3-clear"></div>
<hr>

<h2>Mobile Devices Statistics</h2>
<p>The values below are extracted from <a href="browsers_os.asp">W3Schools' OS Platform Statistics</a>:</p>
<p>*iOS is the operating system for Apple mobile devices (like iPhone, iPad and iPod).</p>
<div class="w3-responsive">
<table class="w3-table-all notranslate">
    <tr>
    <th>2018</th>
    <th class="right">Total</th>
    <th class="right">iOS*</th>
    <th class="right">Android</th>
...
<table class="w3-table-all notranslate">
    ...
    <th>2011</th>
    <th class="right">Total</th>
    <th class="right">iPhone</th>
    <th class="right">iPad</th>
    <th class="right">iPod</th>
    <th class="right">Android</th>
    <th class="right">Others</th>
    </tr>
  <tr>
...
<p><a href="default.asp">Browser statistics</a></p>
