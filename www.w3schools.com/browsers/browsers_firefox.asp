...
<ul>
  ...
  <li><b>JägerMonkey JIT compiler</b> - along with enhancements to the existing TraceMonkey JIT and SpiderMonkey's interpreter for faster page-load speed and better performance.</li>
