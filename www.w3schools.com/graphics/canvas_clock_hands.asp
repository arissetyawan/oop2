...
<html lang="en-US">
<head>
<title>Canvas Clock Hands</title>
<meta charset="utf-8">
...
<h1>Canvas <span class="color_h1">Clock Hands</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="canvas_clock_numbers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="canvas_clock_start.asp">Next &#10095;</a>
</div>
<hr>
<h2>Part IV - Draw Clock Hands</h2>
<p>The clock needs hands. Create a JavaScript function to draw clock hands:</p>
<p>
...
<div class="w3-code notranslate jsHigh">
 function drawClock() {<br>&nbsp;&nbsp;&nbsp; drawFace(ctx, radius);<br>&nbsp;&nbsp;&nbsp; 
 drawNumbers(ctx, radius);<br><strong>&nbsp;&nbsp;&nbsp; drawTime(ctx, radius);<br>
 </strong>}<br><br>function drawTime(ctx, radius){<br>&nbsp;&nbsp;&nbsp; var now = new Date();<br>&nbsp;&nbsp;&nbsp; 
 var hour = now.getHours();<br>&nbsp;&nbsp;&nbsp; var minute = now.getMinutes();<br>&nbsp;&nbsp;&nbsp; 
 var second = now.getSeconds();<br>&nbsp;&nbsp;&nbsp; //hour<br>&nbsp;&nbsp;&nbsp; 
 hour=hour%12;<br>&nbsp;&nbsp;&nbsp; hour=(hour*Math.PI/6)+(minute*Math.PI/(6*60))+(second*Math.PI/(360*60));<br>
 &nbsp;&nbsp;&nbsp; 
 drawHand(ctx, hour, radius*0.5, radius*0.07);<br>&nbsp;&nbsp;&nbsp; //minute<br>&nbsp;&nbsp;&nbsp; 
 minute=(minute*Math.PI/30)+(second*Math.PI/(30*60));<br>&nbsp;&nbsp;&nbsp; 
 drawHand(ctx, minute, radius*0.8, radius*0.07);<br>&nbsp;&nbsp;&nbsp; // second<br>&nbsp;&nbsp;&nbsp; 
 second=(second*Math.PI/30);<br>&nbsp;&nbsp;&nbsp; drawHand(ctx, second, 
 radius*0.9, radius*0.02);<br>}<br><br>function drawHand(ctx, 
 pos, length, width) {<br>&nbsp;&nbsp;&nbsp; ctx.beginPath();<br>&nbsp;&nbsp;&nbsp; 
 ctx.lineWidth = width;<br>&nbsp;&nbsp;&nbsp; ctx.lineCap = &quot;round&quot;;<br>&nbsp;&nbsp;&nbsp; 
 ctx.moveTo(0,0);<br>&nbsp;&nbsp;&nbsp; ctx.rotate(pos);<br>&nbsp;&nbsp;&nbsp; 
 ctx.lineTo(0, -length);<br>&nbsp;&nbsp;&nbsp; ctx.stroke();<br>&nbsp;&nbsp;&nbsp; 
 ctx.rotate(-pos);<br>}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycanvas_clock_hands" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>Use Date to get hour, minute, second:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
 var now = new Date();<br>var hour = now.getHours();<br>var minute = now.getMinutes();<br>var second = now.getSeconds();</div>
</div>

<p>Calculate the angle of the hour hand, and draw it a length (50% of radius), 
and a width (7% of radius):</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
 hour=hour%12;<br>hour=(hour*Math.PI/6)+(minute*Math.PI/(6*60))+(second*Math.PI/(360*60));<br>
 drawHand(ctx, hour, radius*0.5, radius*0.07);</div>
</div>

<p>Use the same technique for minutes and seconds.</p>
<p>The drawHand() routine does not need an explanation. It just draws a line 
