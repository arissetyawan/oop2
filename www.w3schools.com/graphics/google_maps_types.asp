...
<a class="w3-left w3-btn" href="google_maps_controls.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="google_maps_reference.asp">Next &#10095;</a>
</div>
<hr>
...
<h2>Google Maps - 45&deg; Perspective View</h2>
<p>The map types SATELLITE and HYBRID support a 45&deg; perspective imagery view for 
certain locations (only at high zoom levels).</p>
<p>If you zoom into a location with 45&deg; imagery view, the map will automatically 
...
<ul>
  ...
  <li>A Rotate control between the Pan and Zoom controls, allowing you to rotate the image 90&deg;</li>
  <li>A toggle control for displaying the 45&deg; perspective view, under the Satellite control/label</li>
</ul>
<p><b>Note:</b> Zooming out from a map with 45&deg; imagery will revert each of 
these changes, and the original map is displayed.</p>
<p>The following example shows a 45&deg; perspective view of Palazzo Ducale in 
Venice, Italy:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
...
<a target="_blank" href="tryit.asp?filename=trymap_types_45" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Google Maps - Disable 45&deg; Perspective View - setTilt(0)</h2>
<p>You can disable 45&deg; perspective view by calling setTilt(0) on the Map object:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 map.setTilt(0);</div>
<a target="_blank" href="tryit.asp?filename=trymap_types_settilt" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p><b>Tip:</b> To enable 45&deg; perspective view at a later point, call 
setTilt(45).</p>
