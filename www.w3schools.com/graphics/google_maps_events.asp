...
<a class="w3-left w3-btn" href="google_maps_overlays.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="google_maps_controls.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trymap_events_click">Try it Yourself &raquo;</a>
</div>
...
<p>Here, we save the zoom changes and pan the map back after 3 seconds:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
google.maps.event.addListener(marker,'click',function() {<br>
&nbsp; var pos = map.getZoom();<br>&nbsp; map.setZoom(9);<br>&nbsp; 
 map.setCenter(marker.getPosition());<br>&nbsp; window.setTimeout(function() {map.setZoom(pos);},3000);<br>});</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trymap_events_pan">Try it Yourself &raquo;</a>
</div>
<hr>
...
&nbsp; });</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trymap_events_infowindow">Try it Yourself &raquo;</a>
</div>
<hr>
...
&nbsp; placeMarker(map, event.latLng);<br>
&nbsp; });<br>
<br>
function placeMarker(map, location) {<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trymap_events_infowindow2">Try it Yourself &raquo;</a>
</div>
<br>
