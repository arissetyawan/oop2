...
<a class="w3-right w3-btn" href="google_maps_basic.asp">Next &#10095;</a>
</div>
<hr>
...
<p>An API is a set of methods and tools that can be used for building software applications.</p>
</div>
<p>Google Maps API allows you to display maps on your web site: </p>
...
<p>This example creates a Google Map in HTML:</p>
...
<div class="w3-code notranslate htmlHigh">
 ...
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trymap_intro" target="_blank">Try it Yourself &raquo;</a>
</div>
