...
<a class="w3-left w3-btn" href="game_gravity.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="game_rotation.asp">Next &#10095;</a>
</div>
<hr>
<p>This red square bounces when it hits the floor:</p>
...
<p>Another functionallity we want to add is the <code class="w3-codespan">bounce</code> property.</p>
<p>The <code class="w3-codespan">bounce</code> property indicates if the component will bounce back when gravity makes it fall down to the ground.</p>
<p>The bounce property value must be a number. 0 is no bounce at all, and 1 will make the component bounce all the way backto where it start falling.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function component(width, height, color, x, y, type) {<br>&nbsp;&nbsp;&nbsp; this.type = type;<br>&nbsp;&nbsp;&nbsp; this.width = width;<br>&nbsp;&nbsp;&nbsp; this.height = height;<br>&nbsp;&nbsp;&nbsp; this.x = x;<br>&nbsp;&nbsp;&nbsp; this.y = y; <br>&nbsp;&nbsp;&nbsp; this.speedX = 0;<br>&nbsp;&nbsp;&nbsp; this.speedY = 0; <br>&nbsp;&nbsp;&nbsp; this.gravity = 0.1;<br>&nbsp;&nbsp;&nbsp; this.gravitySpeed = 0;<br><strong>&nbsp;&nbsp;&nbsp; this.bounce = 0.6;<br>&nbsp;&nbsp;&nbsp; </strong>this.update = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillRect(this.x, this.y, this.width, this.height);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; this.newPos = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.gravitySpeed += this.gravity;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x += this.speedX;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.y += this.speedY + this.gravitySpeed;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.hitBottom();<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; this.hitBottom = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var rockbottom = this.gamearea.canvas.height - this.height;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (this.y &gt; rockbottom) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.y = rockbottom;<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.gravitySpeed = -(this.gravitySpeed * this.bounce);<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
 <a target="_blank" href="tryit.asp?filename=trygame_bouncing" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="game_gravity.asp">&#10094; Previous</a>
