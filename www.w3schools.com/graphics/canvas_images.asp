...
<h1>HTML Canvas <span class="color_h1">Images</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="canvas_text.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="canvas_reference.asp">Next &#10095;</a>
</div>
<hr>

<h2>Canvas - Images</h2>
<p>To draw an image on a canvas, use the following method:</p>
<ul>
...
<h3>Example</h3>
<p><img id="scream" src="pic_the_scream.jpg" alt="The Scream"></p>
<p>JavaScript:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycanvas_image" target="_blank">Try it Yourself &raquo;</a>
</div>
