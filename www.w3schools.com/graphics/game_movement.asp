...
<a class="w3-left w3-btn" href="game_rotation.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="default.asp">Next &#10095;</a>
</div>
<p>With the new way of drawing components, explained in the Game Rotation chapter, the movements are more flexible.</p>
<div id="canvascontainer"></div>
<button id="playagain" onclick="clickPlayagain()">Play again</button>
<hr>
<h2>How to Move Objects?</h2>
<p>Add a <code class="w3-codespan">speed</code> property to the <code class="w3-codespan">component</code> constructor, which represents the current speed of the component.</p>
<p>Also make some changes in the <code class="w3-codespan">newPos()</code> method, to calculate the 
position of the component, based on <code class="w3-codespan">speed</code> and <code class="w3-codespan">angle</code>.</p>
<p>By default, the components are facing up, and by setting the speed 
property to 1, the component will start moving forward.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
function component(width, height, color, x, y) {<br>&nbsp;&nbsp;&nbsp; this.gamearea = gamearea;<br>&nbsp;&nbsp;&nbsp; this.width = width;<br>&nbsp;&nbsp;&nbsp; this.height = height;<br>&nbsp;&nbsp;&nbsp; this.angle = 0;<br><strong>&nbsp;&nbsp;&nbsp; this.speed = 1;<br>
 </strong>&nbsp;&nbsp;&nbsp; this.x = x;<br>&nbsp;&nbsp;&nbsp; this.y = y;
 <br>&nbsp;&nbsp;&nbsp; this.update = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.save();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.translate(this.x, this.y); <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.rotate(this.angle);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillRect(this.width / -2, this.height / -2, this.width, this.height);
 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.restore(); <br>&nbsp;&nbsp;&nbsp; }<br><strong>&nbsp;&nbsp;&nbsp; this.newPos = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x += this.speed * Math.sin(this.angle);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.y -= this.speed * Math.cos(this.angle);<br>&nbsp;&nbsp;&nbsp; }<br>
 </strong>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_movement_forward" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<hr>
<h2>Making Turns</h2>
<p>We also want to be able to make left and right turns. Make a new 
property called <code class="w3-codespan">moveAngle</code>, which indicates the current moving 
value, or rotation angle. In the <code class="w3-codespan">newPos()</code> method calculate the
<code class="w3-codespan">angle</code> based on the <code class="w3-codespan">moveAngle</code> property:</p>

<div class="w3-example">
<h3>Example</h3>
<p>Set the moveangle property to 1, and see what happens:</p>
<div class="w3-code notranslate jsHigh">
function component(width, height, color, x, y) {<br>&nbsp;&nbsp;&nbsp; this.width = width;<br>&nbsp;&nbsp;&nbsp; this.height = height;<br>&nbsp;&nbsp;&nbsp; this.angle = 0;<br><strong>&nbsp;&nbsp;&nbsp; this.moveAngle = 1;<br>
 </strong>&nbsp;&nbsp;&nbsp; this.speed = 1;<br>
 &nbsp;&nbsp;&nbsp; this.x = x;<br>&nbsp;&nbsp;&nbsp; this.y = y;
 <br>&nbsp;&nbsp;&nbsp; this.update = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.save();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.translate(this.x, this.y); <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.rotate(this.angle);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillRect(this.width / -2, this.height / -2, this.width, this.height);
 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.restore(); <br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; this.newPos = function() {<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.angle += this.moveAngle * Math.PI / 180;<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x += this.speed * Math.sin(this.angle);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.y -= this.speed * Math.cos(this.angle);<br>&nbsp;&nbsp;&nbsp; }<br>
 }<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_movement_turn" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
 
</div>

<h2>Use the Keyboard</h2>
<p>How does the red square move when using the keyboard?
Instead of moving up and down, and from side to side, the red square moves forward when you use the "up" arrow,
and turns left and right when pressing the left and right arrows.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-white w3-padding notranslate">
<iframe src="trygame_movement_keyboard.htm" style="width:100%;height:440px;border:none;"></iframe>
</div>
<a target="_blank" href="tryit.asp?filename=trygame_movement_keyboard" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
