...
<a class="w3-left w3-btn" href="svg_stroking.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="svg_fegaussianblur.asp">Next &#10095;</a>
</div>
<hr>
<h2>SVG Filters</h2>
<p>SVG Filters are used to add special effects to SVG graphics.</p>
<hr>

<h2>Browser Support</h2>
<p>The numbers in the table specify the first browser version that supports SVG filters.</p>
<table class="browserref notranslate">
  <tr>
    <th style="width:20%;font-size:16px;text-align:left;">&nbsp;</th>
  ...
  <tr>
    <td style="text-align:left;">SVG Filters</td>
    <td>8.0</td>
    <td>10.0</td>
    <td>3.0</td>
    <td>6.0</td>
...
<h2>SVG Filter Elements</h2>
<p>In the next chapters, we will only demonstrate a touch of the filter effects 
that are possible - and give you an idea of what can be done with SVG.</p>
<p>The available filter elements in SVG are:</p>
<ul>
...
<p><strong>Tip:</strong> You can use multiple filters on each SVG element!</p>
</div>
