...
<html lang="en-US">
<head>
<title>Canvas Clock Numbers</title>
<meta charset="utf-8">
...
<h1>Canvas <span class="color_h1">Clock Numbers</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="canvas_clock_face.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="canvas_clock_hands.asp">Next &#10095;</a>
</div>
<hr>
<h2>Part III - Draw Clock Numbers</h2>
<p>The clock needs numbers. Create a JavaScript function to draw clock numbers:</p>
<p>
...
&nbsp;&nbsp;&nbsp; drawFace(ctx, radius);<br>
&nbsp;&nbsp;&nbsp; <strong>drawNumbers(ctx, radius);</strong><br>
}<br><br>
function drawNumbers(ctx, radius) {<br>
&nbsp;&nbsp;&nbsp; var ang;<br>
&nbsp;&nbsp;&nbsp; var num;<br>
&nbsp;&nbsp;&nbsp; ctx.font = radius*0.15 + &quot;px arial&quot;;<br>
&nbsp;&nbsp;&nbsp; ctx.textBaseline=&quot;middle&quot;;<br>
&nbsp;&nbsp;&nbsp; ctx.textAlign=&quot;center&quot;;<br>
&nbsp;&nbsp;&nbsp; for(num= 1; num &lt; 13; num++){<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ang = num * Math.PI / 6;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.rotate(ang);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.translate(0, -radius*0.85);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.rotate(-ang);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillText(num.toString(), 0, 0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.rotate(ang);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.translate(0, radius*0.85);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.rotate(-ang);<br>&nbsp;&nbsp;&nbsp; }<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycanvas_clock_numbers" target="_blank">Try it Yourself &raquo;
</a>
</div>
<script>
...
<p>Set the font size (of the drawing object) to 15% of the radius:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
...
<p>Set the text alignment to the middle and the center of the print position:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
 ctx.textBaseline=&quot;middle&quot;;<br>
...
<p>Calculate the print position (for 12 numbers) to 85% of the 
radius, rotated (PI/6) for each number:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
 for(num= 1; num &lt; 13; num++) {<br>
&nbsp;&nbsp;&nbsp;
 ang = num * Math.PI / 6;<br>&nbsp;&nbsp;&nbsp; ctx.rotate(ang);<br>&nbsp;&nbsp;&nbsp; ctx.translate(0, -radius*0.85);<br>
 &nbsp;&nbsp;&nbsp;
 ctx.rotate(-ang);<br>&nbsp;&nbsp;&nbsp; ctx.fillText(num.toString(), 0, 0);<br>&nbsp;&nbsp;&nbsp; ctx.rotate(ang);<br>
 &nbsp;&nbsp;&nbsp;
 ctx.translate(0, radius*0.85);<br>&nbsp;&nbsp;&nbsp; ctx.rotate(-ang);
<br>}</div>
</div>
