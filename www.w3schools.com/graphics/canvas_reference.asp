...
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="canvas_images.asp">❮ Previous</a>
 <a class="w3-right w3-btn" href="canvas_clock.asp">Next ❯</a>
</div>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_fillstyle.asp">fillStyle</a></td>
    <td>Sets or returns the color, gradient, or pattern used to fill the drawing</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_strokestyle.asp">strokeStyle</a></td>
    <td>Sets or returns the color, gradient, or pattern used for strokes</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_shadowcolor.asp">shadowColor</a></td>
    <td>Sets or returns the color to use for shadows</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_shadowblur.asp">shadowBlur</a></td>
    <td>Sets or returns the blur level for shadows</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_shadowoffsetx.asp">shadowOffsetX</a></td>
    <td>Sets or returns the horizontal distance of the shadow from the shape</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_shadowoffsety.asp">shadowOffsetY</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_createlineargradient.asp">
    createLinearGradient()</a></td>
    <td>Creates a linear gradient (to use on canvas content)</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_createpattern.asp">createPattern()</a></td>
    <td>Repeats a specified element in the specified direction</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_createradialgradient.asp">createRadialGradient()</td>
    <td>Creates a radial/circular gradient (to use on canvas content)</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_addcolorstop.asp">addColorStop()</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_linecap.asp">lineCap</a></td>
    <td>Sets or returns the style of the end caps for a line</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_linejoin.asp">lineJoin</a></td>
    <td>Sets or returns the type of corner created, when two lines meet</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_linewidth.asp">lineWidth</a></td>
    <td>Sets or returns the current line width</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_miterlimit.asp">miterLimit</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_rect.asp">rect()</a></td>
    <td>Creates a rectangle</td>
  </tr>
  <tr>
   <td><a href="../tags/canvas_fillrect.asp">fillRect()</a></td>
    <td>Draws a "filled" rectangle</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_strokerect.asp">strokeRect()</a></td>
    <td>Draws a rectangle (no fill)</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_clearrect.asp">clearRect()</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_fill.asp">fill()</a></td>
    <td>Fills the current drawing (path)</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_stroke.asp">stroke()</a></td>
    <td>Actually draws the path you have defined</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_beginpath.asp">beginPath()</a></td>
    <td>Begins a path, or resets the current path</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_moveto.asp">moveTo()</a></td>
    <td>Moves the path to the specified point in the canvas, without creating a 
    line</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_closepath.asp">closePath()</a></td>
    <td>Creates a path from the current point back to the starting point</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_lineto.asp">lineTo()</a></td>
    <td>Adds a new point and creates a line to that point from the last 
    specified point in the canvas</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_clip.asp">clip()</a></td>
    <td>Clips a region of any shape and size from the original canvas</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_quadraticcurveto.asp">quadraticCurveTo()</a></td>
    <td>Creates a quadratic Bézier curve</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_beziercurveto.asp">bezierCurveTo()</a></td>
    <td>Creates a cubic Bézier curve</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_arc.asp">arc()</a></td>
    <td>Creates an arc/curve (used to create circles, or parts of circles)</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_arcto.asp">arcTo()</a></td>
    <td>Creates an arc/curve between two tangents</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_ispointinpath.asp">isPointInPath()</td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_scale.asp">scale()</a></td>
    <td>Scales the current drawing bigger or smaller</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_rotate.asp">rotate()</a></td>
    <td>Rotates the current drawing</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_translate.asp">translate()</a></td>
    <td>Remaps the (0,0) position on the canvas</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_transform.asp">transform()</a></td>
    <td>Replaces the current transformation matrix for the drawing</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_settransform.asp">setTransform()</a></td>
    <td>Resets the current transform to the identity matrix. Then runs <a href="../tags/canvas_transform.asp">
    transform()</a></td>
  </tr>
  </table>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_font.asp">font</a></td>
    <td>Sets or returns the current font properties for text content</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_textalign.asp">textAlign</a></td>
    <td>Sets or returns the current alignment for text content</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_textbaseline.asp">textBaseline</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_filltext.asp">fillText()</a></td>
    <td>Draws "filled" text on the canvas</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_stroketext.asp">strokeText()</a></td>
    <td>Draws text on the canvas (no fill)</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_measuretext.asp">measureText()</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_drawimage.asp">drawImage()</a></td>
...
<table class="w3-table-all notranslate">
  <tr>
    ...
    <tr>
    <td><a href="../tags/canvas_imagedata_width.asp">width</a></td>
    <td>Returns the width of an ImageData object</td>
    </tr>
  <tr>
    <td><a href="../tags/canvas_imagedata_height.asp">height</a></td>
    <td>Returns the height of an ImageData object</td>
    </tr>
  <tr>
    <td><a href="../tags/canvas_imagedata_data.asp">data</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_createimagedata.asp">createImageData()</a></td>
    <td>Creates a new, blank ImageData object</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_getimagedata.asp">getImageData()</a></td>
    <td>Returns an ImageData object that copies the pixel data for the specified 
    rectangle on a canvas</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_putimagedata.asp">putImageData()</a></td>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="../tags/canvas_globalalpha.asp">globalAlpha</a></td>
    <td>Sets or returns the current alpha or transparency value of the drawing</td>
  </tr>
  <tr>
    <td><a href="../tags/canvas_globalcompositeoperation.asp">
    globalCompositeOperation</a></td>
