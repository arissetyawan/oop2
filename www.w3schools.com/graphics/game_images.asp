...
<a class="w3-left w3-btn" href="game_score.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="game_sound.asp">Next &#10095;</a>
</div>
<hr>
<p>Push the buttons to move the smiley:</p>
...
<p>To add images on a canvas, the getContext(&quot;2d&quot;) object has built-in image 
properties and methods.</p>
<p>In our game, to create the gamepiece as an image, use the component 
...
<div class="w3-code notranslate jsHigh">
 function startGame() {<br>&nbsp; myGamePiece = new component(30, 30, <strong>&quot;smiley.gif&quot;</strong>, 10, 120, <strong>&quot;image&quot;</strong>);<br>&nbsp; myGameArea.start();<br>}</div>
 <br>
</div>

<p>In the component constructor we test if the component is of type "image", and 
create an image object by using the built-in &quot;new Image()&quot; object constructor. 
When we are ready to draw the image, we use the drawImage method instead of the fillRect method:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function component(width, height, color, x, y, type) {<br>&nbsp; this.type = type;<br><strong>&nbsp; if (type == &quot;image&quot;) {<br>&nbsp;&nbsp;&nbsp; this.image = new Image();<br>&nbsp;&nbsp;&nbsp; this.image.src = color;<br>&nbsp; }<br></strong>&nbsp; this.width = width;<br>&nbsp; this.height = height;<br>&nbsp; this.speedX = 0;<br>&nbsp; this.speedY = 0; <br>&nbsp; this.x = x;<br>&nbsp; this.y = y; <br>&nbsp; this.update = function() {<br>&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br><strong>&nbsp;&nbsp;&nbsp; if (type == &quot;image&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.drawImage(this.image, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.y,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.width, this.height);<br>&nbsp;&nbsp;&nbsp; } else {<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillRect(this.x, this.y, this.width, this.height);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp; }<br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_image" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>You can change the image whenever you like by changing the <code class="w3-codespan">src</code> property of the <code class="w3-codespan">image</code> object of your component.</p>
<img src="smiley.gif"> <img src="angry.gif">
<p>If you want to change the smiley everytime it moves, change the image source when the user clicks a button, 
and back to normal when the button is not clicked:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function move(dir) {<br><strong>&nbsp;&nbsp;&nbsp; myGamePiece.image.src = &quot;angry.gif&quot;;<br></strong>&nbsp;&nbsp;&nbsp; if (dir == &quot;up&quot;) {myGamePiece.speedY = -1; }<br>&nbsp;&nbsp;&nbsp; if (dir == &quot;down&quot;) {myGamePiece.speedY = 1; }<br>&nbsp;&nbsp;&nbsp; if (dir == &quot;left&quot;) {myGamePiece.speedX = -1; }<br>&nbsp;&nbsp;&nbsp; if (dir == &quot;right&quot;) {myGamePiece.speedX = 1; }<br>}<br><br>function clearmove() {<br><strong>&nbsp;&nbsp;&nbsp; myGamePiece.image.src = &quot;smiley.gif&quot;;<br></strong>&nbsp;&nbsp;&nbsp; myGamePiece.speedX = 0; <br>&nbsp;&nbsp;&nbsp; myGamePiece.speedY = 0; <br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_image_change" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Background Images</h2>

<p>Add a background image to your game area by adding it as a component, and 
also update the background in every frame:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 var myGamePiece;<br><strong>var myBackground;<br></strong><br>function startGame() {<br>&nbsp;&nbsp;&nbsp; myGamePiece = new component(30, 30, &quot;smiley.gif&quot;, 10, 120, &quot;image&quot;);<br><strong>&nbsp;&nbsp;&nbsp; myBackground = new component(656, 270, &quot;citymarket.jpg&quot;, 0, 0, &quot;image&quot;);<br></strong>&nbsp;&nbsp;&nbsp; myGameArea.start();<br>}<br><br>function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br><strong>&nbsp;&nbsp;&nbsp; myBackground.newPos(); <br>&nbsp;&nbsp;&nbsp; myBackground.update();<br></strong>&nbsp;&nbsp;&nbsp; myGamePiece.newPos();
 <br>&nbsp;&nbsp;&nbsp; myGamePiece.update();<br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_image_background" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Moving Background</h2>

<p>Change the background component's <code class="w3-codespan">speedX</code> property to make the background move:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br><strong>&nbsp;&nbsp;&nbsp; myBackground.speedX = -1;
 <br></strong>&nbsp;&nbsp;&nbsp; myBackground.newPos(); <br>&nbsp;&nbsp;&nbsp; myBackground.update();<br>&nbsp;&nbsp;&nbsp; myGamePiece.newPos();
 <br>&nbsp;&nbsp;&nbsp; myGamePiece.update();<br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_image_background_moving" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Background Loop</h2>

<p>To make the same background loop forever, we must use a specific technique.</p>
<p>Start by telling the component constructor that this is a <em>background</em>.
The component constructor will then add the image twice, placing the second image 
immediately after the first image.</p>
<p>In the <code class="w3-codespan">newPos()</code> method, check if the <code class="w3-codespan">x</code> position of the component has reach 
the end of the image, if it has, set the <code class="w3-codespan">x</code> position of the component to 0:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function component(width, height, color, x, y, type) {<br>&nbsp;&nbsp;&nbsp; this.type = type;<br>&nbsp;&nbsp;&nbsp; if (type == &quot;image&quot;<strong> || type == &quot;background&quot;</strong>) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.image = new Image();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.image.src = color;<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; this.width = width;<br>&nbsp;&nbsp;&nbsp; this.height = height;<br>&nbsp;&nbsp;&nbsp; this.speedX = 0;<br>&nbsp;&nbsp;&nbsp; this.speedY = 0; <br>&nbsp;&nbsp;&nbsp; this.x = x;<br>&nbsp;&nbsp;&nbsp; this.y = y; <br>&nbsp;&nbsp;&nbsp; this.update = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (type == &quot;image&quot; || type == &quot;background&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.drawImage(this.image, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x, this.y, this.width, this.height);<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (type == &quot;background&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.drawImage(this.image, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x + this.width, this.y, this.width, this.height);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillRect(this.x, this.y, this.width, this.height);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; this.newPos = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x += this.speedX;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.y += this.speedY;<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (this.type == &quot;background&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (this.x == -(this.width)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x = 0;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br></strong>&nbsp;&nbsp;&nbsp; } <br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_image_background_loop" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
