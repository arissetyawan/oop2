...
<a class="w3-left w3-btn" href="game_bouncing.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="game_movement.asp">Next &#10095;</a>
</div>
<hr>
<p>The red square can rotate:</p>
...
<p>Earlier in this tutorial, the red square was able to move around on the gamearea, but it could not turn or rotate.</p>

<p>To rotate components, we have to change the way we draw components.</p>

<p>The only rotation method available for the canvas element will rotate the entire canvas:</p>

<img src="rotate1.png" class="w3-image">

<p>Everything else you draw on the canvas will also be rotated, not only the specific component.</p>

<p>That is why we have to make some changes in the <code class="w3-codespan">update()</code> method:</p>

<p>First, we save the current canvas context object:</p>

<p><code class="w3-codespan">ctx.save();</code></p>
        
<p>Then we move the entire canvas to the center of the specific component, using the translate method:</p>        

<p><code class="w3-codespan">ctx.translate(x, y);</code></p>

<img src="game_movement1.png" class="w3-image">

<p>Then we perform the wanted rotation using the rotate() method:</p>

<p><code class="w3-codespan">ctx.rotate(<em>angle</em>);</code></p>

<img src="game_movement2.png" class="w3-image">

<p>Now we are ready to draw the component onto the canvas, but now we will draw it with its center position at position 0,0 on the translated (and rotated) canvas:</p>

<p><code class="w3-codespan">ctx.fillRect(width / -2, height / -2, width, height);</code></p>

<img src="game_movement3.png" class="w3-image">

<p>When we are finished, we must restore the context object back to its saved position, using the restore method:</p>

<p><code class="w3-codespan">ctx.restore();</code></p>

<p>The component is the only thing that is rotated:</p>
        
<img src="game_movement4.png" class="w3-image">
<hr>
...
<p>The <code class="w3-codespan">component</code> constructor has a new property called <code class="w3-codespan">angle</code>, 
which is radian number that represents the angle of the component.</p>
<p>The <code class="w3-codespan">update</code> method of the <code class="w3-codespan">component</code> constructor is 
...
function component(width, height, color, x, y) {<br>&nbsp;&nbsp;&nbsp; this.width = width;<br>&nbsp;&nbsp;&nbsp; this.height = height;<br><strong>&nbsp;&nbsp;&nbsp; this.angle = 0;<br>
 </strong>&nbsp;&nbsp;&nbsp; this.x = x;<br>&nbsp;&nbsp;&nbsp; this.y = y;
 <br>&nbsp;&nbsp;&nbsp; this.update = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.save();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.translate(this.x, this.y); <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.rotate(this.angle);<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillRect(this.width / -2, this.height / -2, this.width, this.height);
 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.restore(); <br></strong>&nbsp;&nbsp;&nbsp; }<br>}<br>function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br><strong>&nbsp;&nbsp;&nbsp; myGamePiece.angle += 1 * Math.PI / 180; <br></strong>&nbsp;&nbsp;&nbsp; myGamePiece.update();<br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_rotate_game" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<br>
<div class="w3-clear nextprev">
