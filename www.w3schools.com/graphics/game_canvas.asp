...
<a class="w3-right w3-btn" href="game_components.asp">Next &#10095;</a>
</div>
<hr>


<div id="canvascontainer"><p>The HTML <code class="w3-codespan">&lt;canvas&gt;</code> element is displayed as a rectangular object on a web page:</p></div>
<script>
...
<hr><h2>HTML Canvas</h2>
<p>The <code class="w3-codespan">&lt;canvas&gt;</code> element is perfect for making games in HTML.</p>
<p>The <code class="w3-codespan">&lt;canvas&gt;</code> element offers all the functionality you need for making games.</p>
<p>Use JavaScript to draw, write, insert images, and more, onto the <code class="w3-codespan">
&lt;canvas&gt;</code>.</p>
<hr>
<h2>.getContext("2d")</h2>
<p>The <code class="w3-codespan">&lt;canvas&gt;</code> element has a built-in object, called the <code class="w3-codespan">getContext("2d")</code> object, with methods and properties for drawing.</p>
<p>You can learn more about the <code class="w3-codespan">&lt;canvas&gt;</code> element, and the <code class="w3-codespan">
getContext(&quot;2d&quot;)</code> object, in our <a href="/graphics/canvas_intro.asp">Canvas 
Tutorial</a>.</p>
<hr>
<h2>Get Started</h2>
<p>To make a game, start by creating a gaming area, and make it ready for 
drawing:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function startGame() {<br>&nbsp;&nbsp;&nbsp; myGameArea.start();<br>
 }<br><br>var myGameArea = {<br>&nbsp;&nbsp;&nbsp; canvas : document.createElement(&quot;canvas&quot;),<br>&nbsp;&nbsp;&nbsp; start : function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.canvas.width = 480;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.canvas.height = 270;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.context = this.canvas.getContext(&quot;2d&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.body.insertBefore(this.canvas, document.body.childNodes[0]);<br>&nbsp;&nbsp;&nbsp; }<br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_canvas" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>The object <code class="w3-codespan">myGameArea</code> will have 
more properties and methods later in this tutorial.</p>
<p>The function <code class="w3-codespan">startGame()</code> invokes the method <code class="w3-codespan">
start()</code> of the <code class="w3-codespan">
myGameArea</code> object.</p>
<p>The <code class="w3-codespan">
start()</code> method creates a <code class="w3-codespan">&lt;canvas&gt;</code> element and inserts 
it as the first childnode of the <code class="w3-codespan">&lt;body&gt;</code> element.</p>
<br>
