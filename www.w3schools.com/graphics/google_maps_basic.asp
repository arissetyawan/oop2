...
<a class="w3-right w3-btn" href="google_maps_overlays.asp">Next &#10095;</a>
</div>
<hr>
...
<div class="w3-code notranslate htmlHigh">
 &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;body&gt;<br><br>&lt;h1&gt;My First Google Map&lt;/h1&gt;<br><br>
  &lt;div id=&quot;googleMap&quot; style=&quot;width:100%;height:400px;&quot;&gt;&lt;/div&gt;<br><br>&lt;script&gt;<br>
  function myMap() {<br>var mapProp= {<br>&nbsp;&nbsp;&nbsp; center:new 
  google.maps.LatLng(51.508742,-0.120850),<br>&nbsp;&nbsp;&nbsp; zoom:5,<br>};<br>
  var map=new google.maps.Map(document.getElementById(&quot;googleMap&quot;),mapProp);<br>
  }<br>&lt;/script&gt;<br><br>&lt;script src=&quot;https://maps.googleapis.com/maps/api/js?key=YOUR_KEY&amp;callback=myMap&quot;&gt;&lt;/script&gt;<br>
  <br>&lt;/body&gt;<br>&lt;/html&gt;
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trymap_basic">Try it Yourself &raquo;</a>
</div>
<p>The rest of this page describes the example above, step by step.</p>
<hr>

<h2>The Map Container and Size</h2>
<p>The map needs an HTML element to hold the map:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
&lt;div id=&quot;googleMap&quot; style=&quot;width:100%;height:400px&quot;&gt;&lt;/div&gt;</div>
</div>
<div class="w3-panel w3-note">
<p>Also set the size of the map.</p>
</div>
<hr>
...
<p>The <strong>mapProp</strong> variable defines the properties for the map.</p>
<p>The <strong>center</strong> property specifies where to center the map (using 
latitude and longitude coordinates).</p>
<p>The <strong>zoom</strong> property specifies the zoom level for the map (try 
to experiment with the zoom level).</p>
<p>The line: <strong>var map=new google.maps.Map(document.getElementById(&quot;googleMap&quot;), 
mapProp);</strong> creates a new map inside the &lt;div&gt; element with 
id=&quot;googleMap&quot;, using the parameters that are passed (mapProp).</p>
<hr>

<h2>Multiple Maps</h2>
<p>The example below defines four maps with different 
map types:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
var map1 = new google.maps.Map(document.getElementById(&quot;googleMap1&quot;), mapOptions1);<br>
var map2 = new google.maps.Map(document.getElementById(&quot;googleMap2&quot;), mapOptions2);<br>
var map3 = new google.maps.Map(document.getElementById(&quot;googleMap3&quot;), mapOptions3);<br>
var map4 = new google.maps.Map(document.getElementById(&quot;googleMap4&quot;), mapOptions4);
</div>
 <a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trymap_basic_many" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Free Google API Key</h2>
<p>Google allows a website to call any Google API for free, thousands of times a day.</p>
<p>Go to 
<a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">
https://developers.google.com/maps/documentation/javascript/get-api-key</a> to 
learn how to get an 
API key.</p>
<p>Google Maps expects to find the API key in the <strong>key</strong> parameter when loading an API:</p>
<div class="w3-example">
<div class="w3-code notranslate htmlHigh">
  &lt;script src=&quot;https://maps.googleapis.com/maps/api/js?<strong>key=YOUR_KEY</strong>&amp;callback=myMap&quot;&gt;&lt;/script&gt;
</div></div>
