...
<a class="w3-left w3-btn" href="game_canvas.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="game_controllers.asp">Next &#10095;</a>
</div>
<hr>
<div id="canvascontainer"><p>Add a red square onto the game area:</p></div>
<script>
...
<p>Make a component constructor, which lets you add components onto the gamearea.</p>
<p>The object constructor is called <code class="w3-codespan">
component</code>, and we make our first component, called <code class="w3-codespan">myGamePiece</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 <strong>var myGamePiece;<br></strong><br>function startGame() {<br>&nbsp;&nbsp;&nbsp; myGameArea.start();<br>&nbsp;&nbsp;&nbsp; <strong>myGamePiece = new component(30, 30, &quot;red&quot;, 10, 120);<br></strong>}<br><br><strong>function component(width, height, color, x, y) {<br>&nbsp;&nbsp;&nbsp; this.width = width;<br>&nbsp;&nbsp;&nbsp; this.height = height;<br>&nbsp;&nbsp;&nbsp; this.x = x;<br>&nbsp;&nbsp;&nbsp; this.y = y; <br>&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br>&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp; ctx.fillRect(this.x, this.y, this.width, this.height);<br>}</strong></div>
 <p><a target="_blank" href="tryit.asp?filename=trygame_component_simple" class="w3-btn">Try it Yourself &raquo;</a></p>
</div>
<p>The components have  properties and methods to control their appearances and movements.</p>
<hr>
...
<hr>
<h2>Frames</h2>
<p>To make the game ready for action, we will update the display 50 times per second, 
which is much like frames in a movie. </p>
<p>First, create a new function called <code class="w3-codespan">updateGameArea()</code>.</p>
<p>In the <code class="w3-codespan">myGameArea</code> object, add an interval which will run the <code class="w3-codespan">updateGameArea()</code> function every 
20th 
millisecond (50 times per second). Also add a function called <code class="w3-codespan">clear()</code>, 
that clears the entire canvas.</p>
<p>In the <code class="w3-codespan">component</code> constructor, add a function called <code class="w3-codespan">
update()</code>, to handle the drawing of the component.</p>
<p>The <code class="w3-codespan">updateGameArea()</code> function calls the <code class="w3-codespan">clear()</code> and 
the <code class="w3-codespan">update()</code> method.</p>

<p>The result is that the component is drawn and cleared 50 times per second:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 var myGameArea = {<br>&nbsp;&nbsp;&nbsp; canvas : document.createElement(&quot;canvas&quot;),<br>&nbsp;&nbsp;&nbsp; start : function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.canvas.width = 480;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.canvas.height = 270;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.context = this.canvas.getContext(&quot;2d&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.body.insertBefore(this.canvas, document.body.childNodes[0]);<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.interval = setInterval(updateGameArea, 20);</strong><br>&nbsp;&nbsp;&nbsp; },<br><strong>&nbsp;&nbsp;&nbsp; clear : function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.context.clearRect(0, 0, this.canvas.width, this.canvas.height);<br>&nbsp;&nbsp;&nbsp; }<br></strong>}<br><br>function component(width, height, color, x, y) {<br>&nbsp;&nbsp;&nbsp; this.width = width;<br>&nbsp;&nbsp;&nbsp; this.height = height;<br>&nbsp;&nbsp;&nbsp; this.x = x;<br>&nbsp;&nbsp;&nbsp; this.y = y; <br><strong>&nbsp;&nbsp;&nbsp; this.update = function(){<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillRect(this.x, this.y, this.width, this.height);<br><strong>&nbsp;&nbsp;&nbsp; }<br></strong>}<br><strong><br>function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br>&nbsp;&nbsp;&nbsp;
 myGamePiece.update();<br>}</strong></div>
 <a target="_blank" href="tryit.asp?filename=trygame_component" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Make it Move</h2>
<p>To prove that the red square is being drawn 50 times per second, we will change the x position (horizontal)
by one pixel every time we update the game area:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br>&nbsp;&nbsp;&nbsp;
 <strong>myGamePiece.x += 1;<br>&nbsp;&nbsp;&nbsp; </strong>
 myGamePiece.update();<br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_component_move" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Why Clear The Game Area?</h2>
<p>It might seem unnecessary to clear the game area at every update. However, if we leave out the 
<code class="w3-codespan">clear()</code> method,
all movements of the component will leave a trail of where it was positioned in the last frame:</p>
...
<div class="w3-code notranslate jsHigh">
 ...
 <strong>myGamePiece.x += 1;<br>&nbsp;&nbsp;&nbsp; </strong>
 myGamePiece.update();<br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_component_move_noclear" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Change the Size</h2>
<p>You can 
control the width and height of the component:</p>

<div class="w3-example">
<h3>Example</h3>
 <p>Create a 10x140 pixels rectangle:</p>
<div class="w3-code notranslate jsHigh">
 function startGame() {<br>&nbsp;&nbsp;&nbsp; myGameArea.start();<br>&nbsp;&nbsp;&nbsp; myGamePiece = new component(<strong>10</strong>, <strong>140</strong>, &quot;red&quot;, 10, 120);<br>}</div>
 <a target="_blank" href="tryit.asp?filename=trygame_component_long" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Change the Color</h2>
<p>You can 
control the color of the component:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function startGame() {<br>&nbsp;&nbsp;&nbsp; myGameArea.start();<br>&nbsp;&nbsp;&nbsp; myGamePiece = new component(30, 30, <strong>&quot;blue&quot;</strong>, 10, 120);<br>}</div>
 <a target="_blank" href="tryit.asp?filename=trygame_component_color" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>You can also use other colorvalues like hex, rgb, or rgba:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function startGame() {<br>&nbsp;&nbsp;&nbsp; myGameArea.start();<br>&nbsp;&nbsp;&nbsp; myGamePiece = new component(30, 30, <strong>&quot;rgba(0, 0, 255, 0.5)&quot;</strong>, 10, 120);<br>}</div>
 <a target="_blank" href="tryit.asp?filename=trygame_component_color_rgba" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Change the Position</h2>

<p>We use x- and y-coordinates to position components onto the game area.</p>

<p>The upper-left corner of the canvas has the coordinates (0,0)</p>

<p>Mouse over the game area below to see its x and y coordinates:</p>

<div style="width:90%;max-width:320px;margin-left:20px;text-align:center;">X</div>
<div style="position:relative;">
<div style="position:absolute;top:75px;">Y</div>
</div>
<iframe src="trygame_coordinates.htm" frameborder="0" style="margin-left:20px;border:0;overflow:hidden;width:90%;max-width:320px;height:210px;"></iframe>

<p>You can position the components wherever you like on the game area:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function startGame() {<br>&nbsp;&nbsp;&nbsp; myGameArea.start();<br>&nbsp;&nbsp;&nbsp; myGamePiece = new component(30, 30, &quot;red&quot;, <strong>2</strong>, <strong>2</strong>);<br>}</div>
 <a target="_blank" href="tryit.asp?filename=trygame_component_position" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Many Components</h2>

<p>You can put as many components as you like on the game area:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 <strong>var redGamePiece, blueGamePiece, yellowGamePiece;<br><br></strong>
 function startGame() {<br><strong>&nbsp;&nbsp;&nbsp; redGamePiece = new component(75, 75, &quot;red&quot;, 10, 10);<br>&nbsp;&nbsp;&nbsp; yellowGamePiece = new component(75, 75, &quot;yellow&quot;, 50, 60); <br>&nbsp;&nbsp;&nbsp; blueGamePiece = new component(75, 75, &quot;blue&quot;, 10, 110);<br>&nbsp;&nbsp;&nbsp;
 </strong>myGameArea.start();<br>}<br><br>function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br><strong>&nbsp;&nbsp;&nbsp; redGamePiece.update();<br>&nbsp;&nbsp;&nbsp; yellowGamePiece.update(); <br>&nbsp;&nbsp;&nbsp; blueGamePiece.update();<br>
 </strong>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_component_more" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Moving Components</h2>

<p>Make all three components move in different directions:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br>
 <strong>&nbsp;&nbsp;&nbsp; redGamePiece.x += 1;<br>&nbsp;&nbsp;&nbsp; yellowGamePiece.x += 1; <br>&nbsp;&nbsp;&nbsp; yellowGamePiece.y += 1; <br>&nbsp;&nbsp;&nbsp; blueGamePiece.x += 1; <br>&nbsp;&nbsp;&nbsp; blueGamePiece.y -= 1; <br>
 </strong>&nbsp;&nbsp;&nbsp; redGamePiece.update();<br>&nbsp;&nbsp;&nbsp; yellowGamePiece.update(); <br>&nbsp;&nbsp;&nbsp; blueGamePiece.update();<br>
 }<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_component_more_move" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="game_canvas.asp">&#10094; Previous</a>
