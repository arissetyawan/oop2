...
<h1>Canvas <span class="color_h1">Clock Face</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="canvas_clock.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="canvas_clock_numbers.asp">Next &#10095;</a>
</div>
<hr>
<h2>Part II - Draw a Clock Face</h2>
<p>The clock needs a clock face. Create a JavaScript function to draw a clock face:</p>
<p>
...
&nbsp;&nbsp;&nbsp; <strong>drawFace(ctx, radius);</strong><br>
}<br><br>
function drawFace(ctx, radius) {<br>
&nbsp;&nbsp;&nbsp; var grad;<br>
 <br>&nbsp;&nbsp;&nbsp; ctx.beginPath();<br>
&nbsp;&nbsp;&nbsp; ctx.arc(0, 0, radius, 0, 2*Math.PI);<br>
&nbsp;&nbsp;&nbsp; ctx.fillStyle = 'white';<br>
&nbsp;&nbsp;&nbsp; ctx.fill();<br>
 <br>&nbsp;&nbsp;&nbsp; grad = ctx.createRadialGradient(0,0,radius*0.95, 0,0,radius*1.05);<br>
&nbsp;&nbsp;&nbsp; grad.addColorStop(0, '#333');<br>
&nbsp;&nbsp;&nbsp; grad.addColorStop(0.5, 'white');<br>
&nbsp;&nbsp;&nbsp; grad.addColorStop(1, '#333');<br>&nbsp;&nbsp;&nbsp; ctx.strokeStyle = grad;<br>
&nbsp;&nbsp;&nbsp; ctx.lineWidth = radius*0.1;<br>
&nbsp;&nbsp;&nbsp; ctx.stroke();<br>
 <br>&nbsp;&nbsp;&nbsp; ctx.beginPath();<br>
&nbsp;&nbsp;&nbsp; ctx.arc(0, 0, radius*0.1, 0, 2*Math.PI);<br>
&nbsp;&nbsp;&nbsp; ctx.fillStyle = '#333';<br>
&nbsp;&nbsp;&nbsp; ctx.fill();<br>
}<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycanvas_clock_face" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Create a drawFace() function for drawing the clock face:</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
  function drawClock() {<br>
&nbsp;&nbsp;&nbsp; <strong>drawFace(ctx, radius);</strong><br>
}<br><br>
function drawFace(ctx, radius) {<br>}</div>
</div>
<p>Draw the white circle:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
ctx.beginPath();<br>ctx.arc(0, 0, radius, 0, 2*Math.PI);<br>
ctx.fillStyle = 'white';<br>
ctx.fill();
</div>
</div>
<p>Create a radial gradient (95% and 105% of original clock radius):</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
  grad = ctx.createRadialGradient(0,0,radius*0.95, 0,0,radius*1.05);</div>
</div>
<p>Create 3 color stops, corresponding with the inner, middle, and outer edge of 
the arc:</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
  grad.addColorStop(0, '#333');<br>
  grad.addColorStop(0.5, 'white');<br>
  grad.addColorStop(1, '#333');</div>
</div>

<div class="w3-panel w3-note">
  <p>The color stops create a 3D effect.</p>
</div>

<p>Define the gradient as the stroke style of the drawing object:</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
  ctx.strokeStyle = grad;</div>
</div>
<p>Define the line width of the drawing object (10% of radius):</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
  ctx.lineWidth = radius * 0.1;</div>
</div>
...
<p>Draw the clock center:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
ctx.beginPath();<br>ctx.arc(0, 0, radius*0.1, 0, 2*Math.PI);<br>
ctx.fillStyle = '#333';<br>
ctx.fill();
</div>
</div>
