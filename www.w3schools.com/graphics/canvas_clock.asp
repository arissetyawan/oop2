...
<html lang="en-US">
<head>
<title>Canvas Clock Intro</title>
<meta charset="utf-8">
...
<h1>Canvas <span class="color_h1">Clock</span></h1>
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="canvas_reference.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="canvas_clock_face.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">In these chapters we will build an analog clock using HTML canvas.</p>
<hr>
<h2>Part I - Create the Canvas</h2>
<p>The clock needs an HTML container. Create an HTML canvas:</p>
<p>
...
height=&quot;400&quot; style=&quot;background-color:#333&quot;&gt;&lt;/canvas&gt;<br><br>
&lt;script&gt;<br>var canvas = document.getElementById(&quot;canvas&quot;);<br>
var ctx = canvas.getContext(&quot;2d&quot;);<br>
var radius = canvas.height / 2;<br>
ctx.translate(radius, radius);<br>
radius = radius * 0.90<br>
drawClock();<br><br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycanvas_clock_canvas" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<p>Add an HTML &lt;canvas&gt; element to your page:</p>
<div class="w3-example">
 <div class="w3-code notranslate htmlHigh">
  &lt;canvas id=&quot;canvas&quot; width=&quot;400&quot; 
 height=&quot;400&quot; style=&quot;background-color:#333&quot;&gt;&lt;/canvas&gt;<br>
</div>
</div>
<p>Create a canvas object (var canvas) from the HTML canvas element:</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
  var canvas = 
 document.getElementById(&quot;canvas&quot;);</div>
</div>
<p>Create a 2d drawing object (var ctx) for the canvas object:</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
  var ctx = canvas.getContext(&quot;2d&quot;);</div>
</div>
<p>Calculate the clock radius, using the height of the canvas:</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
 var radius 
 = canvas.height / 2;</div>
...
<div class="w3-panel w3-note">
  <p>Using the canvas height to calculate the clock radius, makes the clock work for 
all canvas sizes.</p>
</div>

<p>Remap the (0,0) position (of the drawing object) to the center of the canvas:</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
  ctx.translate(radius, radius);</div>
</div>
<p>Reduce the clock radius (to 90%) to draw the clock well inside the canvas:</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
  radius = radius * 0.90;</div>
</div>
<p>Create a function to draw the clock:</p>
<div class="w3-example">
 <div class="w3-code notranslate jsHigh">
  function drawClock() {<br>&nbsp;&nbsp;&nbsp; 
 ctx.arc(0, 0, radius, 0 , 2*Math.PI);<br>&nbsp;&nbsp;&nbsp; ctx.fillStyle = 
 &quot;white&quot;;<br>&nbsp;&nbsp;&nbsp; ctx.fill();<br>}</div>
</div>
