...
<h1>Google Maps Reference</h1>
<div class="w3-clear nextprev">
 <a class="w3-left w3-btn" href="google_maps_types.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="svg_intro.asp">Next &#10095;</a>
</div>
<hr>

<h2>The Map() Constructor</h2>
<div class="w3-example">
<h3>Example</h3>
<p>Create a Google Map:</p>
<div class="w3-code notranslate jsHigh">
var map = new google.maps.Map(mapCanvas, mapOptions);
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trymap_ref">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Definition and Usage</h2>
<p>The Map() constructor creates a new map inside a specified HTML element (typically a &lt;div&gt; element).</p>
<hr>
<h2>Syntax</h2>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
new google.maps.Map(<i>HTMLElement</i>,<i>MapOptions</i>)
</div></div>
...
<table class="w3-table-all notranslate"> 
  ...
  <tr>
    <td><i><a  target="_blank" href="tryit.asp?filename=trymap_ref_mapoptions">MapOptions</a></i></td>
...
<table class="w3-table-all notranslate" id="table3">
  ...
  <tr>
    <td><a target="_blank" href="tryit.asp?filename=trymap_ref_getbounds">getBounds()</a></td>
    ...
    <td><a target="_blank" href="tryit.asp?filename=trymap_ref_getcenter">getCenter()</a></td>
    <td><i>LatLng</i></td>
    <td>Returns the lat/lng of the center of the map</td>
  </tr>
  <tr>
    <td><a target="_blank" href="tryit.asp?filename=trymap_ref_getdiv">getDiv()</a></td>
    <td><i>Node</i></td>
  ...
  <tr>
    <td><a target="_blank" href="tryit.asp?filename=trymap_ref_getmaptypeid">getMapTypeId()</a></td>
    <td>HYBRID<br>
 ROADMAP<br>
 SATELLITE<br>
 TERRAIN</td>
  ...
  <tr>
    <td><a target="_blank" href="tryit.asp?filename=trymap_ref_getzoom">getZoom()</a></td>
    <td><i>number</i></td>
  ...
  <tr>
    <td><a target="_blank" href="tryit.asp?filename=trymap_ref_setmaptypeid">setMapTypeId(<i>MapTypeId</i>)</a></td>
    <td>None</td>
  ...
  <tr>
    <td><a target="_blank" href="tryit.asp?filename=trymap_ref_settilt">setTilt(<i>number</i>)</a></td>
    <td>None</td>
    <td>Sets the angle of incidence for aerial imagery in degrees (for SATELLITE and HYBRID map types)</td>
  </tr>
  <tr>
    <td><a target="_blank" href="tryit.asp?filename=trymap_ref_setzoom">setZoom(<i>number</i>)</a></td>
    <td>None</td>
