...
<a class="w3-left w3-btn" href="svg_polygon.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="svg_path.asp">Next &#10095;</a>
</div>
<hr>
<h2>SVG Polyline - &lt;polyline&gt;</h2>

<h2>Example 1</h2>
<p>The &lt;polyline&gt; element is used to create any shape that consists of only straight lines 
(that is connected at several points):</p>
...
<a target="_blank" href="tryit.asp?filename=trysvg_polyline" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>

<p><b>Code explanation:</b></p>
<ul>
  <li>The points attribute defines the list of points (pairs of x and y coordinates) required to draw the polyline</li>
</ul>
<hr>
...
<a target="_blank" href="tryit.asp?filename=trysvg_polyline2" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
