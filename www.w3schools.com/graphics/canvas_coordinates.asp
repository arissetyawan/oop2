...
<h1>HTML Canvas<span class="color_h1"> Coordinates</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="canvas_drawing.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="canvas_gradients.asp">Next &#10095;</a>
</div>
<hr>

<h2>Canvas Coordinates</h2>
<p>The HTML canvas is a two-dimensional grid.</p>
<p>The upper-left corner of the canvas has the coordinates (0,0)</p>
<p>In the previous chapter, you saw this method used: fillRect(0,0,150,75).</p>
<p>This means: Start at the upper-left corner (0,0) and draw a 150x75 pixels rectangle.</p>
<hr>

<h2>Coordinates Example</h2>
...
<h2>Draw a Line</h2>
<p>To draw a straight line on a canvas, use the following methods:</p>
<ul>
  <li>moveTo(<i>x,y</i>) - defines the starting point of the line</li>
  <li>lineTo(<i>x,y</i>) - defines the ending point of the line</li>
</ul>
<p>To actually draw the line, you must use one of the &quot;ink&quot; methods, like stroke().</p>
...
<p>Define a starting point in position (0,0), and an ending point in position (200,100).
Then use the stroke() method to actually draw the line:</p>
<div class="w3-code notranslate jsHigh">
var canvas = document.getElementById(&quot;myCanvas&quot;);<br>var ctx = canvas.getContext(&quot;2d&quot;);<br>
ctx.moveTo(0,0);<br>ctx.lineTo(200,100);<br>
ctx.stroke();</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycanvas_line" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h2>Draw a Circle</h2>
<p>To draw a circle on a canvas, use the following methods:</p>
<ul>
  <li>beginPath() - begins a path</li>
    <li>arc(x,y,r,startangle,endangle) - creates an arc/curve. To create a circle with arc(): Set start angle to 0 and end angle to 2*Math.PI. The x and y parameters define the x- and y-coordinates of the center of the circle. The r parameter defines the radius of the circle.
 </li>
</ul>
<div class="w3-example">
<h3>Example</h3>
...
<p>Define a circle with the arc() method. Then use the stroke() method to actually draw the 
circle:</p>
<div class="w3-code notranslate jsHigh">
var canvas = document.getElementById(&quot;myCanvas&quot;);<br>var ctx = canvas.getContext(&quot;2d&quot;);<br>
ctx.beginPath();<br>ctx.arc(95,50,40,0,2*Math.PI);<br>ctx.stroke();</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycanvas_circle" target="_blank">Try it Yourself &raquo;</a>
</div>
