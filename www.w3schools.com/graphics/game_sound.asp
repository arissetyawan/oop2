...
<a class="w3-left w3-btn" href="game_images.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="game_gravity.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Use the HTML5 &lt;audio&gt; element to add sound and music to your games.</p>
<p>In our examples, we create a new object constructor to handle sound objects:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function sound(src) {<br>&nbsp;&nbsp;&nbsp; this.sound = document.createElement(&quot;audio&quot;);<br>&nbsp;&nbsp;&nbsp; this.sound.src = src;<br>&nbsp;&nbsp;&nbsp; this.sound.setAttribute(&quot;preload&quot;, &quot;auto&quot;);<br>&nbsp;&nbsp;&nbsp; this.sound.setAttribute(&quot;controls&quot;, &quot;none&quot;);<br>&nbsp;&nbsp;&nbsp; this.sound.style.display = &quot;none&quot;;<br>&nbsp;&nbsp;&nbsp; document.body.appendChild(this.sound);<br>&nbsp;&nbsp;&nbsp; this.play = function(){<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.sound.play();<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; this.stop = function(){<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.sound.pause();<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
 <br>
</div>
<hr>
...
<p>To create a new sound object use the <code class="w3-codespan">sound</code> constructor, and when 
the red square hits an obstacle, play the sound:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 var myGamePiece;<br>var myObstacles = [];<br><strong>var mySound;<br></strong><br>function startGame() {<br>&nbsp;&nbsp;&nbsp; myGamePiece = new component(30, 30, &quot;red&quot;, 10, 120);<br>&nbsp;&nbsp;&nbsp;
 <strong>mySound = new sound(&quot;bounce.mp3&quot;);<br></strong>&nbsp;&nbsp;&nbsp; myGameArea.start();<br>}<br><br>function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; var x, height, gap, minHeight, maxHeight, minGap, maxGap;<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; myObstacles.length; i += 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (myGamePiece.crashWith(myObstacles[i])) {<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; mySound.play();<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGameArea.stop();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } <br>&nbsp;&nbsp;&nbsp; }<br><br>...<br><br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_sound" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Background Music</h2>
<p>To add background music to your game, add a new sound object, and start 
playing when you start the game:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 var myGamePiece;<br>var myObstacles = [];<br>var mySound;<br><strong>var myMusic;</strong><br><br>function startGame() {<br>&nbsp;&nbsp;&nbsp; myGamePiece = new component(30, 30, &quot;red&quot;, 10, 120);<br>&nbsp;&nbsp;&nbsp; mySound = new sound(&quot;bounce.mp3&quot;);<br><strong>&nbsp;&nbsp;&nbsp; myMusic = new sound(&quot;gametheme.mp3&quot;);<br>&nbsp;&nbsp;&nbsp; myMusic.play();<br>
 </strong>&nbsp;&nbsp;&nbsp; myGameArea.start();<br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_sound_music" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
