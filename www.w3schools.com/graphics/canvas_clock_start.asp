...
<html lang="en-US">
<head>
<title>Canvas Clock Start</title>
<meta charset="utf-8">
...
<h1>Canvas <span class="color_h1">Clock Start</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="canvas_clock_hands.asp">&#10094; Previous</a>
 <a class="w3-right w3-btn" href="game_intro.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">In these chapters we build an analog clock using HTML Canvas.</p>
<hr>
<h2>Part V - Start the Clock</h2>
<p>To start the clock, call the drawClock function at intervals:</p>
<p>
...
//drawClock();<br>
setInterval(drawClock, 1000);<br>
</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=trycanvas_clock_start" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Example Explained</h2>

<p>The only thing you have to do (to start the clock) is to call the drawClock 
function at intervals.</p>
<p>Substitute:</p>
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
 drawClock();<br></div>
...
<div class="w3-example">
<div class="w3-code notranslate jsHigh">
 setInterval(drawClock, 1000);</div>
</div>


<div class="w3-panel w3-note">
  <p>The interval is in milliseconds. drawClock will be called for each 1000 
milliseconds.</p>
</div>
