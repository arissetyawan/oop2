...
<a class="w3-left w3-btn" href="game_sound.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="game_bouncing.asp">Next &#10095;</a>
</div>
<hr>
<p>Some games have forces that pulls the game component in one direction, like gravity pulls objects to the ground.</p>
...
<p>To add this functionality to our component constructor, first add a <code class="w3-codespan">gravity</code> property, which sets the current gravity.
Then add a <code class="w3-codespan">gravitySpeed</code> property, which increases everytime we update the frame:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function component(width, height, color, x, y, type) {<br>&nbsp;&nbsp;&nbsp; this.type = type;<br>&nbsp;&nbsp;&nbsp; this.width = width;<br>&nbsp;&nbsp;&nbsp; this.height = height;<br>&nbsp;&nbsp;&nbsp; this.x = x;<br>&nbsp;&nbsp;&nbsp; this.y = y; <br>&nbsp;&nbsp;&nbsp; this.speedX = 0;<br>&nbsp;&nbsp;&nbsp; this.speedY = 0; <br><strong>&nbsp;&nbsp;&nbsp; this.gravity = 0.05;<br>&nbsp;&nbsp;&nbsp; this.gravitySpeed = 0;<br>&nbsp;&nbsp;&nbsp; </strong>this.update = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillRect(this.x, this.y, this.width, this.height);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; this.newPos = function() {<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.gravitySpeed += this.gravity;<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x += this.speedX;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.y += this.speedY<strong> + this.gravitySpeed</strong>; <br>&nbsp;&nbsp;&nbsp; }<br>
 }<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_gravity" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>To prevent the red square from falling forever, stop the falling when it hits the bottom of the game area:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 &nbsp;&nbsp;&nbsp; this.newPos = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.gravitySpeed += this.gravity;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x += this.speedX;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.y += this.speedY + this.gravitySpeed;<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.hitBottom();<br></strong>&nbsp;&nbsp;&nbsp; }<br><strong>&nbsp;&nbsp;&nbsp; this.hitBottom = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var rockbottom = myGameArea.canvas.height - this.height;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (this.y &gt; rockbottom) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.y = rockbottom;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; }</strong><br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_gravity_bottom" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Accelerate Up</h2>
<p>In a game, when you have a force that pulls you down, you should have a method to force the component to accelerate up.
<p>Trigger a function when someone clicks a button, and make the red square fly up in the air: </p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;script&gt;<div class="jsHigh">function accelerate(n) {<br>&nbsp;&nbsp;&nbsp;  myGamePiece.gravity = n;<br>}</div>&lt;/script&gt;<br><br>
 &lt;button onmousedown=&quot;accelerate(-0.2)&quot; onmouseup=&quot;accelerate(0.1)&quot;&gt;ACCELERATE&lt;/button&gt;</div>
 <a target="_blank" href="tryit.asp?filename=trygame_gravity_accelerate" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>A Game</h2>
<p>Make a game based on what we have learned so far:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-white w3-padding notranslate">
<iframe id="game1" src="trygame_gravity_game.htm" style="width:100%;max-width:650px;height:480px;border:none;"></iframe>
</div>
 <a target="_blank" href="tryit.asp?filename=trygame_gravity_game" class="w3-btn w3-margin-top w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
