...
<h1>Game Obstacles</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="game_controllers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="game_score.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Now we want to add some obstacles to our game.</p>
<p>Add a new component to the gaming area. Make it green, 10px wide, 200px high, 
and place it 300px to the right and 120px down.</p>
<p>Also update the obstacle component in every frame:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 var myGamePiece;<br><strong>var myObstacle;<br></strong><br>function startGame() {<br>&nbsp;&nbsp;&nbsp; myGamePiece = new component(30, 30, &quot;red&quot;, 10, 120);<br>&nbsp;&nbsp;&nbsp;
 <strong>myObstacle = new component(10, 200, &quot;green&quot;, 300, 120); <br>
 </strong>&nbsp;&nbsp;&nbsp;
 myGameArea.start();<br>}<br><br>function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br>&nbsp;&nbsp;&nbsp; <strong>myObstacle.update();<br>
 &nbsp;&nbsp;&nbsp;
 </strong>myGamePiece.newPos();<br>&nbsp;&nbsp;&nbsp; myGamePiece.update();<br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_obstacle" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>In the example above, nothing happens when you hit the obstacle. In a game, 
that is not very satisfying.</p>
<p>How do we know if our red square hits the obstacle?</p>
<p>Create a new method in the component constructor, that checks if the 
component crashes with another component. This method should be called every 
time the frames updates, 50 times per second.</p>
<p>Also add a <code class="w3-codespan">stop()</code> method to the <code class="w3-codespan">myGameArea</code> object, 
which clears the 20 milliseconds interval.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 var myGameArea = {<br>&nbsp;&nbsp;&nbsp; canvas : document.createElement(&quot;canvas&quot;),<br>&nbsp;&nbsp;&nbsp; start : function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.canvas.width = 480;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.canvas.height = 270;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.context = this.canvas.getContext(&quot;2d&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.body.insertBefore(this.canvas, document.body.childNodes[0]);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.interval = setInterval(updateGameArea, 20);<br>&nbsp;&nbsp;&nbsp; },<br>&nbsp;&nbsp;&nbsp; clear : function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.context.clearRect(0, 0, this.canvas.width, this.canvas.height);<br>&nbsp;&nbsp;&nbsp; }<strong>,<br>&nbsp;&nbsp;&nbsp; stop : function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; clearInterval(this.interval);<br>&nbsp;&nbsp;&nbsp; }<br></strong>}<br><br>function component(width, height, color, x, y) {<br>&nbsp;&nbsp;&nbsp; this.width = width;<br>&nbsp;&nbsp;&nbsp; this.height = height;<br>&nbsp;&nbsp;&nbsp; this.speedX = 0;<br>&nbsp;&nbsp;&nbsp; this.speedY = 0; <br>&nbsp;&nbsp;&nbsp; this.x = x;<br>&nbsp;&nbsp;&nbsp; this.y = y; <br>&nbsp;&nbsp;&nbsp; this.update = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillRect(this.x, this.y, this.width, this.height);<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; this.newPos = function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.x += this.speedX;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.y += this.speedY; <br>&nbsp;&nbsp;&nbsp; }<br><strong>&nbsp;&nbsp;&nbsp; this.crashWith = function(otherobj) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var myleft = this.x;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var myright = this.x + (this.width);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var mytop = this.y;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var mybottom = this.y + (this.height);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var otherleft = otherobj.x;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var otherright = otherobj.x + (otherobj.width);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var othertop = otherobj.y;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var otherbottom = otherobj.y + (otherobj.height);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; var crash = true;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if ((mybottom &lt; othertop) ||<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (mytop &gt; otherbottom) ||<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (myright &lt; otherleft) ||<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (myleft &gt; otherright)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; crash = false;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return crash;<br>&nbsp;&nbsp;&nbsp; }<br></strong>}<strong><br></strong><br>
 function updateGameArea() {<br><strong>&nbsp;&nbsp;&nbsp; if (myGamePiece.crashWith(myObstacle)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGameArea.stop();<br>&nbsp;&nbsp;&nbsp; } else {<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGameArea.clear();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacle.update();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGamePiece.newPos(); <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGamePiece.update();<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
 <a target="_blank" href="tryit.asp?filename=trygame_obstacle_hit" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Moving Obstacle</h2>
<p>The obstacle is of no danger when it is static, so we want it to move.</p>
<p>Change the property value of <code class="w3-codespan">myObstacle.x</code> at 
every update:</p>
...
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; if (myGamePiece.crashWith(myObstacle)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGameArea.stop();<br>&nbsp;&nbsp;&nbsp; } else {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGameArea.clear();<br><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacle.x += -1;<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacle.update();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGamePiece.newPos(); <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGamePiece.update();<br>&nbsp;&nbsp;&nbsp; }<br>}</div>
 <a target="_blank" href="tryit.asp?filename=trygame_obstacle_move" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<hr>
<h2>Multiple Obstacles</h2>
<p>How about adding multiple obstacles?</p>
<p>For that we need a property for counting frames, and a method for execute something at a given frame rate.</p>


<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 var myGameArea = {<br>&nbsp;&nbsp;&nbsp; canvas : document.createElement(&quot;canvas&quot;),<br>&nbsp;&nbsp;&nbsp; start : function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.canvas.width = 480;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.canvas.height = 270;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.context = this.canvas.getContext(&quot;2d&quot;);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; document.body.insertBefore(this.canvas, document.body.childNodes[0]);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <strong>this.frameNo = 0;</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.interval = setInterval(updateGameArea, 20);<br>&nbsp;&nbsp;&nbsp; },<br>&nbsp;&nbsp;&nbsp; clear : function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.context.clearRect(0, 0, this.canvas.width, this.canvas.height);<br>&nbsp;&nbsp;&nbsp; },<br>&nbsp;&nbsp;&nbsp; stop : function() {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; clearInterval(this.interval);<br>&nbsp;&nbsp;&nbsp; }<br>}<br><br><strong>function everyinterval(n) {<br>&nbsp;&nbsp;&nbsp; if ((myGameArea.frameNo / n) % 1 == 0) {return true;}<br>&nbsp;&nbsp;&nbsp; return false;<br>}</strong></div>
    <br>
</div>
<p>The everyinterval function returns true if the current framenumber 
corresponds with the given interval.</p>
<p>To define multiple obstacles, first declare the obstacle variable as an 
array.</p>
<p>Second, we need to make some changes in the updateGameArea function.</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 var myGamePiece;<br><strong>var myObstacles = [];<br></strong><br><strong>function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; var x, y;<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; myObstacles.length; i += 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (myGamePiece.crashWith(myObstacles[i])) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGameArea.stop();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } <br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br>&nbsp;&nbsp;&nbsp; myGameArea.frameNo += 1;<br>&nbsp;&nbsp;&nbsp; if (myGameArea.frameNo == 1 || everyinterval(150)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x = myGameArea.canvas.width;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; y = myGameArea.canvas.height - 200<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles.push(new component(10, 200, &quot;green&quot;, x, y));<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; myObstacles.length; i += 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles[i].x += -1;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles[i].update();<br>&nbsp;&nbsp;&nbsp; }<br></strong>&nbsp;&nbsp;&nbsp; myGamePiece.newPos(); <br>&nbsp;&nbsp;&nbsp; myGamePiece.update();<br><strong>}</strong></div>
 <a target="_blank" href="tryit.asp?filename=trygame_obstacles" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<p>In the <code class="w3-codespan">updateGameArea</code> function we must loop through every obstacle to see if 
there is a crash. If there is a crash, the <code class="w3-codespan">updateGameArea</code> function 
will stop, and no more drawing is done.</p>
<p>The <code class="w3-codespan">updateGameArea</code> function counts frames and adds an obstacle for every 
150th 
frame.</p>
<hr>
<h2>Obstacles of Random Size</h2>
<p>To make the game a bit more difficult, and fun, we will send in obstacles of random sizes, so that the red square must move up and down to 
not crash.</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; var x, height, gap, minHeight, maxHeight, minGap, maxGap;<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; myObstacles.length; i += 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (myGamePiece.crashWith(myObstacles[i])) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGameArea.stop();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } <br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br>&nbsp;&nbsp;&nbsp; myGameArea.frameNo += 1;<br><strong>&nbsp;&nbsp;&nbsp; if (myGameArea.frameNo == 1 || everyinterval(150)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x = myGameArea.canvas.width;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; minHeight = 20;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; maxHeight = 200;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; height = Math.floor(Math.random()*(maxHeight-minHeight+1)+minHeight);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; minGap = 50;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; maxGap = 200;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; gap = Math.floor(Math.random()*(maxGap-minGap+1)+minGap);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles.push(new component(10, height, &quot;green&quot;, x, 0));<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles.push(new component(10, x - height - gap, &quot;green&quot;, x, height + gap));<br>&nbsp;&nbsp;&nbsp; }<br></strong>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; myObstacles.length; i += 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles[i].x += -1;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles[i].update();<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; myGamePiece.newPos(); <br>&nbsp;&nbsp;&nbsp; myGamePiece.update();<br>}</div>
 <a target="_blank" href="tryit.asp?filename=trygame_obstacles_random" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="game_controllers.asp">&#10094; Previous</a>
