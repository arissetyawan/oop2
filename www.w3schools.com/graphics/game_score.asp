...
<a class="w3-left w3-btn" href="game_obstacles.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="game_images.asp">Next &#10095;</a>
</div>
<hr>
...
<p>There are many ways to keep the score in a game, we will show you how to 
write a score onto the canvas.</p>
<p>First make a score component:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 var myGamePiece;<br>var myObstacles = [];<br><strong>var myScore;<br>
 </strong><br>function startGame() {<br>&nbsp; myGamePiece = new component(30, 30, &quot;red&quot;, 10, 160);<br>
 <strong>&nbsp; myScore = new component(&quot;30px&quot;, &quot;Consolas&quot;, &quot;black&quot;, 280, 40, &quot;text&quot;);<br></strong>&nbsp; myGameArea.start();<br>}<br></div>
 <br>
</div>

<p>The syntax for writing text on a canvas element is different from drawing a rectangle.
...
<p>In the component constructor we test if the component is of type "text", and use the 
<code class="w3-codespan">fillText</code> method instead of the <code class="w3-codespan">fillRect</code> method:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function component(width, height, color, x, y<strong>, type</strong>) {<br><strong>&nbsp; this.type = type;<br></strong>&nbsp; this.width = width;<br>&nbsp; this.height = height;<br>&nbsp; this.speedX = 0;<br>&nbsp; this.speedY = 0; <br>&nbsp; this.x = x;<br>&nbsp; this.y = y; <br>&nbsp; this.update = function() {<br>&nbsp;&nbsp;&nbsp; ctx = myGameArea.context;<br><strong>&nbsp;&nbsp;&nbsp; if (this.type == &quot;text&quot;) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.font = this.width + &quot; &quot; + this.height;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillText(this.text, this.x, this.y);<br>&nbsp;&nbsp;&nbsp; } else {<br>
 </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillStyle = color;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ctx.fillRect(this.x, this.y, this.width, this.height);<br><strong>&nbsp;&nbsp;&nbsp; }<br></strong>&nbsp; }<br>...<br>}<br></div>
 <br>
</div>
<hr>
...
<p>At last we add some code in the updateGameArea function that writes the score 
onto the canvas. We use the <code class="w3-codespan">frameNo</code> property to count the score:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate jsHigh">
 function updateGameArea() {<br>&nbsp;&nbsp;&nbsp; var x, height, gap, minHeight, maxHeight, minGap, maxGap;<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; myObstacles.length; i += 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; if (myGamePiece.crashWith(myObstacles[i])) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myGameArea.stop();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; return;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; } <br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; myGameArea.clear();<br><strong>&nbsp;&nbsp;&nbsp; myGameArea.frameNo += 1;<br></strong>&nbsp;&nbsp;&nbsp; if (myGameArea.frameNo == 1 || everyinterval(150)) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x = myGameArea.canvas.width;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; minHeight = 20;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; maxHeight = 200;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; height = Math.floor(Math.random()*(maxHeight-minHeight+1)+minHeight);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; minGap = 50;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; maxGap = 200;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; gap = Math.floor(Math.random()*(maxGap-minGap+1)+minGap);<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles.push(new component(10, height, &quot;green&quot;, x, 0));<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles.push(new component(10, x - height - gap, &quot;green&quot;, x, height + gap));<br>&nbsp;&nbsp;&nbsp; }<br>&nbsp;&nbsp;&nbsp; for (i = 0; i &lt; myObstacles.length; i += 1) {<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles[i].speedX = -1;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles[i].newPos();<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; myObstacles[i].update();<br>&nbsp;&nbsp;&nbsp; }<br><strong>&nbsp;&nbsp;&nbsp; myScore.text=&quot;SCORE: &quot; + myGameArea.frameNo;<br>&nbsp;&nbsp;&nbsp; myScore.update();<br></strong>&nbsp;&nbsp;&nbsp; myGamePiece.newPos();
 <br>&nbsp;&nbsp;&nbsp; myGamePiece.update();<br>}<br></div>
 <a target="_blank" href="tryit.asp?filename=trygame_score" class="w3-btn w3-margin-bottom">Try it Yourself &raquo;</a>
</div>
