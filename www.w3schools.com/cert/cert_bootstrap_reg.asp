...
<input type="hidden" name="item_name" value="Bootstrap Certification" />
<input type="hidden" name="item_number" value="Bootstrap" />
...
<a onclick="clickRegister();return false;" class="w3-btn w3-large" href="javascript:void(0);">Register Now</a>
<br><br>
