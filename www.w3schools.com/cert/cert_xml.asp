...
<a class="w3-left w3-btn" href="cert_bootstrap.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="career_tips.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The XML Certification requires skills in XML, XML DOM and XSLT.</p>
<hr>

<img src="pic_xml_cert_small.gif" alt="XML Certificate" style="float:left;margin-bottom:10px;margin-right:20px;height:206px;width:146px;border:1px solid #888888">
...
<p class="clearfix"><a class="w3-btn w3-large" href="cert_xml_reg.asp">Get Certified now!</a></p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a href="/quiztest/quiztest.asp?qtest=XML">XML Quiz</a></td>
  </tr>
  <tr>
    <td><a href="/xml/xsl_intro.asp">XSLT Tutorial</a></td>
    <td>&nbsp;</td>
  </tr>
  </table>
<hr>
...
<p>If you achieve certification status, you can download your XML Developer Certificate. The document will contain your personal data acknowledging your status as a Certified XML Developer.</p>
