...
<html lang="en-US">
<head>
<title>Bootstrap Certification</title>
<meta charset="utf-8">
...
<h1><span class="color_h1">Bootstrap</span> Certification</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="cert_php.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cert_xml.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The Bootstrap Certification requires skills in Bootstrap.</p>
<hr>

<img src="pic_bs_cert_small.gif" alt="Bootstrap Certificate" style="float:left;margin-bottom:10px;margin-right:20px;height:206px;width:146px;border:1px solid #888888">
<h2>Bootstrap&nbsp;Certificate</h2>
<p>The Bootstrap Developer Certificate proves fundamental knowledge of web development using Bootstrap.</p>
<p><span style="color:#444444;">Price:</span><span style="font-size:150%;color:#900B09"> $95.00</span></p>
<p class="clearfix"><a class="w3-btn w3-large" href="cert_bootstrap_reg.asp">Get Certified now!</a></p>
<hr>

<h2>The Bootstrap Developer Certificate</h2>
<p>Bootstrap is a front-end framework for faster and easier web development.</p>
<p>Bootstrap includes HTML and CSS based design templates for typography, forms, 
buttons, tables, navigation, modals, image carousels and many other, as well as 
optional JavaScript plugins.</p>
<p>Bootstrap also gives you the 
ability to easily create responsive designs.</p>
<p>The Bootstrap Developer Certificate proves fundamental knowledge of web development using Bootstrap.</p>
<p><a target="_blank" href="cert_pic.asp?imgsrc=BS">Bootstrap Developer Certificate</a></p>
<hr>
...
<p>All questions in the exam are based on the content of W3Schools' Bootstrap tutorial. We strongly recommend the following tutorial and quiz:</p>
<table class="w3-table-all notranslate">
  ...
  <tr>
    <td><a href="/bootstrap/default.asp">Bootstrap Tutorial</a></td>
    <td><a href="/quiztest/quiztest.asp?qtest=Bootstrap">Bootstrap Quiz</a></td>
  </tr>
  </table>
<hr>

<h2>The Bootstrap Exam</h2>
<p>The Bootstrap exam will be taken over the Internet, at any time and from any location, but the exam should be supervised by a person selected by the exam candidate.</p>
...
<p>If you achieve certification status, you can download your Bootstrap Developer Certificate. The document will contain your personal data acknowledging your status as a Certified Bootstrap Developer.</p>
...
<p><img src="/images/w3cert.gif" alt="W3Schools Certified"></p>
