...
<a class="w3-left w3-btn" href="cert_html_new.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cert_javascript.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The CSS Certification requires skills in CSS.</p>
<hr>

<img src="pic_css_cert_small.gif" alt="CSS Certificate" style="float:left;margin-bottom:10px;margin-right:20px;height:206px;width:146px;border:1px solid #888888">
<h2>CSS&nbsp;Certificate</h2>
<p>The CSS Developer Certificate proves fundamental knowledge of web development using advanced CSS.</p>
<p><span style="color:#444444;">Price:</span><span style="font-size:150%;color:#900B09"> $95.00</span></p>
<p class="clearfix"><a class="w3-btn w3-large" href="cert_css_reg.asp">Get Certified now!</a></p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a href="/quiztest/quiztest.asp?qtest=CSS">CSS Quiz</a></td>
  </tr>
</table>
<hr>
...
<p>If you achieve certification status, you can download your CSS Developer Certificate. The document will contain your personal data acknowledging your status as a Certified 
CSS Developer.</p>
