...
<a class="w3-left w3-btn" href="cert_jquery.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="cert_bootstrap.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The PHP Certification requires skills in PHP and SQL (MySQL).</p>
<hr>

<img src="pic_php_cert_small.gif" alt="PHP Certificate" style="float:left;margin-bottom:10px;margin-right:20px;height:206px;width:146px;border:1px solid #888888">
...
<p class="clearfix"><a class="w3-btn w3-large" href="cert_php_reg.asp">Get Certified now!</a></p>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a href="/quiztest/quiztest.asp?qtest=PHP">PHP Quiz</a></td>
  </tr>
  <tr>
    <td><a href="/sql/default.asp">SQL Tutorial</a></td>
    <td><a href="/quiztest/quiztest.asp?qtest=SQL">SQL Quiz</a></td>
  </tr>
  </table>
<hr>
...
<p>If you achieve certification status, you can download your PHP Developer Certificate. The document will contain your personal data acknowledging your status as a Certified PHP Developer.</p>
