...
<a class="w3-right w3-btn" href="cert_css.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">The HTML Certification requires skills in HTML.</p>
<hr>

<img src="pic_htmlnew_cert_small.gif" alt="HTML Certificate" style="float:left;margin-bottom:10px;margin-right:20px;height:206px;width:146px;border:1px solid #888888">
...
<p class="clearfix"><a class="w3-btn w3-large" href="cert_html_new_reg.asp">Get Certified now!</a></p>
<hr>
...
<p>The HTML Developer Certificate proves fundamental knowledge of web development using HTML.</p>
<p><a target="_blank" href="cert_pic.asp?imgsrc=HTML_NEW">HTML Developer Certificate</a></p>
<hr>

<h2>Prerequisites</h2>
<p>Before you apply for your exam, you should have a fundamental knowledge of:</p>
<ul>
  <li>The Hypertext Markup Language - HTML</li>
</ul>
<hr>
...
<table class="w3-table-all notranslate">
  ...
  <tr>
    ...
    <td><a href="/quiztest/quiztest.asp?qtest=HTML">HTML Quiz</a></td>
  </tr>
  </table>
<hr>
...
<p>If you achieve certification status, you can download your HTML Developer Certificate. The document will contain your personal data acknowledging your status as a Certified HTML Developer.</p>
