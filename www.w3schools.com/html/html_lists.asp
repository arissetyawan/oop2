...
<a class="w3-left w3-btn" href="html_tables.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_blocks.asp">Next &#10095;</a>
</div>
...
<a class="w3-btn w3-margin-top w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_intro" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>
<a class="w3-btn" href="tryit.asp?filename=tryhtml_lists_unordered" target="_blank">Try it Yourself &raquo;</a>
</p>
</div>
<hr>

<h2>Unordered HTML List - Choose List Item Marker</h2>
<p>The CSS <code class="w3-codespan">list-style-type</code> property is used to define the style of the 
list item marker:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_unordered_disc" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_unordered_circle" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_unordered_square" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_unordered_none" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_ordered" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Ordered HTML List - The Type Attribute</h2>
<p>The <code class="w3-codespan">type</code> attribute of the <code class="w3-codespan">&lt;ol&gt;</code> tag, defines the type of the 
list item marker:</p>
<table class="w3-table-all notranslate">
<tr>
<th>Type</th>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_ordered_numbers" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_ordered_ucase" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_ordered_lcase" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_ordered_roman_ucase" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_ordered_roman_lcase" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_description" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_nested" target="_blank">Try it Yourself &raquo;</a>
</div>

<div class="w3-panel w3-note">
  <p><strong>Note:</strong> List items can contain new list, and other HTML elements, like images and links, etc.</p>
</div>
<hr>

<h2>Control List Counting</h2>
<p>By default, an ordered list will start counting from 1. If you want to start counting from a specified number, you can use the <code class="w3-codespan">start</code> attribute:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
  &lt;ol start=&quot;50&quot;&gt;<br>&nbsp; &lt;li&gt;Coffee&lt;/li&gt;<br>&nbsp; &lt;li&gt;Tea&lt;/li&gt;<br>&nbsp; 
  &lt;li&gt;Milk&lt;/li&gt;<br>&lt;/ol&gt;</div>
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_start" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
 &lt;!DOCTYPE html&gt;<br>&lt;html&gt;<br>&lt;head&gt;<br>&lt;style&gt;<br>ul {<br>&nbsp;&nbsp;&nbsp; list-style-type: none;<br>&nbsp;&nbsp;&nbsp; margin: 0;<br>&nbsp;&nbsp;&nbsp; padding: 0;<br>&nbsp;&nbsp;&nbsp; overflow: hidden;<br>&nbsp;&nbsp;&nbsp; background-color: #333333;<br>}<br><br>li {<br>&nbsp;&nbsp;&nbsp; float: left;<br>}<br><br>li a {<br>&nbsp;&nbsp;&nbsp; display: block;<br>&nbsp;&nbsp;&nbsp; color: white;<br>&nbsp;&nbsp;&nbsp; text-align: center;<br>&nbsp;&nbsp;&nbsp; padding: 16px;<br>&nbsp;&nbsp;&nbsp; text-decoration: none;<br>}<br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_lists_menu" target="_blank">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel w3-note">
...
<ul>
  <li>Use the HTML <code class="w3-codespan">&lt;ul&gt;</code> element to define an unordered list</li>
  <li>Use the CSS <code class="w3-codespan">list-style-type</code> property to define the list item marker</li>
  <li>Use the HTML <code class="w3-codespan">&lt;ol&gt;</code> element to define an ordered list</li>
  <li>Use the HTML <code class="w3-codespan">type</code> attribute to define the numbering type</li>
  <li>Use the HTML <code class="w3-codespan">&lt;li&gt;</code> element to define a list item</li>
  <li>Use the HTML <code class="w3-codespan">&lt;dl&gt;</code> element to define a description list</li>
  <li>Use the HTML <code class="w3-codespan">&lt;dt&gt;</code> element to define the description term</li>
  <li>Use the HTML <code class="w3-codespan">&lt;dd&gt;</code> element to describe the term in a description list </li>
  <li>Lists can be nested inside lists</li>
  <li>List items can contain other HTML elements </li>
  <li>Use the CSS property <code class="w3-codespan">float:left</code> or <code class="w3-codespan">display:inline</code> to display a list horizontally</li>
</ul>
<hr>
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_lists1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_lists2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_lists3" target="_blank">Exercise 3 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_lists4" target="_blank">Exercise 4 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_lists5" target="_blank">Exercise 5 &raquo;</a>
  </div>
</div>
<hr>
