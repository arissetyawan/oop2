...
<p>The <code class="w3-codespan">color</code> property defines the text color for 
an HTML element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<h2>HTML Fonts</h2>
<p>The <code class="w3-codespan">font-family</code> property defines the font to be used  
for an HTML element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<p>The <code class="w3-codespan">text-align</code> property defines the horizontal text alignment for an HTML element:</p>
<div class="w3-example">
<h3>Example</h3>
<div class="w3-code notranslate htmlHigh">
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_styles1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_styles2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_styles3" target="_blank">Exercise 3 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_styles4" target="_blank">Exercise 4 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_styles5" target="_blank">Exercise 5 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_styles6" target="_blank">Exercise 6 &raquo;</a>
  </div>
</div>
