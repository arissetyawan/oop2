...
<a class="w3-left w3-btn" href="html_colors.asp">&#10094; Previous</a>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_css_id" target="_blank">Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_css_class" target="_blank">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_css1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_css2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_css3" target="_blank">Exercise 3 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_css4" target="_blank">Exercise 4 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_css5" target="_blank">Exercise 5 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_css6" target="_blank">Exercise 6 &raquo;</a>
  </div>
</div>
<hr>
