...
<a class="w3-left w3-btn" href="html_blocks.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_id.asp">Next &#10095;</a>
</div>
<hr>
<h2>Using The class Attribute</h2>
<p>The <code class="w3-codespan">class</code> attribute specifies 
one or more class names for an HTML element.<p>The class name can be used by CSS and 
JavaScript to perform certain tasks for elements with the specified class name.<p>
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryhtml_classes_css" target="_blank">
...
<p>JavaScript can access elements with a specified class 
name by using the <code class="w3-codespan">getElementsByClassName()</code> method:</p>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_classes_js" target="_blank">
 Try it Yourself &raquo;</a>
</div>
...
<p>HTML elements can have more than one class name, each class name must be 
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_classes_multiple" target="_blank">
 Try it Yourself &raquo;</a>
</div>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml_classes_tags" target="_blank">
 Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-container w3-dark-grey w3-padding">
  ...
  <div class="w3-bar w3-margin-bottom">
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_classes1" target="_blank">Exercise 1 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_classes2" target="_blank">Exercise 2 &raquo;</a>
    <a class="w3-bar-item w3-btn" href="exercise.asp?filename=exercise_classes3" target="_blank">Exercise 3 &raquo;</a>
  </div>
</div>
