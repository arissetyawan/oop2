...
<h1>HTML <span class="color_h1">Exercises</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_quiz.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_exam.asp">Next &#10095;</a>
</div>
<hr><p class="intro">You can test your HTML skills with W3Schools' Exercises.</p>
<hr>

<h2>Exercises</h2>
<p>We have gathered a variety of HTML exercises (with answers) for each HTML Chapter.</p>
<p>Try to solve an exercise by editing some code. Get a "hint" if you're stuck, or show the answer to see what you've done wrong.</p>
...
<div class="w3-dark-grey w3-padding w3-margin-top">
  <h2>Start HTML Exercises</h2>
  <p>Good luck!</p>
  <p><a href="/html/exercise.asp" target="_blank" class="w3-btn w3-green" style="padding:17px;font-size:17px">Start HTML Exercises &#10095;</a></p>
</div>

<div class="w3-note w3-panel">
  <p>If you don't know HTML, we suggest that you read our <a href="default.asp">HTML Tutorial</a> from scratch.</p>
</div>
<hr>
