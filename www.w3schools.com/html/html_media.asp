...
<a class="w3-left w3-btn" href="html_googlemaps.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html5_video.asp">Next &#10095;</a>
</div>

<hr>
<p class="intro">Multimedia on the web is sound, music, videos, movies, and animations.</p>
<hr>

<h2>What is Multimedia?</h2>
<p>Multimedia comes in many different formats. It can be almost anything you can hear or see.</p>
<p>Examples: Images, music, 
...
<p>In this chapter you will learn about the different multimedia formats.</p>
<hr>
<h2>Browser Support</h2>
<p>The first web browsers had support for text only, limited to a single font in a single color.</p>
<p>Later came browsers with support for colors and fonts, and images!</p>
<p>Audio, video, and animation have been handled differently 
by the major browsers. Different formats have been supported, and some formats require 
extra helper programs (plug-ins) to work.</p>
<p>Hopefully this will become history. HTML5 multimedia promises an easier 
future for multimedia.</p>
...
<table>
<tr>
<td style="width:225px"><img alt="Videoformats" width="196" height="109" src="pic_video.jpg"></td>
<td style="vertical-align:top">MP4 is the new and upcoming format for internet video.<br>
<br>MP4 is recommended by YouTube.<br><br>MP4 is supported by Flash Players.<br>
<br>MP4 is supported by HTML5.
<br>
</td>
</tr>
</table>
...
not supported in HTML5 (See MP4). </td>
</tr>
...
Plays well on Apple computers, but not in web browsers. (See MP4)</td>
</tr>
<tr>
<td>RealVideo</td>
<td>.rm<br>.ram</td>
...
<td>.ogg</td>
<td>
Theora Ogg. Developed by the Xiph.Org Foundation. Supported by HTML5.</td>
</tr>
<tr>
<td>WebM</td>
<td>.webm</td>
...
<p>Only MP4, WebM, and Ogg video are supported by the HTML5 standard.</p>
</div>
...
<td>
Ogg. 
Developed by the Xiph.Org Foundation. Supported by HTML5.</td>
</tr>
<tr>
<td>MP3</td>
<td>.mp3</td>
...
automatic support for MP4 audio by all browsers.</td>
</tr>
</table>
<div class="w3-panel w3-note">
<p>Only MP3, WAV, and Ogg audio are supported by the HTML5 standard.</p>
</div>
<br>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html_googlemaps.asp">&#10094; Previous</a>
