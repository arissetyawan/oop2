...
<a class="w3-left w3-btn" href="html_symbols.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="html_urlencode.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">To display an HTML page correctly, a web browser must know 
which character set (character encoding) to use.</p>
<hr>
...
characters like ! $ + - ( ) @ &lt; &gt; .</p>
<p>ANSI (Windows-1252) was the original Windows character set, with support for 256 different 
character codes. </p>
<p>ISO-8859-1 was the default character set for HTML 4. This character set 
also supported 256 different character codes.</p>
<p>Because ANSI and ISO-8859-1 were so limited, HTML 4 also supported UTF-8.</p>
<div class="w3-panel w3-note">
<p>UTF-8 (Unicode) covers almost all of the characters and symbols in the world.</p>
</div>
<p>The default character encoding for HTML5 is UTF-8.</p>
<hr>
...
<p>This is specified in the <code class="w3-codespan">&lt;meta&gt;</code> tag:</p>
...
<div class="w3-panel w3-note">
<p>If a browser detects ISO-8859-1 in a web page, it defaults to ANSI, because ANSI is identical to ISO-8859-1
except that ANSI has 32 extra characters.</p>
</div>
<hr>
...
<p>The following table displays the differences between the character sets described above:</p>
...
characters.</p>
<p>For a closer look, study our <a href="/charsets/default.asp">Complete HTML Character Set Reference</a>.</p>
<hr>

<h2>The @charset CSS Rule</h2>
<p>You can use the CSS <code class="w3-codespan">@charset</code> rule to specify the character encoding used in a style sheet:</p>
<div class="w3-example">
<h3>Example</h3>
...
<p>Read more about the  <a href="/cssref/pr_charset_rule.asp">CSS @charset Rule in our CSS Reference</a>.</p>
